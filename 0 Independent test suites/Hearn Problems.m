...
{x/(1+x^3), x, 7, -(ArcTan[(1 - 2*x)/Sqrt[3]]/Sqrt[3]) - (1/3)*Log[1 + x] + (1/6)*Log[1 - x + x^2]}
{x^3/((x-1)^2*(x^3+1)), x, 4, 1/(2*(1 - x)) + (3/4)*Log[1 - x] - (1/12)*Log[1 + x] - (1/3)*Log[1 - x + x^2]}
{1/(1+x^4), x, 11, -(ArcTan[1 - Sqrt[2]*x]/(2*Sqrt[2])) + ArcTan[1 + Sqrt[2]*x]/(2*Sqrt[2]) - Log[1 - Sqrt[2]*x + x^2]/(4*Sqrt[2]) + Log[1 + Sqrt[2]*x + x^2]/(4*Sqrt[2])}
{x^2/(1+x^4), x, 11, -(ArcTan[1 - Sqrt[2]*x]/(2*Sqrt[2])) + ArcTan[1 + Sqrt[2]*x]/(2*Sqrt[2]) + Log[1 - Sqrt[2]*x + x^2]/(4*Sqrt[2]) - Log[1 + Sqrt[2]*x + x^2]/(4*Sqrt[2])}
{1/(1+x^2+x^4), x, 11, -(ArcTan[(1 - 2*x)/Sqrt[3]]/(2*Sqrt[3])) + ArcTan[(1 + 2*x)/Sqrt[3]]/(2*Sqrt[3]) - (1/4)*Log[1 - x + x^2] + (1/4)*Log[1 + x + x^2]}
...
{1/(x^4+x^2+2), x, 11, (-(1/2))*Sqrt[(1/14)*(-1 + 2*Sqrt[2])]*ArcTan[(Sqrt[-1 + 2*Sqrt[2]] - 2*x)/Sqrt[1 + 2*Sqrt[2]]] + (1/2)*Sqrt[(1/14)*(-1 + 2*Sqrt[2])]*ArcTan[(Sqrt[-1 + 2*Sqrt[2]] + 2*x)/Sqrt[1 + 2*Sqrt[2]]] - Log[Sqrt[2] - Sqrt[-1 + 2*Sqrt[2]]*x + x^2]/(4*Sqrt[2*(-1 + 2*Sqrt[2])]) + Log[Sqrt[2] + Sqrt[-1 + 2*Sqrt[2]]*x + x^2]/(4*Sqrt[2*(-1 + 2*Sqrt[2])])}
{1/(x^4-x^2+2), x, 11, (-(1/2))*Sqrt[(1/14)*(1 + 2*Sqrt[2])]*ArcTan[(Sqrt[1 + 2*Sqrt[2]] - 2*x)/Sqrt[-1 + 2*Sqrt[2]]] + (1/2)*Sqrt[(1/14)*(1 + 2*Sqrt[2])]*ArcTan[(Sqrt[1 + 2*Sqrt[2]] + 2*x)/Sqrt[-1 + 2*Sqrt[2]]] - Log[Sqrt[2] - Sqrt[1 + 2*Sqrt[2]]*x + x^2]/(4*Sqrt[2*(1 + 2*Sqrt[2])]) + Log[Sqrt[2] + Sqrt[1 + 2*Sqrt[2]]*x + x^2]/(4*Sqrt[2*(1 + 2*Sqrt[2])])}
{1/(x^6-1), x, 12, ArcTan[(1 - 2*x)/Sqrt[3]]/(2*Sqrt[3]) - ArcTan[(1 + 2*x)/Sqrt[3]]/(2*Sqrt[3]) - ArcTanh[x]/3 + (1/12)*Log[1 - x + x^2] - (1/12)*Log[1 + x + x^2]}
{1/(x^6-2), x, 12, ArcTan[(1 - 2^(5/6)*x)/Sqrt[3]]/(2*2^(5/6)*Sqrt[3]) - ArcTan[(1 + 2^(5/6)*x)/Sqrt[3]]/(2*2^(5/6)*Sqrt[3]) - ArcTanh[x/2^(1/6)]/(3*2^(5/6)) + Log[2^(1/3) - 2^(1/6)*x + x^2]/(12*2^(5/6)) - Log[2^(1/3) + 2^(1/6)*x + x^2]/(12*2^(5/6))}
{1/(x^6+2), x, 12, ArcTan[x/2^(1/6)]/(3*2^(5/6)) - ArcTan[Sqrt[3] - 2^(5/6)*x]/(6*2^(5/6)) + ArcTan[Sqrt[3] + 2^(5/6)*x]/(6*2^(5/6)) - Log[2^(1/3) - 2^(1/6)*Sqrt[3]*x + x^2]/(4*2^(5/6)*Sqrt[3]) + Log[2^(1/3) + 2^(1/6)*Sqrt[3]*x + x^2]/(4*2^(5/6)*Sqrt[3])}
{1/(x^8+1), x, 23, -(ArcTan[(Sqrt[2 - Sqrt[2]] - 2*x)/Sqrt[2 + Sqrt[2]]]/(4*Sqrt[2*(2 - Sqrt[2])])) - ArcTan[(Sqrt[2 + Sqrt[2]] - 2*x)/Sqrt[2 - Sqrt[2]]]/(4*Sqrt[2*(2 + Sqrt[2])]) + ArcTan[(Sqrt[2 - Sqrt[2]] + 2*x)/Sqrt[2 + Sqrt[2]]]/(4*Sqrt[2*(2 - Sqrt[2])]) + ArcTan[(Sqrt[2 + Sqrt[2]] + 2*x)/Sqrt[2 - Sqrt[2]]]/(4*Sqrt[2*(2 + Sqrt[2])]) - (1/16)*Sqrt[2 - Sqrt[2]]*Log[1 - Sqrt[2 - Sqrt[2]]*x + x^2] + (1/16)*Sqrt[2 - Sqrt[2]]*Log[1 + Sqrt[2 - Sqrt[2]]*x + x^2] - (1/16)*Sqrt[2 + Sqrt[2]]*Log[1 - Sqrt[2 + Sqrt[2]]*x + x^2] + (1/16)*Sqrt[2 + Sqrt[2]]*Log[1 + Sqrt[2 + Sqrt[2]]*x + x^2]}
{1/(x^8-1), x, 15, -(ArcTan[x]/4) + ArcTan[1 - Sqrt[2]*x]/(4*Sqrt[2]) - ArcTan[1 + Sqrt[2]*x]/(4*Sqrt[2]) - ArcTanh[x]/4 + Log[1 - Sqrt[2]*x + x^2]/(8*Sqrt[2]) - Log[1 + Sqrt[2]*x + x^2]/(8*Sqrt[2])}
{1/(x^8-x^4+1), x, 23, -(ArcTan[(Sqrt[2 - Sqrt[3]] - 2*x)/Sqrt[2 + Sqrt[3]]]/(2*Sqrt[6])) - ArcTan[(Sqrt[2 + Sqrt[3]] - 2*x)/Sqrt[2 - Sqrt[3]]]/(2*Sqrt[6]) + ArcTan[(Sqrt[2 - Sqrt[3]] + 2*x)/Sqrt[2 + Sqrt[3]]]/(2*Sqrt[6]) + ArcTan[(Sqrt[2 + Sqrt[3]] + 2*x)/Sqrt[2 - Sqrt[3]]]/(2*Sqrt[6]) - Log[1 - Sqrt[2 - Sqrt[3]]*x + x^2]/(4*Sqrt[6]) + Log[1 + Sqrt[2 - Sqrt[3]]*x + x^2]/(4*Sqrt[6]) - Log[1 - Sqrt[2 + Sqrt[3]]*x + x^2]/(4*Sqrt[6]) + Log[1 + Sqrt[2 + Sqrt[3]]*x + x^2]/(4*Sqrt[6])}
{x^7/(x^12+1), x, 8, -(ArcTan[(1 - 2*x^4)/Sqrt[3]]/(4*Sqrt[3])) - (1/12)*Log[1 + x^4] + (1/24)*Log[1 - x^4 + x^8]}
...
{x^2*Log[x], x, 2, -(x^3/9) + (1/3)*x^3*Log[x]}
{x^p*Log[x], x, 2, -(x^(1 + p)/(1 + p)^2) + (x^(1 + p)*Log[x])/(1 + p)}
{(Log[x])^2, x, 2, 2*x - 2*x*Log[x] + x*Log[x]^2}
{x^9*Log[x]^11, x, 12, -((6237*x^10)/156250000) + (6237*x^10*Log[x])/15625000 - (6237*x^10*Log[x]^2)/3125000 + (2079*x^10*Log[x]^3)/312500 - (2079*x^10*Log[x]^4)/125000 + (2079*x^10*Log[x]^5)/62500 - (693*x^10*Log[x]^6)/12500 + (99*x^10*Log[x]^7)/1250 - (99*x^10*Log[x]^8)/1000 + (11/100)*x^10*Log[x]^9 - (11/100)*x^10*Log[x]^10 + (1/10)*x^10*Log[x]^11}
{Log[x]^2/x, x, 1, Log[x]^3/3}
{1/Log[x], x, 1, LogIntegral[x]}
{1/Log[x+1], x, 1, LogIntegral[1 + x]}
{1/(x*Log[x]), x, 1, Log[Log[x]]}
{1/(x*Log[x])^2, x, 2, -ExpIntegralEi[-Log[x]] - 1/(x*Log[x])}
{(Log[x])^p/x, x, 1, Log[x]^(1 + p)/(1 + p)}
{Log[x] *(a*x+b), x, 3, (-b)*x - (a*x^2)/4 - (b^2*Log[x])/(2*a) + ((b + a*x)^2*Log[x])/(2*a)}
{(a*x+b)^2*Log[x], x, 3, (-b^2)*x - (1/2)*a*b*x^2 - (a^2*x^3)/9 - (b^3*Log[x])/(3*a) + ((b + a*x)^3*Log[x])/(3*a)}
{Log[x]/(a*x+b)^2, x, 4, Log[x]/(a*b) - Log[x]/(a*(b + a*x)) - Log[b + a*x]/(a*b)}
...
{x*Log[x^2+a^2], x, 2, -(x^2/2) + (1/2)*(a^2 + x^2)*Log[a^2 + x^2]}
...
{Log[Log[Log[Log[x]]]], x, 0, Int[Log[Log[Log[Log[x]]]], x]}
...
{x*Cos[k/Sin[x]]*Cos[x]/Sin[x]^2, x, 0, Int[x*Cos[k*Csc[x]]*Cot[x]*Csc[x], x]}
...
{Sqrt[a+b*x]*Sqrt[c+d*x], x, 4, ((b*c - a*d)*Sqrt[a + b*x]*Sqrt[c + d*x])/(4*b*d) + ((a + b*x)^(3/2)*Sqrt[c + d*x])/(2*b) - ((b*c - a*d)^2*ArcTanh[(Sqrt[d]*Sqrt[a + b*x])/(Sqrt[b]*Sqrt[c + d*x])])/(4*b^(3/2)*d^(3/2))}
...
{ArcTan[(-Sqrt[2]+2*x)/Sqrt[2]], x, 7, ArcTan[1 - Sqrt[2]*x]/Sqrt[2] - x*ArcTan[1 - Sqrt[2]*x] - Log[1 - Sqrt[2]*x + x^2]/(2*Sqrt[2])}
...
{(-2*Sqrt[1 + x^3] + 5*x^4*Sqrt[1 + x^3] - 3*x^2*Sqrt[1 - 2*x + x^5])/(2*Sqrt[1 + x^3]*Sqrt[1 - 2*x + x^5]), x, -4, -Sqrt[1 + x^3] + Sqrt[1 - 2*x + x^5]}
...
{Log[x^2]/x^3, x, 2, -(1/(2*x^2)) - Log[x^2]/(2*x^2)}
...
{x*Log[x^2+a], x, 2, -(x^2/2) + (1/2)*(a + x^2)*Log[a + x^2]}
...
{b^x, x, 1, b^x/Log[b]}
{(x^4+x^(-4)+2)^(1/2), x, 2, (1/3)*x*Sqrt[2 + 1/x^4 + x^4] - (4*x*Sqrt[2 + 1/x^4 + x^4])/(3*(1 + x^4))}
...
{x/(x^3-1), x, 7, ArcTan[(1 + 2*x)/Sqrt[3]]/Sqrt[3] + (1/3)*Log[1 - x] - (1/6)*Log[1 + x + x^2]}
{x/(x^4-1), x, 2, (-(1/2))*ArcTanh[x^2]}
{Log[x]*(x^3+1)/(x^4+2), x, 10, (1/8)*(2 - (-2)^(1/4))*Log[-(((-1)^(3/4)*((-2)^(1/4) - x))/2^(1/4))]*Log[x] + (1/8)*(2 + I*(-2)^(1/4))*Log[-(((-1)^(3/4)*((-2)^(1/4) - I*x))/2^(1/4))]*Log[x] + (1/16)*(4 + (1 - I)*2^(3/4))*Log[-(((-1)^(3/4)*((-2)^(1/4) + I*x))/2^(1/4))]*Log[x] + (1/8)*(2 + (-2)^(1/4))*Log[x]*Log[-(((-1)^(3/4)*((-2)^(1/4) + x))/2^(1/4))] + (1/16)*(4 + (1 - I)*2^(3/4))*PolyLog[2, -(((1 + I)*x)/2^(3/4))] + (1/8)*(2 + I*(-2)^(1/4))*PolyLog[2, ((1 + I)*x)/2^(3/4)] + (1/8)*(2 - (-2)^(1/4))*PolyLog[2, -(((-1)^(3/4)*x)/2^(1/4))] + (1/8)*(2 + (-2)^(1/4))*PolyLog[2, ((-1)^(3/4)*x)/2^(1/4)]}
{Log[x]+Log[x+1]+Log[x+2], x, 4, -3*x + x*Log[x] + (1 + x)*Log[1 + x] + (2 + x)*Log[2 + x]}
{1/(x^3+5), x, 7, -(ArcTan[(5^(1/3) - 2*x)/(Sqrt[3]*5^(1/3))]/(Sqrt[3]*5^(2/3))) + Log[5^(1/3) + x]/(3*5^(2/3)) - Log[5^(2/3) - 5^(1/3)*x + x^2]/(6*5^(2/3))}
{1/Sqrt[1+x^2], x, 1, ArcSinh[x]}
...
{1/(x^8-2*x^7+2*x^6-2*x^5+x^4), x, 4, 1/(2*(1 - x)) - 1/(3*x^3) - 1/x^2 - 2/x - (5/2)*Log[1 - x] + 2*Log[x] + (1/4)*Log[1 + x^2]}
{(a*x^3+b*x^2+c*x+d)/((x+1)*x*(x-3)), x, 2, a*x + (1/12)*(27*a + 9*b + 3*c + d)*Log[3 - x] - (1/3)*d*Log[x] - (1/4)*(a - b + c - d)*Log[1 + x]}
{1/(2-Log[x^2+1])^5, x, 0, Int[1/(2 - Log[1 + x^2])^5, x]}
...
{Sqrt[-4*Sqrt[2] + 9]*x - Sqrt[x^4 + 2*x^2 + 4*x + 1]*Sqrt[2], x, 1, (1/2)*Sqrt[9 - 4*Sqrt[2]]*x^2 - Sqrt[2]*Int[Sqrt[1 + 4*x + 2*x^2 + x^4], x]}
...
{(7*x^13+10*x^8+4*x^7-7*x^6-4*x^3-4*x^2+3*x+3)/(x^14-2*x^8-2*x^7-2*x^4-4*x^3-x^2+2*x+1), x, -2, (1/2)*((1 + Sqrt[2])*Log[1 + x + Sqrt[2]*x + Sqrt[2]*x^2 - x^7] - (-1 + Sqrt[2])*Log[-1 + (-1 + Sqrt[2])*x + Sqrt[2]*x^2 + x^7])}
