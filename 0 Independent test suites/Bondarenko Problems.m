...
{Sqrt[Sqrt[2] + Sqrt[x] + Sqrt[2 + Sqrt[8]*Sqrt[x] + 2*x]], x, 3, (2*Sqrt[2]*Sqrt[Sqrt[2] + Sqrt[x] + Sqrt[2]*Sqrt[1 + Sqrt[2]*Sqrt[x] + x]]*(4 + Sqrt[2]*Sqrt[x] + 3*Sqrt[2]*x^(3/2) - Sqrt[2]*(2*Sqrt[2] - Sqrt[x])*Sqrt[1 + Sqrt[2]*Sqrt[x] + x]))/(15*Sqrt[x])}
...
{1/(Cos[x] + Cos[3*x])^5, x, -57, (-(523/256))*ArcTanh[Sin[x]] + (1483*ArcTanh[Sqrt[2]*Sin[x]])/(512*Sqrt[2]) + Sin[x]/(32*(1 - 2*Sin[x]^2)^4) - (17*Sin[x])/(192*(1 - 2*Sin[x]^2)^3) + (203*Sin[x])/(768*(1 - 2*Sin[x]^2)^2) - (437*Sin[x])/(512*(1 - 2*Sin[x]^2)) - (43/256)*Sec[x]*Tan[x] - (1/128)*Sec[x]^3*Tan[x]}
...
{Log[x^2 + Sqrt[1 - x^2]], x, -34, -2*x - ArcSin[x] + Sqrt[(1/2)*(1 + Sqrt[5])]*ArcTan[Sqrt[2/(1 + Sqrt[5])]*x] + Sqrt[(1/2)*(1 + Sqrt[5])]*ArcTan[(Sqrt[(1/2)*(1 + Sqrt[5])]*x)/Sqrt[1 - x^2]] + Sqrt[(1/2)*(-1 + Sqrt[5])]*ArcTanh[Sqrt[2/(-1 + Sqrt[5])]*x] - Sqrt[(1/2)*(-1 + Sqrt[5])]*ArcTanh[(Sqrt[(1/2)*(-1 + Sqrt[5])]*x)/Sqrt[1 - x^2]] + x*Log[x^2 + Sqrt[1 - x^2]]}
{Log[1 + Exp[x]]/(1 + Exp[2*x]), x, 10, (-(1/2))*Log[(1/2 - I/2)*(I - E^x)]*Log[1 + E^x] - (1/2)*Log[(-(1/2) - I/2)*(I + E^x)]*Log[1 + E^x] - PolyLog[2, -E^x] - (1/2)*PolyLog[2, (1/2 - I/2)*(1 + E^x)] - (1/2)*PolyLog[2, (1/2 + I/2)*(1 + E^x)]}
{Log[1 + Cosh[x]^2]^2*Cosh[x], x, 12, -8*Sqrt[2]*ArcTan[Sinh[x]/Sqrt[2]] + 4*I*Sqrt[2]*ArcTan[Sinh[x]/Sqrt[2]]^2 + 8*Sqrt[2]*ArcTan[Sinh[x]/Sqrt[2]]*Log[(4*I)/(2*I - Sqrt[2]*Sinh[x])] + 4*Sqrt[2]*ArcTan[Sinh[x]/Sqrt[2]]*Log[2 + Sinh[x]^2] + 4*I*Sqrt[2]*PolyLog[2, -((2*I + Sqrt[2]*Sinh[x])/(2*I - Sqrt[2]*Sinh[x]))] + 8*Sinh[x] - 4*Log[2 + Sinh[x]^2]*Sinh[x] + Log[2 + Sinh[x]^2]^2*Sinh[x]}
{Log[Sinh[x] + Cosh[x]^2]^2*Cosh[x], x, 26, -4*Sqrt[3]*ArcTan[(1 + 2*Sinh[x])/Sqrt[3]] - (1/2)*(1 - I*Sqrt[3])*Log[1 - I*Sqrt[3] + 2*Sinh[x]]^2 - (1 + I*Sqrt[3])*Log[(I*(1 - I*Sqrt[3] + 2*Sinh[x]))/(2*Sqrt[3])]*Log[1 + I*Sqrt[3] + 2*Sinh[x]] - (1/2)*(1 + I*Sqrt[3])*Log[1 + I*Sqrt[3] + 2*Sinh[x]]^2 - (1 - I*Sqrt[3])*Log[1 - I*Sqrt[3] + 2*Sinh[x]]*Log[-((I*(1 + I*Sqrt[3] + 2*Sinh[x]))/(2*Sqrt[3]))] - 2*Log[1 + Sinh[x] + Sinh[x]^2] + (1 - I*Sqrt[3])*Log[1 - I*Sqrt[3] + 2*Sinh[x]]*Log[1 + Sinh[x] + Sinh[x]^2] + (1 + I*Sqrt[3])*Log[1 + I*Sqrt[3] + 2*Sinh[x]]*Log[1 + Sinh[x] + Sinh[x]^2] - (1 - I*Sqrt[3])*PolyLog[2, (I*(1 - I*Sqrt[3] + 2*Sinh[x]))/(2*Sqrt[3])] - (1 + I*Sqrt[3])*PolyLog[2, -((I*(1 + I*Sqrt[3] + 2*Sinh[x]))/(2*Sqrt[3]))] + 8*Sinh[x] - 4*Log[1 + Sinh[x] + Sinh[x]^2]*Sinh[x] + Log[1 + Sinh[x] + Sinh[x]^2]^2*Sinh[x]}
{Log[x + Sqrt[1 + x]]/(1 + x^2), x, 36, (1/2)*I*Log[Sqrt[1 - I] - Sqrt[1 + x]]*Log[x + Sqrt[1 + x]] - (1/2)*I*Log[Sqrt[1 + I] - Sqrt[1 + x]]*Log[x + Sqrt[1 + x]] + (1/2)*I*Log[Sqrt[1 - I] + Sqrt[1 + x]]*Log[x + Sqrt[1 + x]] - (1/2)*I*Log[Sqrt[1 + I] + Sqrt[1 + x]]*Log[x + Sqrt[1 + x]] - (1/2)*I*Log[Sqrt[1 - I] + Sqrt[1 + x]]*Log[(1 - Sqrt[5] + 2*Sqrt[1 + x])/(1 - 2*Sqrt[1 - I] - Sqrt[5])] - (1/2)*I*Log[Sqrt[1 - I] - Sqrt[1 + x]]*Log[(1 - Sqrt[5] + 2*Sqrt[1 + x])/(1 + 2*Sqrt[1 - I] - Sqrt[5])] + (1/2)*I*Log[Sqrt[1 + I] + Sqrt[1 + x]]*Log[(1 - Sqrt[5] + 2*Sqrt[1 + x])/(1 - 2*Sqrt[1 + I] - Sqrt[5])] + (1/2)*I*Log[Sqrt[1 + I] - Sqrt[1 + x]]*Log[(1 - Sqrt[5] + 2*Sqrt[1 + x])/(1 + 2*Sqrt[1 + I] - Sqrt[5])] - (1/2)*I*Log[Sqrt[1 - I] + Sqrt[1 + x]]*Log[(1 + Sqrt[5] + 2*Sqrt[1 + x])/(1 - 2*Sqrt[1 - I] + Sqrt[5])] - (1/2)*I*Log[Sqrt[1 - I] - Sqrt[1 + x]]*Log[(1 + Sqrt[5] + 2*Sqrt[1 + x])/(1 + 2*Sqrt[1 - I] + Sqrt[5])] + (1/2)*I*Log[Sqrt[1 + I] + Sqrt[1 + x]]*Log[(1 + Sqrt[5] + 2*Sqrt[1 + x])/(1 - 2*Sqrt[1 + I] + Sqrt[5])] + (1/2)*I*Log[Sqrt[1 + I] - Sqrt[1 + x]]*Log[(1 + Sqrt[5] + 2*Sqrt[1 + x])/(1 + 2*Sqrt[1 + I] + Sqrt[5])] - (1/2)*I*PolyLog[2, (2*(Sqrt[1 - I] - Sqrt[1 + x]))/(1 + 2*Sqrt[1 - I] - Sqrt[5])] - (1/2)*I*PolyLog[2, (2*(Sqrt[1 - I] - Sqrt[1 + x]))/(1 + 2*Sqrt[1 - I] + Sqrt[5])] + (1/2)*I*PolyLog[2, (2*(Sqrt[1 + I] - Sqrt[1 + x]))/(1 + 2*Sqrt[1 + I] - Sqrt[5])] + (1/2)*I*PolyLog[2, (2*(Sqrt[1 + I] - Sqrt[1 + x]))/(1 + 2*Sqrt[1 + I] + Sqrt[5])] - (1/2)*I*PolyLog[2, -((2*(Sqrt[1 - I] + Sqrt[1 + x]))/(1 - 2*Sqrt[1 - I] - Sqrt[5]))] - (1/2)*I*PolyLog[2, -((2*(Sqrt[1 - I] + Sqrt[1 + x]))/(1 - 2*Sqrt[1 - I] + Sqrt[5]))] + (1/2)*I*PolyLog[2, -((2*(Sqrt[1 + I] + Sqrt[1 + x]))/(1 - 2*Sqrt[1 + I] - Sqrt[5]))] + (1/2)*I*PolyLog[2, -((2*(Sqrt[1 + I] + Sqrt[1 + x]))/(1 - 2*Sqrt[1 + I] + Sqrt[5]))]}
{Log[x + Sqrt[1 + x]]^2/(1 + x)^2, x, 31, Log[1 + x] + (2*Log[x + Sqrt[1 + x]])/Sqrt[1 + x] - 6*Log[Sqrt[1 + x]]*Log[x + Sqrt[1 + x]] - Log[x + Sqrt[1 + x]]^2/(1 + x) - (1 + Sqrt[5])*Log[1 - Sqrt[5] + 2*Sqrt[1 + x]] - (3 - Sqrt[5])*Log[2*Sqrt[5]]*Log[1 - Sqrt[5] + 2*Sqrt[1 + x]] + 6*Log[(1/2)*(-1 + Sqrt[5])]*Log[1 - Sqrt[5] + 2*Sqrt[1 + x]] + (3 + Sqrt[5])*Log[x + Sqrt[1 + x]]*Log[1 - Sqrt[5] + 2*Sqrt[1 + x]] - (1/2)*(3 + Sqrt[5])*Log[1 - Sqrt[5] + 2*Sqrt[1 + x]]^2 - (1 - Sqrt[5])*Log[1 + Sqrt[5] + 2*Sqrt[1 + x]] + (3 - Sqrt[5])*Log[x + Sqrt[1 + x]]*Log[1 + Sqrt[5] + 2*Sqrt[1 + x]] - (1/2)*(3 - Sqrt[5])*Log[1 + Sqrt[5] + 2*Sqrt[1 + x]]^2 - (3 + Sqrt[5])*Log[1 - Sqrt[5] + 2*Sqrt[1 + x]]*Log[(1 + Sqrt[5] + 2*Sqrt[1 + x])/(2*Sqrt[5])] + 6*Log[Sqrt[1 + x]]*Log[(1 + Sqrt[5] + 2*Sqrt[1 + x])/(1 + Sqrt[5])] + 6*PolyLog[2, -((2*Sqrt[1 + x])/(1 + Sqrt[5]))] + (3 - Sqrt[5])*PolyLog[2, -((1 - Sqrt[5] + 2*Sqrt[1 + x])/(2*Sqrt[5]))] - (3 + Sqrt[5])*PolyLog[2, -((1 - Sqrt[5] + 2*Sqrt[1 + x])/(2*Sqrt[5]))] - 6*PolyLog[2, (1 - Sqrt[5] + 2*Sqrt[1 + x])/(1 - Sqrt[5])]}
{Log[x + Sqrt[1 + x]]/x, x, 17, Log[1 - Sqrt[1 + x]]*Log[x + Sqrt[1 + x]] + Log[1 + Sqrt[1 + x]]*Log[x + Sqrt[1 + x]] - Log[(1/2)*(3 - Sqrt[5])]*Log[1 - Sqrt[5] + 2*Sqrt[1 + x]] - Log[(1/2)*(1 + Sqrt[5])]*Log[1 - Sqrt[5] + 2*Sqrt[1 + x]] - Log[(1/2)*(3 + Sqrt[5])]*Log[1 + Sqrt[5] + 2*Sqrt[1 + x]] - Log[1 + Sqrt[1 + x]]*Log[-((1 + Sqrt[5] + 2*Sqrt[1 + x])/(1 - Sqrt[5]))] - PolyLog[2, (2*(1 + Sqrt[1 + x]))/(1 - Sqrt[5])] + PolyLog[2, (1 - Sqrt[5] + 2*Sqrt[1 + x])/(3 - Sqrt[5])] + PolyLog[2, -((1 - Sqrt[5] + 2*Sqrt[1 + x])/(1 + Sqrt[5]))] + PolyLog[2, (1 + Sqrt[5] + 2*Sqrt[1 + x])/(3 + Sqrt[5])]}
