...
{(x + 1)/(x^2 + 2*x + 2)^3, x, 2, -(1/(4*(2 + 2*x + x^2)^2))}
...
{Sin[Sqrt[x + 1]]/Sqrt[x + 1], x, 2, -2*Cos[Sqrt[1 + x]]}
...
{x/Sqrt[1 + x^2 + (1 + x^2)^(3/2)], x, 4, (2*Sqrt[1 + x^2 + (1 + x^2)^(3/2)])/Sqrt[1 + x^2]}
{x/(Sqrt[1 + x^2]*Sqrt[1 + Sqrt[1 + x^2]]), x, 1, 2*Sqrt[1 + Sqrt[1 + x^2]]}
{(x^2 + 1 - 2*x)^(1/5)/(1 - x), x, 1, (-(5/2))*(1 - 2*x + x^2)^(1/5)}
...
{Sin[(x - 1)^(1/4)], x, 6, 24*(-1 + x)^(1/4)*Cos[(-1 + x)^(1/4)] - 4*(-1 + x)^(3/4)*Cos[(-1 + x)^(1/4)] - 24*Sin[(-1 + x)^(1/4)] + 12*Sqrt[-1 + x]*Sin[(-1 + x)^(1/4)]}
...
{((a + x)/(a - x))^(1/2), x, 3, -((2*a*Sqrt[(a + x)/(a - x)])/(1 + (a + x)/(a - x))) + 2*a*ArcTan[Sqrt[(a + x)/(a - x)]]}
...
{(3*x^2 + 2*x - 2)/(x^3 - 1), x, 6, (4*ArcTan[(1 + 2*x)/Sqrt[3]])/Sqrt[3] + Log[1 - x^3]}
...
{(x - 3)/(x^3 + 3*x^2 + 2*x), x, 6, -((3*Log[x])/2) + 4*Log[1 + x] - (5/2)*Log[2 + x]}
{1/(x^2 - 1)^2, x, 2, x/(2*(1 - x^2)) + ArcTanh[x]/2}
{(x + 1)/(x^3 - 1), x, 4, (2/3)*Log[1 - x] - (1/3)*Log[1 + x + x^2]}
...
{1/(x^4 + 1), x, 11, -(ArcTan[1 - Sqrt[2]*x]/(2*Sqrt[2])) + ArcTan[1 + Sqrt[2]*x]/(2*Sqrt[2]) - Log[1 - Sqrt[2]*x + x^2]/(4*Sqrt[2]) + Log[1 + Sqrt[2]*x + x^2]/(4*Sqrt[2])}
...
{Sin[x]^2/(1 + Sin[x]^2), x, 4, x - x/Sqrt[2] - ArcTan[(Cos[x]*Sin[x])/(1 + Sqrt[2] + Sin[x]^2)]/Sqrt[2]}
...
{1/Log[t]^(n + 1), t, 1, Gamma[-n, -Log[t]]*(-Log[t])^(1 + n)*Log[t]^(-1 - n)}
