...
{ArcTan[x + Sqrt[1 - x^2]], x, -44, -(ArcSin[x]/2) + (1/4)*Sqrt[3]*ArcTan[(-1 + Sqrt[3]*x)/Sqrt[1 - x^2]] + (1/4)*Sqrt[3]*ArcTan[(1 + Sqrt[3]*x)/Sqrt[1 - x^2]] - (1/4)*Sqrt[3]*ArcTan[(-1 + 2*x^2)/Sqrt[3]] + x*ArcTan[x + Sqrt[1 - x^2]] - (1/4)*ArcTanh[x*Sqrt[1 - x^2]] - (1/8)*Log[1 - x^2 + x^4]}
...
{x*ArcTan[x + Sqrt[1 - x^2]]/Sqrt[1 - x^2], x, -33, -(ArcSin[x]/2) + (1/4)*Sqrt[3]*ArcTan[(-1 + Sqrt[3]*x)/Sqrt[1 - x^2]] + (1/4)*Sqrt[3]*ArcTan[(1 + Sqrt[3]*x)/Sqrt[1 - x^2]] - (1/4)*Sqrt[3]*ArcTan[(-1 + 2*x^2)/Sqrt[3]] - Sqrt[1 - x^2]*ArcTan[x + Sqrt[1 - x^2]] + (1/4)*ArcTanh[x*Sqrt[1 - x^2]] + (1/8)*Log[1 - x^2 + x^4]}
...
{x^3*(ArcSec[x]/Sqrt[x^4 - 1]), x, 6, -(Sqrt[-1 + x^4]/(2*Sqrt[1 - 1/x^2]*x)) + (1/2)*Sqrt[-1 + x^4]*ArcSec[x] + (1/2)*ArcTanh[(Sqrt[1 - 1/x^2]*x)/Sqrt[-1 + x^4]], -((x*Sqrt[-1 + x^4])/(2*Sqrt[x^2]*Sqrt[-1 + x^2])) + (1/2)*Sqrt[-1 + x^4]*ArcSec[x] + (x*ArcTanh[Sqrt[-1 + x^4]/Sqrt[-1 + x^2]])/(2*Sqrt[x^2])}
...
{Sec[x]/Sqrt[Sec[x]^4 - 1], x, -6, -(ArcTanh[(Cos[x]*Cot[x]*Sqrt[Sec[x]^4 - 1])/Sqrt[2]]/Sqrt[2])}
...
{Sin[x]/Sqrt[1 - Sin[x]^6], x, -5, ArcTanh[(Sqrt[3]*Cos[x]*(1 + Sin[x]^2))/(2*Sqrt[1 - Sin[x]^6])]/(2*Sqrt[3])}
...
{x*Log[x^2 + 1]*ArcTan[x]^2, x, 12, 3*x*ArcTan[x] - (3*ArcTan[x]^2)/2 - (1/2)*x^2*ArcTan[x]^2 - (3/2)*Log[1 + x^2] - x*ArcTan[x]*Log[1 + x^2] + (1/2)*(1 + x^2)*ArcTan[x]^2*Log[1 + x^2] + (1/4)*Log[1 + x^2]^2}
...
{ArcTan[x*Sqrt[1 + x^2]], x, 14, x*ArcTan[x*Sqrt[1 + x^2]] + (1/2)*ArcTan[Sqrt[3] - 2*Sqrt[1 + x^2]] - (1/2)*ArcTan[Sqrt[3] + 2*Sqrt[1 + x^2]] - (1/4)*Sqrt[3]*Log[2 + x^2 - Sqrt[3]*Sqrt[1 + x^2]] + (1/4)*Sqrt[3]*Log[2 + x^2 + Sqrt[3]*Sqrt[1 + x^2]]}
