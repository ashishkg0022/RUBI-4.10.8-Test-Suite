...
{x^2*E^ArcTanh[a*x]/(c - a^2*c*x^2), x, 5, Sqrt[1 - a^2*x^2]/(a^3*c) + Sqrt[1 - a^2*x^2]/(a^3*c*(1 - a*x)) - ArcSin[a*x]/(a^3*c)}
...
{x^3*E^ArcTanh[a*x]/(c - a^2*c*x^2)^3, x, 4, 1/(5*a^4*c^3*(1 - a^2*x^2)^(5/2)) + (a*x^5)/(5*c^3*(1 - a^2*x^2)^(5/2)) - 1/(3*a^4*c^3*(1 - a^2*x^2)^(3/2)), (x^3*(1 + a*x))/(5*a*c^3*(1 - a^2*x^2)^(5/2)) + (x^2*(1 - 3*a*x))/(15*a^2*c^3*(1 - a^2*x^2)^(3/2)) - 2/(15*a^4*c^3*Sqrt[1 - a^2*x^2])}
...
{E^ArcTanh[a*x]*(c - a^2*c*x^2)^(3/2), x, 4, (c*x*Sqrt[c - a^2*c*x^2])/Sqrt[1 - a^2*x^2] + (a*c*x^2*Sqrt[c - a^2*c*x^2])/(2*Sqrt[1 - a^2*x^2]) - (a^2*c*x^3*Sqrt[c - a^2*c*x^2])/(3*Sqrt[1 - a^2*x^2]) - (a^3*c*x^4*Sqrt[c - a^2*c*x^2])/(4*Sqrt[1 - a^2*x^2])}
...
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(1/2)*x^3, x, 13, -((2*Sqrt[c - a^2*c*x^2])/a^4) - (3*x*Sqrt[c - a^2*c*x^2])/(4*a^3) - (x^3*Sqrt[c - a^2*c*x^2])/(2*a) + (c - a^2*c*x^2)^(3/2)/(a^4*c) - (c - a^2*c*x^2)^(5/2)/(5*a^4*c^2) + (3*Sqrt[c]*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]])/(4*a^4)}
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(1/2)*x^2, x, 13, -((2*Sqrt[c - a^2*c*x^2])/a^3) - (7*x*Sqrt[c - a^2*c*x^2])/(8*a^2) - (1/4)*x^3*Sqrt[c - a^2*c*x^2] + (2*(c - a^2*c*x^2)^(3/2))/(3*a^3*c) + (7*Sqrt[c]*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]])/(8*a^3)}
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(1/2)*x^1, x, 6, -(Sqrt[c - a^2*c*x^2]/a^2) - ((1 + a*x)*Sqrt[c - a^2*c*x^2])/(3*a^2) - ((1 + a*x)^2*Sqrt[c - a^2*c*x^2])/(3*a^2) + (Sqrt[c]*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]])/a^2}
...
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(1/2)/x^1, x, 9, -Sqrt[c - a^2*c*x^2] + 2*Sqrt[c]*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]] - Sqrt[c]*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]]}
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(1/2)/x^2, x, 9, -(Sqrt[c - a^2*c*x^2]/x) + a*Sqrt[c]*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]] - 2*a*Sqrt[c]*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]]}
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(1/2)/x^3, x, 11, -(Sqrt[c - a^2*c*x^2]/(2*x^2)) - (2*a*Sqrt[c - a^2*c*x^2])/x - (3/2)*a^2*Sqrt[c]*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]]}
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(1/2)/x^4, x, 10, -(Sqrt[c - a^2*c*x^2]/(3*x^3)) - (a*Sqrt[c - a^2*c*x^2])/x^2 - (5*a^2*Sqrt[c - a^2*c*x^2])/(3*x) - a^3*Sqrt[c]*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]]}
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(1/2)/x^5, x, 14, -(Sqrt[c - a^2*c*x^2]/(4*x^4)) - (2*a*Sqrt[c - a^2*c*x^2])/(3*x^3) - (7*a^2*Sqrt[c - a^2*c*x^2])/(8*x^2) - (4*a^3*Sqrt[c - a^2*c*x^2])/(3*x) - (7/8)*a^4*Sqrt[c]*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]]}


{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(3/2)*x^3, x, 14, -((c*x*Sqrt[c - a^2*c*x^2])/(8*a^3)) - (c*x^3*Sqrt[c - a^2*c*x^2])/(12*a) + (1/3)*a*c*x^5*Sqrt[c - a^2*c*x^2] - (2*(c - a^2*c*x^2)^(3/2))/(3*a^4) + (3*(c - a^2*c*x^2)^(5/2))/(5*a^4*c) - (c - a^2*c*x^2)^(7/2)/(7*a^4*c^2) + (c^(3/2)*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]])/(8*a^4)}
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(3/2)*x^2, x, 15, -((3*c*x*Sqrt[c - a^2*c*x^2])/(16*a^2)) + (5/24)*c*x^3*Sqrt[c - a^2*c*x^2] + (1/6)*a^2*c*x^5*Sqrt[c - a^2*c*x^2] - (2*(c - a^2*c*x^2)^(3/2))/(3*a^3) + (2*(c - a^2*c*x^2)^(5/2))/(5*a^3*c) + (3*c^(3/2)*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]])/(16*a^3)}
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(3/2)*x^1, x, 7, (c*x*Sqrt[c - a^2*c*x^2])/(4*a) - (c - a^2*c*x^2)^(3/2)/(6*a^2) - ((1 + a*x)*(c - a^2*c*x^2)^(3/2))/(10*a^2) - ((1 + a*x)^2*(c - a^2*c*x^2)^(3/2))/(5*a^2) + (c^(3/2)*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]])/(4*a^2)}
...
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(3/2)/x^1, x, 11, c*Sqrt[c - a^2*c*x^2] + a*c*x*Sqrt[c - a^2*c*x^2] - (1/3)*(c - a^2*c*x^2)^(3/2) + c^(3/2)*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]] - c^(3/2)*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]]}
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(3/2)/x^2, x, 13, 2*a*c*Sqrt[c - a^2*c*x^2] - (c*Sqrt[c - a^2*c*x^2])/x + (1/2)*a^2*c*x*Sqrt[c - a^2*c*x^2] - (1/2)*a*c^(3/2)*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]] - 2*a*c^(3/2)*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]]}
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(3/2)/x^3, x, 14, a^2*c*Sqrt[c - a^2*c*x^2] - (c*Sqrt[c - a^2*c*x^2])/(2*x^2) - (2*a*c*Sqrt[c - a^2*c*x^2])/x - 2*a^2*c^(3/2)*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]] - (1/2)*a^2*c^(3/2)*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]]}
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(3/2)/x^4, x, 11, -((a*c*Sqrt[c - a^2*c*x^2])/x^2) - (a^2*c*Sqrt[c - a^2*c*x^2])/x - (c - a^2*c*x^2)^(3/2)/(3*x^3) - a^3*c^(3/2)*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]] + a^3*c^(3/2)*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]]}
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(3/2)/x^5, x, 13, -((c*Sqrt[c - a^2*c*x^2])/(4*x^4)) - (3*a^2*c*Sqrt[c - a^2*c*x^2])/(8*x^2) - (2*a*(c - a^2*c*x^2)^(3/2))/(3*x^3) + (5/8)*a^4*c^(3/2)*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]]}
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(3/2)/x^6, x, 11, -((a*c*Sqrt[c - a^2*c*x^2])/(2*x^4)) + (a^3*c*Sqrt[c - a^2*c*x^2])/(4*x^2) - (c - a^2*c*x^2)^(3/2)/(5*x^5) - (7*a^2*(c - a^2*c*x^2)^(3/2))/(15*x^3) + (1/4)*a^5*c^(3/2)*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]]}
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(3/2)/x^7, x, 16, -((c*Sqrt[c - a^2*c*x^2])/(6*x^6)) - (5*a^2*c*Sqrt[c - a^2*c*x^2])/(24*x^4) + (3*a^4*c*Sqrt[c - a^2*c*x^2])/(16*x^2) - (2*a*(c - a^2*c*x^2)^(3/2))/(5*x^5) - (4*a^3*(c - a^2*c*x^2)^(3/2))/(15*x^3) + (3/16)*a^6*c^(3/2)*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]]}
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(3/2)/x^8, x, 14, -((a*c*Sqrt[c - a^2*c*x^2])/(3*x^6)) + (a^3*c*Sqrt[c - a^2*c*x^2])/(12*x^4) + (a^5*c*Sqrt[c - a^2*c*x^2])/(8*x^2) - (c - a^2*c*x^2)^(3/2)/(7*x^7) - (11*a^2*(c - a^2*c*x^2)^(3/2))/(35*x^5) - (22*a^4*(c - a^2*c*x^2)^(3/2))/(105*x^3) + (1/8)*a^7*c^(3/2)*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]]}


{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(5/2)*x^3, x, 30, -((3*c^2*x*Sqrt[c - a^2*c*x^2])/(64*a^3)) - (c^2*x^3*Sqrt[c - a^2*c*x^2])/(32*a) + (3/8)*a*c^2*x^5*Sqrt[c - a^2*c*x^2] - (1/4)*a^3*c^2*x^7*Sqrt[c - a^2*c*x^2] - (2*(c - a^2*c*x^2)^(5/2))/(5*a^4) + (3*(c - a^2*c*x^2)^(7/2))/(7*a^4*c) - (c - a^2*c*x^2)^(9/2)/(9*a^4*c^2) + (3*c^(5/2)*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]])/(64*a^4)}
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(5/2)*x^2, x, 30, -((11*c^2*x*Sqrt[c - a^2*c*x^2])/(128*a^2)) + (53/192)*c^2*x^3*Sqrt[c - a^2*c*x^2] + (1/48)*a^2*c^2*x^5*Sqrt[c - a^2*c*x^2] - (1/8)*a^4*c^2*x^7*Sqrt[c - a^2*c*x^2] - (2*(c - a^2*c*x^2)^(5/2))/(5*a^3) + (2*(c - a^2*c*x^2)^(7/2))/(7*a^3*c) + (11*c^(5/2)*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]])/(128*a^3)}
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(5/2)*x^1, x, 8, (c^2*x*Sqrt[c - a^2*c*x^2])/(8*a) + (c*x*(c - a^2*c*x^2)^(3/2))/(12*a) - (c - a^2*c*x^2)^(5/2)/(15*a^2) - ((1 + a*x)*(c - a^2*c*x^2)^(5/2))/(21*a^2) - ((1 + a*x)^2*(c - a^2*c*x^2)^(5/2))/(7*a^2) + (c^(5/2)*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]])/(8*a^2)}
...
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(5/2)/x^1, x, 22, c^2*Sqrt[c - a^2*c*x^2] + (5/4)*a*c^2*x*Sqrt[c - a^2*c*x^2] - (1/2)*a^3*c^2*x^3*Sqrt[c - a^2*c*x^2] + (1/3)*c*(c - a^2*c*x^2)^(3/2) - (1/5)*(c - a^2*c*x^2)^(5/2) + (3/4)*c^(5/2)*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]] - c^(5/2)*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]]}
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(5/2)/x^2, x, 20, 2*a*c^2*Sqrt[c - a^2*c*x^2] - (c^2*Sqrt[c - a^2*c*x^2])/x + (1/8)*a^2*c^2*x*Sqrt[c - a^2*c*x^2] - (1/4)*a^4*c^2*x^3*Sqrt[c - a^2*c*x^2] + (2/3)*a*c*(c - a^2*c*x^2)^(3/2) - (9/8)*a*c^(5/2)*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]] - 2*a*c^(5/2)*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]]}
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(5/2)/x^3, x, 20, -((c^2*Sqrt[c - a^2*c*x^2])/(2*x^2)) - (2*a*c^2*Sqrt[c - a^2*c*x^2])/x - a^3*c^2*x*Sqrt[c - a^2*c*x^2] + (1/3)*a^2*c*(c - a^2*c*x^2)^(3/2) - 3*a^2*c^(5/2)*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]] + (1/2)*a^2*c^(5/2)*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]]}
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(5/2)/x^4, x, 19, -2*a^3*c^2*Sqrt[c - a^2*c*x^2] - (c^2*Sqrt[c - a^2*c*x^2])/(3*x^3) - (a*c^2*Sqrt[c - a^2*c*x^2])/x^2 + (a^2*c^2*Sqrt[c - a^2*c*x^2])/(3*x) - (1/2)*a^4*c^2*x*Sqrt[c - a^2*c*x^2] - (1/2)*a^3*c^(5/2)*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]] + 3*a^3*c^(5/2)*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]]}
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(5/2)/x^5, x, 21, (-a^4)*c^2*Sqrt[c - a^2*c*x^2] - (c^2*Sqrt[c - a^2*c*x^2])/(4*x^4) - (2*a*c^2*Sqrt[c - a^2*c*x^2])/(3*x^3) + (a^2*c^2*Sqrt[c - a^2*c*x^2])/(8*x^2) + (8*a^3*c^2*Sqrt[c - a^2*c*x^2])/(3*x) + 2*a^4*c^(5/2)*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]] + (9/8)*a^4*c^(5/2)*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]]}
...
{E^(2*ArcTanh[a*x])/(c - a^2*c*x^2)^(1/2)*x^3, x, 13, (2*(1 + a*x))/(a^4*Sqrt[c - a^2*c*x^2]) + (3*Sqrt[c - a^2*c*x^2])/(a^4*c) + (x*Sqrt[c - a^2*c*x^2])/(a^3*c) - (c - a^2*c*x^2)^(3/2)/(3*a^4*c^2) - (3*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]])/(a^4*Sqrt[c])}
{E^(2*ArcTanh[a*x])/(c - a^2*c*x^2)^(1/2)*x^2, x, 10, (2*(1 + a*x))/(a^3*Sqrt[c - a^2*c*x^2]) + (2*Sqrt[c - a^2*c*x^2])/(a^3*c) + (x*Sqrt[c - a^2*c*x^2])/(2*a^2*c) - (5*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]])/(2*a^3*Sqrt[c])}
...
{E^(2*ArcTanh[a*x])/(c - a^2*c*x^2)^(1/2)/x^1, x, 7, (2*Sqrt[c - a^2*c*x^2])/(c*(1 - a*x)) - ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]]/Sqrt[c]}
{E^(2*ArcTanh[a*x])/(c - a^2*c*x^2)^(1/2)/x^2, x, 8, -(Sqrt[c - a^2*c*x^2]/(c*x)) + (2*a*Sqrt[c - a^2*c*x^2])/(c*(1 - a*x)) - (2*a*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]])/Sqrt[c]}
{E^(2*ArcTanh[a*x])/(c - a^2*c*x^2)^(1/2)/x^3, x, 12, -(Sqrt[c - a^2*c*x^2]/(2*c*x^2)) - (2*a*Sqrt[c - a^2*c*x^2])/(c*x) + (2*a^2*Sqrt[c - a^2*c*x^2])/(c*(1 - a*x)) - (5*a^2*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]])/(2*Sqrt[c])}
{E^(2*ArcTanh[a*x])/(c - a^2*c*x^2)^(1/2)/x^4, x, 14, -(Sqrt[c - a^2*c*x^2]/(3*c*x^3)) - (a*Sqrt[c - a^2*c*x^2])/(c*x^2) - (8*a^2*Sqrt[c - a^2*c*x^2])/(3*c*x) + (2*a^3*Sqrt[c - a^2*c*x^2])/(c*(1 - a*x)) - (3*a^3*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]])/Sqrt[c]}


{E^(2*ArcTanh[a*x])/(c - a^2*c*x^2)^(3/2)*x^3, x, 10, -(Sqrt[c - a^2*c*x^2]/(a^4*c^2)) + Sqrt[c - a^2*c*x^2]/(3*a^4*c^2*(1 - a*x)^2) - (8*Sqrt[c - a^2*c*x^2])/(3*a^4*c^2*(1 - a*x)) + (2*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]])/(a^4*c^(3/2))}
{E^(2*ArcTanh[a*x])/(c - a^2*c*x^2)^(3/2)*x^2, x, 9, Sqrt[c - a^2*c*x^2]/(3*a^3*c^2*(1 - a*x)^2) - (5*Sqrt[c - a^2*c*x^2])/(3*a^3*c^2*(1 - a*x)) + ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]]/(a^3*c^(3/2))}
...
{E^(2*ArcTanh[a*x])/(c - a^2*c*x^2)^(3/2)/x^1, x, 10, Sqrt[c - a^2*c*x^2]/(3*c^2*(1 - a*x)^2) + (4*Sqrt[c - a^2*c*x^2])/(3*c^2*(1 - a*x)) - ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]]/c^(3/2)}
{E^(2*ArcTanh[a*x])/(c - a^2*c*x^2)^(3/2)/x^2, x, 11, -(Sqrt[c - a^2*c*x^2]/(c^2*x)) + (a*Sqrt[c - a^2*c*x^2])/(3*c^2*(1 - a*x)^2) + (7*a*Sqrt[c - a^2*c*x^2])/(3*c^2*(1 - a*x)) - (2*a*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]])/c^(3/2)}
{E^(2*ArcTanh[a*x])/(c - a^2*c*x^2)^(3/2)/x^3, x, 15, -(Sqrt[c - a^2*c*x^2]/(2*c^2*x^2)) - (2*a*Sqrt[c - a^2*c*x^2])/(c^2*x) + (a^2*Sqrt[c - a^2*c*x^2])/(3*c^2*(1 - a*x)^2) + (10*a^2*Sqrt[c - a^2*c*x^2])/(3*c^2*(1 - a*x)) - (7*a^2*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]])/(2*c^(3/2))}
...
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(5/2)*x^m, x, 9, (c^2*x^(1 + m)*Sqrt[c - a^2*c*x^2]*Hypergeometric2F1[-(3/2), (1 + m)/2, (3 + m)/2, a^2*x^2])/((1 + m)*Sqrt[1 - a^2*x^2]) + (2*a*c^2*x^(2 + m)*Sqrt[c - a^2*c*x^2]*Hypergeometric2F1[-(3/2), (2 + m)/2, (4 + m)/2, a^2*x^2])/((2 + m)*Sqrt[1 - a^2*x^2]) + (a^2*c^2*x^(3 + m)*Sqrt[c - a^2*c*x^2]*Hypergeometric2F1[-(3/2), (3 + m)/2, (5 + m)/2, a^2*x^2])/((3 + m)*Sqrt[1 - a^2*x^2])}
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(3/2)*x^m, x, 9, (c*x^(1 + m)*Sqrt[c - a^2*c*x^2]*Hypergeometric2F1[-(1/2), (1 + m)/2, (3 + m)/2, a^2*x^2])/((1 + m)*Sqrt[1 - a^2*x^2]) + (2*a*c*x^(2 + m)*Sqrt[c - a^2*c*x^2]*Hypergeometric2F1[-(1/2), (2 + m)/2, (4 + m)/2, a^2*x^2])/((2 + m)*Sqrt[1 - a^2*x^2]) + (a^2*c*x^(3 + m)*Sqrt[c - a^2*c*x^2]*Hypergeometric2F1[-(1/2), (3 + m)/2, (5 + m)/2, a^2*x^2])/((3 + m)*Sqrt[1 - a^2*x^2])}
{E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(1/2)*x^m, x, 9, (c*x^(1 + m)*Sqrt[1 - a^2*x^2]*Hypergeometric2F1[1/2, (1 + m)/2, (3 + m)/2, a^2*x^2])/((1 + m)*Sqrt[c - a^2*c*x^2]) + (2*a*c*x^(2 + m)*Sqrt[1 - a^2*x^2]*Hypergeometric2F1[1/2, (2 + m)/2, (4 + m)/2, a^2*x^2])/((2 + m)*Sqrt[c - a^2*c*x^2]) + (a^2*c*x^(3 + m)*Sqrt[1 - a^2*x^2]*Hypergeometric2F1[1/2, (3 + m)/2, (5 + m)/2, a^2*x^2])/((3 + m)*Sqrt[c - a^2*c*x^2])}
{E^(2*ArcTanh[a*x])/(c - a^2*c*x^2)^(1/2)*x^m, x, 9, (x^(1 + m)*Sqrt[1 - a^2*x^2]*Hypergeometric2F1[3/2, (1 + m)/2, (3 + m)/2, a^2*x^2])/((1 + m)*Sqrt[c - a^2*c*x^2]) + (2*a*x^(2 + m)*Sqrt[1 - a^2*x^2]*Hypergeometric2F1[3/2, (2 + m)/2, (4 + m)/2, a^2*x^2])/((2 + m)*Sqrt[c - a^2*c*x^2]) + (a^2*x^(3 + m)*Sqrt[1 - a^2*x^2]*Hypergeometric2F1[3/2, (3 + m)/2, (5 + m)/2, a^2*x^2])/((3 + m)*Sqrt[c - a^2*c*x^2])}
{E^(2*ArcTanh[a*x])/(c - a^2*c*x^2)^(3/2)*x^m, x, 9, (x^(1 + m)*Sqrt[1 - a^2*x^2]*Hypergeometric2F1[5/2, (1 + m)/2, (3 + m)/2, a^2*x^2])/(c*(1 + m)*Sqrt[c - a^2*c*x^2]) + (2*a*x^(2 + m)*Sqrt[1 - a^2*x^2]*Hypergeometric2F1[5/2, (2 + m)/2, (4 + m)/2, a^2*x^2])/(c*(2 + m)*Sqrt[c - a^2*c*x^2]) + (a^2*x^(3 + m)*Sqrt[1 - a^2*x^2]*Hypergeometric2F1[5/2, (3 + m)/2, (5 + m)/2, a^2*x^2])/(c*(3 + m)*Sqrt[c - a^2*c*x^2])}
...
{E^(3*ArcTanh[a*x])*(c - a^2*c*x^2)*x^3, x, 16, -((4*c*Sqrt[1 - a^2*x^2])/a^4) - (23*c*x*Sqrt[1 - a^2*x^2])/(16*a^3) - (23*c*x^3*Sqrt[1 - a^2*x^2])/(24*a) - (1/6)*a*c*x^5*Sqrt[1 - a^2*x^2] + (7*c*(1 - a^2*x^2)^(3/2))/(3*a^4) - (3*c*(1 - a^2*x^2)^(5/2))/(5*a^4) + (23*c*ArcSin[a*x])/(16*a^4)}
{E^(3*ArcTanh[a*x])*(c - a^2*c*x^2)*x^2, x, 14, -((4*c*Sqrt[1 - a^2*x^2])/a^3) - (13*c*x*Sqrt[1 - a^2*x^2])/(8*a^2) - (3/4)*c*x^3*Sqrt[1 - a^2*x^2] + (5*c*(1 - a^2*x^2)^(3/2))/(3*a^3) - (c*(1 - a^2*x^2)^(5/2))/(5*a^3) + (13*c*ArcSin[a*x])/(8*a^3)}
...
{E^(3*ArcTanh[a*x])*(c - a^2*c*x^2)/x^1, x, 10, -3*c*Sqrt[1 - a^2*x^2] - (1/2)*a*c*x*Sqrt[1 - a^2*x^2] + (7/2)*c*ArcSin[a*x] - c*ArcTanh[Sqrt[1 - a^2*x^2]]}
{E^(3*ArcTanh[a*x])*(c - a^2*c*x^2)/x^2, x, 9, (-a)*c*Sqrt[1 - a^2*x^2] - (c*Sqrt[1 - a^2*x^2])/x + 3*a*c*ArcSin[a*x] - 3*a*c*ArcTanh[Sqrt[1 - a^2*x^2]]}
{E^(3*ArcTanh[a*x])*(c - a^2*c*x^2)/x^3, x, 12, -((c*Sqrt[1 - a^2*x^2])/(2*x^2)) - (3*a*c*Sqrt[1 - a^2*x^2])/x + a^2*c*ArcSin[a*x] - (7/2)*a^2*c*ArcTanh[Sqrt[1 - a^2*x^2]]}
{E^(3*ArcTanh[a*x])*(c - a^2*c*x^2)/x^4, x, 13, -((c*Sqrt[1 - a^2*x^2])/(3*x^3)) - (3*a*c*Sqrt[1 - a^2*x^2])/(2*x^2) - (11*a^2*c*Sqrt[1 - a^2*x^2])/(3*x) - (5/2)*a^3*c*ArcTanh[Sqrt[1 - a^2*x^2]]}
{E^(3*ArcTanh[a*x])*(c - a^2*c*x^2)/x^5, x, 15, -((c*Sqrt[1 - a^2*x^2])/(4*x^4)) - (a*c*Sqrt[1 - a^2*x^2])/x^3 - (15*a^2*c*Sqrt[1 - a^2*x^2])/(8*x^2) - (3*a^3*c*Sqrt[1 - a^2*x^2])/x - (15/8)*a^4*c*ArcTanh[Sqrt[1 - a^2*x^2]]}
{E^(3*ArcTanh[a*x])*(c - a^2*c*x^2)/x^6, x, 17, -((c*Sqrt[1 - a^2*x^2])/(5*x^5)) - (3*a*c*Sqrt[1 - a^2*x^2])/(4*x^4) - (19*a^2*c*Sqrt[1 - a^2*x^2])/(15*x^3) - (13*a^3*c*Sqrt[1 - a^2*x^2])/(8*x^2) - (38*a^4*c*Sqrt[1 - a^2*x^2])/(15*x) - (13/8)*a^5*c*ArcTanh[Sqrt[1 - a^2*x^2]]}
...
{E^(3*ArcTanh[a*x])/(c - a^2*c*x^2)*x^2, x, 8, -(Sqrt[1 - a^2*x^2]/(a^3*c)) + (2*Sqrt[1 - a^2*x^2])/(3*a^3*c*(1 - a*x)^2) - (13*Sqrt[1 - a^2*x^2])/(3*a^3*c*(1 - a*x)) + (3*ArcSin[a*x])/(a^3*c)}
...
{E^(3*ArcTanh[a*x])*(c - a^2*c*x^2)^p*x^m, x, 8, (x^(1 + m)*(c - a^2*c*x^2)^p*Hypergeometric2F1[(1 + m)/2, 3/2 - p, (3 + m)/2, a^2*x^2])/((1 - a^2*x^2)^p*(1 + m)) + (3*a*x^(2 + m)*(c - a^2*c*x^2)^p*Hypergeometric2F1[(2 + m)/2, 3/2 - p, (4 + m)/2, a^2*x^2])/((1 - a^2*x^2)^p*(2 + m)) + (3*a^2*x^(3 + m)*(c - a^2*c*x^2)^p*Hypergeometric2F1[(3 + m)/2, 3/2 - p, (5 + m)/2, a^2*x^2])/((1 - a^2*x^2)^p*(3 + m)) + (a^3*x^(4 + m)*(c - a^2*c*x^2)^p*Hypergeometric2F1[(4 + m)/2, 3/2 - p, (6 + m)/2, a^2*x^2])/((1 - a^2*x^2)^p*(4 + m))}


{E^(3*ArcTanh[a*x])*(c - a^2*c*x^2)^p*x^3, x, 12, (4*(c - a^2*c*x^2)^p)/(a^4*(1 - 2*p)*Sqrt[1 - a^2*x^2]) + (7*Sqrt[1 - a^2*x^2]*(c - a^2*c*x^2)^p)/(a^4*(1 + 2*p)) - (3*(1 - a^2*x^2)^(3/2)*(c - a^2*c*x^2)^p)/(a^4*(3 + 2*p)) + ((3/5)*a*x^5*(c - a^2*c*x^2)^p*Hypergeometric2F1[5/2, 3/2 - p, 7/2, a^2*x^2])/(1 - a^2*x^2)^p + ((1/7)*a^3*x^7*(c - a^2*c*x^2)^p*Hypergeometric2F1[7/2, 3/2 - p, 9/2, a^2*x^2])/(1 - a^2*x^2)^p}
{E^(3*ArcTanh[a*x])*(c - a^2*c*x^2)^p*x^2, x, 12, If[$VersionNumber>=8, (4*(1 + a*x)^3*(c - a^2*c*x^2)^p)/(a^3*(3 - 4*p - 4*p^2)*Sqrt[1 - a^2*x^2]) - (x*(1 + a*x)^3*(c - a^2*c*x^2)^p)/(a^2*(3 + 2*p)*Sqrt[1 - a^2*x^2]) - (2^(1/2 + p)*(11 + 2*p)*(1 + a*x)^(5/2 + p)*(c - a^2*c*x^2)^p*Hypergeometric2F1[1/2 - p, 5/2 + p, 7/2 + p, (1/2)*(1 + a*x)])/((1 - a^2*x^2)^p*(a^3*(3 + 2*p)*(5 - 8*p - 4*p^2))), (4*(1 + a*x)^3*(c - a^2*c*x^2)^p)/(a^3*(3 - 4*p - 4*p^2)*Sqrt[1 - a^2*x^2]) - (x*(1 + a*x)^3*(c - a^2*c*x^2)^p)/(a^2*(3 + 2*p)*Sqrt[1 - a^2*x^2]) - (2^(1/2 + p)*(11 + 2*p)*(1 + a*x)^(5/2 + p)*(c - a^2*c*x^2)^p*Hypergeometric2F1[1/2 - p, 5/2 + p, 7/2 + p, (1/2)*(1 + a*x)])/((1 - a^2*x^2)^p*(a^3*(15 - 14*p - 28*p^2 - 8*p^3)))], (4*(c - a^2*c*x^2)^p)/(a^3*(1 - 2*p)*Sqrt[1 - a^2*x^2]) + (5*Sqrt[1 - a^2*x^2]*(c - a^2*c*x^2)^p)/(a^3*(1 + 2*p)) - ((1 - a^2*x^2)^(3/2)*(c - a^2*c*x^2)^p)/(a^3*(3 + 2*p)) + ((1/3)*x^3*(c - a^2*c*x^2)^p*Hypergeometric2F1[3/2, 3/2 - p, 5/2, a^2*x^2])/(1 - a^2*x^2)^p + ((3/5)*a^2*x^5*(c - a^2*c*x^2)^p*Hypergeometric2F1[5/2, 3/2 - p, 7/2, a^2*x^2])/(1 - a^2*x^2)^p}
{E^(3*ArcTanh[a*x])*(c - a^2*c*x^2)^p*x^1, x, 5, ((1 + a*x)^3*(c - a^2*c*x^2)^p)/(a^2*(1 - 2*p)*Sqrt[1 - a^2*x^2]) + (3*2^(5/2 + p)*(1 - a*x)^(1/2 + p)*(c - a^2*c*x^2)^p*Hypergeometric2F1[-(3/2) - p, 1/2 + p, 3/2 + p, (1/2)*(1 - a*x)])/((1 - a^2*x^2)^p*(a^2*(1 - 4*p^2)))}
...
{E^(3*ArcTanh[a*x])*(c - a^2*c*x^2)^p/x^1, x, 9, (3*(c - a^2*c*x^2)^p)/((1 - 2*p)*Sqrt[1 - a^2*x^2]) + (3*a*x*(c - a^2*c*x^2)^p*Hypergeometric2F1[1/2, 3/2 - p, 3/2, a^2*x^2])/(1 - a^2*x^2)^p + ((c - a^2*c*x^2)^p*Hypergeometric2F1[1, -(1/2) + p, 1/2 + p, 1 - a^2*x^2])/((1 - 2*p)*Sqrt[1 - a^2*x^2]) + ((1/3)*a^3*x^3*(c - a^2*c*x^2)^p*Hypergeometric2F1[3/2, 3/2 - p, 5/2, a^2*x^2])/(1 - a^2*x^2)^p}
{E^(3*ArcTanh[a*x])*(c - a^2*c*x^2)^p/x^2, x, 9, (a*(c - a^2*c*x^2)^p)/((1 - 2*p)*Sqrt[1 - a^2*x^2]) - ((c - a^2*c*x^2)^p*Hypergeometric2F1[-(1/2), 3/2 - p, 1/2, a^2*x^2])/((1 - a^2*x^2)^p*x) + (3*a^2*x*(c - a^2*c*x^2)^p*Hypergeometric2F1[1/2, 3/2 - p, 3/2, a^2*x^2])/(1 - a^2*x^2)^p + (3*a*(c - a^2*c*x^2)^p*Hypergeometric2F1[1, -(1/2) + p, 1/2 + p, 1 - a^2*x^2])/((1 - 2*p)*Sqrt[1 - a^2*x^2])}
{E^(3*ArcTanh[a*x])*(c - a^2*c*x^2)^p/x^3, x, 10, -((3*a*(c - a^2*c*x^2)^p*Hypergeometric2F1[-(1/2), 3/2 - p, 1/2, a^2*x^2])/((1 - a^2*x^2)^p*x)) + (a^3*x*(c - a^2*c*x^2)^p*Hypergeometric2F1[1/2, 3/2 - p, 3/2, a^2*x^2])/(1 - a^2*x^2)^p + (3*a^2*(c - a^2*c*x^2)^p*Hypergeometric2F1[1, -(1/2) + p, 1/2 + p, 1 - a^2*x^2])/((1 - 2*p)*Sqrt[1 - a^2*x^2]) + (a^2*(c - a^2*c*x^2)^p*Hypergeometric2F1[2, -(1/2) + p, 1/2 + p, 1 - a^2*x^2])/((1 - 2*p)*Sqrt[1 - a^2*x^2])}
...
{E^(4*ArcTanh[a*x])/(c - a^2*c*x^2)^1, x, 2, (1 + a*x)^2/(4*a*c*(1 - a*x)^2)}
...
{E^(4*ArcTanh[a*x])*(c - a^2*c*x^2)^p, x, 3, (2^(2 + p)*(c - a^2*c*x^2)^p*Hypergeometric2F1[-2 - p, -1 + p, p, (1/2)*(1 - a*x)])/((1 + a*x)^p*(a*(1 - p)*(1 - a*x)))}
...
{1/E^ArcTanh[a*x]*(c - a^2*c*x^2)^(3/2), x, 4, (c*x*Sqrt[c - a^2*c*x^2])/Sqrt[1 - a^2*x^2] - (a*c*x^2*Sqrt[c - a^2*c*x^2])/(2*Sqrt[1 - a^2*x^2]) - (a^2*c*x^3*Sqrt[c - a^2*c*x^2])/(3*Sqrt[1 - a^2*x^2]) + (a^3*c*x^4*Sqrt[c - a^2*c*x^2])/(4*Sqrt[1 - a^2*x^2])}
...
{1/E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^2, x, 3, c^2*x - a*c^2*x^2 + (1/2)*a^3*c^2*x^4 - (1/5)*a^4*c^2*x^5}
...
{1/E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(1/2)*x^m, x, 9, (c*x^(1 + m)*Sqrt[1 - a^2*x^2]*Hypergeometric2F1[1/2, (1 + m)/2, (3 + m)/2, a^2*x^2])/((1 + m)*Sqrt[c - a^2*c*x^2]) - (2*a*c*x^(2 + m)*Sqrt[1 - a^2*x^2]*Hypergeometric2F1[1/2, (2 + m)/2, (4 + m)/2, a^2*x^2])/((2 + m)*Sqrt[c - a^2*c*x^2]) + (a^2*c*x^(3 + m)*Sqrt[1 - a^2*x^2]*Hypergeometric2F1[1/2, (3 + m)/2, (5 + m)/2, a^2*x^2])/((3 + m)*Sqrt[c - a^2*c*x^2])}

{1/E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(1/2)*x^3, x, 13, -((2*Sqrt[c - a^2*c*x^2])/a^4) + (3*x*Sqrt[c - a^2*c*x^2])/(4*a^3) + (x^3*Sqrt[c - a^2*c*x^2])/(2*a) + (c - a^2*c*x^2)^(3/2)/(a^4*c) - (c - a^2*c*x^2)^(5/2)/(5*a^4*c^2) - (3*Sqrt[c]*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]])/(4*a^4)}
{1/E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(1/2)*x^2, x, 13, (2*Sqrt[c - a^2*c*x^2])/a^3 - (7*x*Sqrt[c - a^2*c*x^2])/(8*a^2) - (1/4)*x^3*Sqrt[c - a^2*c*x^2] - (2*(c - a^2*c*x^2)^(3/2))/(3*a^3*c) + (7*Sqrt[c]*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]])/(8*a^3)}
{1/E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(1/2)*x^1, x, 6, -(Sqrt[c - a^2*c*x^2]/a^2) - ((1 - a*x)*Sqrt[c - a^2*c*x^2])/(3*a^2) - ((1 - a*x)^2*Sqrt[c - a^2*c*x^2])/(3*a^2) - (Sqrt[c]*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]])/a^2}
...
{1/E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(1/2)/x^1, x, 9, -Sqrt[c - a^2*c*x^2] - 2*Sqrt[c]*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]] - Sqrt[c]*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]]}
{1/E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(1/2)/x^2, x, 9, -(Sqrt[c - a^2*c*x^2]/x) + a*Sqrt[c]*ArcTan[(a*Sqrt[c]*x)/Sqrt[c - a^2*c*x^2]] + 2*a*Sqrt[c]*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]]}
{1/E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(1/2)/x^3, x, 11, -(Sqrt[c - a^2*c*x^2]/(2*x^2)) + (2*a*Sqrt[c - a^2*c*x^2])/x - (3/2)*a^2*Sqrt[c]*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]]}
{1/E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(1/2)/x^4, x, 10, -(Sqrt[c - a^2*c*x^2]/(3*x^3)) + (a*Sqrt[c - a^2*c*x^2])/x^2 - (5*a^2*Sqrt[c - a^2*c*x^2])/(3*x) + a^3*Sqrt[c]*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]]}
{1/E^(2*ArcTanh[a*x])*(c - a^2*c*x^2)^(1/2)/x^5, x, 14, -(Sqrt[c - a^2*c*x^2]/(4*x^4)) + (2*a*Sqrt[c - a^2*c*x^2])/(3*x^3) - (7*a^2*Sqrt[c - a^2*c*x^2])/(8*x^2) + (4*a^3*Sqrt[c - a^2*c*x^2])/(3*x) - (7/8)*a^4*Sqrt[c]*ArcTanh[Sqrt[c - a^2*c*x^2]/Sqrt[c]]}
...
{E^(1/2*ArcTanh[a*x])*(1 - a^2*x^2)^(5/2), x, 19, (231*(1 - a*x)^(1/4)*(1 + a*x)^(3/4))/(512*a) + (231*(1 - a*x)^(5/4)*(1 + a*x)^(3/4))/(1280*a) + (77*(1 - a*x)^(9/4)*(1 + a*x)^(3/4))/(960*a) - (77*(1 - a*x)^(13/4)*(1 + a*x)^(3/4))/(480*a) - (11*(1 - a*x)^(13/4)*(1 + a*x)^(7/4))/(60*a) - ((1 - a*x)^(13/4)*(1 + a*x)^(11/4))/(6*a) + (231*ArcTan[1 - (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(512*Sqrt[2]*a) - (231*ArcTan[1 + (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(512*Sqrt[2]*a) + (231*Log[1 + Sqrt[1 - a*x]/Sqrt[1 + a*x] - (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(1024*Sqrt[2]*a) - (231*Log[1 + Sqrt[1 - a*x]/Sqrt[1 + a*x] + (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(1024*Sqrt[2]*a)}
{E^(1/2*ArcTanh[a*x])*(1 - a^2*x^2)^(3/2), x, 17, (35*(1 - a*x)^(1/4)*(1 + a*x)^(3/4))/(64*a) + (7*(1 - a*x)^(5/4)*(1 + a*x)^(3/4))/(32*a) - (7*(1 - a*x)^(9/4)*(1 + a*x)^(3/4))/(24*a) - ((1 - a*x)^(9/4)*(1 + a*x)^(7/4))/(4*a) + (35*ArcTan[1 - (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(64*Sqrt[2]*a) - (35*ArcTan[1 + (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(64*Sqrt[2]*a) + (35*Log[1 + Sqrt[1 - a*x]/Sqrt[1 + a*x] - (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(128*Sqrt[2]*a) - (35*Log[1 + Sqrt[1 - a*x]/Sqrt[1 + a*x] + (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(128*Sqrt[2]*a)}
{E^(1/2*ArcTanh[a*x])*(1 - a^2*x^2)^(1/2), x, 15, (3*(1 - a*x)^(1/4)*(1 + a*x)^(3/4))/(4*a) - ((1 - a*x)^(5/4)*(1 + a*x)^(3/4))/(2*a) + (3*ArcTan[1 - (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(4*Sqrt[2]*a) - (3*ArcTan[1 + (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(4*Sqrt[2]*a) + (3*Log[1 + Sqrt[1 - a*x]/Sqrt[1 + a*x] - (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(8*Sqrt[2]*a) - (3*Log[1 + Sqrt[1 - a*x]/Sqrt[1 + a*x] + (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(8*Sqrt[2]*a)}
{E^(1/2*ArcTanh[a*x])/(1 - a^2*x^2)^(1/2), x, 13, (Sqrt[2]*ArcTan[1 - (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/a - (Sqrt[2]*ArcTan[1 + (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/a + Log[1 + Sqrt[1 - a*x]/Sqrt[1 + a*x] - (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)]/(Sqrt[2]*a) - Log[1 + Sqrt[1 - a*x]/Sqrt[1 + a*x] + (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)]/(Sqrt[2]*a)}
...
{E^(1/2*ArcTanh[a*x])*(c - a^2*c*x^2)^(5/2), x, 20, (231*c^2*(1 - a*x)^(1/4)*(1 + a*x)^(3/4)*Sqrt[c - a^2*c*x^2])/(512*a*Sqrt[1 - a^2*x^2]) + (231*c^2*(1 - a*x)^(5/4)*(1 + a*x)^(3/4)*Sqrt[c - a^2*c*x^2])/(1280*a*Sqrt[1 - a^2*x^2]) + (77*c^2*(1 - a*x)^(9/4)*(1 + a*x)^(3/4)*Sqrt[c - a^2*c*x^2])/(960*a*Sqrt[1 - a^2*x^2]) - (77*c^2*(1 - a*x)^(13/4)*(1 + a*x)^(3/4)*Sqrt[c - a^2*c*x^2])/(480*a*Sqrt[1 - a^2*x^2]) - (11*c^2*(1 - a*x)^(13/4)*(1 + a*x)^(7/4)*Sqrt[c - a^2*c*x^2])/(60*a*Sqrt[1 - a^2*x^2]) - (c^2*(1 - a*x)^(13/4)*(1 + a*x)^(11/4)*Sqrt[c - a^2*c*x^2])/(6*a*Sqrt[1 - a^2*x^2]) + (231*c^2*Sqrt[c - a^2*c*x^2]*ArcTan[1 - (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(512*Sqrt[2]*a*Sqrt[1 - a^2*x^2]) - (231*c^2*Sqrt[c - a^2*c*x^2]*ArcTan[1 + (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(512*Sqrt[2]*a*Sqrt[1 - a^2*x^2]) + (231*c^2*Sqrt[c - a^2*c*x^2]*Log[1 + Sqrt[1 - a*x]/Sqrt[1 + a*x] - (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(1024*Sqrt[2]*a*Sqrt[1 - a^2*x^2]) - (231*c^2*Sqrt[c - a^2*c*x^2]*Log[1 + Sqrt[1 - a*x]/Sqrt[1 + a*x] + (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(1024*Sqrt[2]*a*Sqrt[1 - a^2*x^2])}
{E^(1/2*ArcTanh[a*x])*(c - a^2*c*x^2)^(3/2), x, 18, (35*c*(1 - a*x)^(1/4)*(1 + a*x)^(3/4)*Sqrt[c - a^2*c*x^2])/(64*a*Sqrt[1 - a^2*x^2]) + (7*c*(1 - a*x)^(5/4)*(1 + a*x)^(3/4)*Sqrt[c - a^2*c*x^2])/(32*a*Sqrt[1 - a^2*x^2]) - (7*c*(1 - a*x)^(9/4)*(1 + a*x)^(3/4)*Sqrt[c - a^2*c*x^2])/(24*a*Sqrt[1 - a^2*x^2]) - (c*(1 - a*x)^(9/4)*(1 + a*x)^(7/4)*Sqrt[c - a^2*c*x^2])/(4*a*Sqrt[1 - a^2*x^2]) + (35*c*Sqrt[c - a^2*c*x^2]*ArcTan[1 - (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(64*Sqrt[2]*a*Sqrt[1 - a^2*x^2]) - (35*c*Sqrt[c - a^2*c*x^2]*ArcTan[1 + (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(64*Sqrt[2]*a*Sqrt[1 - a^2*x^2]) + (35*c*Sqrt[c - a^2*c*x^2]*Log[1 + Sqrt[1 - a*x]/Sqrt[1 + a*x] - (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(128*Sqrt[2]*a*Sqrt[1 - a^2*x^2]) - (35*c*Sqrt[c - a^2*c*x^2]*Log[1 + Sqrt[1 - a*x]/Sqrt[1 + a*x] + (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(128*Sqrt[2]*a*Sqrt[1 - a^2*x^2])}
{E^(1/2*ArcTanh[a*x])*(c - a^2*c*x^2)^(1/2), x, 16, (3*(1 - a*x)^(1/4)*(1 + a*x)^(3/4)*Sqrt[c - a^2*c*x^2])/(4*a*Sqrt[1 - a^2*x^2]) - ((1 - a*x)^(5/4)*(1 + a*x)^(3/4)*Sqrt[c - a^2*c*x^2])/(2*a*Sqrt[1 - a^2*x^2]) + (3*Sqrt[c - a^2*c*x^2]*ArcTan[1 - (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(4*Sqrt[2]*a*Sqrt[1 - a^2*x^2]) - (3*Sqrt[c - a^2*c*x^2]*ArcTan[1 + (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(4*Sqrt[2]*a*Sqrt[1 - a^2*x^2]) + (3*Sqrt[c - a^2*c*x^2]*Log[1 + Sqrt[1 - a*x]/Sqrt[1 + a*x] - (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(8*Sqrt[2]*a*Sqrt[1 - a^2*x^2]) - (3*Sqrt[c - a^2*c*x^2]*Log[1 + Sqrt[1 - a*x]/Sqrt[1 + a*x] + (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(8*Sqrt[2]*a*Sqrt[1 - a^2*x^2])}
{E^(1/2*ArcTanh[a*x])/(c - a^2*c*x^2)^(1/2), x, 14, (Sqrt[2]*Sqrt[1 - a^2*x^2]*ArcTan[1 - (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(a*Sqrt[c - a^2*c*x^2]) - (Sqrt[2]*Sqrt[1 - a^2*x^2]*ArcTan[1 + (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(a*Sqrt[c - a^2*c*x^2]) + (Sqrt[1 - a^2*x^2]*Log[1 + Sqrt[1 - a*x]/Sqrt[1 + a*x] - (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(Sqrt[2]*a*Sqrt[c - a^2*c*x^2]) - (Sqrt[1 - a^2*x^2]*Log[1 + Sqrt[1 - a*x]/Sqrt[1 + a*x] + (Sqrt[2]*(1 - a*x)^(1/4))/(1 + a*x)^(1/4)])/(Sqrt[2]*a*Sqrt[c - a^2*c*x^2])}
...
{E^(n*ArcTanh[a*x])/(c - a^2*c*x^2)^2*x^4, x, 10, ((1 - n)*(3 + n)*(1 - a*x)^(-1 - n/2)*(1 + a*x)^((1/2)*(-2 + n)))/(a^5*c^2*(2 - n)) + ((3 + n)*x*(1 - a*x)^(-1 - n/2)*(1 + a*x)^((1/2)*(-2 + n)))/(a^4*c^2) - (x^3*(1 - a*x)^(-1 - n/2)*(1 + a*x)^((1/2)*(-2 + n)))/(a^2*c^2) + ((1 - a*x)^(1 - n/2)*(1 + a*x)^((1/2)*(-2 + n)))/(a^5*c^2*(2 - n)) - (1 + a*x)^((1/2)*(-2 + n))/((1 - a*x)^(n/2)*(a^5*c^2)) - ((3 + n)*(2 - n^2)*(1 - a*x)^(-1 - n/2)*(1 + a*x)^(n/2))/(a^5*c^2*(4 - n^2)) - ((3 + n)*(2 - n^2)*(1 + a*x)^(n/2))/((1 - a*x)^(n/2)*(a^5*c^2*n*(4 - n^2))) - (2^(n/2)*n*(1 - a*x)^(1 - n/2)*Hypergeometric2F1[1 - n/2, 1 - n/2, 2 - n/2, (1/2)*(1 - a*x)])/(a^5*c^2*(2 - n))}
{E^(n*ArcTanh[a*x])/(c - a^2*c*x^2)^2*x^3, x, 10, -(((1 - a*x)^(-1 - n/2)*(1 + a*x)^((1/2)*(-2 + n)))/(a^4*c^2*(2 + n))) + (2*(1 - a*x)^(1 - n/2)*(1 + a*x)^((1/2)*(-2 + n)))/(a^4*c^2*n*(4 - n^2)) - (2*(1 + a*x)^((1/2)*(-2 + n)))/((1 - a*x)^(n/2)*(a^4*c^2*n*(2 + n))) + (3*(1 - a*x)^(-1 - n/2)*(1 + a*x)^(n/2))/(a^4*c^2*(2 + n)) + (3*(1 + a*x)^(n/2))/((1 - a*x)^(n/2)*(a^4*c^2*n*(2 + n))) - (3*(1 - a*x)^(-1 - n/2)*(1 + a*x)^((2 + n)/2))/(a^4*c^2*(2 + n)) + (2^(2 + n/2)*(1 - a*x)^(-1 - n/2)*Hypergeometric2F1[-1 - n/2, -1 - n/2, -(n/2), (1/2)*(1 - a*x)])/(a^4*c^2*(2 + n))}
