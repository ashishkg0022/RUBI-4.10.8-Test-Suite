...
{1/((d + e*x^2)*(a + b*ArcSinh[c*x])), x, 0, Defer[Int][1/((d + e*x^2)*(a + b*ArcSinh[c*x])), x]}
{1/((d + e*x^2)^2*(a + b*ArcSinh[c*x])), x, 0, Defer[Int][1/((d + e*x^2)^2*(a + b*ArcSinh[c*x])), x]}
...
{1/((d + e*x^2)*(a + b*ArcSinh[c*x])^2), x, 0, Defer[Int][1/((d + e*x^2)*(a + b*ArcSinh[c*x])^2), x]}
{1/((d + e*x^2)^2*(a + b*ArcSinh[c*x])^2), x, 0, Defer[Int][1/((d + e*x^2)^2*(a + b*ArcSinh[c*x])^2), x]}
...
{Sqrt[a + b*ArcSinh[c*x]]/(d + e*x^2), x, 0, Defer[Int][Sqrt[a + b*ArcSinh[c*x]]/(d + e*x^2), x]}
{Sqrt[a + b*ArcSinh[c*x]]/(d + e*x^2)^2, x, 0, Defer[Int][Sqrt[a + b*ArcSinh[c*x]]/(d + e*x^2)^2, x]}
...
{(a + b*ArcSinh[c*x])^(3/2)/(d + e*x^2), x, 0, Defer[Int][(a + b*ArcSinh[c*x])^(3/2)/(d + e*x^2), x]}
{(a + b*ArcSinh[c*x])^(3/2)/(d + e*x^2)^2, x, 0, Defer[Int][(a + b*ArcSinh[c*x])^(3/2)/(d + e*x^2)^2, x]}
...
{1/((d + e*x^2)*Sqrt[a + b*ArcSinh[c*x]]), x, 0, Defer[Int][1/((d + e*x^2)*Sqrt[a + b*ArcSinh[c*x]]), x]}
{1/((d + e*x^2)^2*Sqrt[a + b*ArcSinh[c*x]]), x, 0, Defer[Int][1/((d + e*x^2)^2*Sqrt[a + b*ArcSinh[c*x]]), x]}
...
{1/((d + e*x^2)*(a + b*ArcSinh[c*x])^(3/2)), x, 0, Defer[Int][1/((d + e*x^2)*(a + b*ArcSinh[c*x])^(3/2)), x]}
{1/((d + e*x^2)^2*(a + b*ArcSinh[c*x])^(3/2)), x, 0, Defer[Int][1/((d + e*x^2)^2*(a + b*ArcSinh[c*x])^(3/2)), x]}
...
{Sqrt[d + e*x^2]*(a + b*ArcSinh[c*x]), x, 0, Defer[Int][Sqrt[d + e*x^2]*(a + b*ArcSinh[c*x]), x]}
{(a + b*ArcSinh[c*x])/Sqrt[d + e*x^2], x, 0, Defer[Int][(a + b*ArcSinh[c*x])/Sqrt[d + e*x^2], x]}
{(a + b*ArcSinh[c*x])/(d + e*x^2)^(3/2), x, 5, (x*(a + b*ArcSinh[c*x]))/(d*Sqrt[d + e*x^2]) - (b*ArcTanh[(Sqrt[e]*Sqrt[1 + c^2*x^2])/(c*Sqrt[d + e*x^2])])/(d*Sqrt[e])}
{(a + b*ArcSinh[c*x])/(d + e*x^2)^(5/2), x, 6, -(b*c*Sqrt[1 + c^2*x^2])/(3*d*(c^2*d - e)*Sqrt[d + e*x^2]) + (x*(a + b*ArcSinh[c*x]))/(3*d*(d + e*x^2)^(3/2)) + (2*x*(a + b*ArcSinh[c*x]))/(3*d^2*Sqrt[d + e*x^2]) - (2*b*ArcTanh[(Sqrt[e]*Sqrt[1 + c^2*x^2])/(c*Sqrt[d + e*x^2])])/(3*d^2*Sqrt[e])}
{(a + b*ArcSinh[c*x])/(d + e*x^2)^(7/2), x, 10, -(b*c*Sqrt[1 + c^2*x^2])/(15*d*(c^2*d - e)*(d + e*x^2)^(3/2)) - (2*b*c*(5*c^2*d - 6*e)*Sqrt[1 + c^2*x^2])/(9*d^2*(c^2*d - e)^2*Sqrt[d + e*x^2]) + (16*b*c*(2*c^2*d - 3*e)*Sqrt[1 + c^2*x^2])/(45*d^2*(c^2*d - e)^2*Sqrt[d + e*x^2]) + (x*(a + b*ArcSinh[c*x]))/(5*d*(d + e*x^2)^(5/2)) + (4*x*(a + b*ArcSinh[c*x]))/(15*d^2*(d + e*x^2)^(3/2)) + (8*x*(a + b*ArcSinh[c*x]))/(15*d^3*Sqrt[d + e*x^2]) - (8*b*ArcTanh[(Sqrt[e]*Sqrt[1 + c^2*x^2])/(c*Sqrt[d + e*x^2])])/(15*d^3*Sqrt[e])}


{Sqrt[d + e*x^2]*(a + b*ArcSinh[c*x])^2, x, 0, Defer[Int][Sqrt[d + e*x^2]*(a + b*ArcSinh[c*x])^2, x]}
{(a + b*ArcSinh[c*x])^2/Sqrt[d + e*x^2], x, 0, Defer[Int][(a + b*ArcSinh[c*x])^2/Sqrt[d + e*x^2], x]}
{(a + b*ArcSinh[c*x])^2/(d + e*x^2)^(3/2), x, 0, Defer[Int][(a + b*ArcSinh[c*x])^2/(d + e*x^2)^(3/2), x]}
{(a + b*ArcSinh[c*x])^2/(d + e*x^2)^(5/2), x, 0, Defer[Int][(a + b*ArcSinh[c*x])^2/(d + e*x^2)^(5/2), x]}
...
{Sqrt[d + e*x^2]/(a + b*ArcSinh[c*x]), x, 0, Defer[Int][Sqrt[d + e*x^2]/(a + b*ArcSinh[c*x]), x]}
{1/(Sqrt[d + e*x^2]*(a + b*ArcSinh[c*x])), x, 0, Defer[Int][1/(Sqrt[d + e*x^2]*(a + b*ArcSinh[c*x])), x]}
{1/((d + e*x^2)^(3/2)*(a + b*ArcSinh[c*x])), x, 0, Defer[Int][1/((d + e*x^2)^(3/2)*(a + b*ArcSinh[c*x])), x]}
{1/((d + e*x^2)^(5/2)*(a + b*ArcSinh[c*x])), x, 0, Defer[Int][1/((d + e*x^2)^(5/2)*(a + b*ArcSinh[c*x])), x]}


{Sqrt[d + e*x^2]/(a + b*ArcSinh[c*x])^2, x, 0, Defer[Int][Sqrt[d + e*x^2]/(a + b*ArcSinh[c*x])^2, x]}
{1/(Sqrt[d + e*x^2]*(a + b*ArcSinh[c*x])^2), x, 0, Defer[Int][1/(Sqrt[d + e*x^2]*(a + b*ArcSinh[c*x])^2), x]}
{1/((d + e*x^2)^(3/2)*(a + b*ArcSinh[c*x])^2), x, 0, Defer[Int][1/((d + e*x^2)^(3/2)*(a + b*ArcSinh[c*x])^2), x]}
{1/((d + e*x^2)^(5/2)*(a + b*ArcSinh[c*x])^2), x, 0, Defer[Int][1/((d + e*x^2)^(5/2)*(a + b*ArcSinh[c*x])^2), x]}
