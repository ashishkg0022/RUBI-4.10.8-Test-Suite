...
(* ::Title::Closed:: *)
(*Integrands of the form (a+b x^n)^p (c+d x^n)^q with integer n>1*)
...
{(a + b*x^2)^(1/2)*(c + d*x^2)^2, x, 5, ((8*b^2*c^2 - 4*a*b*c*d + a^2*d^2)*x*Sqrt[a + b*x^2])/(16*b^2) + (d*(8*b*c - 3*a*d)*x*(a + b*x^2)^(3/2))/(24*b^2) + (d*x*(a + b*x^2)^(3/2)*(c + d*x^2))/(6*b) + (a*(8*b^2*c^2 - 4*a*b*c*d + a^2*d^2)*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/(16*b^(5/2))}
{(a + b*x^2)^(1/2)*(c + d*x^2)^1, x, 4, ((4*b*c - a*d)*x*Sqrt[a + b*x^2])/(8*b) + (d*x*(a + b*x^2)^(3/2))/(4*b) + (a*(4*b*c - a*d)*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/(8*b^(3/2))}
{(a + b*x^2)^(1/2)*(c + d*x^2)^0, x, 3, (1/2)*x*Sqrt[a + b*x^2] + (a*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/(2*Sqrt[b])}
{(a + b*x^2)^(1/2)/(c + d*x^2)^1, x, 5, (Sqrt[b]*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/d - (Sqrt[b*c - a*d]*ArcTanh[(Sqrt[b*c - a*d]*x)/(Sqrt[c]*Sqrt[a + b*x^2])])/(Sqrt[c]*d)}
{(a + b*x^2)^(1/2)/(c + d*x^2)^2, x, 3, (x*Sqrt[a + b*x^2])/(2*c*(c + d*x^2)) + (a*ArcTanh[(Sqrt[b*c - a*d]*x)/(Sqrt[c]*Sqrt[a + b*x^2])])/(2*c^(3/2)*Sqrt[b*c - a*d])}
{(a + b*x^2)^(1/2)/(c + d*x^2)^3, x, 4, -((d*x*(a + b*x^2)^(3/2))/(4*c*(b*c - a*d)*(c + d*x^2)^2)) + ((4*b*c - 3*a*d)*x*Sqrt[a + b*x^2])/(8*c^2*(b*c - a*d)*(c + d*x^2)) + (a*(4*b*c - 3*a*d)*ArcTanh[(Sqrt[b*c - a*d]*x)/(Sqrt[c]*Sqrt[a + b*x^2])])/(8*c^(5/2)*(b*c - a*d)^(3/2))}
{(a + b*x^2)^(1/2)/(c + d*x^2)^4, x, 6, (x*Sqrt[a + b*x^2])/(6*c*(c + d*x^2)^3) + ((4*b*c - 5*a*d)*x*Sqrt[a + b*x^2])/(24*c^2*(b*c - a*d)*(c + d*x^2)^2) + ((2*b*c - 5*a*d)*(4*b*c - 3*a*d)*x*Sqrt[a + b*x^2])/(48*c^3*(b*c - a*d)^2*(c + d*x^2)) + (a*(8*b^2*c^2 - 12*a*b*c*d + 5*a^2*d^2)*ArcTanh[(Sqrt[b*c - a*d]*x)/(Sqrt[c]*Sqrt[a + b*x^2])])/(16*c^(7/2)*(b*c - a*d)^(5/2))}
...
{(a + b*x^2)^(3/2)*(c + d*x^2)^2, x, 6, (a*(48*b^2*c^2 - 16*a*b*c*d + 3*a^2*d^2)*x*Sqrt[a + b*x^2])/(128*b^2) + ((48*b^2*c^2 - 16*a*b*c*d + 3*a^2*d^2)*x*(a + b*x^2)^(3/2))/(192*b^2) + (d*(10*b*c - 3*a*d)*x*(a + b*x^2)^(5/2))/(48*b^2) + (d*x*(a + b*x^2)^(5/2)*(c + d*x^2))/(8*b) + (a^2*(48*b^2*c^2 - 16*a*b*c*d + 3*a^2*d^2)*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/(128*b^(5/2))}
{(a + b*x^2)^(3/2)*(c + d*x^2)^1, x, 5, (a*(6*b*c - a*d)*x*Sqrt[a + b*x^2])/(16*b) + ((6*b*c - a*d)*x*(a + b*x^2)^(3/2))/(24*b) + (d*x*(a + b*x^2)^(5/2))/(6*b) + (a^2*(6*b*c - a*d)*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/(16*b^(3/2))}
{(a + b*x^2)^(3/2)*(c + d*x^2)^0, x, 4, (3/8)*a*x*Sqrt[a + b*x^2] + (1/4)*x*(a + b*x^2)^(3/2) + (3*a^2*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/(8*Sqrt[b])}
{(a + b*x^2)^(3/2)/(c + d*x^2)^1, x, 6, (b*x*Sqrt[a + b*x^2])/(2*d) - (Sqrt[b]*(2*b*c - 3*a*d)*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/(2*d^2) + ((b*c - a*d)^(3/2)*ArcTanh[(Sqrt[b*c - a*d]*x)/(Sqrt[c]*Sqrt[a + b*x^2])])/(Sqrt[c]*d^2)}
{(a + b*x^2)^(3/2)/(c + d*x^2)^2, x, 6, -(((b*c - a*d)*x*Sqrt[a + b*x^2])/(2*c*d*(c + d*x^2))) + (b^(3/2)*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/d^2 - (Sqrt[b*c - a*d]*(2*b*c + a*d)*ArcTanh[(Sqrt[b*c - a*d]*x)/(Sqrt[c]*Sqrt[a + b*x^2])])/(2*c^(3/2)*d^2)}
{(a + b*x^2)^(3/2)/(c + d*x^2)^3, x, 4, (x*(a + b*x^2)^(3/2))/(4*c*(c + d*x^2)^2) + (3*a*x*Sqrt[a + b*x^2])/(8*c^2*(c + d*x^2)) + (3*a^2*ArcTanh[(Sqrt[b*c - a*d]*x)/(Sqrt[c]*Sqrt[a + b*x^2])])/(8*c^(5/2)*Sqrt[b*c - a*d])}
{(a + b*x^2)^(3/2)/(c + d*x^2)^4, x, 5, -((d*x*(a + b*x^2)^(5/2))/(6*c*(b*c - a*d)*(c + d*x^2)^3)) + ((6*b*c - 5*a*d)*x*(a + b*x^2)^(3/2))/(24*c^2*(b*c - a*d)*(c + d*x^2)^2) + (a*(6*b*c - 5*a*d)*x*Sqrt[a + b*x^2])/(16*c^3*(b*c - a*d)*(c + d*x^2)) + (a^2*(6*b*c - 5*a*d)*ArcTanh[(Sqrt[b*c - a*d]*x)/(Sqrt[c]*Sqrt[a + b*x^2])])/(16*c^(7/2)*(b*c - a*d)^(3/2))}
...
{(a + b*x^2)^(5/2)*(c + d*x^2)^3, x, 8, (a^2*(320*b^3*c^3 - 120*a*b^2*c^2*d + 36*a^2*b*c*d^2 - 5*a^3*d^3)*x*Sqrt[a + b*x^2])/(1024*b^3) + (a*(320*b^3*c^3 - 120*a*b^2*c^2*d + 36*a^2*b*c*d^2 - 5*a^3*d^3)*x*(a + b*x^2)^(3/2))/(1536*b^3) + ((320*b^3*c^3 - 120*a*b^2*c^2*d + 36*a^2*b*c*d^2 - 5*a^3*d^3)*x*(a + b*x^2)^(5/2))/(1920*b^3) + (d*(152*b^2*c^2 - 68*a*b*c*d + 15*a^2*d^2)*x*(a + b*x^2)^(7/2))/(960*b^3) + (d*(16*b*c - 5*a*d)*x*(a + b*x^2)^(7/2)*(c + d*x^2))/(120*b^2) + (d*x*(a + b*x^2)^(7/2)*(c + d*x^2)^2)/(12*b) + (a^3*(320*b^3*c^3 - 120*a*b^2*c^2*d + 36*a^2*b*c*d^2 - 5*a^3*d^3)*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/(1024*b^(7/2))}
{(a + b*x^2)^(5/2)*(c + d*x^2)^2, x, 7, (a^2*(80*b^2*c^2 - 20*a*b*c*d + 3*a^2*d^2)*x*Sqrt[a + b*x^2])/(256*b^2) + (a*(80*b^2*c^2 - 20*a*b*c*d + 3*a^2*d^2)*x*(a + b*x^2)^(3/2))/(384*b^2) + ((80*b^2*c^2 - 20*a*b*c*d + 3*a^2*d^2)*x*(a + b*x^2)^(5/2))/(480*b^2) + (3*d*(4*b*c - a*d)*x*(a + b*x^2)^(7/2))/(80*b^2) + (d*x*(a + b*x^2)^(7/2)*(c + d*x^2))/(10*b) + (a^3*(80*b^2*c^2 - 20*a*b*c*d + 3*a^2*d^2)*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/(256*b^(5/2))}
{(a + b*x^2)^(5/2)*(c + d*x^2)^1, x, 6, (5*a^2*(8*b*c - a*d)*x*Sqrt[a + b*x^2])/(128*b) + (5*a*(8*b*c - a*d)*x*(a + b*x^2)^(3/2))/(192*b) + ((8*b*c - a*d)*x*(a + b*x^2)^(5/2))/(48*b) + (d*x*(a + b*x^2)^(7/2))/(8*b) + (5*a^3*(8*b*c - a*d)*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/(128*b^(3/2))}
{(a + b*x^2)^(5/2)*(c + d*x^2)^0, x, 5, (5/16)*a^2*x*Sqrt[a + b*x^2] + (5/24)*a*x*(a + b*x^2)^(3/2) + (1/6)*x*(a + b*x^2)^(5/2) + (5*a^3*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/(16*Sqrt[b])}
{(a + b*x^2)^(5/2)/(c + d*x^2)^1, x, 7, -((b*(4*b*c - 7*a*d)*x*Sqrt[a + b*x^2])/(8*d^2)) + (b*x*(a + b*x^2)^(3/2))/(4*d) + (Sqrt[b]*(8*b^2*c^2 - 20*a*b*c*d + 15*a^2*d^2)*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/(8*d^3) - ((b*c - a*d)^(5/2)*ArcTanh[(Sqrt[b*c - a*d]*x)/(Sqrt[c]*Sqrt[a + b*x^2])])/(Sqrt[c]*d^3)}
{(a + b*x^2)^(5/2)/(c + d*x^2)^2, x, 7, (b*(2*b*c - a*d)*x*Sqrt[a + b*x^2])/(2*c*d^2) - ((b*c - a*d)*x*(a + b*x^2)^(3/2))/(2*c*d*(c + d*x^2)) - (b^(3/2)*(4*b*c - 5*a*d)*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/(2*d^3) + ((b*c - a*d)^(3/2)*(4*b*c + a*d)*ArcTanh[(Sqrt[b*c - a*d]*x)/(Sqrt[c]*Sqrt[a + b*x^2])])/(2*c^(3/2)*d^3)}
{(a + b*x^2)^(5/2)/(c + d*x^2)^3, x, 7, -(((b*c - a*d)*x*(a + b*x^2)^(3/2))/(4*c*d*(c + d*x^2)^2)) - ((b*c - a*d)*(4*b*c + 3*a*d)*x*Sqrt[a + b*x^2])/(8*c^2*d^2*(c + d*x^2)) + (b^(5/2)*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/d^3 - (Sqrt[b*c - a*d]*(8*b^2*c^2 + 4*a*b*c*d + 3*a^2*d^2)*ArcTanh[(Sqrt[b*c - a*d]*x)/(Sqrt[c]*Sqrt[a + b*x^2])])/(8*c^(5/2)*d^3)}
{(a + b*x^2)^(5/2)/(c + d*x^2)^4, x, 5, (x*(a + b*x^2)^(5/2))/(6*c*(c + d*x^2)^3) + (5*a*x*(a + b*x^2)^(3/2))/(24*c^2*(c + d*x^2)^2) + (5*a^2*x*Sqrt[a + b*x^2])/(16*c^3*(c + d*x^2)) + (5*a^3*ArcTanh[(Sqrt[b*c - a*d]*x)/(Sqrt[c]*Sqrt[a + b*x^2])])/(16*c^(7/2)*Sqrt[b*c - a*d])}
{(a + b*x^2)^(5/2)/(c + d*x^2)^5, x, 6, -((d*x*(a + b*x^2)^(7/2))/(8*c*(b*c - a*d)*(c + d*x^2)^4)) + ((8*b*c - 7*a*d)*x*(a + b*x^2)^(5/2))/(48*c^2*(b*c - a*d)*(c + d*x^2)^3) + (5*a*(8*b*c - 7*a*d)*x*(a + b*x^2)^(3/2))/(192*c^3*(b*c - a*d)*(c + d*x^2)^2) + (5*a^2*(8*b*c - 7*a*d)*x*Sqrt[a + b*x^2])/(128*c^4*(b*c - a*d)*(c + d*x^2)) + (5*a^3*(8*b*c - 7*a*d)*ArcTanh[(Sqrt[b*c - a*d]*x)/(Sqrt[c]*Sqrt[a + b*x^2])])/(128*c^(9/2)*(b*c - a*d)^(3/2))}


{Sqrt[1 - x^2]/(1 + x^2), x, 4, -ArcSin[x] + Sqrt[2]*ArcTan[(Sqrt[2]*x)/Sqrt[1 - x^2]]}
{Sqrt[1 + x^2]/(-1 + x^2), x, 4, ArcSinh[x] - Sqrt[2]*ArcTanh[(Sqrt[2]*x)/Sqrt[1 + x^2]]}
{Sqrt[1 - x^2]/(-1 + 2*x^2), x, 4, -(ArcSin[x]/2) - (1/2)*ArcTanh[x/Sqrt[1 - x^2]]}
...
{1/(a + b*x^2)^(1/2)*(c + d*x^2)^3, x, 5, (d*(44*b^2*c^2 - 44*a*b*c*d + 15*a^2*d^2)*x*Sqrt[a + b*x^2])/(48*b^3) + (5*d*(2*b*c - a*d)*x*Sqrt[a + b*x^2]*(c + d*x^2))/(24*b^2) + (d*x*Sqrt[a + b*x^2]*(c + d*x^2)^2)/(6*b) + ((2*b*c - a*d)*(8*b^2*c^2 - 8*a*b*c*d + 5*a^2*d^2)*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/(16*b^(7/2))}
{1/(a + b*x^2)^(1/2)*(c + d*x^2)^2, x, 4, (3*d*(2*b*c - a*d)*x*Sqrt[a + b*x^2])/(8*b^2) + (d*x*Sqrt[a + b*x^2]*(c + d*x^2))/(4*b) + ((8*b^2*c^2 - 8*a*b*c*d + 3*a^2*d^2)*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/(8*b^(5/2))}
{1/(a + b*x^2)^(1/2)*(c + d*x^2)^1, x, 3, (d*x*Sqrt[a + b*x^2])/(2*b) + ((2*b*c - a*d)*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/(2*b^(3/2))}
{1/(a + b*x^2)^(1/2)*(c + d*x^2)^0, x, 2, ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]]/Sqrt[b]}
{1/(a + b*x^2)^(1/2)/(c + d*x^2)^1, x, 2, ArcTanh[(Sqrt[b*c - a*d]*x)/(Sqrt[c]*Sqrt[a + b*x^2])]/(Sqrt[c]*Sqrt[b*c - a*d])}
{1/(a + b*x^2)^(1/2)/(c + d*x^2)^2, x, 3, -((d*x*Sqrt[a + b*x^2])/(2*c*(b*c - a*d)*(c + d*x^2))) + ((2*b*c - a*d)*ArcTanh[(Sqrt[b*c - a*d]*x)/(Sqrt[c]*Sqrt[a + b*x^2])])/(2*c^(3/2)*(b*c - a*d)^(3/2))}
{1/(a + b*x^2)^(1/2)/(c + d*x^2)^3, x, 5, -((d*x*Sqrt[a + b*x^2])/(4*c*(b*c - a*d)*(c + d*x^2)^2)) - (3*d*(2*b*c - a*d)*x*Sqrt[a + b*x^2])/(8*c^2*(b*c - a*d)^2*(c + d*x^2)) + ((8*b^2*c^2 - 8*a*b*c*d + 3*a^2*d^2)*ArcTanh[(Sqrt[b*c - a*d]*x)/(Sqrt[c]*Sqrt[a + b*x^2])])/(8*c^(5/2)*(b*c - a*d)^(5/2))}
...
{1/(a + b*x^2)^(3/2)*(c + d*x^2)^3, x, 5, -((d*(2*b*c - 5*a*d)*(4*b*c - 3*a*d)*x*Sqrt[a + b*x^2])/(8*a*b^3)) - (d*(4*b*c - 5*a*d)*x*Sqrt[a + b*x^2]*(c + d*x^2))/(4*a*b^2) + ((b*c - a*d)*x*(c + d*x^2)^2)/(a*b*Sqrt[a + b*x^2]) + (3*d*(8*b^2*c^2 - 12*a*b*c*d + 5*a^2*d^2)*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/(8*b^(7/2))}
{1/(a + b*x^2)^(3/2)*(c + d*x^2)^2, x, 4, ((b*c - a*d)^2*x)/(a*b^2*Sqrt[a + b*x^2]) + (d^2*x*Sqrt[a + b*x^2])/(2*b^2) + (d*(4*b*c - 3*a*d)*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/(2*b^(5/2)), -((d*(2*b*c - 3*a*d)*x*Sqrt[a + b*x^2])/(2*a*b^2)) + ((b*c - a*d)*x*(c + d*x^2))/(a*b*Sqrt[a + b*x^2]) + (d*(4*b*c - 3*a*d)*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/(2*b^(5/2))}
{1/(a + b*x^2)^(3/2)*(c + d*x^2)^1, x, 3, ((b*c - a*d)*x)/(a*b*Sqrt[a + b*x^2]) + (d*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/b^(3/2)}
{1/(a + b*x^2)^(3/2)*(c + d*x^2)^0, x, 1, x/(a*Sqrt[a + b*x^2])}
{1/(a + b*x^2)^(3/2)/(c + d*x^2)^1, x, 3, (b*x)/(a*(b*c - a*d)*Sqrt[a + b*x^2]) - (d*ArcTanh[(Sqrt[b*c - a*d]*x)/(Sqrt[c]*Sqrt[a + b*x^2])])/(Sqrt[c]*(b*c - a*d)^(3/2))}
{1/(a + b*x^2)^(3/2)/(c + d*x^2)^2, x, 5, (b*(2*b*c + a*d)*x)/(2*a*c*(b*c - a*d)^2*Sqrt[a + b*x^2]) - (d*x)/(2*c*(b*c - a*d)*Sqrt[a + b*x^2]*(c + d*x^2)) - (d*(4*b*c - a*d)*ArcTanh[(Sqrt[b*c - a*d]*x)/(Sqrt[c]*Sqrt[a + b*x^2])])/(2*c^(3/2)*(b*c - a*d)^(5/2))}
{1/(a + b*x^2)^(3/2)/(c + d*x^2)^3, x, 6, -((d*x)/(4*c*(b*c - a*d)*Sqrt[a + b*x^2]*(c + d*x^2)^2)) + (b*(4*b*c + a*d)*x)/(4*a*c*(b*c - a*d)^2*Sqrt[a + b*x^2]*(c + d*x^2)) + (d*(4*b*c - a*d)*(2*b*c + 3*a*d)*x*Sqrt[a + b*x^2])/(8*a*c^2*(b*c - a*d)^3*(c + d*x^2)) - (3*d*(8*b^2*c^2 - 4*a*b*c*d + a^2*d^2)*ArcTanh[(Sqrt[b*c - a*d]*x)/(Sqrt[c]*Sqrt[a + b*x^2])])/(8*c^(5/2)*(b*c - a*d)^(7/2))}


{1/(a + b*x^2)^(5/2)*(c + d*x^2)^4, x, 6, -((d*(16*b^3*c^3 + 40*a*b^2*c^2*d - 170*a^2*b*c*d^2 + 105*a^3*d^3)*x*Sqrt[a + b*x^2])/(24*a^2*b^4)) - (d*(8*b^2*c^2 + 24*a*b*c*d - 35*a^2*d^2)*x*Sqrt[a + b*x^2]*(c + d*x^2))/(12*a^2*b^3) + ((b*c - a*d)*(2*b*c + 7*a*d)*x*(c + d*x^2)^2)/(3*a^2*b^2*Sqrt[a + b*x^2]) + ((b*c - a*d)*x*(c + d*x^2)^3)/(3*a*b*(a + b*x^2)^(3/2)) + (d^2*(48*b^2*c^2 - 80*a*b*c*d + 35*a^2*d^2)*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/(8*b^(9/2))}
{1/(a + b*x^2)^(5/2)*(c + d*x^2)^3, x, 5, -((d*(4*b^2*c^2 + 8*a*b*c*d - 15*a^2*d^2)*x*Sqrt[a + b*x^2])/(6*a^2*b^3)) + ((b*c - a*d)*(2*b*c + 5*a*d)*x*(c + d*x^2))/(3*a^2*b^2*Sqrt[a + b*x^2]) + ((b*c - a*d)*x*(c + d*x^2)^2)/(3*a*b*(a + b*x^2)^(3/2)) + (d^2*(6*b*c - 5*a*d)*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/(2*b^(7/2))}
{1/(a + b*x^2)^(5/2)*(c + d*x^2)^2, x, 4, ((b*c - a*d)*(2*b*c + 3*a*d)*x)/(3*a^2*b^2*Sqrt[a + b*x^2]) + ((b*c - a*d)*x*(c + d*x^2))/(3*a*b*(a + b*x^2)^(3/2)) + (d^2*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/b^(5/2)}
{1/(a + b*x^2)^(5/2)*(c + d*x^2)^1, x, 2, (2*c*x)/(3*a^2*Sqrt[a + b*x^2]) + (x*(c + d*x^2))/(3*a*(a + b*x^2)^(3/2))}
{1/(a + b*x^2)^(5/2)*(c + d*x^2)^0, x, 2, x/(3*a*(a + b*x^2)^(3/2)) + (2*x)/(3*a^2*Sqrt[a + b*x^2])}
{1/(a + b*x^2)^(5/2)/(c + d*x^2)^1, x, 5, (b*x)/(3*a*(b*c - a*d)*(a + b*x^2)^(3/2)) + (b*(2*b*c - 5*a*d)*x)/(3*a^2*(b*c - a*d)^2*Sqrt[a + b*x^2]) + (d^2*ArcTanh[(Sqrt[b*c - a*d]*x)/(Sqrt[c]*Sqrt[a + b*x^2])])/(Sqrt[c]*(b*c - a*d)^(5/2))}
{1/(a + b*x^2)^(5/2)/(c + d*x^2)^2, x, 6, (b*(2*b*c + 3*a*d)*x)/(6*a*c*(b*c - a*d)^2*(a + b*x^2)^(3/2)) + (b*(4*b^2*c^2 - 16*a*b*c*d - 3*a^2*d^2)*x)/(6*a^2*c*(b*c - a*d)^3*Sqrt[a + b*x^2]) - (d*x)/(2*c*(b*c - a*d)*(a + b*x^2)^(3/2)*(c + d*x^2)) + (d^2*(6*b*c - a*d)*ArcTanh[(Sqrt[b*c - a*d]*x)/(Sqrt[c]*Sqrt[a + b*x^2])])/(2*c^(3/2)*(b*c - a*d)^(7/2))}
{1/(a + b*x^2)^(5/2)/(c + d*x^2)^3, x, 7, -((d*x)/(4*c*(b*c - a*d)*(a + b*x^2)^(3/2)*(c + d*x^2)^2)) + (b*(4*b*c + 3*a*d)*x)/(12*a*c*(b*c - a*d)^2*(a + b*x^2)^(3/2)*(c + d*x^2)) + (b*(8*b^2*c^2 - 40*a*b*c*d - 3*a^2*d^2)*x)/(12*a^2*c*(b*c - a*d)^3*Sqrt[a + b*x^2]*(c + d*x^2)) + (d*(16*b^3*c^3 - 88*a*b^2*c^2*d - 42*a^2*b*c*d^2 + 9*a^3*d^3)*x*Sqrt[a + b*x^2])/(24*a^2*c^2*(b*c - a*d)^4*(c + d*x^2)) + (d^2*(48*b^2*c^2 - 16*a*b*c*d + 3*a^2*d^2)*ArcTanh[(Sqrt[b*c - a*d]*x)/(Sqrt[c]*Sqrt[a + b*x^2])])/(8*c^(5/2)*(b*c - a*d)^(9/2))}


{(a + b*x^2)^3/(c + d*x^2)^(11/2), x, 5, -((d*x*(a + b*x^2)^4)/(9*c*(b*c - a*d)*(c + d*x^2)^(9/2))) + ((9*b*c - 8*a*d)*x*(a + b*x^2)^3)/(63*c^2*(b*c - a*d)*(c + d*x^2)^(7/2)) + (2*a*(9*b*c - 8*a*d)*x*(a + b*x^2)^2)/(105*c^3*(b*c - a*d)*(c + d*x^2)^(5/2)) + (8*a^2*(9*b*c - 8*a*d)*x*(a + b*x^2))/(315*c^4*(b*c - a*d)*(c + d*x^2)^(3/2)) + (16*a^3*(9*b*c - 8*a*d)*x)/(315*c^5*(b*c - a*d)*Sqrt[c + d*x^2])}
{(a + b*x^2)^2/(c + d*x^2)^(9/2), x, 4, -((d*x*(a + b*x^2)^3)/(7*c*(b*c - a*d)*(c + d*x^2)^(7/2))) + ((7*b*c - 6*a*d)*x*(a + b*x^2)^2)/(35*c^2*(b*c - a*d)*(c + d*x^2)^(5/2)) + (4*a*(7*b*c - 6*a*d)*x*(a + b*x^2))/(105*c^3*(b*c - a*d)*(c + d*x^2)^(3/2)) + (8*a^2*(7*b*c - 6*a*d)*x)/(105*c^4*(b*c - a*d)*Sqrt[c + d*x^2])}
{(a + b*x^2)^1/(c + d*x^2)^(7/2), x, 3, -(((b*c - a*d)*x)/(5*c*d*(c + d*x^2)^(5/2))) + ((b*c + 4*a*d)*x)/(15*c^2*d*(c + d*x^2)^(3/2)) + (2*(b*c + 4*a*d)*x)/(15*c^3*d*Sqrt[c + d*x^2])}
{(a + b*x^2)^0/(c + d*x^2)^(5/2), x, 2, x/(3*c*(c + d*x^2)^(3/2)) + (2*x)/(3*c^2*Sqrt[c + d*x^2])}
{1/((a + b*x^2)^1*(c + d*x^2)^(3/2)), x, 3, -((d*x)/(c*(b*c - a*d)*Sqrt[c + d*x^2])) + (b*ArcTan[(Sqrt[b*c - a*d]*x)/(Sqrt[a]*Sqrt[c + d*x^2])])/(Sqrt[a]*(b*c - a*d)^(3/2))}
{1/((a + b*x^2)^2*(c + d*x^2)^(1/2)), x, 3, (b*x*Sqrt[c + d*x^2])/(2*a*(b*c - a*d)*(a + b*x^2)) + ((b*c - 2*a*d)*ArcTan[(Sqrt[b*c - a*d]*x)/(Sqrt[a]*Sqrt[c + d*x^2])])/(2*a^(3/2)*(b*c - a*d)^(3/2))}
{(c + d*x^2)^(1/2)/(a + b*x^2)^3, x, 4, ((3*b*c - 4*a*d)*x*Sqrt[c + d*x^2])/(8*a^2*(b*c - a*d)*(a + b*x^2)) + (b*x*(c + d*x^2)^(3/2))/(4*a*(b*c - a*d)*(a + b*x^2)^2) + (c*(3*b*c - 4*a*d)*ArcTan[(Sqrt[b*c - a*d]*x)/(Sqrt[a]*Sqrt[c + d*x^2])])/(8*a^(5/2)*(b*c - a*d)^(3/2))}
{(c + d*x^2)^(3/2)/(a + b*x^2)^4, x, 5, (c*(5*b*c - 6*a*d)*x*Sqrt[c + d*x^2])/(16*a^3*(b*c - a*d)*(a + b*x^2)) + ((5*b*c - 6*a*d)*x*(c + d*x^2)^(3/2))/(24*a^2*(b*c - a*d)*(a + b*x^2)^2) + (b*x*(c + d*x^2)^(5/2))/(6*a*(b*c - a*d)*(a + b*x^2)^3) + (c^2*(5*b*c - 6*a*d)*ArcTan[(Sqrt[b*c - a*d]*x)/(Sqrt[a]*Sqrt[c + d*x^2])])/(16*a^(7/2)*(b*c - a*d)^(3/2))}


{1/((b*c/d + b*x^2)*Sqrt[c + d*x^2]), x, 2, (d*x)/(b*c*Sqrt[c + d*x^2])}
{1/((1 + x^2)*Sqrt[1 - x^2]), x, 2, ArcTan[(Sqrt[2]*x)/Sqrt[1 - x^2]]/Sqrt[2]}
{1/((a + b*x^2)*Sqrt[c + d*x^2]), x, 2, ArcTan[(Sqrt[b*c - a*d]*x)/(Sqrt[a]*Sqrt[c + d*x^2])]/(Sqrt[a]*Sqrt[b*c - a*d])}
...
{(a - b*x^2)^(2/3)/(3*a + b*x^2)^1, x, 10, (3*x)/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3)) + (2^(1/3)*Sqrt[a]*(1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(Sqrt[3]*Sqrt[b]*(a - b*x^2)^(1/3)) - (2^(1/3)*Sqrt[a]*(1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(Sqrt[3]*Sqrt[b]*(a - b*x^2)^(1/3)) + (3*3^(1/4)*Sqrt[2 + Sqrt[3]]*a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticE[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(2*b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) - (Sqrt[2]*3^(3/4)*a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticF[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) - (Sqrt[a]*(1 - (b*x^2)/a)^(1/3)*Log[(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3) + 2^(1/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3)])/(2^(2/3)*Sqrt[b]*(a - b*x^2)^(1/3)) + (Sqrt[a]*(1 - (b*x^2)/a)^(1/3)*Log[2^(1/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3) + (1 + (Sqrt[b]*x)/Sqrt[a])^(2/3)])/(2^(2/3)*Sqrt[b]*(a - b*x^2)^(1/3))}
...
{(a - b*x^2)^(2/3)/(3*a + b*x^2)^3, x, 12, (x*(a - b*x^2)^(2/3))/(12*a*(3*a + b*x^2)^2) + (x*(a - b*x^2)^(2/3))/(36*a^2*(3*a + b*x^2)) - x/(36*a^2*((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))) + ((1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(72*2^(2/3)*Sqrt[3]*a^(3/2)*Sqrt[b]*(a - b*x^2)^(1/3)) - ((1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(72*2^(2/3)*Sqrt[3]*a^(3/2)*Sqrt[b]*(a - b*x^2)^(1/3)) - (Sqrt[2 + Sqrt[3]]*(a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticE[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(24*3^(3/4)*a^(5/3)*b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) + ((a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticF[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(18*Sqrt[2]*3^(1/4)*a^(5/3)*b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) - ((1 - (b*x^2)/a)^(1/3)*Log[(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3) + 2^(1/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3)])/(144*2^(2/3)*a^(3/2)*Sqrt[b]*(a - b*x^2)^(1/3)) + ((1 - (b*x^2)/a)^(1/3)*Log[2^(1/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3) + (1 + (Sqrt[b]*x)/Sqrt[a])^(2/3)])/(144*2^(2/3)*a^(3/2)*Sqrt[b]*(a - b*x^2)^(1/3))}
{(a - b*x^2)^(2/3)/(3*a + b*x^2)^4, x, 13, (x*(a - b*x^2)^(2/3))/(18*a*(3*a + b*x^2)^3) + (x*(a - b*x^2)^(2/3))/(54*a^2*(3*a + b*x^2)^2) + (x*(a - b*x^2)^(2/3))/(144*a^3*(3*a + b*x^2)) - x/(144*a^3*((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))) + (7*(1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(1296*2^(2/3)*Sqrt[3]*a^(5/2)*Sqrt[b]*(a - b*x^2)^(1/3)) - (7*(1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(1296*2^(2/3)*Sqrt[3]*a^(5/2)*Sqrt[b]*(a - b*x^2)^(1/3)) - (Sqrt[2 + Sqrt[3]]*(a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticE[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(96*3^(3/4)*a^(8/3)*b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) + ((a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticF[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(72*Sqrt[2]*3^(1/4)*a^(8/3)*b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) - (7*(1 - (b*x^2)/a)^(1/3)*Log[(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3) + 2^(1/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3)])/(2592*2^(2/3)*a^(5/2)*Sqrt[b]*(a - b*x^2)^(1/3)) + (7*(1 - (b*x^2)/a)^(1/3)*Log[2^(1/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3) + (1 + (Sqrt[b]*x)/Sqrt[a])^(2/3)])/(2592*2^(2/3)*a^(5/2)*Sqrt[b]*(a - b*x^2)^(1/3))}
...
{(a - b*x^2)^(5/3)/(3*a + b*x^2)^1, x, 11, (-(3/7))*x*(a - b*x^2)^(2/3) + (96*a*x)/(7*((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))) + (4*2^(1/3)*a^(3/2)*(1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(Sqrt[3]*Sqrt[b]*(a - b*x^2)^(1/3)) - (4*2^(1/3)*a^(3/2)*(1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(Sqrt[3]*Sqrt[b]*(a - b*x^2)^(1/3)) + (48*3^(1/4)*Sqrt[2 + Sqrt[3]]*a^(4/3)*(a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticE[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(7*b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) - (32*Sqrt[2]*3^(3/4)*a^(4/3)*(a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticF[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(7*b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) - (2*2^(1/3)*a^(3/2)*(1 - (b*x^2)/a)^(1/3)*Log[(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3) + 2^(1/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3)])/(Sqrt[b]*(a - b*x^2)^(1/3)) + (2*2^(1/3)*a^(3/2)*(1 - (b*x^2)/a)^(1/3)*Log[2^(1/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3) + (1 + (Sqrt[b]*x)/Sqrt[a])^(2/3)])/(Sqrt[b]*(a - b*x^2)^(1/3))}
{(a - b*x^2)^(5/3)/(3*a + b*x^2)^2, x, 11, (2*x*(a - b*x^2)^(2/3))/(3*(3*a + b*x^2)) - (11*x)/(3*((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))) - (2^(1/3)*Sqrt[a]*(1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(Sqrt[3]*Sqrt[b]*(a - b*x^2)^(1/3)) + (2^(1/3)*Sqrt[a]*(1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(Sqrt[3]*Sqrt[b]*(a - b*x^2)^(1/3)) - (11*Sqrt[2 + Sqrt[3]]*a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticE[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(2*3^(3/4)*b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) + (11*Sqrt[2]*a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticF[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(3*3^(1/4)*b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) + (Sqrt[a]*(1 - (b*x^2)/a)^(1/3)*Log[(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3) + 2^(1/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3)])/(2^(2/3)*Sqrt[b]*(a - b*x^2)^(1/3)) - (Sqrt[a]*(1 - (b*x^2)/a)^(1/3)*Log[2^(1/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3) + (1 + (Sqrt[b]*x)/Sqrt[a])^(2/3)])/(2^(2/3)*Sqrt[b]*(a - b*x^2)^(1/3))}
{(a - b*x^2)^(5/3)/(3*a + b*x^2)^3, x, 5, (x*(a - b*x^2)^(2/3))/(144*a^2) + (x*(a - b*x^2)^(8/3))/(48*a^2*(3*a + b*x^2)^2) + (x*(a - b*x^2)^(5/3))/(36*a^2*(3*a + b*x^2)) + x/(18*a*((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))) + ((1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(18*2^(2/3)*Sqrt[3]*Sqrt[a]*Sqrt[b]*(a - b*x^2)^(1/3)) - ((1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(18*2^(2/3)*Sqrt[3]*Sqrt[a]*Sqrt[b]*(a - b*x^2)^(1/3)) + (3^(1/4)*Sqrt[2 + Sqrt[3]]*(a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticE[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(36*a^(2/3)*b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) - ((a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticF[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(9*Sqrt[2]*3^(1/4)*a^(2/3)*b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) + ((1 - (b*x^2)/a)^(1/3)*Log[(2 - (2*Sqrt[b]*x)/Sqrt[a])^(1/3) + (1 + (Sqrt[b]*x)/Sqrt[a])^(2/3)])/(36*2^(2/3)*Sqrt[a]*Sqrt[b]*(a - b*x^2)^(1/3)) - ((1 - (b*x^2)/a)^(1/3)*Log[(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3) + (2 + (2*Sqrt[b]*x)/Sqrt[a])^(1/3)])/(36*2^(2/3)*Sqrt[a]*Sqrt[b]*(a - b*x^2)^(1/3)), (x*(a - b*x^2)^(2/3))/(3*(3*a + b*x^2)^2) + (4*b*x^3*(1 - (b*x^2)/a)^(1/3)*AppellF1[3/2, 1/3, 2, 5/2, (b*x^2)/a, -((b*x^2)/(3*a))])/(243*a^2*(a - b*x^2)^(1/3))}
...
{1/((-a + b*x^2)^(1/3)*(-3*a - b*x^2)), x, 5, -(((1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(2*2^(2/3)*Sqrt[3]*Sqrt[a]*Sqrt[b]*(-a + b*x^2)^(1/3))) + ((1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(2*2^(2/3)*Sqrt[3]*Sqrt[a]*Sqrt[b]*(-a + b*x^2)^(1/3)) + ((1 - (b*x^2)/a)^(1/3)*Log[(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3) + 2^(1/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3)])/(4*2^(2/3)*Sqrt[a]*Sqrt[b]*(-a + b*x^2)^(1/3)) - ((1 - (b*x^2)/a)^(1/3)*Log[2^(1/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3) + (1 + (Sqrt[b]*x)/Sqrt[a])^(2/3)])/(4*2^(2/3)*Sqrt[a]*Sqrt[b]*(-a + b*x^2)^(1/3))}
{1/((a + b*x^2)^(1/3)*(3*a - b*x^2)), x, 3, -(ArcTan[1/Sqrt[3] + (2^(2/3)*(Sqrt[3]*Sqrt[a] - Sqrt[b]*x))/(3*a^(1/6)*(a + b*x^2)^(1/3))]/(6*2^(2/3)*a^(5/6)*Sqrt[b])) + ArcTan[1/Sqrt[3] + (2^(2/3)*(Sqrt[3]*Sqrt[a] + Sqrt[b]*x))/(3*a^(1/6)*(a + b*x^2)^(1/3))]/(6*2^(2/3)*a^(5/6)*Sqrt[b]) + Log[Sqrt[3] - (Sqrt[b]*x)/Sqrt[a]]/(4*2^(2/3)*Sqrt[3]*a^(5/6)*Sqrt[b]) - Log[Sqrt[3] + (Sqrt[b]*x)/Sqrt[a]]/(4*2^(2/3)*Sqrt[3]*a^(5/6)*Sqrt[b]) + Log[Sqrt[3]*b - (b^(3/2)*x)/Sqrt[a] - (2^(1/3)*Sqrt[3]*b*(a + b*x^2)^(1/3))/a^(1/3)]/(4*2^(2/3)*Sqrt[3]*a^(5/6)*Sqrt[b]) - Log[Sqrt[3]*b + (b^(3/2)*x)/Sqrt[a] - (2^(1/3)*Sqrt[3]*b*(a + b*x^2)^(1/3))/a^(1/3)]/(4*2^(2/3)*Sqrt[3]*a^(5/6)*Sqrt[b])}
...
{1/((3*a + b*x^2)^1*(a - b*x^2)^(1/3)), x, 5, ((1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(2*2^(2/3)*Sqrt[3]*Sqrt[a]*Sqrt[b]*(a - b*x^2)^(1/3)) - ((1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(2*2^(2/3)*Sqrt[3]*Sqrt[a]*Sqrt[b]*(a - b*x^2)^(1/3)) - ((1 - (b*x^2)/a)^(1/3)*Log[(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3) + 2^(1/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3)])/(4*2^(2/3)*Sqrt[a]*Sqrt[b]*(a - b*x^2)^(1/3)) + ((1 - (b*x^2)/a)^(1/3)*Log[2^(1/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3) + (1 + (Sqrt[b]*x)/Sqrt[a])^(2/3)])/(4*2^(2/3)*Sqrt[a]*Sqrt[b]*(a - b*x^2)^(1/3))}
{1/((3*a + b*x^2)^2*(a - b*x^2)^(1/3)), x, 11, (x*(a - b*x^2)^(2/3))/(24*a^2*(3*a + b*x^2)) - x/(24*a^2*((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))) + ((1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(8*2^(2/3)*Sqrt[3]*a^(3/2)*Sqrt[b]*(a - b*x^2)^(1/3)) - ((1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(8*2^(2/3)*Sqrt[3]*a^(3/2)*Sqrt[b]*(a - b*x^2)^(1/3)) - (Sqrt[2 + Sqrt[3]]*(a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticE[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(16*3^(3/4)*a^(5/3)*b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) + ((a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticF[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(12*Sqrt[2]*3^(1/4)*a^(5/3)*b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) - ((1 - (b*x^2)/a)^(1/3)*Log[(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3) + 2^(1/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3)])/(16*2^(2/3)*a^(3/2)*Sqrt[b]*(a - b*x^2)^(1/3)) + ((1 - (b*x^2)/a)^(1/3)*Log[2^(1/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3) + (1 + (Sqrt[b]*x)/Sqrt[a])^(2/3)])/(16*2^(2/3)*a^(3/2)*Sqrt[b]*(a - b*x^2)^(1/3))}
{1/((3*a + b*x^2)^3*(a - b*x^2)^(1/3)), x, 12, (x*(a - b*x^2)^(2/3))/(48*a^2*(3*a + b*x^2)^2) + (5*x*(a - b*x^2)^(2/3))/(288*a^3*(3*a + b*x^2)) - (5*x)/(288*a^3*((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))) + (5*(1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(144*2^(2/3)*Sqrt[3]*a^(5/2)*Sqrt[b]*(a - b*x^2)^(1/3)) - (5*(1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(144*2^(2/3)*Sqrt[3]*a^(5/2)*Sqrt[b]*(a - b*x^2)^(1/3)) - (5*Sqrt[2 + Sqrt[3]]*(a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticE[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(192*3^(3/4)*a^(8/3)*b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) + (5*(a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticF[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(144*Sqrt[2]*3^(1/4)*a^(8/3)*b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) - (5*(1 - (b*x^2)/a)^(1/3)*Log[(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3) + 2^(1/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3)])/(288*2^(2/3)*a^(5/2)*Sqrt[b]*(a - b*x^2)^(1/3)) + (5*(1 - (b*x^2)/a)^(1/3)*Log[2^(1/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3) + (1 + (Sqrt[b]*x)/Sqrt[a])^(2/3)])/(288*2^(2/3)*a^(5/2)*Sqrt[b]*(a - b*x^2)^(1/3))}
...
{1/((3*a + b*x^2)^1*(a - b*x^2)^(4/3)), x, 11, (3*x)/(8*a^2*(a - b*x^2)^(1/3)) + (3*x)/(8*a^2*((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))) + ((1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(8*2^(2/3)*Sqrt[3]*a^(3/2)*Sqrt[b]*(a - b*x^2)^(1/3)) - ((1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(8*2^(2/3)*Sqrt[3]*a^(3/2)*Sqrt[b]*(a - b*x^2)^(1/3)) + (3*3^(1/4)*Sqrt[2 + Sqrt[3]]*(a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticE[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(16*a^(5/3)*b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) - (3^(3/4)*(a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticF[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(4*Sqrt[2]*a^(5/3)*b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) - ((1 - (b*x^2)/a)^(1/3)*Log[(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3) + 2^(1/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3)])/(16*2^(2/3)*a^(3/2)*Sqrt[b]*(a - b*x^2)^(1/3)) + ((1 - (b*x^2)/a)^(1/3)*Log[2^(1/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3) + (1 + (Sqrt[b]*x)/Sqrt[a])^(2/3)])/(16*2^(2/3)*a^(3/2)*Sqrt[b]*(a - b*x^2)^(1/3))}
{1/((3*a + b*x^2)^2*(a - b*x^2)^(4/3)), x, 12, x/(12*a^3*(a - b*x^2)^(1/3)) + x/(24*a^2*(a - b*x^2)^(1/3)*(3*a + b*x^2)) + x/(12*a^3*((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))) + ((1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(16*2^(2/3)*Sqrt[3]*a^(5/2)*Sqrt[b]*(a - b*x^2)^(1/3)) - ((1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(16*2^(2/3)*Sqrt[3]*a^(5/2)*Sqrt[b]*(a - b*x^2)^(1/3)) + (Sqrt[2 + Sqrt[3]]*(a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticE[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(8*3^(3/4)*a^(8/3)*b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) - ((a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticF[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(6*Sqrt[2]*3^(1/4)*a^(8/3)*b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) - ((1 - (b*x^2)/a)^(1/3)*Log[(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3) + 2^(1/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3)])/(32*2^(2/3)*a^(5/2)*Sqrt[b]*(a - b*x^2)^(1/3)) + ((1 - (b*x^2)/a)^(1/3)*Log[2^(1/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3) + (1 + (Sqrt[b]*x)/Sqrt[a])^(2/3)])/(32*2^(2/3)*a^(5/2)*Sqrt[b]*(a - b*x^2)^(1/3))}
{1/((3*a + b*x^2)^3*(a - b*x^2)^(4/3)), x, 13, x/(48*a^2*(a - b*x^2)^(1/3)*(3*a + b*x^2)^2) + (17*x)/(192*a^3*(a - b*x^2)^(1/3)*(3*a + b*x^2)) - (19*x*(a - b*x^2)^(2/3))/(1152*a^4*(3*a + b*x^2)) + (19*x)/(1152*a^4*((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))) + (7*(1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(288*2^(2/3)*Sqrt[3]*a^(7/2)*Sqrt[b]*(a - b*x^2)^(1/3)) - (7*(1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(288*2^(2/3)*Sqrt[3]*a^(7/2)*Sqrt[b]*(a - b*x^2)^(1/3)) + (19*Sqrt[2 + Sqrt[3]]*(a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticE[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(768*3^(3/4)*a^(11/3)*b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) - (19*(a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticF[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(576*Sqrt[2]*3^(1/4)*a^(11/3)*b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) - (7*(1 - (b*x^2)/a)^(1/3)*Log[(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3) + 2^(1/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3)])/(576*2^(2/3)*a^(7/2)*Sqrt[b]*(a - b*x^2)^(1/3)) + (7*(1 - (b*x^2)/a)^(1/3)*Log[2^(1/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3) + (1 + (Sqrt[b]*x)/Sqrt[a])^(2/3)])/(576*2^(2/3)*a^(7/2)*Sqrt[b]*(a - b*x^2)^(1/3))}
...
{(3*a + b*x^2)^2/(a - b*x^2)^(7/3), x, 2, (9*x)/(2*(a - b*x^2)^(1/3)) + (3*x*(3*a + b*x^2))/(2*(a - b*x^2)^(4/3))}
...
{1/((3*a + b*x^2)^1*(a - b*x^2)^(7/3)), x, 12, (3*x)/(32*a^2*(a - b*x^2)^(4/3)) + (21*x)/(64*a^3*(a - b*x^2)^(1/3)) + (21*x)/(64*a^3*((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))) + ((1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(32*2^(2/3)*Sqrt[3]*a^(5/2)*Sqrt[b]*(a - b*x^2)^(1/3)) - ((1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(32*2^(2/3)*Sqrt[3]*a^(5/2)*Sqrt[b]*(a - b*x^2)^(1/3)) + (21*3^(1/4)*Sqrt[2 + Sqrt[3]]*(a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticE[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(128*a^(8/3)*b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) - (7*3^(3/4)*(a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticF[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(32*Sqrt[2]*a^(8/3)*b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) - ((1 - (b*x^2)/a)^(1/3)*Log[(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3) + 2^(1/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3)])/(64*2^(2/3)*a^(5/2)*Sqrt[b]*(a - b*x^2)^(1/3)) + ((1 - (b*x^2)/a)^(1/3)*Log[2^(1/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3) + (1 + (Sqrt[b]*x)/Sqrt[a])^(2/3)])/(64*2^(2/3)*a^(5/2)*Sqrt[b]*(a - b*x^2)^(1/3))}
{1/((3*a + b*x^2)^2*(a - b*x^2)^(7/3)), x, 13, (5*x)/(384*a^3*(a - b*x^2)^(4/3)) + (79*x)/(768*a^4*(a - b*x^2)^(1/3)) + x/(24*a^2*(a - b*x^2)^(4/3)*(3*a + b*x^2)) + (79*x)/(768*a^4*((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))) + (Sqrt[3]*(1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(128*2^(2/3)*a^(7/2)*Sqrt[b]*(a - b*x^2)^(1/3)) - (Sqrt[3]*(1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(128*2^(2/3)*a^(7/2)*Sqrt[b]*(a - b*x^2)^(1/3)) + (79*Sqrt[2 + Sqrt[3]]*(a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticE[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(512*3^(3/4)*a^(11/3)*b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) - (79*(a^(1/3) - (a - b*x^2)^(1/3))*Sqrt[(a^(2/3) + a^(1/3)*(a - b*x^2)^(1/3) + (a - b*x^2)^(2/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2]*EllipticF[ArcSin[((1 + Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))], -7 + 4*Sqrt[3]])/(384*Sqrt[2]*3^(1/4)*a^(11/3)*b*x*Sqrt[-((a^(1/3)*(a^(1/3) - (a - b*x^2)^(1/3)))/((1 - Sqrt[3])*a^(1/3) - (a - b*x^2)^(1/3))^2)]) - (3*(1 - (b*x^2)/a)^(1/3)*Log[(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3) + 2^(1/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3)])/(256*2^(2/3)*a^(7/2)*Sqrt[b]*(a - b*x^2)^(1/3)) + (3*(1 - (b*x^2)/a)^(1/3)*Log[2^(1/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3) + (1 + (Sqrt[b]*x)/Sqrt[a])^(2/3)])/(256*2^(2/3)*a^(7/2)*Sqrt[b]*(a - b*x^2)^(1/3))}


{1/((1 - x^2)^(1/3)*(3 + x^2)), x, 3, ArcTan[1/Sqrt[3] - (2^(2/3)*(1 - x)^(2/3))/(Sqrt[3]*(1 + x)^(1/3))]/(2*2^(2/3)*Sqrt[3]) - ArcTan[1/Sqrt[3] - (2^(2/3)*(1 + x)^(2/3))/(Sqrt[3]*(1 - x)^(1/3))]/(2*2^(2/3)*Sqrt[3]) - Log[(1 - x)^(2/3) + 2^(1/3)*(1 + x)^(1/3)]/(4*2^(2/3)) + Log[2^(1/3)*(1 - x)^(1/3) + (1 + x)^(2/3)]/(4*2^(2/3))}


{1/((1 + x^2)^(1/3)*(3 - x^2)), x, 3, -(ArcTan[1/Sqrt[3] + (2^(2/3)*(Sqrt[3] - x))/(3*(1 + x^2)^(1/3))]/(6*2^(2/3))) + ArcTan[1/Sqrt[3] + (2^(2/3)*(Sqrt[3] + x))/(3*(1 + x^2)^(1/3))]/(6*2^(2/3)) + Log[Sqrt[3] - x]/(4*2^(2/3)*Sqrt[3]) - Log[Sqrt[3] + x]/(4*2^(2/3)*Sqrt[3]) + Log[Sqrt[3] - x - 2^(1/3)*Sqrt[3]*(1 + x^2)^(1/3)]/(4*2^(2/3)*Sqrt[3]) - Log[Sqrt[3] + x - 2^(1/3)*Sqrt[3]*(1 + x^2)^(1/3)]/(4*2^(2/3)*Sqrt[3])}


{1/((a + b*x^2)^(1/3)*(3*a - b*x^2)), x, 3, -(ArcTan[1/Sqrt[3] + (2^(2/3)*(Sqrt[3]*Sqrt[a] - Sqrt[b]*x))/(3*a^(1/6)*(a + b*x^2)^(1/3))]/(6*2^(2/3)*a^(5/6)*Sqrt[b])) + ArcTan[1/Sqrt[3] + (2^(2/3)*(Sqrt[3]*Sqrt[a] + Sqrt[b]*x))/(3*a^(1/6)*(a + b*x^2)^(1/3))]/(6*2^(2/3)*a^(5/6)*Sqrt[b]) + Log[Sqrt[3] - (Sqrt[b]*x)/Sqrt[a]]/(4*2^(2/3)*Sqrt[3]*a^(5/6)*Sqrt[b]) - Log[Sqrt[3] + (Sqrt[b]*x)/Sqrt[a]]/(4*2^(2/3)*Sqrt[3]*a^(5/6)*Sqrt[b]) + Log[Sqrt[3]*b - (b^(3/2)*x)/Sqrt[a] - (2^(1/3)*Sqrt[3]*b*(a + b*x^2)^(1/3))/a^(1/3)]/(4*2^(2/3)*Sqrt[3]*a^(5/6)*Sqrt[b]) - Log[Sqrt[3]*b + (b^(3/2)*x)/Sqrt[a] - (2^(1/3)*Sqrt[3]*b*(a + b*x^2)^(1/3))/a^(1/3)]/(4*2^(2/3)*Sqrt[3]*a^(5/6)*Sqrt[b])}
{1/((c + 3*d*x^2)^(1/3)*(c - d*x^2)), x, 3, -(ArcTan[1/Sqrt[3] + (2^(2/3)*(Sqrt[c] - Sqrt[d]*x))/(Sqrt[3]*c^(1/6)*(c + 3*d*x^2)^(1/3))]/(2*2^(2/3)*Sqrt[3]*c^(5/6)*Sqrt[d])) + ArcTan[1/Sqrt[3] + (2^(2/3)*(Sqrt[c] + Sqrt[d]*x))/(Sqrt[3]*c^(1/6)*(c + 3*d*x^2)^(1/3))]/(2*2^(2/3)*Sqrt[3]*c^(5/6)*Sqrt[d]) + Log[Sqrt[3] - (Sqrt[3]*Sqrt[d]*x)/Sqrt[c]]/(4*2^(2/3)*c^(5/6)*Sqrt[d]) - Log[Sqrt[3] + (Sqrt[3]*Sqrt[d]*x)/Sqrt[c]]/(4*2^(2/3)*c^(5/6)*Sqrt[d]) + Log[3*Sqrt[3]*d - (3*Sqrt[3]*d^(3/2)*x)/Sqrt[c] - (3*2^(1/3)*Sqrt[3]*d*(c + 3*d*x^2)^(1/3))/c^(1/3)]/(4*2^(2/3)*c^(5/6)*Sqrt[d]) - Log[3*Sqrt[3]*d + (3*Sqrt[3]*d^(3/2)*x)/Sqrt[c] - (3*2^(1/3)*Sqrt[3]*d*(c + 3*d*x^2)^(1/3))/c^(1/3)]/(4*2^(2/3)*c^(5/6)*Sqrt[d])}


{1/((a - b*x^2)^(1/3)*(3*a + b*x^2)), x, 5, ((1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(2*2^(2/3)*Sqrt[3]*Sqrt[a]*Sqrt[b]*(a - b*x^2)^(1/3)) - ((1 - (b*x^2)/a)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(2/3))/(Sqrt[3]*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3))])/(2*2^(2/3)*Sqrt[3]*Sqrt[a]*Sqrt[b]*(a - b*x^2)^(1/3)) - ((1 - (b*x^2)/a)^(1/3)*Log[(1 - (Sqrt[b]*x)/Sqrt[a])^(2/3) + 2^(1/3)*(1 + (Sqrt[b]*x)/Sqrt[a])^(1/3)])/(4*2^(2/3)*Sqrt[a]*Sqrt[b]*(a - b*x^2)^(1/3)) + ((1 - (b*x^2)/a)^(1/3)*Log[2^(1/3)*(1 - (Sqrt[b]*x)/Sqrt[a])^(1/3) + (1 + (Sqrt[b]*x)/Sqrt[a])^(2/3)])/(4*2^(2/3)*Sqrt[a]*Sqrt[b]*(a - b*x^2)^(1/3))}
{1/((c - 3*d*x^2)^(1/3)*(c + d*x^2)), x, 5, ((1 - (3*d*x^2)/c)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 - (Sqrt[3]*Sqrt[d]*x)/Sqrt[c])^(2/3))/(Sqrt[3]*(1 + (Sqrt[3]*Sqrt[d]*x)/Sqrt[c])^(1/3))])/(2*2^(2/3)*Sqrt[c]*Sqrt[d]*(c - 3*d*x^2)^(1/3)) - ((1 - (3*d*x^2)/c)^(1/3)*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 + (Sqrt[3]*Sqrt[d]*x)/Sqrt[c])^(2/3))/(Sqrt[3]*(1 - (Sqrt[3]*Sqrt[d]*x)/Sqrt[c])^(1/3))])/(2*2^(2/3)*Sqrt[c]*Sqrt[d]*(c - 3*d*x^2)^(1/3)) - (Sqrt[3]*(1 - (3*d*x^2)/c)^(1/3)*Log[(1 - (Sqrt[3]*Sqrt[d]*x)/Sqrt[c])^(2/3) + 2^(1/3)*(1 + (Sqrt[3]*Sqrt[d]*x)/Sqrt[c])^(1/3)])/(4*2^(2/3)*Sqrt[c]*Sqrt[d]*(c - 3*d*x^2)^(1/3)) + (Sqrt[3]*(1 - (3*d*x^2)/c)^(1/3)*Log[2^(1/3)*(1 - (Sqrt[3]*Sqrt[d]*x)/Sqrt[c])^(1/3) + (1 + (Sqrt[3]*Sqrt[d]*x)/Sqrt[c])^(2/3)])/(4*2^(2/3)*Sqrt[c]*Sqrt[d]*(c - 3*d*x^2)^(1/3))}


{(3 - x)/((1 - x^2)^(1/3)*(3 + x^2)), x, 1, -((Sqrt[3]*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 + x)^(2/3))/(Sqrt[3]*(1 - x)^(1/3))])/2^(2/3)) - Log[3 + x^2]/(2*2^(2/3)) + (3*Log[2^(1/3)*(1 - x)^(1/3) + (1 + x)^(2/3)])/(2*2^(2/3))}
{(3 + x)/((1 - x^2)^(1/3)*(3 + x^2)), x, 1, (Sqrt[3]*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 - x)^(2/3))/(Sqrt[3]*(1 + x)^(1/3))])/2^(2/3) + Log[3 + x^2]/(2*2^(2/3)) - (3*Log[(1 - x)^(2/3) + 2^(1/3)*(1 + x)^(1/3)])/(2*2^(2/3))}


{1/((3 - x^2)*(1 + x^2)^(1/3)), x, 3, -(ArcTan[1/Sqrt[3] + (2^(2/3)*(Sqrt[3] - x))/(3*(1 + x^2)^(1/3))]/(6*2^(2/3))) + ArcTan[1/Sqrt[3] + (2^(2/3)*(Sqrt[3] + x))/(3*(1 + x^2)^(1/3))]/(6*2^(2/3)) + Log[Sqrt[3] - x]/(4*2^(2/3)*Sqrt[3]) - Log[Sqrt[3] + x]/(4*2^(2/3)*Sqrt[3]) + Log[Sqrt[3] - x - 2^(1/3)*Sqrt[3]*(1 + x^2)^(1/3)]/(4*2^(2/3)*Sqrt[3]) - Log[Sqrt[3] + x - 2^(1/3)*Sqrt[3]*(1 + x^2)^(1/3)]/(4*2^(2/3)*Sqrt[3])}
...
{(a + b*x^2)^(3/2)*Sqrt[c + d*x^2], x, 6, ((7*a*c - (2*b*c^2)/d + (3*a^2*d)/b)*x*Sqrt[a + b*x^2])/(15*Sqrt[c + d*x^2]) - (2*(b*c - 3*a*d)*x*Sqrt[a + b*x^2]*Sqrt[c + d*x^2])/(15*d) + (b*x*Sqrt[a + b*x^2]*(c + d*x^2)^(3/2))/(5*d) + (Sqrt[c]*(2*b^2*c^2 - 7*a*b*c*d - 3*a^2*d^2)*Sqrt[a + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(15*b*d^(3/2)*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2]) - (c^(3/2)*(b*c - 9*a*d)*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(15*d^(3/2)*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{(a + b*x^2)^(1/2)*Sqrt[c + d*x^2], x, 5, ((b*c + a*d)*x*Sqrt[a + b*x^2])/(3*b*Sqrt[c + d*x^2]) + (1/3)*x*Sqrt[a + b*x^2]*Sqrt[c + d*x^2] - (Sqrt[c]*(b*c + a*d)*Sqrt[a + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(3*b*Sqrt[d]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2]) + (2*c^(3/2)*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(3*Sqrt[d]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{Sqrt[c + d*x^2]/(a + b*x^2)^(1/2), x, 4, (d*x*Sqrt[a + b*x^2])/(b*Sqrt[c + d*x^2]) - (Sqrt[c]*Sqrt[d]*Sqrt[a + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(b*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2]) + (c^(3/2)*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(a*Sqrt[d]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{Sqrt[c + d*x^2]/(a + b*x^2)^(3/2), x, 1, (Sqrt[c + d*x^2]*EllipticE[ArcTan[(Sqrt[b]*x)/Sqrt[a]], 1 - (a*d)/(b*c)])/(Sqrt[a]*Sqrt[b]*Sqrt[a + b*x^2]*Sqrt[(a*(c + d*x^2))/(c*(a + b*x^2))])}
{Sqrt[c + d*x^2]/(a + b*x^2)^(5/2), x, 4, (x*Sqrt[c + d*x^2])/(3*a*(a + b*x^2)^(3/2)) + ((2*b*c - a*d)*Sqrt[c + d*x^2]*EllipticE[ArcTan[(Sqrt[b]*x)/Sqrt[a]], 1 - (a*d)/(b*c)])/(3*a^(3/2)*Sqrt[b]*(b*c - a*d)*Sqrt[a + b*x^2]*Sqrt[(a*(c + d*x^2))/(c*(a + b*x^2))]) - (c^(3/2)*Sqrt[d]*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(3*a^2*(b*c - a*d)*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{Sqrt[c + d*x^2]/(a + b*x^2)^(7/2), x, 5, (x*Sqrt[c + d*x^2])/(5*a*(a + b*x^2)^(5/2)) + ((4*b*c - 3*a*d)*x*Sqrt[c + d*x^2])/(15*a^2*(b*c - a*d)*(a + b*x^2)^(3/2)) + ((8*b^2*c^2 - 13*a*b*c*d + 3*a^2*d^2)*Sqrt[c + d*x^2]*EllipticE[ArcTan[(Sqrt[b]*x)/Sqrt[a]], 1 - (a*d)/(b*c)])/(15*a^(5/2)*Sqrt[b]*(b*c - a*d)^2*Sqrt[a + b*x^2]*Sqrt[(a*(c + d*x^2))/(c*(a + b*x^2))]) - (2*c^(3/2)*Sqrt[d]*(2*b*c - 3*a*d)*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(15*a^3*(b*c - a*d)^2*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}


{(a + b*x^2)^(3/2)*(c + d*x^2)^(3/2), x, 7, -((2*(b*c + a*d)*(b^2*c^2 - 6*a*b*c*d + a^2*d^2)*x*Sqrt[a + b*x^2])/(35*b^2*d*Sqrt[c + d*x^2])) + (1/35)*(9*a*c + (b*c^2)/d - (2*a^2*d)/b)*x*Sqrt[a + b*x^2]*Sqrt[c + d*x^2] + (2*(4*b*c - a*d)*x*(a + b*x^2)^(3/2)*Sqrt[c + d*x^2])/(35*b) + (d*x*(a + b*x^2)^(5/2)*Sqrt[c + d*x^2])/(7*b) + (2*Sqrt[c]*(b*c + a*d)*(b^2*c^2 - 6*a*b*c*d + a^2*d^2)*Sqrt[a + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(35*b^2*d^(3/2)*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2]) - (c^(3/2)*(b^2*c^2 - 18*a*b*c*d + a^2*d^2)*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(35*b*d^(3/2)*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{(a + b*x^2)^(1/2)*(c + d*x^2)^(3/2), x, 6, ((3*b^2*c^2 + 7*a*b*c*d - 2*a^2*d^2)*x*Sqrt[a + b*x^2])/(15*b^2*Sqrt[c + d*x^2]) + (2*(3*b*c - a*d)*x*Sqrt[a + b*x^2]*Sqrt[c + d*x^2])/(15*b) + (d*x*(a + b*x^2)^(3/2)*Sqrt[c + d*x^2])/(5*b) - (Sqrt[c]*(3*b^2*c^2 + 7*a*b*c*d - 2*a^2*d^2)*Sqrt[a + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(15*b^2*Sqrt[d]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2]) + (c^(3/2)*(9*b*c - a*d)*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(15*b*Sqrt[d]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{(c + d*x^2)^(3/2)/(a + b*x^2)^(1/2), x, 5, (2*d*(2*b*c - a*d)*x*Sqrt[a + b*x^2])/(3*b^2*Sqrt[c + d*x^2]) + (d*x*Sqrt[a + b*x^2]*Sqrt[c + d*x^2])/(3*b) - (2*Sqrt[c]*Sqrt[d]*(2*b*c - a*d)*Sqrt[a + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(3*b^2*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2]) + (c^(3/2)*(3*b*c - a*d)*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(3*a*b*Sqrt[d]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{(c + d*x^2)^(3/2)/(a + b*x^2)^(3/2), x, 5, -((d*(b*c - 2*a*d)*x*Sqrt[a + b*x^2])/(a*b^2*Sqrt[c + d*x^2])) + ((b*c - a*d)*x*Sqrt[c + d*x^2])/(a*b*Sqrt[a + b*x^2]) + (Sqrt[c]*Sqrt[d]*(b*c - 2*a*d)*Sqrt[a + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(a*b^2*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2]) + (c^(3/2)*Sqrt[d]*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(a*b*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{(c + d*x^2)^(3/2)/(a + b*x^2)^(5/2), x, 4, ((b*c - a*d)*x*Sqrt[c + d*x^2])/(3*a*b*(a + b*x^2)^(3/2)) + (2*(b*c + a*d)*Sqrt[c + d*x^2]*EllipticE[ArcTan[(Sqrt[b]*x)/Sqrt[a]], 1 - (a*d)/(b*c)])/(3*a^(3/2)*b^(3/2)*Sqrt[a + b*x^2]*Sqrt[(a*(c + d*x^2))/(c*(a + b*x^2))]) - (c^(3/2)*Sqrt[d]*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(3*a^2*b*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{(c + d*x^2)^(3/2)/(a + b*x^2)^(7/2), x, 5, ((b*c - a*d)*x*Sqrt[c + d*x^2])/(5*a*b*(a + b*x^2)^(5/2)) + (2*(2*b*c + a*d)*x*Sqrt[c + d*x^2])/(15*a^2*b*(a + b*x^2)^(3/2)) + ((8*b^2*c^2 - 3*a*b*c*d - 2*a^2*d^2)*Sqrt[c + d*x^2]*EllipticE[ArcTan[(Sqrt[b]*x)/Sqrt[a]], 1 - (a*d)/(b*c)])/(15*a^(5/2)*b^(3/2)*(b*c - a*d)*Sqrt[a + b*x^2]*Sqrt[(a*(c + d*x^2))/(c*(a + b*x^2))]) - (c^(3/2)*Sqrt[d]*(4*b*c - a*d)*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(15*a^3*b*(b*c - a*d)*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}


{Sqrt[2 + b*x^2]*Sqrt[3 + d*x^2], x, 5, ((3*b + 2*d)*x*Sqrt[2 + b*x^2])/(3*b*Sqrt[3 + d*x^2]) + (1/3)*x*Sqrt[2 + b*x^2]*Sqrt[3 + d*x^2] - (Sqrt[2]*(3*b + 2*d)*Sqrt[2 + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[3]], 1 - (3*b)/(2*d)])/(3*b*Sqrt[d]*Sqrt[(2 + b*x^2)/(3 + d*x^2)]*Sqrt[3 + d*x^2]) + (2*Sqrt[2]*Sqrt[2 + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[3]], 1 - (3*b)/(2*d)])/(Sqrt[d]*Sqrt[(2 + b*x^2)/(3 + d*x^2)]*Sqrt[3 + d*x^2])}
...
{Sqrt[2 + b*x^2]/Sqrt[3 + d*x^2], x, 4, (x*Sqrt[2 + b*x^2])/Sqrt[3 + d*x^2] - (Sqrt[2]*Sqrt[2 + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[3]], 1 - (3*b)/(2*d)])/(Sqrt[d]*Sqrt[(2 + b*x^2)/(3 + d*x^2)]*Sqrt[3 + d*x^2]) + (Sqrt[2]*Sqrt[2 + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[3]], 1 - (3*b)/(2*d)])/(Sqrt[d]*Sqrt[(2 + b*x^2)/(3 + d*x^2)]*Sqrt[3 + d*x^2])}
{Sqrt[4 - x^2]/Sqrt[c + d*x^2], x, 5, -((Sqrt[c + d*x^2]*EllipticE[ArcSin[x/2], -((4*d)/c)])/(d*Sqrt[1 + (d*x^2)/c])) + ((c + 4*d)*Sqrt[1 + (d*x^2)/c]*EllipticF[ArcSin[x/2], -((4*d)/c)])/(d*Sqrt[c + d*x^2])}
{Sqrt[4 + x^2]/Sqrt[c + d*x^2], x, 4, (x*Sqrt[c + d*x^2])/(d*Sqrt[4 + x^2]) - (Sqrt[c + d*x^2]*EllipticE[ArcTan[x/2], 1 - (4*d)/c])/(d*Sqrt[4 + x^2]*Sqrt[(c + d*x^2)/(c*(4 + x^2))]) + (4*Sqrt[c + d*x^2]*EllipticF[ArcTan[x/2], 1 - (4*d)/c])/(c*Sqrt[4 + x^2]*Sqrt[(c + d*x^2)/(c*(4 + x^2))])}
...
{Sqrt[1 - x^2]/Sqrt[1 + x^2], x, 4, -EllipticE[ArcSin[x], -1] + 2*EllipticF[ArcSin[x], -1]}
{Sqrt[1 - x^2]/Sqrt[2 + 3*x^2], x, 3, (-(1/3))*Sqrt[2]*EllipticE[ArcSin[x], -(3/2)] + (5*EllipticF[ArcSin[x], -(3/2)])/(3*Sqrt[2])}
{Sqrt[4 - x^2]/Sqrt[2 + 3*x^2], x, 3, (-(1/3))*Sqrt[2]*EllipticE[ArcSin[x/2], -6] + (7/3)*Sqrt[2]*EllipticF[ArcSin[x/2], -6]}
{Sqrt[1 - 4*x^2]/Sqrt[2 + 3*x^2], x, 3, (-(2/3))*Sqrt[2]*EllipticE[ArcSin[2*x], -(3/8)] + (11*EllipticF[ArcSin[2*x], -(3/8)])/(6*Sqrt[2])}

{Sqrt[1 + x^2]/Sqrt[2 + 3*x^2], x, 4, (x*Sqrt[2 + 3*x^2])/(3*Sqrt[1 + x^2]) - (Sqrt[2]*Sqrt[2 + 3*x^2]*EllipticE[ArcTan[x], -(1/2)])/(3*Sqrt[1 + x^2]*Sqrt[(2 + 3*x^2)/(1 + x^2)]) + (Sqrt[2 + 3*x^2]*EllipticF[ArcTan[x], -(1/2)])/(Sqrt[2]*Sqrt[1 + x^2]*Sqrt[(2 + 3*x^2)/(1 + x^2)])}
{Sqrt[4 + x^2]/Sqrt[2 + 3*x^2], x, 4, (x*Sqrt[2 + 3*x^2])/(3*Sqrt[4 + x^2]) - (Sqrt[2]*Sqrt[2 + 3*x^2]*EllipticE[ArcTan[x/2], -5])/(3*Sqrt[4 + x^2]*Sqrt[(2 + 3*x^2)/(4 + x^2)]) + (2*Sqrt[2]*Sqrt[2 + 3*x^2]*EllipticF[ArcTan[x/2], -5])/(Sqrt[4 + x^2]*Sqrt[(2 + 3*x^2)/(4 + x^2)])}
{Sqrt[1 + 4*x^2]/Sqrt[2 + 3*x^2], x, 4, (4*x*Sqrt[2 + 3*x^2])/(3*Sqrt[1 + 4*x^2]) - (2*Sqrt[2]*Sqrt[2 + 3*x^2]*EllipticE[ArcTan[2*x], 5/8])/(3*Sqrt[(2 + 3*x^2)/(1 + 4*x^2)]*Sqrt[1 + 4*x^2]) + (Sqrt[2 + 3*x^2]*EllipticF[ArcTan[2*x], 5/8])/(2*Sqrt[2]*Sqrt[(2 + 3*x^2)/(1 + 4*x^2)]*Sqrt[1 + 4*x^2])}

{Sqrt[1 - x^2]/Sqrt[-1 + 2*x^2], x, 2, (Sqrt[1 - 2*x^2]*EllipticE[ArcSin[Sqrt[2]*x], 1/2])/(Sqrt[2]*Sqrt[-1 + 2*x^2])}
...
{(a + b*x^2)^(7/2)/Sqrt[c + d*x^2], x, 7, -((8*(b*c - 2*a*d)*(6*b^2*c^2 - 11*a*b*c*d + 11*a^2*d^2)*x*Sqrt[a + b*x^2])/(105*d^3*Sqrt[c + d*x^2])) + (b*(24*b^2*c^2 - 71*a*b*c*d + 71*a^2*d^2)*x*Sqrt[a + b*x^2]*Sqrt[c + d*x^2])/(105*d^3) - (6*b*(b*c - 2*a*d)*x*(a + b*x^2)^(3/2)*Sqrt[c + d*x^2])/(35*d^2) + (b*x*(a + b*x^2)^(5/2)*Sqrt[c + d*x^2])/(7*d) + (8*Sqrt[c]*(b*c - 2*a*d)*(6*b^2*c^2 - 11*a*b*c*d + 11*a^2*d^2)*Sqrt[a + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(105*d^(7/2)*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2]) - (Sqrt[c]*(3*b*c - 7*a*d)*(8*b^2*c^2 - 11*a*b*c*d + 15*a^2*d^2)*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(105*d^(7/2)*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{(a + b*x^2)^(5/2)/Sqrt[c + d*x^2], x, 6, ((8*b^2*c^2 - 23*a*b*c*d + 23*a^2*d^2)*x*Sqrt[a + b*x^2])/(15*d^2*Sqrt[c + d*x^2]) - (4*b*(b*c - 2*a*d)*x*Sqrt[a + b*x^2]*Sqrt[c + d*x^2])/(15*d^2) + (b*x*(a + b*x^2)^(3/2)*Sqrt[c + d*x^2])/(5*d) - (Sqrt[c]*(8*b^2*c^2 - 23*a*b*c*d + 23*a^2*d^2)*Sqrt[a + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(15*d^(5/2)*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2]) + (Sqrt[c]*(4*b^2*c^2 - 11*a*b*c*d + 15*a^2*d^2)*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(15*d^(5/2)*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{(a + b*x^2)^(3/2)/Sqrt[c + d*x^2], x, 5, -((2*(b*c - 2*a*d)*x*Sqrt[a + b*x^2])/(3*d*Sqrt[c + d*x^2])) + (b*x*Sqrt[a + b*x^2]*Sqrt[c + d*x^2])/(3*d) + (2*Sqrt[c]*(b*c - 2*a*d)*Sqrt[a + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(3*d^(3/2)*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2]) - (Sqrt[c]*(b*c - 3*a*d)*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(3*d^(3/2)*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{(a + b*x^2)^(1/2)/Sqrt[c + d*x^2], x, 4, (x*Sqrt[a + b*x^2])/Sqrt[c + d*x^2] - (Sqrt[c]*Sqrt[a + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(Sqrt[d]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2]) + (Sqrt[c]*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(Sqrt[d]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{1/((a + b*x^2)^(1/2)*Sqrt[c + d*x^2]), x, 1, (Sqrt[c]*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(a*Sqrt[d]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{1/((a + b*x^2)^(3/2)*Sqrt[c + d*x^2]), x, 6, -((d*x*Sqrt[a + b*x^2])/(a*(b*c - a*d)*Sqrt[c + d*x^2])) + (b*x*Sqrt[c + d*x^2])/(a*(b*c - a*d)*Sqrt[a + b*x^2]) + (Sqrt[c]*Sqrt[d]*Sqrt[a + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(a*(b*c - a*d)*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2]) - (Sqrt[c]*Sqrt[d]*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(a*(b*c - a*d)*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{1/((a + b*x^2)^(5/2)*Sqrt[c + d*x^2]), x, 4, (b*x*Sqrt[c + d*x^2])/(3*a*(b*c - a*d)*(a + b*x^2)^(3/2)) + (2*Sqrt[b]*(b*c - 2*a*d)*Sqrt[c + d*x^2]*EllipticE[ArcTan[(Sqrt[b]*x)/Sqrt[a]], 1 - (a*d)/(b*c)])/(3*a^(3/2)*(b*c - a*d)^2*Sqrt[a + b*x^2]*Sqrt[(a*(c + d*x^2))/(c*(a + b*x^2))]) - (Sqrt[c]*Sqrt[d]*(b*c - 3*a*d)*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(3*a^2*(b*c - a*d)^2*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{1/((a + b*x^2)^(7/2)*Sqrt[c + d*x^2]), x, 5, (b*x*Sqrt[c + d*x^2])/(5*a*(b*c - a*d)*(a + b*x^2)^(5/2)) + (4*b*(b*c - 2*a*d)*x*Sqrt[c + d*x^2])/(15*a^2*(b*c - a*d)^2*(a + b*x^2)^(3/2)) + (Sqrt[b]*(8*b^2*c^2 - 23*a*b*c*d + 23*a^2*d^2)*Sqrt[c + d*x^2]*EllipticE[ArcTan[(Sqrt[b]*x)/Sqrt[a]], 1 - (a*d)/(b*c)])/(15*a^(5/2)*(b*c - a*d)^3*Sqrt[a + b*x^2]*Sqrt[(a*(c + d*x^2))/(c*(a + b*x^2))]) - (Sqrt[c]*Sqrt[d]*(4*b^2*c^2 - 11*a*b*c*d + 15*a^2*d^2)*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(15*a^3*(b*c - a*d)^3*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}


{(a + b*x^2)^(7/2)/(c + d*x^2)^(3/2), x, 7, ((48*b^3*c^3 - 128*a*b^2*c^2*d + 103*a^2*b*c*d^2 - 15*a^3*d^3)*x*Sqrt[a + b*x^2])/(15*c*d^3*Sqrt[c + d*x^2]) - ((b*c - a*d)*x*(a + b*x^2)^(5/2))/(c*d*Sqrt[c + d*x^2]) - (b*(24*b^2*c^2 - 43*a*b*c*d + 15*a^2*d^2)*x*Sqrt[a + b*x^2]*Sqrt[c + d*x^2])/(15*c*d^3) + (b*(6*b*c - 5*a*d)*x*(a + b*x^2)^(3/2)*Sqrt[c + d*x^2])/(5*c*d^2) - ((48*b^3*c^3 - 128*a*b^2*c^2*d + 103*a^2*b*c*d^2 - 15*a^3*d^3)*Sqrt[a + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(15*Sqrt[c]*d^(7/2)*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2]) + (b*Sqrt[c]*(24*b^2*c^2 - 61*a*b*c*d + 45*a^2*d^2)*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(15*d^(7/2)*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{(a + b*x^2)^(5/2)/(c + d*x^2)^(3/2), x, 6, -(((8*b^2*c^2 - 13*a*b*c*d + 3*a^2*d^2)*x*Sqrt[a + b*x^2])/(3*c*d^2*Sqrt[c + d*x^2])) - ((b*c - a*d)*x*(a + b*x^2)^(3/2))/(c*d*Sqrt[c + d*x^2]) + (b*(4*b*c - 3*a*d)*x*Sqrt[a + b*x^2]*Sqrt[c + d*x^2])/(3*c*d^2) + ((8*b^2*c^2 - 13*a*b*c*d + 3*a^2*d^2)*Sqrt[a + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(3*Sqrt[c]*d^(5/2)*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2]) - (2*b*Sqrt[c]*(2*b*c - 3*a*d)*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(3*d^(5/2)*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{(a + b*x^2)^(3/2)/(c + d*x^2)^(3/2), x, 5, -(((b*c - a*d)*x*Sqrt[a + b*x^2])/(c*d*Sqrt[c + d*x^2])) + ((2*b*c - a*d)*x*Sqrt[a + b*x^2])/(c*d*Sqrt[c + d*x^2]) - ((2*b*c - a*d)*Sqrt[a + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(Sqrt[c]*d^(3/2)*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2]) + (b*Sqrt[c]*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(d^(3/2)*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{(a + b*x^2)^(1/2)/(c + d*x^2)^(3/2), x, 1, (Sqrt[a + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(Sqrt[c]*Sqrt[d]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{1/((a + b*x^2)^(1/2)*(c + d*x^2)^(3/2)), x, 6, -((Sqrt[d]*Sqrt[a + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(Sqrt[c]*(b*c - a*d)*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])) + (b*Sqrt[c]*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(a*Sqrt[d]*(b*c - a*d)*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{1/((a + b*x^2)^(3/2)*(c + d*x^2)^(3/2)), x, 4, (b*x)/(a*(b*c - a*d)*Sqrt[a + b*x^2]*Sqrt[c + d*x^2]) + (Sqrt[d]*(b*c + a*d)*Sqrt[a + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(a*Sqrt[c]*(b*c - a*d)^2*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2]) - (2*b*Sqrt[c]*Sqrt[d]*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(a*(b*c - a*d)^2*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{1/((a + b*x^2)^(5/2)*(c + d*x^2)^(3/2)), x, 5, (b*x)/(3*a*(b*c - a*d)*(a + b*x^2)^(3/2)*Sqrt[c + d*x^2]) + (2*b*(b*c - 3*a*d)*x)/(3*a^2*(b*c - a*d)^2*Sqrt[a + b*x^2]*Sqrt[c + d*x^2]) + (Sqrt[d]*(2*b^2*c^2 - 7*a*b*c*d - 3*a^2*d^2)*Sqrt[a + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(3*a^2*Sqrt[c]*(b*c - a*d)^3*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2]) - (b*Sqrt[c]*Sqrt[d]*(b*c - 9*a*d)*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(3*a^2*(b*c - a*d)^3*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}


{1/(Sqrt[a + b*x^2]*Sqrt[c + d*x^2]), x, 1, (Sqrt[c]*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(a*Sqrt[d]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{1/(Sqrt[a - b*x^2]*Sqrt[c + d*x^2]), x, 3, (Sqrt[a]*Sqrt[1 - (b*x^2)/a]*Sqrt[1 + (d*x^2)/c]*EllipticF[ArcSin[(Sqrt[b]*x)/Sqrt[a]], -((a*d)/(b*c))])/(Sqrt[b]*Sqrt[a - b*x^2]*Sqrt[c + d*x^2])}
{1/(Sqrt[a + b*x^2]*Sqrt[c - d*x^2]), x, 3, (Sqrt[c]*Sqrt[1 + (b*x^2)/a]*Sqrt[1 - (d*x^2)/c]*EllipticF[ArcSin[(Sqrt[d]*x)/Sqrt[c]], -((b*c)/(a*d))])/(Sqrt[d]*Sqrt[a + b*x^2]*Sqrt[c - d*x^2])}
{1/(Sqrt[a - b*x^2]*Sqrt[c - d*x^2]), x, 3, (Sqrt[c]*Sqrt[1 - (b*x^2)/a]*Sqrt[1 - (d*x^2)/c]*EllipticF[ArcSin[(Sqrt[d]*x)/Sqrt[c]], (b*c)/(a*d)])/(Sqrt[d]*Sqrt[a - b*x^2]*Sqrt[c - d*x^2])}
...
{1/(Sqrt[1 - x^2]*Sqrt[2 + 2*x^2]), x, 2, EllipticF[ArcSin[x], -1]/Sqrt[2]}
{1/(Sqrt[1 - x^2]*Sqrt[2 + 1*x^2]), x, 1, EllipticF[ArcSin[x], -(1/2)]/Sqrt[2]}
{1/(Sqrt[1 - x^2]*Sqrt[2 - 1*x^2]), x, 1, EllipticF[ArcSin[x], 1/2]/Sqrt[2]}
{1/(Sqrt[1 - x^2]*Sqrt[2 - 2*x^2]), x, 2, ArcTanh[x]/Sqrt[2]}
{1/(Sqrt[1 - x^2]*Sqrt[2 - 3*x^2]), x, 1, EllipticF[ArcSin[x], 3/2]/Sqrt[2]}
{1/(Sqrt[1 - x^2]*Sqrt[2 - 4*x^2]), x, 1, EllipticF[ArcSin[x], 2]/Sqrt[2]}
{1/(Sqrt[1 - x^2]*Sqrt[2 - 5*x^2]), x, 1, EllipticF[ArcSin[x], 5/2]/Sqrt[2]}


{1/(Sqrt[1 + x^2]*Sqrt[2 + 5*x^2]), x, 1, (Sqrt[2 + 5*x^2]*EllipticF[ArcTan[x], -(3/2)])/(Sqrt[2]*Sqrt[1 + x^2]*Sqrt[(2 + 5*x^2)/(1 + x^2)])}
{1/(Sqrt[1 + x^2]*Sqrt[2 + 4*x^2]), x, 1, (Sqrt[1 + 2*x^2]*EllipticF[ArcTan[x], -1])/(Sqrt[2]*Sqrt[1 + x^2]*Sqrt[(1 + 2*x^2)/(1 + x^2)])}
{1/(Sqrt[1 + x^2]*Sqrt[2 + 3*x^2]), x, 1, (Sqrt[2 + 3*x^2]*EllipticF[ArcTan[x], -(1/2)])/(Sqrt[2]*Sqrt[1 + x^2]*Sqrt[(2 + 3*x^2)/(1 + x^2)])}
{1/(Sqrt[1 + x^2]*Sqrt[2 + 2*x^2]), x, 2, ArcTan[x]/Sqrt[2]}
{1/(Sqrt[1 + x^2]*Sqrt[2 + 1*x^2]), x, 1, (Sqrt[2 + x^2]*EllipticF[ArcTan[x], 1/2])/(Sqrt[2]*Sqrt[1 + x^2]*Sqrt[(2 + x^2)/(1 + x^2)])}
{1/(Sqrt[1 + x^2]*Sqrt[2 - 1*x^2]), x, 1, EllipticF[ArcSin[x/Sqrt[2]], -2]}
{1/(Sqrt[1 + x^2]*Sqrt[2 - 2*x^2]), x, 2, EllipticF[ArcSin[x], -1]/Sqrt[2]}
{1/(Sqrt[1 + x^2]*Sqrt[2 - 3*x^2]), x, 1, EllipticF[ArcSin[Sqrt[3/2]*x], -(2/3)]/Sqrt[3]}
{1/(Sqrt[1 + x^2]*Sqrt[2 - 4*x^2]), x, 1, (1/2)*EllipticF[ArcSin[Sqrt[2]*x], -(1/2)]}
{1/(Sqrt[1 + x^2]*Sqrt[2 - 5*x^2]), x, 1, EllipticF[ArcSin[Sqrt[5/2]*x], -(2/5)]/Sqrt[5]}


{1/(Sqrt[-1 + x^2]*Sqrt[2 + 5*x^2]), x, 2, (Sqrt[1 - x^2]*EllipticF[ArcSin[x], -(5/2)])/(Sqrt[2]*Sqrt[-1 + x^2])}
{1/(Sqrt[-1 + x^2]*Sqrt[2 + 4*x^2]), x, 2, (Sqrt[1 - x^2]*EllipticF[ArcSin[x], -2])/(Sqrt[2]*Sqrt[-1 + x^2])}
{1/(Sqrt[-1 + x^2]*Sqrt[2 + 3*x^2]), x, 2, (Sqrt[1 - x^2]*EllipticF[ArcSin[x], -(3/2)])/(Sqrt[2]*Sqrt[-1 + x^2])}
{1/(Sqrt[-1 + x^2]*Sqrt[2 + 2*x^2]), x, 2, (1/2)*EllipticF[ArcSin[(Sqrt[2]*x)/Sqrt[-1 + x^2]], 1/2]}
{1/(Sqrt[-1 + x^2]*Sqrt[2 + 1*x^2]), x, 2, (Sqrt[1 - x^2]*EllipticF[ArcSin[x], -(1/2)])/(Sqrt[2]*Sqrt[-1 + x^2])}
{1/(Sqrt[-1 + x^2]*Sqrt[2 - 1*x^2]), x, 1, -EllipticF[ArcCos[x/Sqrt[2]], 2]}
{1/(Sqrt[-1 + x^2]*Sqrt[2 - 2*x^2]), x, 2, -((Sqrt[-1 + x^2]*ArcTanh[x])/(Sqrt[2]*Sqrt[1 - x^2]))}
{1/(Sqrt[-1 + x^2]*Sqrt[2 - 3*x^2]), x, 2, (Sqrt[1 - x^2]*EllipticF[ArcSin[x], 3/2])/(Sqrt[2]*Sqrt[-1 + x^2])}
{1/(Sqrt[-1 + x^2]*Sqrt[2 - 4*x^2]), x, 2, (Sqrt[1 - x^2]*EllipticF[ArcSin[x], 2])/(Sqrt[2]*Sqrt[-1 + x^2])}
{1/(Sqrt[-1 + x^2]*Sqrt[2 - 5*x^2]), x, 2, (Sqrt[1 - x^2]*EllipticF[ArcSin[x], 5/2])/(Sqrt[2]*Sqrt[-1 + x^2])}
...
{1/(Sqrt[-1 - x^2]*Sqrt[2 + 4*x^2]), x, 1, (Sqrt[1 + 2*x^2]*EllipticF[ArcTan[x], -1])/(Sqrt[2]*Sqrt[-1 - x^2]*Sqrt[(1 + 2*x^2)/(1 + x^2)])}
{1/(Sqrt[-1 - x^2]*Sqrt[2 + 3*x^2]), x, 1, (Sqrt[2 + 3*x^2]*EllipticF[ArcTan[x], -(1/2)])/(Sqrt[2]*Sqrt[-1 - x^2]*Sqrt[(2 + 3*x^2)/(1 + x^2)])}
{1/(Sqrt[-1 - x^2]*Sqrt[2 + 2*x^2]), x, 2, (Sqrt[1 + x^2]*ArcTan[x])/(Sqrt[2]*Sqrt[-1 - x^2])}
{1/(Sqrt[-1 - x^2]*Sqrt[2 + 1*x^2]), x, 1, (Sqrt[2 + x^2]*EllipticF[ArcTan[x], 1/2])/(Sqrt[2]*Sqrt[-1 - x^2]*Sqrt[(2 + x^2)/(1 + x^2)])}
{1/(Sqrt[-1 - x^2]*Sqrt[2 - 1*x^2]), x, 2, (Sqrt[1 + x^2]*EllipticF[ArcSin[x/Sqrt[2]], -2])/Sqrt[-1 - x^2]}
{1/(Sqrt[-1 - x^2]*Sqrt[2 - 2*x^2]), x, 2, -((Sqrt[1 - 1/x^4]*x^2*EllipticF[ArcCsc[x], -1])/(Sqrt[2 - 2*x^2]*Sqrt[-1 - x^2])), (Sqrt[-1 + x^2]*Sqrt[1 + x^2]*EllipticF[ArcSin[(Sqrt[2]*x)/Sqrt[-1 + x^2]], 1/2])/(2*Sqrt[-1 - x^2]*Sqrt[1 - x^2])}
{1/(Sqrt[-1 - x^2]*Sqrt[2 - 3*x^2]), x, 2, (Sqrt[1 + x^2]*EllipticF[ArcSin[Sqrt[3/2]*x], -(2/3)])/(Sqrt[3]*Sqrt[-1 - x^2])}
{1/(Sqrt[-1 - x^2]*Sqrt[2 - 4*x^2]), x, 2, (Sqrt[1 + x^2]*EllipticF[ArcSin[Sqrt[2]*x], -(1/2)])/(2*Sqrt[-1 - x^2])}
{1/(Sqrt[-1 - x^2]*Sqrt[2 - 5*x^2]), x, 2, (Sqrt[1 + x^2]*EllipticF[ArcSin[Sqrt[5/2]*x], -(2/5)])/(Sqrt[5]*Sqrt[-1 - x^2])}


{Sqrt[a + b*x^2]/Sqrt[c - d*x^2], x, 3, (Sqrt[c]*Sqrt[a + b*x^2]*Sqrt[1 - (d*x^2)/c]*EllipticE[ArcSin[(Sqrt[d]*x)/Sqrt[c]], -((b*c)/(a*d))])/(Sqrt[d]*Sqrt[1 + (b*x^2)/a]*Sqrt[c - d*x^2])}
{Sqrt[-a - b*x^2]/Sqrt[c - d*x^2], x, 3, (Sqrt[c]*Sqrt[-a - b*x^2]*Sqrt[1 - (d*x^2)/c]*EllipticE[ArcSin[(Sqrt[d]*x)/Sqrt[c]], -((b*c)/(a*d))])/(Sqrt[d]*Sqrt[1 + (b*x^2)/a]*Sqrt[c - d*x^2])}
{Sqrt[a + b*x^2]/Sqrt[-c + d*x^2], x, 3, (Sqrt[c]*Sqrt[a + b*x^2]*Sqrt[1 - (d*x^2)/c]*EllipticE[ArcSin[(Sqrt[d]*x)/Sqrt[c]], -((b*c)/(a*d))])/(Sqrt[d]*Sqrt[1 + (b*x^2)/a]*Sqrt[-c + d*x^2])}
{Sqrt[-a - b*x^2]/Sqrt[-c + d*x^2], x, 3, (Sqrt[c]*Sqrt[-a - b*x^2]*Sqrt[1 - (d*x^2)/c]*EllipticE[ArcSin[(Sqrt[d]*x)/Sqrt[c]], -((b*c)/(a*d))])/(Sqrt[d]*Sqrt[1 + (b*x^2)/a]*Sqrt[-c + d*x^2])}
...
{Sqrt[a + b*x^2]/Sqrt[c + d*x^2], x, 4, (x*Sqrt[a + b*x^2])/Sqrt[c + d*x^2] - (Sqrt[c]*Sqrt[a + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(Sqrt[d]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2]) + (Sqrt[c]*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(Sqrt[d]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{Sqrt[-a - b*x^2]/Sqrt[c + d*x^2], x, 4, (x*Sqrt[-a - b*x^2])/Sqrt[c + d*x^2] - (Sqrt[c]*Sqrt[-a - b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(Sqrt[d]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2]) + (Sqrt[c]*Sqrt[-a - b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(Sqrt[d]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{Sqrt[a + b*x^2]/Sqrt[-c - d*x^2], x, 4, (x*Sqrt[a + b*x^2])/Sqrt[-c - d*x^2] - (Sqrt[c]*Sqrt[a + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(Sqrt[d]*Sqrt[-c - d*x^2]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]) + (Sqrt[c]*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(Sqrt[d]*Sqrt[-c - d*x^2]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))])}
{Sqrt[-a - b*x^2]/Sqrt[-c - d*x^2], x, 4, (x*Sqrt[-a - b*x^2])/Sqrt[-c - d*x^2] - (Sqrt[c]*Sqrt[-a - b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(Sqrt[d]*Sqrt[-c - d*x^2]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]) + (Sqrt[c]*Sqrt[-a - b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(Sqrt[d]*Sqrt[-c - d*x^2]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))])}

{Sqrt[a - b*x^2]/Sqrt[c + d*x^2], x, 7, -((Sqrt[a]*Sqrt[b]*Sqrt[1 - (b*x^2)/a]*Sqrt[c + d*x^2]*EllipticE[ArcSin[(Sqrt[b]*x)/Sqrt[a]], -((a*d)/(b*c))])/(d*Sqrt[a - b*x^2]*Sqrt[1 + (d*x^2)/c])) + (Sqrt[a]*(b*c + a*d)*Sqrt[1 - (b*x^2)/a]*Sqrt[1 + (d*x^2)/c]*EllipticF[ArcSin[(Sqrt[b]*x)/Sqrt[a]], -((a*d)/(b*c))])/(Sqrt[b]*d*Sqrt[a - b*x^2]*Sqrt[c + d*x^2])}
{Sqrt[-a + b*x^2]/Sqrt[c + d*x^2], x, 7, (Sqrt[a]*Sqrt[b]*Sqrt[1 - (b*x^2)/a]*Sqrt[c + d*x^2]*EllipticE[ArcSin[(Sqrt[b]*x)/Sqrt[a]], -((a*d)/(b*c))])/(d*Sqrt[-a + b*x^2]*Sqrt[1 + (d*x^2)/c]) - (Sqrt[a]*(b*c + a*d)*Sqrt[1 - (b*x^2)/a]*Sqrt[1 + (d*x^2)/c]*EllipticF[ArcSin[(Sqrt[b]*x)/Sqrt[a]], -((a*d)/(b*c))])/(Sqrt[b]*d*Sqrt[-a + b*x^2]*Sqrt[c + d*x^2])}
{Sqrt[a - b*x^2]/Sqrt[-c - d*x^2], x, 7, (Sqrt[a]*Sqrt[b]*Sqrt[1 - (b*x^2)/a]*Sqrt[-c - d*x^2]*EllipticE[ArcSin[(Sqrt[b]*x)/Sqrt[a]], -((a*d)/(b*c))])/(d*Sqrt[a - b*x^2]*Sqrt[1 + (d*x^2)/c]) + (Sqrt[a]*(b*c + a*d)*Sqrt[1 - (b*x^2)/a]*Sqrt[1 + (d*x^2)/c]*EllipticF[ArcSin[(Sqrt[b]*x)/Sqrt[a]], -((a*d)/(b*c))])/(Sqrt[b]*d*Sqrt[a - b*x^2]*Sqrt[-c - d*x^2])}
{Sqrt[-a + b*x^2]/Sqrt[-c - d*x^2], x, 7, -((Sqrt[a]*Sqrt[b]*Sqrt[1 - (b*x^2)/a]*Sqrt[-c - d*x^2]*EllipticE[ArcSin[(Sqrt[b]*x)/Sqrt[a]], -((a*d)/(b*c))])/(d*Sqrt[-a + b*x^2]*Sqrt[1 + (d*x^2)/c])) - (Sqrt[a]*(b*c + a*d)*Sqrt[1 - (b*x^2)/a]*Sqrt[1 + (d*x^2)/c]*EllipticF[ArcSin[(Sqrt[b]*x)/Sqrt[a]], -((a*d)/(b*c))])/(Sqrt[b]*d*Sqrt[-a + b*x^2]*Sqrt[-c - d*x^2])}


{Sqrt[c + d*x^2]/Sqrt[a - b*x^2], x, 3, (Sqrt[a]*Sqrt[1 - (b*x^2)/a]*Sqrt[c + d*x^2]*EllipticE[ArcSin[(Sqrt[b]*x)/Sqrt[a]], -((a*d)/(b*c))])/(Sqrt[b]*Sqrt[a - b*x^2]*Sqrt[1 + (d*x^2)/c])}
{Sqrt[-c - d*x^2]/Sqrt[a - b*x^2], x, 3, (Sqrt[a]*Sqrt[1 - (b*x^2)/a]*Sqrt[-c - d*x^2]*EllipticE[ArcSin[(Sqrt[b]*x)/Sqrt[a]], -((a*d)/(b*c))])/(Sqrt[b]*Sqrt[a - b*x^2]*Sqrt[1 + (d*x^2)/c])}
{Sqrt[c + d*x^2]/Sqrt[-a + b*x^2], x, 3, (Sqrt[a]*Sqrt[1 - (b*x^2)/a]*Sqrt[c + d*x^2]*EllipticE[ArcSin[(Sqrt[b]*x)/Sqrt[a]], -((a*d)/(b*c))])/(Sqrt[b]*Sqrt[-a + b*x^2]*Sqrt[1 + (d*x^2)/c])}
{Sqrt[-c - d*x^2]/Sqrt[-a + b*x^2], x, 3, (Sqrt[a]*Sqrt[1 - (b*x^2)/a]*Sqrt[-c - d*x^2]*EllipticE[ArcSin[(Sqrt[b]*x)/Sqrt[a]], -((a*d)/(b*c))])/(Sqrt[b]*Sqrt[-a + b*x^2]*Sqrt[1 + (d*x^2)/c])}
...
{Sqrt[c + d*x^2]/Sqrt[a + b*x^2], x, 4, (d*x*Sqrt[a + b*x^2])/(b*Sqrt[c + d*x^2]) - (Sqrt[c]*Sqrt[d]*Sqrt[a + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(b*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2]) + (c^(3/2)*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(a*Sqrt[d]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{Sqrt[-c - d*x^2]/Sqrt[a + b*x^2], x, 4, -((d*x*Sqrt[a + b*x^2])/(b*Sqrt[-c - d*x^2])) + (Sqrt[c]*Sqrt[d]*Sqrt[a + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(b*Sqrt[-c - d*x^2]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]) - (c^(3/2)*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(a*Sqrt[d]*Sqrt[-c - d*x^2]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))])}
{Sqrt[c + d*x^2]/Sqrt[-a - b*x^2], x, 4, -((d*x*Sqrt[-a - b*x^2])/(b*Sqrt[c + d*x^2])) + (Sqrt[c]*Sqrt[d]*Sqrt[-a - b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(b*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2]) - (c^(3/2)*Sqrt[-a - b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(a*Sqrt[d]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])}
{Sqrt[-c - d*x^2]/Sqrt[-a - b*x^2], x, 4, (d*x*Sqrt[-a - b*x^2])/(b*Sqrt[-c - d*x^2]) - (Sqrt[c]*Sqrt[d]*Sqrt[-a - b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(b*Sqrt[-c - d*x^2]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]) + (c^(3/2)*Sqrt[-a - b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(a*Sqrt[d]*Sqrt[-c - d*x^2]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))])}

{Sqrt[c - d*x^2]/Sqrt[a + b*x^2], x, 7, -((Sqrt[c]*Sqrt[d]*Sqrt[a + b*x^2]*Sqrt[1 - (d*x^2)/c]*EllipticE[ArcSin[(Sqrt[d]*x)/Sqrt[c]], -((b*c)/(a*d))])/(b*Sqrt[1 + (b*x^2)/a]*Sqrt[c - d*x^2])) + (Sqrt[c]*(b*c + a*d)*Sqrt[1 + (b*x^2)/a]*Sqrt[1 - (d*x^2)/c]*EllipticF[ArcSin[(Sqrt[d]*x)/Sqrt[c]], -((b*c)/(a*d))])/(b*Sqrt[d]*Sqrt[a + b*x^2]*Sqrt[c - d*x^2])}
{Sqrt[-c + d*x^2]/Sqrt[a + b*x^2], x, 7, (Sqrt[c]*Sqrt[d]*Sqrt[a + b*x^2]*Sqrt[1 - (d*x^2)/c]*EllipticE[ArcSin[(Sqrt[d]*x)/Sqrt[c]], -((b*c)/(a*d))])/(b*Sqrt[1 + (b*x^2)/a]*Sqrt[-c + d*x^2]) - (Sqrt[c]*(b*c + a*d)*Sqrt[1 + (b*x^2)/a]*Sqrt[1 - (d*x^2)/c]*EllipticF[ArcSin[(Sqrt[d]*x)/Sqrt[c]], -((b*c)/(a*d))])/(b*Sqrt[d]*Sqrt[a + b*x^2]*Sqrt[-c + d*x^2])}
{Sqrt[c - d*x^2]/Sqrt[-a - b*x^2], x, 7, (Sqrt[c]*Sqrt[d]*Sqrt[-a - b*x^2]*Sqrt[1 - (d*x^2)/c]*EllipticE[ArcSin[(Sqrt[d]*x)/Sqrt[c]], -((b*c)/(a*d))])/(b*Sqrt[1 + (b*x^2)/a]*Sqrt[c - d*x^2]) + (Sqrt[c]*(b*c + a*d)*Sqrt[1 + (b*x^2)/a]*Sqrt[1 - (d*x^2)/c]*EllipticF[ArcSin[(Sqrt[d]*x)/Sqrt[c]], -((b*c)/(a*d))])/(b*Sqrt[d]*Sqrt[-a - b*x^2]*Sqrt[c - d*x^2])}
{Sqrt[-c + d*x^2]/Sqrt[-a - b*x^2], x, 7, -((Sqrt[c]*Sqrt[d]*Sqrt[-a - b*x^2]*Sqrt[1 - (d*x^2)/c]*EllipticE[ArcSin[(Sqrt[d]*x)/Sqrt[c]], -((b*c)/(a*d))])/(b*Sqrt[1 + (b*x^2)/a]*Sqrt[-c + d*x^2])) - (Sqrt[c]*(b*c + a*d)*Sqrt[1 + (b*x^2)/a]*Sqrt[1 - (d*x^2)/c]*EllipticF[ArcSin[(Sqrt[d]*x)/Sqrt[c]], -((b*c)/(a*d))])/(b*Sqrt[d]*Sqrt[-a - b*x^2]*Sqrt[-c + d*x^2])}


{1/(Sqrt[2 + b*x^2]*Sqrt[3 + d*x^2]), x, 1, (Sqrt[2 + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[3]], 1 - (3*b)/(2*d)])/(Sqrt[2]*Sqrt[d]*Sqrt[(2 + b*x^2)/(3 + d*x^2)]*Sqrt[3 + d*x^2])}
{1/(Sqrt[4 - x^2]*Sqrt[c + d*x^2]), x, 2, (Sqrt[1 + (d*x^2)/c]*EllipticF[ArcSin[x/2], -((4*d)/c)])/Sqrt[c + d*x^2]}
{1/(Sqrt[4 + x^2]*Sqrt[c + d*x^2]), x, 1, (Sqrt[c + d*x^2]*EllipticF[ArcTan[x/2], 1 - (4*d)/c])/(c*Sqrt[4 + x^2]*Sqrt[(c + d*x^2)/(c*(4 + x^2))])}
...
{Sqrt[1 - (2*c*x^2)/(b - Sqrt[b^2 - 4*a*c])]/Sqrt[1 - (2*c*x^2)/(b + Sqrt[b^2 - 4*a*c])], x, 1, (Sqrt[b + Sqrt[b^2 - 4*a*c]]*EllipticE[ArcSin[(Sqrt[2]*Sqrt[c]*x)/Sqrt[b + Sqrt[b^2 - 4*a*c]]], (b + Sqrt[b^2 - 4*a*c])/(b - Sqrt[b^2 - 4*a*c])])/(Sqrt[2]*Sqrt[c])}
{Sqrt[1 + (2*c*x^2)/(b - Sqrt[b^2 - 4*a*c])]/Sqrt[1 + (2*c*x^2)/(b + Sqrt[b^2 - 4*a*c])], x, 4, (x*Sqrt[1 + (2*c*x^2)/(b - Sqrt[b^2 - 4*a*c])])/Sqrt[1 + (2*c*x^2)/(b + Sqrt[b^2 - 4*a*c])] - (Sqrt[b + Sqrt[b^2 - 4*a*c]]*Sqrt[1 + (2*c*x^2)/(b - Sqrt[b^2 - 4*a*c])]*EllipticE[ArcTan[(Sqrt[2]*Sqrt[c]*x)/Sqrt[b + Sqrt[b^2 - 4*a*c]]], -((2*Sqrt[b^2 - 4*a*c])/(b - Sqrt[b^2 - 4*a*c]))])/(Sqrt[2]*Sqrt[c]*Sqrt[(1 + (2*c*x^2)/(b - Sqrt[b^2 - 4*a*c]))/(1 + (2*c*x^2)/(b + Sqrt[b^2 - 4*a*c]))]*Sqrt[1 + (2*c*x^2)/(b + Sqrt[b^2 - 4*a*c])]) + (Sqrt[b + Sqrt[b^2 - 4*a*c]]*Sqrt[1 + (2*c*x^2)/(b - Sqrt[b^2 - 4*a*c])]*EllipticF[ArcTan[(Sqrt[2]*Sqrt[c]*x)/Sqrt[b + Sqrt[b^2 - 4*a*c]]], -((2*Sqrt[b^2 - 4*a*c])/(b - Sqrt[b^2 - 4*a*c]))])/(Sqrt[2]*Sqrt[c]*Sqrt[(1 + (2*c*x^2)/(b - Sqrt[b^2 - 4*a*c]))/(1 + (2*c*x^2)/(b + Sqrt[b^2 - 4*a*c]))]*Sqrt[1 + (2*c*x^2)/(b + Sqrt[b^2 - 4*a*c])])}
{Sqrt[1 - (2*c*x^2)/(b - Sqrt[b^2 - 4*a*c])]/Sqrt[1 + (2*c*x^2)/(b + Sqrt[b^2 - 4*a*c])], x, 3, -(((b + Sqrt[b^2 - 4*a*c])*EllipticE[ArcSin[(Sqrt[2]*Sqrt[c]*x)/Sqrt[b - Sqrt[b^2 - 4*a*c]]], -((b - Sqrt[b^2 - 4*a*c])/(b + Sqrt[b^2 - 4*a*c]))])/(Sqrt[2]*Sqrt[c]*Sqrt[b - Sqrt[b^2 - 4*a*c]])) + (Sqrt[2]*b*EllipticF[ArcSin[(Sqrt[2]*Sqrt[c]*x)/Sqrt[b - Sqrt[b^2 - 4*a*c]]], -((b - Sqrt[b^2 - 4*a*c])/(b + Sqrt[b^2 - 4*a*c]))])/(Sqrt[c]*Sqrt[b - Sqrt[b^2 - 4*a*c]])}


{(1 - 2*x^2)^m/Sqrt[1 - x^2], x, -1, -((2^(-2 - m)*Sqrt[x^2]*(2 - 4*x^2)^(1 + m)*Hypergeometric2F1[1/2, (1 + m)/2, (3 + m)/2, (1 - 2*x^2)^2])/((1 + m)*x))}


{1/(Sqrt[-1 + x^2]*Sqrt[7 - 4*Sqrt[3] + x^2]), x, 2, (Sqrt[1 - x^2]*EllipticF[ArcSin[x], -7 - 4*Sqrt[3]])/(Sqrt[7 - 4*Sqrt[3]]*Sqrt[-1 + x^2])}


{1/(Sqrt[3 - 3*Sqrt[3] + 2*Sqrt[3]*x^2]*Sqrt[3 + (-3 + Sqrt[3])*x^2]), x, 1, (-(1/6))*Sqrt[3 + Sqrt[3]]*EllipticF[ArcCos[Sqrt[(1/3)*(3 - Sqrt[3])]*x], (1/2)*(1 + Sqrt[3])]}
...
{(a + b*x^2)^(7/4)/(c + d*x^2), x, 14, (6*a*b*x)/(5*d*(a + b*x^2)^(1/4)) - (2*b*(b*c - a*d)*x)/(d^2*(a + b*x^2)^(1/4)) + (2*b*x*(a + b*x^2)^(3/4))/(5*d) - (6*a^(3/2)*Sqrt[b]*(1 + (b*x^2)/a)^(1/4)*EllipticE[(1/2)*ArcTan[(Sqrt[b]*x)/Sqrt[a]], 2])/(5*d*(a + b*x^2)^(1/4)) + (2*Sqrt[a]*Sqrt[b]*(b*c - a*d)*(1 + (b*x^2)/a)^(1/4)*EllipticE[(1/2)*ArcTan[(Sqrt[b]*x)/Sqrt[a]], 2])/(d^2*(a + b*x^2)^(1/4)) + (a^(1/4)*((-b)*c + a*d)^(3/2)*Sqrt[-((b*x^2)/a)]*EllipticPi[-((Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d]), ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(d^(5/2)*x) - (a^(1/4)*((-b)*c + a*d)^(3/2)*Sqrt[-((b*x^2)/a)]*EllipticPi[(Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d], ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(d^(5/2)*x)}
{(a + b*x^2)^(5/4)/(c + d*x^2), x, 12, (2*b*x*(a + b*x^2)^(1/4))/(3*d) + (2*a^(3/2)*Sqrt[b]*(1 + (b*x^2)/a)^(3/4)*EllipticF[(1/2)*ArcTan[(Sqrt[b]*x)/Sqrt[a]], 2])/(3*d*(a + b*x^2)^(3/4)) - (2*Sqrt[a]*Sqrt[b]*(b*c - a*d)*(1 + (b*x^2)/a)^(3/4)*EllipticF[(1/2)*ArcTan[(Sqrt[b]*x)/Sqrt[a]], 2])/(d^2*(a + b*x^2)^(3/4)) + (a^(1/4)*(b*c - a*d)*Sqrt[-((b*x^2)/a)]*EllipticPi[-((Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d]), ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(d^2*x) + (a^(1/4)*(b*c - a*d)*Sqrt[-((b*x^2)/a)]*EllipticPi[(Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d], ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(d^2*x)}
{(a + b*x^2)^(3/4)/(c + d*x^2), x, 9, (2*b*x)/(d*(a + b*x^2)^(1/4)) - (2*Sqrt[a]*Sqrt[b]*(1 + (b*x^2)/a)^(1/4)*EllipticE[(1/2)*ArcTan[(Sqrt[b]*x)/Sqrt[a]], 2])/(d*(a + b*x^2)^(1/4)) + (a^(1/4)*Sqrt[(-b)*c + a*d]*Sqrt[-((b*x^2)/a)]*EllipticPi[-((Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d]), ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(d^(3/2)*x) - (a^(1/4)*Sqrt[(-b)*c + a*d]*Sqrt[-((b*x^2)/a)]*EllipticPi[(Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d], ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(d^(3/2)*x)}
{(a + b*x^2)^(1/4)/(c + d*x^2), x, 8, (2*Sqrt[a]*Sqrt[b]*(1 + (b*x^2)/a)^(3/4)*EllipticF[(1/2)*ArcTan[(Sqrt[b]*x)/Sqrt[a]], 2])/(d*(a + b*x^2)^(3/4)) - (a^(1/4)*Sqrt[-((b*x^2)/a)]*EllipticPi[-((Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d]), ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(d*x) - (a^(1/4)*Sqrt[-((b*x^2)/a)]*EllipticPi[(Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d], ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(d*x)}
{1/((a + b*x^2)^(1/4)*(c + d*x^2)), x, 5, (a^(1/4)*Sqrt[-((b*x^2)/a)]*EllipticPi[-((Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d]), ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(Sqrt[d]*Sqrt[(-b)*c + a*d]*x) - (a^(1/4)*Sqrt[-((b*x^2)/a)]*EllipticPi[(Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d], ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(Sqrt[d]*Sqrt[(-b)*c + a*d]*x)}
{1/((a + b*x^2)^(3/4)*(c + d*x^2)), x, 5, (a^(1/4)*Sqrt[-((b*x^2)/a)]*EllipticPi[-((Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d]), ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/((b*c - a*d)*x) + (a^(1/4)*Sqrt[-((b*x^2)/a)]*EllipticPi[(Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d], ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/((b*c - a*d)*x)}
{1/((a + b*x^2)^(5/4)*(c + d*x^2)), x, 8, (2*Sqrt[b]*(1 + (b*x^2)/a)^(1/4)*EllipticE[(1/2)*ArcTan[(Sqrt[b]*x)/Sqrt[a]], 2])/(Sqrt[a]*(b*c - a*d)*(a + b*x^2)^(1/4)) + (a^(1/4)*Sqrt[d]*Sqrt[-((b*x^2)/a)]*EllipticPi[-((Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d]), ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(((-b)*c + a*d)^(3/2)*x) - (a^(1/4)*Sqrt[d]*Sqrt[-((b*x^2)/a)]*EllipticPi[(Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d], ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(((-b)*c + a*d)^(3/2)*x)}
{1/((a + b*x^2)^(7/4)*(c + d*x^2)), x, 9, (2*b*x)/(3*a*(b*c - a*d)*(a + b*x^2)^(3/4)) + (2*Sqrt[b]*(1 + (b*x^2)/a)^(3/4)*EllipticF[(1/2)*ArcTan[(Sqrt[b]*x)/Sqrt[a]], 2])/(3*Sqrt[a]*(b*c - a*d)*(a + b*x^2)^(3/4)) - (a^(1/4)*d*Sqrt[-((b*x^2)/a)]*EllipticPi[-((Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d]), ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/((b*c - a*d)^2*x) - (a^(1/4)*d*Sqrt[-((b*x^2)/a)]*EllipticPi[(Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d], ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/((b*c - a*d)^2*x)}
{1/((a + b*x^2)^(9/4)*(c + d*x^2)), x, 11, (2*b*x)/(5*a*(b*c - a*d)*(a + b*x^2)^(5/4)) + (2*Sqrt[b]*(3*b*c - 8*a*d)*(1 + (b*x^2)/a)^(1/4)*EllipticE[(1/2)*ArcTan[(Sqrt[b]*x)/Sqrt[a]], 2])/(5*a^(3/2)*(b*c - a*d)^2*(a + b*x^2)^(1/4)) + (a^(1/4)*d^(3/2)*Sqrt[-((b*x^2)/a)]*EllipticPi[-((Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d]), ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(((-b)*c + a*d)^(5/2)*x) - (a^(1/4)*d^(3/2)*Sqrt[-((b*x^2)/a)]*EllipticPi[(Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d], ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(((-b)*c + a*d)^(5/2)*x)}
{1/((a + b*x^2)^(11/4)*(c + d*x^2)), x, 10, (2*b*x)/(7*a*(b*c - a*d)*(a + b*x^2)^(7/4)) + (2*b*(5*b*c - 12*a*d)*x)/(21*a^2*(b*c - a*d)^2*(a + b*x^2)^(3/4)) + (2*Sqrt[b]*(5*b*c - 12*a*d)*(1 + (b*x^2)/a)^(3/4)*EllipticF[(1/2)*ArcTan[(Sqrt[b]*x)/Sqrt[a]], 2])/(21*a^(3/2)*(b*c - a*d)^2*(a + b*x^2)^(3/4)) + (a^(1/4)*d^2*Sqrt[-((b*x^2)/a)]*EllipticPi[-((Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d]), ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/((b*c - a*d)^3*x) + (a^(1/4)*d^2*Sqrt[-((b*x^2)/a)]*EllipticPi[(Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d], ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/((b*c - a*d)^3*x)}


{(a + b*x^2)^(7/4)/(c + d*x^2)^2, x, 10, (b*(5*b*c - a*d)*x)/(2*c*d^2*(a + b*x^2)^(1/4)) - ((b*c - a*d)*x*(a + b*x^2)^(3/4))/(2*c*d*(c + d*x^2)) - (Sqrt[a]*Sqrt[b]*(5*b*c - a*d)*(1 + (b*x^2)/a)^(1/4)*EllipticE[(1/2)*ArcTan[(Sqrt[b]*x)/Sqrt[a]], 2])/(2*c*d^2*(a + b*x^2)^(1/4)) + (a^(1/4)*Sqrt[(-b)*c + a*d]*(5*b*c + 2*a*d)*Sqrt[-((b*x^2)/a)]*EllipticPi[-((Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d]), ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(4*c*d^(5/2)*x) - (a^(1/4)*Sqrt[(-b)*c + a*d]*(5*b*c + 2*a*d)*Sqrt[-((b*x^2)/a)]*EllipticPi[(Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d], ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(4*c*d^(5/2)*x)}
{(a + b*x^2)^(5/4)/(c + d*x^2)^2, x, 9, -(((b*c - a*d)*x*(a + b*x^2)^(1/4))/(2*c*d*(c + d*x^2))) + (Sqrt[a]*Sqrt[b]*(3*b*c + a*d)*(1 + (b*x^2)/a)^(3/4)*EllipticF[(1/2)*ArcTan[(Sqrt[b]*x)/Sqrt[a]], 2])/(2*c*d^2*(a + b*x^2)^(3/4)) - (a^(1/4)*(3*b*c + 2*a*d)*Sqrt[-((b*x^2)/a)]*EllipticPi[-((Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d]), ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(4*c*d^2*x) - (a^(1/4)*(3*b*c + 2*a*d)*Sqrt[-((b*x^2)/a)]*EllipticPi[(Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d], ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(4*c*d^2*x)}
{(a + b*x^2)^(3/4)/(c + d*x^2)^2, x, 10, -((b*x)/(2*c*d*(a + b*x^2)^(1/4))) + (x*(a + b*x^2)^(3/4))/(2*c*(c + d*x^2)) + (Sqrt[a]*Sqrt[b]*(1 + (b*x^2)/a)^(1/4)*EllipticE[(1/2)*ArcTan[(Sqrt[b]*x)/Sqrt[a]], 2])/(2*c*d*(a + b*x^2)^(1/4)) + (a^(1/4)*(b*c + 2*a*d)*Sqrt[-((b*x^2)/a)]*EllipticPi[-((Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d]), ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(4*c*d^(3/2)*Sqrt[(-b)*c + a*d]*x) - (a^(1/4)*(b*c + 2*a*d)*Sqrt[-((b*x^2)/a)]*EllipticPi[(Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d], ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(4*c*d^(3/2)*Sqrt[(-b)*c + a*d]*x)}
{(a + b*x^2)^(1/4)/(c + d*x^2)^2, x, 9, (x*(a + b*x^2)^(1/4))/(2*c*(c + d*x^2)) + (Sqrt[a]*Sqrt[b]*(1 + (b*x^2)/a)^(3/4)*EllipticF[(1/2)*ArcTan[(Sqrt[b]*x)/Sqrt[a]], 2])/(2*c*d*(a + b*x^2)^(3/4)) - (a^(1/4)*(b*c - 2*a*d)*Sqrt[-((b*x^2)/a)]*EllipticPi[-((Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d]), ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(4*c*d*(b*c - a*d)*x) - (a^(1/4)*(b*c - 2*a*d)*Sqrt[-((b*x^2)/a)]*EllipticPi[(Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d], ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(4*c*d*(b*c - a*d)*x)}
{1/((a + b*x^2)^(1/4)*(c + d*x^2)^2), x, 10, (b*x)/(2*c*(b*c - a*d)*(a + b*x^2)^(1/4)) - (d*x*(a + b*x^2)^(3/4))/(2*c*(b*c - a*d)*(c + d*x^2)) - (Sqrt[a]*Sqrt[b]*(1 + (b*x^2)/a)^(1/4)*EllipticE[(1/2)*ArcTan[(Sqrt[b]*x)/Sqrt[a]], 2])/(2*c*(b*c - a*d)*(a + b*x^2)^(1/4)) - (a^(1/4)*(3*b*c - 2*a*d)*Sqrt[-((b*x^2)/a)]*EllipticPi[-((Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d]), ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(4*c*Sqrt[d]*((-b)*c + a*d)^(3/2)*x) + (a^(1/4)*(3*b*c - 2*a*d)*Sqrt[-((b*x^2)/a)]*EllipticPi[(Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d], ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(4*c*Sqrt[d]*((-b)*c + a*d)^(3/2)*x)}
{1/((a + b*x^2)^(3/4)*(c + d*x^2)^2), x, 9, -((d*x*(a + b*x^2)^(1/4))/(2*c*(b*c - a*d)*(c + d*x^2))) - (Sqrt[a]*Sqrt[b]*(1 + (b*x^2)/a)^(3/4)*EllipticF[(1/2)*ArcTan[(Sqrt[b]*x)/Sqrt[a]], 2])/(2*c*(b*c - a*d)*(a + b*x^2)^(3/4)) + (a^(1/4)*(5*b*c - 2*a*d)*Sqrt[-((b*x^2)/a)]*EllipticPi[-((Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d]), ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(4*c*(b*c - a*d)^2*x) + (a^(1/4)*(5*b*c - 2*a*d)*Sqrt[-((b*x^2)/a)]*EllipticPi[(Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d], ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(4*c*(b*c - a*d)^2*x)}
{1/((a + b*x^2)^(5/4)*(c + d*x^2)^2), x, 11, -((d*x)/(2*c*(b*c - a*d)*(a + b*x^2)^(1/4)*(c + d*x^2))) + (Sqrt[b]*(4*b*c + a*d)*(1 + (b*x^2)/a)^(1/4)*EllipticE[(1/2)*ArcTan[(Sqrt[b]*x)/Sqrt[a]], 2])/(2*Sqrt[a]*c*(b*c - a*d)^2*(a + b*x^2)^(1/4)) - (a^(1/4)*Sqrt[d]*(7*b*c - 2*a*d)*Sqrt[-((b*x^2)/a)]*EllipticPi[-((Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d]), ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(4*c*((-b)*c + a*d)^(5/2)*x) + (a^(1/4)*Sqrt[d]*(7*b*c - 2*a*d)*Sqrt[-((b*x^2)/a)]*EllipticPi[(Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d], ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(4*c*((-b)*c + a*d)^(5/2)*x)}
{1/((a + b*x^2)^(7/4)*(c + d*x^2)^2), x, 10, (b*(4*b*c + 3*a*d)*x)/(6*a*c*(b*c - a*d)^2*(a + b*x^2)^(3/4)) - (d*x)/(2*c*(b*c - a*d)*(a + b*x^2)^(3/4)*(c + d*x^2)) + (Sqrt[b]*(4*b*c + 3*a*d)*(1 + (b*x^2)/a)^(3/4)*EllipticF[(1/2)*ArcTan[(Sqrt[b]*x)/Sqrt[a]], 2])/(6*Sqrt[a]*c*(b*c - a*d)^2*(a + b*x^2)^(3/4)) - (a^(1/4)*d*(9*b*c - 2*a*d)*Sqrt[-((b*x^2)/a)]*EllipticPi[-((Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d]), ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(4*c*(b*c - a*d)^3*x) - (a^(1/4)*d*(9*b*c - 2*a*d)*Sqrt[-((b*x^2)/a)]*EllipticPi[(Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d], ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(4*c*(b*c - a*d)^3*x)}
{1/((a + b*x^2)^(9/4)*(c + d*x^2)^2), x, 12, (b*(4*b*c + 5*a*d)*x)/(10*a*c*(b*c - a*d)^2*(a + b*x^2)^(5/4)) - (d*x)/(2*c*(b*c - a*d)*(a + b*x^2)^(5/4)*(c + d*x^2)) + (Sqrt[b]*(12*b^2*c^2 - 52*a*b*c*d - 5*a^2*d^2)*(1 + (b*x^2)/a)^(1/4)*EllipticE[(1/2)*ArcTan[(Sqrt[b]*x)/Sqrt[a]], 2])/(10*a^(3/2)*c*(b*c - a*d)^3*(a + b*x^2)^(1/4)) - (a^(1/4)*d^(3/2)*(11*b*c - 2*a*d)*Sqrt[-((b*x^2)/a)]*EllipticPi[-((Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d]), ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(4*c*((-b)*c + a*d)^(7/2)*x) + (a^(1/4)*d^(3/2)*(11*b*c - 2*a*d)*Sqrt[-((b*x^2)/a)]*EllipticPi[(Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d], ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(4*c*((-b)*c + a*d)^(7/2)*x)}
{1/((a + b*x^2)^(11/4)*(c + d*x^2)^2), x, 11, (b*(4*b*c + 7*a*d)*x)/(14*a*c*(b*c - a*d)^2*(a + b*x^2)^(7/4)) + (b*(20*b^2*c^2 - 76*a*b*c*d - 21*a^2*d^2)*x)/(42*a^2*c*(b*c - a*d)^3*(a + b*x^2)^(3/4)) - (d*x)/(2*c*(b*c - a*d)*(a + b*x^2)^(7/4)*(c + d*x^2)) + (Sqrt[b]*(20*b^2*c^2 - 76*a*b*c*d - 21*a^2*d^2)*(1 + (b*x^2)/a)^(3/4)*EllipticF[(1/2)*ArcTan[(Sqrt[b]*x)/Sqrt[a]], 2])/(42*a^(3/2)*c*(b*c - a*d)^3*(a + b*x^2)^(3/4)) + (a^(1/4)*d^2*(13*b*c - 2*a*d)*Sqrt[-((b*x^2)/a)]*EllipticPi[-((Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d]), ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(4*c*(b*c - a*d)^4*x) + (a^(1/4)*d^2*(13*b*c - 2*a*d)*Sqrt[-((b*x^2)/a)]*EllipticPi[(Sqrt[a]*Sqrt[d])/Sqrt[(-b)*c + a*d], ArcSin[(a + b*x^2)^(1/4)/a^(1/4)], -1])/(4*c*(b*c - a*d)^4*x)}
...
{(a + b*x^2)^p*(c + d*x^2)^q, x, 3, (x*(a + b*x^2)^p*(c + d*x^2)^q*AppellF1[1/2, -p, -q, 3/2, -((b*x^2)/a), -((d*x^2)/c)])/((1 + (b*x^2)/a)^p*(1 + (d*x^2)/c)^q)}


{(a + b*x^2)^p*(c + d*x^2)^3, x, 5, If[$VersionNumber>=8, (d*(15*a^2*d^2 - 8*a*b*c*d*(6 + p) + b^2*c^2*(57 + 28*p + 4*p^2))*x*(a + b*x^2)^(1 + p))/(b^3*(3 + 2*p)*(5 + 2*p)*(7 + 2*p)) - (d*(5*a*d - b*c*(11 + 2*p))*x*(a + b*x^2)^(1 + p)*(c + d*x^2))/(b^2*(5 + 2*p)*(7 + 2*p)) + (d*x*(a + b*x^2)^(1 + p)*(c + d*x^2)^2)/(b*(7 + 2*p)) - ((15*a^3*d^3 - 9*a^2*b*c*d^2*(7 + 2*p) + 3*a*b^2*c^2*d*(35 + 24*p + 4*p^2) - b^3*c^3*(105 + 142*p + 60*p^2 + 8*p^3))*x*(a + b*x^2)^p*Hypergeometric2F1[1/2, -p, 3/2, -((b*x^2)/a)])/((1 + (b*x^2)/a)^p*(b^3*(3 + 2*p)*(5 + 2*p)*(7 + 2*p))), (d*(15*a^2*d^2 - 8*a*b*c*d*(6 + p) + b^2*c^2*(57 + 28*p + 4*p^2))*x*(a + b*x^2)^(1 + p))/(b^3*(105 + 142*p + 60*p^2 + 8*p^3)) - (d*(5*a*d - b*c*(11 + 2*p))*x*(a + b*x^2)^(1 + p)*(c + d*x^2))/(b^2*(35 + 24*p + 4*p^2)) + (d*x*(a + b*x^2)^(1 + p)*(c + d*x^2)^2)/(b*(7 + 2*p)) - ((15*a^3*d^3 - 9*a^2*b*c*d^2*(7 + 2*p) + 3*a*b^2*c^2*d*(35 + 24*p + 4*p^2) - b^3*c^3*(105 + 142*p + 60*p^2 + 8*p^3))*x*(a + b*x^2)^p*Hypergeometric2F1[1/2, -p, 3/2, -((b*x^2)/a)])/(1 + (b*x^2)/a)^p/(b^3*(105 + 142*p + 60*p^2 + 8*p^3))]}
{(a + b*x^2)^p*(c + d*x^2)^2, x, 4, If[$VersionNumber>=8, -((d*(3*a*d - b*c*(7 + 2*p))*x*(a + b*x^2)^(1 + p))/(b^2*(3 + 2*p)*(5 + 2*p))) + (d*x*(a + b*x^2)^(1 + p)*(c + d*x^2))/(b*(5 + 2*p)) + ((3*a^2*d^2 - 2*a*b*c*d*(5 + 2*p) + b^2*c^2*(15 + 16*p + 4*p^2))*x*(a + b*x^2)^p*Hypergeometric2F1[1/2, -p, 3/2, -((b*x^2)/a)])/((1 + (b*x^2)/a)^p*(b^2*(3 + 2*p)*(5 + 2*p))), -((d*(3*a*d - b*c*(7 + 2*p))*x*(a + b*x^2)^(1 + p))/(b^2*(15 + 16*p + 4*p^2))) + (d*x*(a + b*x^2)^(1 + p)*(c + d*x^2))/(b*(5 + 2*p)) + ((3*a^2*d^2 - 2*a*b*c*d*(5 + 2*p) + b^2*c^2*(15 + 16*p + 4*p^2))*x*(a + b*x^2)^p*Hypergeometric2F1[1/2, -p, 3/2, -((b*x^2)/a)])/((1 + (b*x^2)/a)^p*(b^2*(15 + 16*p + 4*p^2)))]}
{(a + b*x^2)^p*(c + d*x^2)^1, x, 3, (d*x*(a + b*x^2)^(1 + p))/(b*(3 + 2*p)) - ((a*d - b*c*(3 + 2*p))*x*(a + b*x^2)^p*Hypergeometric2F1[1/2, -p, 3/2, -((b*x^2)/a)])/((1 + (b*x^2)/a)^p*(b*(3 + 2*p)))}
{(a + b*x^2)^p*(c + d*x^2)^0, x, 2, (x*(a + b*x^2)^p*Hypergeometric2F1[1/2, -p, 3/2, -((b*x^2)/a)])/(1 + (b*x^2)/a)^p}
{(a + b*x^2)^p/(c + d*x^2)^1, x, 3, (x*(a + b*x^2)^p*AppellF1[1/2, -p, 1, 3/2, -((b*x^2)/a), -((d*x^2)/c)])/((1 + (b*x^2)/a)^p*c)}
{(a + b*x^2)^p/(c + d*x^2)^2, x, 3, (x*(a + b*x^2)^p*AppellF1[1/2, -p, 2, 3/2, -((b*x^2)/a), -((d*x^2)/c)])/((1 + (b*x^2)/a)^p*c^2)}
{(a + b*x^2)^p/(c + d*x^2)^3, x, 3, (x*(a + b*x^2)^p*AppellF1[1/2, -p, 3, 3/2, -((b*x^2)/a), -((d*x^2)/c)])/((1 + (b*x^2)/a)^p*c^3)}


{(a + b*x^2)^(-1 - (b*c)/(2*b*c - 2*a*d))*(c + d*x^2)^(-1 + (a*d)/(2*b*c - 2*a*d)), x, 1, (x*(c + d*x^2)^((a*d)/(2*b*c - 2*a*d)))/((a + b*x^2)^((b*c)/(2*b*c - 2*a*d))*(a*c))}
...
{(a + b*x^3)/(c + d*x^3)^1, x, 8, (b*x)/d + ((b*c - a*d)*ArcTan[(c^(1/3) - 2*d^(1/3)*x)/(Sqrt[3]*c^(1/3))])/(Sqrt[3]*c^(2/3)*d^(4/3)) - ((b*c - a*d)*Log[c^(1/3) + d^(1/3)*x])/(3*c^(2/3)*d^(4/3)) + ((b*c - a*d)*Log[c^(2/3) - c^(1/3)*d^(1/3)*x + d^(2/3)*x^2])/(6*c^(2/3)*d^(4/3))}
{(a + b*x^3)/(c + d*x^3)^2, x, 8, -(((b*c - a*d)*x)/(3*c*d*(c + d*x^3))) - ((b*c + 2*a*d)*ArcTan[(c^(1/3) - 2*d^(1/3)*x)/(Sqrt[3]*c^(1/3))])/(3*Sqrt[3]*c^(5/3)*d^(4/3)) + ((b*c + 2*a*d)*Log[c^(1/3) + d^(1/3)*x])/(9*c^(5/3)*d^(4/3)) - ((b*c + 2*a*d)*Log[c^(2/3) - c^(1/3)*d^(1/3)*x + d^(2/3)*x^2])/(18*c^(5/3)*d^(4/3))}
{(a + b*x^3)/(c + d*x^3)^3, x, 9, -(((b*c - a*d)*x)/(6*c*d*(c + d*x^3)^2)) + ((b*c + 5*a*d)*x)/(18*c^2*d*(c + d*x^3)) - ((b*c + 5*a*d)*ArcTan[(c^(1/3) - 2*d^(1/3)*x)/(Sqrt[3]*c^(1/3))])/(9*Sqrt[3]*c^(8/3)*d^(4/3)) + ((b*c + 5*a*d)*Log[c^(1/3) + d^(1/3)*x])/(27*c^(8/3)*d^(4/3)) - ((b*c + 5*a*d)*Log[c^(2/3) - c^(1/3)*d^(1/3)*x + d^(2/3)*x^2])/(54*c^(8/3)*d^(4/3))}
...
{(a + b*x^3)^2/(c + d*x^3)^1, x, 9, -((b*(b*c - 2*a*d)*x)/d^2) + (b^2*x^4)/(4*d) - ((b*c - a*d)^2*ArcTan[(c^(1/3) - 2*d^(1/3)*x)/(Sqrt[3]*c^(1/3))])/(Sqrt[3]*c^(2/3)*d^(7/3)) + ((b*c - a*d)^2*Log[c^(1/3) + d^(1/3)*x])/(3*c^(2/3)*d^(7/3)) - ((b*c - a*d)^2*Log[c^(2/3) - c^(1/3)*d^(1/3)*x + d^(2/3)*x^2])/(6*c^(2/3)*d^(7/3))}
{(a + b*x^3)^2/(c + d*x^3)^2, x, 10, (b^2*x)/d^2 + ((b*c - a*d)^2*x)/(3*c*d^2*(c + d*x^3)) + (2*(b*c - a*d)*(2*b*c + a*d)*ArcTan[(c^(1/3) - 2*d^(1/3)*x)/(Sqrt[3]*c^(1/3))])/(3*Sqrt[3]*c^(5/3)*d^(7/3)) - (2*(b*c - a*d)*(2*b*c + a*d)*Log[c^(1/3) + d^(1/3)*x])/(9*c^(5/3)*d^(7/3)) + ((b*c - a*d)*(2*b*c + a*d)*Log[c^(2/3) - c^(1/3)*d^(1/3)*x + d^(2/3)*x^2])/(9*c^(5/3)*d^(7/3))}
{(a + b*x^3)^2/(c + d*x^3)^3, x, 9, -(((b*c - a*d)*x*(a + b*x^3))/(6*c*d*(c + d*x^3)^2)) - ((b*c - a*d)*(4*b*c + 5*a*d)*x)/(18*c^2*d^2*(c + d*x^3)) - ((2*b^2*c^2 + 2*a*b*c*d + 5*a^2*d^2)*ArcTan[(c^(1/3) - 2*d^(1/3)*x)/(Sqrt[3]*c^(1/3))])/(9*Sqrt[3]*c^(8/3)*d^(7/3)) + ((2*b^2*c^2 + 2*a*b*c*d + 5*a^2*d^2)*Log[c^(1/3) + d^(1/3)*x])/(27*c^(8/3)*d^(7/3)) - ((2*b^2*c^2 + 2*a*b*c*d + 5*a^2*d^2)*Log[c^(2/3) - c^(1/3)*d^(1/3)*x + d^(2/3)*x^2])/(54*c^(8/3)*d^(7/3))}
...
{1/(a + b*x^3)*(c + d*x^3)^4, x, 9, (d*(2*b*c - a*d)*(2*b^2*c^2 - 2*a*b*c*d + a^2*d^2)*x)/b^4 + (d^2*(6*b^2*c^2 - 4*a*b*c*d + a^2*d^2)*x^4)/(4*b^3) + (d^3*(4*b*c - a*d)*x^7)/(7*b^2) + (d^4*x^10)/(10*b) - ((b*c - a*d)^4*ArcTan[(a^(1/3) - 2*b^(1/3)*x)/(Sqrt[3]*a^(1/3))])/(Sqrt[3]*a^(2/3)*b^(13/3)) + ((b*c - a*d)^4*Log[a^(1/3) + b^(1/3)*x])/(3*a^(2/3)*b^(13/3)) - ((b*c - a*d)^4*Log[a^(2/3) - a^(1/3)*b^(1/3)*x + b^(2/3)*x^2])/(6*a^(2/3)*b^(13/3))}
{1/(a + b*x^3)*(c + d*x^3)^3, x, 9, (d*(3*b^2*c^2 - 3*a*b*c*d + a^2*d^2)*x)/b^3 + (d^2*(3*b*c - a*d)*x^4)/(4*b^2) + (d^3*x^7)/(7*b) - ((b*c - a*d)^3*ArcTan[(a^(1/3) - 2*b^(1/3)*x)/(Sqrt[3]*a^(1/3))])/(Sqrt[3]*a^(2/3)*b^(10/3)) + ((b*c - a*d)^3*Log[a^(1/3) + b^(1/3)*x])/(3*a^(2/3)*b^(10/3)) - ((b*c - a*d)^3*Log[a^(2/3) - a^(1/3)*b^(1/3)*x + b^(2/3)*x^2])/(6*a^(2/3)*b^(10/3))}
{1/(a + b*x^3)*(c + d*x^3)^2, x, 9, (d*(2*b*c - a*d)*x)/b^2 + (d^2*x^4)/(4*b) - ((b*c - a*d)^2*ArcTan[(a^(1/3) - 2*b^(1/3)*x)/(Sqrt[3]*a^(1/3))])/(Sqrt[3]*a^(2/3)*b^(7/3)) + ((b*c - a*d)^2*Log[a^(1/3) + b^(1/3)*x])/(3*a^(2/3)*b^(7/3)) - ((b*c - a*d)^2*Log[a^(2/3) - a^(1/3)*b^(1/3)*x + b^(2/3)*x^2])/(6*a^(2/3)*b^(7/3))}
{1/(a + b*x^3)*(c + d*x^3)^1, x, 8, (d*x)/b - ((b*c - a*d)*ArcTan[(a^(1/3) - 2*b^(1/3)*x)/(Sqrt[3]*a^(1/3))])/(Sqrt[3]*a^(2/3)*b^(4/3)) + ((b*c - a*d)*Log[a^(1/3) + b^(1/3)*x])/(3*a^(2/3)*b^(4/3)) - ((b*c - a*d)*Log[a^(2/3) - a^(1/3)*b^(1/3)*x + b^(2/3)*x^2])/(6*a^(2/3)*b^(4/3))}
{1/(a + b*x^3)/(c + d*x^3)^1, x, 15, -((b^(2/3)*ArcTan[(a^(1/3) - 2*b^(1/3)*x)/(Sqrt[3]*a^(1/3))])/(Sqrt[3]*a^(2/3)*(b*c - a*d))) + (d^(2/3)*ArcTan[(c^(1/3) - 2*d^(1/3)*x)/(Sqrt[3]*c^(1/3))])/(Sqrt[3]*c^(2/3)*(b*c - a*d)) + (b^(2/3)*Log[a^(1/3) + b^(1/3)*x])/(3*a^(2/3)*(b*c - a*d)) - (d^(2/3)*Log[c^(1/3) + d^(1/3)*x])/(3*c^(2/3)*(b*c - a*d)) - (b^(2/3)*Log[a^(2/3) - a^(1/3)*b^(1/3)*x + b^(2/3)*x^2])/(6*a^(2/3)*(b*c - a*d)) + (d^(2/3)*Log[c^(2/3) - c^(1/3)*d^(1/3)*x + d^(2/3)*x^2])/(6*c^(2/3)*(b*c - a*d))}
{1/(a + b*x^3)/(c + d*x^3)^2, x, 16, -((d*x)/(3*c*(b*c - a*d)*(c + d*x^3))) - (b^(5/3)*ArcTan[(a^(1/3) - 2*b^(1/3)*x)/(Sqrt[3]*a^(1/3))])/(Sqrt[3]*a^(2/3)*(b*c - a*d)^2) + (d^(2/3)*(5*b*c - 2*a*d)*ArcTan[(c^(1/3) - 2*d^(1/3)*x)/(Sqrt[3]*c^(1/3))])/(3*Sqrt[3]*c^(5/3)*(b*c - a*d)^2) + (b^(5/3)*Log[a^(1/3) + b^(1/3)*x])/(3*a^(2/3)*(b*c - a*d)^2) - (d^(2/3)*(5*b*c - 2*a*d)*Log[c^(1/3) + d^(1/3)*x])/(9*c^(5/3)*(b*c - a*d)^2) - (b^(5/3)*Log[a^(2/3) - a^(1/3)*b^(1/3)*x + b^(2/3)*x^2])/(6*a^(2/3)*(b*c - a*d)^2) + (d^(2/3)*(5*b*c - 2*a*d)*Log[c^(2/3) - c^(1/3)*d^(1/3)*x + d^(2/3)*x^2])/(18*c^(5/3)*(b*c - a*d)^2)}


{1/(a + b*x^3)^2*(c + d*x^3)^5, x, 10, (d^2*(10*b^3*c^3 - 20*a*b^2*c^2*d + 15*a^2*b*c*d^2 - 4*a^3*d^3)*x)/b^5 + (d^3*(10*b^2*c^2 - 10*a*b*c*d + 3*a^2*d^2)*x^4)/(4*b^4) + (d^4*(5*b*c - 2*a*d)*x^7)/(7*b^3) + (d^5*x^10)/(10*b^2) + ((b*c - a*d)^5*x)/(3*a*b^5*(a + b*x^3)) - ((b*c - a*d)^4*(2*b*c + 13*a*d)*ArcTan[(a^(1/3) - 2*b^(1/3)*x)/(Sqrt[3]*a^(1/3))])/(3*Sqrt[3]*a^(5/3)*b^(16/3)) + ((b*c - a*d)^4*(2*b*c + 13*a*d)*Log[a^(1/3) + b^(1/3)*x])/(9*a^(5/3)*b^(16/3)) - ((b*c - a*d)^4*(2*b*c + 13*a*d)*Log[a^(2/3) - a^(1/3)*b^(1/3)*x + b^(2/3)*x^2])/(18*a^(5/3)*b^(16/3))}
{1/(a + b*x^3)^2*(c + d*x^3)^4, x, 10, (d^2*(6*b^2*c^2 - 8*a*b*c*d + 3*a^2*d^2)*x)/b^4 + (d^3*(2*b*c - a*d)*x^4)/(2*b^3) + (d^4*x^7)/(7*b^2) + ((b*c - a*d)^4*x)/(3*a*b^4*(a + b*x^3)) - (2*(b*c - a*d)^3*(b*c + 5*a*d)*ArcTan[(a^(1/3) - 2*b^(1/3)*x)/(Sqrt[3]*a^(1/3))])/(3*Sqrt[3]*a^(5/3)*b^(13/3)) + (2*(b*c - a*d)^3*(b*c + 5*a*d)*Log[a^(1/3) + b^(1/3)*x])/(9*a^(5/3)*b^(13/3)) - ((b*c - a*d)^3*(b*c + 5*a*d)*Log[a^(2/3) - a^(1/3)*b^(1/3)*x + b^(2/3)*x^2])/(9*a^(5/3)*b^(13/3))}
{1/(a + b*x^3)^2*(c + d*x^3)^3, x, 10, (d^2*(3*b*c - 2*a*d)*x)/b^3 + (d^3*x^4)/(4*b^2) + ((b*c - a*d)^3*x)/(3*a*b^3*(a + b*x^3)) - ((b*c - a*d)^2*(2*b*c + 7*a*d)*ArcTan[(a^(1/3) - 2*b^(1/3)*x)/(Sqrt[3]*a^(1/3))])/(3*Sqrt[3]*a^(5/3)*b^(10/3)) + ((b*c - a*d)^2*(2*b*c + 7*a*d)*Log[a^(1/3) + b^(1/3)*x])/(9*a^(5/3)*b^(10/3)) - ((b*c - a*d)^2*(2*b*c + 7*a*d)*Log[a^(2/3) - a^(1/3)*b^(1/3)*x + b^(2/3)*x^2])/(18*a^(5/3)*b^(10/3))}
{1/(a + b*x^3)^2*(c + d*x^3)^2, x, 10, (d^2*x)/b^2 + ((b*c - a*d)^2*x)/(3*a*b^2*(a + b*x^3)) - (2*(b*c - a*d)*(b*c + 2*a*d)*ArcTan[(a^(1/3) - 2*b^(1/3)*x)/(Sqrt[3]*a^(1/3))])/(3*Sqrt[3]*a^(5/3)*b^(7/3)) + (2*(b*c - a*d)*(b*c + 2*a*d)*Log[a^(1/3) + b^(1/3)*x])/(9*a^(5/3)*b^(7/3)) - ((b*c - a*d)*(b*c + 2*a*d)*Log[a^(2/3) - a^(1/3)*b^(1/3)*x + b^(2/3)*x^2])/(9*a^(5/3)*b^(7/3))}
{1/(a + b*x^3)^2*(c + d*x^3)^1, x, 8, ((b*c - a*d)*x)/(3*a*b*(a + b*x^3)) - ((2*b*c + a*d)*ArcTan[(a^(1/3) - 2*b^(1/3)*x)/(Sqrt[3]*a^(1/3))])/(3*Sqrt[3]*a^(5/3)*b^(4/3)) + ((2*b*c + a*d)*Log[a^(1/3) + b^(1/3)*x])/(9*a^(5/3)*b^(4/3)) - ((2*b*c + a*d)*Log[a^(2/3) - a^(1/3)*b^(1/3)*x + b^(2/3)*x^2])/(18*a^(5/3)*b^(4/3))}
...
{1/((a + b*x^3)*(c + d*x^3)^(1/3)), x, 8, -(ArcTan[(a^(1/3) - (2*(b*c - a*d)^(1/3)*x)/(c + d*x^3)^(1/3))/(Sqrt[3]*a^(1/3))]/(Sqrt[3]*a^(2/3)*(b*c - a*d)^(1/3))) + Log[a^(1/3) + ((b*c - a*d)^(1/3)*x)/(c + d*x^3)^(1/3)]/(3*a^(2/3)*(b*c - a*d)^(1/3)) - Log[a^(2/3) + ((b*c - a*d)^(2/3)*x^2)/(c + d*x^3)^(2/3) - (a^(1/3)*(b*c - a*d)^(1/3)*x)/(c + d*x^3)^(1/3)]/(6*a^(2/3)*(b*c - a*d)^(1/3))}
{(c + d*x^3)^(2/3)/(a + b*x^3)^2, x, 9, (x*(c + d*x^3)^(2/3))/(3*a*(a + b*x^3)) - (2*c*ArcTan[(a^(1/3) - (2*(b*c - a*d)^(1/3)*x)/(c + d*x^3)^(1/3))/(Sqrt[3]*a^(1/3))])/(3*Sqrt[3]*a^(5/3)*(b*c - a*d)^(1/3)) + (2*c*Log[a^(1/3) + ((b*c - a*d)^(1/3)*x)/(c + d*x^3)^(1/3)])/(9*a^(5/3)*(b*c - a*d)^(1/3)) - (c*Log[a^(2/3) + ((b*c - a*d)^(2/3)*x^2)/(c + d*x^3)^(2/3) - (a^(1/3)*(b*c - a*d)^(1/3)*x)/(c + d*x^3)^(1/3)])/(9*a^(5/3)*(b*c - a*d)^(1/3))}
{(c + d*x^3)^(5/3)/(a + b*x^3)^3, x, 10, (5*c*x*(c + d*x^3)^(2/3))/(18*a^2*(a + b*x^3)) + (x*(c + d*x^3)^(5/3))/(6*a*(a + b*x^3)^2) - (5*c^2*ArcTan[(a^(1/3) - (2*(b*c - a*d)^(1/3)*x)/(c + d*x^3)^(1/3))/(Sqrt[3]*a^(1/3))])/(9*Sqrt[3]*a^(8/3)*(b*c - a*d)^(1/3)) + (5*c^2*Log[a^(1/3) + ((b*c - a*d)^(1/3)*x)/(c + d*x^3)^(1/3)])/(27*a^(8/3)*(b*c - a*d)^(1/3)) - (5*c^2*Log[a^(2/3) + ((b*c - a*d)^(2/3)*x^2)/(c + d*x^3)^(2/3) - (a^(1/3)*(b*c - a*d)^(1/3)*x)/(c + d*x^3)^(1/3)])/(54*a^(8/3)*(b*c - a*d)^(1/3))}
...
{1/(a + b*x^3)^1*(c + d*x^3)^q, x, 3, (x*(c + d*x^3)^q*AppellF1[1/3, 1, -q, 4/3, -((b*x^3)/a), -((d*x^3)/c)])/((1 + (d*x^3)/c)^q*a)}
{1/(a + b*x^3)^2*(c + d*x^3)^q, x, 3, (x*(c + d*x^3)^q*AppellF1[1/3, 2, -q, 4/3, -((b*x^3)/a), -((d*x^3)/c)])/((1 + (d*x^3)/c)^q*a^2)}
...
{(a + b*x^3)^m/(c + d*x^3)^1, x, 3, (x*(a + b*x^3)^m*AppellF1[1/3, -m, 1, 4/3, -((b*x^3)/a), -((d*x^3)/c)])/((1 + (b*x^3)/a)^m*c)}
{(a + b*x^3)^m/(c + d*x^3)^2, x, 3, (x*(a + b*x^3)^m*AppellF1[1/3, -m, 2, 4/3, -((b*x^3)/a), -((d*x^3)/c)])/((1 + (b*x^3)/a)^m*c^2)}
{(a + b*x^3)^m/(c + d*x^3)^3, x, 3, (x*(a + b*x^3)^m*AppellF1[1/3, -m, 3, 4/3, -((b*x^3)/a), -((d*x^3)/c)])/((1 + (b*x^3)/a)^m*c^3)}
...
{(a + b*x^4)^(3/2)/(c + d*x^4), x, 8, (b*x*Sqrt[a + b*x^4])/(3*d) + ((b*c - a*d)^2*ArcTan[(Sqrt[-((Sqrt[-c]*(b - (a*d)/c))/Sqrt[d])]*x)/Sqrt[a + b*x^4]])/(4*c*d^2*Sqrt[(b*c - a*d)/(Sqrt[-c]*Sqrt[d])]) + ((b*c - a*d)^2*ArcTan[(Sqrt[(Sqrt[-c]*(b - (a*d)/c))/Sqrt[d]]*x)/Sqrt[a + b*x^4]])/(4*c*d^2*Sqrt[-((b*c - a*d)/(Sqrt[-c]*Sqrt[d]))]) - (b^(3/4)*(3*b*c - 5*a*d)*(Sqrt[a] + Sqrt[b]*x^2)*Sqrt[(a + b*x^4)/(Sqrt[a] + Sqrt[b]*x^2)^2]*EllipticF[2*ArcTan[(b^(1/4)*x)/a^(1/4)], 1/2])/(6*a^(1/4)*d^2*Sqrt[a + b*x^4]) + (b^(1/4)*(b*c - a*d)^2*(Sqrt[a] + Sqrt[b]*x^2)*Sqrt[(a + b*x^4)/(Sqrt[a] + Sqrt[b]*x^2)^2]*EllipticF[2*ArcTan[(b^(1/4)*x)/a^(1/4)], 1/2])/(4*a^(1/4)*(Sqrt[b]*c - Sqrt[a]*Sqrt[-c]*Sqrt[d])*d^2*Sqrt[a + b*x^4]) + (b^(1/4)*(b*c - a*d)^2*(Sqrt[a] + Sqrt[b]*x^2)*Sqrt[(a + b*x^4)/(Sqrt[a] + Sqrt[b]*x^2)^2]*EllipticF[2*ArcTan[(b^(1/4)*x)/a^(1/4)], 1/2])/(4*a^(1/4)*(Sqrt[b]*c + Sqrt[a]*Sqrt[-c]*Sqrt[d])*d^2*Sqrt[a + b*x^4]) - ((Sqrt[b]*Sqrt[-c] + Sqrt[a]*Sqrt[d])*(b*c - a*d)^2*(Sqrt[a] + Sqrt[b]*x^2)*Sqrt[(a + b*x^4)/(Sqrt[a] + Sqrt[b]*x^2)^2]*EllipticPi[-((Sqrt[b]*Sqrt[-c] - Sqrt[a]*Sqrt[d])^2/(4*Sqrt[a]*Sqrt[b]*Sqrt[-c]*Sqrt[d])), 2*ArcTan[(b^(1/4)*x)/a^(1/4)], 1/2])/(8*a^(1/4)*b^(1/4)*c*(Sqrt[b]*Sqrt[-c] - Sqrt[a]*Sqrt[d])*d^2*Sqrt[a + b*x^4]) - ((Sqrt[b]*Sqrt[-c] - Sqrt[a]*Sqrt[d])*(b*c - a*d)^2*(Sqrt[a] + Sqrt[b]*x^2)*Sqrt[(a + b*x^4)/(Sqrt[a] + Sqrt[b]*x^2)^2]*EllipticPi[(Sqrt[b]*Sqrt[-c] + Sqrt[a]*Sqrt[d])^2/(4*Sqrt[a]*Sqrt[b]*Sqrt[-c]*Sqrt[d]), 2*ArcTan[(b^(1/4)*x)/a^(1/4)], 1/2])/(8*a^(1/4)*b^(1/4)*c*(Sqrt[b]*Sqrt[-c] + Sqrt[a]*Sqrt[d])*d^2*Sqrt[a + b*x^4])}
{(a + b*x^4)^(1/2)/(c + d*x^4), x, 7, -(((b*c - a*d)*ArcTan[(Sqrt[-((Sqrt[-c]*(b - (a*d)/c))/Sqrt[d])]*x)/Sqrt[a + b*x^4]])/(4*c*d*Sqrt[(b*c - a*d)/(Sqrt[-c]*Sqrt[d])])) - ((b*c - a*d)*ArcTan[(Sqrt[(Sqrt[-c]*(b - (a*d)/c))/Sqrt[d]]*x)/Sqrt[a + b*x^4]])/(4*c*d*Sqrt[-((b*c - a*d)/(Sqrt[-c]*Sqrt[d]))]) + (b^(3/4)*(Sqrt[a] + Sqrt[b]*x^2)*Sqrt[(a + b*x^4)/(Sqrt[a] + Sqrt[b]*x^2)^2]*EllipticF[2*ArcTan[(b^(1/4)*x)/a^(1/4)], 1/2])/(2*a^(1/4)*d*Sqrt[a + b*x^4]) - (b^(1/4)*(b*c - a*d)*(Sqrt[a] + Sqrt[b]*x^2)*Sqrt[(a + b*x^4)/(Sqrt[a] + Sqrt[b]*x^2)^2]*EllipticF[2*ArcTan[(b^(1/4)*x)/a^(1/4)], 1/2])/(4*a^(1/4)*(Sqrt[b]*c - Sqrt[a]*Sqrt[-c]*Sqrt[d])*d*Sqrt[a + b*x^4]) - (b^(1/4)*(b*c - a*d)*(Sqrt[a] + Sqrt[b]*x^2)*Sqrt[(a + b*x^4)/(Sqrt[a] + Sqrt[b]*x^2)^2]*EllipticF[2*ArcTan[(b^(1/4)*x)/a^(1/4)], 1/2])/(4*a^(1/4)*(Sqrt[b]*c + Sqrt[a]*Sqrt[-c]*Sqrt[d])*d*Sqrt[a + b*x^4]) + ((Sqrt[b]*Sqrt[-c] + Sqrt[a]*Sqrt[d])*(b*c - a*d)*(Sqrt[a] + Sqrt[b]*x^2)*Sqrt[(a + b*x^4)/(Sqrt[a] + Sqrt[b]*x^2)^2]*EllipticPi[-((Sqrt[b]*Sqrt[-c] - Sqrt[a]*Sqrt[d])^2/(4*Sqrt[a]*Sqrt[b]*Sqrt[-c]*Sqrt[d])), 2*ArcTan[(b^(1/4)*x)/a^(1/4)], 1/2])/(8*a^(1/4)*b^(1/4)*c*(Sqrt[b]*Sqrt[-c] - Sqrt[a]*Sqrt[d])*d*Sqrt[a + b*x^4]) + ((Sqrt[b]*Sqrt[-c] - Sqrt[a]*Sqrt[d])*(b*c - a*d)*(Sqrt[a] + Sqrt[b]*x^2)*Sqrt[(a + b*x^4)/(Sqrt[a] + Sqrt[b]*x^2)^2]*EllipticPi[(Sqrt[b]*Sqrt[-c] + Sqrt[a]*Sqrt[d])^2/(4*Sqrt[a]*Sqrt[b]*Sqrt[-c]*Sqrt[d]), 2*ArcTan[(b^(1/4)*x)/a^(1/4)], 1/2])/(8*a^(1/4)*b^(1/4)*c*(Sqrt[b]*Sqrt[-c] + Sqrt[a]*Sqrt[d])*d*Sqrt[a + b*x^4])}
{1/((a + b*x^4)^(1/2)*(c + d*x^4)), x, 5, ArcTan[(Sqrt[-((Sqrt[-c]*(b - (a*d)/c))/Sqrt[d])]*x)/Sqrt[a + b*x^4]]/(4*c*Sqrt[(b*c - a*d)/(Sqrt[-c]*Sqrt[d])]) + ArcTan[(Sqrt[(Sqrt[-c]*(b - (a*d)/c))/Sqrt[d]]*x)/Sqrt[a + b*x^4]]/(4*c*Sqrt[-((b*c - a*d)/(Sqrt[-c]*Sqrt[d]))]) + (b^(1/4)*(Sqrt[a] + Sqrt[b]*x^2)*Sqrt[(a + b*x^4)/(Sqrt[a] + Sqrt[b]*x^2)^2]*EllipticF[2*ArcTan[(b^(1/4)*x)/a^(1/4)], 1/2])/(4*a^(1/4)*(Sqrt[b]*c - Sqrt[a]*Sqrt[-c]*Sqrt[d])*Sqrt[a + b*x^4]) + (b^(1/4)*(Sqrt[a] + Sqrt[b]*x^2)*Sqrt[(a + b*x^4)/(Sqrt[a] + Sqrt[b]*x^2)^2]*EllipticF[2*ArcTan[(b^(1/4)*x)/a^(1/4)], 1/2])/(4*a^(1/4)*(Sqrt[b]*c + Sqrt[a]*Sqrt[-c]*Sqrt[d])*Sqrt[a + b*x^4]) - ((Sqrt[b]*Sqrt[-c] + Sqrt[a]*Sqrt[d])*(Sqrt[a] + Sqrt[b]*x^2)*Sqrt[(a + b*x^4)/(Sqrt[a] + Sqrt[b]*x^2)^2]*EllipticPi[-((Sqrt[b]*Sqrt[-c] - Sqrt[a]*Sqrt[d])^2/(4*Sqrt[a]*Sqrt[b]*Sqrt[-c]*Sqrt[d])), 2*ArcTan[(b^(1/4)*x)/a^(1/4)], 1/2])/(8*a^(1/4)*b^(1/4)*c*(Sqrt[b]*Sqrt[-c] - Sqrt[a]*Sqrt[d])*Sqrt[a + b*x^4]) - ((Sqrt[b]*Sqrt[-c] - Sqrt[a]*Sqrt[d])*(Sqrt[a] + Sqrt[b]*x^2)*Sqrt[(a + b*x^4)/(Sqrt[a] + Sqrt[b]*x^2)^2]*EllipticPi[(Sqrt[b]*Sqrt[-c] + Sqrt[a]*Sqrt[d])^2/(4*Sqrt[a]*Sqrt[b]*Sqrt[-c]*Sqrt[d]), 2*ArcTan[(b^(1/4)*x)/a^(1/4)], 1/2])/(8*a^(1/4)*b^(1/4)*c*(Sqrt[b]*Sqrt[-c] + Sqrt[a]*Sqrt[d])*Sqrt[a + b*x^4])}
{1/((a + b*x^4)^(3/2)*(c + d*x^4)), x, 8, (b*x)/(2*a*(b*c - a*d)*Sqrt[a + b*x^4]) - (d*ArcTan[(Sqrt[-((Sqrt[-c]*(b - (a*d)/c))/Sqrt[d])]*x)/Sqrt[a + b*x^4]])/(4*c*(b*c - a*d)*Sqrt[(b*c - a*d)/(Sqrt[-c]*Sqrt[d])]) - (d*ArcTan[(Sqrt[(Sqrt[-c]*(b - (a*d)/c))/Sqrt[d]]*x)/Sqrt[a + b*x^4]])/(4*c*(b*c - a*d)*Sqrt[-((b*c - a*d)/(Sqrt[-c]*Sqrt[d]))]) + (b^(3/4)*(Sqrt[a] + Sqrt[b]*x^2)*Sqrt[(a + b*x^4)/(Sqrt[a] + Sqrt[b]*x^2)^2]*EllipticF[2*ArcTan[(b^(1/4)*x)/a^(1/4)], 1/2])/(4*a^(5/4)*(b*c - a*d)*Sqrt[a + b*x^4]) - (b^(1/4)*d*(Sqrt[a] + Sqrt[b]*x^2)*Sqrt[(a + b*x^4)/(Sqrt[a] + Sqrt[b]*x^2)^2]*EllipticF[2*ArcTan[(b^(1/4)*x)/a^(1/4)], 1/2])/(4*a^(1/4)*(Sqrt[b]*c - Sqrt[a]*Sqrt[-c]*Sqrt[d])*(b*c - a*d)*Sqrt[a + b*x^4]) - (b^(1/4)*d*(Sqrt[a] + Sqrt[b]*x^2)*Sqrt[(a + b*x^4)/(Sqrt[a] + Sqrt[b]*x^2)^2]*EllipticF[2*ArcTan[(b^(1/4)*x)/a^(1/4)], 1/2])/(4*a^(1/4)*(Sqrt[b]*c + Sqrt[a]*Sqrt[-c]*Sqrt[d])*(b*c - a*d)*Sqrt[a + b*x^4]) + ((Sqrt[b]*Sqrt[-c] + Sqrt[a]*Sqrt[d])*d*(Sqrt[a] + Sqrt[b]*x^2)*Sqrt[(a + b*x^4)/(Sqrt[a] + Sqrt[b]*x^2)^2]*EllipticPi[-((Sqrt[b]*Sqrt[-c] - Sqrt[a]*Sqrt[d])^2/(4*Sqrt[a]*Sqrt[b]*Sqrt[-c]*Sqrt[d])), 2*ArcTan[(b^(1/4)*x)/a^(1/4)], 1/2])/(8*a^(1/4)*b^(1/4)*c*(Sqrt[b]*Sqrt[-c] - Sqrt[a]*Sqrt[d])*(b*c - a*d)*Sqrt[a + b*x^4]) + ((Sqrt[b]*Sqrt[-c] - Sqrt[a]*Sqrt[d])*d*(Sqrt[a] + Sqrt[b]*x^2)*Sqrt[(a + b*x^4)/(Sqrt[a] + Sqrt[b]*x^2)^2]*EllipticPi[(Sqrt[b]*Sqrt[-c] + Sqrt[a]*Sqrt[d])^2/(4*Sqrt[a]*Sqrt[b]*Sqrt[-c]*Sqrt[d]), 2*ArcTan[(b^(1/4)*x)/a^(1/4)], 1/2])/(8*a^(1/4)*b^(1/4)*c*(Sqrt[b]*Sqrt[-c] + Sqrt[a]*Sqrt[d])*(b*c - a*d)*Sqrt[a + b*x^4])}
{1/((a + b*x^4)^(5/2)*(c + d*x^4)), x, 9, (b*x)/(6*a*(b*c - a*d)*(a + b*x^4)^(3/2)) + (b*(5*b*c - 11*a*d)*x)/(12*a^2*(b*c - a*d)^2*Sqrt[a + b*x^4]) + (d^2*ArcTan[(Sqrt[-((Sqrt[-c]*(b - (a*d)/c))/Sqrt[d])]*x)/Sqrt[a + b*x^4]])/(4*c*(b*c - a*d)^2*Sqrt[(b*c - a*d)/(Sqrt[-c]*Sqrt[d])]) + (d^2*ArcTan[(Sqrt[(Sqrt[-c]*(b - (a*d)/c))/Sqrt[d]]*x)/Sqrt[a + b*x^4]])/(4*c*(b*c - a*d)^2*Sqrt[-((b*c - a*d)/(Sqrt[-c]*Sqrt[d]))]) + (b^(1/4)*d^2*(Sqrt[a] + Sqrt[b]*x^2)*Sqrt[(a + b*x^4)/(Sqrt[a] + Sqrt[b]*x^2)^2]*EllipticF[2*ArcTan[(b^(1/4)*x)/a^(1/4)], 1/2])/(4*a^(1/4)*(Sqrt[b]*c - Sqrt[a]*Sqrt[-c]*Sqrt[d])*(b*c - a*d)^2*Sqrt[a + b*x^4]) + (b^(1/4)*d^2*(Sqrt[a] + Sqrt[b]*x^2)*Sqrt[(a + b*x^4)/(Sqrt[a] + Sqrt[b]*x^2)^2]*EllipticF[2*ArcTan[(b^(1/4)*x)/a^(1/4)], 1/2])/(4*a^(1/4)*(Sqrt[b]*c + Sqrt[a]*Sqrt[-c]*Sqrt[d])*(b*c - a*d)^2*Sqrt[a + b*x^4]) + (b^(3/4)*(5*b*c - 11*a*d)*(Sqrt[a] + Sqrt[b]*x^2)*Sqrt[(a + b*x^4)/(Sqrt[a] + Sqrt[b]*x^2)^2]*EllipticF[2*ArcTan[(b^(1/4)*x)/a^(1/4)], 1/2])/(24*a^(9/4)*(b*c - a*d)^2*Sqrt[a + b*x^4]) - ((Sqrt[b]*Sqrt[-c] + Sqrt[a]*Sqrt[d])*d^2*(Sqrt[a] + Sqrt[b]*x^2)*Sqrt[(a + b*x^4)/(Sqrt[a] + Sqrt[b]*x^2)^2]*EllipticPi[-((Sqrt[b]*Sqrt[-c] - Sqrt[a]*Sqrt[d])^2/(4*Sqrt[a]*Sqrt[b]*Sqrt[-c]*Sqrt[d])), 2*ArcTan[(b^(1/4)*x)/a^(1/4)], 1/2])/(8*a^(1/4)*b^(1/4)*c*(Sqrt[b]*Sqrt[-c] - Sqrt[a]*Sqrt[d])*(b*c - a*d)^2*Sqrt[a + b*x^4]) - ((Sqrt[b]*Sqrt[-c] - Sqrt[a]*Sqrt[d])*d^2*(Sqrt[a] + Sqrt[b]*x^2)*Sqrt[(a + b*x^4)/(Sqrt[a] + Sqrt[b]*x^2)^2]*EllipticPi[(Sqrt[b]*Sqrt[-c] + Sqrt[a]*Sqrt[d])^2/(4*Sqrt[a]*Sqrt[b]*Sqrt[-c]*Sqrt[d]), 2*ArcTan[(b^(1/4)*x)/a^(1/4)], 1/2])/(8*a^(1/4)*b^(1/4)*c*(Sqrt[b]*Sqrt[-c] + Sqrt[a]*Sqrt[d])*(b*c - a*d)^2*Sqrt[a + b*x^4])}
...
{1/(a + b*x^4)^1*(c + d*x^4)^q, x, 3, (x*(c + d*x^4)^q*AppellF1[1/4, 1, -q, 5/4, -((b*x^4)/a), -((d*x^4)/c)])/((1 + (d*x^4)/c)^q*a)}
{1/(a + b*x^4)^2*(c + d*x^4)^q, x, 3, (x*(c + d*x^4)^q*AppellF1[1/4, 2, -q, 5/4, -((b*x^4)/a), -((d*x^4)/c)])/((1 + (d*x^4)/c)^q*a^2)}
...
{1/((a + b*x^5)^(1/5)*(c + d*x^5)), x, 8, (Sqrt[(1/2)*(5 + Sqrt[5])]*ArcTan[((1 - Sqrt[5])*c^(1/5) + (4*(b*c - a*d)^(1/5)*x)/(a + b*x^5)^(1/5))/(Sqrt[2*(5 + Sqrt[5])]*c^(1/5))])/(5*c^(4/5)*(b*c - a*d)^(1/5)) + (Sqrt[(1/2)*(5 - Sqrt[5])]*ArcTan[(Sqrt[5 + Sqrt[5]]*((1 + Sqrt[5])*c^(1/5) + (4*(b*c - a*d)^(1/5)*x)/(a + b*x^5)^(1/5)))/(2*Sqrt[10]*c^(1/5))])/(5*c^(4/5)*(b*c - a*d)^(1/5)) - Log[c^(1/5) - ((b*c - a*d)^(1/5)*x)/(a + b*x^5)^(1/5)]/(5*c^(4/5)*(b*c - a*d)^(1/5)) + ((1 - Sqrt[5])*Log[(2*(b*c - a*d)^(2/5)*x^2 + c^(1/5)*(b*c - a*d)^(1/5)*x*(a + b*x^5)^(1/5) - Sqrt[5]*c^(1/5)*(b*c - a*d)^(1/5)*x*(a + b*x^5)^(1/5) + 2*c^(2/5)*(a + b*x^5)^(2/5))/(a + b*x^5)^(2/5)])/(20*c^(4/5)*(b*c - a*d)^(1/5)) + ((1 + Sqrt[5])*Log[(2*(b*c - a*d)^(2/5)*x^2 + c^(1/5)*(b*c - a*d)^(1/5)*x*(a + b*x^5)^(1/5) + Sqrt[5]*c^(1/5)*(b*c - a*d)^(1/5)*x*(a + b*x^5)^(1/5) + 2*c^(2/5)*(a + b*x^5)^(2/5))/(a + b*x^5)^(2/5)])/(20*c^(4/5)*(b*c - a*d)^(1/5))}
...
{(a + b/x)^(-3/2), x, 5, (-2*x)/(a*Sqrt[a + b/x]) + (3*Sqrt[a + b/x]*x)/a^2 - (3*b*ArcTanh[Sqrt[a + b/x]/Sqrt[a]])/a^(5/2)}
...
{(c + d/x)^3/(a + b/x)^(5/2), x, 5, (2*a*(b*c - a*d)*(10*b^2*c^2 - 5*a*b*c*d - 2*a^2*d^2) + (3*b*(b*c - a*d)*(5*b^2*c^2 - a*b*c*d - 2*a^2*d^2))/x)/(3*a^3*b^2*(a + b/x)^(3/2)) + (c*(c + d/x)^2*x)/(a*(a + b/x)^(3/2)) - (c^2*(5*b*c - 6*a*d)*ArcTanh[Sqrt[a + b/x]/Sqrt[a]])/a^(7/2)}
...
{(a + b/x)^(-5/2), x, 6, (-2*x)/(3*a*(a + b/x)^(3/2)) - (10*x)/(3*a^2*Sqrt[a + b/x]) + (5*Sqrt[a + b/x]*x)/a^3 - (5*b*ArcTanh[Sqrt[a + b/x]/Sqrt[a]])/a^(7/2)}
...
{Sqrt[a + b/x]*(c + d/x)^(1/2), x, 7, Sqrt[a + b/x]*Sqrt[c + d/x]*x + ((b*c + a*d)*ArcTanh[(Sqrt[c]*Sqrt[a + b/x])/(Sqrt[a]*Sqrt[c + d/x])])/(Sqrt[a]*Sqrt[c]) - 2*Sqrt[b]*Sqrt[d]*ArcTanh[(Sqrt[d]*Sqrt[a + b/x])/(Sqrt[b]*Sqrt[c + d/x])]}
...
{(a + b/x^3)/(c + d/x^3), x, 9, (a*x)/c - ((b*c - a*d)*ArcTan[(d^(1/3) - 2*c^(1/3)*x)/(Sqrt[3]*d^(1/3))])/(Sqrt[3]*c^(4/3)*d^(2/3)) + ((b*c - a*d)*Log[d^(1/3) + c^(1/3)*x])/(3*c^(4/3)*d^(2/3)) - ((b*c - a*d)*Log[d^(2/3) - c^(1/3)*d^(1/3)*x + c^(2/3)*x^2])/(6*c^(4/3)*d^(2/3))}
...
{(-16 + x^(3/4))/(16 + x^(3/4)), x, 10, -128*x^(1/4) + x - (256*2^(1/3)*ArcTan[(2^(1/3) - x^(1/4))/(2^(1/3)*Sqrt[3])])/Sqrt[3] + (256/3)*2^(1/3)*Log[2*2^(1/3) + x^(1/4)] - (128/3)*2^(1/3)*Log[4*2^(2/3) - 2*2^(1/3)*x^(1/4) + Sqrt[x]]}
...
{(a + b*x^n)^p/(c + d*x^n)^1, x, 3, (x*(a + b*x^n)^p*AppellF1[1/n, -p, 1, 1 + 1/n, -((b*x^n)/a), -((d*x^n)/c)])/((1 + (b*x^n)/a)^p*c)}
{(a + b*x^n)^p/(c + d*x^n)^2, x, 3, (x*(a + b*x^n)^p*AppellF1[1/n, -p, 2, 1 + 1/n, -((b*x^n)/a), -((d*x^n)/c)])/((1 + (b*x^n)/a)^p*c^2)}
{(a + b*x^n)^p/(c + d*x^n)^3, x, 3, (x*(a + b*x^n)^p*AppellF1[1/n, -p, 3, 1 + 1/n, -((b*x^n)/a), -((d*x^n)/c)])/((1 + (b*x^n)/a)^p*c^3)}
...
(* ::Subsection::Closed:: *)
(*Integrands of the form (e x)^m (a1+b1 x)^p (a2+b2 x)^p (c+d x^2)^q with a2 b1+a1 b2=0*)
...
{x^0*(a + b*x^2)/(Sqrt[-1 + c*x]*Sqrt[1 + c*x]), x, 4, (b*x*Sqrt[-1 + c*x]*Sqrt[1 + c*x])/(2*c^2) + (b*ArcCosh[c*x])/(2*c^3) + (a*ArcCosh[c*x])/c}
...
{1/(Sqrt[a - b*Sqrt[x]]*Sqrt[a + b*Sqrt[x]]*Sqrt[a^2 + b^2*x]), x, 3, -((2*Sqrt[a^2 - b^2*x]*ArcTan[Sqrt[a^2 - b^2*x]/Sqrt[a^2 + b^2*x]])/(b^2*Sqrt[a - b*Sqrt[x]]*Sqrt[a + b*Sqrt[x]]))}
...
{(c + d*x^(2*n))^p/((a + b*x^n)*(a - b*x^n)), x, 4, (x*(c + d*x^(2*n))^p*AppellF1[1/(2*n), 1, -p, (1/2)*(2 + 1/n), (b^2*x^(2*n))/a^2, -((d*x^(2*n))/c)])/((1 + (d*x^(2*n))/c)^p*a^2)}
