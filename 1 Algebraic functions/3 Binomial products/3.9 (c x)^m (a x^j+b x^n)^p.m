...
{x*(a*x + b*x^3), x, 2, (a*x^3)/3 + (b*x^5)/5}
...
{1/(1/x^2 + x^3), x, 8, (1/5)*Sqrt[(1/2)*(5 - Sqrt[5])]*ArcTan[(1 - Sqrt[5] - 4*x)/Sqrt[2*(5 + Sqrt[5])]] - (1/5)*Sqrt[(1/2)*(5 + Sqrt[5])]*ArcTan[(1/2)*Sqrt[(1/10)*(5 + Sqrt[5])]*(1 + Sqrt[5] - 4*x)] + (1/5)*Log[1 + x] - (1/20)*(1 + Sqrt[5])*Log[1 - (1/2)*(1 - Sqrt[5])*x + x^2] - (1/20)*(1 - Sqrt[5])*Log[1 - (1/2)*(1 + Sqrt[5])*x + x^2]}
...
{1/(a*x^(1/3) + b*x^(2/3))^(1/3), x, 11, -((45*a^2*(a + 2*b*x^(1/3))*(-((b*(a*x^(1/3) + b*x^(2/3)))/a^2))^(1/3))/(14*2^(1/3)*b^3*(1 - Sqrt[3] - (1 - (a + 2*b*x^(1/3))^2/a^2)^(1/3))*(a*x^(1/3) + b*x^(2/3))^(1/3))) - (45*a*(a + b*x^(1/3))*x^(1/3))/(28*b^2*(a*x^(1/3) + b*x^(2/3))^(1/3)) + (9*(a + b*x^(1/3))*x^(2/3))/(7*b*(a*x^(1/3) + b*x^(2/3))^(1/3)) - (45*3^(1/4)*Sqrt[2 + Sqrt[3]]*a^4*(1 - (1 - (a + 2*b*x^(1/3))^2/a^2)^(1/3))*Sqrt[(1 + (1 - (a + 2*b*x^(1/3))^2/a^2)^(1/3) + (1 - (a + 2*b*x^(1/3))^2/a^2)^(2/3))/(1 - Sqrt[3] - (1 - (a + 2*b*x^(1/3))^2/a^2)^(1/3))^2]*(-((b*(a*x^(1/3) + b*x^(2/3)))/a^2))^(1/3)*EllipticE[ArcSin[(1 + Sqrt[3] - (1 - (a + 2*b*x^(1/3))^2/a^2)^(1/3))/(1 - Sqrt[3] - (1 - (a + 2*b*x^(1/3))^2/a^2)^(1/3))], -7 + 4*Sqrt[3]])/(28*2^(1/3)*b^3*Sqrt[-((1 - (1 - (a + 2*b*x^(1/3))^2/a^2)^(1/3))/(1 - Sqrt[3] - (1 - (a + 2*b*x^(1/3))^2/a^2)^(1/3))^2)]*(a + 2*b*x^(1/3))*(a*x^(1/3) + b*x^(2/3))^(1/3)) + (15*3^(3/4)*a^4*(1 - (1 - (a + 2*b*x^(1/3))^2/a^2)^(1/3))*Sqrt[(1 + (1 - (a + 2*b*x^(1/3))^2/a^2)^(1/3) + (1 - (a + 2*b*x^(1/3))^2/a^2)^(2/3))/(1 - Sqrt[3] - (1 - (a + 2*b*x^(1/3))^2/a^2)^(1/3))^2]*(-((b*(a*x^(1/3) + b*x^(2/3)))/a^2))^(1/3)*EllipticF[ArcSin[(1 + Sqrt[3] - (1 - (a + 2*b*x^(1/3))^2/a^2)^(1/3))/(1 - Sqrt[3] - (1 - (a + 2*b*x^(1/3))^2/a^2)^(1/3))], -7 + 4*Sqrt[3]])/(7*2^(5/6)*b^3*Sqrt[-((1 - (1 - (a + 2*b*x^(1/3))^2/a^2)^(1/3))/(1 - Sqrt[3] - (1 - (a + 2*b*x^(1/3))^2/a^2)^(1/3))^2)]*(a + 2*b*x^(1/3))*(a*x^(1/3) + b*x^(2/3))^(1/3))}
{1/(a*x^(1/3) + b*x^(2/3))^(2/3), x, 9, -((18*a*(a + b*x^(1/3))*x^(1/3))/(5*b^2*(a*x^(1/3) + b*x^(2/3))^(2/3))) + (9*(a + b*x^(1/3))*x^(2/3))/(5*b*(a*x^(1/3) + b*x^(2/3))^(2/3)) + (6*2^(1/3)*3^(3/4)*Sqrt[2 - Sqrt[3]]*a^4*(1 - (1 - (a + 2*b*x^(1/3))^2/a^2)^(1/3))*Sqrt[(1 + (1 - (a + 2*b*x^(1/3))^2/a^2)^(1/3) + (1 - (a + 2*b*x^(1/3))^2/a^2)^(2/3))/(1 - Sqrt[3] - (1 - (a + 2*b*x^(1/3))^2/a^2)^(1/3))^2]*(-((b*(a*x^(1/3) + b*x^(2/3)))/a^2))^(2/3)*EllipticF[ArcSin[(1 + Sqrt[3] - (1 - (a + 2*b*x^(1/3))^2/a^2)^(1/3))/(1 - Sqrt[3] - (1 - (a + 2*b*x^(1/3))^2/a^2)^(1/3))], -7 + 4*Sqrt[3]])/(5*b^3*Sqrt[-((1 - (1 - (a + 2*b*x^(1/3))^2/a^2)^(1/3))/(1 - Sqrt[3] - (1 - (a + 2*b*x^(1/3))^2/a^2)^(1/3))^2)]*(a + 2*b*x^(1/3))*(a*x^(1/3) + b*x^(2/3))^(2/3))}
