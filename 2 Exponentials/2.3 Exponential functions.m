...
(* ::Section::Closed:: *)
(*Integrands of the form F^(e+f x) (a+b F^(e+f x))^n*)
...
{f^(c*(a + b*x)^2)*x^m, x, 1, Defer[Int][f^(a^2*c + 2*a*b*c*x + b^2*c*x^2)*x^m, x]}
...
{f^(c*(a + b*x)^2)/x^1, x, 0, Defer[Int][f^(c*(a + b*x)^2)/x, x]}
{f^(c*(a + b*x)^2)/x^2, x, 2, -(f^(c*(a + b*x)^2)/x) + b*Sqrt[c]*Sqrt[Pi]*Erfi[Sqrt[c]*(a + b*x)*Sqrt[Log[f]]]*Sqrt[Log[f]] + 2*a*b*c*Log[f]*Defer[Int][f^(c*(a + b*x)^2)/x, x]}
{f^(c*(a + b*x)^2)/x^3, x, 3, -(f^(c*(a + b*x)^2)/(2*x^2)) - (a*b*c*f^(c*(a + b*x)^2)*Log[f])/x + a*b^2*c^(3/2)*Sqrt[Pi]*Erfi[Sqrt[c]*(a + b*x)*Sqrt[Log[f]]]*Log[f]^(3/2) + b^2*c*Log[f]*Defer[Int][f^(c*(a + b*x)^2)/x, x] + 2*a^2*b^2*c^2*Log[f]^2*Defer[Int][f^(c*(a + b*x)^2)/x, x]}


{f^(c*(a + b*x)^3)*x^m, x, 0, Defer[Int][f^(c*(a + b*x)^3)*x^m, x]}
...
{f^(c*(a + b*x)^3)/x^1, x, 0, Defer[Int][f^(c*(a + b*x)^3)/x, x]}
{f^(c*(a + b*x)^3)/x^2, x, 5, -(f^(c*(a + b*x)^3)/x) - (b*c*(a + b*x)^2*Gamma[2/3, (-c)*(a + b*x)^3*Log[f]]*Log[f])/((-c)*(a + b*x)^3*Log[f])^(2/3) - (a*b*c*(a + b*x)*Gamma[1/3, (-c)*(a + b*x)^3*Log[f]]*Log[f])/((-c)*(a + b*x)^3*Log[f])^(1/3) + 3*a^2*b*c*Log[f]*Defer[Int][f^(c*(a + b*x)^3)/x, x]}
{f^(c*(a + b*x)^3)/x^3, x, 9, -(f^(c*(a + b*x)^3)/(2*x^2)) - (3*a^2*b*c*f^(c*(a + b*x)^3)*Log[f])/(2*x) - (3*a^2*b^2*c^2*(a + b*x)^2*Gamma[2/3, (-c)*(a + b*x)^3*Log[f]]*Log[f]^2)/(2*((-c)*(a + b*x)^3*Log[f])^(2/3)) - (b^2*c*(a + b*x)*Gamma[1/3, (-c)*(a + b*x)^3*Log[f]]*Log[f])/(2*((-c)*(a + b*x)^3*Log[f])^(1/3)) - (3*a^3*b^2*c^2*(a + b*x)*Gamma[1/3, (-c)*(a + b*x)^3*Log[f]]*Log[f]^2)/(2*((-c)*(a + b*x)^3*Log[f])^(1/3)) + 3*a*b^2*c*Log[f]*Defer[Int][f^(c*(a + b*x)^3)/x, x] + (9/2)*a^4*b^2*c^2*Log[f]^2*Defer[Int][f^(c*(a + b*x)^3)/x, x]}


{E^(a^3 + 3*a^2*b*x + 3*a*b^2*x^2 + b^3*x^3)*x^m, x, 0, Defer[Int][E^(a^3 + 3*a^2*b*x + 3*a*b^2*x^2 + b^3*x^3)*x^m, x]}
...
{E^(a^3 + 3*a^2*b*x + 3*a*b^2*x^2 + b^3*x^3)/x^1, x, 0, Defer[Int][E^(a^3 + 3*a^2*b*x + 3*a*b^2*x^2 + b^3*x^3)/x, x]}
...
{f^(c/(a + b*x))*x^m, x, 0, Defer[Int][f^(c/(a + b*x))*x^m, x]}
...
{f^(c/(a + b*x)^2)*x^m, x, 0, Defer[Int][f^(c/(a + b*x)^2)*x^m, x]}
...
{f^(c/(a + b*x)^2)/x^1, x, 0, Defer[Int][f^(c/(a + b*x)^2)/x, x]}
{f^(c/(a + b*x)^2)/x^2, x, 0, Defer[Int][f^(c/(a + b*x)^2)/x^2, x]}
{f^(c/(a + b*x)^2)/x^3, x, 0, Defer[Int][f^(c/(a + b*x)^2)/x^3, x]}
...
{f^(c/(a + b*x)^3)/x^1, x, 0, Defer[Int][f^(c/(a + b*x)^3)/x, x]}
{f^(c/(a + b*x)^3)/x^2, x, 0, Defer[Int][f^(c/(a + b*x)^3)/x^2, x]}
{f^(c/(a + b*x)^3)/x^3, x, 0, Defer[Int][f^(c/(a + b*x)^3)/x^3, x]}
...
{f^(c*(a + b*x)^n)*x^m, x, 0, Defer[Int][f^(c*(a + b*x)^n)*x^m, x]}
...
{f^(c*(a + b*x)^n)/x^1, x, 0, Defer[Int][f^(c*(a + b*x)^n)/x, x]}
{f^(c*(a + b*x)^n)/x^2, x, 0, Defer[Int][f^(c*(a + b*x)^n)/x^2, x]}
{f^(c*(a + b*x)^n)/x^3, x, 0, Defer[Int][f^(c*(a + b*x)^n)/x^3, x]}
...
{F^(a + b*(c + d*x)^2)/(e + f*x)^1, x, 0, Defer[Int][F^(a + b*(c + d*x)^2)/(e + f*x), x]}
{F^(a + b*(c + d*x)^2)/(e + f*x)^2, x, 2, -(F^(a + b*(c + d*x)^2)/(f*(e + f*x))) + (Sqrt[b]*d*F^a*Sqrt[Pi]*Erfi[Sqrt[b]*(c + d*x)*Sqrt[Log[F]]]*Sqrt[Log[F]])/f^2 - (2*b*d*(d*e - c*f)*Log[F]*Defer[Int][F^(a + b*(c + d*x)^2)/(e + f*x), x])/f^2}
{F^(a + b*(c + d*x)^2)/(e + f*x)^3, x, 3, -(F^(a + b*(c + d*x)^2)/(2*f*(e + f*x)^2)) + (b*d*(d*e - c*f)*F^(a + b*(c + d*x)^2)*Log[F])/(f^3*(e + f*x)) - (b^(3/2)*d^2*(d*e - c*f)*F^a*Sqrt[Pi]*Erfi[Sqrt[b]*(c + d*x)*Sqrt[Log[F]]]*Log[F]^(3/2))/f^4 + (b*d^2*Log[F]*Defer[Int][F^(a + b*(c + d*x)^2)/(e + f*x), x])/f^2 + (2*b^2*d^2*(d*e - c*f)^2*Log[F]^2*Defer[Int][F^(a + b*(c + d*x)^2)/(e + f*x), x])/f^4}
...
{E^(e*(c + d*x)^3)/(a + b*x)^1, x, 0, Defer[Int][E^(e*(c + d*x)^3)/(a + b*x), x]}
{E^(e*(c + d*x)^3)/(a + b*x)^2, x, 5, -(E^(e*(c + d*x)^3)/(b*(a + b*x))) - (d*(b*c - a*d)*e*(c + d*x)*Gamma[1/3, (-e)*(c + d*x)^3])/(b^3*((-e)*(c + d*x)^3)^(1/3)) - (d*e*(c + d*x)^2*Gamma[2/3, (-e)*(c + d*x)^3])/(b^2*((-e)*(c + d*x)^3)^(2/3)) + (3*d*(b*c - a*d)^2*e*Defer[Int][E^(e*(c + d*x)^3)/(a + b*x), x])/b^3}
...
{E^(e/(c + d*x)^2)/(a + b*x)^1, x, 0, Defer[Int][E^(e/(c + d*x)^2)/(a + b*x), x]}
{E^(e/(c + d*x)^2)/(a + b*x)^2, x, 0, Defer[Int][E^(e/(c + d*x)^2)/(a + b*x)^2, x]}
{E^(e/(c + d*x)^2)/(a + b*x)^3, x, 0, Defer[Int][E^(e/(c + d*x)^2)/(a + b*x)^3, x]}
...
{E^(e/(c + d*x)^3)/(a + b*x)^1, x, 0, Defer[Int][E^(e/(c + d*x)^3)/(a + b*x), x]}
{E^(e/(c + d*x)^3)/(a + b*x)^2, x, 0, Defer[Int][E^(e/(c + d*x)^3)/(a + b*x)^2, x]}
...
{f^(a + b*x + c*x^2)/x, x, 0, Defer[Int][f^(a + b*x + c*x^2)/x, x]}
{f^(a + b*x + c*x^2)/x^2, x, 3, -(f^(a + b*x + c*x^2)/x) + Sqrt[c]*f^(a - b^2/(4*c))*Sqrt[Pi]*Erfi[((b + 2*c*x)*Sqrt[Log[f]])/(2*Sqrt[c])]*Sqrt[Log[f]] + b*Defer[Int][f^(a + b*x + c*x^2)/x, x]*Log[f]}
...
{E^(a + b*x - c*x^2)/x, x, 0, Defer[Int][E^(a + b*x - c*x^2)/x, x]}
{E^(a + b*x - c*x^2)/x^2, x, 3, -(E^(a + b*x - c*x^2)/x) + Sqrt[c]*E^(a + b^2/(4*c))*Sqrt[Pi]*Erf[(b - 2*c*x)/(2*Sqrt[c])] + b*Defer[Int][E^(a + b*x - c*x^2)/x, x]}
...
{E^((a + b*x)*(c + d*x))/x, x, 1, Defer[Int][E^(a*c + (b*c + a*d)*x + b*d*x^2)/x, x]}
{E^((a + b*x)*(c + d*x))/x^2, x, 4, -(E^(a*c + (b*c + a*d)*x + b*d*x^2)/x) + (Sqrt[b]*Sqrt[d]*Sqrt[Pi]*Erfi[(b*c + a*d + 2*b*d*x)/(2*Sqrt[b]*Sqrt[d])])/E^((b*c - a*d)^2/(4*b*d)) + (b*c + a*d)*Defer[Int][E^(a*c + (b*c + a*d)*x + b*d*x^2)/x, x]}
...
{f^(a + b*x + c*x^2)/(d + e*x), x, 0, Defer[Int][f^(a + b*x + c*x^2)/(d + e*x), x]}
{f^(a + b*x + c*x^2)/(d + e*x)^2, x, 3, -(f^(a + b*x + c*x^2)/(e*(d + e*x))) + (Sqrt[c]*f^(a - b^2/(4*c))*Sqrt[Pi]*Erfi[((b + 2*c*x)*Sqrt[Log[f]])/(2*Sqrt[c])]*Sqrt[Log[f]])/e^2 - ((2*c*d - b*e)*Defer[Int][f^(a + b*x + c*x^2)/(d + e*x), x]*Log[f])/e^2}
{f^(a + b*x + c*x^2)/(d + e*x)^3, x, 4, -(f^(a + b*x + c*x^2)/(2*e*(d + e*x)^2)) + ((2*c*d - b*e)*f^(a + b*x + c*x^2)*Log[f])/(2*e^3*(d + e*x)) + (c*Defer[Int][f^(a + b*x + c*x^2)/(d + e*x), x]*Log[f])/e^2 - (Sqrt[c]*(2*c*d - b*e)*f^(a - b^2/(4*c))*Sqrt[Pi]*Erfi[((b + 2*c*x)*Sqrt[Log[f]])/(2*Sqrt[c])]*Log[f]^(3/2))/(2*e^4) + ((2*c*d - b*e)^2*Defer[Int][f^(a + b*x + c*x^2)/(d + e*x), x]*Log[f]^2)/(2*e^4)}
...
{1/(x^1*(a + b*E^(c + d*x))), x, 0, Defer[Int][1/((a + b*E^(c + d*x))*x), x]}
{x^0/(a + b*E^(c + d*x)), x, 4, x/a - Log[a + b*E^(c + d*x)]/(a*d)}
{x^1/(a + b*E^(c + d*x)), x, 3, -((x*Log[1 + (a*E^(-c - d*x))/b])/(a*d)) + PolyLog[2, -((a*E^(-c - d*x))/b)]/(a*d^2)}
{x^2/(a + b*E^(c + d*x)), x, 4, -((x^2*Log[1 + (a*E^(-c - d*x))/b])/(a*d)) + (2*x*PolyLog[2, -((a*E^(-c - d*x))/b)])/(a*d^2) + (2*PolyLog[3, -((a*E^(-c - d*x))/b)])/(a*d^3)}
{x^3/(a + b*E^(c + d*x)), x, 5, -((x^3*Log[1 + (a*E^(-c - d*x))/b])/(a*d)) + (3*x^2*PolyLog[2, -((a*E^(-c - d*x))/b)])/(a*d^2) + (6*x*PolyLog[3, -((a*E^(-c - d*x))/b)])/(a*d^3) + (6*PolyLog[4, -((a*E^(-c - d*x))/b)])/(a*d^4)}

{1/(a + b*E^(c - d*x)), x, 4, x/a + Log[a + b*E^(c - d*x)]/(a*d)}
{1/(a + b*E^(-c - d*x)), x, 4, x/a + Log[a + b*E^(-c - d*x)]/(a*d)}


{1/(x^1*(a + b*E^(c + d*x))^2), x, 0, Defer[Int][1/((a + b*E^(c + d*x))^2*x), x]}
...
{x^2/(a + b*E^(c + d*x))^2, x, 12, x^2/(a*d*(a + b*E^(c + d*x))) + x^3/(3*a^2) + (2*x*Log[1 + (a*E^(-c - d*x))/b])/(a^2*d^2) - (x^2*Log[1 + (b*E^(c + d*x))/a])/(a^2*d) - (2*PolyLog[2, -((a*E^(-c - d*x))/b)])/(a^2*d^3) - (2*x*PolyLog[2, -((b*E^(c + d*x))/a)])/(a^2*d^2) + (2*PolyLog[3, -((b*E^(c + d*x))/a)])/(a^2*d^3)}
{x^3/(a + b*E^(c + d*x))^2, x, 14, x^3/(a*d*(a + b*E^(c + d*x))) + x^4/(4*a^2) + (3*x^2*Log[1 + (a*E^(-c - d*x))/b])/(a^2*d^2) - (x^3*Log[1 + (b*E^(c + d*x))/a])/(a^2*d) - (6*x*PolyLog[2, -((a*E^(-c - d*x))/b)])/(a^2*d^3) - (3*x^2*PolyLog[2, -((b*E^(c + d*x))/a)])/(a^2*d^2) - (6*PolyLog[3, -((a*E^(-c - d*x))/b)])/(a^2*d^4) + (6*x*PolyLog[3, -((b*E^(c + d*x))/a)])/(a^2*d^3) - (6*PolyLog[4, -((b*E^(c + d*x))/a)])/(a^2*d^4)}

{1/(a + b*E^(c - d*x))^2, x, 3, -(1/(a*d*(a + b*E^(c - d*x)))) + x/a^2 + Log[a + b*E^(c - d*x)]/(a^2*d)}
{1/(a + b*E^(-c - d*x))^2, x, 3, -(1/(a*d*(a + b*E^(-c - d*x)))) + x/a^2 + Log[a + b*E^(-c - d*x)]/(a^2*d)}


{1/(x^1*(a + b*E^(c + d*x))^3), x, 0, Defer[Int][1/((a + b*E^(c + d*x))^3*x), x]}
{x^0/(a + b*E^(c + d*x))^3, x, 3, 1/(2*a*d*(a + b*E^(c + d*x))^2) + 1/(a^2*d*(a + b*E^(c + d*x))) + x/a^3 - Log[a + b*E^(c + d*x)]/(a^3*d)}
{x^1/(a + b*E^(c + d*x))^3, x, 13, -(1/(2*a^2*d^2*(a + b*E^(c + d*x)))) - (3*x)/(2*a^3*d) + x/(2*a*d*(a + b*E^(c + d*x))^2) + x/(a^2*d*(a + b*E^(c + d*x))) + x^2/(2*a^3) + (3*Log[a + b*E^(c + d*x)])/(2*a^3*d^2) - (x*Log[1 + (b*E^(c + d*x))/a])/(a^3*d) - PolyLog[2, -((b*E^(c + d*x))/a)]/(a^3*d^2)}
{x^2/(a + b*E^(c + d*x))^3, x, 22, x/(a^3*d^2) - x/(a^2*d^2*(a + b*E^(c + d*x))) - (3*x^2)/(2*a^3*d) + x^2/(2*a*d*(a + b*E^(c + d*x))^2) + x^2/(a^2*d*(a + b*E^(c + d*x))) + x^3/(3*a^3) - Log[a + b*E^(c + d*x)]/(a^3*d^3) + (3*x*Log[1 + (b*E^(c + d*x))/a])/(a^3*d^2) - (x^2*Log[1 + (b*E^(c + d*x))/a])/(a^3*d) + (3*PolyLog[2, -((b*E^(c + d*x))/a)])/(a^3*d^3) - (2*x*PolyLog[2, -((b*E^(c + d*x))/a)])/(a^3*d^2) + (2*PolyLog[3, -((b*E^(c + d*x))/a)])/(a^3*d^3), x/(a^3*d^2) - x/(a^2*d^2*(a + b*E^(c + d*x))) - x^2/(2*a^3*d) + x^2/(2*a*d*(a + b*E^(c + d*x))^2) + x^2/(a^2*d*(a + b*E^(c + d*x))) + x^3/(3*a^3) + (2*x*Log[1 + (a*E^(-c - d*x))/b])/(a^3*d^2) - Log[a + b*E^(c + d*x)]/(a^3*d^3) + (x*Log[1 + (b*E^(c + d*x))/a])/(a^3*d^2) - (x^2*Log[1 + (b*E^(c + d*x))/a])/(a^3*d) - (2*PolyLog[2, -((a*E^(-c - d*x))/b)])/(a^3*d^3) + PolyLog[2, -((b*E^(c + d*x))/a)]/(a^3*d^3) - (2*x*PolyLog[2, -((b*E^(c + d*x))/a)])/(a^3*d^2) + (2*PolyLog[3, -((b*E^(c + d*x))/a)])/(a^3*d^3)}
(* {x^3/(a + b*E^(c + d*x))^3, x, 28, (3*x^2)/(2*a^3*d^2) - (3*x^2)/(2*a^2*d^2*(a + b*E^(c + d*x))) - (3*x^3)/(2*a^3*d) + x^3/(2*a*d*(a + b*E^(c + d*x))^2) + x^3/(a^2*d*(a + b*E^(c + d*x))) + x^4/(4*a^3) - (3*x*Log[1 + (b*E^(c + d*x))/a])/(a^3*d^3) + (9*x^2*Log[1 + (b*E^(c + d*x))/a])/(2*a^3*d^2) - (x^3*Log[1 + (b*E^(c + d*x))/a])/(a^3*d) - (3*PolyLog[2, -((b*E^(c + d*x))/a)])/(a^3*d^4) + (9*x*PolyLog[2, -((b*E^(c + d*x))/a)])/(a^3*d^3) - (3*x^2*PolyLog[2, -((b*E^(c + d*x))/a)])/(a^3*d^2) - (9*PolyLog[3, -((b*E^(c + d*x))/a)])/(a^3*d^4) + (6*x*PolyLog[3, -((b*E^(c + d*x))/a)])/(a^3*d^3) - (6*PolyLog[4, -((b*E^(c + d*x))/a)])/(a^3*d^4)} *)
...
{2^x/Sqrt[a + b*2^(2*x)], x, 3, ArcTanh[(2^x*Sqrt[b])/Sqrt[a + 2^(2*x)*b]]/(Sqrt[b]*Log[2])}

{2^x/Sqrt[a - b*4^x], x, 3, ArcTan[(2^x*Sqrt[b])/Sqrt[a - 2^(2*x)*b]]/(Sqrt[b]*Log[2])}
{2^x/Sqrt[a - b*2^(2*x)], x, 3, ArcTan[(2^x*Sqrt[b])/Sqrt[a - 2^(2*x)*b]]/(Sqrt[b]*Log[2])}
...
{1/(3 + 3*E^x + E^(2*x)), x, 8, x/3 - ArcTan[(3 + 2*E^x)/Sqrt[3]]/Sqrt[3] - (1/6)*Log[3 + 3*E^x + E^(2*x)]}
{1/(a + b*E^x + c*E^(2*x)), x, 8, x/a + (b*ArcTanh[(b + 2*c*E^x)/Sqrt[b^2 - 4*a*c]])/(a*Sqrt[b^2 - 4*a*c]) - Log[a + b*E^x + c*E^(2*x)]/(2*a)}

{x/(1 + 2*E^x + E^(2*x)), x, 9, -x + x/(1 + E^x) + x^2/2 + Log[1 + E^x] - x*Log[1 + E^x] - PolyLog[2, -E^x]}
{x/(2 + 3*E^x + E^(2*x)), x, 7, (-x)*Log[1 + E^(-x)] + (1/2)*x*Log[1 + 2/E^x] - (1/2)*PolyLog[2, -2/E^x] + PolyLog[2, -E^(-x)]}
{x/(-1 + E^x + E^(2*x)), x, 7, -((2*x*Log[1 + ((1/2)*(1 - Sqrt[5]))/E^x])/(Sqrt[5]*(1 - Sqrt[5]))) + (2*x*Log[1 + ((1/2)*(1 + Sqrt[5]))/E^x])/(Sqrt[5]*(1 + Sqrt[5])) + (2*PolyLog[2, -1/2*(1 - Sqrt[5])/E^x])/(Sqrt[5]*(1 - Sqrt[5])) - (2*PolyLog[2, -1/2*(1 + Sqrt[5])/E^x])/(Sqrt[5]*(1 + Sqrt[5]))}
{x/(3 + 3*E^x + E^(2*x)), x, 7, -((2*x*Log[1 + ((1/2)*(3 - I*Sqrt[3]))/E^x])/(Sqrt[3]*(3*I + Sqrt[3]))) + (2*x*Log[1 + ((1/2)*(3 + I*Sqrt[3]))/E^x])/(Sqrt[3]*(3*I - Sqrt[3])) + (2*PolyLog[2, -1/2*(3 - I*Sqrt[3])/E^x])/(Sqrt[3]*(3*I + Sqrt[3])) - (2*PolyLog[2, -1/2*(3 + I*Sqrt[3])/E^x])/(Sqrt[3]*(3*I - Sqrt[3]))}
{x/(a + b*E^x + c*E^(2*x)), x, 7, (2*c*x*Log[1 + (b - Sqrt[b^2 - 4*a*c])/(E^x*(2*c))])/(b^2 - 4*a*c - b*Sqrt[b^2 - 4*a*c]) + (2*c*x*Log[1 + (b + Sqrt[b^2 - 4*a*c])/(E^x*(2*c))])/(b^2 - 4*a*c + b*Sqrt[b^2 - 4*a*c]) - (2*c*PolyLog[2, -((b - Sqrt[b^2 - 4*a*c])/(E^x*(2*c)))])/(b^2 - 4*a*c - b*Sqrt[b^2 - 4*a*c]) - (2*c*PolyLog[2, -((b + Sqrt[b^2 - 4*a*c])/(E^x*(2*c)))])/(b^2 - 4*a*c + b*Sqrt[b^2 - 4*a*c])}

{x^2/(1 + 2*E^x + E^(2*x)), x, 12, x^2/(1 + E^x) + x^3/3 + 2*x*Log[1 + E^(-x)] - x^2*Log[1 + E^x] - 2*PolyLog[2, -E^(-x)] - 2*x*PolyLog[2, -E^x] + 2*PolyLog[3, -E^x]}
{x^2/(2 + 3*E^x + E^(2*x)), x, 9, (-x^2)*Log[1 + E^(-x)] + (1/2)*x^2*Log[1 + 2/E^x] - x*PolyLog[2, -2/E^x] + 2*x*PolyLog[2, -E^(-x)] - PolyLog[3, -2/E^x] + 2*PolyLog[3, -E^(-x)]}
{x^2/(-1 + E^x + E^(2*x)), x, 9, -((2*x^2*Log[1 + ((1/2)*(1 - Sqrt[5]))/E^x])/(Sqrt[5]*(1 - Sqrt[5]))) + (2*x^2*Log[1 + ((1/2)*(1 + Sqrt[5]))/E^x])/(Sqrt[5]*(1 + Sqrt[5])) + (4*x*PolyLog[2, -1/2*(1 - Sqrt[5])/E^x])/(Sqrt[5]*(1 - Sqrt[5])) - (4*x*PolyLog[2, -1/2*(1 + Sqrt[5])/E^x])/(Sqrt[5]*(1 + Sqrt[5])) + (4*PolyLog[3, -1/2*(1 - Sqrt[5])/E^x])/(Sqrt[5]*(1 - Sqrt[5])) - (4*PolyLog[3, -1/2*(1 + Sqrt[5])/E^x])/(Sqrt[5]*(1 + Sqrt[5]))}
{x^2/(3 + 3*E^x + E^(2*x)), x, 9, -((2*x^2*Log[1 + ((1/2)*(3 - I*Sqrt[3]))/E^x])/(Sqrt[3]*(3*I + Sqrt[3]))) + (2*x^2*Log[1 + ((1/2)*(3 + I*Sqrt[3]))/E^x])/(Sqrt[3]*(3*I - Sqrt[3])) + (4*x*PolyLog[2, -1/2*(3 - I*Sqrt[3])/E^x])/(Sqrt[3]*(3*I + Sqrt[3])) - (4*x*PolyLog[2, -1/2*(3 + I*Sqrt[3])/E^x])/(Sqrt[3]*(3*I - Sqrt[3])) + (4*PolyLog[3, -1/2*(3 - I*Sqrt[3])/E^x])/(Sqrt[3]*(3*I + Sqrt[3])) - (4*PolyLog[3, -1/2*(3 + I*Sqrt[3])/E^x])/(Sqrt[3]*(3*I - Sqrt[3]))}
{x^2/(a + b*E^x + c*E^(2*x)), x, 9, (2*c*x^2*Log[1 + (b - Sqrt[b^2 - 4*a*c])/(E^x*(2*c))])/(b^2 - 4*a*c - b*Sqrt[b^2 - 4*a*c]) + (2*c*x^2*Log[1 + (b + Sqrt[b^2 - 4*a*c])/(E^x*(2*c))])/(b^2 - 4*a*c + b*Sqrt[b^2 - 4*a*c]) - (4*c*x*PolyLog[2, -((b - Sqrt[b^2 - 4*a*c])/(E^x*(2*c)))])/(b^2 - 4*a*c - b*Sqrt[b^2 - 4*a*c]) - (4*c*x*PolyLog[2, -((b + Sqrt[b^2 - 4*a*c])/(E^x*(2*c)))])/(b^2 - 4*a*c + b*Sqrt[b^2 - 4*a*c]) - (4*c*PolyLog[3, -((b - Sqrt[b^2 - 4*a*c])/(E^x*(2*c)))])/(b^2 - 4*a*c - b*Sqrt[b^2 - 4*a*c]) - (4*c*PolyLog[3, -((b + Sqrt[b^2 - 4*a*c])/(E^x*(2*c)))])/(b^2 - 4*a*c + b*Sqrt[b^2 - 4*a*c])}


{1/(1 + 2*f^(c + d*x) + f^(2*c + 2*d*x)), x, 3, x + 1/(d*(1 + f^(c + d*x))*Log[f]) - Log[1 + f^(c + d*x)]/(d*Log[f])}
{1/(a + b*f^(c + d*x) + c*f^(2*c + 2*d*x)), x, 8, x/a + (b*ArcTanh[(b + 2*c*f^(c + d*x))/Sqrt[b^2 - 4*a*c]])/(a*Sqrt[b^2 - 4*a*c]*d*Log[f]) - Log[a + b*f^(c + d*x) + c*f^(2*c + 2*d*x)]/(2*a*d*Log[f])}
{1/(a + b*f^(g + h*x) + c*f^(2*(g + h*x))), x, 8, x/a + (b*ArcTanh[(b + 2*c*f^(g + h*x))/Sqrt[b^2 - 4*a*c]])/(a*Sqrt[b^2 - 4*a*c]*h*Log[f]) - Log[a + b*f^(g + h*x) + c*f^(2*g + 2*h*x)]/(2*a*h*Log[f])}

{x/(1 + 2*f^(c + d*x) + f^(2*c + 2*d*x)), x, 9, x^2/2 - x/(d*Log[f]) + x/(d*(1 + f^(c + d*x))*Log[f]) + Log[1 + f^(c + d*x)]/(d^2*Log[f]^2) - (x*Log[1 + f^(c + d*x)])/(d*Log[f]) - PolyLog[2, -f^(c + d*x)]/(d^2*Log[f]^2)}
{x/(a + b*f^(c + d*x) + c*f^(2*c + 2*d*x)), x, 7, -((2*c*x*Log[1 + ((b - Sqrt[b^2 - 4*a*c])*f^(-c - d*x))/(2*c)])/(Sqrt[b^2 - 4*a*c]*(b - Sqrt[b^2 - 4*a*c])*d*Log[f])) + (2*c*x*Log[1 + ((b + Sqrt[b^2 - 4*a*c])*f^(-c - d*x))/(2*c)])/(Sqrt[b^2 - 4*a*c]*(b + Sqrt[b^2 - 4*a*c])*d*Log[f]) + (2*c*PolyLog[2, -(((b - Sqrt[b^2 - 4*a*c])*f^(-c - d*x))/(2*c))])/(Sqrt[b^2 - 4*a*c]*(b - Sqrt[b^2 - 4*a*c])*d^2*Log[f]^2) - (2*c*PolyLog[2, -(((b + Sqrt[b^2 - 4*a*c])*f^(-c - d*x))/(2*c))])/(Sqrt[b^2 - 4*a*c]*(b + Sqrt[b^2 - 4*a*c])*d^2*Log[f]^2)}

{x^2/(1 + 2*f^(c + d*x) + f^(2*c + 2*d*x)), x, 12, x^3/3 + x^2/(d*(1 + f^(c + d*x))*Log[f]) + (2*x*Log[1 + f^(-c - d*x)])/(d^2*Log[f]^2) - (x^2*Log[1 + f^(c + d*x)])/(d*Log[f]) - (2*PolyLog[2, -f^(-c - d*x)])/(d^3*Log[f]^3) - (2*x*PolyLog[2, -f^(c + d*x)])/(d^2*Log[f]^2) + (2*PolyLog[3, -f^(c + d*x)])/(d^3*Log[f]^3)}
{x^2/(a + b*f^(c + d*x) + c*f^(2*c + 2*d*x)), x, 9, -((2*c*x^2*Log[1 + ((b - Sqrt[b^2 - 4*a*c])*f^(-c - d*x))/(2*c)])/(Sqrt[b^2 - 4*a*c]*(b - Sqrt[b^2 - 4*a*c])*d*Log[f])) + (2*c*x^2*Log[1 + ((b + Sqrt[b^2 - 4*a*c])*f^(-c - d*x))/(2*c)])/(Sqrt[b^2 - 4*a*c]*(b + Sqrt[b^2 - 4*a*c])*d*Log[f]) + (4*c*x*PolyLog[2, -(((b - Sqrt[b^2 - 4*a*c])*f^(-c - d*x))/(2*c))])/(Sqrt[b^2 - 4*a*c]*(b - Sqrt[b^2 - 4*a*c])*d^2*Log[f]^2) - (4*c*x*PolyLog[2, -(((b + Sqrt[b^2 - 4*a*c])*f^(-c - d*x))/(2*c))])/(Sqrt[b^2 - 4*a*c]*(b + Sqrt[b^2 - 4*a*c])*d^2*Log[f]^2) + (4*c*PolyLog[3, -(((b - Sqrt[b^2 - 4*a*c])*f^(-c - d*x))/(2*c))])/(Sqrt[b^2 - 4*a*c]*(b - Sqrt[b^2 - 4*a*c])*d^3*Log[f]^3) - (4*c*PolyLog[3, -(((b + Sqrt[b^2 - 4*a*c])*f^(-c - d*x))/(2*c))])/(Sqrt[b^2 - 4*a*c]*(b + Sqrt[b^2 - 4*a*c])*d^3*Log[f]^3)}


{(d + e*f^(g + h*x))/(a + b*f^(g + h*x) + c*f^(2*g + 2*h*x)), x, 8, (d*x)/a + ((b*d - 2*a*e)*ArcTanh[(b + 2*c*f^(g + h*x))/Sqrt[b^2 - 4*a*c]])/(a*Sqrt[b^2 - 4*a*c]*h*Log[f]) - (d*Log[a + b*f^(g + h*x) + c*f^(2*g + 2*h*x)])/(2*a*h*Log[f])}
{(d + e*f^(g + h*x))/(a + b*f^(g + h*x) + c*f^(2*(g + h*x))), x, 8, (d*x)/a + ((b*d - 2*a*e)*ArcTanh[(b + 2*c*f^(g + h*x))/Sqrt[b^2 - 4*a*c]])/(a*Sqrt[b^2 - 4*a*c]*h*Log[f]) - (d*Log[a + b*f^(g + h*x) + c*f^(2*g + 2*h*x)])/(2*a*h*Log[f])}


{1/(2 + E^(-x) + E^x), x, 2, -(1/(1 + E^x))}
{x/(2 + E^(-x) + E^x), x, 7, x - x/(1 + E^x) - Log[1 + E^x]}
{x^2/(2 + E^(-x) + E^x), x, 6, -(x^2/(1 + E^x)) - 2*x*Log[1 + E^(-x)] + 2*PolyLog[2, -E^(-x)]}
...
{x^2/(2 + f^(-c - d*x) + f^(c + d*x)), x, 6, -(x^2/(d*(1 + f^(c + d*x))*Log[f])) - (2*x*Log[1 + f^(-c - d*x)])/(d^2*Log[f]^2) + (2*PolyLog[2, -f^(-c - d*x)])/(d^3*Log[f]^3)}
...
(* ::Section::Closed:: *)
(*Integrands of the form u^m (a+b F^(Sqrt[1-c x]/Sqrt[1+c x]))^n*)
...
{(a + b*F^(Sqrt[1 - c*x]/Sqrt[1 + c*x]))^n/(1 - c^2*x^2), x, 1, -(Defer[Subst][Defer[Int][(a + b*F^x)^n/x, x], x, Sqrt[1 - c*x]/Sqrt[1 + c*x]]/c)}

{(a + b*F^(Sqrt[1 - c*x]/Sqrt[1 + c*x]))^3/(1 - c^2*x^2), x, 6, -((3*a^2*b*ExpIntegralEi[(Sqrt[1 - c*x]*Log[F])/Sqrt[1 + c*x]])/c) - (3*a*b^2*ExpIntegralEi[(2*Sqrt[1 - c*x]*Log[F])/Sqrt[1 + c*x]])/c - (b^3*ExpIntegralEi[(3*Sqrt[1 - c*x]*Log[F])/Sqrt[1 + c*x]])/c - (a^3*Log[Sqrt[1 - c*x]/Sqrt[1 + c*x]])/c}
{(a + b*F^(Sqrt[1 - c*x]/Sqrt[1 + c*x]))^2/(1 - c^2*x^2), x, 5, -((2*a*b*ExpIntegralEi[(Sqrt[1 - c*x]*Log[F])/Sqrt[1 + c*x]])/c) - (b^2*ExpIntegralEi[(2*Sqrt[1 - c*x]*Log[F])/Sqrt[1 + c*x]])/c - (a^2*Log[Sqrt[1 - c*x]/Sqrt[1 + c*x]])/c}
{(a + b*F^(Sqrt[1 - c*x]/Sqrt[1 + c*x]))^1/(1 - c^2*x^2), x, 4, -((b*ExpIntegralEi[(Sqrt[1 - c*x]*Log[F])/Sqrt[1 + c*x]])/c) - (a*Log[Sqrt[1 - c*x]/Sqrt[1 + c*x]])/c}
{1/((a + b*F^(Sqrt[1 - c*x]/Sqrt[1 + c*x]))^1*(1 - c^2*x^2)), x, 1, -(Defer[Subst][Defer[Int][1/((a + b*F^x)*x), x], x, Sqrt[1 - c*x]/Sqrt[1 + c*x]]/c)}
{1/((a + b*F^(Sqrt[1 - c*x]/Sqrt[1 + c*x]))^2*(1 - c^2*x^2)), x, 1, -(Defer[Subst][Defer[Int][1/((a + b*F^x)^2*x), x], x, Sqrt[1 - c*x]/Sqrt[1 + c*x]]/c)}
...
(* ::Section::Closed:: *)
(*Integrands of the form F^(c+d x) (a+b F^(e+f x))^n*)
...
{x^1*E^x/(1 - E^(2*x)), x, 5, x*ArcTanh[E^x] + (1/2)*PolyLog[2, -E^x] - (1/2)*PolyLog[2, E^x]}
...
{x^2/(a*f^x + b*f^(-x))^2, x, 5, -(x^2/(2*a*(b + a*f^(2*x))*Log[f])) - (x*Log[1 + b/(f^(2*x)*a)])/(2*a*b*Log[f]^2) + PolyLog[2, -(b/(f^(2*x)*a))]/(4*a*b*Log[f]^3)}
{x^3/(a*f^x + b*f^(-x))^2, x, 6, -(x^3/(2*a*(b + a*f^(2*x))*Log[f])) - (3*x^2*Log[1 + b/(f^(2*x)*a)])/(4*a*b*Log[f]^2) + (3*x*PolyLog[2, -(b/(f^(2*x)*a))])/(4*a*b*Log[f]^3) + (3*PolyLog[3, -(b/(f^(2*x)*a))])/(8*a*b*Log[f]^4)}


{x^0/(a*f^x + b*f^(-x))^3, x, 4, -(f^x/(4*a*(b + a*f^(2*x))^2*Log[f])) + f^x/(8*a*b*(b + a*f^(2*x))*Log[f]) + ArcTan[(Sqrt[a]*f^x)/Sqrt[b]]/(8*a^(3/2)*b^(3/2)*Log[f])}
{x^1/(a*f^x + b*f^(-x))^3, x, -1, f^x/(8*a*b*(b + a*f^(2*x))*Log[f]^2) - (f^x*x)/(4*a*(b + a*f^(2*x))^2*Log[f]) + (f^x*x)/(8*a*b*(b + a*f^(2*x))*Log[f]) + (x*ArcTan[(Sqrt[a]*f^x)/Sqrt[b]])/(8*a^(3/2)*b^(3/2)*Log[f]) - (I*PolyLog[2, -((I*Sqrt[a]*f^x)/Sqrt[b])])/(16*a^(3/2)*b^(3/2)*Log[f]^2) + (I*PolyLog[2, (I*Sqrt[a]*f^x)/Sqrt[b]])/(16*a^(3/2)*b^(3/2)*Log[f]^2)}
{x^2/(a*f^x + b*f^(-x))^3, x, -1, -(ArcTan[(Sqrt[a]*f^x)/Sqrt[b]]/(4*a^(3/2)*b^(3/2)*Log[f]^3)) + (f^x*x)/(4*a*b*(b + a*f^(2*x))*Log[f]^2) - (f^x*x^2)/(4*a*(b + a*f^(2*x))^2*Log[f]) + (f^x*x^2)/(8*a*b*(b + a*f^(2*x))*Log[f]) + (x^2*ArcTan[(Sqrt[a]*f^x)/Sqrt[b]])/(8*a^(3/2)*b^(3/2)*Log[f]) - (I*x*PolyLog[2, -((I*Sqrt[a]*f^x)/Sqrt[b])])/(8*a^(3/2)*b^(3/2)*Log[f]^2) + (I*x*PolyLog[2, (I*Sqrt[a]*f^x)/Sqrt[b]])/(8*a^(3/2)*b^(3/2)*Log[f]^2) + (I*PolyLog[3, -((I*Sqrt[a]*f^x)/Sqrt[b])])/(8*a^(3/2)*b^(3/2)*Log[f]^3) - (I*PolyLog[3, (I*Sqrt[a]*f^x)/Sqrt[b]])/(8*a^(3/2)*b^(3/2)*Log[f]^3)}
...
{F^(e*(c + d*x))*(a + b*G^(h*(f + g*x)))^n, x, 1, (F^(e*(c + d*x))*(a + b*G^(h*(f + g*x)))^(1 + n)*Hypergeometric2F1[1, 1 + n + (d*e*Log[F])/(g*h*Log[G]), 1 + (d*e*Log[F])/(g*h*Log[G]), -((b*G^(h*(f + g*x)))/a)])/(a*d*e*Log[F])}
...
{(f + g*x)^3*(d + e*E^(h + i*x))/(a + b*E^(h + i*x) + c*E^(2*h + 2*i*x)), x, 11, -(((e + (2*c*d - b*e)/Sqrt[b^2 - 4*a*c])*(f + g*x)^3*Log[1 + ((b - Sqrt[b^2 - 4*a*c])*E^(-h - i*x))/(2*c)])/((b - Sqrt[b^2 - 4*a*c])*i)) - ((e - (2*c*d - b*e)/Sqrt[b^2 - 4*a*c])*(f + g*x)^3*Log[1 + ((b + Sqrt[b^2 - 4*a*c])*E^(-h - i*x))/(2*c)])/((b + Sqrt[b^2 - 4*a*c])*i) + (3*(e + (2*c*d - b*e)/Sqrt[b^2 - 4*a*c])*g*(f + g*x)^2*PolyLog[2, -(((b - Sqrt[b^2 - 4*a*c])*E^(-h - i*x))/(2*c))])/((b - Sqrt[b^2 - 4*a*c])*i^2) + (3*(e - (2*c*d - b*e)/Sqrt[b^2 - 4*a*c])*g*(f + g*x)^2*PolyLog[2, -(((b + Sqrt[b^2 - 4*a*c])*E^(-h - i*x))/(2*c))])/((b + Sqrt[b^2 - 4*a*c])*i^2) + (6*(e + (2*c*d - b*e)/Sqrt[b^2 - 4*a*c])*g^2*(f + g*x)*PolyLog[3, -(((b - Sqrt[b^2 - 4*a*c])*E^(-h - i*x))/(2*c))])/((b - Sqrt[b^2 - 4*a*c])*i^3) + (6*(e - (2*c*d - b*e)/Sqrt[b^2 - 4*a*c])*g^2*(f + g*x)*PolyLog[3, -(((b + Sqrt[b^2 - 4*a*c])*E^(-h - i*x))/(2*c))])/((b + Sqrt[b^2 - 4*a*c])*i^3) + (6*(e + (2*c*d - b*e)/Sqrt[b^2 - 4*a*c])*g^3*PolyLog[4, -(((b - Sqrt[b^2 - 4*a*c])*E^(-h - i*x))/(2*c))])/((b - Sqrt[b^2 - 4*a*c])*i^4) + (6*(e - (2*c*d - b*e)/Sqrt[b^2 - 4*a*c])*g^3*PolyLog[4, -(((b + Sqrt[b^2 - 4*a*c])*E^(-h - i*x))/(2*c))])/((b + Sqrt[b^2 - 4*a*c])*i^4)}
{(f + g*x)^2*(d + e*E^(h + i*x))/(a + b*E^(h + i*x) + c*E^(2*h + 2*i*x)), x, 9, -(((e + (2*c*d - b*e)/Sqrt[b^2 - 4*a*c])*(f + g*x)^2*Log[1 + ((b - Sqrt[b^2 - 4*a*c])*E^(-h - i*x))/(2*c)])/((b - Sqrt[b^2 - 4*a*c])*i)) - ((e - (2*c*d - b*e)/Sqrt[b^2 - 4*a*c])*(f + g*x)^2*Log[1 + ((b + Sqrt[b^2 - 4*a*c])*E^(-h - i*x))/(2*c)])/((b + Sqrt[b^2 - 4*a*c])*i) + (2*(e + (2*c*d - b*e)/Sqrt[b^2 - 4*a*c])*g*(f + g*x)*PolyLog[2, -(((b - Sqrt[b^2 - 4*a*c])*E^(-h - i*x))/(2*c))])/((b - Sqrt[b^2 - 4*a*c])*i^2) + (2*(e - (2*c*d - b*e)/Sqrt[b^2 - 4*a*c])*g*(f + g*x)*PolyLog[2, -(((b + Sqrt[b^2 - 4*a*c])*E^(-h - i*x))/(2*c))])/((b + Sqrt[b^2 - 4*a*c])*i^2) + (2*(e + (2*c*d - b*e)/Sqrt[b^2 - 4*a*c])*g^2*PolyLog[3, -(((b - Sqrt[b^2 - 4*a*c])*E^(-h - i*x))/(2*c))])/((b - Sqrt[b^2 - 4*a*c])*i^3) + (2*(e - (2*c*d - b*e)/Sqrt[b^2 - 4*a*c])*g^2*PolyLog[3, -(((b + Sqrt[b^2 - 4*a*c])*E^(-h - i*x))/(2*c))])/((b + Sqrt[b^2 - 4*a*c])*i^3)}
{(f + g*x)^1*(d + e*E^(h + i*x))/(a + b*E^(h + i*x) + c*E^(2*h + 2*i*x)), x, 7, -(((e + (2*c*d - b*e)/Sqrt[b^2 - 4*a*c])*(f + g*x)*Log[1 + ((b - Sqrt[b^2 - 4*a*c])*E^(-h - i*x))/(2*c)])/((b - Sqrt[b^2 - 4*a*c])*i)) - ((e - (2*c*d - b*e)/Sqrt[b^2 - 4*a*c])*(f + g*x)*Log[1 + ((b + Sqrt[b^2 - 4*a*c])*E^(-h - i*x))/(2*c)])/((b + Sqrt[b^2 - 4*a*c])*i) + ((e + (2*c*d - b*e)/Sqrt[b^2 - 4*a*c])*g*PolyLog[2, -(((b - Sqrt[b^2 - 4*a*c])*E^(-h - i*x))/(2*c))])/((b - Sqrt[b^2 - 4*a*c])*i^2) + ((e - (2*c*d - b*e)/Sqrt[b^2 - 4*a*c])*g*PolyLog[2, -(((b + Sqrt[b^2 - 4*a*c])*E^(-h - i*x))/(2*c))])/((b + Sqrt[b^2 - 4*a*c])*i^2)}
{(f + g*x)^0*(d + e*E^(h + i*x))/(a + b*E^(h + i*x) + c*E^(2*h + 2*i*x)), x, 8, (d*x)/a + ((b*d - 2*a*e)*ArcTanh[(b + 2*c*E^(h + i*x))/Sqrt[b^2 - 4*a*c]])/(a*Sqrt[b^2 - 4*a*c]*i) - (d*Log[a + b*E^(h + i*x) + c*E^(2*h + 2*i*x)])/(2*a*i)}
{1/(f + g*x)^1*(d + e*E^(h + i*x))/(a + b*E^(h + i*x) + c*E^(2*h + 2*i*x)), x, 2, d*Defer[Int][1/((a + b*E^(h + i*x) + c*E^(2*h + 2*i*x))*(f + g*x)), x] + e*Defer[Int][E^(h + i*x)/((a + b*E^(h + i*x) + c*E^(2*h + 2*i*x))*(f + g*x)), x]}
{1/(f + g*x)^2*(d + e*E^(h + i*x))/(a + b*E^(h + i*x) + c*E^(2*h + 2*i*x)), x, 2, d*Defer[Int][1/((a + b*E^(h + i*x) + c*E^(2*h + 2*i*x))*(f + g*x)^2), x] + e*Defer[Int][E^(h + i*x)/((a + b*E^(h + i*x) + c*E^(2*h + 2*i*x))*(f + g*x)^2), x]}


{x*(b*e - a*e*E^(c + d*x))/(b*e - 2*a*e*E^(c + d*x) - b*e*E^(2*(c + d*x))), x, 7, -((x*Log[1 + ((a - Sqrt[a^2 + b^2])*E^(-c - d*x))/b])/(2*d)) - (x*Log[1 + ((a + Sqrt[a^2 + b^2])*E^(-c - d*x))/b])/(2*d) + PolyLog[2, -(((a - Sqrt[a^2 + b^2])*E^(-c - d*x))/b)]/(2*d^2) + PolyLog[2, -(((a + Sqrt[a^2 + b^2])*E^(-c - d*x))/b)]/(2*d^2)}
...
{E^x/(2 + 3*E^x + E^(2*x)), x, 3, -2*ArcTanh[3 + 2*E^x]}
...
{((1 + E^x)*x)/Sqrt[E^x + x], x, 5, 2*x*Sqrt[E^x + x] - 2*Defer[Int][Sqrt[E^x + x], x]}
{x/Sqrt[E^x + x] + (E^x*x)/Sqrt[E^x + x], x, 4, 2*x*Sqrt[E^x + x] - 2*Defer[Int][Sqrt[E^x + x], x]}
{x*E^x/Sqrt[E^x + x], x, 2, 2*Sqrt[E^x + x] + 2*x*Sqrt[E^x + x] - Defer[Int][1/Sqrt[E^x + x], x] - 3*Defer[Int][Sqrt[E^x + x], x]}

{(x^2*(5*E^x + 3*x^2))/(5*Sqrt[5*E^x + x^3]) + (4/5)*x*Sqrt[5*E^x + x^3], x, 4, (2/5)*x^2*Sqrt[5*E^x + x^3]}
{x^2*E^x/Sqrt[5*E^x + x^3], x, 1, (2/5)*x^2*Sqrt[5*E^x + x^3] - (3/5)*Defer[Int][x^4/Sqrt[5*E^x + x^3], x] - (4/5)*Defer[Int][x*Sqrt[5*E^x + x^3], x]}

{-((1 + E^x)/(E^x + x)^(1/3)), x, 1, (-(3/2))*(E^x + x)^(2/3)}
{-(1/(E^x + x)^(1/3)) + x/(E^x + x)^(1/3) - (E^x + x)^(2/3), x, 2, (-(3/2))*(E^x + x)^(2/3)}
{x/(E^x + x)^(1/3), x, 1, (-(3/2))*(E^x + x)^(2/3) + Defer[Int][1/(E^x + x)^(1/3), x] + Defer[Int][(E^x + x)^(2/3), x]}
...
{x/(E^x + x), x, 0, Defer[Int][x/(E^x + x), x]}
{x^2/Sqrt[E^x + x], x, 0, Defer[Int][x^2/Sqrt[E^x + x], x]}
{E^x/(E^x + x), x, 0, Defer[Int][E^x/(E^x + x), x]}
{E^x/(E^x + x^2), x, 0, Defer[Int][E^x/(E^x + x^2), x]}

{f[x]/(f[x] + x), x, 2, x - Defer[Int][x/(x + f[x]), x]}
{f[x]/(f[x] + x^2), x, 2, x - Defer[Int][x^2/(x^2 + f[x]), x]}
{f[x]/(f[x] + x)^2, x, 2, -Defer[Int][x/(x + f[x])^2, x] + Defer[Int][1/(x + f[x]), x]}
{f[x]/(f[x] + x^2)^2, x, 2, -Defer[Int][x^2/(x^2 + f[x])^2, x] + Defer[Int][1/(x^2 + f[x]), x]}
