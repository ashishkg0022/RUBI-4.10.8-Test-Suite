...
{Zeta[2, a + b*x]/x^1, x, 1, Defer[Int][PolyGamma[1, a + b*x]/x, x]}
{Zeta[2, a + b*x]/x^2, x, 2, b*Defer[Int][PolyGamma[2, a + b*x]/x, x] - PolyGamma[1, a + b*x]/x}
{Zeta[2, a + b*x]/x^3, x, 3, (1/2)*b^2*Defer[Int][PolyGamma[3, a + b*x]/x, x] - PolyGamma[1, a + b*x]/(2*x^2) - (b*PolyGamma[2, a + b*x])/(2*x)}
...
{Zeta[s, a + b*x]/x^1, x, 0, Defer[Int][Zeta[s, a + b*x]/x, x]}
{Zeta[s, a + b*x]/x^2, x, 1, (-b)*s*Defer[Int][Zeta[1 + s, a + b*x]/x, x] - Zeta[s, a + b*x]/x}
{Zeta[s, a + b*x]/x^3, x, 2, (1/2)*b^2*s*(1 + s)*Defer[Int][Zeta[2 + s, a + b*x]/x, x] - Zeta[s, a + b*x]/(2*x^2) + (b*s*Zeta[1 + s, a + b*x])/(2*x)}
