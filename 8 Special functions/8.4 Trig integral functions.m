...
{x^m*SinIntegral[b*x]^2, x, 0, Defer[Int][x^m*SinIntegral[b*x]^2, x]}
...
{SinIntegral[b*x]^2/x^1, x, 0, Defer[Int][SinIntegral[b*x]^2/x, x]}
{SinIntegral[b*x]^2/x^2, x, 0, Defer[Int][SinIntegral[b*x]^2/x^2, x]}
{SinIntegral[b*x]^2/x^3, x, 0, Defer[Int][SinIntegral[b*x]^2/x^3, x]}
...
{x^m*SinIntegral[a + b*x], x, 1, -((b*Defer[Int][(x^(1 + m)*Sin[a + b*x])/(a + b*x), x])/(1 + m)) + (x^(1 + m)*SinIntegral[a + b*x])/(1 + m)}
...
{SinIntegral[a + b*x]/x^1, x, 0, Defer[Int][SinIntegral[a + b*x]/x, x]}
...
{x^m*SinIntegral[a + b*x]^2, x, 0, Defer[Int][x^m*SinIntegral[a + b*x]^2, x]}
...
{Sin[b*x]*SinIntegral[b*x]/x^2, x, 5, b*Defer[Int][(Cos[b*x]*SinIntegral[b*x])/x, x] - Sin[b*x]^2/x - (Sin[b*x]*SinIntegral[b*x])/x + b*SinIntegral[2*b*x]}
...
{Cos[b*x]*SinIntegral[b*x]/x^3, x, 12, -((b*Cos[2*b*x])/(4*x)) - (1/2)*b^2*Defer[Int][(Cos[b*x]*SinIntegral[b*x])/x, x] + (b*Sin[b*x]^2)/(2*x) - Sin[2*b*x]/(8*x^2) - (Cos[b*x]*SinIntegral[b*x])/(2*x^2) + (b*Sin[b*x]*SinIntegral[b*x])/(2*x) - b^2*SinIntegral[2*b*x]}
{Cos[b*x]*SinIntegral[b*x]/x^2, x, 7, b*CosIntegral[2*b*x] - Sin[2*b*x]/(2*x) - (Cos[b*x]*SinIntegral[b*x])/x - (1/2)*b*SinIntegral[b*x]^2}
{Cos[b*x]*SinIntegral[b*x]/x, x, 0, Defer[Int][(Cos[b*x]*SinIntegral[b*x])/x, x]}
...
{Sin[a + b*x]*SinIntegral[a + b*x]/x^1, x, 0, Defer[Int][(Sin[a + b*x]*SinIntegral[a + b*x])/x, x]}
...
{Cos[a + b*x]*SinIntegral[a + b*x]/x^1, x, 0, Defer[Int][(Cos[a + b*x]*SinIntegral[a + b*x])/x, x]}
...
{Sin[a + b*x]*SinIntegral[c + d*x]/x^1, x, 0, Defer[Int][(Sin[a + b*x]*SinIntegral[c + d*x])/x, x]}
...
{Cos[a + b*x]*SinIntegral[c + d*x]/x^1, x, 0, Defer[Int][(Cos[a + b*x]*SinIntegral[c + d*x])/x, x]}
...
{x^m*CosIntegral[b*x]^2, x, 0, Defer[Int][x^m*CosIntegral[b*x]^2, x]}
...
{CosIntegral[b*x]^2/x^1, x, 0, Defer[Int][CosIntegral[b*x]^2/x, x]}
{CosIntegral[b*x]^2/x^2, x, 0, Defer[Int][CosIntegral[b*x]^2/x^2, x]}
{CosIntegral[b*x]^2/x^3, x, 0, Defer[Int][CosIntegral[b*x]^2/x^3, x]}
...
{x^m*CosIntegral[a + b*x], x, 1, (x^(1 + m)*CosIntegral[a + b*x])/(1 + m) - (b*Defer[Int][(x^(1 + m)*Cos[a + b*x])/(a + b*x), x])/(1 + m)}
...
{CosIntegral[a + b*x]/x^1, x, 0, Defer[Int][CosIntegral[a + b*x]/x, x]}
...
{Sin[b*x]*CosIntegral[b*x]/x^3, x, 12, -((b*Cos[b*x]^2)/(2*x)) - (b*Cos[2*b*x])/(4*x) - (b*Cos[b*x]*CosIntegral[b*x])/(2*x) - (1/2)*b^2*Defer[Int][(CosIntegral[b*x]*Sin[b*x])/x, x] - (CosIntegral[b*x]*Sin[b*x])/(2*x^2) - Sin[2*b*x]/(8*x^2) - b^2*SinIntegral[2*b*x]}
{Sin[b*x]*CosIntegral[b*x]/x^2, x, 7, (1/2)*b*CosIntegral[b*x]^2 + b*CosIntegral[2*b*x] - (CosIntegral[b*x]*Sin[b*x])/x - Sin[2*b*x]/(2*x)}
{Sin[b*x]*CosIntegral[b*x]/x, x, 0, Defer[Int][(CosIntegral[b*x]*Sin[b*x])/x, x]}
...
{Cos[b*x]*CosIntegral[b*x]/x^2, x, 5, -(Cos[b*x]^2/x) - (Cos[b*x]*CosIntegral[b*x])/x - b*Defer[Int][(CosIntegral[b*x]*Sin[b*x])/x, x] - b*SinIntegral[2*b*x]}
...
{Sin[a + b*x]*CosIntegral[a + b*x]/x^1, x, 0, Defer[Int][(Sin[a + b*x]*CosIntegral[a + b*x])/x, x]}
...
{Cos[a + b*x]*CosIntegral[a + b*x]/x^1, x, 0, Defer[Int][(Cos[a + b*x]*CosIntegral[a + b*x])/x, x]}
...
{Sin[a + b*x]*CosIntegral[c + d*x]/x^1, x, 0, Defer[Int][(CosIntegral[c + d*x]*Sin[a + b*x])/x, x]}
...
{Cos[a + b*x]*CosIntegral[c + d*x]/x^1, x, 0, Defer[Int][(Cos[a + b*x]*CosIntegral[c + d*x])/x, x]}
