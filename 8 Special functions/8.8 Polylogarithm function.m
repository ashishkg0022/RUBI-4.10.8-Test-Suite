...
{PolyLog[3/2, x], x, 2, Defer[Int][PolyLog[-(1/2), x], x] - x*PolyLog[1/2, x] + x*PolyLog[3/2, x]}
{PolyLog[1/2, x], x, 1, -Defer[Int][PolyLog[-(1/2), x], x] + x*PolyLog[1/2, x]}
{PolyLog[-1/2, x], x, 0, Defer[Int][PolyLog[-(1/2), x], x]}
{PolyLog[-3/2, x], x, 1, -Defer[Int][PolyLog[-(1/2), x], x] + x*PolyLog[-(1/2), x]}
{PolyLog[-5/2, x], x, 2, Defer[Int][PolyLog[-(1/2), x], x] + x*PolyLog[-(3/2), x] - x*PolyLog[-(1/2), x]}
...
{PolyLog[n, d*(f^(c*(a + b*x)))^p]/x^1, x, 1, Defer[Int][PolyLog[n, d*(f^(a*c + b*c*x))^p]/x, x]}
