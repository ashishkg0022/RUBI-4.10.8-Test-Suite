...
{1/Sqrt[c*ProductLog[a + b*x]], x, 2, (Sqrt[Pi]*Erfi[Sqrt[c*ProductLog[a + b*x]]/Sqrt[c]])/(2*b*Sqrt[c]) + (a + b*x)/(b*Sqrt[c*ProductLog[a + b*x]])}
{1/Sqrt[c*ProductLog[a + b*x]]/x, x, 1, (Defer[Int][1/(x*Sqrt[ProductLog[a + b*x]]), x]*Sqrt[ProductLog[a + b*x]])/Sqrt[c*ProductLog[a + b*x]]}
{1/Sqrt[c*ProductLog[a + b*x]]/x^2, x, 1, (Defer[Int][1/(x^2*Sqrt[ProductLog[a + b*x]]), x]*Sqrt[ProductLog[a + b*x]])/Sqrt[c*ProductLog[a + b*x]]}
...
{Sqrt[c*ProductLog[a + b*x]], x, 3, (Sqrt[c]*Sqrt[Pi]*Erfi[Sqrt[c*ProductLog[a + b*x]]/Sqrt[c]])/(4*b) - (c*(a + b*x))/(2*b*Sqrt[c*ProductLog[a + b*x]]) + ((a + b*x)*Sqrt[c*ProductLog[a + b*x]])/b}
{Sqrt[c*ProductLog[a + b*x]]/x, x, 1, (Defer[Int][Sqrt[ProductLog[a + b*x]]/x, x]*Sqrt[c*ProductLog[a + b*x]])/Sqrt[ProductLog[a + b*x]]}
{Sqrt[c*ProductLog[a + b*x]]/x^2, x, 1, (Defer[Int][Sqrt[ProductLog[a + b*x]]/x^2, x]*Sqrt[c*ProductLog[a + b*x]])/Sqrt[ProductLog[a + b*x]]}
...
{1/(x*(d + d*ProductLog[a + b*x])), x, 2, Defer[Int][1/(x*(1 + ProductLog[a + b*x])), x]/d}
{1/(x^2*(d + d*ProductLog[a + b*x])), x, 2, Defer[Int][1/(x^2*(1 + ProductLog[a + b*x])), x]/d}
...
{1/ProductLog[a*x^2], x, 0, Defer[Int][1/ProductLog[a*x^2], x]}
{1/(x*ProductLog[a*x^2]), x, 2, (1/2)*Log[ProductLog[a*x^2]] - 1/(2*ProductLog[a*x^2])}
{1/(x^2*ProductLog[a*x^2]), x, 0, Defer[Int][1/(x^2*ProductLog[a*x^2]), x]}
{1/(x^3*ProductLog[a*x^2]), x, 4, -(1/(4*x^2)) - (1/4)*a*ExpIntegralEi[-ProductLog[a*x^2]] - 1/(4*x^2*ProductLog[a*x^2])}
{1/(x^4*ProductLog[a*x^2]), x, 0, Defer[Int][1/(x^4*ProductLog[a*x^2]), x]}
...
{x^6/ProductLog[a*x^2]^2, x, 0, Defer[Int][x^6/ProductLog[a*x^2]^2, x]}
{x^5/ProductLog[a*x^2]^2, x, 2, x^6/(9*ProductLog[a*x^2]^3) + x^6/(6*ProductLog[a*x^2]^2)}
{x^4/ProductLog[a*x^2]^2, x, 0, Defer[Int][x^4/ProductLog[a*x^2]^2, x]}
...
{1/ProductLog[a*x^2]^2, x, 0, Defer[Int][1/ProductLog[a*x^2]^2, x]}
{1/(x*ProductLog[a*x^2]^2), x, 2, -(1/(4*ProductLog[a*x^2]^2)) - 1/(2*ProductLog[a*x^2])}
{1/(x^2*ProductLog[a*x^2]^2), x, 0, Defer[Int][1/(x^2*ProductLog[a*x^2]^2), x]}
...
{Sqrt[c*ProductLog[a*x^2]]/x^2, x, 1, (Defer[Int][Sqrt[ProductLog[a*x^2]]/x^2, x]*Sqrt[c*ProductLog[a*x^2]])/Sqrt[ProductLog[a*x^2]]}
{Sqrt[c*ProductLog[a*x^2]]/x^3, x, 2, (-(1/2))*a*Sqrt[c]*Sqrt[Pi]*Erf[Sqrt[c*ProductLog[a*x^2]]/Sqrt[c]] - Sqrt[c*ProductLog[a*x^2]]/x^2}
{Sqrt[c*ProductLog[a*x^2]]/x^4, x, 1, (Defer[Int][Sqrt[ProductLog[a*x^2]]/x^4, x]*Sqrt[c*ProductLog[a*x^2]])/Sqrt[ProductLog[a*x^2]]}
...
{Sqrt[c*ProductLog[a*x^2]]/x^6, x, 1, (Defer[Int][Sqrt[ProductLog[a*x^2]]/x^6, x]*Sqrt[c*ProductLog[a*x^2]])/Sqrt[ProductLog[a*x^2]]}
...
{1/Sqrt[c*ProductLog[a*x^2]], x, 1, (Defer[Int][1/Sqrt[ProductLog[a*x^2]], x]*Sqrt[ProductLog[a*x^2]])/Sqrt[c*ProductLog[a*x^2]]}
{1/(x*Sqrt[c*ProductLog[a*x^2]]), x, 2, -(1/Sqrt[c*ProductLog[a*x^2]]) + Sqrt[c*ProductLog[a*x^2]]/c}
{1/(x^2*Sqrt[c*ProductLog[a*x^2]]), x, 1, (Defer[Int][1/(x^2*Sqrt[ProductLog[a*x^2]]), x]*Sqrt[ProductLog[a*x^2]])/Sqrt[c*ProductLog[a*x^2]]}
...
{1/(x^4*Sqrt[c*ProductLog[a*x^2]]), x, 1, (Defer[Int][1/(x^4*Sqrt[ProductLog[a*x^2]]), x]*Sqrt[ProductLog[a*x^2]])/Sqrt[c*ProductLog[a*x^2]]}
...
{1/(x^6*Sqrt[c*ProductLog[a*x^2]]), x, 1, (Defer[Int][1/(x^6*Sqrt[ProductLog[a*x^2]]), x]*Sqrt[ProductLog[a*x^2]])/Sqrt[c*ProductLog[a*x^2]]}
...
{x^2*(c*ProductLog[a*x^2])^p, x, 1, (Defer[Int][x^2*ProductLog[a*x^2]^p, x]*(c*ProductLog[a*x^2])^p)/ProductLog[a*x^2]^p}
...
{(c*ProductLog[a*x^2])^p/x^2, x, 1, (Defer[Int][ProductLog[a*x^2]^p/x^2, x]*(c*ProductLog[a*x^2])^p)/ProductLog[a*x^2]^p}
{(c*ProductLog[a*x^2])^p/x^3, x, 5, -((E^(2*ProductLog[a*x^2])*Gamma[-1 + p, ProductLog[a*x^2]]*ProductLog[a*x^2]^(2 - p)*(c*ProductLog[a*x^2])^p)/(2*a*x^4)) - (E^(2*ProductLog[a*x^2])*Gamma[p, ProductLog[a*x^2]]*ProductLog[a*x^2]^(2 - p)*(c*ProductLog[a*x^2])^p)/(2*a*x^4)}
...
{x^(-1 - n*(1 + p))*(c*ProductLog[a*x^n])^p, x, 2, -((c*ProductLog[a*x^n])^p/(x^(n*(1 + p))*n)) - (p*(c*ProductLog[a*x^n])^p*Defer[Int][(x^(-1 - n*(1 + p))*ProductLog[a*x^n]^(1 + p))/(1 + ProductLog[a*x^n]), x])/ProductLog[a*x^n]^p}
{x^(-1 + n*(0 - p))*(c*ProductLog[a*x^n])^p, x, 2, -((c*ProductLog[a*x^n])^p/(x^(n*p)*(n*p))) + (Defer[Int][(x^(-1 - n*p)*ProductLog[a*x^n]^p)/(1 + ProductLog[a*x^n]), x]*(c*ProductLog[a*x^n])^p)/ProductLog[a*x^n]^p}
...
{x^2/(1 + ProductLog[a*x^2]), x, 0, Defer[Int][x^2/(1 + ProductLog[a*x^2]), x]}
{x/(1 + ProductLog[a*x^2]), x, 2, x^2/(2*ProductLog[a*x^2])}
{1/(1 + ProductLog[a*x^2]), x, 0, Defer[Int][1/(1 + ProductLog[a*x^2]), x]}
{1/(x*(1 + ProductLog[a*x^2])), x, 1, (1/2)*Log[ProductLog[a*x^2]]}
{1/(x^2*(1 + ProductLog[a*x^2])), x, 0, Defer[Int][1/(x^2*(1 + ProductLog[a*x^2])), x]}
{1/(x^3*(1 + ProductLog[a*x^2])), x, 3, -(1/(2*x^2)) - (1/2)*a*ExpIntegralEi[-ProductLog[a*x^2]]}
{1/(x^4*(1 + ProductLog[a*x^2])), x, 0, Defer[Int][1/(x^4*(1 + ProductLog[a*x^2])), x]}
...
{x^2/(1 + ProductLog[a/x^2]), x, 1, -Defer[Subst][Defer[Int][1/(x^4*(1 + ProductLog[a*x^2])), x], x, 1/x]}
{x/(1 + ProductLog[a/x^2]), x, 4, x^2/2 + (1/2)*a*ExpIntegralEi[-ProductLog[a/x^2]]}
{1/(1 + ProductLog[a/x^2]), x, 1, -Defer[Subst][Defer[Int][1/(x^2*(1 + ProductLog[a*x^2])), x], x, 1/x]}
{1/(x*(1 + ProductLog[a/x^2])), x, 1, (-(1/2))*Log[ProductLog[a/x^2]]}
{1/(x^2*(1 + ProductLog[a/x^2])), x, 1, -Defer[Subst][Defer[Int][1/(1 + ProductLog[a*x^2]), x], x, 1/x]}
{1/(x^3*(1 + ProductLog[a/x^2])), x, 3, -(1/(2*x^2*ProductLog[a/x^2]))}
{1/(x^4*(1 + ProductLog[a/x^2])), x, 1, -Defer[Subst][Defer[Int][x^2/(1 + ProductLog[a*x^2]), x], x, 1/x]}
