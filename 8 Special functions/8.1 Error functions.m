...
{Erf[b*x]^2/x^1, x, 0, Defer[Int][Erf[b*x]^2/x, x]}
{Erf[b*x]^2/x^2, x, 0, Defer[Int][Erf[b*x]^2/x^2, x]}
{Erf[b*x]^2/x^3, x, 4, -((2*b*Erf[b*x])/(E^(b^2*x^2)*(Sqrt[Pi]*x))) - b^2*Erf[b*x]^2 - Erf[b*x]^2/(2*x^2) + (2*b^2*ExpIntegralEi[-2*b^2*x^2])/Pi}
{Erf[b*x]^2/x^4, x, 0, Defer[Int][Erf[b*x]^2/x^4, x]}
...
{Erf[b*x]^2/x^6, x, 0, Defer[Int][Erf[b*x]^2/x^6, x]}
...
{Erf[b*x]^2/x^8, x, 0, Defer[Int][Erf[b*x]^2/x^8, x]}


{x^3*Erf[a + b*x], x, 12, -(a/(E^(a + b*x)^2*(b^4*Sqrt[Pi]))) - a^3/(E^(a + b*x)^2*(b^4*Sqrt[Pi])) + (3*(a + b*x))/(E^(a + b*x)^2*(8*b^4*Sqrt[Pi])) + (3*a^2*(a + b*x))/(E^(a + b*x)^2*(2*b^4*Sqrt[Pi])) - (a*(a + b*x)^2)/(E^(a + b*x)^2*(b^4*Sqrt[Pi])) + (a + b*x)^3/(E^(a + b*x)^2*(4*b^4*Sqrt[Pi])) - (3*Erf[a + b*x])/(16*b^4) - (3*a^2*Erf[a + b*x])/(4*b^4) - (a^4*Erf[a + b*x])/(4*b^4) + (1/4)*x^4*Erf[a + b*x]}
{x^2*Erf[a + b*x], x, 9, 1/(E^(a + b*x)^2*(3*b^3*Sqrt[Pi])) + a^2/(E^(a + b*x)^2*(b^3*Sqrt[Pi])) - (a*(a + b*x))/(E^(a + b*x)^2*(b^3*Sqrt[Pi])) + (a + b*x)^2/(E^(a + b*x)^2*(3*b^3*Sqrt[Pi])) + (a*Erf[a + b*x])/(2*b^3) + (a^3*Erf[a + b*x])/(3*b^3) + (1/3)*x^3*Erf[a + b*x]}
{x^1*Erf[a + b*x], x, 7, -(a/(E^(a + b*x)^2*(b^2*Sqrt[Pi]))) + (a + b*x)/(E^(a + b*x)^2*(2*b^2*Sqrt[Pi])) - Erf[a + b*x]/(4*b^2) - (a^2*Erf[a + b*x])/(2*b^2) + (1/2)*x^2*Erf[a + b*x]}
{x^0*Erf[a + b*x], x, 1, 1/(E^(a + b*x)^2*(b*Sqrt[Pi])) + ((a + b*x)*Erf[a + b*x])/b}
{Erf[a + b*x]/x^1, x, 0, Defer[Int][Erf[a + b*x]/x, x]}
{Erf[a + b*x]/x^2, x, 1, -(Erf[a + b*x]/x) + (2*b*Defer[Int][1/(E^(a + b*x)^2*x), x])/Sqrt[Pi]}
...
{Erf[a + b*x]^2/x^1, x, 0, Defer[Int][Erf[a + b*x]^2/x, x]}
{Erf[a + b*x]^2/x^2, x, 0, Defer[Int][Erf[a + b*x]^2/x^2, x]}
...
{E^(-b^2*x^2)*Erf[b*x]/x^1, x, 0, Defer[Int][Erf[b*x]/(E^(b^2*x^2)*x), x]}
{E^(-b^2*x^2)*Erf[b*x]/x^2, x, 3, -(Erf[b*x]/(E^(b^2*x^2)*x)) - (1/2)*b*Sqrt[Pi]*Erf[b*x]^2 + (b*ExpIntegralEi[-2*b^2*x^2])/Sqrt[Pi]}
{E^(-b^2*x^2)*Erf[b*x]/x^3, x, 3, -(b/(E^(2*b^2*x^2)*(Sqrt[Pi]*x))) - Erf[b*x]/(E^(b^2*x^2)*(2*x^2)) - Sqrt[2]*b^2*Erf[Sqrt[2]*b*x] - b^2*Defer[Int][Erf[b*x]/(E^(b^2*x^2)*x), x]}
...
{E^(-b^2*x^2)*Erf[b*x]/x^5, x, 7, -(b/(E^(2*b^2*x^2)*(6*Sqrt[Pi]*x^3))) + (7*b^3)/(E^(2*b^2*x^2)*(6*Sqrt[Pi]*x)) - Erf[b*x]/(E^(b^2*x^2)*(4*x^4)) + (b^2*Erf[b*x])/(E^(b^2*x^2)*(4*x^2)) + (b^4*Erf[Sqrt[2]*b*x])/Sqrt[2] + (2/3)*Sqrt[2]*b^4*Erf[Sqrt[2]*b*x] + (1/2)*b^4*Defer[Int][Erf[b*x]/(E^(b^2*x^2)*x), x]}
...
{Erfc[b*x]^2/x^8, x, 0, Defer[Int][Erfc[b*x]^2/x^8, x]}
...
{Erfc[b*x]^2/x^6, x, 0, Defer[Int][Erfc[b*x]^2/x^6, x]}
...
{Erfc[b*x]^2/x^4, x, 0, Defer[Int][Erfc[b*x]^2/x^4, x]}
{Erfc[b*x]^2/x^3, x, 4, (2*b*Erfc[b*x])/(E^(b^2*x^2)*(Sqrt[Pi]*x)) - b^2*Erfc[b*x]^2 - Erfc[b*x]^2/(2*x^2) + (2*b^2*ExpIntegralEi[-2*b^2*x^2])/Pi}
{Erfc[b*x]^2/x^2, x, 0, Defer[Int][Erfc[b*x]^2/x^2, x]}
{Erfc[b*x]^2/x, x, 0, Defer[Int][Erfc[b*x]^2/x, x]}
...
{Erfc[a + b*x]/x, x, 0, Defer[Int][Erfc[a + b*x]/x, x]}
{Erfc[a + b*x], x, 1, -(1/(E^(a + b*x)^2*(b*Sqrt[Pi]))) + ((a + b*x)*Erfc[a + b*x])/b}
{x*Erfc[a + b*x], x, 7, a/(E^(a + b*x)^2*(b^2*Sqrt[Pi])) - (a + b*x)/(E^(a + b*x)^2*(2*b^2*Sqrt[Pi])) + Erf[a + b*x]/(4*b^2) + (a^2*Erf[a + b*x])/(2*b^2) + (1/2)*x^2*Erfc[a + b*x]}
{x^2*Erfc[a + b*x], x, 9, -(1/(E^(a + b*x)^2*(3*b^3*Sqrt[Pi]))) - a^2/(E^(a + b*x)^2*(b^3*Sqrt[Pi])) + (a*(a + b*x))/(E^(a + b*x)^2*(b^3*Sqrt[Pi])) - (a + b*x)^2/(E^(a + b*x)^2*(3*b^3*Sqrt[Pi])) - (a*Erf[a + b*x])/(2*b^3) - (a^3*Erf[a + b*x])/(3*b^3) + (1/3)*x^3*Erfc[a + b*x]}
{x^3*Erfc[a + b*x], x, 12, a/(E^(a + b*x)^2*(b^4*Sqrt[Pi])) + a^3/(E^(a + b*x)^2*(b^4*Sqrt[Pi])) - (3*(a + b*x))/(E^(a + b*x)^2*(8*b^4*Sqrt[Pi])) - (3*a^2*(a + b*x))/(E^(a + b*x)^2*(2*b^4*Sqrt[Pi])) + (a*(a + b*x)^2)/(E^(a + b*x)^2*(b^4*Sqrt[Pi])) - (a + b*x)^3/(E^(a + b*x)^2*(4*b^4*Sqrt[Pi])) + (3*Erf[a + b*x])/(16*b^4) + (3*a^2*Erf[a + b*x])/(4*b^4) + (a^4*Erf[a + b*x])/(4*b^4) + (1/4)*x^4*Erfc[a + b*x]}


{Erfc[a + b*x]^2/x, x, 0, Defer[Int][Erfc[a + b*x]^2/x, x]}
...
{E^(-b^2*x^2)*Erfc[b*x]/x^5, x, 7, b/(E^(2*b^2*x^2)*(6*Sqrt[Pi]*x^3)) - (7*b^3)/(E^(2*b^2*x^2)*(6*Sqrt[Pi]*x)) - (b^4*Erf[Sqrt[2]*b*x])/Sqrt[2] - (2/3)*Sqrt[2]*b^4*Erf[Sqrt[2]*b*x] - Erfc[b*x]/(E^(b^2*x^2)*(4*x^4)) + (b^2*Erfc[b*x])/(E^(b^2*x^2)*(4*x^2)) + (1/2)*b^4*Defer[Int][Erfc[b*x]/(E^(b^2*x^2)*x), x]}
...
{E^(-b^2*x^2)*Erfc[b*x]/x^3, x, 3, b/(E^(2*b^2*x^2)*(Sqrt[Pi]*x)) + Sqrt[2]*b^2*Erf[Sqrt[2]*b*x] - Erfc[b*x]/(E^(b^2*x^2)*(2*x^2)) - b^2*Defer[Int][Erfc[b*x]/(E^(b^2*x^2)*x), x]}
{E^(-b^2*x^2)*Erfc[b*x]/x^2, x, 3, -(Erfc[b*x]/(E^(b^2*x^2)*x)) + (1/2)*b*Sqrt[Pi]*Erfc[b*x]^2 - (b*ExpIntegralEi[-2*b^2*x^2])/Sqrt[Pi]}
{E^(-b^2*x^2)*Erfc[b*x]/x, x, 0, Defer[Int][Erfc[b*x]/(E^(b^2*x^2)*x), x]}
...
{Erfi[b*x]^2/x^8, x, 0, Defer[Int][Erfi[b*x]^2/x^8, x]}
...
{Erfi[b*x]^2/x^6, x, 0, Defer[Int][Erfi[b*x]^2/x^6, x]}
...
{Erfi[b*x]^2/x^4, x, 0, Defer[Int][Erfi[b*x]^2/x^4, x]}
{Erfi[b*x]^2/x^3, x, 4, -((2*b*E^(b^2*x^2)*Erfi[b*x])/(Sqrt[Pi]*x)) + b^2*Erfi[b*x]^2 - Erfi[b*x]^2/(2*x^2) + (2*b^2*ExpIntegralEi[2*b^2*x^2])/Pi}
{Erfi[b*x]^2/x^2, x, 0, Defer[Int][Erfi[b*x]^2/x^2, x]}
{Erfi[b*x]^2/x, x, 0, Defer[Int][Erfi[b*x]^2/x, x]}
...
{Erfi[a + b*x]/x, x, 0, Defer[Int][Erfi[a + b*x]/x, x]}
{Erfi[a + b*x], x, 1, -(E^(a + b*x)^2/(b*Sqrt[Pi])) + ((a + b*x)*Erfi[a + b*x])/b}
{x*Erfi[a + b*x], x, 7, (a*E^(a + b*x)^2)/(b^2*Sqrt[Pi]) - (E^(a + b*x)^2*(a + b*x))/(2*b^2*Sqrt[Pi]) + Erfi[a + b*x]/(4*b^2) - (a^2*Erfi[a + b*x])/(2*b^2) + (1/2)*x^2*Erfi[a + b*x]}
{x^2*Erfi[a + b*x], x, 9, E^(a + b*x)^2/(3*b^3*Sqrt[Pi]) - (a^2*E^(a + b*x)^2)/(b^3*Sqrt[Pi]) + (a*E^(a + b*x)^2*(a + b*x))/(b^3*Sqrt[Pi]) - (E^(a + b*x)^2*(a + b*x)^2)/(3*b^3*Sqrt[Pi]) - (a*Erfi[a + b*x])/(2*b^3) + (a^3*Erfi[a + b*x])/(3*b^3) + (1/3)*x^3*Erfi[a + b*x]}
{x^3*Erfi[a + b*x], x, 12, -((a*E^(a + b*x)^2)/(b^4*Sqrt[Pi])) + (a^3*E^(a + b*x)^2)/(b^4*Sqrt[Pi]) + (3*E^(a + b*x)^2*(a + b*x))/(8*b^4*Sqrt[Pi]) - (3*a^2*E^(a + b*x)^2*(a + b*x))/(2*b^4*Sqrt[Pi]) + (a*E^(a + b*x)^2*(a + b*x)^2)/(b^4*Sqrt[Pi]) - (E^(a + b*x)^2*(a + b*x)^3)/(4*b^4*Sqrt[Pi]) - (3*Erfi[a + b*x])/(16*b^4) + (3*a^2*Erfi[a + b*x])/(4*b^4) - (a^4*Erfi[a + b*x])/(4*b^4) + (1/4)*x^4*Erfi[a + b*x]}


{Erfi[a + b*x]^2/x, x, 0, Defer[Int][Erfi[a + b*x]^2/x, x]}
...
{E^(b^2*x^2)*Erfi[b*x]/x^5, x, 7, -((b*E^(2*b^2*x^2))/(6*Sqrt[Pi]*x^3)) - (7*b^3*E^(2*b^2*x^2))/(6*Sqrt[Pi]*x) - (E^(b^2*x^2)*Erfi[b*x])/(4*x^4) - (b^2*E^(b^2*x^2)*Erfi[b*x])/(4*x^2) + (b^4*Erfi[Sqrt[2]*b*x])/Sqrt[2] + (2/3)*Sqrt[2]*b^4*Erfi[Sqrt[2]*b*x] + (1/2)*b^4*Defer[Int][(E^(b^2*x^2)*Erfi[b*x])/x, x]}
...
{E^(b^2*x^2)*Erfi[b*x]/x^3, x, 3, -((b*E^(2*b^2*x^2))/(Sqrt[Pi]*x)) - (E^(b^2*x^2)*Erfi[b*x])/(2*x^2) + Sqrt[2]*b^2*Erfi[Sqrt[2]*b*x] + b^2*Defer[Int][(E^(b^2*x^2)*Erfi[b*x])/x, x]}
{E^(b^2*x^2)*Erfi[b*x]/x^2, x, 3, -((E^(b^2*x^2)*Erfi[b*x])/x) + (1/2)*b*Sqrt[Pi]*Erfi[b*x]^2 + (b*ExpIntegralEi[2*b^2*x^2])/Sqrt[Pi]}
{E^(b^2*x^2)*Erfi[b*x]/x, x, 0, Defer[Int][(E^(b^2*x^2)*Erfi[b*x])/x, x]}
