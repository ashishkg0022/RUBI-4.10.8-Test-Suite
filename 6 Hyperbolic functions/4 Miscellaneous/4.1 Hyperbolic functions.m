...
{Sinh[a + b*x]^(7/3)/Cosh[a + b*x]^(7/3), x, 10, -((Sqrt[3]*ArcTan[(1 + (2*Sinh[a + b*x]^(2/3))/Cosh[a + b*x]^(2/3))/Sqrt[3]])/(2*b)) - Log[1 - Sinh[a + b*x]^(2/3)/Cosh[a + b*x]^(2/3)]/(2*b) + Log[1 + Sinh[a + b*x]^(2/3)/Cosh[a + b*x]^(2/3) + Sinh[a + b*x]^(4/3)/Cosh[a + b*x]^(4/3)]/(4*b) - (3*Sinh[a + b*x]^(4/3))/(4*b*Cosh[a + b*x]^(4/3))}
{Sinh[a + b*x]^(5/3)/Cosh[a + b*x]^(5/3), x, 10, -((Sqrt[3]*ArcTan[(1 + (2*Cosh[a + b*x]^(2/3))/Sinh[a + b*x]^(2/3))/Sqrt[3]])/(2*b)) - Log[1 - Cosh[a + b*x]^(2/3)/Sinh[a + b*x]^(2/3)]/(2*b) + Log[1 + Cosh[a + b*x]^(4/3)/Sinh[a + b*x]^(4/3) + Cosh[a + b*x]^(2/3)/Sinh[a + b*x]^(2/3)]/(4*b) - (3*Sinh[a + b*x]^(2/3))/(2*b*Cosh[a + b*x]^(2/3))}
{Sinh[a + b*x]^(4/3)/Cosh[a + b*x]^(4/3), x, 14, (Sqrt[3]*ArcTan[(1 - (2*Cosh[a + b*x]^(1/3))/Sinh[a + b*x]^(1/3))/Sqrt[3]])/(2*b) - (Sqrt[3]*ArcTan[(1 + (2*Cosh[a + b*x]^(1/3))/Sinh[a + b*x]^(1/3))/Sqrt[3]])/(2*b) + ArcTanh[Cosh[a + b*x]^(1/3)/Sinh[a + b*x]^(1/3)]/b - Log[1 + Cosh[a + b*x]^(2/3)/Sinh[a + b*x]^(2/3) - Cosh[a + b*x]^(1/3)/Sinh[a + b*x]^(1/3)]/(4*b) + Log[1 + Cosh[a + b*x]^(2/3)/Sinh[a + b*x]^(2/3) + Cosh[a + b*x]^(1/3)/Sinh[a + b*x]^(1/3)]/(4*b) - (3*Sinh[a + b*x]^(1/3))/(b*Cosh[a + b*x]^(1/3))}
{Sinh[a + b*x]^(2/3)/Cosh[a + b*x]^(2/3), x, 13, (Sqrt[3]*ArcTan[(1 - (2*Sinh[a + b*x]^(1/3))/Cosh[a + b*x]^(1/3))/Sqrt[3]])/(2*b) - (Sqrt[3]*ArcTan[(1 + (2*Sinh[a + b*x]^(1/3))/Cosh[a + b*x]^(1/3))/Sqrt[3]])/(2*b) + ArcTanh[Sinh[a + b*x]^(1/3)/Cosh[a + b*x]^(1/3)]/b - Log[1 - Sinh[a + b*x]^(1/3)/Cosh[a + b*x]^(1/3) + Sinh[a + b*x]^(2/3)/Cosh[a + b*x]^(2/3)]/(4*b) + Log[1 + Sinh[a + b*x]^(1/3)/Cosh[a + b*x]^(1/3) + Sinh[a + b*x]^(2/3)/Cosh[a + b*x]^(2/3)]/(4*b)}
{Sinh[a + b*x]^(1/3)/Cosh[a + b*x]^(1/3), x, 9, -((Sqrt[3]*ArcTan[(1 + (2*Sinh[a + b*x]^(2/3))/Cosh[a + b*x]^(2/3))/Sqrt[3]])/(2*b)) - Log[1 - Sinh[a + b*x]^(2/3)/Cosh[a + b*x]^(2/3)]/(2*b) + Log[1 + Sinh[a + b*x]^(2/3)/Cosh[a + b*x]^(2/3) + Sinh[a + b*x]^(4/3)/Cosh[a + b*x]^(4/3)]/(4*b)}
{Cosh[a + b*x]^(1/3)/Sinh[a + b*x]^(1/3), x, 9, -((Sqrt[3]*ArcTan[(1 + (2*Cosh[a + b*x]^(2/3))/Sinh[a + b*x]^(2/3))/Sqrt[3]])/(2*b)) - Log[1 - Cosh[a + b*x]^(2/3)/Sinh[a + b*x]^(2/3)]/(2*b) + Log[1 + Cosh[a + b*x]^(4/3)/Sinh[a + b*x]^(4/3) + Cosh[a + b*x]^(2/3)/Sinh[a + b*x]^(2/3)]/(4*b)}
{Cosh[a + b*x]^(2/3)/Sinh[a + b*x]^(2/3), x, 13, (Sqrt[3]*ArcTan[(1 - (2*Cosh[a + b*x]^(1/3))/Sinh[a + b*x]^(1/3))/Sqrt[3]])/(2*b) - (Sqrt[3]*ArcTan[(1 + (2*Cosh[a + b*x]^(1/3))/Sinh[a + b*x]^(1/3))/Sqrt[3]])/(2*b) + ArcTanh[Cosh[a + b*x]^(1/3)/Sinh[a + b*x]^(1/3)]/b - Log[1 + Cosh[a + b*x]^(2/3)/Sinh[a + b*x]^(2/3) - Cosh[a + b*x]^(1/3)/Sinh[a + b*x]^(1/3)]/(4*b) + Log[1 + Cosh[a + b*x]^(2/3)/Sinh[a + b*x]^(2/3) + Cosh[a + b*x]^(1/3)/Sinh[a + b*x]^(1/3)]/(4*b)}
{Cosh[a + b*x]^(4/3)/Sinh[a + b*x]^(4/3), x, 14, (Sqrt[3]*ArcTan[(1 - (2*Sinh[a + b*x]^(1/3))/Cosh[a + b*x]^(1/3))/Sqrt[3]])/(2*b) - (Sqrt[3]*ArcTan[(1 + (2*Sinh[a + b*x]^(1/3))/Cosh[a + b*x]^(1/3))/Sqrt[3]])/(2*b) + ArcTanh[Sinh[a + b*x]^(1/3)/Cosh[a + b*x]^(1/3)]/b - Log[1 - Sinh[a + b*x]^(1/3)/Cosh[a + b*x]^(1/3) + Sinh[a + b*x]^(2/3)/Cosh[a + b*x]^(2/3)]/(4*b) + Log[1 + Sinh[a + b*x]^(1/3)/Cosh[a + b*x]^(1/3) + Sinh[a + b*x]^(2/3)/Cosh[a + b*x]^(2/3)]/(4*b) - (3*Cosh[a + b*x]^(1/3))/(b*Sinh[a + b*x]^(1/3))}
{Cosh[a + b*x]^(5/3)/Sinh[a + b*x]^(5/3), x, 10, -((Sqrt[3]*ArcTan[(1 + (2*Sinh[a + b*x]^(2/3))/Cosh[a + b*x]^(2/3))/Sqrt[3]])/(2*b)) - Log[1 - Sinh[a + b*x]^(2/3)/Cosh[a + b*x]^(2/3)]/(2*b) + Log[1 + Sinh[a + b*x]^(2/3)/Cosh[a + b*x]^(2/3) + Sinh[a + b*x]^(4/3)/Cosh[a + b*x]^(4/3)]/(4*b) - (3*Cosh[a + b*x]^(2/3))/(2*b*Sinh[a + b*x]^(2/3))}
{Cosh[a + b*x]^(7/3)/Sinh[a + b*x]^(7/3), x, 10, -((Sqrt[3]*ArcTan[(1 + (2*Cosh[a + b*x]^(2/3))/Sinh[a + b*x]^(2/3))/Sqrt[3]])/(2*b)) - Log[1 - Cosh[a + b*x]^(2/3)/Sinh[a + b*x]^(2/3)]/(2*b) + Log[1 + Cosh[a + b*x]^(4/3)/Sinh[a + b*x]^(4/3) + Cosh[a + b*x]^(2/3)/Sinh[a + b*x]^(2/3)]/(4*b) - (3*Cosh[a + b*x]^(4/3))/(4*b*Sinh[a + b*x]^(4/3))}
...
{Sinh[a + b*x]^3*Tanh[a + b*x]^3, x, 4, (5*ArcTan[Sinh[a + b*x]])/(2*b) - (5*Sinh[a + b*x])/(2*b) + (5*Sinh[a + b*x]^3)/(6*b) - (Sinh[a + b*x]^3*Tanh[a + b*x]^2)/(2*b)}
...
{Cosh[a + b*x]^3*Coth[a + b*x]^3, x, 4, -((5*ArcTanh[Cosh[a + b*x]])/(2*b)) + (5*Cosh[a + b*x])/(2*b) + (5*Cosh[a + b*x]^3)/(6*b) - (Cosh[a + b*x]^3*Coth[a + b*x]^2)/(2*b)}
...
{Tanh[n*x]*Sinh[x], x, 0, Defer[Int][Sinh[x]*Tanh[n*x], x]}
...
{Coth[3*x]*Cosh[x], x, 5, (-(1/3))*ArcTanh[Cosh[x]] - (1/3)*ArcTanh[2*Cosh[x]] + Cosh[x]}
...
(* Before use of TryTrigReduceQ in ExpandExpression, TrigReduce expansion resulted in infinite recursion. *)
{Coth[n*x]*Cosh[x], x, 0, Defer[Int][Cosh[x]*Coth[n*x], x]}
...
{x^m*Sech[a + b*x]*Sinh[a + b*x], x, 0, Defer[Int][x^m*Tanh[a + b*x], x]}
...
{Sech[a + b*x]*Sinh[a + b*x]/x^1, x, 0, Defer[Int][Tanh[a + b*x]/x, x]}
{Sech[a + b*x]*Sinh[a + b*x]/x^2, x, 0, Defer[Int][Tanh[a + b*x]/x^2, x]}


{x^m*Sech[a + b*x]^2*Sinh[a + b*x], x, 0, Defer[Int][x^m*Sech[a + b*x]*Tanh[a + b*x], x]}
...
{Sech[a + b*x]^2*Sinh[a + b*x]/x^1, x, 0, Defer[Int][(Sech[a + b*x]*Tanh[a + b*x])/x, x]}
{Sech[a + b*x]^2*Sinh[a + b*x]/x^2, x, 0, Defer[Int][(Sech[a + b*x]*Tanh[a + b*x])/x^2, x]}


{x^m*Sech[a + b*x]^3*Sinh[a + b*x], x, 0, Defer[Int][x^m*Sech[a + b*x]^2*Tanh[a + b*x], x]}
...
{Sech[a + b*x]^3*Sinh[a + b*x]/x^1, x, 0, Defer[Int][(Sech[a + b*x]^2*Tanh[a + b*x])/x, x]}
{Sech[a + b*x]^3*Sinh[a + b*x]/x^2, x, 0, Defer[Int][(Sech[a + b*x]^2*Tanh[a + b*x])/x^2, x]}
...
{x^m*Sech[a + b*x]*Sinh[a + b*x]^2, x, 4, (E^a*x^m*Gamma[1 + m, (-b)*x])/(((-b)*x)^m*(2*b)) - (x^m*Gamma[1 + m, b*x])/(E^a*(b*x)^m*(2*b)) - Defer[Int][x^m*Sech[a + b*x], x]}
...
{Sech[a + b*x]*Sinh[a + b*x]^2/x^1, x, 4, Cosh[a]*CoshIntegral[b*x] - Defer[Int][Sech[a + b*x]/x, x] + Sinh[a]*SinhIntegral[b*x]}
{Sech[a + b*x]*Sinh[a + b*x]^2/x^2, x, 5, -(Cosh[a + b*x]/x) - Defer[Int][Sech[a + b*x]/x^2, x] + b*CoshIntegral[b*x]*Sinh[a] + b*Cosh[a]*SinhIntegral[b*x]}


{x^m*Sech[a + b*x]^2*Sinh[a + b*x]^2, x, 0, Defer[Int][x^m*Tanh[a + b*x]^2, x]}
...
{Sech[a + b*x]^2*Sinh[a + b*x]^2/x^1, x, 0, Defer[Int][Tanh[a + b*x]^2/x, x]}
{Sech[a + b*x]^2*Sinh[a + b*x]^2/x^2, x, 0, Defer[Int][Tanh[a + b*x]^2/x^2, x]}


{x^m*Sech[a + b*x]^3*Sinh[a + b*x]^2, x, 1, Defer[Int][x^m*Sech[a + b*x], x] - Defer[Int][x^m*Sech[a + b*x]^3, x]}
...
{Sech[a + b*x]^3*Sinh[a + b*x]^2/x^1, x, 1, Defer[Int][Sech[a + b*x]/x, x] - Defer[Int][Sech[a + b*x]^3/x, x]}
{Sech[a + b*x]^3*Sinh[a + b*x]^2/x^2, x, 1, Defer[Int][Sech[a + b*x]/x^2, x] - Defer[Int][Sech[a + b*x]^3/x^2, x]}
...
{x^m*Sech[a + b*x]*Sinh[a + b*x]^3, x, 6, (2^(-3 - m)*E^(2*a)*x^m*Gamma[1 + m, -2*b*x])/(((-b)*x)^m*b) + (2^(-3 - m)*x^m*Gamma[1 + m, 2*b*x])/(E^(2*a)*(b*x)^m*b) - Defer[Int][x^m*Tanh[a + b*x], x]}

{x^3*Sech[a + b*x]*Sinh[a + b*x]^3, x, 12, (3*x)/(8*b^3) + x^3/(4*b) + x^4/4 - (x^3*Log[1 + E^(2*a + 2*b*x)])/b - (3*x^2*PolyLog[2, -E^(2*a + 2*b*x)])/(2*b^2) + (3*x*PolyLog[3, -E^(2*a + 2*b*x)])/(2*b^3) - (3*PolyLog[4, -E^(2*a + 2*b*x)])/(4*b^4) - (3*Cosh[a + b*x]*Sinh[a + b*x])/(8*b^4) - (3*x^2*Cosh[a + b*x]*Sinh[a + b*x])/(4*b^2) + (3*x*Sinh[a + b*x]^2)/(4*b^3) + (x^3*Sinh[a + b*x]^2)/(2*b)}
...
{x^1*Sech[a + b*x]*Sinh[a + b*x]^3, x, 8, x/(4*b) + x^2/2 - (x*Log[1 + E^(2*a + 2*b*x)])/b - PolyLog[2, -E^(2*a + 2*b*x)]/(2*b^2) - (Cosh[a + b*x]*Sinh[a + b*x])/(4*b^2) + (x*Sinh[a + b*x]^2)/(2*b)}
{x^0*Sech[a + b*x]*Sinh[a + b*x]^3, x, 3, Cosh[a + b*x]^2/(2*b) - Log[Cosh[a + b*x]]/b}
{Sech[a + b*x]*Sinh[a + b*x]^3/x^1, x, 6, -Defer[Int][Tanh[a + b*x]/x, x] + (1/2)*CoshIntegral[2*b*x]*Sinh[2*a] + (1/2)*Cosh[2*a]*SinhIntegral[2*b*x]}
{Sech[a + b*x]*Sinh[a + b*x]^3/x^2, x, 7, b*Cosh[2*a]*CoshIntegral[2*b*x] - Defer[Int][Tanh[a + b*x]/x^2, x] - Sinh[2*a + 2*b*x]/(2*x) + b*Sinh[2*a]*SinhIntegral[2*b*x]}


{x^m*Sech[a + b*x]^2*Sinh[a + b*x]^3, x, 4, (E^a*x^m*Gamma[1 + m, (-b)*x])/(((-b)*x)^m*(2*b)) + (x^m*Gamma[1 + m, b*x])/(E^a*(b*x)^m*(2*b)) - Defer[Int][x^m*Sech[a + b*x]*Tanh[a + b*x], x]}
...
{Sech[a + b*x]^2*Sinh[a + b*x]^3/x^1, x, 4, -Defer[Int][(Sech[a + b*x]*Tanh[a + b*x])/x, x] + CoshIntegral[b*x]*Sinh[a] + Cosh[a]*SinhIntegral[b*x]}
{Sech[a + b*x]^2*Sinh[a + b*x]^3/x^2, x, 5, b*Cosh[a]*CoshIntegral[b*x] - Defer[Int][(Sech[a + b*x]*Tanh[a + b*x])/x^2, x] - Sinh[a + b*x]/x + b*Sinh[a]*SinhIntegral[b*x]}


{x^m*Sech[a + b*x]^3*Sinh[a + b*x]^3, x, 0, Defer[Int][x^m*Tanh[a + b*x]^3, x]}
...
{Sech[a + b*x]^3*Sinh[a + b*x]^3/x^1, x, 0, Defer[Int][Tanh[a + b*x]^3/x, x]}
{Sech[a + b*x]^3*Sinh[a + b*x]^3/x^2, x, 0, Defer[Int][Tanh[a + b*x]^3/x^2, x]}
...
{x^m*Cosh[a + b*x]*Csch[a + b*x], x, 0, Defer[Int][x^m*Coth[a + b*x], x]}
...
{Cosh[a + b*x]*Csch[a + b*x]/x^1, x, 0, Defer[Int][Coth[a + b*x]/x, x]}
{Cosh[a + b*x]*Csch[a + b*x]/x^2, x, 0, Defer[Int][Coth[a + b*x]/x^2, x]}


{x^m*Cosh[a + b*x]^2*Csch[a + b*x], x, 4, (E^a*x^m*Gamma[1 + m, (-b)*x])/(((-b)*x)^m*(2*b)) + (x^m*Gamma[1 + m, b*x])/(E^a*(b*x)^m*(2*b)) + Defer[Int][x^m*Csch[a + b*x], x]}
...
{Cosh[a + b*x]^2*Csch[a + b*x]/x^1, x, 4, Defer[Int][Csch[a + b*x]/x, x] + CoshIntegral[b*x]*Sinh[a] + Cosh[a]*SinhIntegral[b*x]}
{Cosh[a + b*x]^2*Csch[a + b*x]/x^2, x, 5, b*Cosh[a]*CoshIntegral[b*x] + Defer[Int][Csch[a + b*x]/x^2, x] - Sinh[a + b*x]/x + b*Sinh[a]*SinhIntegral[b*x]}


{x^m*Cosh[a + b*x]^3*Csch[a + b*x], x, 6, (2^(-3 - m)*E^(2*a)*x^m*Gamma[1 + m, -2*b*x])/(((-b)*x)^m*b) + (2^(-3 - m)*x^m*Gamma[1 + m, 2*b*x])/(E^(2*a)*(b*x)^m*b) + Defer[Int][x^m*Coth[a + b*x], x]}

{x^3*Cosh[a + b*x]^3*Csch[a + b*x], x, 12, (3*x)/(8*b^3) + x^3/(4*b) - x^4/4 + (x^3*Log[1 - E^(2*a + 2*b*x)])/b + (3*x^2*PolyLog[2, E^(2*a + 2*b*x)])/(2*b^2) - (3*x*PolyLog[3, E^(2*a + 2*b*x)])/(2*b^3) + (3*PolyLog[4, E^(2*a + 2*b*x)])/(4*b^4) - (3*Cosh[a + b*x]*Sinh[a + b*x])/(8*b^4) - (3*x^2*Cosh[a + b*x]*Sinh[a + b*x])/(4*b^2) + (3*x*Sinh[a + b*x]^2)/(4*b^3) + (x^3*Sinh[a + b*x]^2)/(2*b)}
...
{x^1*Cosh[a + b*x]^3*Csch[a + b*x], x, 8, x/(4*b) - x^2/2 + (x*Log[1 - E^(2*a + 2*b*x)])/b + PolyLog[2, E^(2*a + 2*b*x)]/(2*b^2) - (Cosh[a + b*x]*Sinh[a + b*x])/(4*b^2) + (x*Sinh[a + b*x]^2)/(2*b)}
{x^0*Cosh[a + b*x]^3*Csch[a + b*x], x, 3, Log[Sinh[a + b*x]]/b + Sinh[a + b*x]^2/(2*b)}
{Cosh[a + b*x]^3*Csch[a + b*x]/x^1, x, 6, Defer[Int][Coth[a + b*x]/x, x] + (1/2)*CoshIntegral[2*b*x]*Sinh[2*a] + (1/2)*Cosh[2*a]*SinhIntegral[2*b*x]}
{Cosh[a + b*x]^3*Csch[a + b*x]/x^2, x, 7, b*Cosh[2*a]*CoshIntegral[2*b*x] + Defer[Int][Coth[a + b*x]/x^2, x] - Sinh[2*a + 2*b*x]/(2*x) + b*Sinh[2*a]*SinhIntegral[2*b*x]}
...
{x^m*Cosh[a + b*x]*Csch[a + b*x]^2, x, 0, Defer[Int][x^m*Coth[a + b*x]*Csch[a + b*x], x]}
...
{Cosh[a + b*x]*Csch[a + b*x]^2/x^1, x, 0, Defer[Int][(Coth[a + b*x]*Csch[a + b*x])/x, x]}
{Cosh[a + b*x]*Csch[a + b*x]^2/x^2, x, 0, Defer[Int][(Coth[a + b*x]*Csch[a + b*x])/x^2, x]}


{x^m*Cosh[a + b*x]^2*Csch[a + b*x]^2, x, 0, Defer[Int][x^m*Coth[a + b*x]^2, x]}
...
{Cosh[a + b*x]^2*Csch[a + b*x]^2/x^1, x, 0, Defer[Int][Coth[a + b*x]^2/x, x]}
{Cosh[a + b*x]^2*Csch[a + b*x]^2/x^2, x, 0, Defer[Int][Coth[a + b*x]^2/x^2, x]}


{x^m*Cosh[a + b*x]^3*Csch[a + b*x]^2, x, 4, (E^a*x^m*Gamma[1 + m, (-b)*x])/(((-b)*x)^m*(2*b)) - (x^m*Gamma[1 + m, b*x])/(E^a*(b*x)^m*(2*b)) + Defer[Int][x^m*Coth[a + b*x]*Csch[a + b*x], x]}
...
{Cosh[a + b*x]^3*Csch[a + b*x]^2/x^1, x, 4, Cosh[a]*CoshIntegral[b*x] + Defer[Int][(Coth[a + b*x]*Csch[a + b*x])/x, x] + Sinh[a]*SinhIntegral[b*x]}
{Cosh[a + b*x]^3*Csch[a + b*x]^2/x^2, x, 5, -(Cosh[a + b*x]/x) + Defer[Int][(Coth[a + b*x]*Csch[a + b*x])/x^2, x] + b*CoshIntegral[b*x]*Sinh[a] + b*Cosh[a]*SinhIntegral[b*x]}
...
{x^m*Cosh[a + b*x]*Csch[a + b*x]^3, x, 0, Defer[Int][x^m*Coth[a + b*x]*Csch[a + b*x]^2, x]}
...
{Cosh[a + b*x]*Csch[a + b*x]^3/x^1, x, 0, Defer[Int][(Coth[a + b*x]*Csch[a + b*x]^2)/x, x]}
{Cosh[a + b*x]*Csch[a + b*x]^3/x^2, x, 0, Defer[Int][(Coth[a + b*x]*Csch[a + b*x]^2)/x^2, x]}


{x^m*Cosh[a + b*x]^2*Csch[a + b*x]^3, x, 1, Defer[Int][x^m*Csch[a + b*x], x] + Defer[Int][x^m*Csch[a + b*x]^3, x]}
...
{Cosh[a + b*x]^2*Csch[a + b*x]^3/x^1, x, 1, Defer[Int][Csch[a + b*x]/x, x] + Defer[Int][Csch[a + b*x]^3/x, x]}
{Cosh[a + b*x]^2*Csch[a + b*x]^3/x^2, x, 1, Defer[Int][Csch[a + b*x]/x^2, x] + Defer[Int][Csch[a + b*x]^3/x^2, x]}


{x^m*Cosh[a + b*x]^3*Csch[a + b*x]^3, x, 0, Defer[Int][x^m*Coth[a + b*x]^3, x]}
...
{Cosh[a + b*x]^3*Csch[a + b*x]^3/x^1, x, 0, Defer[Int][Coth[a + b*x]^3/x, x]}
{Cosh[a + b*x]^3*Csch[a + b*x]^3/x^2, x, 0, Defer[Int][Coth[a + b*x]^3/x^2, x]}
...
{x^m*Sech[a + b*x]*Csch[a + b*x], x, 0, Defer[Int][x^m*Csch[a + b*x]*Sech[a + b*x], x]}
...
{Sech[a + b*x]*Csch[a + b*x]/x^1, x, 1, 2*Defer[Int][Csch[2*a + 2*b*x]/x, x]}
{Sech[a + b*x]*Csch[a + b*x]/x^2, x, 1, 2*Defer[Int][Csch[2*a + 2*b*x]/x^2, x]}


{x^m*Sech[a + b*x]^2*Csch[a + b*x], x, 0, Defer[Int][x^m*Csch[a + b*x]*Sech[a + b*x]^2, x]}
...
{Sech[a + b*x]^2*Csch[a + b*x]/x^1, x, 0, Defer[Int][(Csch[a + b*x]*Sech[a + b*x]^2)/x, x]}
{Sech[a + b*x]^2*Csch[a + b*x]/x^2, x, 0, Defer[Int][(Csch[a + b*x]*Sech[a + b*x]^2)/x^2, x]}


{x^m*Sech[a + b*x]^3*Csch[a + b*x], x, 0, Defer[Int][x^m*Csch[a + b*x]*Sech[a + b*x]^3, x]}
...
{Sech[a + b*x]^3*Csch[a + b*x]/x^1, x, 0, Defer[Int][(Csch[a + b*x]*Sech[a + b*x]^3)/x, x]}
{Sech[a + b*x]^3*Csch[a + b*x]/x^2, x, 0, Defer[Int][(Csch[a + b*x]*Sech[a + b*x]^3)/x^2, x]}
...
{x^m*Sech[a + b*x]*Csch[a + b*x]^2, x, 0, Defer[Int][x^m*Csch[a + b*x]^2*Sech[a + b*x], x]}
...
{Sech[a + b*x]*Csch[a + b*x]^2/x^1, x, 0, Defer[Int][(Csch[a + b*x]^2*Sech[a + b*x])/x, x]}
{Sech[a + b*x]*Csch[a + b*x]^2/x^2, x, 0, Defer[Int][(Csch[a + b*x]^2*Sech[a + b*x])/x^2, x]}


{x^m*Sech[a + b*x]^2*Csch[a + b*x]^2, x, 0, Defer[Int][x^m*Csch[a + b*x]^2*Sech[a + b*x]^2, x]}
...
{Sech[a + b*x]^2*Csch[a + b*x]^2/x^1, x, 1, 4*Defer[Int][Csch[2*a + 2*b*x]^2/x, x]}
{Sech[a + b*x]^2*Csch[a + b*x]^2/x^2, x, 1, 4*Defer[Int][Csch[2*a + 2*b*x]^2/x^2, x]}


{x^m*Sech[a + b*x]^3*Csch[a + b*x]^2, x, 0, Defer[Int][x^m*Csch[a + b*x]^2*Sech[a + b*x]^3, x]}
...
{x^1*Sech[a + b*x]^3*Csch[a + b*x]^2, x, 12, -((3*x*ArcTan[E^(a + b*x)])/b) - ArcTanh[Cosh[a + b*x]]/b^2 - (3*x*Csch[a + b*x])/(2*b) + (3*I*PolyLog[2, (-I)*E^(a + b*x)])/(2*b^2) - (3*I*PolyLog[2, I*E^(a + b*x)])/(2*b^2) - Sech[a + b*x]/(2*b^2) + (x*Csch[a + b*x]*Sech[a + b*x]^2)/(2*b)}
{x^0*Sech[a + b*x]^3*Csch[a + b*x]^2, x, 3, -((3*ArcTan[Sinh[a + b*x]])/(2*b)) - (3*Csch[a + b*x])/(2*b) + (Csch[a + b*x]*Sech[a + b*x]^2)/(2*b)}
{Sech[a + b*x]^3*Csch[a + b*x]^2/x^1, x, 0, Defer[Int][(Csch[a + b*x]^2*Sech[a + b*x]^3)/x, x]}
{Sech[a + b*x]^3*Csch[a + b*x]^2/x^2, x, 0, Defer[Int][(Csch[a + b*x]^2*Sech[a + b*x]^3)/x^2, x]}
...
{x^m*Sech[a + b*x]*Csch[a + b*x]^3, x, 0, Defer[Int][x^m*Csch[a + b*x]^3*Sech[a + b*x], x]}
...
{Sech[a + b*x]*Csch[a + b*x]^3/x^1, x, 0, Defer[Int][(Csch[a + b*x]^3*Sech[a + b*x])/x, x]}
{Sech[a + b*x]*Csch[a + b*x]^3/x^2, x, 0, Defer[Int][(Csch[a + b*x]^3*Sech[a + b*x])/x^2, x]}


{x^m*Sech[a + b*x]^2*Csch[a + b*x]^3, x, 0, Defer[Int][x^m*Csch[a + b*x]^3*Sech[a + b*x]^2, x]}
...
{x^1*Sech[a + b*x]^2*Csch[a + b*x]^3, x, 12, ArcTan[Sinh[a + b*x]]/b^2 + (3*x*ArcTanh[E^(a + b*x)])/b - Csch[a + b*x]/(2*b^2) + (3*PolyLog[2, -E^(a + b*x)])/(2*b^2) - (3*PolyLog[2, E^(a + b*x)])/(2*b^2) - (3*x*Sech[a + b*x])/(2*b) - (x*Csch[a + b*x]^2*Sech[a + b*x])/(2*b)}
{x^0*Sech[a + b*x]^2*Csch[a + b*x]^3, x, 3, (3*ArcTanh[Cosh[a + b*x]])/(2*b) - (3*Sech[a + b*x])/(2*b) - (Csch[a + b*x]^2*Sech[a + b*x])/(2*b)}
{Sech[a + b*x]^2*Csch[a + b*x]^3/x^1, x, 0, Defer[Int][(Csch[a + b*x]^3*Sech[a + b*x]^2)/x, x]}
{Sech[a + b*x]^2*Csch[a + b*x]^3/x^2, x, 0, Defer[Int][(Csch[a + b*x]^3*Sech[a + b*x]^2)/x^2, x]}


{x^m*Sech[a + b*x]^3*Csch[a + b*x]^3, x, 0, Defer[Int][x^m*Csch[a + b*x]^3*Sech[a + b*x]^3, x]}
...
{Sech[a + b*x]^3*Csch[a + b*x]^3/x^1, x, 1, 8*Defer[Int][Csch[2*a + 2*b*x]^3/x, x]}
{Sech[a + b*x]^3*Csch[a + b*x]^3/x^2, x, 1, 8*Defer[Int][Csch[2*a + 2*b*x]^3/x^2, x]}
...
{(1 + Sinh[x]^2)/(1 - Sinh[x]^2), x, 4, -x + Sqrt[2]*ArcTanh[Sqrt[2]*Tanh[x]]}
{(1 - Sinh[x]^2)/(1 + Sinh[x]^2), x, 4, -x + 2*Tanh[x]}


{(1 + Cosh[x]^2)/(1 - Cosh[x]^2), x, 4, -x + 2*Coth[x]}
{(1 - Cosh[x]^2)/(1 + Cosh[x]^2), x, 4, -x + Sqrt[2]*ArcTanh[Tanh[x]/Sqrt[2]]}
...
{(a*Sech[x] + b*Tanh[x])^5, x, 9, (1/8)*a*(3*a^4 + 10*a^2*b^2 + 15*b^4)*ArcTan[Sinh[x]] + b^5*Log[Cosh[x]] - (1/8)*a*b^2*(3*a^2 + 7*b^2)*Sinh[x] - (1/4)*Sech[x]^4*(b - a*Sinh[x])*(a + b*Sinh[x])^4 - (1/8)*Sech[x]^2*(a + b*Sinh[x])^2*(2*b*(a^2 + 2*b^2) - a*(3*a^2 + 5*b^2)*Sinh[x])}
...
{(a*Sech[x] + b*Tanh[x])^3, x, 8, (1/2)*a*(a^2 + 3*b^2)*ArcTan[Sinh[x]] + b^3*Log[Cosh[x]] - (1/2)*a*b^2*Sinh[x] - (1/2)*Sech[x]^2*(b - a*Sinh[x])*(a + b*Sinh[x])^2}
...
{(a*Coth[x] + b*Csch[x])^5, x, 9, (-(1/8))*b*(15*a^4 - 10*a^2*b^2 + 3*b^4)*ArcTanh[Cosh[x]] + (1/8)*a^2*b*(7*a^2 - 3*b^2)*Cosh[x] - (1/8)*(b + a*Cosh[x])^2*(2*a*(2*a^2 - b^2) + b*(5*a^2 - 3*b^2)*Cosh[x])*Csch[x]^2 - (1/4)*(b + a*Cosh[x])^4*(a + b*Cosh[x])*Csch[x]^4 + a^5*Log[Sinh[x]]}
...
{(a*Coth[x] + b*Csch[x])^3, x, 8, (-(1/2))*b*(3*a^2 - b^2)*ArcTanh[Cosh[x]] + (1/2)*a^2*b*Cosh[x] - (1/2)*(b + a*Cosh[x])^2*(a + b*Cosh[x])*Csch[x]^2 + a^3*Log[Sinh[x]]}
...
{(Csch[x] + Sinh[x])^3, x, 5, (-(5/2))*ArcTanh[Cosh[x]] + (5*Cosh[x])/2 + (5*Cosh[x]^3)/6 - (1/2)*Cosh[x]^3*Coth[x]^2}
...
{(Sech[x] - Cosh[x])^3, x, 5, (-(5/2))*ArcTan[Sinh[x]] + (5*Sinh[x])/2 - (5*Sinh[x]^3)/6 + (1/2)*Sinh[x]^3*Tanh[x]^2}
...
{Sech[x]^2/(a + b*Tanh[x] + c*Sech[x]), x, 11, (2*c*ArcTan[Tanh[x/2]])/(b^2 + c^2) - (2*a*c*ArcTan[(b + (a - c)*Tanh[x/2])/Sqrt[a^2 - b^2 - c^2]])/(Sqrt[a^2 - b^2 - c^2]*(b^2 + c^2)) - (b*Log[1 + Tanh[x/2]^2])/(b^2 + c^2) + (b*Log[a + c + 2*b*Tanh[x/2] + (a - c)*Tanh[x/2]^2])/(b^2 + c^2)}
...
{Csch[x]^2/(a + b*Coth[x] + c*Csch[x]), x, 10, -((2*a*c*ArcTanh[(a + (b - c)*Tanh[x/2])/Sqrt[a^2 - b^2 + c^2]])/((b^2 - c^2)*Sqrt[a^2 - b^2 + c^2])) + Log[Tanh[x/2]]/(b + c) - (b*Log[b + c + 2*a*Tanh[x/2] + (b - c)*Tanh[x/2]^2])/(b^2 - c^2)}
...
{(a + b*Cosh[c + d*x]*Sinh[c + d*x])^2, x, 3, (1/8)*(8*a^2 - b^2)*x + (a*b*Cosh[2*c + 2*d*x])/(2*d) + (b^2*Cosh[2*c + 2*d*x]*Sinh[2*c + 2*d*x])/(16*d)}
...
{1/(x^1*(a + b*Sinh[x]*Cosh[x])), x, 1, Defer[Int][1/(x*(a + (1/2)*b*Sinh[2*x])), x]}
...
{F^(c*(a + b*x))/(f + I*f*Sinh[d + e*x])^2, x, 3, (2*E^((1/2)*(2*d + I*Pi + 2*e*x))*F^(c*(a + b*x))*Hypergeometric2F1[2, 1 + (b*c*Log[F])/e, 2 + (b*c*Log[F])/e, -E^((1/2)*(2*d + I*Pi + 2*e*x))]*(e - b*c*Log[F]))/(3*e^2*f^2) + (b*c*F^(c*(a + b*x))*Log[F]*Sech[(1/4)*(2*d + I*Pi) + (e*x)/2]^2)/(6*e^2*f^2) + (F^(c*(a + b*x))*Sech[(1/4)*(2*d + I*Pi) + (e*x)/2]^2*Tanh[(1/4)*(2*d + I*Pi) + (e*x)/2])/(6*e*f^2)}
...
{E^x*Sech[2*x]*Tanh[2*x], x, 14, -(E^(3*x)/(1 + E^(4*x))) - ArcTan[1 - Sqrt[2]*E^x]/(2*Sqrt[2]) + ArcTan[1 + Sqrt[2]*E^x]/(2*Sqrt[2]) + Log[1 - Sqrt[2]*E^x + E^(2*x)]/(4*Sqrt[2]) - Log[1 + Sqrt[2]*E^x + E^(2*x)]/(4*Sqrt[2])}
{E^x*Sech[2*x]^2*Tanh[2*x], x, 15, -(E^(5*x)/(1 + E^(4*x))^2) - E^x/(4*(1 + E^(4*x))) - ArcTan[1 - Sqrt[2]*E^x]/(8*Sqrt[2]) + ArcTan[1 + Sqrt[2]*E^x]/(8*Sqrt[2]) - Log[1 - Sqrt[2]*E^x + E^(2*x)]/(16*Sqrt[2]) + Log[1 + Sqrt[2]*E^x + E^(2*x)]/(16*Sqrt[2])}
{E^x*Sech[2*x]*Tanh[2*x]^2, x, 15, E^(3*x)/(1 + E^(4*x))^2 - (3*E^(3*x))/(4*(1 + E^(4*x))) - (5*ArcTan[1 - Sqrt[2]*E^x])/(8*Sqrt[2]) + (5*ArcTan[1 + Sqrt[2]*E^x])/(8*Sqrt[2]) + (5*Log[1 - Sqrt[2]*E^x + E^(2*x)])/(16*Sqrt[2]) - (5*Log[1 + Sqrt[2]*E^x + E^(2*x)])/(16*Sqrt[2])}
{E^x*Sech[2*x]^2*Tanh[2*x]^2, x, 16, (4*E^(5*x))/(3*(1 + E^(4*x))^3) - (5*E^(5*x))/(6*(1 + E^(4*x))^2) - (3*E^x)/(8*(1 + E^(4*x))) - (3*ArcTan[1 - Sqrt[2]*E^x])/(16*Sqrt[2]) + (3*ArcTan[1 + Sqrt[2]*E^x])/(16*Sqrt[2]) - (3*Log[1 - Sqrt[2]*E^x + E^(2*x)])/(32*Sqrt[2]) + (3*Log[1 + Sqrt[2]*E^x + E^(2*x)])/(32*Sqrt[2])}
...
{E^(a + b*x)*Sinh[c + d*x]^(3/2) - ((3*d^2)/(4*(b^2 - (9*d^2)/4)))*(E^(a + b*x)/Sqrt[Sinh[c + d*x]]), x, 8, -((6*d*E^(a + b*x)*Cosh[c + d*x]*Sqrt[Sinh[c + d*x]])/(4*b^2 - 9*d^2)) + (4*b*E^(a + b*x)*Sinh[c + d*x]^(3/2))/(4*b^2 - 9*d^2)}
...
{E^(n*Cosh[a*c+b*c*x])*Sinh[c*(a+b*x)], x, 1, E^(n*Cosh[a*c + b*c*x])/(b*c*n)}
{E^(n*Cosh[c*(a+b*x)])*Sinh[a*c+b*c*x], x, 2, E^(n*Cosh[a*c + b*c*x])/(b*c*n)}


{E^(n*Cosh[a+b*x])*Tanh[a+b*x], x, 2, ExpIntegralEi[n*Cosh[a + b*x]]/b}
{E^(n*Cosh[a*c+b*c*x])*Tanh[c*(a+b*x)], x, 2, ExpIntegralEi[n*Cosh[a*c + b*c*x]]/(b*c)}
...
{E^(n*Sinh[a*c+b*c*x])*Cosh[c*(a+b*x)], x, 1, E^(n*Sinh[a*c + b*c*x])/(b*c*n)}
{E^(n*Sinh[c*(a+b*x)])*Cosh[a*c+b*c*x], x, 2, E^(n*Sinh[a*c + b*c*x])/(b*c*n)}


{E^(n*Sinh[a+b*x])*Coth[a+b*x], x, 2, ExpIntegralEi[n*Sinh[a + b*x]]/b}
{E^(n*Sinh[a*c+b*c*x])*Coth[c*(a+b*x)], x, 2, ExpIntegralEi[n*Sinh[a*c + b*c*x]]/(b*c)}
...
{Sech[x]^2*(2 - Tanh[x]^2)/(1 - Tanh[x]^2), x, 3, x + Tanh[x]}
...
{Sech[x]^2/(3 - 4*Tanh[x]^3), x, 8, ArcTan[(3 + 2*6^(2/3)*Tanh[x])/(3*Sqrt[3])]/(3*2^(2/3)*3^(1/6)) - Log[3^(1/3) - 2^(2/3)*Tanh[x]]/(3*6^(2/3)) + Log[3^(2/3) + 2^(2/3)*3^(1/3)*Tanh[x] + 2*2^(1/3)*Tanh[x]^2]/(6*6^(2/3))}
...
{Sech[x]^4*(-1 + Sech[x]^2)^2*Tanh[x], x, 4, Tanh[x]^6/6 - Tanh[x]^8/8, (-(1/4))*Sech[x]^4 + Sech[x]^6/3 - Sech[x]^8/8}
...
{Cosh[a + b*x]*F[c, d, Sinh[a + b*x], r, s], x, 1, Defer[Subst][Defer[Int][F[c, d, x, r, s], x], x, Sinh[a + b*x]]/b}
{Sinh[a + b*x]*F[c, d, Cosh[a + b*x], r, s], x, 1, (Defer[Subst][Defer[Int][F[c, d, x, r, s], x], x, Cosh[a + b*x]]/b)}
{Sech[a + b*x]^2*F[c, d, Tanh[a + b*x], r, s], x, 1, Defer[Subst][Defer[Int][F[c, d, x, r, s], x], x, Tanh[a + b*x]]/b}
{Csch[a + b*x]^2*F[c, d, Coth[a + b*x], r, s], x, 2, -(Defer[Subst][Defer[Int][F[c, d, x, r, s], x], x, Coth[a + b*x]]/b)}
...
{Sinh[x]^2/(a + b*Sinh[2*x]), x, 10, ArcTanh[(b - a*Tanh[x])/Sqrt[a^2 + b^2]]/(2*Sqrt[a^2 + b^2]) + Log[a + b*Sinh[2*x]]/(4*b), ArcTanh[(b - a*Tanh[x])/Sqrt[a^2 + b^2]]/(2*Sqrt[a^2 + b^2]) + Log[Cosh[x]]/(2*b) + Log[a + 2*b*Tanh[x] - a*Tanh[x]^2]/(4*b)}
{Cosh[x]^2/(a + b*Sinh[2*x]), x, 9, -(ArcTanh[(b - a*Tanh[x])/Sqrt[a^2 + b^2]]/(2*Sqrt[a^2 + b^2])) + Log[a + b*Sinh[2*x]]/(4*b), -(ArcTanh[(b - a*Tanh[x])/Sqrt[a^2 + b^2]]/(2*Sqrt[a^2 + b^2])) + Log[Cosh[x]]/(2*b) + Log[a + 2*b*Tanh[x] - a*Tanh[x]^2]/(4*b)}
...
{Tanh[c + d*x]/Sqrt[a*Sinh[c+d*x]^2], x, 4, ArcTan[Sqrt[a*Sinh[c + d*x]^2]/Sqrt[a]]/(Sqrt[a]*d)}
{Coth[c + d*x]/Sqrt[a*Cosh[c+d*x]^2], x, 4, -(ArcTanh[Sqrt[a*Cosh[c + d*x]^2]/Sqrt[a]]/(Sqrt[a]*d))}
...
(* {Csch[x^5]/x, x, Defer[Int][Csch[x^5]/x, x]} *)
