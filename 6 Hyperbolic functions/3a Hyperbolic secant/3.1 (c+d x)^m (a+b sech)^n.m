...
{Sech[a + b*x]/(c + d*x)^1, x, 0, Defer[Int][Sech[a + b*x]/(c + d*x), x]}
...
{Sech[a + b*x]^2/(c + d*x)^1, x, 0, Defer[Int][Sech[a + b*x]^2/(c + d*x), x]}
...
{Sech[a + b*x]^3/(c + d*x)^1, x, 0, Defer[Int][Sech[a + b*x]^3/(c + d*x), x]}
