...
{Tanh[8*x]^(1/3), x, 10, (-(1/16))*Sqrt[3]*ArcTan[(1 + 2*Tanh[8*x]^(2/3))/Sqrt[3]] - (1/16)*Log[1 - Tanh[8*x]^(2/3)] + (1/32)*Log[1 + Tanh[8*x]^(2/3) + Tanh[8*x]^(4/3)]}
...
{Sech[x]^6/(1 + Tanh[x]), x, 3, Tanh[x] - Tanh[x]^2/2 - Tanh[x]^3/3 + Tanh[x]^4/4}
...
{Cosh[x]^2/(a + b*Tanh[x]), x, 7, -(((a + 2*b)*Log[1 - Tanh[x]])/(4*(a + b)^2)) + ((a - 2*b)*Log[1 + Tanh[x]])/(4*(a - b)^2) + (b^3*Log[a + b*Tanh[x]])/(a^2 - b^2)^2 - (Cosh[x]^2*(b - a*Tanh[x]))/(2*(a^2 - b^2))}
{Cosh[x]^4/(a + b*Tanh[x]), x, 8, -(((3*a^2 + 9*a*b + 8*b^2)*Log[1 - Tanh[x]])/(16*(a + b)^3)) + ((3*a^2 - 9*a*b + 8*b^2)*Log[1 + Tanh[x]])/(16*(a - b)^3) - (b^5*Log[a + b*Tanh[x]])/(a^2 - b^2)^3 - (Cosh[x]^4*(b - a*Tanh[x]))/(4*(a^2 - b^2)) + (Cosh[x]^2*(4*b^3 - a*(7 - (3*a^2)/b^2)*b^2*Tanh[x]))/(8*(a^2 - b^2)^2)}
...
{Csch[c + d*x]^2*(a + b*Tanh[c + d*x]^2), x, 2, -((a*Coth[c + d*x])/d) + (b*Tanh[c + d*x])/d}
...
{Csch[c + d*x]^3*(a + b*Tanh[c + d*x]^2)^2, x, 5, (a*(a - 4*b)*ArcTanh[Cosh[c + d*x]])/(2*d) - ((3*a^2 + 2*b^2)*Coth[c + d*x]*Csch[c + d*x])/(6*d) + (b*(6*a + b)*Sech[c + d*x])/(3*d) + (b^2*Csch[c + d*x]^2*Sech[c + d*x]^3)/(3*d)}
...
{Csch[c + d*x]^3*(a + b*Tanh[c + d*x]^2)^3, x, 5, (a^2*(a - 6*b)*ArcTanh[Cosh[c + d*x]])/(2*d) - (a^2*(a - 6*b)*Sech[c + d*x])/(2*d) + (b*(6*a^2 - 3*a*b - 2*b^2)*Sech[c + d*x]^3)/(6*d) - ((5*a - 2*b)*b^2*Sech[c + d*x]^5)/(10*d) - (a*(b - (a + b)*Cosh[c + d*x]^2)^2*Csch[c + d*x]^2*Sech[c + d*x]^5)/(2*d)}
...
{Csch[c + d*x]^3/(a + b*Tanh[c + d*x]^2), x, 5, ((a + 2*b)*ArcTanh[Cosh[c + d*x]])/(2*a^2*d) - (Sqrt[b]*Sqrt[a + b]*ArcTanh[(Sqrt[a + b]*Cosh[c + d*x])/Sqrt[b]])/(a^2*d) - (Coth[c + d*x]*Csch[c + d*x])/(2*a*d)}
...
{Sinh[c + d*x]^3/(a + b*Tanh[c + d*x]^2)^2, x, 5, ((3*a - 2*b)*Sqrt[b]*ArcTanh[(Sqrt[a + b]*Cosh[c + d*x])/Sqrt[b]])/(2*(a + b)^(7/2)*d) - ((a - b)*Cosh[c + d*x])/((a + b)^3*d) + Cosh[c + d*x]^3/(3*(a + b)^2*d) - (a*b*Cosh[c + d*x])/(2*(a + b)^3*d*(b - (a + b)*Cosh[c + d*x]^2))}
...
{Csch[c + d*x]^1/(a + b*Tanh[c + d*x]^2)^2, x, 5, -(ArcTanh[Cosh[c + d*x]]/(a^2*d)) + (Sqrt[b]*(3*a + 2*b)*ArcTanh[(Sqrt[a + b]*Cosh[c + d*x])/Sqrt[b]])/(2*a^2*(a + b)^(3/2)*d) - (b*Cosh[c + d*x])/(2*a*(a + b)*d*(b - (a + b)*Cosh[c + d*x]^2))}
...
{Csch[c + d*x]^3/(a + b*Tanh[c + d*x]^2)^2, x, 6, ((a + 4*b)*ArcTanh[Cosh[c + d*x]])/(2*a^3*d) - (Sqrt[b]*(3*a + 4*b)*ArcTanh[(Sqrt[a + b]*Cosh[c + d*x])/Sqrt[b]])/(2*a^3*Sqrt[a + b]*d) + ((a + 2*b)*Cosh[c + d*x])/(2*a^2*d*(b - (a + b)*Cosh[c + d*x]^2)) + (Coth[c + d*x]*Csch[c + d*x])/(2*a*d*(b - (a + b)*Cosh[c + d*x]^2))}
...
{Sinh[c + d*x]^3/(a + b*Tanh[c + d*x]^2)^3, x, 6, (5*(3*a - 4*b)*Sqrt[b]*ArcTanh[(Sqrt[a + b]*Cosh[c + d*x])/Sqrt[b]])/(8*(a + b)^(9/2)*d) - ((a - 2*b)*Cosh[c + d*x])/((a + b)^4*d) + Cosh[c + d*x]^3/(3*(a + b)^3*d) + (a*b^2*Cosh[c + d*x])/(4*(a + b)^4*d*(b - (a + b)*Cosh[c + d*x]^2)^2) - ((9*a - 4*b)*b*Cosh[c + d*x])/(8*(a + b)^4*d*(b - (a + b)*Cosh[c + d*x]^2))}
...
{Sinh[c + d*x]^4*(a + b*Tanh[c + d*x]^3), x, 8, -((3*(a + 8*b)*Log[1 - Tanh[c + d*x]])/(16*d)) + (3*(a - 8*b)*Log[1 + Tanh[c + d*x]])/(16*d) - (b*Tanh[c + d*x]^2)/(2*d) + (Cosh[c + d*x]^3*Sinh[c + d*x]*(a + b*Tanh[c + d*x]))/(4*d) - (5*Cosh[c + d*x]*Sinh[c + d*x]*(a + 2*b*Tanh[c + d*x]))/(8*d)}
{Sinh[c + d*x]^3*(a + b*Tanh[c + d*x]^3), x, 8, (5*b*ArcTan[Sinh[c + d*x]])/(2*d) - (a*Cosh[c + d*x])/d + (a*Cosh[c + d*x]^3)/(3*d) - (5*b*Sinh[c + d*x])/(2*d) + (5*b*Sinh[c + d*x]^3)/(6*d) - (b*Sinh[c + d*x]^3*Tanh[c + d*x]^2)/(2*d)}
{Sinh[c + d*x]^2*(a + b*Tanh[c + d*x]^3), x, 7, ((a + 4*b)*Log[1 - Tanh[c + d*x]])/(4*d) - ((a - 4*b)*Log[1 + Tanh[c + d*x]])/(4*d) + (b*Tanh[c + d*x]^2)/(2*d) + (Cosh[c + d*x]*Sinh[c + d*x]*(a + b*Tanh[c + d*x]))/(2*d)}
{Sinh[c + d*x]^1*(a + b*Tanh[c + d*x]^3), x, 6, (-3*b*ArcTan[Sinh[c + d*x]])/(2*d) + (a*Cosh[c + d*x])/d + (3*b*Sinh[c + d*x])/(2*d) - (b*Sinh[c + d*x]*Tanh[c + d*x]^2)/(2*d)}
...
{Sinh[c + d*x]^4*(a + b*Tanh[c + d*x]^3)^2, x, 8, (3/8)*(a^2 + 21*b^2)*x + (6*a*b*Log[Cosh[c + d*x]])/d - (6*b^2*Tanh[c + d*x])/d - (a*b*Tanh[c + d*x]^2)/d - (b^2*Tanh[c + d*x]^3)/d - (b^2*Tanh[c + d*x]^5)/(5*d) + (Cosh[c + d*x]^3*Sinh[c + d*x]*(a^2 + b^2 + 2*a*b*Tanh[c + d*x]))/(4*d) - (Cosh[c + d*x]*Sinh[c + d*x]*(5*a^2 + 17*b^2 + 20*a*b*Tanh[c + d*x]))/(8*d), -((3*(a^2 + 16*a*b + 21*b^2)*Log[1 - Tanh[c + d*x]])/(16*d)) + (3*(a^2 - 16*a*b + 21*b^2)*Log[1 + Tanh[c + d*x]])/(16*d) - (6*b^2*Tanh[c + d*x])/d - (a*b*Tanh[c + d*x]^2)/d - (b^2*Tanh[c + d*x]^3)/d - (b^2*Tanh[c + d*x]^5)/(5*d) + (Cosh[c + d*x]^3*Sinh[c + d*x]*(a^2 + b^2 + 2*a*b*Tanh[c + d*x]))/(4*d) - (Cosh[c + d*x]*Sinh[c + d*x]*(5*a^2 + 17*b^2 + 20*a*b*Tanh[c + d*x]))/(8*d)}
{Sinh[c + d*x]^3*(a + b*Tanh[c + d*x]^3)^2, x, 11, (5*a*b*ArcTan[Sinh[c + d*x]])/d - (a^2*Cosh[c + d*x])/d - (4*b^2*Cosh[c + d*x])/d + (a^2*Cosh[c + d*x]^3)/(3*d) + (b^2*Cosh[c + d*x]^3)/(3*d) - (6*b^2*Sech[c + d*x])/d + (4*b^2*Sech[c + d*x]^3)/(3*d) - (b^2*Sech[c + d*x]^5)/(5*d) - (5*a*b*Sinh[c + d*x])/d + (5*a*b*Sinh[c + d*x]^3)/(3*d) - (a*b*Sinh[c + d*x]^3*Tanh[c + d*x]^2)/d}
{Sinh[c + d*x]^2*(a + b*Tanh[c + d*x]^3)^2, x, 7, (-(1/2))*(a^2 + 7*b^2)*x - (4*a*b*Log[Cosh[c + d*x]])/d + (3*b^2*Tanh[c + d*x])/d + (a*b*Tanh[c + d*x]^2)/d + (2*b^2*Tanh[c + d*x]^3)/(3*d) + (b^2*Tanh[c + d*x]^5)/(5*d) + (Cosh[c + d*x]*Sinh[c + d*x]*(a^2 + b^2 + 2*a*b*Tanh[c + d*x]))/(2*d), ((a + b)*(a + 7*b)*Log[1 - Tanh[c + d*x]])/(4*d) - ((a - 7*b)*(a - b)*Log[1 + Tanh[c + d*x]])/(4*d) + (3*b^2*Tanh[c + d*x])/d + (a*b*Tanh[c + d*x]^2)/d + (2*b^2*Tanh[c + d*x]^3)/(3*d) + (b^2*Tanh[c + d*x]^5)/(5*d) + (Cosh[c + d*x]*Sinh[c + d*x]*(a^2 + b^2 + 2*a*b*Tanh[c + d*x]))/(2*d)}
{Sinh[c + d*x]^1*(a + b*Tanh[c + d*x]^3)^2, x, 9, (-3*a*b*ArcTan[Sinh[c + d*x]])/d + (a^2*Cosh[c + d*x])/d + (b^2*Cosh[c + d*x])/d + (3*b^2*Sech[c + d*x])/d - (b^2*Sech[c + d*x]^3)/d + (b^2*Sech[c + d*x]^5)/(5*d) + (3*a*b*Sinh[c + d*x])/d - (a*b*Sinh[c + d*x]*Tanh[c + d*x]^2)/d}
...
{Sinh[c + d*x]^1/(a + b*Tanh[c + d*x]^3), x, 0, (-I)*Defer[Int][(I*Sinh[c + d*x])/(a + b*Tanh[c + d*x]^3), x]}
{Csch[c + d*x]^1/(a + b*Tanh[c + d*x]^3), x, 0, I*Defer[Int][((-I)*Csch[c + d*x])/(a + b*Tanh[c + d*x]^3), x]}
{Csch[c + d*x]^2/(a + b*Tanh[c + d*x]^3), x, 9, (b^(1/3)*ArcTan[(a^(1/3) - 2*b^(1/3)*Tanh[c + d*x])/(Sqrt[3]*a^(1/3))])/(Sqrt[3]*a^(4/3)*d) - Coth[c + d*x]/(a*d) + (b^(1/3)*Log[a^(1/3) + b^(1/3)*Tanh[c + d*x]])/(3*a^(4/3)*d) - (b^(1/3)*Log[a^(2/3) - a^(1/3)*b^(1/3)*Tanh[c + d*x] + b^(2/3)*Tanh[c + d*x]^2])/(6*a^(4/3)*d)}
{Csch[c + d*x]^3/(a + b*Tanh[c + d*x]^3), x, 0, (-I)*Defer[Int][(I*Csch[c + d*x]^3)/(a + b*Tanh[c + d*x]^3), x]}
...
{(a + b*Tanh[c + d*x]^3)^2, x, 6, (a^2 + b^2)*x + (2*a*b*Log[Cosh[c + d*x]])/d - (b^2*Tanh[c + d*x])/d - (a*b*Tanh[c + d*x]^2)/d - (b^2*Tanh[c + d*x]^3)/(3*d) - (b^2*Tanh[c + d*x]^5)/(5*d)}
...
{Tanh[x]^5/Sqrt[a + b*Tanh[x]^2 + c*Tanh[x]^4], x, 11, (b*ArcTanh[(b + 2*c*Tanh[x]^2)/(2*Sqrt[c]*Sqrt[a + b*Tanh[x]^2 + c*Tanh[x]^4])])/(4*c^(3/2)) - ArcTanh[(b + 2*c*Tanh[x]^2)/(2*Sqrt[c]*Sqrt[a + b*Tanh[x]^2 + c*Tanh[x]^4])]/(2*Sqrt[c]) + ArcTanh[(2*a + b + (b + 2*c)*Tanh[x]^2)/(2*Sqrt[a + b + c]*Sqrt[a + b*Tanh[x]^2 + c*Tanh[x]^4])]/(2*Sqrt[a + b + c]) - Sqrt[a + b*Tanh[x]^2 + c*Tanh[x]^4]/(2*c)}
...
{E^x*Tanh[2*x]^2, x, 15, E^x + E^x/(1 + E^(4*x)) + ArcTan[1 - Sqrt[2]*E^x]/(2*Sqrt[2]) - ArcTan[1 + Sqrt[2]*E^x]/(2*Sqrt[2]) + Log[1 - Sqrt[2]*E^x + E^(2*x)]/(4*Sqrt[2]) - Log[1 + Sqrt[2]*E^x + E^(2*x)]/(4*Sqrt[2])}
{E^x*Tanh[2*x], x, 13, E^x + ArcTan[1 - Sqrt[2]*E^x]/Sqrt[2] - ArcTan[1 + Sqrt[2]*E^x]/Sqrt[2] + Log[1 - Sqrt[2]*E^x + E^(2*x)]/(2*Sqrt[2]) - Log[1 + Sqrt[2]*E^x + E^(2*x)]/(2*Sqrt[2])}
{E^x*Coth[2*x], x, 5, E^x - ArcTan[E^x] - ArcTanh[E^x]}
{E^x*Coth[2*x]^2, x, 7, E^x + E^x/(1 - E^(4*x)) - ArcTan[E^x]/2 - ArcTanh[E^x]/2}


{E^x*Tanh[3*x]^2, x, 16, E^x + (2*E^x)/(3*(1 + E^(6*x))) - (2*ArcTan[E^x])/9 + (1/9)*ArcTan[Sqrt[3] - 2*E^x] - (1/9)*ArcTan[Sqrt[3] + 2*E^x] + Log[1 - Sqrt[3]*E^x + E^(2*x)]/(6*Sqrt[3]) - Log[1 + Sqrt[3]*E^x + E^(2*x)]/(6*Sqrt[3])}
{E^x*Tanh[3*x], x, 14, E^x - (2*ArcTan[E^x])/3 + (1/3)*ArcTan[Sqrt[3] - 2*E^x] - (1/3)*ArcTan[Sqrt[3] + 2*E^x] + Log[1 - Sqrt[3]*E^x + E^(2*x)]/(2*Sqrt[3]) - Log[1 + Sqrt[3]*E^x + E^(2*x)]/(2*Sqrt[3])}
{E^x*Coth[3*x], x, 14, E^x + ArcTan[(1 - 2*E^x)/Sqrt[3]]/Sqrt[3] - ArcTan[(1 + 2*E^x)/Sqrt[3]]/Sqrt[3] - (2*ArcTanh[E^x])/3 + (1/6)*Log[1 - E^x + E^(2*x)] - (1/6)*Log[1 + E^x + E^(2*x)]}
{E^x*Coth[3*x]^2, x, 16, E^x + (2*E^x)/(3*(1 - E^(6*x))) + ArcTan[(1 - 2*E^x)/Sqrt[3]]/(3*Sqrt[3]) - ArcTan[(1 + 2*E^x)/Sqrt[3]]/(3*Sqrt[3]) - (2*ArcTanh[E^x])/9 + (1/18)*Log[1 - E^x + E^(2*x)] - (1/18)*Log[1 + E^x + E^(2*x)]}


{E^x*Tanh[4*x]^2, x, 27, E^x + E^x/(2*(1 + E^(8*x))) + ArcTan[(Sqrt[2 - Sqrt[2]] - 2*E^x)/Sqrt[2 + Sqrt[2]]]/(8*Sqrt[2*(2 - Sqrt[2])]) + ArcTan[(Sqrt[2 + Sqrt[2]] - 2*E^x)/Sqrt[2 - Sqrt[2]]]/(8*Sqrt[2*(2 + Sqrt[2])]) - ArcTan[(Sqrt[2 - Sqrt[2]] + 2*E^x)/Sqrt[2 + Sqrt[2]]]/(8*Sqrt[2*(2 - Sqrt[2])]) - ArcTan[(Sqrt[2 + Sqrt[2]] + 2*E^x)/Sqrt[2 - Sqrt[2]]]/(8*Sqrt[2*(2 + Sqrt[2])]) + (1/32)*Sqrt[2 - Sqrt[2]]*Log[1 - Sqrt[2 - Sqrt[2]]*E^x + E^(2*x)] - (1/32)*Sqrt[2 - Sqrt[2]]*Log[1 + Sqrt[2 - Sqrt[2]]*E^x + E^(2*x)] + (1/32)*Sqrt[2 + Sqrt[2]]*Log[1 - Sqrt[2 + Sqrt[2]]*E^x + E^(2*x)] - (1/32)*Sqrt[2 + Sqrt[2]]*Log[1 + Sqrt[2 + Sqrt[2]]*E^x + E^(2*x)]}
{E^x*Tanh[4*x], x, 25, E^x + ArcTan[(Sqrt[2 - Sqrt[2]] - 2*E^x)/Sqrt[2 + Sqrt[2]]]/(2*Sqrt[2*(2 - Sqrt[2])]) + ArcTan[(Sqrt[2 + Sqrt[2]] - 2*E^x)/Sqrt[2 - Sqrt[2]]]/(2*Sqrt[2*(2 + Sqrt[2])]) - ArcTan[(Sqrt[2 - Sqrt[2]] + 2*E^x)/Sqrt[2 + Sqrt[2]]]/(2*Sqrt[2*(2 - Sqrt[2])]) - ArcTan[(Sqrt[2 + Sqrt[2]] + 2*E^x)/Sqrt[2 - Sqrt[2]]]/(2*Sqrt[2*(2 + Sqrt[2])]) + (1/8)*Sqrt[2 - Sqrt[2]]*Log[1 - Sqrt[2 - Sqrt[2]]*E^x + E^(2*x)] - (1/8)*Sqrt[2 - Sqrt[2]]*Log[1 + Sqrt[2 - Sqrt[2]]*E^x + E^(2*x)] + (1/8)*Sqrt[2 + Sqrt[2]]*Log[1 - Sqrt[2 + Sqrt[2]]*E^x + E^(2*x)] - (1/8)*Sqrt[2 + Sqrt[2]]*Log[1 + Sqrt[2 + Sqrt[2]]*E^x + E^(2*x)]}
{E^x*Coth[4*x], x, 17, E^x - ArcTan[E^x]/2 + ArcTan[1 - Sqrt[2]*E^x]/(2*Sqrt[2]) - ArcTan[1 + Sqrt[2]*E^x]/(2*Sqrt[2]) - ArcTanh[E^x]/2 + Log[1 - Sqrt[2]*E^x + E^(2*x)]/(4*Sqrt[2]) - Log[1 + Sqrt[2]*E^x + E^(2*x)]/(4*Sqrt[2])}
{E^x*Coth[4*x]^2, x, 19, E^x + E^x/(2*(1 - E^(8*x))) - ArcTan[E^x]/8 + ArcTan[1 - Sqrt[2]*E^x]/(8*Sqrt[2]) - ArcTan[1 + Sqrt[2]*E^x]/(8*Sqrt[2]) - ArcTanh[E^x]/8 + Log[1 - Sqrt[2]*E^x + E^(2*x)]/(16*Sqrt[2]) - Log[1 + Sqrt[2]*E^x + E^(2*x)]/(16*Sqrt[2])}
...
{Csc[Tanh[a + b*x]]^1, x, 3, -(Defer[Subst][Defer[Int][Csc[x]/(-1 + x), x], x, Tanh[a + b*x]]/(2*b)) + Defer[Subst][Defer[Int][Csc[x]/(1 + x), x], x, Tanh[a + b*x]]/(2*b)}
...
{Sec[Tanh[a + b*x]]^1, x, 3, -(Defer[Subst][Defer[Int][Sec[x]/(-1 + x), x], x, Tanh[a + b*x]]/(2*b)) + Defer[Subst][Defer[Int][Sec[x]/(1 + x), x], x, Tanh[a + b*x]]/(2*b)}
