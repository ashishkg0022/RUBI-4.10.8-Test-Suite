...
{Coth[a + b*x]/x^1, x, 0, Defer[Int][Coth[a + b*x]/x, x]}
{Coth[a + b*x]/x^2, x, 0, Defer[Int][Coth[a + b*x]/x^2, x]}
...
{Coth[a + b*x]^2/x^1, x, 0, Defer[Int][Coth[a + b*x]^2/x, x]}
{Coth[a + b*x]^2/x^2, x, 0, Defer[Int][Coth[a + b*x]^2/x^2, x]}
...
{Coth[a + b*x]^3/x^1, x, 0, Defer[Int][Coth[a + b*x]^3/x, x]}
{Coth[a + b*x]^3/x^2, x, 0, Defer[Int][Coth[a + b*x]^3/x^2, x]}
...
{(c + d*x)^m*(a + a*Coth[e + f*x])^2, x, 0, Defer[Int][(c + d*x)^m*(a + a*Coth[e + f*x])^2, x]}
{(c + d*x)^m*(a + a*Coth[e + f*x])^1, x, 0, Defer[Int][(c + d*x)^m*(a + a*Coth[e + f*x]), x]}
...
{(c + d*x)^3*(a + b*Coth[e + f*x]), x, 8, (a*(c + d*x)^4)/(4*d) - (b*(c + d*x)^4)/(4*d) + (b*(c + d*x)^3*Log[1 - E^(2*e + 2*f*x)])/f + (3*b*d*(c + d*x)^2*PolyLog[2, E^(2*e + 2*f*x)])/(2*f^2) - (3*b*d^2*(c + d*x)*PolyLog[3, E^(2*e + 2*f*x)])/(2*f^3) + (3*b*d^3*PolyLog[4, E^(2*e + 2*f*x)])/(4*f^4)}
{(c + d*x)^2*(a + b*Coth[e + f*x]), x, 7, (a*(c + d*x)^3)/(3*d) - (b*(c + d*x)^3)/(3*d) + (b*(c + d*x)^2*Log[1 - E^(2*e + 2*f*x)])/f + (b*d*(c + d*x)*PolyLog[2, E^(2*e + 2*f*x)])/f^2 - (b*d^2*PolyLog[3, E^(2*e + 2*f*x)])/(2*f^3)}
{(c + d*x)^1*(a + b*Coth[e + f*x]), x, 6, (a*(c + d*x)^2)/(2*d) - (b*(c + d*x)^2)/(2*d) + (b*(c + d*x)*Log[1 - E^(2*e + 2*f*x)])/f + (b*d*PolyLog[2, E^(2*e + 2*f*x)])/(2*f^2)}
{(a + b*Coth[e + f*x])/(c + d*x)^1, x, 0, Defer[Int][(a + b*Coth[e + f*x])/(c + d*x), x]}
{(a + b*Coth[e + f*x])/(c + d*x)^2, x, 0, Defer[Int][(a + b*Coth[e + f*x])/(c + d*x)^2, x]}


{(c + d*x)^3*(a + b*Coth[e + f*x])^2, x, 15, -((b^2*(c + d*x)^3)/f) + (a^2*(c + d*x)^4)/(4*d) - (a*b*(c + d*x)^4)/(2*d) + (b^2*(c + d*x)^4)/(4*d) - (b^2*(c + d*x)^3*Coth[e + f*x])/f + (3*b^2*d*(c + d*x)^2*Log[1 - E^(2*e + 2*f*x)])/f^2 + (2*a*b*(c + d*x)^3*Log[1 - E^(2*e + 2*f*x)])/f + (3*b^2*d^2*(c + d*x)*PolyLog[2, E^(2*e + 2*f*x)])/f^3 + (3*a*b*d*(c + d*x)^2*PolyLog[2, E^(2*e + 2*f*x)])/f^2 - (3*b^2*d^3*PolyLog[3, E^(2*e + 2*f*x)])/(2*f^4) - (3*a*b*d^2*(c + d*x)*PolyLog[3, E^(2*e + 2*f*x)])/f^3 + (3*a*b*d^3*PolyLog[4, E^(2*e + 2*f*x)])/(2*f^4)}
{(c + d*x)^2*(a + b*Coth[e + f*x])^2, x, 13, -((b^2*(c + d*x)^2)/f) + (a^2*(c + d*x)^3)/(3*d) - (2*a*b*(c + d*x)^3)/(3*d) + (b^2*(c + d*x)^3)/(3*d) - (b^2*(c + d*x)^2*Coth[e + f*x])/f + (2*b^2*d*(c + d*x)*Log[1 - E^(2*e + 2*f*x)])/f^2 + (2*a*b*(c + d*x)^2*Log[1 - E^(2*e + 2*f*x)])/f + (b^2*d^2*PolyLog[2, E^(2*e + 2*f*x)])/f^3 + (2*a*b*d*(c + d*x)*PolyLog[2, E^(2*e + 2*f*x)])/f^2 - (a*b*d^2*PolyLog[3, E^(2*e + 2*f*x)])/f^3}
{(c + d*x)^1*(a + b*Coth[e + f*x])^2, x, 9, b^2*c*x + (b^2*d*x^2)/2 + (a^2*(c + d*x)^2)/(2*d) - (a*b*(c + d*x)^2)/d - (b^2*(c + d*x)*Coth[e + f*x])/f + (2*a*b*(c + d*x)*Log[1 - E^(2*e + 2*f*x)])/f + (b^2*d*Log[Sinh[e + f*x]])/f^2 + (a*b*d*PolyLog[2, E^(2*e + 2*f*x)])/f^2}
{(a + b*Coth[e + f*x])^2/(c + d*x)^1, x, 0, Defer[Int][(a + b*Coth[e + f*x])^2/(c + d*x), x]}
{(a + b*Coth[e + f*x])^2/(c + d*x)^2, x, 0, Defer[Int][(a + b*Coth[e + f*x])^2/(c + d*x)^2, x]}


{(c + d*x)^3*(a + b*Coth[e + f*x])^3, x, 28, (-3*b^3*d*(c + d*x)^2)/(2*f^2) - (3*a*b^2*(c + d*x)^3)/f + (b^3*(c + d*x)^3)/(2*f) + (a^3*(c + d*x)^4)/(4*d) - (3*a^2*b*(c + d*x)^4)/(4*d) + (3*a*b^2*(c + d*x)^4)/(4*d) - (b^3*(c + d*x)^4)/(4*d) - (3*b^3*d*(c + d*x)^2*Coth[e + f*x])/(2*f^2) - (3*a*b^2*(c + d*x)^3*Coth[e + f*x])/f - (b^3*(c + d*x)^3*Coth[e + f*x]^2)/(2*f) + (3*b^3*d^2*(c + d*x)*Log[1 - E^(2*e + 2*f*x)])/f^3 + (9*a*b^2*d*(c + d*x)^2*Log[1 - E^(2*e + 2*f*x)])/f^2 + (3*a^2*b*(c + d*x)^3*Log[1 - E^(2*e + 2*f*x)])/f + (b^3*(c + d*x)^3*Log[1 - E^(2*e + 2*f*x)])/f + (3*b^3*d^3*PolyLog[2, E^(2*e + 2*f*x)])/(2*f^4) + (9*a*b^2*d^2*(c + d*x)*PolyLog[2, E^(2*e + 2*f*x)])/f^3 + (9*a^2*b*d*(c + d*x)^2*PolyLog[2, E^(2*e + 2*f*x)])/(2*f^2) + (3*b^3*d*(c + d*x)^2*PolyLog[2, E^(2*e + 2*f*x)])/(2*f^2) - (9*a*b^2*d^3*PolyLog[3, E^(2*e + 2*f*x)])/(2*f^4) - (9*a^2*b*d^2*(c + d*x)*PolyLog[3, E^(2*e + 2*f*x)])/(2*f^3) - (3*b^3*d^2*(c + d*x)*PolyLog[3, E^(2*e + 2*f*x)])/(2*f^3) + (9*a^2*b*d^3*PolyLog[4, E^(2*e + 2*f*x)])/(4*f^4) + (3*b^3*d^3*PolyLog[4, E^(2*e + 2*f*x)])/(4*f^4)}
{(c + d*x)^2*(a + b*Coth[e + f*x])^3, x, 22, (b^3*c*d*x)/f + (b^3*d^2*x^2)/(2*f) - (3*a*b^2*(c + d*x)^2)/f + (a^3*(c + d*x)^3)/(3*d) - (a^2*b*(c + d*x)^3)/d + (a*b^2*(c + d*x)^3)/d - (b^3*(c + d*x)^3)/(3*d) - (b^3*d*(c + d*x)*Coth[e + f*x])/f^2 - (3*a*b^2*(c + d*x)^2*Coth[e + f*x])/f - (b^3*(c + d*x)^2*Coth[e + f*x]^2)/(2*f) + (6*a*b^2*d*(c + d*x)*Log[1 - E^(2*e + 2*f*x)])/f^2 + (3*a^2*b*(c + d*x)^2*Log[1 - E^(2*e + 2*f*x)])/f + (b^3*(c + d*x)^2*Log[1 - E^(2*e + 2*f*x)])/f + (b^3*d^2*Log[Sinh[e + f*x]])/f^3 + (3*a*b^2*d^2*PolyLog[2, E^(2*e + 2*f*x)])/f^3 + (3*a^2*b*d*(c + d*x)*PolyLog[2, E^(2*e + 2*f*x)])/f^2 + (b^3*d*(c + d*x)*PolyLog[2, E^(2*e + 2*f*x)])/f^2 - (3*a^2*b*d^2*PolyLog[3, E^(2*e + 2*f*x)])/(2*f^3) - (b^3*d^2*PolyLog[3, E^(2*e + 2*f*x)])/(2*f^3)}
{(c + d*x)^1*(a + b*Coth[e + f*x])^3, x, 16, 3*a*b^2*c*x + (b^3*d*x)/(2*f) + (3*a*b^2*d*x^2)/2 + (a^3*(c + d*x)^2)/(2*d) - (3*a^2*b*(c + d*x)^2)/(2*d) - (b^3*(c + d*x)^2)/(2*d) - (b^3*d*Coth[e + f*x])/(2*f^2) - (3*a*b^2*(c + d*x)*Coth[e + f*x])/f - (b^3*(c + d*x)*Coth[e + f*x]^2)/(2*f) + (3*a^2*b*(c + d*x)*Log[1 - E^(2*e + 2*f*x)])/f + (b^3*(c + d*x)*Log[1 - E^(2*e + 2*f*x)])/f + (3*a*b^2*d*Log[Sinh[e + f*x]])/f^2 + (3*a^2*b*d*PolyLog[2, E^(2*e + 2*f*x)])/(2*f^2) + (b^3*d*PolyLog[2, E^(2*e + 2*f*x)])/(2*f^2)}
{(a + b*Coth[e + f*x])^3/(c + d*x)^1, x, 0, Defer[Int][(a + b*Coth[e + f*x])^3/(c + d*x), x]}
{(a + b*Coth[e + f*x])^3/(c + d*x)^2, x, 0, Defer[Int][(a + b*Coth[e + f*x])^3/(c + d*x)^2, x]}
...
{(c + d*x)^1/(a + b*Coth[e + f*x])^2, x, 5, -(c + d*x)^2/(2*(a^2 - b^2)*d) + (b*d - 2*a*c*f - 2*a*d*f*x)^2/(4*a*(a - b)*(a + b)^2*d*f^2) + (b*(c + d*x))/((a^2 - b^2)*f*(a + b*Coth[e + f*x])) + (b*(b*d - 2*a*c*f - 2*a*d*f*x)*Log[1 - (a - b)/((a + b)*E^(2*(e + f*x)))])/((a^2 - b^2)^2*f^2) + (a*b*d*PolyLog[2, (a - b)/((a + b)*E^(2*(e + f*x)))])/((a^2 - b^2)^2*f^2)}
{1/((c + d*x)^1*(a + b*Coth[e + f*x])^2), x, 0, Defer[Int][1/((c + d*x)*(a + b*Coth[e + f*x])^2), x]}
{1/((c + d*x)^2*(a + b*Coth[e + f*x])^2), x, 0, Defer[Int][1/((c + d*x)^2*(a + b*Coth[e + f*x])^2), x]}
