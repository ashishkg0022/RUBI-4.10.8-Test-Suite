...
{(b*Coth[c + d*x])^(4/3),x, 15, -((Sqrt[3]*b^(4/3)*ArcTan[(b^(1/3) - 2*(b*Coth[c + d*x])^(1/3))/(Sqrt[3]*b^(1/3))])/(2*d)) + (Sqrt[3]*b^(4/3)*ArcTan[(b^(1/3) + 2*(b*Coth[c + d*x])^(1/3))/(Sqrt[3]*b^(1/3))])/(2*d) + (b^(4/3)*ArcTanh[(b*Coth[c + d*x])^(1/3)/b^(1/3)])/d - (3*b*(b*Coth[c + d*x])^(1/3))/d - (b^(4/3)*Log[b^(2/3) - b^(1/3)*(b*Coth[c + d*x])^(1/3) + (b*Coth[c + d*x])^(2/3)])/(4*d) + (b^(4/3)*Log[b^(2/3) + b^(1/3)*(b*Coth[c + d*x])^(1/3) + (b*Coth[c + d*x])^(2/3)])/(4*d)}
{(b*Coth[c + d*x])^(2/3),x, 14, (Sqrt[3]*b^(2/3)*ArcTan[(b^(1/3) - 2*(b*Coth[c + d*x])^(1/3))/(Sqrt[3]*b^(1/3))])/(2*d) - (Sqrt[3]*b^(2/3)*ArcTan[(b^(1/3) + 2*(b*Coth[c + d*x])^(1/3))/(Sqrt[3]*b^(1/3))])/(2*d) + (b^(2/3)*ArcTanh[(b*Coth[c + d*x])^(1/3)/b^(1/3)])/d - (b^(2/3)*Log[b^(2/3) - b^(1/3)*(b*Coth[c + d*x])^(1/3) + (b*Coth[c + d*x])^(2/3)])/(4*d) + (b^(2/3)*Log[b^(2/3) + b^(1/3)*(b*Coth[c + d*x])^(1/3) + (b*Coth[c + d*x])^(2/3)])/(4*d)}
{(b*Coth[c + d*x])^(1/3), x, 10, -((Sqrt[3]*b^(1/3)*ArcTan[(b^(2/3) + 2*(b*Coth[c + d*x])^(2/3))/(Sqrt[3]*b^(2/3))])/(2*d)) - (b^(1/3)*Log[b^(2/3) - (b*Coth[c + d*x])^(2/3)])/(2*d) + (b^(1/3)*Log[b^(4/3) + b^(2/3)*(b*Coth[c + d*x])^(2/3) + (b*Coth[c + d*x])^(4/3)])/(4*d)}
{1/(b*Coth[c + d*x])^(1/3), x, 10, (Sqrt[3]*ArcTan[(b^(2/3) + 2*(b*Coth[c + d*x])^(2/3))/(Sqrt[3]*b^(2/3))])/(2*b^(1/3)*d) - Log[b^(2/3) - (b*Coth[c + d*x])^(2/3)]/(2*b^(1/3)*d) + Log[b^(4/3) + b^(2/3)*(b*Coth[c + d*x])^(2/3) + (b*Coth[c + d*x])^(4/3)]/(4*b^(1/3)*d)}
{1/(b*Coth[c + d*x])^(2/3), x, 14, -((Sqrt[3]*ArcTan[(b^(1/3) - 2*(b*Coth[c + d*x])^(1/3))/(Sqrt[3]*b^(1/3))])/(2*b^(2/3)*d)) + (Sqrt[3]*ArcTan[(b^(1/3) + 2*(b*Coth[c + d*x])^(1/3))/(Sqrt[3]*b^(1/3))])/(2*b^(2/3)*d) + ArcTanh[(b*Coth[c + d*x])^(1/3)/b^(1/3)]/(b^(2/3)*d) - Log[b^(2/3) - b^(1/3)*(b*Coth[c + d*x])^(1/3) + (b*Coth[c + d*x])^(2/3)]/(4*b^(2/3)*d) + Log[b^(2/3) + b^(1/3)*(b*Coth[c + d*x])^(1/3) + (b*Coth[c + d*x])^(2/3)]/(4*b^(2/3)*d)}
{1/(b*Coth[c + d*x])^(4/3), x, 15, (Sqrt[3]*ArcTan[(b^(1/3) - 2*(b*Coth[c + d*x])^(1/3))/(Sqrt[3]*b^(1/3))])/(2*b^(4/3)*d) - (Sqrt[3]*ArcTan[(b^(1/3) + 2*(b*Coth[c + d*x])^(1/3))/(Sqrt[3]*b^(1/3))])/(2*b^(4/3)*d) + ArcTanh[(b*Coth[c + d*x])^(1/3)/b^(1/3)]/(b^(4/3)*d) - 3/(b*d*(b*Coth[c + d*x])^(1/3)) - Log[b^(2/3) - b^(1/3)*(b*Coth[c + d*x])^(1/3) + (b*Coth[c + d*x])^(2/3)]/(4*b^(4/3)*d) + Log[b^(2/3) + b^(1/3)*(b*Coth[c + d*x])^(1/3) + (b*Coth[c + d*x])^(2/3)]/(4*b^(4/3)*d)}
...
{Sinh[x]^4/(a + b*Coth[x]), x, 8, -(((3*a^2 + 9*a*b + 8*b^2)*Log[1 - Coth[x]])/(16*(a + b)^3)) + ((3*a^2 - 9*a*b + 8*b^2)*Log[1 + Coth[x]])/(16*(a - b)^3) - (b^5*Log[a + b*Coth[x]])/(a^2 - b^2)^3 - ((4*b^3 - a*(7 - (3*a^2)/b^2)*b^2*Coth[x])*Sinh[x]^2)/(8*(a^2 - b^2)^2) - ((b - a*Coth[x])*Sinh[x]^4)/(4*(a^2 - b^2))}
...
{Sinh[x]^2/(a + b*Coth[x]), x, 7, ((a + 2*b)*Log[1 - Coth[x]])/(4*(a + b)^2) - ((a - 2*b)*Log[1 + Coth[x]])/(4*(a - b)^2) - (b^3*Log[a + b*Coth[x]])/(a^2 - b^2)^2 - ((b - a*Coth[x])*Sinh[x]^2)/(2*(a^2 - b^2))}
...
{(1 - Coth[x]^2)^(3/2), x, 3, (1/2)*ArcSin[Coth[x]] + (1/2)*Coth[x]*Sqrt[-Csch[x]^2]}
...
{Coth[x]^5/Sqrt[a + b*Coth[x]^2 + c*Coth[x]^4], x, 11, (b*ArcTanh[(b + 2*c*Coth[x]^2)/(2*Sqrt[c]*Sqrt[a + b*Coth[x]^2 + c*Coth[x]^4])])/(4*c^(3/2)) - ArcTanh[(b + 2*c*Coth[x]^2)/(2*Sqrt[c]*Sqrt[a + b*Coth[x]^2 + c*Coth[x]^4])]/(2*Sqrt[c]) + ArcTanh[(2*a + b + (b + 2*c)*Coth[x]^2)/(2*Sqrt[a + b + c]*Sqrt[a + b*Coth[x]^2 + c*Coth[x]^4])]/(2*Sqrt[a + b + c]) - Sqrt[a + b*Coth[x]^2 + c*Coth[x]^4]/(2*c)}
...
{Csc[Coth[a + b*x]]^1, x, 3, -(Defer[Subst][Defer[Int][Csc[x]/(-1 + x), x], x, Coth[a + b*x]]/(2*b)) + Defer[Subst][Defer[Int][Csc[x]/(1 + x), x], x, Coth[a + b*x]]/(2*b)}
...
{Sec[Coth[a + b*x]]^1, x, 3, -(Defer[Subst][Defer[Int][Sec[x]/(-1 + x), x], x, Coth[a + b*x]]/(2*b)) + Defer[Subst][Defer[Int][Sec[x]/(1 + x), x], x, Coth[a + b*x]]/(2*b)}
