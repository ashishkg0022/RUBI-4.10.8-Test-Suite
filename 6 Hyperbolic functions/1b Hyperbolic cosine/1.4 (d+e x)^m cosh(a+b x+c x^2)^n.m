...
{Cosh[a + b*x + c*x^2]/x, x, 0, Defer[Int][Cosh[a + b*x + c*x^2]/x, x]}
...
{Cosh[1/4 + x + x^2]/x, x, 0, Defer[Int][Cosh[1/4 + x + x^2]/x, x]}
{Cosh[1/4 + x + x^2]/x^2, x, 6, -(Cosh[1/4 + x + x^2]/x) + (1/2)*Sqrt[Pi]*Erf[(1/2)*(-1 - 2*x)] + (1/2)*Sqrt[Pi]*Erfi[(1/2)*(1 + 2*x)] + Defer[Int][Sinh[1/4 + x + x^2]/x, x]}
...
{Cosh[a + b*x + c*x^2]^2/x, x, 2, (1/2)*Defer[Int][Cosh[2*a + 2*b*x + 2*c*x^2]/x, x] + Log[x]/2}
...
{Cosh[1/4 + x + x^2]^2/x, x, 2, (1/2)*Defer[Int][Cosh[1/2 + 2*x + 2*x^2]/x, x] + Log[x]/2}
...
{Cosh[a + b*x + c*x^2]/(d + e*x), x, 0, Defer[Int][Cosh[a + b*x + c*x^2]/(d + e*x), x]}
...
{Cosh[a + b*x + c*x^2]^2/(d + e*x), x, 2, (1/2)*Defer[Int][Cosh[2*a + 2*b*x + 2*c*x^2]/(d + e*x), x] + Log[d + e*x]/(2*e)}
