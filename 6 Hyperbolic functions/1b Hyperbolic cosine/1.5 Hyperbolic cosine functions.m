...
{Sinh[x]^5/(a + a*Cosh[x]), x, 3, Cosh[x]/a - Cosh[x]^2/(2*a) - Cosh[x]^3/(3*a) + Cosh[x]^4/(4*a)}
...
{Csch[x]^3/(a + b*Cosh[x]), x, 7, ((b - a*Cosh[x])*Csch[x]^2)/(2*(a^2 - b^2)) - ((a + 2*b)*Log[1 - Cosh[x]])/(4*(a + b)^2) + ((a - 2*b)*Log[1 + Cosh[x]])/(4*(a - b)^2) + (b^3*Log[a + b*Cosh[x]])/(a^2 - b^2)^2}
...
{Csch[x]^5/(a + b*Cosh[x]), x, 8, ((4*b^3 + a*(3*a^2 - 7*b^2)*Cosh[x])*Csch[x]^2)/(8*(a^2 - b^2)^2) + ((b - a*Cosh[x])*Csch[x]^4)/(4*(a^2 - b^2)) + ((3*a^2 + 9*a*b + 8*b^2)*Log[1 - Cosh[x]])/(16*(a + b)^3) - ((3*a^2 - 9*a*b + 8*b^2)*Log[1 + Cosh[x]])/(16*(a - b)^3) + (b^5*Log[a + b*Cosh[x]])/(a^2 - b^2)^3}
...
{Sinh[x]^8/(a + b*Cosh[x]^2), x, 7, -(((16*a^3 + 56*a^2*b + 70*a*b^2 + 35*b^3)*x)/(16*b^4)) + ((a + b)^(7/2)*ArcTanh[(Sqrt[a]*Tanh[x])/Sqrt[a + b]])/(Sqrt[a]*b^4) + ((8*a^2 + 22*a*b + 19*b^2)*Cosh[x]*Sinh[x])/(16*b^3) - ((6*a + 11*b)*Cosh[x]*Sinh[x]^3)/(24*b^2) + (Cosh[x]*Sinh[x]^5)/(6*b)}
...
{(a + b*Cosh[x]^2)^(3/2), x, 7, -((2*I*(2*a + b)*Sqrt[2*a + b + b*Cosh[2*x]]*EllipticE[I*x, b/(a + b)])/(3*Sqrt[(2*a + b + b*Cosh[2*x])/(a + b)])) + (I*a*(a + b)*Sqrt[(2*a + b + b*Cosh[2*x])/(a + b)]*EllipticF[I*x, b/(a + b)])/(3*Sqrt[2*a + b + b*Cosh[2*x]]) + (b*Sqrt[2*a + b + b*Cosh[2*x]]*Sinh[2*x])/(6*Sqrt[2])}

{(1 + Cosh[x]^2)^(3/2), x, 5, -2*I*Sqrt[2]*EllipticE[I*x, 1/2] + (1/3)*I*Sqrt[2]*EllipticF[I*x, 1/2] + (Sqrt[3 + Cosh[2*x]]*Sinh[2*x])/(6*Sqrt[2])}
{(1 - Cosh[x]^2)^(3/2), x, 4, (2/3)*Coth[x]*Sqrt[-Sinh[x]^2] + (1/3)*Coth[x]*(-Sinh[x]^2)^(3/2)}
{(-1 + Cosh[x]^2)^(3/2), x, 4, (-(2/3))*Coth[x]*Sqrt[Sinh[x]^2] + (1/3)*Coth[x]*(Sinh[x]^2)^(3/2)}
{(-1 - Cosh[x]^2)^(3/2), x, 7, (2*I*Sqrt[2]*Sqrt[-3 - Cosh[2*x]]*EllipticE[I*x, 1/2])/Sqrt[3 + Cosh[2*x]] + (I*Sqrt[2]*Sqrt[3 + Cosh[2*x]]*EllipticF[I*x, 1/2])/(3*Sqrt[-3 - Cosh[2*x]]) - (Sqrt[-3 - Cosh[2*x]]*Sinh[2*x])/(6*Sqrt[2])}
...
{1/(a + b*Cosh[x]^2)^3, x, 4, ((8*a^2 + 8*a*b + 3*b^2)*ArcTanh[(Sqrt[a]*Tanh[x])/Sqrt[a + b]])/(8*a^(5/2)*(a + b)^(5/2)) - (b*Sech[x]^2*Tanh[x])/(4*a*(a + b)*(a + b - a*Tanh[x]^2)^2) - (3*b*(2*a + b)*Tanh[x])/(8*a^2*(a + b)^2*(a + b - a*Tanh[x]^2))}


{1/(1 + Cosh[x]^2), x, 2, ArcTanh[Tanh[x]/Sqrt[2]]/Sqrt[2]}
{1/(1 + Cosh[x]^2)^2, x, 3, (3*ArcTanh[Tanh[x]/Sqrt[2]])/(4*Sqrt[2]) - Tanh[x]/(4*(2 - Tanh[x]^2))}
{1/(1 + Cosh[x]^2)^3, x, 4, (19*ArcTanh[Tanh[x]/Sqrt[2]])/(32*Sqrt[2]) - (Sech[x]^2*Tanh[x])/(8*(2 - Tanh[x]^2)^2) - (9*Tanh[x])/(32*(2 - Tanh[x]^2))}
...
{Tanh[x]/(1 + Cosh[x]^2), x, 5, Log[Cosh[x]] - (1/2)*Log[1 + Cosh[x]^2]}


{Tanh[x]/Sqrt[a + b*Cosh[x]^2], x, 4, -(ArcTanh[Sqrt[a + b*Cosh[x]^2]/Sqrt[a]]/Sqrt[a])}
{Tanh[x]/Sqrt[1 + Cosh[x]^2], x, 4, -ArcTanh[Sqrt[1 + Cosh[x]^2]]}
{Tanh[x]/Sqrt[1 - Cosh[x]^2], x, 2, (ArcTan[Sinh[x]]*Sinh[x])/Sqrt[-Sinh[x]^2]}


{Tanh[x]*Sqrt[a + b*Cosh[x]^2], x, 5, (-Sqrt[a])*ArcTanh[Sqrt[a + b*Cosh[x]^2]/Sqrt[a]] + Sqrt[a + b*Cosh[x]^2]}
...
{Sinh[x]/(4 - 3*Cosh[x]^3), x, 8, ArcTan[(1 + 6^(1/3)*Cosh[x])/Sqrt[3]]/(2*2^(1/3)*3^(5/6)) - Log[2^(2/3) - 3^(1/3)*Cosh[x]]/(6*6^(1/3)) + Log[2*2^(1/3) + 2^(2/3)*3^(1/3)*Cosh[x] + 3^(2/3)*Cosh[x]^2]/(12*6^(1/3))}
...
{Tanh[x]^3/(a + b*Cosh[x]^3), x, 12, -((b^(2/3)*ArcTan[(a^(1/3) - 2*b^(1/3)*Cosh[x])/(Sqrt[3]*a^(1/3))])/(Sqrt[3]*a^(5/3))) + Log[Cosh[x]]/a + (b^(2/3)*Log[a^(1/3) + b^(1/3)*Cosh[x]])/(3*a^(5/3)) - (b^(2/3)*Log[a^(2/3) - a^(1/3)*b^(1/3)*Cosh[x] + b^(2/3)*Cosh[x]^2])/(6*a^(5/3)) - Log[a + b*Cosh[x]^3]/(3*a) + Sech[x]^2/(2*a)}
...
{1/(a + b*Cosh[x]^4), x, 5, -(ArcTanh[((-a)^(1/4)*Tanh[x])/Sqrt[Sqrt[-a] - Sqrt[b]]]/(2*(-a)^(3/4)*Sqrt[Sqrt[-a] - Sqrt[b]])) - ArcTanh[((-a)^(1/4)*Tanh[x])/Sqrt[Sqrt[-a] + Sqrt[b]]]/(2*(-a)^(3/4)*Sqrt[Sqrt[-a] + Sqrt[b]])}
...
{1/(1 + Cosh[x]^5), x, 11, If[$VersionNumber<9, -((2*ArcTan[Tanh[x/2]/Sqrt[-((1 - (-1)^(1/5))/(1 + (-1)^(1/5)))]])/(5*Sqrt[-1 + (-1)^(2/5)])) + (2*ArcTan[Sqrt[-((1 - (-1)^(2/5))/(1 + (-1)^(2/5)))]*Tanh[x/2]])/(5*Sqrt[-1 + (-1)^(4/5)]) - (2*Sqrt[-((1 + (-1)^(3/5))/(1 - (-1)^(3/5)))]*ArcTan[Sqrt[-((1 + (-1)^(3/5))/(1 - (-1)^(3/5)))]*Tanh[x/2]])/(5*(1 + (-1)^(3/5))) - (2*ArcTan[Tanh[x/2]/Sqrt[-((1 + (-1)^(4/5))/(1 - (-1)^(4/5)))]])/(5*Sqrt[-1 - (-1)^(3/5)]) + Sinh[x]/(5*(1 + Cosh[x])), -((2*ArcTan[Tanh[x/2]/Sqrt[-((1 - (-1)^(1/5))/(1 + (-1)^(1/5)))]])/(5*Sqrt[-1 + (-1)^(2/5)])) - (2*Sqrt[-((1 + (-1)^(3/5))/(1 - (-1)^(3/5)))]*ArcTan[Sqrt[-((1 + (-1)^(3/5))/(1 - (-1)^(3/5)))]*Tanh[x/2]])/(5*(1 + (-1)^(3/5))) + (2*ArcTanh[Sqrt[(1 - (-1)^(2/5))/(1 + (-1)^(2/5))]*Tanh[x/2]])/(5*Sqrt[1 - (-1)^(4/5)]) + (2*ArcTanh[Sqrt[(1 - (-1)^(4/5))/(1 + (-1)^(4/5))]*Tanh[x/2]])/(5*Sqrt[1 + (-1)^(3/5)]) + Sinh[x]/(5*(1 + Cosh[x]))]}
...
{1/(1 - Cosh[x]^5), x, 11, If[$VersionNumber<9, (2*ArcTan[Sqrt[-((1 - (-1)^(1/5))/(1 + (-1)^(1/5)))]*Tanh[x/2]])/(5*Sqrt[-1 + (-1)^(2/5)]) - (2*ArcTan[Tanh[x/2]/Sqrt[-((1 - (-1)^(2/5))/(1 + (-1)^(2/5)))]])/(5*Sqrt[-1 + (-1)^(4/5)]) + (2*Sqrt[-((1 + (-1)^(3/5))/(1 - (-1)^(3/5)))]*ArcTan[Tanh[x/2]/Sqrt[-((1 + (-1)^(3/5))/(1 - (-1)^(3/5)))]])/(5*(1 + (-1)^(3/5))) + (2*ArcTan[Sqrt[-((1 + (-1)^(4/5))/(1 - (-1)^(4/5)))]*Tanh[x/2]])/(5*Sqrt[-1 - (-1)^(3/5)]) - Sinh[x]/(5*(1 - Cosh[x])), (2*ArcTan[Sqrt[-((1 - (-1)^(1/5))/(1 + (-1)^(1/5)))]*Tanh[x/2]])/(5*Sqrt[-1 + (-1)^(2/5)]) + (2*ArcTan[Sqrt[-((1 + (-1)^(4/5))/(1 - (-1)^(4/5)))]*Tanh[x/2]])/(5*Sqrt[-1 - (-1)^(3/5)]) + (2*ArcTanh[Tanh[x/2]/Sqrt[(1 - (-1)^(2/5))/(1 + (-1)^(2/5))]])/(5*Sqrt[1 - (-1)^(4/5)]) + (2*ArcTanh[Sqrt[(1 - (-1)^(3/5))/(1 + (-1)^(3/5))]*Tanh[x/2]])/(5*Sqrt[1 + (-1)^(1/5)]) - Sinh[x]/(5*(1 - Cosh[x]))]}
...
{(A + B*Coth[x])/(a + b*Cosh[x]), x, 10, (2*A*ArcTanh[(Sqrt[a - b]*Tanh[x/2])/Sqrt[a + b]])/(Sqrt[a - b]*Sqrt[a + b]) + (B*Log[1 - Cosh[x]])/(2*(a + b)) + (B*Log[1 + Cosh[x]])/(2*(a - b)) - (a*B*Log[a + b*Cosh[x]])/(a^2 - b^2)}
...
{1/(Cosh[Sqrt[1 - a*x]/Sqrt[1 + a*x]]^1*(1 - a^2*x^2)), x, 1, -(Defer[Subst][Defer[Int][Sech[x]/x, x], x, Sqrt[1 - a*x]/Sqrt[1 + a*x]]/a)}
{1/(Cosh[Sqrt[1 - a*x]/Sqrt[1 + a*x]]^2*(1 - a^2*x^2)), x, 1, -(Defer[Subst][Defer[Int][Sech[x]^2/x, x], x, Sqrt[1 - a*x]/Sqrt[1 + a*x]]/a)}
...
{(x^m*Sinh[c + d*x])/(a + b*Cosh[c + d*x]), x, 0, Defer[Int][(x^m*Sinh[c + d*x])/(a + b*Cosh[c + d*x]), x]}
...
{Sinh[c + d*x]/(x*(a + b*Cosh[c + d*x])), x, 0, Defer[Int][Sinh[c + d*x]/(x*(a + b*Cosh[c + d*x])), x]}


{(x^m*Sinh[c + d*x]^2)/(a + b*Cosh[c + d*x]), x, 0, Defer[Int][(x^m*Sinh[c + d*x]^2)/(a + b*Cosh[c + d*x]), x]}
...
{Sinh[c + d*x]^2/(x*(a + b*Cosh[c + d*x])), x, 0, Defer[Int][Sinh[c + d*x]^2/(x*(a + b*Cosh[c + d*x])), x]}


{(x^m*Sinh[c + d*x]^3)/(a + b*Cosh[c + d*x]), x, 0, Defer[Int][(x^m*Sinh[c + d*x]^3)/(a + b*Cosh[c + d*x]), x]}
...
{Sinh[c + d*x]^3/(x*(a + b*Cosh[c + d*x])), x, 0, Defer[Int][Sinh[c + d*x]^3/(x*(a + b*Cosh[c + d*x])), x]}
...
{Cosh[a + 2/n*Log[c*x^n]]^(5/2), x, 7, (5/16)*x*Sqrt[Cosh[a + (2*Log[c*x^n])/n]] - (5*x*ArcTanh[Sqrt[1 + E^(2*a)*(c*x^n)^(4/n)]]*Sqrt[Cosh[a + (2*Log[c*x^n])/n]])/(16*Sqrt[1 + E^(2*a)*(c*x^n)^(4/n)]) - (1/24)*x*Cosh[a + (2*Log[c*x^n])/n]^(5/2) + (5/24)*x*Cosh[a + (2*Log[c*x^n])/n]^(3/2)*Sinh[a + (2*Log[c*x^n])/n]}
{Sqrt[Cosh[a + 2/n*Log[c*x^n]]], x, 6, (1/2)*x*Sqrt[Cosh[a + (2*Log[c*x^n])/n]] - (x*ArcTanh[Sqrt[1 + E^(2*a)*(c*x^n)^(4/n)]]*Sqrt[Cosh[a + (2*Log[c*x^n])/n]])/(2*Sqrt[1 + E^(2*a)*(c*x^n)^(4/n)])}
...
{E^x*Sech[2*x], x, 13, -(ArcTan[1 - Sqrt[2]*E^x]/Sqrt[2]) + ArcTan[1 + Sqrt[2]*E^x]/Sqrt[2] + Log[1 - Sqrt[2]*E^x + E^(2*x)]/(2*Sqrt[2]) - Log[1 + Sqrt[2]*E^x + E^(2*x)]/(2*Sqrt[2])}
{E^x*Sech[2*x]^2, x, 14, -(E^x/(1 + E^(4*x))) - ArcTan[1 - Sqrt[2]*E^x]/(2*Sqrt[2]) + ArcTan[1 + Sqrt[2]*E^x]/(2*Sqrt[2]) - Log[1 - Sqrt[2]*E^x + E^(2*x)]/(4*Sqrt[2]) + Log[1 + Sqrt[2]*E^x + E^(2*x)]/(4*Sqrt[2])}


{E^x*Cosh[3*x]^2, x, 4, -(1/20)/E^(5*x) + E^x/2 + E^(7*x)/28}
{E^x*Cosh[3*x], x, 4, -(1/4)/E^(2*x) + E^(4*x)/8}
{E^x*Sech[3*x], x, 10, -(ArcTan[(1 - 2*E^(2*x))/Sqrt[3]]/Sqrt[3]) - (1/3)*Log[1 + E^(2*x)] + (1/6)*Log[1 - E^(2*x) + E^(4*x)]}
{E^x*Sech[3*x]^2, x, 15, -((2*E^x)/(3*(1 + E^(6*x)))) + (2*ArcTan[E^x])/9 - (1/9)*ArcTan[Sqrt[3] - 2*E^x] + (1/9)*ArcTan[Sqrt[3] + 2*E^x] - Log[1 - Sqrt[3]*E^x + E^(2*x)]/(6*Sqrt[3]) + Log[1 + Sqrt[3]*E^x + E^(2*x)]/(6*Sqrt[3])}


{E^x*Cosh[4*x]^2, x, 4, -(1/28)/E^(7*x) + E^x/2 + E^(9*x)/36}
{E^x*Cosh[4*x], x, 4, -(1/6)/E^(3*x) + E^(5*x)/10}
{E^x*Sech[4*x], x, 25, ArcTan[(Sqrt[2 - Sqrt[2]] - 2*E^x)/Sqrt[2 + Sqrt[2]]]/(2*Sqrt[2*(2 + Sqrt[2])]) - ArcTan[(Sqrt[2 + Sqrt[2]] - 2*E^x)/Sqrt[2 - Sqrt[2]]]/(2*Sqrt[2*(2 - Sqrt[2])]) - ArcTan[(Sqrt[2 - Sqrt[2]] + 2*E^x)/Sqrt[2 + Sqrt[2]]]/(2*Sqrt[2*(2 + Sqrt[2])]) + ArcTan[(Sqrt[2 + Sqrt[2]] + 2*E^x)/Sqrt[2 - Sqrt[2]]]/(2*Sqrt[2*(2 - Sqrt[2])]) - Log[1 - Sqrt[2 - Sqrt[2]]*E^x + E^(2*x)]/(4*Sqrt[2*(2 - Sqrt[2])]) + Log[1 + Sqrt[2 - Sqrt[2]]*E^x + E^(2*x)]/(4*Sqrt[2*(2 - Sqrt[2])]) + Log[1 - Sqrt[2 + Sqrt[2]]*E^x + E^(2*x)]/(4*Sqrt[2*(2 + Sqrt[2])]) - Log[1 + Sqrt[2 + Sqrt[2]]*E^x + E^(2*x)]/(4*Sqrt[2*(2 + Sqrt[2])])}
{E^x*Sech[4*x]^2, x, 26, -(E^x/(2*(1 + E^(8*x)))) - ArcTan[(Sqrt[2 - Sqrt[2]] - 2*E^x)/Sqrt[2 + Sqrt[2]]]/(8*Sqrt[2*(2 - Sqrt[2])]) - ArcTan[(Sqrt[2 + Sqrt[2]] - 2*E^x)/Sqrt[2 - Sqrt[2]]]/(8*Sqrt[2*(2 + Sqrt[2])]) + ArcTan[(Sqrt[2 - Sqrt[2]] + 2*E^x)/Sqrt[2 + Sqrt[2]]]/(8*Sqrt[2*(2 - Sqrt[2])]) + ArcTan[(Sqrt[2 + Sqrt[2]] + 2*E^x)/Sqrt[2 - Sqrt[2]]]/(8*Sqrt[2*(2 + Sqrt[2])]) - (1/32)*Sqrt[2 - Sqrt[2]]*Log[1 - Sqrt[2 - Sqrt[2]]*E^x + E^(2*x)] + (1/32)*Sqrt[2 - Sqrt[2]]*Log[1 + Sqrt[2 - Sqrt[2]]*E^x + E^(2*x)] - (1/32)*Sqrt[2 + Sqrt[2]]*Log[1 - Sqrt[2 + Sqrt[2]]*E^x + E^(2*x)] + (1/32)*Sqrt[2 + Sqrt[2]]*Log[1 + Sqrt[2 + Sqrt[2]]*E^x + E^(2*x)]}
