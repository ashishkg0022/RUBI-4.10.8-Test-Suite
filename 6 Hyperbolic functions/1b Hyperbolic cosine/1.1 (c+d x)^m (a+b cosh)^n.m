...
{Sech[a + b*x]/(c + d*x), x, 0, Defer[Int][Sech[a + b*x]/(c + d*x), x]}
{Sech[a + b*x]/(c + d*x)^2, x, 0, Defer[Int][Sech[a + b*x]/(c + d*x)^2, x]}
...
{Sech[a + b*x]^2/(c + d*x), x, 0, Defer[Int][Sech[a + b*x]^2/(c + d*x), x]}
{Sech[a + b*x]^2/(c + d*x)^2, x, 0, Defer[Int][Sech[a + b*x]^2/(c + d*x)^2, x]}
...
{Sech[a + b*x]^3/(c + d*x), x, 0, Defer[Int][Sech[a + b*x]^3/(c + d*x), x]}
{Sech[a + b*x]^3/(c + d*x)^2, x, 0, Defer[Int][Sech[a + b*x]^3/(c + d*x)^2, x]}
...
{Sqrt[c + d*x]*Sech[a + b*x], x, 0, Defer[Int][Sqrt[c + d*x]*Sech[a + b*x], x]}
{Sech[a + b*x]/Sqrt[c + d*x], x, 0, Defer[Int][Sech[a + b*x]/Sqrt[c + d*x], x]}
...
{Cosh[x]^(3/2)/x^3, x, 1, -Cosh[x]^(3/2)/(2*x^2) - (3*Sqrt[Cosh[x]]*Sinh[x])/(4*x) - (3*Defer[Int][1/(x*Sqrt[Cosh[x]]), x])/8 + (9*Defer[Int][Cosh[x]^(3/2)/x, x])/8}
...
{(c + d*x)^m*(b*Cosh[e + f*x])^n, x, 0, Defer[Int][(c + d*x)^m*(b*Cosh[e + f*x])^n, x]}
...
{(c + d*x)^m*Sech[a + b*x], x, 0, Defer[Int][(c + d*x)^m*Sech[a + b*x], x]}
{(c + d*x)^m*Sech[a + b*x]^2, x, 0, Defer[Int][(c + d*x)^m*Sech[a + b*x]^2, x]}
...
{1/((c + d*x)*(a + a*Cosh[e + f*x])), x, 1, Defer[Int][Sech[e/2 + (f*x)/2]^2/(c + d*x), x]/(2*a)}
{1/((c + d*x)^2*(a + a*Cosh[e + f*x])), x, 1, Defer[Int][Sech[e/2 + (f*x)/2]^2/(c + d*x)^2, x]/(2*a)}
...
{1/((c + d*x)*(a + a*Cosh[e + f*x])^2), x, 1, Defer[Int][Sech[e/2 + (f*x)/2]^4/(c + d*x), x]/(4*a^2)}
{1/((c + d*x)^2*(a + a*Cosh[e + f*x])^2), x, 1, Defer[Int][Sech[e/2 + (f*x)/2]^4/(c + d*x)^2, x]/(4*a^2)}
...
{1/(x*Sqrt[a + a*Cosh[c + d*x]]), x, 0, Defer[Int][1/(x*Sqrt[a + a*Cosh[c + d*x]]), x]}
{1/(x^2*Sqrt[a + a*Cosh[c + d*x]]), x, 0, Defer[Int][1/(x^2*Sqrt[a + a*Cosh[c + d*x]]), x]}
...
{1/(x*(a + a*Cosh[x])^(3/2)), x, 0, Defer[Int][1/(x*(a + a*Cosh[x])^(3/2)), x]}
{1/(x^2*(a + a*Cosh[x])^(3/2)), x, 0, Defer[Int][1/(x^2*(a + a*Cosh[x])^(3/2)), x]}
...
(* Used to hang Rubi *)
{(a + a*Cosh[c + d*x])^(1/3)/x, x, 0, Defer[Int][(a + a*Cosh[c + d*x])^(1/3)/x, x]}
...
{(c + d*x)^m*(a + a*Cosh[e + f*x])^n, x, 0, Defer[Int][(c + d*x)^m*(a + a*Cosh[e + f*x])^n, x]}
...
{(c + d*x)^m/(a + a*Cosh[e + f*x]), x, 1, Defer[Int][(c + d*x)^m*Sech[e/2 + (f*x)/2]^2, x]/(2*a)}
{(c + d*x)^m/(a + a*Cosh[e + f*x])^2, x, 1, Defer[Int][(c + d*x)^m*Sech[e/2 + (f*x)/2]^4, x]/(4*a^2)}
...
{1/((c + d*x)*(a + b*Cosh[e + f*x])), x, 0, Defer[Int][1/((c + d*x)*(a + b*Cosh[e + f*x])), x]}
{1/((c + d*x)^2*(a + b*Cosh[e + f*x])), x, 0, Defer[Int][1/((c + d*x)^2*(a + b*Cosh[e + f*x])), x]}
...
{1/((c + d*x)*(a + b*Cosh[e + f*x])^2), x, 0, Defer[Int][1/((c + d*x)*(a + b*Cosh[e + f*x])^2), x]}
{1/((c + d*x)^2*(a + b*Cosh[e + f*x])^2), x, 0, Defer[Int][1/((c + d*x)^2*(a + b*Cosh[e + f*x])^2), x]}
...
{(c + d*x)^m*(a + b*Cosh[e + f*x])^n, x, 0, Defer[Int][(c + d*x)^m*(a + b*Cosh[e + f*x])^n, x]}
...
{(c + d*x)^m/(a + b*Cosh[e + f*x]), x, 0, Defer[Int][(c + d*x)^m/(a + b*Cosh[e + f*x]), x]}
{(c + d*x)^m/(a + b*Cosh[e + f*x])^2, x, 0, Defer[Int][(c + d*x)^m/(a + b*Cosh[e + f*x])^2, x]}
