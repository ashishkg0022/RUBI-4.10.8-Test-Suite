...
{Cosh[a + b*x^2]^2/x^3, x, 7, -(1/(4*x^2)) - Cosh[2*a + 2*b*x^2]/(4*x^2) + (1/2)*b*CoshIntegral[2*b*x^2]*Sinh[2*a] + (1/2)*b*Cosh[2*a]*SinhIntegral[2*b*x^2]}
...
{Cosh[a + b*x^2]^3/x^3, x, 12, -((3*Cosh[a + b*x^2])/(8*x^2)) - Cosh[3*a + 3*b*x^2]/(8*x^2) + (3/8)*b*CoshIntegral[b*x^2]*Sinh[a] + (3/8)*b*CoshIntegral[3*b*x^2]*Sinh[3*a] + (3/8)*b*Cosh[a]*SinhIntegral[b*x^2] + (3/8)*b*Cosh[3*a]*SinhIntegral[3*b*x^2]}
...
{Cosh[a + b*x^n]^2/x^(n + 1), x, 7, -(1/(x^n*(2*n))) - Cosh[2*a + 2*b*x^n]/(x^n*(2*n)) + (b*CoshIntegral[2*b*x^n]*Sinh[2*a])/n + (b*Cosh[2*a]*SinhIntegral[2*b*x^n])/n}
{Cosh[a + b*x^n]^3/x^(n + 1), x, 12, -((3*Cosh[a + b*x^n])/(x^n*(4*n))) - Cosh[3*a + 3*b*x^n]/(x^n*(4*n)) + (3*b*CoshIntegral[b*x^n]*Sinh[a])/(4*n) + (3*b*CoshIntegral[3*b*x^n]*Sinh[3*a])/(4*n) + (3*b*Cosh[a]*SinhIntegral[b*x^n])/(4*n) + (3*b*Cosh[3*a]*SinhIntegral[3*b*x^n])/(4*n)}
...
{Cosh[(a + b*x)^2]/x^1, x, 1, Defer[Subst][Defer[Int][Cosh[x^2]/(-a + x), x], x, a + b*x]}
{Cosh[(a + b*x)^2]/x^2, x, 1, Defer[Int][Cosh[(a + b*x)^2]/x^2, x], b*Defer[Subst][Defer[Int][Cosh[x^2]/(-a + x)^2, x], x, a + b*x]}
...
{Cosh[a + b*Sqrt[c + d*x]]/x^1, x, 10, Cosh[a + b*Sqrt[c]]*CoshIntegral[b*Sqrt[c] - b*Sqrt[c + d*x]] + Cosh[a - b*Sqrt[c]]*CoshIntegral[b*Sqrt[c] + b*Sqrt[c + d*x]] - Sinh[a + b*Sqrt[c]]*SinhIntegral[b*Sqrt[c] - b*Sqrt[c + d*x]] + Sinh[a - b*Sqrt[c]]*SinhIntegral[b*Sqrt[c] + b*Sqrt[c + d*x]]}
{Cosh[a + b*Sqrt[c + d*x]]/x^2, x, 11, -(Cosh[a + b*Sqrt[c + d*x]]/x) - (b*d*CoshIntegral[b*Sqrt[c] + b*Sqrt[c + d*x]]*Sinh[a - b*Sqrt[c]])/(2*Sqrt[c]) + (b*d*CoshIntegral[b*Sqrt[c] - b*Sqrt[c + d*x]]*Sinh[a + b*Sqrt[c]])/(2*Sqrt[c]) - (b*d*Cosh[a + b*Sqrt[c]]*SinhIntegral[b*Sqrt[c] - b*Sqrt[c + d*x]])/(2*Sqrt[c]) - (b*d*Cosh[a - b*Sqrt[c]]*SinhIntegral[b*Sqrt[c] + b*Sqrt[c + d*x]])/(2*Sqrt[c])}
...
{Cosh[a + b*(c + d*x)^(1/3)]/x^1, x, 13, Cosh[a + b*c^(1/3)]*CoshIntegral[b*c^(1/3) - b*(c + d*x)^(1/3)] + Cosh[a + (-1)^(2/3)*b*c^(1/3)]*CoshIntegral[(-1)^(2/3)*b*c^(1/3) - b*(c + d*x)^(1/3)] + Cosh[a - (-1)^(1/3)*b*c^(1/3)]*CoshIntegral[(-1)^(1/3)*b*c^(1/3) + b*(c + d*x)^(1/3)] - Sinh[a + b*c^(1/3)]*SinhIntegral[b*c^(1/3) - b*(c + d*x)^(1/3)] - Sinh[a + (-1)^(2/3)*b*c^(1/3)]*SinhIntegral[(-1)^(2/3)*b*c^(1/3) - b*(c + d*x)^(1/3)] + Sinh[a - (-1)^(1/3)*b*c^(1/3)]*SinhIntegral[(-1)^(1/3)*b*c^(1/3) + b*(c + d*x)^(1/3)]}
{Cosh[a + b*(c + d*x)^(1/3)]/x^2, x, 14, -(Cosh[a + b*(c + d*x)^(1/3)]/x) + (b*d*CoshIntegral[b*c^(1/3) - b*(c + d*x)^(1/3)]*Sinh[a + b*c^(1/3)])/(3*c^(2/3)) - ((-1)^(1/3)*b*d*CoshIntegral[(-1)^(1/3)*b*c^(1/3) + b*(c + d*x)^(1/3)]*Sinh[a - (-1)^(1/3)*b*c^(1/3)])/(3*c^(2/3)) + ((-1)^(2/3)*b*d*CoshIntegral[(-1)^(2/3)*b*c^(1/3) - b*(c + d*x)^(1/3)]*Sinh[a + (-1)^(2/3)*b*c^(1/3)])/(3*c^(2/3)) - (b*d*Cosh[a + b*c^(1/3)]*SinhIntegral[b*c^(1/3) - b*(c + d*x)^(1/3)])/(3*c^(2/3)) - ((-1)^(2/3)*b*d*Cosh[a + (-1)^(2/3)*b*c^(1/3)]*SinhIntegral[(-1)^(2/3)*b*c^(1/3) - b*(c + d*x)^(1/3)])/(3*c^(2/3)) - ((-1)^(1/3)*b*d*Cosh[a - (-1)^(1/3)*b*c^(1/3)]*SinhIntegral[(-1)^(1/3)*b*c^(1/3) + b*(c + d*x)^(1/3)])/(3*c^(2/3))}
