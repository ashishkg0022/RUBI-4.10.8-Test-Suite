...
{Sinh[a + b*x + c*x^2]/x, x, 0, Defer[Int][Sinh[a + b*x + c*x^2]/x, x]}
...
{Sinh[1/4 + x + x^2]/x, x, 0, Defer[Int][Sinh[1/4 + x + x^2]/x, x]}
{Sinh[1/4 + x + x^2]/x^2, x, 6, (-(1/2))*Sqrt[Pi]*Erf[(1/2)*(-1 - 2*x)] + (1/2)*Sqrt[Pi]*Erfi[(1/2)*(1 + 2*x)] + Defer[Int][Cosh[1/4 + x + x^2]/x, x] - Sinh[1/4 + x + x^2]/x}
...
{Sinh[a + b*x + c*x^2]^2/x, x, 2, (1/2)*Defer[Int][Cosh[2*a + 2*b*x + 2*c*x^2]/x, x] - Log[x]/2}
...
{Sinh[1/4 + x + x^2]^2/x, x, 2, (1/2)*Defer[Int][Cosh[1/2 + 2*x + 2*x^2]/x, x] - Log[x]/2}
...
{Sinh[a + b*x + c*x^2]/(d + e*x), x, 0, Defer[Int][Sinh[a + b*x + c*x^2]/(d + e*x), x]}
...
{Sinh[a + b*x + c*x^2]^2/(d + e*x), x, 2, (1/2)*Defer[Int][Cosh[2*a + 2*b*x + 2*c*x^2]/(d + e*x), x] - Log[d + e*x]/(2*e)}
