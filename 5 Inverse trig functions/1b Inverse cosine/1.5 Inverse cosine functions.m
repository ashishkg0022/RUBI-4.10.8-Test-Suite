...
(* ::Subsection:: *)
(*Integrands of the form (f+g x)^m (d-c^2 d x^2)^p (a+b ArcCos[c x])^1*)
...
{Log[h*(f + g*x)^m]*(a + b*ArcCos[c*x])^n/Sqrt[1 - c^2*x^2], x, 0, Defer[Int][((a + b*ArcCos[c*x])^n*Log[h*(f + g*x)^m])/Sqrt[1 - c^2*x^2], x]}
...
{Log[h*(f + g*x)^m]/(a + b*ArcCos[c*x])^1/Sqrt[1 - c^2*x^2], x, 0, Defer[Int][Log[h*(f + g*x)^m]/(Sqrt[1 - c^2*x^2]*(a + b*ArcCos[c*x])), x]}
...
{(d + e*x^2)*(a + b*ArcCos[c*x])/x^1, x, 13, -((b*e*x*Sqrt[1 - c^2*x^2])/(4*c)) + (1/2)*e*x^2*(a + b*ArcCos[c*x]) + (b*e*ArcSin[c*x])/(4*c^2) + (1/2)*I*b*d*ArcSin[c*x]^2 - b*d*ArcSin[c*x]*Log[1 - E^(2*I*ArcSin[c*x])] + d*(a + b*ArcCos[c*x])*Log[x] + b*d*ArcSin[c*x]*Log[x] + (1/2)*I*b*d*PolyLog[2, E^(2*I*ArcSin[c*x])]}
{(d + e*x^2)*(a + b*ArcCos[c*x])/x^2, x, 5, -((b*e*Sqrt[1 - c^2*x^2])/c) - (d*(a + b*ArcCos[c*x]))/x + e*x*(a + b*ArcCos[c*x]) + b*c*d*ArcTanh[Sqrt[1 - c^2*x^2]]}
{(d + e*x^2)*(a + b*ArcCos[c*x])/x^3, x, 11, (b*c*d*Sqrt[1 - c^2*x^2])/(2*x) - (d*(a + b*ArcCos[c*x]))/(2*x^2) + (1/2)*I*b*e*ArcSin[c*x]^2 - b*e*ArcSin[c*x]*Log[1 - E^(2*I*ArcSin[c*x])] + e*(a + b*ArcCos[c*x])*Log[x] + b*e*ArcSin[c*x]*Log[x] + (1/2)*I*b*e*PolyLog[2, E^(2*I*ArcSin[c*x])]}
...
{ArcCos[a*x]*(c + d*x^2)^(1/2), x, 0, Defer[Int][Sqrt[c + d*x^2]*ArcCos[a*x], x]}
...
{ArcCos[a*x]/(c + d*x^2)^(1/2), x, 0, Defer[Int][ArcCos[a*x]/Sqrt[c + d*x^2], x]}


{ArcCos[a*x]/(c + d*x^2)^(3/2), x, 5, (x*ArcCos[a*x])/(c*Sqrt[c + d*x^2]) - ArcTan[(Sqrt[d]*Sqrt[1 - a^2*x^2])/(a*Sqrt[c + d*x^2])]/(c*Sqrt[d])}


{ArcCos[a*x]/(c + d*x^2)^(5/2), x, 6, -((a*Sqrt[1 - a^2*x^2])/(3*c*(a^2*c + d)*Sqrt[c + d*x^2])) + (x*ArcCos[a*x])/(3*c*(c + d*x^2)^(3/2)) + (2*x*ArcCos[a*x])/(3*c^2*Sqrt[c + d*x^2]) - (2*ArcTan[(Sqrt[d]*Sqrt[1 - a^2*x^2])/(a*Sqrt[c + d*x^2])])/(3*c^2*Sqrt[d])}


{ArcCos[a*x]/(c + d*x^2)^(7/2), x, 10, -((a*Sqrt[1 - a^2*x^2])/(15*c*(a^2*c + d)*(c + d*x^2)^(3/2))) + (16*a*(2*a^2*c + 3*d)*Sqrt[1 - a^2*x^2])/(45*c^2*(a^2*c + d)^2*Sqrt[c + d*x^2]) - (2*a*(5*a^2*c + 6*d)*Sqrt[1 - a^2*x^2])/(9*c^2*(a^2*c + d)^2*Sqrt[c + d*x^2]) + (x*ArcCos[a*x])/(5*c*(c + d*x^2)^(5/2)) + (4*x*ArcCos[a*x])/(15*c^2*(c + d*x^2)^(3/2)) + (8*x*ArcCos[a*x])/(15*c^3*Sqrt[c + d*x^2]) - (8*ArcTan[(Sqrt[d]*Sqrt[1 - a^2*x^2])/(a*Sqrt[c + d*x^2])])/(15*c^3*Sqrt[d])}
...
{x^2*ArcCos[a + b*x], x, 5, -((x^2*Sqrt[1 - (a + b*x)^2])/(9*b)) - ((4*(1 + 4*a^2) - 5*a*(a + b*x))*Sqrt[1 - (a + b*x)^2])/(18*b^3) + (1/3)*x^3*ArcCos[a + b*x] - (a*(3 + 2*a^2)*ArcSin[a + b*x])/(6*b^3)}
...
{(a + b*ArcCos[Sqrt[1 - c*x]/Sqrt[1 + c*x]])^n/(1 - c^2*x^2), x, 1, -(Subst[Int[(a + b*ArcCos[x])^n/x, x], x, Sqrt[1 - c*x]/Sqrt[1 + c*x]]/c)}
...
{1/((a + b*ArcCos[Sqrt[1 - c*x]/Sqrt[1 + c*x]])^1*(1 - c^2*x^2)), x, 1, -(Subst[Int[1/(x*(a + b*ArcCos[x])), x], x, Sqrt[1 - c*x]/Sqrt[1 + c*x]]/c)}
{1/((a + b*ArcCos[Sqrt[1 - c*x]/Sqrt[1 + c*x]])^2*(1 - c^2*x^2)), x, 1, -(Subst[Int[1/(x*(a + b*ArcCos[x])^2), x], x, Sqrt[1 - c*x]/Sqrt[1 + c*x]]/c)}
