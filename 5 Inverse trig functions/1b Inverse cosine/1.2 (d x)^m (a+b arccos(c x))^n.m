...
{1/(x*ArcCos[a*x]), x, 0, Defer[Int][1/(x*ArcCos[a*x]), x]}
{1/(x^2*ArcCos[a*x]), x, 0, Defer[Int][1/(x^2*ArcCos[a*x]), x]}
...
{1/(x*ArcCos[a*x]^2), x, 0, Defer[Int][1/(x*ArcCos[a*x]^2), x]}
{1/(x^2*ArcCos[a*x]^2), x, 0, Defer[Int][1/(x^2*ArcCos[a*x]^2), x]}
...
{1/(x*ArcCos[a*x]^3), x, 0, Defer[Int][1/(x*ArcCos[a*x]^3), x]}
{1/(x^2*ArcCos[a*x]^3), x, 0, Defer[Int][1/(x^2*ArcCos[a*x]^3), x]}
...
{1/(x*ArcCos[a*x]^4), x, 0, Defer[Int][1/(x*ArcCos[a*x]^4), x]}
{1/(x^2*ArcCos[a*x]^4), x, 0, Defer[Int][1/(x^2*ArcCos[a*x]^4), x]}
...
{Sqrt[ArcCos[a*x]]/x, x, 0, Defer[Int][Sqrt[ArcCos[a*x]]/x, x]}
...
{ArcCos[a*x]^(3/2)/x, x, 0, Defer[Int][ArcCos[a*x]^(3/2)/x, x]}
...
{ArcCos[a*x]^(5/2)/x, x, 0, Defer[Int][ArcCos[a*x]^(5/2)/x, x]}
...
{1/(x*Sqrt[ArcCos[a*x]]), x, 0, Defer[Int][1/(x*Sqrt[ArcCos[a*x]]), x]}
{1/(x^2*Sqrt[ArcCos[a*x]]), x, 0, Defer[Int][1/(x^2*Sqrt[ArcCos[a*x]]), x]}
...
{1/(x*ArcCos[a*x]^(3/2)), x, 0, Defer[Int][1/(x*ArcCos[a*x]^(3/2)), x]}
...
{1/(x*ArcCos[a*x]^(5/2)), x, 0, Defer[Int][1/(x*ArcCos[a*x]^(5/2)), x]}
...
{1/(x*ArcCos[a*x]^(7/2)), x, 0, Defer[Int][1/(x*ArcCos[a*x]^(7/2)), x]}
...
{(b*x)^m*ArcCos[a*x]^4, x, 1, ((b*x)^(1 + m)*ArcCos[a*x]^4)/(b*(1 + m)) + (4*a*Defer[Int][((b*x)^(1 + m)*ArcCos[a*x]^3)/Sqrt[1 - a^2*x^2], x])/(b*(1 + m))}
{(b*x)^m*ArcCos[a*x]^3, x, 1, ((b*x)^(1 + m)*ArcCos[a*x]^3)/(b*(1 + m)) + (3*a*Defer[Int][((b*x)^(1 + m)*ArcCos[a*x]^2)/Sqrt[1 - a^2*x^2], x])/(b*(1 + m))}
...
{(b*x)^m/ArcCos[a*x], x, 0, Defer[Int][(b*x)^m/ArcCos[a*x], x]}
{(b*x)^m/ArcCos[a*x]^2, x, 0, Defer[Int][(b*x)^m/ArcCos[a*x]^2, x]}


{(b*x)^m*ArcCos[a*x]^(3/2), x, 0, Defer[Int][(b*x)^m*ArcCos[a*x]^(3/2), x]}
{(b*x)^m*Sqrt[ArcCos[a*x]], x, 0, Defer[Int][(b*x)^m*Sqrt[ArcCos[a*x]], x]}
{(b*x)^m/Sqrt[ArcCos[a*x]], x, 0, Defer[Int][(b*x)^m/Sqrt[ArcCos[a*x]], x]}
{(b*x)^m/ArcCos[a*x]^(3/2), x, 0, Defer[Int][(b*x)^m/ArcCos[a*x]^(3/2), x]}
...
{(b*x)^m*ArcCos[a*x]^n, x, 0, Defer[Int][(b*x)^m*ArcCos[a*x]^n, x]}
...
{ArcCos[a*x]^n/x, x, 0, Defer[Int][ArcCos[a*x]^n/x, x]}
{ArcCos[a*x]^n/x^2, x, 0, Defer[Int][ArcCos[a*x]^n/x^2, x]}


{(b*x)^(3/2)*ArcCos[a*x]^n, x, 0, Defer[Int][(b*x)^(3/2)*ArcCos[a*x]^n, x]}
{Sqrt[b*x]*ArcCos[a*x]^n, x, 0, Defer[Int][Sqrt[b*x]*ArcCos[a*x]^n, x]}
{ArcCos[a*x]^n/Sqrt[b*x], x, 0, Defer[Int][ArcCos[a*x]^n/Sqrt[b*x], x]}
{ArcCos[a*x]^n/(b*x)^(3/2), x, 0, Defer[Int][ArcCos[a*x]^n/(b*x)^(3/2), x]}
...
{1/(x*(a + b*ArcCos[c*x])), x, 0, Defer[Int][1/(x*(a + b*ArcCos[c*x])), x]}
{1/(x^2*(a + b*ArcCos[c*x])), x, 0, Defer[Int][1/(x^2*(a + b*ArcCos[c*x])), x]}
...
{1/(x*(a + b*ArcCos[c*x])^2), x, 0, Defer[Int][1/(x*(a + b*ArcCos[c*x])^2), x]}
{1/(x^2*(a + b*ArcCos[c*x])^2), x, 0, Defer[Int][1/(x^2*(a + b*ArcCos[c*x])^2), x]}
...
{1/(x*(a + b*ArcCos[c*x])^3), x, 0, Defer[Int][1/(x*(a + b*ArcCos[c*x])^3), x]}
{1/(x^2*(a + b*ArcCos[c*x])^3), x, 0, Defer[Int][1/(x^2*(a + b*ArcCos[c*x])^3), x]}
...
{Sqrt[a + b*ArcCos[c*x]]/x, x, 0, Defer[Int][Sqrt[a + b*ArcCos[c*x]]/x, x]}
{Sqrt[a + b*ArcCos[c*x]]/x^2, x, 0, Defer[Int][Sqrt[a + b*ArcCos[c*x]]/x^2, x]}
...
{(a + b*ArcCos[c*x])^(3/2)/x, x, 0, Defer[Int][(a + b*ArcCos[c*x])^(3/2)/x, x]}
{(a + b*ArcCos[c*x])^(3/2)/x^2, x, 0, Defer[Int][(a + b*ArcCos[c*x])^(3/2)/x^2, x]}
...
{(a + b*ArcCos[c*x])^(5/2)/x, x, 0, Defer[Int][(a + b*ArcCos[c*x])^(5/2)/x, x]}
{(a + b*ArcCos[c*x])^(5/2)/x^2, x, 0, Defer[Int][(a + b*ArcCos[c*x])^(5/2)/x^2, x]}
...
{1/(x*Sqrt[a + b*ArcCos[c*x]]), x, 0, Defer[Int][1/(x*Sqrt[a + b*ArcCos[c*x]]), x]}
{1/(x^2*Sqrt[a + b*ArcCos[c*x]]), x, 0, Defer[Int][1/(x^2*Sqrt[a + b*ArcCos[c*x]]), x]}
...
{1/(x*(a + b*ArcCos[c*x])^(3/2)), x, 0, Defer[Int][1/(x*(a + b*ArcCos[c*x])^(3/2)), x]}
{1/(x^2*(a + b*ArcCos[c*x])^(3/2)), x, 0, Defer[Int][1/(x^2*(a + b*ArcCos[c*x])^(3/2)), x]}
...
{1/(x*(a + b*ArcCos[c*x])^(5/2)), x, 0, Defer[Int][1/(x*(a + b*ArcCos[c*x])^(5/2)), x]}
{1/(x^2*(a + b*ArcCos[c*x])^(5/2)), x, 0, Defer[Int][1/(x^2*(a + b*ArcCos[c*x])^(5/2)), x]}
...
{(d*x)^(3/2)*(a + b*ArcCos[c*x])^3, x, 1, (2*(d*x)^(5/2)*(a + b*ArcCos[c*x])^3)/(5*d) + (6*b*c*Defer[Int][((d*x)^(5/2)*(a + b*ArcCos[c*x])^2)/Sqrt[1 - c^2*x^2], x])/(5*d)}
{Sqrt[d*x]*(a + b*ArcCos[c*x])^3, x, 1, (2*(d*x)^(3/2)*(a + b*ArcCos[c*x])^3)/(3*d) + (2*b*c*Defer[Int][((d*x)^(3/2)*(a + b*ArcCos[c*x])^2)/Sqrt[1 - c^2*x^2], x])/d}
{(a + b*ArcCos[c*x])^3/Sqrt[d*x], x, 1, (2*Sqrt[d*x]*(a + b*ArcCos[c*x])^3)/d + (6*b*c*Defer[Int][(Sqrt[d*x]*(a + b*ArcCos[c*x])^2)/Sqrt[1 - c^2*x^2], x])/d}
{(a + b*ArcCos[c*x])^3/(d*x)^(3/2), x, 1, (-2*(a + b*ArcCos[c*x])^3)/(d*Sqrt[d*x]) - (6*b*c*Defer[Int][(a + b*ArcCos[c*x])^2/(Sqrt[d*x]*Sqrt[1 - c^2*x^2]), x])/d}
{(a + b*ArcCos[c*x])^3/(d*x)^(5/2), x, 1, (-2*(a + b*ArcCos[c*x])^3)/(3*d*(d*x)^(3/2)) - (2*b*c*Defer[Int][(a + b*ArcCos[c*x])^2/((d*x)^(3/2)*Sqrt[1 - c^2*x^2]), x])/d}
...
{(d*x)^(3/2)/(a + b*ArcCos[c*x]), x, 0, Defer[Int][(d*x)^(3/2)/(a + b*ArcCos[c*x]), x]}
{Sqrt[d*x]/(a + b*ArcCos[c*x]), x, 0, Defer[Int][Sqrt[d*x]/(a + b*ArcCos[c*x]), x]}
{1/(Sqrt[d*x]*(a + b*ArcCos[c*x])), x, 0, Defer[Int][1/(Sqrt[d*x]*(a + b*ArcCos[c*x])), x]}
{1/((d*x)^(3/2)*(a + b*ArcCos[c*x])), x, 0, Defer[Int][1/((d*x)^(3/2)*(a + b*ArcCos[c*x])), x]}


{(d*x)^(3/2)/(a + b*ArcCos[c*x])^2, x, 0, Defer[Int][(d*x)^(3/2)/(a + b*ArcCos[c*x])^2, x]}
{Sqrt[d*x]/(a + b*ArcCos[c*x])^2, x, 0, Defer[Int][Sqrt[d*x]/(a + b*ArcCos[c*x])^2, x]}
{1/(Sqrt[d*x]*(a + b*ArcCos[c*x])^2), x, 0, Defer[Int][1/(Sqrt[d*x]*(a + b*ArcCos[c*x])^2), x]}
{1/((d*x)^(3/2)*(a + b*ArcCos[c*x])^2), x, 0, Defer[Int][1/((d*x)^(3/2)*(a + b*ArcCos[c*x])^2), x]}
