...
{1/(x^1*ArcSin[a*x]), x, 0, Defer[Int][1/(x*ArcSin[a*x]), x]}
{1/(x^2*ArcSin[a*x]), x, 0, Defer[Int][1/(x^2*ArcSin[a*x]), x]}
...
{1/(x^1*ArcSin[a*x]^2), x, 0, Defer[Int][1/(x*ArcSin[a*x]^2), x]}
{1/(x^2*ArcSin[a*x]^2), x, 0, Defer[Int][1/(x^2*ArcSin[a*x]^2), x]}
...
{1/(x^1*ArcSin[a*x]^3), x, 0, Defer[Int][1/(x*ArcSin[a*x]^3), x]}
{1/(x^2*ArcSin[a*x]^3), x, 0, Defer[Int][1/(x^2*ArcSin[a*x]^3), x]}
...
{1/(x^1*ArcSin[a*x]^4), x, 0, Defer[Int][1/(x*ArcSin[a*x]^4), x]}
{1/(x^2*ArcSin[a*x]^4), x, 0, Defer[Int][1/(x^2*ArcSin[a*x]^4), x]}
...
{Sqrt[ArcSin[a*x]]/x^1, x, 0, Defer[Int][Sqrt[ArcSin[a*x]]/x, x]}
...
{ArcSin[a*x]^(3/2)/x^1, x, 0, Defer[Int][ArcSin[a*x]^(3/2)/x, x]}
...
{ArcSin[a*x]^(5/2)/x^1, x, 0, Defer[Int][ArcSin[a*x]^(5/2)/x, x]}
...
{1/(x^1*Sqrt[ArcSin[a*x]]), x, 0, Defer[Int][1/(x*Sqrt[ArcSin[a*x]]), x]}
{1/(x^2*Sqrt[ArcSin[a*x]]), x, 0, Defer[Int][1/(x^2*Sqrt[ArcSin[a*x]]), x]}
...
{1/(x^1*ArcSin[a*x]^(3/2)), x, 0, Defer[Int][1/(x*ArcSin[a*x]^(3/2)), x]}
...
{1/(x^1*ArcSin[a*x]^(5/2)), x, 0, Defer[Int][1/(x*ArcSin[a*x]^(5/2)), x]}
...
{1/(x^1*ArcSin[a*x]^(7/2)), x, 0, Defer[Int][1/(x*ArcSin[a*x]^(7/2)), x]}
...
{(b*x)^m*ArcSin[a*x]^4, x, 1, ((b*x)^(1 + m)*ArcSin[a*x]^4)/(b*(1 + m)) - (4*a*Defer[Int][((b*x)^(1 + m)*ArcSin[a*x]^3)/Sqrt[1 - a^2*x^2], x])/(b*(1 + m))}
{(b*x)^m*ArcSin[a*x]^3, x, 1, ((b*x)^(1 + m)*ArcSin[a*x]^3)/(b*(1 + m)) - (3*a*Defer[Int][((b*x)^(1 + m)*ArcSin[a*x]^2)/Sqrt[1 - a^2*x^2], x])/(b*(1 + m))}
...
{(b*x)^m/ArcSin[a*x]^1, x, 0, Defer[Int][(b*x)^m/ArcSin[a*x], x]}
{(b*x)^m/ArcSin[a*x]^2, x, 0, Defer[Int][(b*x)^m/ArcSin[a*x]^2, x]}


{(b*x)^m*ArcSin[a*x]^(3/2), x, 0, Defer[Int][(b*x)^m*ArcSin[a*x]^(3/2), x]}
{(b*x)^m*ArcSin[a*x]^(1/2), x, 0, Defer[Int][(b*x)^m*Sqrt[ArcSin[a*x]], x]}
{(b*x)^m/ArcSin[a*x]^(1/2), x, 0, Defer[Int][(b*x)^m/Sqrt[ArcSin[a*x]], x]}
{(b*x)^m/ArcSin[a*x]^(3/2), x, 0, Defer[Int][(b*x)^m/ArcSin[a*x]^(3/2), x]}
...
{(b*x)^m*ArcSin[a*x]^n, x, 0, Defer[Int][(b*x)^m*ArcSin[a*x]^n, x]}
...
{ArcSin[a*x]^n/x^1, x, 0, Defer[Int][ArcSin[a*x]^n/x, x]}
{ArcSin[a*x]^n/x^2, x, 0, Defer[Int][ArcSin[a*x]^n/x^2, x]}


{(b*x)^(3/2)*ArcSin[a*x]^n, x, 0, Defer[Int][(b*x)^(3/2)*ArcSin[a*x]^n, x]}
{(b*x)^(1/2)*ArcSin[a*x]^n, x, 0, Defer[Int][Sqrt[b*x]*ArcSin[a*x]^n, x]}
{ArcSin[a*x]^n/(b*x)^(1/2), x, 0, Defer[Int][ArcSin[a*x]^n/Sqrt[b*x], x]}
{ArcSin[a*x]^n/(b*x)^(3/2), x, 0, Defer[Int][ArcSin[a*x]^n/(b*x)^(3/2), x]}
...
{1/(x^1*(a + b*ArcSin[c*x])), x, 0, Defer[Int][1/(x*(a + b*ArcSin[c*x])), x]}
{1/(x^2*(a + b*ArcSin[c*x])), x, 0, Defer[Int][1/(x^2*(a + b*ArcSin[c*x])), x]}
...
{1/(x^1*(a + b*ArcSin[c*x])^2), x, 0, Defer[Int][1/(x*(a + b*ArcSin[c*x])^2), x]}
{1/(x^2*(a + b*ArcSin[c*x])^2), x, 0, Defer[Int][1/(x^2*(a + b*ArcSin[c*x])^2), x]}
...
{1/(x^1*(a + b*ArcSin[c*x])^3), x, 0, Defer[Int][1/(x*(a + b*ArcSin[c*x])^3), x]}
{1/(x^2*(a + b*ArcSin[c*x])^3), x, 0, Defer[Int][1/(x^2*(a + b*ArcSin[c*x])^3), x]}
...
{(a + b*ArcSin[c*x])^(1/2)/x^1, x, 0, Defer[Int][Sqrt[a + b*ArcSin[c*x]]/x, x]}
{(a + b*ArcSin[c*x])^(1/2)/x^2, x, 0, Defer[Int][Sqrt[a + b*ArcSin[c*x]]/x^2, x]}
...
{(a + b*ArcSin[c*x])^(3/2)/x^1, x, 0, Defer[Int][(a + b*ArcSin[c*x])^(3/2)/x, x]}
{(a + b*ArcSin[c*x])^(3/2)/x^2, x, 0, Defer[Int][(a + b*ArcSin[c*x])^(3/2)/x^2, x]}
...
{(a + b*ArcSin[c*x])^(5/2)/x^1, x, 0, Defer[Int][(a + b*ArcSin[c*x])^(5/2)/x, x]}
{(a + b*ArcSin[c*x])^(5/2)/x^2, x, 0, Defer[Int][(a + b*ArcSin[c*x])^(5/2)/x^2, x]}
...
{1/(x^1*(a + b*ArcSin[c*x])^(1/2)), x, 0, Defer[Int][1/(x*Sqrt[a + b*ArcSin[c*x]]), x]}
{1/(x^2*(a + b*ArcSin[c*x])^(1/2)), x, 0, Defer[Int][1/(x^2*Sqrt[a + b*ArcSin[c*x]]), x]}
...
{1/(x^1*(a + b*ArcSin[c*x])^(3/2)), x, 0, Defer[Int][1/(x*(a + b*ArcSin[c*x])^(3/2)), x]}
{1/(x^2*(a + b*ArcSin[c*x])^(3/2)), x, 0, Defer[Int][1/(x^2*(a + b*ArcSin[c*x])^(3/2)), x]}
...
{1/(x^1*(a + b*ArcSin[c*x])^(5/2)), x, 0, Defer[Int][1/(x*(a + b*ArcSin[c*x])^(5/2)), x]}
{1/(x^2*(a + b*ArcSin[c*x])^(5/2)), x, 0, Defer[Int][1/(x^2*(a + b*ArcSin[c*x])^(5/2)), x]}
...
{(d*x)^(3/2)*(a + b*ArcSin[c*x])^3, x, 1, (2*(d*x)^(5/2)*(a + b*ArcSin[c*x])^3)/(5*d) - (6*b*c*Defer[Int][((d*x)^(5/2)*(a + b*ArcSin[c*x])^2)/Sqrt[1 - c^2*x^2], x])/(5*d)}
{(d*x)^(1/2)*(a + b*ArcSin[c*x])^3, x, 1, (2*(d*x)^(3/2)*(a + b*ArcSin[c*x])^3)/(3*d) - (2*b*c*Defer[Int][((d*x)^(3/2)*(a + b*ArcSin[c*x])^2)/Sqrt[1 - c^2*x^2], x])/d}
{(a + b*ArcSin[c*x])^3/(d*x)^(1/2), x, 1, (2*Sqrt[d*x]*(a + b*ArcSin[c*x])^3)/d - (6*b*c*Defer[Int][(Sqrt[d*x]*(a + b*ArcSin[c*x])^2)/Sqrt[1 - c^2*x^2], x])/d}
{(a + b*ArcSin[c*x])^3/(d*x)^(3/2), x, 1, -((2*(a + b*ArcSin[c*x])^3)/(d*Sqrt[d*x])) + (6*b*c*Defer[Int][(a + b*ArcSin[c*x])^2/(Sqrt[d*x]*Sqrt[1 - c^2*x^2]), x])/d}
{(a + b*ArcSin[c*x])^3/(d*x)^(5/2), x, 1, -((2*(a + b*ArcSin[c*x])^3)/(3*d*(d*x)^(3/2))) + (2*b*c*Defer[Int][(a + b*ArcSin[c*x])^2/((d*x)^(3/2)*Sqrt[1 - c^2*x^2]), x])/d}
...
{(d*x)^(3/2)/(a + b*ArcSin[c*x]), x, 0, Defer[Int][(d*x)^(3/2)/(a + b*ArcSin[c*x]), x]}
{(d*x)^(1/2)/(a + b*ArcSin[c*x]), x, 0, Defer[Int][Sqrt[d*x]/(a + b*ArcSin[c*x]), x]}
{1/((d*x)^(1/2)*(a + b*ArcSin[c*x])), x, 0, Defer[Int][1/(Sqrt[d*x]*(a + b*ArcSin[c*x])), x]}
{1/((d*x)^(3/2)*(a + b*ArcSin[c*x])), x, 0, Defer[Int][1/((d*x)^(3/2)*(a + b*ArcSin[c*x])), x]}


{(d*x)^(3/2)/(a + b*ArcSin[c*x])^2, x, 0, Defer[Int][(d*x)^(3/2)/(a + b*ArcSin[c*x])^2, x]}
{(d*x)^(1/2)/(a + b*ArcSin[c*x])^2, x, 0, Defer[Int][Sqrt[d*x]/(a + b*ArcSin[c*x])^2, x]}
{1/((d*x)^(1/2)*(a + b*ArcSin[c*x])^2), x, 0, Defer[Int][1/(Sqrt[d*x]*(a + b*ArcSin[c*x])^2), x]}
{1/((d*x)^(3/2)*(a + b*ArcSin[c*x])^2), x, 0, Defer[Int][1/((d*x)^(3/2)*(a + b*ArcSin[c*x])^2), x]}
