...
{(b*Tan[c + d*x])^(7/2), x, 15, -((b^(7/2)*ArcTan[1 - (Sqrt[2]*Sqrt[b*Tan[c + d*x]])/Sqrt[b]])/(Sqrt[2]*d)) + (b^(7/2)*ArcTan[1 + (Sqrt[2]*Sqrt[b*Tan[c + d*x]])/Sqrt[b]])/(Sqrt[2]*d) - (b^(7/2)*Log[Sqrt[b] + Sqrt[b]*Tan[c + d*x] - Sqrt[2]*Sqrt[b*Tan[c + d*x]]])/(2*Sqrt[2]*d) + (b^(7/2)*Log[Sqrt[b] + Sqrt[b]*Tan[c + d*x] + Sqrt[2]*Sqrt[b*Tan[c + d*x]]])/(2*Sqrt[2]*d) - (2*b^3*Sqrt[b*Tan[c + d*x]])/d + (2*b*(b*Tan[c + d*x])^(5/2))/(5*d)}
{(b*Tan[c + d*x])^(5/2), x, 14, (b^(5/2)*ArcTan[1 - (Sqrt[2]*Sqrt[b*Tan[c + d*x]])/Sqrt[b]])/(Sqrt[2]*d) - (b^(5/2)*ArcTan[1 + (Sqrt[2]*Sqrt[b*Tan[c + d*x]])/Sqrt[b]])/(Sqrt[2]*d) - (b^(5/2)*Log[Sqrt[b] + Sqrt[b]*Tan[c + d*x] - Sqrt[2]*Sqrt[b*Tan[c + d*x]]])/(2*Sqrt[2]*d) + (b^(5/2)*Log[Sqrt[b] + Sqrt[b]*Tan[c + d*x] + Sqrt[2]*Sqrt[b*Tan[c + d*x]]])/(2*Sqrt[2]*d) + (2*b*(b*Tan[c + d*x])^(3/2))/(3*d)}
{(b*Tan[c + d*x])^(3/2), x, 14, (b^(3/2)*ArcTan[1 - (Sqrt[2]*Sqrt[b*Tan[c + d*x]])/Sqrt[b]])/(Sqrt[2]*d) - (b^(3/2)*ArcTan[1 + (Sqrt[2]*Sqrt[b*Tan[c + d*x]])/Sqrt[b]])/(Sqrt[2]*d) + (b^(3/2)*Log[Sqrt[b] + Sqrt[b]*Tan[c + d*x] - Sqrt[2]*Sqrt[b*Tan[c + d*x]]])/(2*Sqrt[2]*d) - (b^(3/2)*Log[Sqrt[b] + Sqrt[b]*Tan[c + d*x] + Sqrt[2]*Sqrt[b*Tan[c + d*x]]])/(2*Sqrt[2]*d) + (2*b*Sqrt[b*Tan[c + d*x]])/d}
{(b*Tan[c + d*x])^(1/2), x, 13, -((Sqrt[b]*ArcTan[1 - (Sqrt[2]*Sqrt[b*Tan[c + d*x]])/Sqrt[b]])/(Sqrt[2]*d)) + (Sqrt[b]*ArcTan[1 + (Sqrt[2]*Sqrt[b*Tan[c + d*x]])/Sqrt[b]])/(Sqrt[2]*d) + (Sqrt[b]*Log[Sqrt[b] + Sqrt[b]*Tan[c + d*x] - Sqrt[2]*Sqrt[b*Tan[c + d*x]]])/(2*Sqrt[2]*d) - (Sqrt[b]*Log[Sqrt[b] + Sqrt[b]*Tan[c + d*x] + Sqrt[2]*Sqrt[b*Tan[c + d*x]]])/(2*Sqrt[2]*d)}
{1/(b*Tan[c + d*x])^(1/2), x, 13, -(ArcTan[1 - (Sqrt[2]*Sqrt[b*Tan[c + d*x]])/Sqrt[b]]/(Sqrt[2]*Sqrt[b]*d)) + ArcTan[1 + (Sqrt[2]*Sqrt[b*Tan[c + d*x]])/Sqrt[b]]/(Sqrt[2]*Sqrt[b]*d) - Log[Sqrt[b] + Sqrt[b]*Tan[c + d*x] - Sqrt[2]*Sqrt[b*Tan[c + d*x]]]/(2*Sqrt[2]*Sqrt[b]*d) + Log[Sqrt[b] + Sqrt[b]*Tan[c + d*x] + Sqrt[2]*Sqrt[b*Tan[c + d*x]]]/(2*Sqrt[2]*Sqrt[b]*d)}
{1/(b*Tan[c + d*x])^(3/2), x, 14, ArcTan[1 - (Sqrt[2]*Sqrt[b*Tan[c + d*x]])/Sqrt[b]]/(Sqrt[2]*b^(3/2)*d) - ArcTan[1 + (Sqrt[2]*Sqrt[b*Tan[c + d*x]])/Sqrt[b]]/(Sqrt[2]*b^(3/2)*d) - Log[Sqrt[b] + Sqrt[b]*Tan[c + d*x] - Sqrt[2]*Sqrt[b*Tan[c + d*x]]]/(2*Sqrt[2]*b^(3/2)*d) + Log[Sqrt[b] + Sqrt[b]*Tan[c + d*x] + Sqrt[2]*Sqrt[b*Tan[c + d*x]]]/(2*Sqrt[2]*b^(3/2)*d) - 2/(b*d*Sqrt[b*Tan[c + d*x]])}
{1/(b*Tan[c + d*x])^(5/2), x, 14, ArcTan[1 - (Sqrt[2]*Sqrt[b*Tan[c + d*x]])/Sqrt[b]]/(Sqrt[2]*b^(5/2)*d) - ArcTan[1 + (Sqrt[2]*Sqrt[b*Tan[c + d*x]])/Sqrt[b]]/(Sqrt[2]*b^(5/2)*d) + Log[Sqrt[b] + Sqrt[b]*Tan[c + d*x] - Sqrt[2]*Sqrt[b*Tan[c + d*x]]]/(2*Sqrt[2]*b^(5/2)*d) - Log[Sqrt[b] + Sqrt[b]*Tan[c + d*x] + Sqrt[2]*Sqrt[b*Tan[c + d*x]]]/(2*Sqrt[2]*b^(5/2)*d) - 2/(3*b*d*(b*Tan[c + d*x])^(3/2))}
...
{(b*Tan[c + d*x])^(4/3), x, 15, -((b^(4/3)*ArcTan[(b*Tan[c + d*x])^(1/3)/b^(1/3)])/d) + (b^(4/3)*ArcTan[(Sqrt[3]*b^(1/3) - 2*(b*Tan[c + d*x])^(1/3))/b^(1/3)])/(2*d) - (b^(4/3)*ArcTan[(Sqrt[3]*b^(1/3) + 2*(b*Tan[c + d*x])^(1/3))/b^(1/3)])/(2*d) + (Sqrt[3]*b^(4/3)*Log[b^(2/3) - Sqrt[3]*b^(1/3)*(b*Tan[c + d*x])^(1/3) + (b*Tan[c + d*x])^(2/3)])/(4*d) - (Sqrt[3]*b^(4/3)*Log[b^(2/3) + Sqrt[3]*b^(1/3)*(b*Tan[c + d*x])^(1/3) + (b*Tan[c + d*x])^(2/3)])/(4*d) + (3*b*(b*Tan[c + d*x])^(1/3))/d}
{(b*Tan[c + d*x])^(2/3), x, 14, (b^(2/3)*ArcTan[(b*Tan[c + d*x])^(1/3)/b^(1/3)])/d - (b^(2/3)*ArcTan[(Sqrt[3]*b^(1/3) - 2*(b*Tan[c + d*x])^(1/3))/b^(1/3)])/(2*d) + (b^(2/3)*ArcTan[(Sqrt[3]*b^(1/3) + 2*(b*Tan[c + d*x])^(1/3))/b^(1/3)])/(2*d) + (Sqrt[3]*b^(2/3)*Log[b^(2/3) - Sqrt[3]*b^(1/3)*(b*Tan[c + d*x])^(1/3) + (b*Tan[c + d*x])^(2/3)])/(4*d) - (Sqrt[3]*b^(2/3)*Log[b^(2/3) + Sqrt[3]*b^(1/3)*(b*Tan[c + d*x])^(1/3) + (b*Tan[c + d*x])^(2/3)])/(4*d)}
{(b*Tan[c + d*x])^(1/3), x, 10, -((Sqrt[3]*b^(1/3)*ArcTan[(b^(2/3) - 2*(b*Tan[c + d*x])^(2/3))/(Sqrt[3]*b^(2/3))])/(2*d)) - (b^(1/3)*Log[b^(2/3) + (b*Tan[c + d*x])^(2/3)])/(2*d) + (b^(1/3)*Log[b^(4/3) - b^(2/3)*(b*Tan[c + d*x])^(2/3) + (b*Tan[c + d*x])^(4/3)])/(4*d)}
{1/(b*Tan[c + d*x])^(1/3), x, 10, -((Sqrt[3]*ArcTan[(b^(2/3) - 2*(b*Tan[c + d*x])^(2/3))/(Sqrt[3]*b^(2/3))])/(2*b^(1/3)*d)) + Log[b^(2/3) + (b*Tan[c + d*x])^(2/3)]/(2*b^(1/3)*d) - Log[b^(4/3) - b^(2/3)*(b*Tan[c + d*x])^(2/3) + (b*Tan[c + d*x])^(4/3)]/(4*b^(1/3)*d)}
{1/(b*Tan[c + d*x])^(2/3), x, 14, ArcTan[(b*Tan[c + d*x])^(1/3)/b^(1/3)]/(b^(2/3)*d) - ArcTan[(Sqrt[3]*b^(1/3) - 2*(b*Tan[c + d*x])^(1/3))/b^(1/3)]/(2*b^(2/3)*d) + ArcTan[(Sqrt[3]*b^(1/3) + 2*(b*Tan[c + d*x])^(1/3))/b^(1/3)]/(2*b^(2/3)*d) - (Sqrt[3]*Log[b^(2/3) - Sqrt[3]*b^(1/3)*(b*Tan[c + d*x])^(1/3) + (b*Tan[c + d*x])^(2/3)])/(4*b^(2/3)*d) + (Sqrt[3]*Log[b^(2/3) + Sqrt[3]*b^(1/3)*(b*Tan[c + d*x])^(1/3) + (b*Tan[c + d*x])^(2/3)])/(4*b^(2/3)*d)}
{1/(b*Tan[c + d*x])^(4/3), x, 15, -(ArcTan[(b*Tan[c + d*x])^(1/3)/b^(1/3)]/(b^(4/3)*d)) + ArcTan[(Sqrt[3]*b^(1/3) - 2*(b*Tan[c + d*x])^(1/3))/b^(1/3)]/(2*b^(4/3)*d) - ArcTan[(Sqrt[3]*b^(1/3) + 2*(b*Tan[c + d*x])^(1/3))/b^(1/3)]/(2*b^(4/3)*d) - (Sqrt[3]*Log[b^(2/3) - Sqrt[3]*b^(1/3)*(b*Tan[c + d*x])^(1/3) + (b*Tan[c + d*x])^(2/3)])/(4*b^(4/3)*d) + (Sqrt[3]*Log[b^(2/3) + Sqrt[3]*b^(1/3)*(b*Tan[c + d*x])^(1/3) + (b*Tan[c + d*x])^(2/3)])/(4*b^(4/3)*d) - 3/(b*d*(b*Tan[c + d*x])^(1/3))}
...
{Sin[a + b*x]^4*(d*Tan[a + b*x])^(1/2), x, 16, -((21*Sqrt[d]*ArcTan[1 - (Sqrt[2]*Sqrt[d*Tan[a + b*x]])/Sqrt[d]])/(32*Sqrt[2]*b)) + (21*Sqrt[d]*ArcTan[1 + (Sqrt[2]*Sqrt[d*Tan[a + b*x]])/Sqrt[d]])/(32*Sqrt[2]*b) + (21*Sqrt[d]*Log[Sqrt[d] + Sqrt[d]*Tan[a + b*x] - Sqrt[2]*Sqrt[d*Tan[a + b*x]]])/(64*Sqrt[2]*b) - (21*Sqrt[d]*Log[Sqrt[d] + Sqrt[d]*Tan[a + b*x] + Sqrt[2]*Sqrt[d*Tan[a + b*x]]])/(64*Sqrt[2]*b) - (7*Cos[a + b*x]^2*(d*Tan[a + b*x])^(3/2))/(16*b*d) - (Cos[a + b*x]^4*(d*Tan[a + b*x])^(7/2))/(4*b*d^3)}
{Sin[a + b*x]^2*(d*Tan[a + b*x])^(1/2), x, 15, -((3*Sqrt[d]*ArcTan[1 - (Sqrt[2]*Sqrt[d*Tan[a + b*x]])/Sqrt[d]])/(4*Sqrt[2]*b)) + (3*Sqrt[d]*ArcTan[1 + (Sqrt[2]*Sqrt[d*Tan[a + b*x]])/Sqrt[d]])/(4*Sqrt[2]*b) + (3*Sqrt[d]*Log[Sqrt[d] + Sqrt[d]*Tan[a + b*x] - Sqrt[2]*Sqrt[d*Tan[a + b*x]]])/(8*Sqrt[2]*b) - (3*Sqrt[d]*Log[Sqrt[d] + Sqrt[d]*Tan[a + b*x] + Sqrt[2]*Sqrt[d*Tan[a + b*x]]])/(8*Sqrt[2]*b) - (Cos[a + b*x]^2*(d*Tan[a + b*x])^(3/2))/(2*b*d)}
{Csc[a + b*x]^2*(d*Tan[a + b*x])^(1/2), x, 3, -((2*d)/(b*Sqrt[d*Tan[a + b*x]]))}
{Csc[a + b*x]^4*(d*Tan[a + b*x])^(1/2), x, 4, -((2*d^3)/(5*b*(d*Tan[a + b*x])^(5/2))) - (2*d)/(b*Sqrt[d*Tan[a + b*x]])}
{Csc[a + b*x]^6*(d*Tan[a + b*x])^(1/2), x, 4, -((2*d^5)/(9*b*(d*Tan[a + b*x])^(9/2))) - (4*d^3)/(5*b*(d*Tan[a + b*x])^(5/2)) - (2*d)/(b*Sqrt[d*Tan[a + b*x]])}

{Sin[a + b*x]^3*(d*Tan[a + b*x])^(1/2), x, 6, (5*d*EllipticF[a - Pi/4 + b*x, 2]*Sec[a + b*x]*Sqrt[Sin[2*a + 2*b*x]])/(12*b*Sqrt[d*Tan[a + b*x]]) - (5*Cos[a + b*x]*Sqrt[d*Tan[a + b*x]])/(6*b) - (Cos[a + b*x]^3*(d*Tan[a + b*x])^(5/2))/(3*b*d^2)}
{Sin[a + b*x]^1*(d*Tan[a + b*x])^(1/2), x, 5, (d*EllipticF[a - Pi/4 + b*x, 2]*Sec[a + b*x]*Sqrt[Sin[2*a + 2*b*x]])/(2*b*Sqrt[d*Tan[a + b*x]]) - (Cos[a + b*x]*Sqrt[d*Tan[a + b*x]])/b}
{Csc[a + b*x]^1*(d*Tan[a + b*x])^(1/2), x, 4, (d*EllipticF[a - Pi/4 + b*x, 2]*Sec[a + b*x]*Sqrt[Sin[2*a + 2*b*x]])/(b*Sqrt[d*Tan[a + b*x]])}
{Csc[a + b*x]^3*(d*Tan[a + b*x])^(1/2), x, 5, -((2*d^2*Sec[a + b*x])/(3*b*(d*Tan[a + b*x])^(3/2))) + (2*d*EllipticF[a - Pi/4 + b*x, 2]*Sec[a + b*x]*Sqrt[Sin[2*a + 2*b*x]])/(3*b*Sqrt[d*Tan[a + b*x]])}
{Csc[a + b*x]^5*(d*Tan[a + b*x])^(1/2), x, 6, -((2*d^4*Sec[a + b*x]^3)/(7*b*(d*Tan[a + b*x])^(7/2))) - (4*d^2*Sec[a + b*x])/(7*b*(d*Tan[a + b*x])^(3/2)) + (4*d*EllipticF[a - Pi/4 + b*x, 2]*Sec[a + b*x]*Sqrt[Sin[2*a + 2*b*x]])/(7*b*Sqrt[d*Tan[a + b*x]])}


{Sin[a + b*x]^4*(d*Tan[a + b*x])^(3/2), x, 17, (45*d^(3/2)*ArcTan[1 - (Sqrt[2]*Sqrt[d*Tan[a + b*x]])/Sqrt[d]])/(32*Sqrt[2]*b) - (45*d^(3/2)*ArcTan[1 + (Sqrt[2]*Sqrt[d*Tan[a + b*x]])/Sqrt[d]])/(32*Sqrt[2]*b) + (45*d^(3/2)*Log[Sqrt[d] + Sqrt[d]*Tan[a + b*x] - Sqrt[2]*Sqrt[d*Tan[a + b*x]]])/(64*Sqrt[2]*b) - (45*d^(3/2)*Log[Sqrt[d] + Sqrt[d]*Tan[a + b*x] + Sqrt[2]*Sqrt[d*Tan[a + b*x]]])/(64*Sqrt[2]*b) + (45*d*Sqrt[d*Tan[a + b*x]])/(16*b) - (9*Cos[a + b*x]^2*(d*Tan[a + b*x])^(5/2))/(16*b*d) - (Cos[a + b*x]^4*(d*Tan[a + b*x])^(9/2))/(4*b*d^3)}
{Sin[a + b*x]^2*(d*Tan[a + b*x])^(3/2), x, 16, (5*d^(3/2)*ArcTan[1 - (Sqrt[2]*Sqrt[d*Tan[a + b*x]])/Sqrt[d]])/(4*Sqrt[2]*b) - (5*d^(3/2)*ArcTan[1 + (Sqrt[2]*Sqrt[d*Tan[a + b*x]])/Sqrt[d]])/(4*Sqrt[2]*b) + (5*d^(3/2)*Log[Sqrt[d] + Sqrt[d]*Tan[a + b*x] - Sqrt[2]*Sqrt[d*Tan[a + b*x]]])/(8*Sqrt[2]*b) - (5*d^(3/2)*Log[Sqrt[d] + Sqrt[d]*Tan[a + b*x] + Sqrt[2]*Sqrt[d*Tan[a + b*x]]])/(8*Sqrt[2]*b) + (5*d*Sqrt[d*Tan[a + b*x]])/(2*b) - (Cos[a + b*x]^2*(d*Tan[a + b*x])^(5/2))/(2*b*d)}
{Csc[a + b*x]^2*(d*Tan[a + b*x])^(3/2), x, 3, (2*d*Sqrt[d*Tan[a + b*x]])/b}
{Csc[a + b*x]^4*(d*Tan[a + b*x])^(3/2), x, 4, -((2*d^3)/(3*b*(d*Tan[a + b*x])^(3/2))) + (2*d*Sqrt[d*Tan[a + b*x]])/b}
{Csc[a + b*x]^6*(d*Tan[a + b*x])^(3/2), x, 4, -((2*d^5)/(7*b*(d*Tan[a + b*x])^(7/2))) - (4*d^3)/(3*b*(d*Tan[a + b*x])^(3/2)) + (2*d*Sqrt[d*Tan[a + b*x]])/b}

{Sin[a + b*x]^3*(d*Tan[a + b*x])^(3/2), x, 6, -((7*d*Cos[a + b*x]*EllipticE[a - Pi/4 + b*x, 2]*Sqrt[d*Tan[a + b*x]])/(2*b*Sqrt[Sin[2*a + 2*b*x]])) + (7*Cos[a + b*x]*(d*Tan[a + b*x])^(3/2))/(3*b) - (Cos[a + b*x]^3*(d*Tan[a + b*x])^(7/2))/(3*b*d^2)}
{Sin[a + b*x]^1*(d*Tan[a + b*x])^(3/2), x, 5, -((3*d*Cos[a + b*x]*EllipticE[a - Pi/4 + b*x, 2]*Sqrt[d*Tan[a + b*x]])/(b*Sqrt[Sin[2*a + 2*b*x]])) + (2*Cos[a + b*x]*(d*Tan[a + b*x])^(3/2))/b}
{Csc[a + b*x]^1*(d*Tan[a + b*x])^(3/2), x, 5, (2*Cos[a + b*x]*(d*Tan[a + b*x])^(3/2))/b - (2*d*Cos[a + b*x]*EllipticE[a - Pi/4 + b*x, 2]*Sqrt[d*Tan[a + b*x]])/(b*Sqrt[Sin[2*a + 2*b*x]])}
{Csc[a + b*x]^3*(d*Tan[a + b*x])^(3/2), x, 6, -((2*d^2*Sec[a + b*x])/(b*Sqrt[d*Tan[a + b*x]])) - (4*d*Cos[a + b*x]*EllipticE[a - Pi/4 + b*x, 2]*Sqrt[d*Tan[a + b*x]])/(b*Sqrt[Sin[2*a + 2*b*x]]) + (4*Cos[a + b*x]*(d*Tan[a + b*x])^(3/2))/b}


{Sin[a + b*x]^4*(d*Tan[a + b*x])^(5/2), x, 17, (77*d^(5/2)*ArcTan[1 - (Sqrt[2]*Sqrt[d*Tan[a + b*x]])/Sqrt[d]])/(32*Sqrt[2]*b) - (77*d^(5/2)*ArcTan[1 + (Sqrt[2]*Sqrt[d*Tan[a + b*x]])/Sqrt[d]])/(32*Sqrt[2]*b) - (77*d^(5/2)*Log[Sqrt[d] + Sqrt[d]*Tan[a + b*x] - Sqrt[2]*Sqrt[d*Tan[a + b*x]]])/(64*Sqrt[2]*b) + (77*d^(5/2)*Log[Sqrt[d] + Sqrt[d]*Tan[a + b*x] + Sqrt[2]*Sqrt[d*Tan[a + b*x]]])/(64*Sqrt[2]*b) + (77*d*(d*Tan[a + b*x])^(3/2))/(48*b) - (11*Cos[a + b*x]^2*(d*Tan[a + b*x])^(7/2))/(16*b*d) - (Cos[a + b*x]^4*(d*Tan[a + b*x])^(11/2))/(4*b*d^3)}
{Sin[a + b*x]^2*(d*Tan[a + b*x])^(5/2), x, 16, (7*d^(5/2)*ArcTan[1 - (Sqrt[2]*Sqrt[d*Tan[a + b*x]])/Sqrt[d]])/(4*Sqrt[2]*b) - (7*d^(5/2)*ArcTan[1 + (Sqrt[2]*Sqrt[d*Tan[a + b*x]])/Sqrt[d]])/(4*Sqrt[2]*b) - (7*d^(5/2)*Log[Sqrt[d] + Sqrt[d]*Tan[a + b*x] - Sqrt[2]*Sqrt[d*Tan[a + b*x]]])/(8*Sqrt[2]*b) + (7*d^(5/2)*Log[Sqrt[d] + Sqrt[d]*Tan[a + b*x] + Sqrt[2]*Sqrt[d*Tan[a + b*x]]])/(8*Sqrt[2]*b) + (7*d*(d*Tan[a + b*x])^(3/2))/(6*b) - (Cos[a + b*x]^2*(d*Tan[a + b*x])^(7/2))/(2*b*d)}
{Csc[a + b*x]^2*(d*Tan[a + b*x])^(5/2), x, 3, (2*d*(d*Tan[a + b*x])^(3/2))/(3*b)}
{Csc[a + b*x]^4*(d*Tan[a + b*x])^(5/2), x, 4, -((2*d^3)/(b*Sqrt[d*Tan[a + b*x]])) + (2*d*(d*Tan[a + b*x])^(3/2))/(3*b)}
{Csc[a + b*x]^6*(d*Tan[a + b*x])^(5/2), x, 4, -((2*d^5)/(5*b*(d*Tan[a + b*x])^(5/2))) - (4*d^3)/(b*Sqrt[d*Tan[a + b*x]]) + (2*d*(d*Tan[a + b*x])^(3/2))/(3*b)}

{Sin[a + b*x]^3*(d*Tan[a + b*x])^(5/2), x, 7, -((5*d^3*EllipticF[a - Pi/4 + b*x, 2]*Sec[a + b*x]*Sqrt[Sin[2*a + 2*b*x]])/(4*b*Sqrt[d*Tan[a + b*x]])) + (5*d^2*Cos[a + b*x]*Sqrt[d*Tan[a + b*x]])/(2*b) + (Cos[a + b*x]*(d*Tan[a + b*x])^(5/2))/b - (Cos[a + b*x]^3*(d*Tan[a + b*x])^(9/2))/(3*b*d^2)}
{Sin[a + b*x]^1*(d*Tan[a + b*x])^(5/2), x, 6, -((5*d^3*EllipticF[a - Pi/4 + b*x, 2]*Sec[a + b*x]*Sqrt[Sin[2*a + 2*b*x]])/(6*b*Sqrt[d*Tan[a + b*x]])) + (5*d^2*Cos[a + b*x]*Sqrt[d*Tan[a + b*x]])/(3*b) + (2*Cos[a + b*x]*(d*Tan[a + b*x])^(5/2))/(3*b)}
{Csc[a + b*x]^1*(d*Tan[a + b*x])^(5/2), x, 5, -((d^3*EllipticF[a - Pi/4 + b*x, 2]*Sec[a + b*x]*Sqrt[Sin[2*a + 2*b*x]])/(3*b*Sqrt[d*Tan[a + b*x]])) + (2*d^2*Sec[a + b*x]*Sqrt[d*Tan[a + b*x]])/(3*b)}
{Csc[a + b*x]^3*(d*Tan[a + b*x])^(5/2), x, 5, (2*d^3*EllipticF[a - Pi/4 + b*x, 2]*Sec[a + b*x]*Sqrt[Sin[2*a + 2*b*x]])/(3*b*Sqrt[d*Tan[a + b*x]]) + (2*d^2*Sec[a + b*x]*Sqrt[d*Tan[a + b*x]])/(3*b)}
{Csc[a + b*x]^5*(d*Tan[a + b*x])^(5/2), x, 6, -((2*d^4*Sec[a + b*x]^3)/(3*b*(d*Tan[a + b*x])^(3/2))) + (4*d^3*EllipticF[a - Pi/4 + b*x, 2]*Sec[a + b*x]*Sqrt[Sin[2*a + 2*b*x]])/(3*b*Sqrt[d*Tan[a + b*x]]) + (4*d^2*Sec[a + b*x]*Sqrt[d*Tan[a + b*x]])/(3*b)}
{Csc[a + b*x]^7*(d*Tan[a + b*x])^(5/2), x, 7, -((2*d^6*Sec[a + b*x]^5)/(7*b*(d*Tan[a + b*x])^(7/2))) - (20*d^4*Sec[a + b*x]^3)/(21*b*(d*Tan[a + b*x])^(3/2)) + (40*d^3*EllipticF[a - Pi/4 + b*x, 2]*Sec[a + b*x]*Sqrt[Sin[2*a + 2*b*x]])/(21*b*Sqrt[d*Tan[a + b*x]]) + (40*d^2*Sec[a + b*x]*Sqrt[d*Tan[a + b*x]])/(21*b)}
...
{Sin[a + b*x]^4/(d*Tan[a + b*x])^(1/2), x, 16, -((5*ArcTan[1 - (Sqrt[2]*Sqrt[d*Tan[a + b*x]])/Sqrt[d]])/(32*Sqrt[2]*b*Sqrt[d])) + (5*ArcTan[1 + (Sqrt[2]*Sqrt[d*Tan[a + b*x]])/Sqrt[d]])/(32*Sqrt[2]*b*Sqrt[d]) - (5*Log[Sqrt[d] + Sqrt[d]*Tan[a + b*x] - Sqrt[2]*Sqrt[d*Tan[a + b*x]]])/(64*Sqrt[2]*b*Sqrt[d]) + (5*Log[Sqrt[d] + Sqrt[d]*Tan[a + b*x] + Sqrt[2]*Sqrt[d*Tan[a + b*x]]])/(64*Sqrt[2]*b*Sqrt[d]) - (5*Cos[a + b*x]^2*Sqrt[d*Tan[a + b*x]])/(16*b*d) - (Cos[a + b*x]^4*(d*Tan[a + b*x])^(5/2))/(4*b*d^3)}
{Sin[a + b*x]^2/(d*Tan[a + b*x])^(1/2), x, 15, -(ArcTan[1 - (Sqrt[2]*Sqrt[d*Tan[a + b*x]])/Sqrt[d]]/(4*Sqrt[2]*b*Sqrt[d])) + ArcTan[1 + (Sqrt[2]*Sqrt[d*Tan[a + b*x]])/Sqrt[d]]/(4*Sqrt[2]*b*Sqrt[d]) - Log[Sqrt[d] + Sqrt[d]*Tan[a + b*x] - Sqrt[2]*Sqrt[d*Tan[a + b*x]]]/(8*Sqrt[2]*b*Sqrt[d]) + Log[Sqrt[d] + Sqrt[d]*Tan[a + b*x] + Sqrt[2]*Sqrt[d*Tan[a + b*x]]]/(8*Sqrt[2]*b*Sqrt[d]) - (Cos[a + b*x]^2*Sqrt[d*Tan[a + b*x]])/(2*b*d)}
{Csc[a + b*x]^2/(d*Tan[a + b*x])^(1/2), x, 3, -((2*d)/(3*b*(d*Tan[a + b*x])^(3/2)))}
{Csc[a + b*x]^4/(d*Tan[a + b*x])^(1/2), x, 4, -((2*d^3)/(7*b*(d*Tan[a + b*x])^(7/2))) - (2*d)/(3*b*(d*Tan[a + b*x])^(3/2))}
{Csc[a + b*x]^6/(d*Tan[a + b*x])^(1/2), x, 4, -((2*d^5)/(11*b*(d*Tan[a + b*x])^(11/2))) - (4*d^3)/(7*b*(d*Tan[a + b*x])^(7/2)) - (2*d)/(3*b*(d*Tan[a + b*x])^(3/2))}

{Sin[a + b*x]^3/(d*Tan[a + b*x])^(1/2), x, 5, (Cos[a + b*x]*EllipticE[a - Pi/4 + b*x, 2]*Sqrt[d*Tan[a + b*x]])/(2*b*d*Sqrt[Sin[2*a + 2*b*x]]) - (Cos[a + b*x]^3*(d*Tan[a + b*x])^(3/2))/(3*b*d^2)}
{Sin[a + b*x]^1/(d*Tan[a + b*x])^(1/2), x, 4, (Cos[a + b*x]*EllipticE[a - Pi/4 + b*x, 2]*Sqrt[d*Tan[a + b*x]])/(b*d*Sqrt[Sin[2*a + 2*b*x]])}
{Csc[a + b*x]^1/(d*Tan[a + b*x])^(1/2), x, 5, -((2*Cos[a + b*x])/(b*Sqrt[d*Tan[a + b*x]])) - (2*Cos[a + b*x]*EllipticE[a - Pi/4 + b*x, 2]*Sqrt[d*Tan[a + b*x]])/(b*d*Sqrt[Sin[2*a + 2*b*x]])}
{Csc[a + b*x]^3/(d*Tan[a + b*x])^(1/2), x, 6, -((2*d^2*Sec[a + b*x])/(5*b*(d*Tan[a + b*x])^(5/2))) - (4*Cos[a + b*x])/(5*b*Sqrt[d*Tan[a + b*x]]) - (4*Cos[a + b*x]*EllipticE[a - Pi/4 + b*x, 2]*Sqrt[d*Tan[a + b*x]])/(5*b*d*Sqrt[Sin[2*a + 2*b*x]])}


{Sin[a + b*x]^4/(d*Tan[a + b*x])^(3/2), x, 16, -((3*ArcTan[1 - (Sqrt[2]*Sqrt[d*Tan[a + b*x]])/Sqrt[d]])/(32*Sqrt[2]*b*d^(3/2))) + (3*ArcTan[1 + (Sqrt[2]*Sqrt[d*Tan[a + b*x]])/Sqrt[d]])/(32*Sqrt[2]*b*d^(3/2)) + (3*Log[Sqrt[d] + Sqrt[d]*Tan[a + b*x] - Sqrt[2]*Sqrt[d*Tan[a + b*x]]])/(64*Sqrt[2]*b*d^(3/2)) - (3*Log[Sqrt[d] + Sqrt[d]*Tan[a + b*x] + Sqrt[2]*Sqrt[d*Tan[a + b*x]]])/(64*Sqrt[2]*b*d^(3/2)) + (3*Cos[a + b*x]^2*(d*Tan[a + b*x])^(3/2))/(16*b*d^3) - (Cos[a + b*x]^4*(d*Tan[a + b*x])^(3/2))/(4*b*d^3)}
{Sin[a + b*x]^2/(d*Tan[a + b*x])^(3/2), x, 15, -(ArcTan[1 - (Sqrt[2]*Sqrt[d*Tan[a + b*x]])/Sqrt[d]]/(4*Sqrt[2]*b*d^(3/2))) + ArcTan[1 + (Sqrt[2]*Sqrt[d*Tan[a + b*x]])/Sqrt[d]]/(4*Sqrt[2]*b*d^(3/2)) + Log[Sqrt[d] + Sqrt[d]*Tan[a + b*x] - Sqrt[2]*Sqrt[d*Tan[a + b*x]]]/(8*Sqrt[2]*b*d^(3/2)) - Log[Sqrt[d] + Sqrt[d]*Tan[a + b*x] + Sqrt[2]*Sqrt[d*Tan[a + b*x]]]/(8*Sqrt[2]*b*d^(3/2)) + (Cos[a + b*x]^2*(d*Tan[a + b*x])^(3/2))/(2*b*d^3)}
{Csc[a + b*x]^2/(d*Tan[a + b*x])^(3/2), x, 3, -((2*d)/(5*b*(d*Tan[a + b*x])^(5/2)))}
{Csc[a + b*x]^4/(d*Tan[a + b*x])^(3/2), x, 4, -((2*d^3)/(9*b*(d*Tan[a + b*x])^(9/2))) - (2*d)/(5*b*(d*Tan[a + b*x])^(5/2))}
{Csc[a + b*x]^6/(d*Tan[a + b*x])^(3/2), x, 4, -((2*d^5)/(13*b*(d*Tan[a + b*x])^(13/2))) - (4*d^3)/(9*b*(d*Tan[a + b*x])^(9/2)) - (2*d)/(5*b*(d*Tan[a + b*x])^(5/2))}

{Sin[a + b*x]^3/(d*Tan[a + b*x])^(3/2), x, 6, (EllipticF[a - Pi/4 + b*x, 2]*Sec[a + b*x]*Sqrt[Sin[2*a + 2*b*x]])/(12*b*d*Sqrt[d*Tan[a + b*x]]) + (Cos[a + b*x]*Sqrt[d*Tan[a + b*x]])/(6*b*d^2) - (Cos[a + b*x]^3*Sqrt[d*Tan[a + b*x]])/(3*b*d^2)}
{Sin[a + b*x]^1/(d*Tan[a + b*x])^(3/2), x, 5, (EllipticF[a - Pi/4 + b*x, 2]*Sec[a + b*x]*Sqrt[Sin[2*a + 2*b*x]])/(2*b*d*Sqrt[d*Tan[a + b*x]]) + (Cos[a + b*x]*Sqrt[d*Tan[a + b*x]])/(b*d^2)}
{Csc[a + b*x]^1/(d*Tan[a + b*x])^(3/2), x, 5, -((2*Sec[a + b*x])/(3*b*(d*Tan[a + b*x])^(3/2))) - (EllipticF[a - Pi/4 + b*x, 2]*Sec[a + b*x]*Sqrt[Sin[2*a + 2*b*x]])/(3*b*d*Sqrt[d*Tan[a + b*x]])}
{Csc[a + b*x]^3/(d*Tan[a + b*x])^(3/2), x, 6, -((2*d^2*Sec[a + b*x])/(7*b*(d*Tan[a + b*x])^(7/2))) - (4*Sec[a + b*x])/(21*b*(d*Tan[a + b*x])^(3/2)) - (2*EllipticF[a - Pi/4 + b*x, 2]*Sec[a + b*x]*Sqrt[Sin[2*a + 2*b*x]])/(21*b*d*Sqrt[d*Tan[a + b*x]])}


{Sin[a + b*x]^4/(d*Tan[a + b*x])^(5/2), x, 16, -((3*ArcTan[1 - (Sqrt[2]*Sqrt[d*Tan[a + b*x]])/Sqrt[d]])/(32*Sqrt[2]*b*d^(5/2))) + (3*ArcTan[1 + (Sqrt[2]*Sqrt[d*Tan[a + b*x]])/Sqrt[d]])/(32*Sqrt[2]*b*d^(5/2)) - (3*Log[Sqrt[d] + Sqrt[d]*Tan[a + b*x] - Sqrt[2]*Sqrt[d*Tan[a + b*x]]])/(64*Sqrt[2]*b*d^(5/2)) + (3*Log[Sqrt[d] + Sqrt[d]*Tan[a + b*x] + Sqrt[2]*Sqrt[d*Tan[a + b*x]]])/(64*Sqrt[2]*b*d^(5/2)) + (Cos[a + b*x]^2*Sqrt[d*Tan[a + b*x]])/(16*b*d^3) - (Cos[a + b*x]^4*Sqrt[d*Tan[a + b*x]])/(4*b*d^3)}
{Sin[a + b*x]^2/(d*Tan[a + b*x])^(5/2), x, 15, -((3*ArcTan[1 - (Sqrt[2]*Sqrt[d*Tan[a + b*x]])/Sqrt[d]])/(4*Sqrt[2]*b*d^(5/2))) + (3*ArcTan[1 + (Sqrt[2]*Sqrt[d*Tan[a + b*x]])/Sqrt[d]])/(4*Sqrt[2]*b*d^(5/2)) - (3*Log[Sqrt[d] + Sqrt[d]*Tan[a + b*x] - Sqrt[2]*Sqrt[d*Tan[a + b*x]]])/(8*Sqrt[2]*b*d^(5/2)) + (3*Log[Sqrt[d] + Sqrt[d]*Tan[a + b*x] + Sqrt[2]*Sqrt[d*Tan[a + b*x]]])/(8*Sqrt[2]*b*d^(5/2)) + (Cos[a + b*x]^2*Sqrt[d*Tan[a + b*x]])/(2*b*d^3)}
{Csc[a + b*x]^2/(d*Tan[a + b*x])^(5/2), x, 3, -((2*d)/(7*b*(d*Tan[a + b*x])^(7/2)))}
{Csc[a + b*x]^4/(d*Tan[a + b*x])^(5/2), x, 4, -((2*d^3)/(11*b*(d*Tan[a + b*x])^(11/2))) - (2*d)/(7*b*(d*Tan[a + b*x])^(7/2))}
{Csc[a + b*x]^6/(d*Tan[a + b*x])^(5/2), x, 4, -((2*d^5)/(15*b*(d*Tan[a + b*x])^(15/2))) - (4*d^3)/(11*b*(d*Tan[a + b*x])^(11/2)) - (2*d)/(7*b*(d*Tan[a + b*x])^(7/2))}

{Sin[a + b*x]^5/(d*Tan[a + b*x])^(5/2), x, 6, (3*Cos[a + b*x]*EllipticE[a - Pi/4 + b*x, 2]*Sqrt[d*Tan[a + b*x]])/(20*b*d^3*Sqrt[Sin[2*a + 2*b*x]]) + (Cos[a + b*x]^3*(d*Tan[a + b*x])^(3/2))/(10*b*d^4) - (Cos[a + b*x]^5*(d*Tan[a + b*x])^(3/2))/(5*b*d^4)}
{Sin[a + b*x]^3/(d*Tan[a + b*x])^(5/2), x, 5, (Cos[a + b*x]*EllipticE[a - Pi/4 + b*x, 2]*Sqrt[d*Tan[a + b*x]])/(2*b*d^3*Sqrt[Sin[2*a + 2*b*x]]) + (Cos[a + b*x]^3*(d*Tan[a + b*x])^(3/2))/(3*b*d^4)}
{Sin[a + b*x]^1/(d*Tan[a + b*x])^(5/2), x, 5, -((2*Cos[a + b*x])/(b*d^2*Sqrt[d*Tan[a + b*x]])) - (3*Cos[a + b*x]*EllipticE[a - Pi/4 + b*x, 2]*Sqrt[d*Tan[a + b*x]])/(b*d^3*Sqrt[Sin[2*a + 2*b*x]])}
{Csc[a + b*x]^1/(d*Tan[a + b*x])^(5/2), x, 6, -((2*Sec[a + b*x])/(5*b*(d*Tan[a + b*x])^(5/2))) + (6*Cos[a + b*x])/(5*b*d^2*Sqrt[d*Tan[a + b*x]]) + (6*Cos[a + b*x]*EllipticE[a - Pi/4 + b*x, 2]*Sqrt[d*Tan[a + b*x]])/(5*b*d^3*Sqrt[Sin[2*a + 2*b*x]])}
{Csc[a + b*x]^3/(d*Tan[a + b*x])^(5/2), x, 7, -((2*d^2*Sec[a + b*x])/(9*b*(d*Tan[a + b*x])^(9/2))) - (4*Sec[a + b*x])/(45*b*(d*Tan[a + b*x])^(5/2)) + (4*Cos[a + b*x])/(15*b*d^2*Sqrt[d*Tan[a + b*x]]) + (4*Cos[a + b*x]*EllipticE[a - Pi/4 + b*x, 2]*Sqrt[d*Tan[a + b*x]])/(15*b*d^3*Sqrt[Sin[2*a + 2*b*x]])}
...
{(b*Sin[e + f*x])^(3/2)*(d*Tan[e + f*x])^(3/2), x, 2, (8*b^2*d*Sqrt[d*Tan[e + f*x]])/(3*f*Sqrt[b*Sin[e + f*x]]) - (2*d*(b*Sin[e + f*x])^(3/2)*Sqrt[d*Tan[e + f*x]])/(3*f)}
...
{(d*Tan[e + f*x])^(3/2)*(b*Sin[e + f*x])^(4/3), x, 2, (6*d*(Cos[e + f*x]^2)^(1/4)*Hypergeometric2F1[5/4, 23/12, 35/12, Sin[e + f*x]^2]*(b*Sin[e + f*x])^(10/3)*Sqrt[d*Tan[e + f*x]])/(23*b^2*f)}
{(d*Tan[e + f*x])^(3/2)*(b*Sin[e + f*x])^(1/3), x, 2, (6*d*(Cos[e + f*x]^2)^(1/4)*Hypergeometric2F1[5/4, 17/12, 29/12, Sin[e + f*x]^2]*(b*Sin[e + f*x])^(7/3)*Sqrt[d*Tan[e + f*x]])/(17*b^2*f)}
{(d*Tan[e + f*x])^(3/2)/(b*Sin[e + f*x])^(1/3), x, 2, (6*d*(Cos[e + f*x]^2)^(1/4)*Hypergeometric2F1[13/12, 5/4, 25/12, Sin[e + f*x]^2]*(b*Sin[e + f*x])^(5/3)*Sqrt[d*Tan[e + f*x]])/(13*b^2*f)}
{(d*Tan[e + f*x])^(3/2)/(b*Sin[e + f*x])^(4/3), x, 2, (6*d*(Cos[e + f*x]^2)^(1/4)*Hypergeometric2F1[7/12, 5/4, 19/12, Sin[e + f*x]^2]*(b*Sin[e + f*x])^(2/3)*Sqrt[d*Tan[e + f*x]])/(7*b^2*f)}
...
{Sqrt[b*Sin[e + f*x]]*(d*Tan[e + f*x])^(4/3), x, 5, (6*d*(Cos[e + f*x]^2)^(1/6)*Hypergeometric2F1[7/6, 17/12, 29/12, Sin[e + f*x]^2]*(b*Sin[e + f*x])^(5/2)*(d*Tan[e + f*x])^(1/3))/(17*b^2*f), (3*d*Sqrt[b*Sin[e + f*x]]*(d*Tan[e + f*x])^(1/3))/f - (3*d*Hypergeometric2F1[5/12, 5/4, 17/12, -Tan[e + f*x]^2]*(Sec[e + f*x]^2)^(1/4)*Sqrt[b*Sin[e + f*x]]*(d*Tan[e + f*x])^(1/3))/f}
...
{Sqrt[b*Sin[e + f*x]]/(d*Tan[e + f*x])^(4/3), x, 5, (6*Hypergeometric2F1[-(1/6), 1/12, 13/12, Sin[e + f*x]^2]*Sqrt[b*Sin[e + f*x]])/(d*f*(Cos[e + f*x]^2)^(1/6)*(d*Tan[e + f*x])^(1/3)), (2*Sqrt[b*Sin[e + f*x]])/(d*f*(d*Tan[e + f*x])^(1/3)) + (4*Hypergeometric2F1[1/12, 1/4, 13/12, -Tan[e + f*x]^2]*(Sec[e + f*x]^2)^(1/4)*Sqrt[b*Sin[e + f*x]])/(d*f*(d*Tan[e + f*x])^(1/3))}


{(b*Sin[e + f*x])^(3/2)*(d*Tan[e + f*x])^(4/3), x, 5, (6*d*(Cos[e + f*x]^2)^(1/6)*Hypergeometric2F1[7/6, 23/12, 35/12, Sin[e + f*x]^2]*(b*Sin[e + f*x])^(7/2)*(d*Tan[e + f*x])^(1/3))/(23*b^2*f), (3*d*(b*Sin[e + f*x])^(3/2)*(d*Tan[e + f*x])^(1/3))/f - (3*d*Hypergeometric2F1[11/12, 7/4, 23/12, -Tan[e + f*x]^2]*(Sec[e + f*x]^2)^(3/4)*(b*Sin[e + f*x])^(3/2)*(d*Tan[e + f*x])^(1/3))/f}
...
{(b*Sin[e + f*x])^(3/2)/(d*Tan[e + f*x])^(4/3), x, 5, (6*Hypergeometric2F1[-(1/6), 7/12, 19/12, Sin[e + f*x]^2]*(b*Sin[e + f*x])^(3/2))/(7*d*f*(Cos[e + f*x]^2)^(1/6)*(d*Tan[e + f*x])^(1/3)), (2*(b*Sin[e + f*x])^(3/2))/(3*d*f*(d*Tan[e + f*x])^(1/3)) + (4*Hypergeometric2F1[7/12, 3/4, 19/12, -Tan[e + f*x]^2]*(Sec[e + f*x]^2)^(3/4)*(b*Sin[e + f*x])^(3/2))/(21*d*f*(d*Tan[e + f*x])^(1/3))}
...
{(b*Sin[e + f*x])^m*Tan[e + f*x]^3, x, 2, (Hypergeometric2F1[2, (4 + m)/2, (6 + m)/2, Sin[e + f*x]^2]*(b*Sin[e + f*x])^(4 + m))/(b^4*f*(4 + m))}
{(b*Sin[e + f*x])^m*Tan[e + f*x]^1, x, 2, (Hypergeometric2F1[1, (2 + m)/2, (4 + m)/2, Sin[e + f*x]^2]*(b*Sin[e + f*x])^(2 + m))/(b^2*f*(2 + m))}
{(b*Sin[e + f*x])^m*Cot[e + f*x]^1, x, 2, (b*Sin[e + f*x])^m/(f*m)}
{(b*Sin[e + f*x])^m*Cot[e + f*x]^3, x, 3, -((b^2*(b*Sin[e + f*x])^(-2 + m))/(f*(2 - m))) - (b*Sin[e + f*x])^m/(f*m)}
{(b*Sin[e + f*x])^m*Cot[e + f*x]^5, x, 3, -((b^4*(b*Sin[e + f*x])^(-4 + m))/(f*(4 - m))) + (2*b^2*(b*Sin[e + f*x])^(-2 + m))/(f*(2 - m)) + (b*Sin[e + f*x])^m/(f*m)}

{(b*Sin[e + f*x])^m*Tan[e + f*x]^4, x, 2, (Sqrt[Cos[e + f*x]^2]*Hypergeometric2F1[5/2, (5 + m)/2, (7 + m)/2, Sin[e + f*x]^2]*Sec[e + f*x]*(b*Sin[e + f*x])^(5 + m))/(b^5*f*(5 + m))}
{(b*Sin[e + f*x])^m*Tan[e + f*x]^2, x, 2, (Sqrt[Cos[e + f*x]^2]*Hypergeometric2F1[3/2, (3 + m)/2, (5 + m)/2, Sin[e + f*x]^2]*Sec[e + f*x]*(b*Sin[e + f*x])^(3 + m))/(b^3*f*(3 + m))}
{(b*Sin[e + f*x])^m*Cot[e + f*x]^2, x, 2, -((b*Cos[e + f*x]*Hypergeometric2F1[-(1/2), (1/2)*(-1 + m), (1 + m)/2, Sin[e + f*x]^2]*(b*Sin[e + f*x])^(-1 + m))/(f*(1 - m)*Sqrt[Cos[e + f*x]^2]))}
{(b*Sin[e + f*x])^m*Cot[e + f*x]^4, x, 2, -((b^3*Cos[e + f*x]*Hypergeometric2F1[-(3/2), (1/2)*(-3 + m), (1/2)*(-1 + m), Sin[e + f*x]^2]*(b*Sin[e + f*x])^(-3 + m))/(f*(3 - m)*Sqrt[Cos[e + f*x]^2]))}


{(b*Sin[e + f*x])^m*(d*Tan[e + f*x])^(3/2), x, 2, (2*d*(Cos[e + f*x]^2)^(1/4)*Hypergeometric2F1[5/4, (1/4)*(5 + 2*m), (1/4)*(9 + 2*m), Sin[e + f*x]^2]*(b*Sin[e + f*x])^(2 + m)*Sqrt[d*Tan[e + f*x]])/(b^2*f*(5 + 2*m))}
{(b*Sin[e + f*x])^m*(d*Tan[e + f*x])^(1/2), x, 2, (2*(Cos[e + f*x]^2)^(3/4)*Hypergeometric2F1[3/4, (1/4)*(3 + 2*m), (1/4)*(7 + 2*m), Sin[e + f*x]^2]*(b*Sin[e + f*x])^m*(d*Tan[e + f*x])^(3/2))/(d*f*(3 + 2*m))}
{(b*Sin[e + f*x])^m/(d*Tan[e + f*x])^(1/2), x, 2, (2*(Cos[e + f*x]^2)^(1/4)*Hypergeometric2F1[1/4, (1/4)*(1 + 2*m), (1/4)*(5 + 2*m), Sin[e + f*x]^2]*(b*Sin[e + f*x])^m*Sqrt[d*Tan[e + f*x]])/(d*f*(1 + 2*m))}
{(b*Sin[e + f*x])^m/(d*Tan[e + f*x])^(3/2), x, 2, -((2*Hypergeometric2F1[-(1/4), (1/4)*(-1 + 2*m), (1/4)*(3 + 2*m), Sin[e + f*x]^2]*(b*Sin[e + f*x])^m)/(d*f*(1 - 2*m)*(Cos[e + f*x]^2)^(1/4)*Sqrt[d*Tan[e + f*x]]))}
...
{Sin[e + f*x]^4*(b*Tan[e + f*x])^n, x, 3, (Hypergeometric2F1[3, (5 + n)/2, (7 + n)/2, -Tan[e + f*x]^2]*(b*Tan[e + f*x])^(5 + n))/(b^5*f*(5 + n))}
{Sin[e + f*x]^2*(b*Tan[e + f*x])^n, x, 3, (Hypergeometric2F1[2, (3 + n)/2, (5 + n)/2, -Tan[e + f*x]^2]*(b*Tan[e + f*x])^(3 + n))/(b^3*f*(3 + n))}
{Csc[e + f*x]^2*(b*Tan[e + f*x])^n, x, 3, -((b*(b*Tan[e + f*x])^(-1 + n))/(f*(1 - n)))}
{Csc[e + f*x]^4*(b*Tan[e + f*x])^n, x, 4, -((b^3*(b*Tan[e + f*x])^(-3 + n))/(f*(3 - n))) - (b*(b*Tan[e + f*x])^(-1 + n))/(f*(1 - n))}
{Csc[e + f*x]^6*(b*Tan[e + f*x])^n, x, 4, -((b^5*(b*Tan[e + f*x])^(-5 + n))/(f*(5 - n))) - (2*b^3*(b*Tan[e + f*x])^(-3 + n))/(f*(3 - n)) - (b*(b*Tan[e + f*x])^(-1 + n))/(f*(1 - n))}

{Sin[e + f*x]^3*(b*Tan[e + f*x])^n, x, 2, (Cos[e + f*x]^3*(Cos[e + f*x]^2)^((1 + n)/2)*Hypergeometric2F1[(1 + n)/2, (4 + n)/2, (6 + n)/2, Sin[e + f*x]^2]*(b*Tan[e + f*x])^(4 + n))/(b^4*f*(4 + n))}
{Sin[e + f*x]^1*(b*Tan[e + f*x])^n, x, 2, (Cos[e + f*x]*(Cos[e + f*x]^2)^((1 + n)/2)*Hypergeometric2F1[(1 + n)/2, (2 + n)/2, (4 + n)/2, Sin[e + f*x]^2]*(b*Tan[e + f*x])^(2 + n))/(b^2*f*(2 + n))}
{Csc[e + f*x]^1*(b*Tan[e + f*x])^n, x, 2, ((Cos[e + f*x]^2)^((1 + n)/2)*Hypergeometric2F1[n/2, (1 + n)/2, (2 + n)/2, Sin[e + f*x]^2]*Sec[e + f*x]*(b*Tan[e + f*x])^n)/(f*n)}
{Csc[e + f*x]^3*(b*Tan[e + f*x])^n, x, 2, -((b^2*(Cos[e + f*x]^2)^((1 + n)/2)*Hypergeometric2F1[(1/2)*(-2 + n), (1 + n)/2, n/2, Sin[e + f*x]^2]*Sec[e + f*x]^3*(b*Tan[e + f*x])^(-2 + n))/(f*(2 - n)))}
...
{Tan[e + f*x]^4*Sqrt[d*Cot[e + f*x]], x, 16, (Sqrt[d]*ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f) - (Sqrt[d]*ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f) + (2*d^3)/(5*f*(d*Cot[e + f*x])^(5/2)) - (2*d)/(f*Sqrt[d*Cot[e + f*x]]) - (Sqrt[d]*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f) + (Sqrt[d]*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f)}
{Tan[e + f*x]^3*Sqrt[d*Cot[e + f*x]], x, 15, -((Sqrt[d]*ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f)) + (Sqrt[d]*ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f) + (2*d^2)/(3*f*(d*Cot[e + f*x])^(3/2)) - (Sqrt[d]*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f) + (Sqrt[d]*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f)}
{Tan[e + f*x]^2*Sqrt[d*Cot[e + f*x]], x, 15, -((Sqrt[d]*ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f)) + (Sqrt[d]*ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f) + (2*d)/(f*Sqrt[d*Cot[e + f*x]]) + (Sqrt[d]*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f) - (Sqrt[d]*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f)}
{Tan[e + f*x]^1*Sqrt[d*Cot[e + f*x]], x, 14, (Sqrt[d]*ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f) - (Sqrt[d]*ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f) + (Sqrt[d]*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f) - (Sqrt[d]*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f)}
{Tan[e + f*x]^0*Sqrt[d*Cot[e + f*x]], x, 13, (Sqrt[d]*ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f) - (Sqrt[d]*ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f) - (Sqrt[d]*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f) + (Sqrt[d]*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f)}
{Cot[e + f*x]^1*Sqrt[d*Cot[e + f*x]], x, 15, -((Sqrt[d]*ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f)) + (Sqrt[d]*ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f) - (2*Sqrt[d*Cot[e + f*x]])/f - (Sqrt[d]*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f) + (Sqrt[d]*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f)}
{Cot[e + f*x]^2*Sqrt[d*Cot[e + f*x]], x, 15, -((Sqrt[d]*ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f)) + (Sqrt[d]*ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f) - (2*(d*Cot[e + f*x])^(3/2))/(3*d*f) + (Sqrt[d]*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f) - (Sqrt[d]*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f)}
{Cot[e + f*x]^3*Sqrt[d*Cot[e + f*x]], x, 16, (Sqrt[d]*ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f) - (Sqrt[d]*ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f) + (2*Sqrt[d*Cot[e + f*x]])/f - (2*(d*Cot[e + f*x])^(5/2))/(5*d^2*f) + (Sqrt[d]*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f) - (Sqrt[d]*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f)}


{Tan[e + f*x]^5*(d*Cot[e + f*x])^(3/2), x, 16, (d^(3/2)*ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f) - (d^(3/2)*ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f) + (2*d^4)/(5*f*(d*Cot[e + f*x])^(5/2)) - (2*d^2)/(f*Sqrt[d*Cot[e + f*x]]) - (d^(3/2)*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f) + (d^(3/2)*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f)}
{Tan[e + f*x]^4*(d*Cot[e + f*x])^(3/2), x, 15, -((d^(3/2)*ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f)) + (d^(3/2)*ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f) + (2*d^3)/(3*f*(d*Cot[e + f*x])^(3/2)) - (d^(3/2)*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f) + (d^(3/2)*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f)}
{Tan[e + f*x]^3*(d*Cot[e + f*x])^(3/2), x, 15, -((d^(3/2)*ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f)) + (d^(3/2)*ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f) + (2*d^2)/(f*Sqrt[d*Cot[e + f*x]]) + (d^(3/2)*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f) - (d^(3/2)*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f)}
{Tan[e + f*x]^2*(d*Cot[e + f*x])^(3/2), x, 14, (d^(3/2)*ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f) - (d^(3/2)*ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f) + (d^(3/2)*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f) - (d^(3/2)*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f)}
{Tan[e + f*x]^1*(d*Cot[e + f*x])^(3/2), x, 14, (d^(3/2)*ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f) - (d^(3/2)*ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f) - (d^(3/2)*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f) + (d^(3/2)*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f)}
{Tan[e + f*x]^0*(d*Cot[e + f*x])^(3/2), x, 14, -((d^(3/2)*ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f)) + (d^(3/2)*ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f) - (2*d*Sqrt[d*Cot[e + f*x]])/f - (d^(3/2)*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f) + (d^(3/2)*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f)}
{Cot[e + f*x]^1*(d*Cot[e + f*x])^(3/2), x, 15, -((d^(3/2)*ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f)) + (d^(3/2)*ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f) - (2*(d*Cot[e + f*x])^(3/2))/(3*f) + (d^(3/2)*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f) - (d^(3/2)*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f)}
{Cot[e + f*x]^2*(d*Cot[e + f*x])^(3/2), x, 16, (d^(3/2)*ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f) - (d^(3/2)*ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f) + (2*d*Sqrt[d*Cot[e + f*x]])/f - (2*(d*Cot[e + f*x])^(5/2))/(5*d*f) + (d^(3/2)*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f) - (d^(3/2)*Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]])/(2*Sqrt[2]*f)}
...
{Tan[e + f*x]^3/Sqrt[d*Cot[e + f*x]], x, 16, ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*Sqrt[d]*f) - ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*Sqrt[d]*f) + (2*d^2)/(5*f*(d*Cot[e + f*x])^(5/2)) - 2/(f*Sqrt[d*Cot[e + f*x]]) - Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*Sqrt[d]*f) + Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*Sqrt[d]*f)}
{Tan[e + f*x]^2/Sqrt[d*Cot[e + f*x]], x, 15, -(ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*Sqrt[d]*f)) + ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*Sqrt[d]*f) + (2*d)/(3*f*(d*Cot[e + f*x])^(3/2)) - Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*Sqrt[d]*f) + Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*Sqrt[d]*f)}
{Tan[e + f*x]^1/Sqrt[d*Cot[e + f*x]], x, 15, -(ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*Sqrt[d]*f)) + ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*Sqrt[d]*f) + 2/(f*Sqrt[d*Cot[e + f*x]]) + Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*Sqrt[d]*f) - Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*Sqrt[d]*f)}
{Tan[e + f*x]^0/Sqrt[d*Cot[e + f*x]], x, 13, ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*Sqrt[d]*f) - ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*Sqrt[d]*f) + Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*Sqrt[d]*f) - Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*Sqrt[d]*f)}
{Cot[e + f*x]^1/Sqrt[d*Cot[e + f*x]], x, 14, ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*Sqrt[d]*f) - ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*Sqrt[d]*f) - Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*Sqrt[d]*f) + Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*Sqrt[d]*f)}
{Cot[e + f*x]^2/Sqrt[d*Cot[e + f*x]], x, 15, -(ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*Sqrt[d]*f)) + ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*Sqrt[d]*f) - (2*Sqrt[d*Cot[e + f*x]])/(d*f) - Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*Sqrt[d]*f) + Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*Sqrt[d]*f)}
{Cot[e + f*x]^3/Sqrt[d*Cot[e + f*x]], x, 15, -(ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*Sqrt[d]*f)) + ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*Sqrt[d]*f) - (2*(d*Cot[e + f*x])^(3/2))/(3*d^2*f) + Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*Sqrt[d]*f) - Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*Sqrt[d]*f)}


{Tan[e + f*x]^2/(d*Cot[e + f*x])^(3/2), x, 16, ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*d^(3/2)*f) - ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*d^(3/2)*f) + (2*d)/(5*f*(d*Cot[e + f*x])^(5/2)) - 2/(d*f*Sqrt[d*Cot[e + f*x]]) - Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*d^(3/2)*f) + Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*d^(3/2)*f)}
{Tan[e + f*x]^1/(d*Cot[e + f*x])^(3/2), x, 15, -(ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*d^(3/2)*f)) + ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*d^(3/2)*f) + 2/(3*f*(d*Cot[e + f*x])^(3/2)) - Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*d^(3/2)*f) + Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*d^(3/2)*f)}
{Tan[e + f*x]^0/(d*Cot[e + f*x])^(3/2), x, 14, -(ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*d^(3/2)*f)) + ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*d^(3/2)*f) + 2/(d*f*Sqrt[d*Cot[e + f*x]]) + Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*d^(3/2)*f) - Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*d^(3/2)*f)}
{Cot[e + f*x]^1/(d*Cot[e + f*x])^(3/2), x, 14, ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*d^(3/2)*f) - ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*d^(3/2)*f) + Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*d^(3/2)*f) - Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*d^(3/2)*f)}
{Cot[e + f*x]^2/(d*Cot[e + f*x])^(3/2), x, 14, ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*d^(3/2)*f) - ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*d^(3/2)*f) - Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*d^(3/2)*f) + Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*d^(3/2)*f)}
{Cot[e + f*x]^3/(d*Cot[e + f*x])^(3/2), x, 15, -(ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*d^(3/2)*f)) + ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*d^(3/2)*f) - (2*Sqrt[d*Cot[e + f*x]])/(d^2*f) - Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*d^(3/2)*f) + Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*d^(3/2)*f)}
{Cot[e + f*x]^4/(d*Cot[e + f*x])^(3/2), x, 15, -(ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*d^(3/2)*f)) + ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*d^(3/2)*f) - (2*(d*Cot[e + f*x])^(3/2))/(3*d^3*f) + Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*d^(3/2)*f) - Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*d^(3/2)*f)}
{Cot[e + f*x]^5/(d*Cot[e + f*x])^(3/2), x, 16, ArcTan[1 - (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*d^(3/2)*f) - ArcTan[1 + (Sqrt[2]*Sqrt[d*Cot[e + f*x]])/Sqrt[d]]/(Sqrt[2]*d^(3/2)*f) + (2*Sqrt[d*Cot[e + f*x]])/(d^2*f) - (2*(d*Cot[e + f*x])^(5/2))/(5*d^4*f) + Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] - Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*d^(3/2)*f) - Log[Sqrt[d] + Sqrt[d]*Cot[e + f*x] + Sqrt[2]*Sqrt[d*Cot[e + f*x]]]/(2*Sqrt[2]*d^(3/2)*f)}
...
{(Cot[e + f*x])^m*(Tan[e + f*x])^n, x, 3, (Cot[e + f*x]^m*Hypergeometric2F1[1, (1/2)*(1 - m + n), (1/2)*(3 - m + n), -Tan[e + f*x]^2]*Tan[e + f*x]^(1 + n))/(f*(1 - m + n))}
{(Cot[e + f*x])^m*(b*Tan[e + f*x])^n, x, 3, (Cot[e + f*x]^m*Hypergeometric2F1[1, (1/2)*(1 - m + n), (1/2)*(3 - m + n), -Tan[e + f*x]^2]*(b*Tan[e + f*x])^(1 + n))/(b*f*(1 - m + n))}
{(a*Cot[e + f*x])^m*(Tan[e + f*x])^n, x, 3, ((a*Cot[e + f*x])^m*Hypergeometric2F1[1, (1/2)*(1 - m + n), (1/2)*(3 - m + n), -Tan[e + f*x]^2]*Tan[e + f*x]^(1 + n))/(f*(1 - m + n))}
{(a*Cot[e + f*x])^m*(b*Tan[e + f*x])^n, x, 3, ((a*Cot[e + f*x])^m*Hypergeometric2F1[1, (1/2)*(1 - m + n), (1/2)*(3 - m + n), -Tan[e + f*x]^2]*(b*Tan[e + f*x])^(1 + n))/(b*f*(1 - m + n))}
...
{Sec[e + f*x]^0*Sqrt[d*Tan[e + f*x]], x, 13, -((Sqrt[d]*ArcTan[1 - (Sqrt[2]*Sqrt[d*Tan[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f)) + (Sqrt[d]*ArcTan[1 + (Sqrt[2]*Sqrt[d*Tan[e + f*x]])/Sqrt[d]])/(Sqrt[2]*f) + (Sqrt[d]*Log[Sqrt[d] + Sqrt[d]*Tan[e + f*x] - Sqrt[2]*Sqrt[d*Tan[e + f*x]]])/(2*Sqrt[2]*f) - (Sqrt[d]*Log[Sqrt[d] + Sqrt[d]*Tan[e + f*x] + Sqrt[2]*Sqrt[d*Tan[e + f*x]]])/(2*Sqrt[2]*f)}
{Cos[e + f*x]^2*Sqrt[d*Tan[e + f*x]], x, 14, -((Sqrt[d]*ArcTan[1 - (Sqrt[2]*Sqrt[d*Tan[e + f*x]])/Sqrt[d]])/(4*Sqrt[2]*f)) + (Sqrt[d]*ArcTan[1 + (Sqrt[2]*Sqrt[d*Tan[e + f*x]])/Sqrt[d]])/(4*Sqrt[2]*f) + (Sqrt[d]*Log[Sqrt[d] + Sqrt[d]*Tan[e + f*x] - Sqrt[2]*Sqrt[d*Tan[e + f*x]]])/(8*Sqrt[2]*f) - (Sqrt[d]*Log[Sqrt[d] + Sqrt[d]*Tan[e + f*x] + Sqrt[2]*Sqrt[d*Tan[e + f*x]]])/(8*Sqrt[2]*f) + (Cos[e + f*x]^2*(d*Tan[e + f*x])^(3/2))/(2*d*f)}
...
{Sec[e + f*x]^(4/3)*Tan[e + f*x]^2, x, 2, ((Cos[e + f*x]^2)^(1/6)*Hypergeometric2F1[3/2, 13/6, 5/2, Sin[e + f*x]^2]*Sec[e + f*x]^(1/3)*Sin[e + f*x]^3)/(3*f)}
{Sec[e + f*x]^(2/3)*Tan[e + f*x]^2, x, 2, ((Cos[e + f*x]^2)^(5/6)*Hypergeometric2F1[3/2, 11/6, 5/2, Sin[e + f*x]^2]*Sec[e + f*x]^(5/3)*Sin[e + f*x]^3)/(3*f)}
{Sec[e + f*x]^(1/3)*Tan[e + f*x]^2, x, 2, ((Cos[e + f*x]^2)^(2/3)*Hypergeometric2F1[3/2, 5/3, 5/2, Sin[e + f*x]^2]*Sec[e + f*x]^(4/3)*Sin[e + f*x]^3)/(3*f)}
{Tan[e + f*x]^2/Sec[e + f*x]^(1/3), x, 2, ((Cos[e + f*x]^2)^(1/3)*Hypergeometric2F1[4/3, 3/2, 5/2, Sin[e + f*x]^2]*Sec[e + f*x]^(2/3)*Sin[e + f*x]^3)/(3*f)}
{Tan[e + f*x]^2/Sec[e + f*x]^(2/3), x, 2, ((Cos[e + f*x]^2)^(1/6)*Hypergeometric2F1[7/6, 3/2, 5/2, Sin[e + f*x]^2]*Sec[e + f*x]^(1/3)*Sin[e + f*x]^3)/(3*f)}


{Sec[e + f*x]^(4/3)*Tan[e + f*x]^4, x, 2, ((Cos[e + f*x]^2)^(1/6)*Hypergeometric2F1[5/2, 19/6, 7/2, Sin[e + f*x]^2]*Sec[e + f*x]^(1/3)*Sin[e + f*x]^5)/(5*f)}
{Sec[e + f*x]^(2/3)*Tan[e + f*x]^4, x, 2, ((Cos[e + f*x]^2)^(5/6)*Hypergeometric2F1[5/2, 17/6, 7/2, Sin[e + f*x]^2]*Sec[e + f*x]^(5/3)*Sin[e + f*x]^5)/(5*f)}
{Sec[e + f*x]^(1/3)*Tan[e + f*x]^4, x, 2, ((Cos[e + f*x]^2)^(2/3)*Hypergeometric2F1[5/2, 8/3, 7/2, Sin[e + f*x]^2]*Sec[e + f*x]^(4/3)*Sin[e + f*x]^5)/(5*f)}
{Tan[e + f*x]^4/Sec[e + f*x]^(1/3), x, 2, ((Cos[e + f*x]^2)^(1/3)*Hypergeometric2F1[7/3, 5/2, 7/2, Sin[e + f*x]^2]*Sec[e + f*x]^(2/3)*Sin[e + f*x]^5)/(5*f)}
{Tan[e + f*x]^4/Sec[e + f*x]^(2/3), x, 2, ((Cos[e + f*x]^2)^(1/6)*Hypergeometric2F1[13/6, 5/2, 7/2, Sin[e + f*x]^2]*Sec[e + f*x]^(1/3)*Sin[e + f*x]^5)/(5*f)}
...
{(b*Csc[e + f*x])^m*(d*Tan[e + f*x])^(3/2), x, 3, ((Cos[e + f*x]^2)^(5/4)*(b*Csc[e + f*x])^m*Hypergeometric2F1[5/4, (1/2)*(5/2 - m), (1/2)*(9/2 - m), Sin[e + f*x]^2]*(d*Tan[e + f*x])^(5/2))/(d*f*(5/2 - m)), (2*d*(Cos[e + f*x]^2)^(1/4)*(b*Csc[e + f*x])^m*Hypergeometric2F1[5/4, (1/4)*(5 - 2*m), (1/4)*(9 - 2*m), Sin[e + f*x]^2]*Sin[e + f*x]^2*Sqrt[d*Tan[e + f*x]])/(f*(5 - 2*m))}
...
(* ::Title:: *)
(*Integrands of the form (a Trg[e+f x])^m (b (c Tan[e+f x])^q)^n*)


(* ::Section::Closed:: *)
(*Integrands of the form (a Sin[e+f x])^m (b (c Tan[e+f x])^q)^n*)


{Sin[e + f*x]*(-Tan[e + f*x]^2)^n, x, 3, -((Cos[e + f*x]*Hypergeometric2F1[-(1/2), -n, 1/2, Sec[e + f*x]^2])/f)}
