...
(* ::Subsection::Closed:: *)
(*Integrands of the form x^m Tan[a+b x]^n*)
...
{Tan[a + b*x]/x^1, x, 0, Defer[Int][Tan[a + b*x]/x, x]}
{Tan[a + b*x]/x^2, x, 0, Defer[Int][Tan[a + b*x]/x^2, x]}
...
{Tan[a + b*x]^2/x^1, x, 0, Defer[Int][Tan[a + b*x]^2/x, x]}
{Tan[a + b*x]^2/x^2, x, 0, Defer[Int][Tan[a + b*x]^2/x^2, x]}
...
{Tan[a + b*x]^3/x^1, x, 0, Defer[Int][Tan[a + b*x]^3/x, x]}
{Tan[a + b*x]^3/x^2, x, 0, Defer[Int][Tan[a + b*x]^3/x^2, x]}


(* ::Subsection::Closed:: *)
(*Integrands of the form x^m Tan[a+b x]^(n/2)*)
...
(* ::Subsection::Closed:: *)
(*Integrands of the form (c+d x)^m (a+a Tan[e+f x])^n*)
...
{(c + d*x)^m*(a + I*a*Tan[e + f*x])^2, x, 0, Defer[Int][(c + d*x)^m*(a + I*a*Tan[e + f*x])^2, x]}
{(c + d*x)^m*(a + I*a*Tan[e + f*x])^1, x, 0, Defer[Int][(c + d*x)^m*(a + I*a*Tan[e + f*x]), x]}
...
{(a + b*Tan[e + f*x])/(c + d*x)^1, x, 0, Defer[Int][(a + b*Tan[e + f*x])/(c + d*x), x]}
{(a + b*Tan[e + f*x])/(c + d*x)^2, x, 0, Defer[Int][(a + b*Tan[e + f*x])/(c + d*x)^2, x]}
...
{(a + b*Tan[e + f*x])^2/(c + d*x)^1, x, 0, Defer[Int][(a + b*Tan[e + f*x])^2/(c + d*x), x]}
{(a + b*Tan[e + f*x])^2/(c + d*x)^2, x, 0, Defer[Int][(a + b*Tan[e + f*x])^2/(c + d*x)^2, x]}
...
{(a + b*Tan[e + f*x])^3/(c + d*x)^1, x, 0, Defer[Int][(a + b*Tan[e + f*x])^3/(c + d*x), x]}
{(a + b*Tan[e + f*x])^3/(c + d*x)^2, x, 0, Defer[Int][(a + b*Tan[e + f*x])^3/(c + d*x)^2, x]}
...
{(c + d*x)^3/(a + b*Tan[e + f*x]), x, 6, (c + d*x)^4/(4*(a - I*b)*d) + (b*(c + d*x)^3*Log[1 + (a + I*b)/((a - I*b)*E^((2*I)*(e + f*x)))])/((a^2 + b^2)*f) + (((3*I)/2)*b*d*(c + d*x)^2*PolyLog[2, -((a + I*b)/((a - I*b)*E^((2*I)*(e + f*x))))])/((a^2 + b^2)*f^2) + (3*b*d^2*(c + d*x)*PolyLog[3, -((a + I*b)/((a - I*b)*E^((2*I)*(e + f*x))))])/(2*(a^2 + b^2)*f^3) - (((3*I)/4)*b*d^3*PolyLog[4, -((a + I*b)/((a - I*b)*E^((2*I)*(e + f*x))))])/((a^2 + b^2)*f^4)}
{(c + d*x)^2/(a + b*Tan[e + f*x]), x, 5, (c + d*x)^3/(3*(a - I*b)*d) + (b*(c + d*x)^2*Log[1 + (a + I*b)/((a - I*b)*E^((2*I)*(e + f*x)))])/((a^2 + b^2)*f) + (I*b*d*(c + d*x)*PolyLog[2, -((a + I*b)/((a - I*b)*E^((2*I)*(e + f*x))))])/((a^2 + b^2)*f^2) + (b*d^2*PolyLog[3, -((a + I*b)/((a - I*b)*E^((2*I)*(e + f*x))))])/(2*(a^2 + b^2)*f^3)}
{(c + d*x)^1/(a + b*Tan[e + f*x]), x, 4, (c + d*x)^2/(2*(a - I*b)*d) + (b*(c + d*x)*Log[1 + (a + I*b)/((a - I*b)*E^((2*I)*(e + f*x)))])/((a^2 + b^2)*f) + ((I/2)*b*d*PolyLog[2, -((a + I*b)/((a - I*b)*E^((2*I)*(e + f*x))))])/((a^2 + b^2)*f^2)}
{1/((c + d*x)^1*(a + b*Tan[e + f*x])), x, 0, Defer[Int][1/((c + d*x)*(a + b*Tan[e + f*x])), x]}
{1/((c + d*x)^2*(a + b*Tan[e + f*x])), x, 0, Defer[Int][1/((c + d*x)^2*(a + b*Tan[e + f*x])), x]}


{(c + d*x)^3/(a + b*Tan[e + f*x])^2, x, 23, (6*b^2*c^2*d*x^2)/(a^2 + b^2)^2 + (8*b^2*c*d^2*x^3)/(a^2 + b^2)^2 + (3*b^2*d^3*x^4)/(a^2 + b^2)^2 - (2*b^2*(c + d*x)^3)/((I*a - b)*(a - I*b)^2*(a + I*b + (a - I*b)*E^((2*I)*e + (2*I)*f*x))*f) - (4*b^2*x*(c + d*x)^3)/(a^2 + b^2)^2 + (c + d*x)^4/(4*(a - I*b)^2*d) + (3*b^2*d*(c + d*x)^2*Log[1 + ((a + I*b)*E^((-2*I)*e - (2*I)*f*x))/(a - I*b)])/((a^2 + b^2)^2*f^2) + (2*b*(c + d*x)^3*Log[1 + ((a + I*b)*E^((-2*I)*e - (2*I)*f*x))/(a - I*b)])/((a - I*b)^2*(a + I*b)*f) - ((2*I)*b^2*(c + d*x)^3*Log[a + I*b + (a - I*b)*E^((2*I)*e + (2*I)*f*x)])/((a^2 + b^2)^2*f) + ((2*I)*b^2*(c + d*x)^3*Log[a + I*b + (a - I*b)*E^((2*I)*(e + f*x))])/((a^2 + b^2)^2*f) - ((2*I)*b^2*(c + d*x)^3*Log[1 + ((a - I*b)*E^((2*I)*(e + f*x)))/(a + I*b)])/((a^2 + b^2)^2*f) + ((3*I)*b^2*d^2*(c + d*x)*PolyLog[2, -(((a + I*b)*E^((-2*I)*e - (2*I)*f*x))/(a - I*b))])/((a^2 + b^2)^2*f^3) - (3*b*d*(c + d*x)^2*PolyLog[2, -(((a + I*b)*E^((-2*I)*e - (2*I)*f*x))/(a - I*b))])/((I*a - b)*(a - I*b)^2*f^2) - (3*b^2*d*(c + d*x)^2*PolyLog[2, -(((a - I*b)*E^((2*I)*(e + f*x)))/(a + I*b))])/((a^2 + b^2)^2*f^2) + (3*b^2*d^3*PolyLog[3, -(((a + I*b)*E^((-2*I)*e - (2*I)*f*x))/(a - I*b))])/(2*(a^2 + b^2)^2*f^4) + (3*b*d^2*(c + d*x)*PolyLog[3, -(((a + I*b)*E^((-2*I)*e - (2*I)*f*x))/(a - I*b))])/((a - I*b)^2*(a + I*b)*f^3) - ((3*I)*b^2*d^2*(c + d*x)*PolyLog[3, -(((a - I*b)*E^((2*I)*(e + f*x)))/(a + I*b))])/((a^2 + b^2)^2*f^3) + (3*b*d^3*PolyLog[4, -(((a + I*b)*E^((-2*I)*e - (2*I)*f*x))/(a - I*b))])/(2*(I*a - b)*(a - I*b)^2*f^4) + (3*b^2*d^3*PolyLog[4, -(((a - I*b)*E^((2*I)*(e + f*x)))/(a + I*b))])/(2*(a^2 + b^2)^2*f^4)}
{(c + d*x)^2/(a + b*Tan[e + f*x])^2, x, 20, (4*b^2*c*d*x^2)/(a^2 + b^2)^2 + (8*b^2*d^2*x^3)/(3*(a^2 + b^2)^2) - (2*b^2*(c + d*x)^2)/((I*a - b)*(a - I*b)^2*(a + I*b + (a - I*b)*E^((2*I)*e + (2*I)*f*x))*f) - (4*b^2*x*(c + d*x)^2)/(a^2 + b^2)^2 + (c + d*x)^3/(3*(a - I*b)^2*d) + (2*b^2*d*(c + d*x)*Log[1 + ((a + I*b)*E^((-2*I)*e - (2*I)*f*x))/(a - I*b)])/((a^2 + b^2)^2*f^2) + (2*b*(c + d*x)^2*Log[1 + ((a + I*b)*E^((-2*I)*e - (2*I)*f*x))/(a - I*b)])/((a - I*b)^2*(a + I*b)*f) - ((2*I)*b^2*(c + d*x)^2*Log[a + I*b + (a - I*b)*E^((2*I)*e + (2*I)*f*x)])/((a^2 + b^2)^2*f) + ((2*I)*b^2*(c + d*x)^2*Log[a + I*b + (a - I*b)*E^((2*I)*(e + f*x))])/((a^2 + b^2)^2*f) - ((2*I)*b^2*(c + d*x)^2*Log[1 + ((a - I*b)*E^((2*I)*(e + f*x)))/(a + I*b)])/((a^2 + b^2)^2*f) + (I*b^2*d^2*PolyLog[2, -(((a + I*b)*E^((-2*I)*e - (2*I)*f*x))/(a - I*b))])/((a^2 + b^2)^2*f^3) - (2*b*d*(c + d*x)*PolyLog[2, -(((a + I*b)*E^((-2*I)*e - (2*I)*f*x))/(a - I*b))])/((I*a - b)*(a - I*b)^2*f^2) - (2*b^2*d*(c + d*x)*PolyLog[2, -(((a - I*b)*E^((2*I)*(e + f*x)))/(a + I*b))])/((a^2 + b^2)^2*f^2) + (b*d^2*PolyLog[3, -(((a + I*b)*E^((-2*I)*e - (2*I)*f*x))/(a - I*b))])/((a - I*b)^2*(a + I*b)*f^3) - (I*b^2*d^2*PolyLog[3, -(((a - I*b)*E^((2*I)*(e + f*x)))/(a + I*b))])/((a^2 + b^2)^2*f^3)}
{(c + d*x)^1/(a + b*Tan[e + f*x])^2, x, 5, -(c + d*x)^2/(2*(a^2 + b^2)*d) + (b*d + 2*a*c*f + 2*a*d*f*x)^2/(4*a*(a - I*b)^2*(a + I*b)*d*f^2) + (b*(b*d + 2*a*c*f + 2*a*d*f*x)*Log[1 + (a + I*b)/((a - I*b)*E^((2*I)*(e + f*x)))])/((a^2 + b^2)^2*f^2) + (I*a*b*d*PolyLog[2, -((a + I*b)/((a - I*b)*E^((2*I)*(e + f*x))))])/((a^2 + b^2)^2*f^2) - (b*(c + d*x))/((a^2 + b^2)*f*(a + b*Tan[e + f*x]))}
{1/((c + d*x)^1*(a + b*Tan[e + f*x])^2), x, 0, Defer[Int][1/((c + d*x)*(a + b*Tan[e + f*x])^2), x]}
{1/((c + d*x)^2*(a + b*Tan[e + f*x])^2), x, 0, Defer[Int][1/((c + d*x)^2*(a + b*Tan[e + f*x])^2), x]}
