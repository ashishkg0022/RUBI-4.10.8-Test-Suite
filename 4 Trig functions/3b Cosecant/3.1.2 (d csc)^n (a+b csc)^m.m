...
{Csc[e + f*x]^0*(a + b*Csc[e + f*x])^m, x, 0, Defer[Int][(a + b*Csc[e + f*x])^m, x]}
{Sin[e + f*x]^1*(a + b*Csc[e + f*x])^m, x, 0, Defer[Int][(a + b*Csc[e + f*x])^m*Sin[e + f*x], x]}
{Sin[e + f*x]^2*(a + b*Csc[e + f*x])^m, x, 0, Defer[Int][(a + b*Csc[e + f*x])^m*Sin[e + f*x]^2, x]}
