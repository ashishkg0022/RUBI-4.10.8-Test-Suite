...
{Sec[x]^1/(a + b*Csc[x]), x, 7, -(Log[1 - Sin[x]]/(2*(a + b))) + Log[1 + Sin[x]]/(2*(a - b)) - (b*Log[b + a*Sin[x]])/(a^2 - b^2)}
{Sec[x]^2/(a + b*Csc[x]), x, 6, (2*a*b*ArcTanh[(a + b*Tan[x/2])/Sqrt[a^2 - b^2]])/(a^2 - b^2)^(3/2) - (Sec[x]*(b - a*Sin[x]))/(a^2 - b^2)}
{Sec[x]^3/(a + b*Csc[x]), x, 9, -((a*Log[1 - Sin[x]])/(4*(a + b)^2)) + (a*Log[1 + Sin[x]])/(4*(a - b)^2) - (a^2*b*Log[b + a*Sin[x]])/(a^2 - b^2)^2 - (Sec[x]^2*(b - a*Sin[x]))/(2*(a^2 - b^2))}
