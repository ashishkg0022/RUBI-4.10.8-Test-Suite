...
{(c*Sec[a + b*x])^(5/2)*(d*Csc[a + b*x])^(7/2), x, 3, (64*c*d^5*(c*Sec[a + b*x])^(3/2))/(15*b*(d*Csc[a + b*x])^(3/2)) - (16*c*d^3*Sqrt[d*Csc[a + b*x]]*(c*Sec[a + b*x])^(3/2))/(5*b) - (2*c*d*(d*Csc[a + b*x])^(5/2)*(c*Sec[a + b*x])^(3/2))/(5*b)}
...
{(c*Sec[a + b*x])^(5/2)*(d*Csc[a + b*x])^(3/2), x, 2, (8*c*d^3*(c*Sec[a + b*x])^(3/2))/(3*b*(d*Csc[a + b*x])^(3/2)) - (2*c*d*Sqrt[d*Csc[a + b*x]]*(c*Sec[a + b*x])^(3/2))/b}
...
{(a*Sec[e + f*x])^m*(Csc[e + f*x])^n, x, 2, -((Cos[e + f*x]*Csc[e + f*x]^(1 + n)*Hypergeometric2F1[(1 - m)/2, (1 + n)/2, (3 - m)/2, Cos[e + f*x]^2]*(a*Sec[e + f*x])^m*(Sin[e + f*x]^2)^((1 + n)/2))/(f*(1 - m)))}
{(Sec[e + f*x])^m*(b*Csc[e + f*x])^n, x, 2, ((Cos[e + f*x]^2)^((1 + m)/2)*(b*Csc[e + f*x])^n*Hypergeometric2F1[(1 + m)/2, (1 - n)/2, (3 - n)/2, Sin[e + f*x]^2]*Sec[e + f*x]^(1 + m)*Sin[e + f*x])/(f*(1 - n))}
{(a*Sec[e + f*x])^m*(b*Csc[e + f*x])^n, x, 2, ((Cos[e + f*x]^2)^((1 + m)/2)*(b*Csc[e + f*x])^n*Hypergeometric2F1[(1 + m)/2, (1 - n)/2, (3 - n)/2, Sin[e + f*x]^2]*(a*Sec[e + f*x])^m*Tan[e + f*x])/(f*(1 - n))}
