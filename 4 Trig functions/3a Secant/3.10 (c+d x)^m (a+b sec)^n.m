...
{(a + a*Sec[e + f*x])*(c + d*x)^3, x, 11, (a*(c + d*x)^4)/(4*d) - (2*I*a*(c + d*x)^3*ArcTan[E^(I*e + I*f*x)])/f + (3*I*a*d*(c + d*x)^2*PolyLog[2, (-I)*E^(I*(e + f*x))])/f^2 - (3*I*a*d*(c + d*x)^2*PolyLog[2, I*E^(I*(e + f*x))])/f^2 - (6*a*d^2*(c + d*x)*PolyLog[3, (-I)*E^(I*(e + f*x))])/f^3 + (6*a*d^2*(c + d*x)*PolyLog[3, I*E^(I*(e + f*x))])/f^3 - (6*I*a*d^3*PolyLog[4, (-I)*E^(I*(e + f*x))])/f^4 + (6*I*a*d^3*PolyLog[4, I*E^(I*(e + f*x))])/f^4}
{(a + a*Sec[e + f*x])*(c + d*x)^2, x, 9, (a*(c + d*x)^3)/(3*d) - (2*I*a*(c + d*x)^2*ArcTan[E^(I*e + I*f*x)])/f + (2*I*a*d*(c + d*x)*PolyLog[2, (-I)*E^(I*(e + f*x))])/f^2 - (2*I*a*d*(c + d*x)*PolyLog[2, I*E^(I*(e + f*x))])/f^2 - (2*a*d^2*PolyLog[3, (-I)*E^(I*(e + f*x))])/f^3 + (2*a*d^2*PolyLog[3, I*E^(I*(e + f*x))])/f^3}
{(a + a*Sec[e + f*x])*(c + d*x)^1, x, 7, (a*(c + d*x)^2)/(2*d) - (2*I*a*(c + d*x)*ArcTan[E^(I*e + I*f*x)])/f + (I*a*d*PolyLog[2, (-I)*E^(I*(e + f*x))])/f^2 - (I*a*d*PolyLog[2, I*E^(I*(e + f*x))])/f^2}
{(a + a*Sec[e + f*x])/(c + d*x)^1, x, 0, Defer[Int][(a + a*Sec[e + f*x])/(c + d*x), x]}
{(a + a*Sec[e + f*x])/(c + d*x)^2, x, 0, Defer[Int][(a + a*Sec[e + f*x])/(c + d*x)^2, x]}


{(a + a*Sec[e + f*x])^2*(c + d*x)^3, x, 17, -((I*a^2*(c + d*x)^3)/f) + (a^2*(c + d*x)^4)/(4*d) - (4*I*a^2*(c + d*x)^3*ArcTan[E^(I*e + I*f*x)])/f + (3*a^2*d*(c + d*x)^2*Log[1 + E^(2*I*(e + f*x))])/f^2 + (6*I*a^2*d*(c + d*x)^2*PolyLog[2, (-I)*E^(I*(e + f*x))])/f^2 - (6*I*a^2*d*(c + d*x)^2*PolyLog[2, I*E^(I*(e + f*x))])/f^2 - (3*I*a^2*d^2*(c + d*x)*PolyLog[2, -E^(2*I*(e + f*x))])/f^3 - (12*a^2*d^2*(c + d*x)*PolyLog[3, (-I)*E^(I*(e + f*x))])/f^3 + (12*a^2*d^2*(c + d*x)*PolyLog[3, I*E^(I*(e + f*x))])/f^3 + (3*a^2*d^3*PolyLog[3, -E^(2*I*(e + f*x))])/(2*f^4) - (12*I*a^2*d^3*PolyLog[4, (-I)*E^(I*(e + f*x))])/f^4 + (12*I*a^2*d^3*PolyLog[4, I*E^(I*(e + f*x))])/f^4 + (a^2*(c + d*x)^3*Tan[e + f*x])/f}
{(a + a*Sec[e + f*x])^2*(c + d*x)^2, x, 14, -((I*a^2*(c + d*x)^2)/f) + (a^2*(c + d*x)^3)/(3*d) - (4*I*a^2*(c + d*x)^2*ArcTan[E^(I*e + I*f*x)])/f + (2*a^2*d*(c + d*x)*Log[1 + E^(2*I*(e + f*x))])/f^2 + (4*I*a^2*d*(c + d*x)*PolyLog[2, (-I)*E^(I*(e + f*x))])/f^2 - (4*I*a^2*d*(c + d*x)*PolyLog[2, I*E^(I*(e + f*x))])/f^2 - (I*a^2*d^2*PolyLog[2, -E^(2*I*(e + f*x))])/f^3 - (4*a^2*d^2*PolyLog[3, (-I)*E^(I*(e + f*x))])/f^3 + (4*a^2*d^2*PolyLog[3, I*E^(I*(e + f*x))])/f^3 + (a^2*(c + d*x)^2*Tan[e + f*x])/f}
{(a + a*Sec[e + f*x])^2*(c + d*x)^1, x, 9, (a^2*(c + d*x)^2)/(2*d) - (4*I*a^2*(c + d*x)*ArcTan[E^(I*e + I*f*x)])/f + (a^2*d*Log[Cos[e + f*x]])/f^2 + (2*I*a^2*d*PolyLog[2, (-I)*E^(I*(e + f*x))])/f^2 - (2*I*a^2*d*PolyLog[2, I*E^(I*(e + f*x))])/f^2 + (a^2*(c + d*x)*Tan[e + f*x])/f}
{(a + a*Sec[e + f*x])^2/(c + d*x)^1, x, 0, Defer[Int][(a + a*Sec[e + f*x])^2/(c + d*x), x]}
{(a + a*Sec[e + f*x])^2/(c + d*x)^2, x, 0, Defer[Int][(a + a*Sec[e + f*x])^2/(c + d*x)^2, x]}
...
{1/(a + a*Sec[e + f*x])/(c + d*x)^1, x, 0, Defer[Int][1/((c + d*x)*(a + a*Sec[e + f*x])), x]}
{1/(a + a*Sec[e + f*x])/(c + d*x)^2, x, 0, Defer[Int][1/((c + d*x)^2*(a + a*Sec[e + f*x])), x]}
...
{1/(a + a*Sec[e + f*x])^2/(c + d*x)^1, x, 0, Defer[Int][1/((c + d*x)*(a + a*Sec[e + f*x])^2), x]}
{1/(a + a*Sec[e + f*x])^2/(c + d*x)^2, x, 0, Defer[Int][1/((c + d*x)^2*(a + a*Sec[e + f*x])^2), x]}
...
{(c + d*x)^m*(a + a*Sec[e + f*x])^n, x, 0, Defer[Int][(c + d*x)^m*(a + a*Sec[e + f*x])^n, x]}


{(c + d*x)^m*(a + a*Sec[e + f*x])^1, x, 0, Defer[Int][(c + d*x)^m*(a + a*Sec[e + f*x]), x]}
{(c + d*x)^m/(a + a*Sec[e + f*x])^1, x, 0, Defer[Int][(c + d*x)^m/(a + a*Sec[e + f*x]), x]}
...
{(a + b*Sec[e + f*x])*(c + d*x)^3, x, 11, (a*(c + d*x)^4)/(4*d) - (2*I*b*(c + d*x)^3*ArcTan[E^(I*e + I*f*x)])/f + (3*I*b*d*(c + d*x)^2*PolyLog[2, (-I)*E^(I*(e + f*x))])/f^2 - (3*I*b*d*(c + d*x)^2*PolyLog[2, I*E^(I*(e + f*x))])/f^2 - (6*b*d^2*(c + d*x)*PolyLog[3, (-I)*E^(I*(e + f*x))])/f^3 + (6*b*d^2*(c + d*x)*PolyLog[3, I*E^(I*(e + f*x))])/f^3 - (6*I*b*d^3*PolyLog[4, (-I)*E^(I*(e + f*x))])/f^4 + (6*I*b*d^3*PolyLog[4, I*E^(I*(e + f*x))])/f^4}
{(a + b*Sec[e + f*x])*(c + d*x)^2, x, 9, (a*(c + d*x)^3)/(3*d) - (2*I*b*(c + d*x)^2*ArcTan[E^(I*e + I*f*x)])/f + (2*I*b*d*(c + d*x)*PolyLog[2, (-I)*E^(I*(e + f*x))])/f^2 - (2*I*b*d*(c + d*x)*PolyLog[2, I*E^(I*(e + f*x))])/f^2 - (2*b*d^2*PolyLog[3, (-I)*E^(I*(e + f*x))])/f^3 + (2*b*d^2*PolyLog[3, I*E^(I*(e + f*x))])/f^3}
{(a + b*Sec[e + f*x])*(c + d*x)^1, x, 7, (a*(c + d*x)^2)/(2*d) - (2*I*b*(c + d*x)*ArcTan[E^(I*e + I*f*x)])/f + (I*b*d*PolyLog[2, (-I)*E^(I*(e + f*x))])/f^2 - (I*b*d*PolyLog[2, I*E^(I*(e + f*x))])/f^2}
{(a + b*Sec[e + f*x])/(c + d*x)^1, x, 0, Defer[Int][(a + b*Sec[e + f*x])/(c + d*x), x]}
{(a + b*Sec[e + f*x])/(c + d*x)^2, x, 0, Defer[Int][(a + b*Sec[e + f*x])/(c + d*x)^2, x]}


{(a + b*Sec[e + f*x])^2*(c + d*x)^3, x, 17, -((I*b^2*(c + d*x)^3)/f) + (a^2*(c + d*x)^4)/(4*d) - (4*I*a*b*(c + d*x)^3*ArcTan[E^(I*e + I*f*x)])/f + (3*b^2*d*(c + d*x)^2*Log[1 + E^(2*I*(e + f*x))])/f^2 + (6*I*a*b*d*(c + d*x)^2*PolyLog[2, (-I)*E^(I*(e + f*x))])/f^2 - (6*I*a*b*d*(c + d*x)^2*PolyLog[2, I*E^(I*(e + f*x))])/f^2 - (3*I*b^2*d^2*(c + d*x)*PolyLog[2, -E^(2*I*(e + f*x))])/f^3 - (12*a*b*d^2*(c + d*x)*PolyLog[3, (-I)*E^(I*(e + f*x))])/f^3 + (12*a*b*d^2*(c + d*x)*PolyLog[3, I*E^(I*(e + f*x))])/f^3 + (3*b^2*d^3*PolyLog[3, -E^(2*I*(e + f*x))])/(2*f^4) - (12*I*a*b*d^3*PolyLog[4, (-I)*E^(I*(e + f*x))])/f^4 + (12*I*a*b*d^3*PolyLog[4, I*E^(I*(e + f*x))])/f^4 + (b^2*(c + d*x)^3*Tan[e + f*x])/f}
{(a + b*Sec[e + f*x])^2*(c + d*x)^2, x, 14, -((I*b^2*(c + d*x)^2)/f) + (a^2*(c + d*x)^3)/(3*d) - (4*I*a*b*(c + d*x)^2*ArcTan[E^(I*e + I*f*x)])/f + (2*b^2*d*(c + d*x)*Log[1 + E^(2*I*(e + f*x))])/f^2 + (4*I*a*b*d*(c + d*x)*PolyLog[2, (-I)*E^(I*(e + f*x))])/f^2 - (4*I*a*b*d*(c + d*x)*PolyLog[2, I*E^(I*(e + f*x))])/f^2 - (I*b^2*d^2*PolyLog[2, -E^(2*I*(e + f*x))])/f^3 - (4*a*b*d^2*PolyLog[3, (-I)*E^(I*(e + f*x))])/f^3 + (4*a*b*d^2*PolyLog[3, I*E^(I*(e + f*x))])/f^3 + (b^2*(c + d*x)^2*Tan[e + f*x])/f}
{(a + b*Sec[e + f*x])^2*(c + d*x)^1, x, 9, (a^2*(c + d*x)^2)/(2*d) - (4*I*a*b*(c + d*x)*ArcTan[E^(I*e + I*f*x)])/f + (b^2*d*Log[Cos[e + f*x]])/f^2 + (2*I*a*b*d*PolyLog[2, (-I)*E^(I*(e + f*x))])/f^2 - (2*I*a*b*d*PolyLog[2, I*E^(I*(e + f*x))])/f^2 + (b^2*(c + d*x)*Tan[e + f*x])/f}
{(a + b*Sec[e + f*x])^2/(c + d*x)^1, x, 0, Defer[Int][(a + b*Sec[e + f*x])^2/(c + d*x), x]}
{(a + b*Sec[e + f*x])^2/(c + d*x)^2, x, 0, Defer[Int][(a + b*Sec[e + f*x])^2/(c + d*x)^2, x]}
...
{1/((c + d*x)^1*(a + b*Sec[e + f*x])), x, 0, Defer[Int][1/((c + d*x)*(a + b*Sec[e + f*x])), x]}
{1/((c + d*x)^2*(a + b*Sec[e + f*x])), x, 0, Defer[Int][1/((c + d*x)^2*(a + b*Sec[e + f*x])), x]}
...
{1/((c + d*x)^1*(a + b*Sec[e + f*x])^2), x, 0, Defer[Int][1/((c + d*x)*(a + b*Sec[e + f*x])^2), x]}
{1/((c + d*x)^2*(a + b*Sec[e + f*x])^2), x, 0, Defer[Int][1/((c + d*x)^2*(a + b*Sec[e + f*x])^2), x]}
...
{(c + d*x)^m*(a + b*Sec[e + f*x])^n, x, 0, Defer[Int][(c + d*x)^m*(a + b*Sec[e + f*x])^n, x]}


{(c + d*x)^m*(a + b*Sec[e + f*x])^1, x, 0, Defer[Int][(c + d*x)^m*(a + b*Sec[e + f*x]), x]}
{(c + d*x)^m/(a + b*Sec[e + f*x])^1, x, 0, Defer[Int][(c + d*x)^m/(a + b*Sec[e + f*x]), x]}
