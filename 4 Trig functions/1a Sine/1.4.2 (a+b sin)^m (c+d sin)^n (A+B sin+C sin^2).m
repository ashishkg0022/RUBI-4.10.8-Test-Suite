...
{(a + a*Sin[e + f*x])^m*(c - c*Sin[e + f*x])^(-m - 2)*(A + B*Sin[e + f*x] + C*Sin[e + f*x]^2), x, 6, ((A + B + C)*Cos[e + f*x]*(a + a*Sin[e + f*x])^(1 + m)*(c - c*Sin[e + f*x])^(-2 - m))/(2*a*f*(3 + 2*m)) + ((A - B + C)*Cos[e + f*x]*(a + a*Sin[e + f*x])^m*(c - c*Sin[e + f*x])^(-1 - m))/(2*c*f*(1 + 2*m)) - (2^(-(1/2) - m)*C*Cos[e + f*x]^3*Hypergeometric2F1[(1/2)*(3 + 2*m), (1/2)*(3 + 2*m), (1/2)*(5 + 2*m), (1/2)*(1 + Sin[e + f*x])]*(1 - Sin[e + f*x])^((1/2)*(-1 + 2*m))*(a + a*Sin[e + f*x])^m*(c - c*Sin[e + f*x])^(-1 - m))/(c*f*(3 + 2*m))}
...
{(a + b*Sin[e + f*x])^m*(c + d*Sin[e + f*x])^n*(A + B*Sin[e + f*x] + C*Sin[e + f*x]^2), x, 0, Defer[Int][(a + b*Sin[e + f*x])^m*(c + d*Sin[e + f*x])^n*(A + B*Sin[e + f*x] + C*Sin[e + f*x]^2), x]}
