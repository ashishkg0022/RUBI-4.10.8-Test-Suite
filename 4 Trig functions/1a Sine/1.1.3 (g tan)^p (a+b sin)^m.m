...
{Cot[c + d*x]^2/(a + a*Sin[c + d*x])^4, x, 15, (4*ArcTanh[Cos[c + d*x]])/(a^4*d) - (94*Cot[c + d*x])/(15*a^4*d) + (2*Cot[c + d*x])/(5*a^4*d*(1 + Sin[c + d*x])^3) + (13*Cot[c + d*x])/(15*a^4*d*(1 + Sin[c + d*x])^2) + (4*Cot[c + d*x])/(a^4*d*(1 + Sin[c + d*x]))}
{Cot[c + d*x]^4/(a + a*Sin[c + d*x])^4, x, 17, (14*ArcTanh[Cos[c + d*x]])/(a^4*d) - (33*Cot[c + d*x])/(a^4*d) - (11*Cot[c + d*x]^3)/(a^4*d) + (14*Cot[c + d*x]*Csc[c + d*x])/(a^4*d) + (4*Cot[c + d*x]*Csc[c + d*x]^2)/(3*a^4*d*(1 + Sin[c + d*x])^2) + (28*Cot[c + d*x]*Csc[c + d*x]^2)/(3*a^4*d*(1 + Sin[c + d*x]))}
{Cot[c + d*x]^6/(a + a*Sin[c + d*x])^4, x, 16, (27*ArcTanh[Cos[c + d*x]])/(2*a^4*d) - (40*Cot[c + d*x])/(a^4*d) - (27*Cot[c + d*x]^3)/(a^4*d) - (41*Cot[c + d*x]^5)/(5*a^4*d) + (27*Cot[c + d*x]*Csc[c + d*x])/(2*a^4*d) + (9*Cot[c + d*x]*Csc[c + d*x]^3)/(a^4*d) + (8*Cot[c + d*x]*Csc[c + d*x]^4)/(a^4*d*(1 + Sin[c + d*x]))}
...
{(g*Tan[e + f*x])^p*(a + a*Sin[e + f*x])^3, x, 11, (a^3*Hypergeometric2F1[1, (1 + p)/2, (3 + p)/2, -Tan[e + f*x]^2]*(g*Tan[e + f*x])^(1 + p))/(f*g*(1 + p)) + (3*a^3*Cos[e + f*x]*(Cos[e + f*x]^2)^((1 + p)/2)*Hypergeometric2F1[(1 + p)/2, (2 + p)/2, (4 + p)/2, Sin[e + f*x]^2]*(g*Tan[e + f*x])^(2 + p))/(f*g^2*(2 + p)) + (3*a^3*Hypergeometric2F1[2, (3 + p)/2, (5 + p)/2, -Tan[e + f*x]^2]*(g*Tan[e + f*x])^(3 + p))/(f*g^3*(3 + p)) + (a^3*Cos[e + f*x]^3*(Cos[e + f*x]^2)^((1 + p)/2)*Hypergeometric2F1[(1 + p)/2, (4 + p)/2, (6 + p)/2, Sin[e + f*x]^2]*(g*Tan[e + f*x])^(4 + p))/(f*g^4*(4 + p))}
{(g*Tan[e + f*x])^p*(a + a*Sin[e + f*x])^2, x, 9, (a^2*Hypergeometric2F1[1, (1 + p)/2, (3 + p)/2, -Tan[e + f*x]^2]*(g*Tan[e + f*x])^(1 + p))/(f*g*(1 + p)) + (2*a^2*Cos[e + f*x]*(Cos[e + f*x]^2)^((1 + p)/2)*Hypergeometric2F1[(1 + p)/2, (2 + p)/2, (4 + p)/2, Sin[e + f*x]^2]*(g*Tan[e + f*x])^(2 + p))/(f*g^2*(2 + p)) + (a^2*Hypergeometric2F1[2, (3 + p)/2, (5 + p)/2, -Tan[e + f*x]^2]*(g*Tan[e + f*x])^(3 + p))/(f*g^3*(3 + p))}
{(g*Tan[e + f*x])^p*(a + a*Sin[e + f*x])^1, x, 6, (a*Hypergeometric2F1[1, (1 + p)/2, (3 + p)/2, -Tan[e + f*x]^2]*(g*Tan[e + f*x])^(1 + p))/(f*g*(1 + p)) + (a*Cos[e + f*x]*(Cos[e + f*x]^2)^((1 + p)/2)*Hypergeometric2F1[(1 + p)/2, (2 + p)/2, (4 + p)/2, Sin[e + f*x]^2]*(g*Tan[e + f*x])^(2 + p))/(f*g^2*(2 + p))}
...
{Tan[c + d*x]^3*(a + b*Sin[c + d*x]), x, 7, ((2*a + 3*b)*Log[1 - Sin[c + d*x]])/(4*d) + ((2*a - 3*b)*Log[1 + Sin[c + d*x]])/(4*d) + (3*b*Sin[c + d*x])/(2*d) + ((a + b*Sin[c + d*x])*Tan[c + d*x]^2)/(2*d)}
{Tan[c + d*x]^1*(a + b*Sin[c + d*x]), x, 6, -(((a + b)*Log[1 - Sin[c + d*x]])/(2*d)) - ((a - b)*Log[1 + Sin[c + d*x]])/(2*d) - (b*Sin[c + d*x])/d}
...
{Tan[c + d*x]^3*(a + b*Sin[c + d*x])^2, x, 3, ((a + b)*(a + 2*b)*Log[1 - Sin[c + d*x]])/(2*d) + ((a - 2*b)*(a - b)*Log[1 + Sin[c + d*x]])/(2*d) + (a + b)^2/(4*d*(1 - Sin[c + d*x])) + (2*a*b*Sin[c + d*x])/d + (b^2*Sin[c + d*x]^2)/(2*d) + (a - b)^2/(4*d*(1 + Sin[c + d*x]))}
...
{Tan[c + d*x]^4*(a + b*Sin[c + d*x])^2, x, 12, a^2*x + (5*b^2*x)/2 - (2*a*b*Cos[c + d*x])/d - (4*a*b*Sec[c + d*x])/d + (2*a*b*Sec[c + d*x]^3)/(3*d) - (a^2*Tan[c + d*x])/d - (5*b^2*Tan[c + d*x])/(2*d) + (a^2*Tan[c + d*x]^3)/(3*d) + (5*b^2*Tan[c + d*x]^3)/(6*d) - (b^2*Sin[c + d*x]^2*Tan[c + d*x]^3)/(2*d)}
{Tan[c + d*x]^2*(a + b*Sin[c + d*x])^2, x, 10, (-a^2)*x - (3*b^2*x)/2 + (2*a*b*Cos[c + d*x])/d + (2*a*b*Sec[c + d*x])/d + (a^2*Tan[c + d*x])/d + (3*b^2*Tan[c + d*x])/(2*d) - (b^2*Sin[c + d*x]^2*Tan[c + d*x])/(2*d)}
{Cot[c + d*x]^2*(a + b*Sin[c + d*x])^2, x, 8, (-a^2)*x + (b^2*x)/2 - (2*a*b*ArcTanh[Cos[c + d*x]])/d + (2*a*b*Cos[c + d*x])/d - (a^2*Cot[c + d*x])/d + (b^2*Cos[c + d*x]*Sin[c + d*x])/(2*d)}
...
{Tan[c + d*x]^3*(a + b*Sin[c + d*x])^3, x, 3, ((a + b)^2*(2*a + 5*b)*Log[1 - Sin[c + d*x]])/(4*d) + ((2*a - 5*b)*(a - b)^2*Log[1 + Sin[c + d*x]])/(4*d) + (a + b)^3/(4*d*(1 - Sin[c + d*x])) + (b*(3*a^2 + 2*b^2)*Sin[c + d*x])/d + (3*a*b^2*Sin[c + d*x]^2)/(2*d) + (b^3*Sin[c + d*x]^3)/(3*d) + (a - b)^3/(4*d*(1 + Sin[c + d*x]))}
...
{Tan[c + d*x]^4*(a + b*Sin[c + d*x])^3, x, 15, a^3*x + (15*a*b^2*x)/2 - (3*a^2*b*Cos[c + d*x])/d - (3*b^3*Cos[c + d*x])/d + (b^3*Cos[c + d*x]^3)/(3*d) - (6*a^2*b*Sec[c + d*x])/d - (3*b^3*Sec[c + d*x])/d + (a^2*b*Sec[c + d*x]^3)/d + (b^3*Sec[c + d*x]^3)/(3*d) - (a^3*Tan[c + d*x])/d - (15*a*b^2*Tan[c + d*x])/(2*d) + (a^3*Tan[c + d*x]^3)/(3*d) + (5*a*b^2*Tan[c + d*x]^3)/(2*d) - (3*a*b^2*Sin[c + d*x]^2*Tan[c + d*x]^3)/(2*d)}
{Tan[c + d*x]^2*(a + b*Sin[c + d*x])^3, x, 13, (-a^3)*x - (9/2)*a*b^2*x + (3*a^2*b*Cos[c + d*x])/d + (2*b^3*Cos[c + d*x])/d - (b^3*Cos[c + d*x]^3)/(3*d) + (3*a^2*b*Sec[c + d*x])/d + (b^3*Sec[c + d*x])/d + (a^3*Tan[c + d*x])/d + (9*a*b^2*Tan[c + d*x])/(2*d) - (3*a*b^2*Sin[c + d*x]^2*Tan[c + d*x])/(2*d)}
{Cot[c + d*x]^2*(a + b*Sin[c + d*x])^3, x, 10, (-a^3)*x + (3/2)*a*b^2*x - (3*a^2*b*ArcTanh[Cos[c + d*x]])/d + (3*a^2*b*Cos[c + d*x])/d - (b^3*Cos[c + d*x]^3)/(3*d) - (a^3*Cot[c + d*x])/d + (3*a*b^2*Cos[c + d*x]*Sin[c + d*x])/(2*d)}
{Cot[c + d*x]^4*(a + b*Sin[c + d*x])^3, x, 14, a^3*x - (9/2)*a*b^2*x + (9*a^2*b*ArcTanh[Cos[c + d*x]])/(2*d) - (b^3*ArcTanh[Cos[c + d*x]])/d - (9*a^2*b*Cos[c + d*x])/(2*d) + (b^3*Cos[c + d*x])/d + (b^3*Cos[c + d*x]^3)/(3*d) + (a^3*Cot[c + d*x])/d - (9*a*b^2*Cot[c + d*x])/(2*d) + (3*a*b^2*Cos[c + d*x]^2*Cot[c + d*x])/(2*d) - (3*a^2*b*Cos[c + d*x]*Cot[c + d*x]^2)/(2*d) - (a^3*Cot[c + d*x]^3)/(3*d)}
{Cot[c + d*x]^6*(a + b*Sin[c + d*x])^3, x, 18, (-a^3)*x + (15/2)*a*b^2*x - (45*a^2*b*ArcTanh[Cos[c + d*x]])/(8*d) + (5*b^3*ArcTanh[Cos[c + d*x]])/(2*d) + (45*a^2*b*Cos[c + d*x])/(8*d) - (5*b^3*Cos[c + d*x])/(2*d) - (5*b^3*Cos[c + d*x]^3)/(6*d) - (a^3*Cot[c + d*x])/d + (15*a*b^2*Cot[c + d*x])/(2*d) + (15*a^2*b*Cos[c + d*x]*Cot[c + d*x]^2)/(8*d) - (b^3*Cos[c + d*x]^3*Cot[c + d*x]^2)/(2*d) + (a^3*Cot[c + d*x]^3)/(3*d) - (5*a*b^2*Cot[c + d*x]^3)/(2*d) + (3*a*b^2*Cos[c + d*x]^2*Cot[c + d*x]^3)/(2*d) - (3*a^2*b*Cos[c + d*x]*Cot[c + d*x]^4)/(4*d) - (a^3*Cot[c + d*x]^5)/(5*d)}
...
{(g*Tan[e + f*x])^p*(a + b*Sin[e + f*x])^3, x, 11, (a^3*Hypergeometric2F1[1, (1 + p)/2, (3 + p)/2, -Tan[e + f*x]^2]*(g*Tan[e + f*x])^(1 + p))/(f*g*(1 + p)) + (3*a^2*b*Cos[e + f*x]*(Cos[e + f*x]^2)^((1 + p)/2)*Hypergeometric2F1[(1 + p)/2, (2 + p)/2, (4 + p)/2, Sin[e + f*x]^2]*(g*Tan[e + f*x])^(2 + p))/(f*g^2*(2 + p)) + (3*a*b^2*Hypergeometric2F1[2, (3 + p)/2, (5 + p)/2, -Tan[e + f*x]^2]*(g*Tan[e + f*x])^(3 + p))/(f*g^3*(3 + p)) + (b^3*Cos[e + f*x]^3*(Cos[e + f*x]^2)^((1 + p)/2)*Hypergeometric2F1[(1 + p)/2, (4 + p)/2, (6 + p)/2, Sin[e + f*x]^2]*(g*Tan[e + f*x])^(4 + p))/(f*g^4*(4 + p))}
{(g*Tan[e + f*x])^p*(a + b*Sin[e + f*x])^2, x, 9, (a^2*Hypergeometric2F1[1, (1 + p)/2, (3 + p)/2, -Tan[e + f*x]^2]*(g*Tan[e + f*x])^(1 + p))/(f*g*(1 + p)) + (2*a*b*Cos[e + f*x]*(Cos[e + f*x]^2)^((1 + p)/2)*Hypergeometric2F1[(1 + p)/2, (2 + p)/2, (4 + p)/2, Sin[e + f*x]^2]*(g*Tan[e + f*x])^(2 + p))/(f*g^2*(2 + p)) + (b^2*Hypergeometric2F1[2, (3 + p)/2, (5 + p)/2, -Tan[e + f*x]^2]*(g*Tan[e + f*x])^(3 + p))/(f*g^3*(3 + p))}
{(g*Tan[e + f*x])^p*(a + b*Sin[e + f*x])^1, x, 6, (a*Hypergeometric2F1[1, (1 + p)/2, (3 + p)/2, -Tan[e + f*x]^2]*(g*Tan[e + f*x])^(1 + p))/(f*g*(1 + p)) + (b*Cos[e + f*x]*(Cos[e + f*x]^2)^((1 + p)/2)*Hypergeometric2F1[(1 + p)/2, (2 + p)/2, (4 + p)/2, Sin[e + f*x]^2]*(g*Tan[e + f*x])^(2 + p))/(f*g^2*(2 + p))}
{(g*Tan[e + f*x])^p/(a + b*Sin[e + f*x])^1, x, 0, Defer[Int][(g*Tan[e + f*x])^p/(a + b*Sin[e + f*x]), x]}
{(g*Tan[e + f*x])^p/(a + b*Sin[e + f*x])^2, x, 0, Defer[Int][(g*Tan[e + f*x])^p/(a + b*Sin[e + f*x])^2, x]}
...
{(g*Tan[e + f*x])^p*(a + b*Sin[e + f*x])^m, x, 0, Defer[Int][(a + b*Sin[e + f*x])^m*(g*Tan[e + f*x])^p, x]}
