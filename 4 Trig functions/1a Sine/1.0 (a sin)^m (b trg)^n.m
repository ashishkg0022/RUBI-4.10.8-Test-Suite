...
(* ::Section::Closed:: *)
(*Integrands of the form (b Sin[c+d x]^p)^n*)


(* ::Subsection::Closed:: *)
(*Integrands of the form (b Sin[c+d x]^p)^(n/2) with p positive integer*)
...
(* ::Subsection::Closed:: *)
(*Integrands of the form (b Sin[c+d x]^p)^n with n symbolic*)


{(b*Sin[c + d*x]^p)^n, x, 2, (Cos[c + d*x]*Hypergeometric2F1[1/2, (1/2)*(1 + n*p), (1/2)*(3 + n*p), Sin[c + d*x]^2]*Sin[c + d*x]*(b*Sin[c + d*x]^p)^n)/(d*(1 + n*p)*Sqrt[Cos[c + d*x]^2])}


{(c*Sin[a + b*x]^2)^n,x, 2, (Cos[a + b*x]*Hypergeometric2F1[1/2, (1/2)*(1 + 2*n), (1/2)*(3 + 2*n), Sin[a + b*x]^2]*Sin[a + b*x]*(c*Sin[a + b*x]^2)^n)/(b*(1 + 2*n)*Sqrt[Cos[a + b*x]^2])}
{(c*Sin[a + b*x]^3)^n,x, 2, (Cos[a + b*x]*Hypergeometric2F1[1/2, (1/2)*(1 + 3*n), (3*(1 + n))/2, Sin[a + b*x]^2]*Sin[a + b*x]*(c*Sin[a + b*x]^3)^n)/(b*(1 + 3*n)*Sqrt[Cos[a + b*x]^2])}
{(c*Sin[a + b*x]^4)^n,x, 2, (Cos[a + b*x]*Hypergeometric2F1[1/2, (1/2)*(1 + 4*n), (1/2)*(3 + 4*n), Sin[a + b*x]^2]*Sin[a + b*x]*(c*Sin[a + b*x]^4)^n)/(b*(1 + 4*n)*Sqrt[Cos[a + b*x]^2])}
...
(* ::Section::Closed:: *)
(*Integrands of the form (a (b Sin[c+d x])^p)^n*)


(* ::Subsection::Closed:: *)
(*Integrands of the form (a (b Sin[c+d x])^p)^n with n symbolic*)
...
{Sec[a + b*x]^3*Sin[a + b*x]^6, x, 4, -((5*ArcTanh[Sin[a + b*x]])/(2*b)) + (5*Sin[a + b*x])/(2*b) + (5*Sin[a + b*x]^3)/(6*b) + (Sin[a + b*x]^3*Tan[a + b*x]^2)/(2*b)}
...
{Cos[a + b*x]^6/Sin[a + b*x]^3, x, 4, (5*ArcTanh[Cos[a + b*x]])/(2*b) - (5*Cos[a + b*x])/(2*b) - (5*Cos[a + b*x]^3)/(6*b) - (Cos[a + b*x]^3*Cot[a + b*x]^2)/(2*b)}
...
{Cos[a + b*x]^8/Sin[a + b*x]^5, x, 5, -((35*ArcTanh[Cos[a + b*x]])/(8*b)) + (35*Cos[a + b*x])/(8*b) + (35*Cos[a + b*x]^3)/(24*b) + (7*Cos[a + b*x]^3*Cot[a + b*x]^2)/(8*b) - (Cos[a + b*x]^3*Cot[a + b*x]^4)/(4*b)}
...
{Sin[a + b*x]^(7/2)/Cos[a + b*x]^(7/2), x, 14, ArcTan[1 - (Sqrt[2]*Sqrt[Cos[a + b*x]])/Sqrt[Sin[a + b*x]]]/(Sqrt[2]*b) - ArcTan[1 + (Sqrt[2]*Sqrt[Cos[a + b*x]])/Sqrt[Sin[a + b*x]]]/(Sqrt[2]*b) - Log[1 + Cot[a + b*x] - (Sqrt[2]*Sqrt[Cos[a + b*x]])/Sqrt[Sin[a + b*x]]]/(2*Sqrt[2]*b) + Log[1 + Cot[a + b*x] + (Sqrt[2]*Sqrt[Cos[a + b*x]])/Sqrt[Sin[a + b*x]]]/(2*Sqrt[2]*b) - (2*Sqrt[Sin[a + b*x]])/(b*Sqrt[Cos[a + b*x]]) + (2*Sin[a + b*x]^(5/2))/(5*b*Cos[a + b*x]^(5/2))}


{Sin[x]^(3/2)/Cos[x]^(7/2), x, 1, (2*Sin[x]^(5/2))/(5*Cos[x]^(5/2))}
{Sqrt[Sin[x]]/Sqrt[Cos[x]], x, 12, -(ArcTan[1 - (Sqrt[2]*Sqrt[Sin[x]])/Sqrt[Cos[x]]]/Sqrt[2]) + ArcTan[1 + (Sqrt[2]*Sqrt[Sin[x]])/Sqrt[Cos[x]]]/Sqrt[2] + Log[1 - (Sqrt[2]*Sqrt[Sin[x]])/Sqrt[Cos[x]] + Tan[x]]/(2*Sqrt[2]) - Log[1 + (Sqrt[2]*Sqrt[Sin[x]])/Sqrt[Cos[x]] + Tan[x]]/(2*Sqrt[2])}
{Sin[x]^(5/2)/Sqrt[Cos[x]], x, 13, -((3*ArcTan[1 - (Sqrt[2]*Sqrt[Sin[x]])/Sqrt[Cos[x]]])/(4*Sqrt[2])) + (3*ArcTan[1 + (Sqrt[2]*Sqrt[Sin[x]])/Sqrt[Cos[x]]])/(4*Sqrt[2]) + (3*Log[1 - (Sqrt[2]*Sqrt[Sin[x]])/Sqrt[Cos[x]] + Tan[x]])/(8*Sqrt[2]) - (3*Log[1 + (Sqrt[2]*Sqrt[Sin[x]])/Sqrt[Cos[x]] + Tan[x]])/(8*Sqrt[2]) - (1/2)*Sqrt[Cos[x]]*Sin[x]^(3/2)}
...
{Cos[a + b*x]^(1/2)/Sin[a + b*x]^(1/2), x, 12, ArcTan[1 - (Sqrt[2]*Sqrt[Cos[a + b*x]])/Sqrt[Sin[a + b*x]]]/(Sqrt[2]*b) - ArcTan[1 + (Sqrt[2]*Sqrt[Cos[a + b*x]])/Sqrt[Sin[a + b*x]]]/(Sqrt[2]*b) - Log[1 + Cot[a + b*x] - (Sqrt[2]*Sqrt[Cos[a + b*x]])/Sqrt[Sin[a + b*x]]]/(2*Sqrt[2]*b) + Log[1 + Cot[a + b*x] + (Sqrt[2]*Sqrt[Cos[a + b*x]])/Sqrt[Sin[a + b*x]]]/(2*Sqrt[2]*b)}


{Cos[a + b*x]^(3/2)/Sin[a + b*x]^(3/2), x, 13, ArcTan[1 - (Sqrt[2]*Sqrt[Sin[a + b*x]])/Sqrt[Cos[a + b*x]]]/(Sqrt[2]*b) - ArcTan[1 + (Sqrt[2]*Sqrt[Sin[a + b*x]])/Sqrt[Cos[a + b*x]]]/(Sqrt[2]*b) - Log[1 - (Sqrt[2]*Sqrt[Sin[a + b*x]])/Sqrt[Cos[a + b*x]] + Tan[a + b*x]]/(2*Sqrt[2]*b) + Log[1 + (Sqrt[2]*Sqrt[Sin[a + b*x]])/Sqrt[Cos[a + b*x]] + Tan[a + b*x]]/(2*Sqrt[2]*b) - (2*Sqrt[Cos[a + b*x]])/(b*Sqrt[Sin[a + b*x]])}


{Cos[a + b*x]^(5/2)/Sin[a + b*x]^(5/2), x, 13, -(ArcTan[1 - (Sqrt[2]*Sqrt[Cos[a + b*x]])/Sqrt[Sin[a + b*x]]]/(Sqrt[2]*b)) + ArcTan[1 + (Sqrt[2]*Sqrt[Cos[a + b*x]])/Sqrt[Sin[a + b*x]]]/(Sqrt[2]*b) + Log[1 + Cot[a + b*x] - (Sqrt[2]*Sqrt[Cos[a + b*x]])/Sqrt[Sin[a + b*x]]]/(2*Sqrt[2]*b) - Log[1 + Cot[a + b*x] + (Sqrt[2]*Sqrt[Cos[a + b*x]])/Sqrt[Sin[a + b*x]]]/(2*Sqrt[2]*b) - (2*Cos[a + b*x]^(3/2))/(3*b*Sin[a + b*x]^(3/2))}


{Cos[a + b*x]^(7/2)/Sin[a + b*x]^(7/2), x, 14, -(ArcTan[1 - (Sqrt[2]*Sqrt[Sin[a + b*x]])/Sqrt[Cos[a + b*x]]]/(Sqrt[2]*b)) + ArcTan[1 + (Sqrt[2]*Sqrt[Sin[a + b*x]])/Sqrt[Cos[a + b*x]]]/(Sqrt[2]*b) + Log[1 - (Sqrt[2]*Sqrt[Sin[a + b*x]])/Sqrt[Cos[a + b*x]] + Tan[a + b*x]]/(2*Sqrt[2]*b) - Log[1 + (Sqrt[2]*Sqrt[Sin[a + b*x]])/Sqrt[Cos[a + b*x]] + Tan[a + b*x]]/(2*Sqrt[2]*b) - (2*Cos[a + b*x]^(5/2))/(5*b*Sin[a + b*x]^(5/2)) + (2*Sqrt[Cos[a + b*x]])/(b*Sqrt[Sin[a + b*x]])}
...
{Sin[a + b*x]^(1/3)/Cos[a + b*x]^(1/3), x, 9, -((Sqrt[3]*ArcTan[(1 - (2*Sin[a + b*x]^(2/3))/Cos[a + b*x]^(2/3))/Sqrt[3]])/(2*b)) - Log[1 + Sin[a + b*x]^(2/3)/Cos[a + b*x]^(2/3)]/(2*b) + Log[1 - Sin[a + b*x]^(2/3)/Cos[a + b*x]^(2/3) + Sin[a + b*x]^(4/3)/Cos[a + b*x]^(4/3)]/(4*b)}


{Sin[a + b*x]^(2/3)/Cos[a + b*x]^(2/3), x, 13, -(ArcTan[Sqrt[3] - (2*Sin[a + b*x]^(1/3))/Cos[a + b*x]^(1/3)]/(2*b)) + ArcTan[Sqrt[3] + (2*Sin[a + b*x]^(1/3))/Cos[a + b*x]^(1/3)]/(2*b) + ArcTan[Sin[a + b*x]^(1/3)/Cos[a + b*x]^(1/3)]/b + (Sqrt[3]*Log[1 - (Sqrt[3]*Sin[a + b*x]^(1/3))/Cos[a + b*x]^(1/3) + Sin[a + b*x]^(2/3)/Cos[a + b*x]^(2/3)])/(4*b) - (Sqrt[3]*Log[1 + (Sqrt[3]*Sin[a + b*x]^(1/3))/Cos[a + b*x]^(1/3) + Sin[a + b*x]^(2/3)/Cos[a + b*x]^(2/3)])/(4*b)}


{Sin[a + b*x]^(4/3)/Cos[a + b*x]^(4/3), x, 14, -(ArcTan[Sqrt[3] - (2*Cos[a + b*x]^(1/3))/Sin[a + b*x]^(1/3)]/(2*b)) + ArcTan[Sqrt[3] + (2*Cos[a + b*x]^(1/3))/Sin[a + b*x]^(1/3)]/(2*b) + ArcTan[Cos[a + b*x]^(1/3)/Sin[a + b*x]^(1/3)]/b + (Sqrt[3]*Log[1 + Cos[a + b*x]^(2/3)/Sin[a + b*x]^(2/3) - (Sqrt[3]*Cos[a + b*x]^(1/3))/Sin[a + b*x]^(1/3)])/(4*b) - (Sqrt[3]*Log[1 + Cos[a + b*x]^(2/3)/Sin[a + b*x]^(2/3) + (Sqrt[3]*Cos[a + b*x]^(1/3))/Sin[a + b*x]^(1/3)])/(4*b) + (3*Sin[a + b*x]^(1/3))/(b*Cos[a + b*x]^(1/3))}


{Sin[a + b*x]^(5/3)/Cos[a + b*x]^(5/3), x, 10, -((Sqrt[3]*ArcTan[(1 - (2*Cos[a + b*x]^(2/3))/Sin[a + b*x]^(2/3))/Sqrt[3]])/(2*b)) + Log[1 + Cos[a + b*x]^(4/3)/Sin[a + b*x]^(4/3) - Cos[a + b*x]^(2/3)/Sin[a + b*x]^(2/3)]/(4*b) - Log[1 + Cos[a + b*x]^(2/3)/Sin[a + b*x]^(2/3)]/(2*b) + (3*Sin[a + b*x]^(2/3))/(2*b*Cos[a + b*x]^(2/3))}


{Sin[a + b*x]^(7/3)/Cos[a + b*x]^(7/3), x, 10, (Sqrt[3]*ArcTan[(1 - (2*Sin[a + b*x]^(2/3))/Cos[a + b*x]^(2/3))/Sqrt[3]])/(2*b) + Log[1 + Sin[a + b*x]^(2/3)/Cos[a + b*x]^(2/3)]/(2*b) - Log[1 - Sin[a + b*x]^(2/3)/Cos[a + b*x]^(2/3) + Sin[a + b*x]^(4/3)/Cos[a + b*x]^(4/3)]/(4*b) + (3*Sin[a + b*x]^(4/3))/(4*b*Cos[a + b*x]^(4/3))}
...
{Cos[a + b*x]^(1/3)/Sin[a + b*x]^(1/3), x, 9, (Sqrt[3]*ArcTan[(1 - (2*Cos[a + b*x]^(2/3))/Sin[a + b*x]^(2/3))/Sqrt[3]])/(2*b) - Log[1 + Cos[a + b*x]^(4/3)/Sin[a + b*x]^(4/3) - Cos[a + b*x]^(2/3)/Sin[a + b*x]^(2/3)]/(4*b) + Log[1 + Cos[a + b*x]^(2/3)/Sin[a + b*x]^(2/3)]/(2*b)}


{Cos[a + b*x]^(2/3)/Sin[a + b*x]^(2/3), x, 13, ArcTan[Sqrt[3] - (2*Cos[a + b*x]^(1/3))/Sin[a + b*x]^(1/3)]/(2*b) - ArcTan[Sqrt[3] + (2*Cos[a + b*x]^(1/3))/Sin[a + b*x]^(1/3)]/(2*b) - ArcTan[Cos[a + b*x]^(1/3)/Sin[a + b*x]^(1/3)]/b - (Sqrt[3]*Log[1 + Cos[a + b*x]^(2/3)/Sin[a + b*x]^(2/3) - (Sqrt[3]*Cos[a + b*x]^(1/3))/Sin[a + b*x]^(1/3)])/(4*b) + (Sqrt[3]*Log[1 + Cos[a + b*x]^(2/3)/Sin[a + b*x]^(2/3) + (Sqrt[3]*Cos[a + b*x]^(1/3))/Sin[a + b*x]^(1/3)])/(4*b)}


{Cos[a + b*x]^(4/3)/Sin[a + b*x]^(4/3), x, 14, ArcTan[Sqrt[3] - (2*Sin[a + b*x]^(1/3))/Cos[a + b*x]^(1/3)]/(2*b) - ArcTan[Sqrt[3] + (2*Sin[a + b*x]^(1/3))/Cos[a + b*x]^(1/3)]/(2*b) - ArcTan[Sin[a + b*x]^(1/3)/Cos[a + b*x]^(1/3)]/b - (Sqrt[3]*Log[1 - (Sqrt[3]*Sin[a + b*x]^(1/3))/Cos[a + b*x]^(1/3) + Sin[a + b*x]^(2/3)/Cos[a + b*x]^(2/3)])/(4*b) + (Sqrt[3]*Log[1 + (Sqrt[3]*Sin[a + b*x]^(1/3))/Cos[a + b*x]^(1/3) + Sin[a + b*x]^(2/3)/Cos[a + b*x]^(2/3)])/(4*b) - (3*Cos[a + b*x]^(1/3))/(b*Sin[a + b*x]^(1/3))}


{Cos[a + b*x]^(5/3)/Sin[a + b*x]^(5/3), x, 10, (Sqrt[3]*ArcTan[(1 - (2*Sin[a + b*x]^(2/3))/Cos[a + b*x]^(2/3))/Sqrt[3]])/(2*b) + Log[1 + Sin[a + b*x]^(2/3)/Cos[a + b*x]^(2/3)]/(2*b) - Log[1 - Sin[a + b*x]^(2/3)/Cos[a + b*x]^(2/3) + Sin[a + b*x]^(4/3)/Cos[a + b*x]^(4/3)]/(4*b) - (3*Cos[a + b*x]^(2/3))/(2*b*Sin[a + b*x]^(2/3))}


{Cos[a + b*x]^(7/3)/Sin[a + b*x]^(7/3), x, 10, -((Sqrt[3]*ArcTan[(1 - (2*Cos[a + b*x]^(2/3))/Sin[a + b*x]^(2/3))/Sqrt[3]])/(2*b)) + Log[1 + Cos[a + b*x]^(4/3)/Sin[a + b*x]^(4/3) - Cos[a + b*x]^(2/3)/Sin[a + b*x]^(2/3)]/(4*b) - Log[1 + Cos[a + b*x]^(2/3)/Sin[a + b*x]^(2/3)]/(2*b) - (3*Cos[a + b*x]^(4/3))/(4*b*Sin[a + b*x]^(4/3))}
...
{(Sin[e + f*x])^m*(Cos[e + f*x])^n, x, 1, (Cos[e + f*x]^(-1 + n)*(Cos[e + f*x]^2)^((1 - n)/2)*Hypergeometric2F1[(1 + m)/2, (1 - n)/2, (3 + m)/2, Sin[e + f*x]^2]*Sin[e + f*x]^(1 + m))/(f*(1 + m))}
...
{(b*Sin[e + f*x])^m*(Cos[e + f*x])^n, x, 1, (Cos[e + f*x]^(-1 + n)*(Cos[e + f*x]^2)^((1 - n)/2)*Hypergeometric2F1[(1 + m)/2, (1 - n)/2, (3 + m)/2, Sin[e + f*x]^2]*(b*Sin[e + f*x])^(1 + m))/(b*f*(1 + m))}
{(b*Sin[e + f*x])^m*(d*Cos[e + f*x])^n, x, 1, (d*(d*Cos[e + f*x])^(-1 + n)*(Cos[e + f*x]^2)^((1 - n)/2)*Hypergeometric2F1[(1 + m)/2, (1 - n)/2, (3 + m)/2, Sin[e + f*x]^2]*(b*Sin[e + f*x])^(1 + m))/(b*f*(1 + m))}
...
{Csc[e + f*x]^2*(b*Sec[e + f*x])^(5/2), x, 4, (5*b^2*Sqrt[Cos[e + f*x]]*EllipticF[(e + f*x)/2, 2]*Sqrt[b*Sec[e + f*x]])/(3*f) - (b*Csc[e + f*x]*(b*Sec[e + f*x])^(3/2))/f + (5*b*(b*Sec[e + f*x])^(3/2)*Sin[e + f*x])/(3*f)}
{Csc[e + f*x]^4*(b*Sec[e + f*x])^(5/2), x, 5, (5*b^2*Sqrt[Cos[e + f*x]]*EllipticF[(e + f*x)/2, 2]*Sqrt[b*Sec[e + f*x]])/(2*f) - (3*b*Csc[e + f*x]*(b*Sec[e + f*x])^(3/2))/(2*f) - (b*Csc[e + f*x]^3*(b*Sec[e + f*x])^(3/2))/(3*f) + (5*b*(b*Sec[e + f*x])^(3/2)*Sin[e + f*x])/(2*f)}
...
{Sin[e + f*x]^(9/2)/Sqrt[b*Sec[e + f*x]], x, 5, -((7*b*Sin[e + f*x]^(3/2))/(30*f*(b*Sec[e + f*x])^(3/2))) - (b*Sin[e + f*x]^(7/2))/(5*f*(b*Sec[e + f*x])^(3/2)) + (7*Cos[e + f*x]*EllipticE[e - Pi/4 + f*x, 2]*Sqrt[b*Sec[e + f*x]]*Sqrt[Sin[e + f*x]])/(20*b*f*Sqrt[Sin[2*e + 2*f*x]])}
{Sin[e + f*x]^(5/2)/Sqrt[b*Sec[e + f*x]], x, 4, -((b*Sin[e + f*x]^(3/2))/(3*f*(b*Sec[e + f*x])^(3/2))) + (Cos[e + f*x]*EllipticE[e - Pi/4 + f*x, 2]*Sqrt[b*Sec[e + f*x]]*Sqrt[Sin[e + f*x]])/(2*b*f*Sqrt[Sin[2*e + 2*f*x]])}
{Sin[e + f*x]^(1/2)/Sqrt[b*Sec[e + f*x]], x, 3, (Cos[e + f*x]*EllipticE[e - Pi/4 + f*x, 2]*Sqrt[b*Sec[e + f*x]]*Sqrt[Sin[e + f*x]])/(b*f*Sqrt[Sin[2*e + 2*f*x]])}
{1/(Sin[e + f*x]^(3/2)*Sqrt[b*Sec[e + f*x]]), x, 4, -((2*b)/(f*(b*Sec[e + f*x])^(3/2)*Sqrt[Sin[e + f*x]])) - (2*Cos[e + f*x]*EllipticE[e - Pi/4 + f*x, 2]*Sqrt[b*Sec[e + f*x]]*Sqrt[Sin[e + f*x]])/(b*f*Sqrt[Sin[2*e + 2*f*x]])}
{1/(Sin[e + f*x]^(7/2)*Sqrt[b*Sec[e + f*x]]), x, 5, -((2*b)/(5*f*(b*Sec[e + f*x])^(3/2)*Sin[e + f*x]^(5/2))) - (4*b)/(5*f*(b*Sec[e + f*x])^(3/2)*Sqrt[Sin[e + f*x]]) - (4*Cos[e + f*x]*EllipticE[e - Pi/4 + f*x, 2]*Sqrt[b*Sec[e + f*x]]*Sqrt[Sin[e + f*x]])/(5*b*f*Sqrt[Sin[2*e + 2*f*x]])}

{Sin[e + f*x]^(3/2)/Sqrt[b*Sec[e + f*x]], x, 14, (ArcTan[1 - (Sqrt[2]*Sqrt[b]*Sqrt[Cos[e + f*x]/b])/Sqrt[Sin[e + f*x]]]*Sqrt[Cos[e + f*x]/b]*Sqrt[b*Sec[e + f*x]])/(4*Sqrt[2]*Sqrt[b]*f) - (ArcTan[1 + (Sqrt[2]*Sqrt[b]*Sqrt[Cos[e + f*x]/b])/Sqrt[Sin[e + f*x]]]*Sqrt[Cos[e + f*x]/b]*Sqrt[b*Sec[e + f*x]])/(4*Sqrt[2]*Sqrt[b]*f) - (Sqrt[Cos[e + f*x]/b]*Log[1 + Cot[e + f*x] - (Sqrt[2]*Sqrt[b]*Sqrt[Cos[e + f*x]/b])/Sqrt[Sin[e + f*x]]]*Sqrt[b*Sec[e + f*x]])/(8*Sqrt[2]*Sqrt[b]*f) + (Sqrt[Cos[e + f*x]/b]*Log[1 + Cot[e + f*x] + (Sqrt[2]*Sqrt[b]*Sqrt[Cos[e + f*x]/b])/Sqrt[Sin[e + f*x]]]*Sqrt[b*Sec[e + f*x]])/(8*Sqrt[2]*Sqrt[b]*f) - (b*Sqrt[Sin[e + f*x]])/(2*f*(b*Sec[e + f*x])^(3/2))}
{1/(Sin[e + f*x]^(1/2)*Sqrt[b*Sec[e + f*x]]), x, 13, (ArcTan[1 - (Sqrt[2]*Sqrt[b]*Sqrt[Cos[e + f*x]/b])/Sqrt[Sin[e + f*x]]]*Sqrt[Cos[e + f*x]/b]*Sqrt[b*Sec[e + f*x]])/(Sqrt[2]*Sqrt[b]*f) - (ArcTan[1 + (Sqrt[2]*Sqrt[b]*Sqrt[Cos[e + f*x]/b])/Sqrt[Sin[e + f*x]]]*Sqrt[Cos[e + f*x]/b]*Sqrt[b*Sec[e + f*x]])/(Sqrt[2]*Sqrt[b]*f) - (Sqrt[Cos[e + f*x]/b]*Log[1 + Cot[e + f*x] - (Sqrt[2]*Sqrt[b]*Sqrt[Cos[e + f*x]/b])/Sqrt[Sin[e + f*x]]]*Sqrt[b*Sec[e + f*x]])/(2*Sqrt[2]*Sqrt[b]*f) + (Sqrt[Cos[e + f*x]/b]*Log[1 + Cot[e + f*x] + (Sqrt[2]*Sqrt[b]*Sqrt[Cos[e + f*x]/b])/Sqrt[Sin[e + f*x]]]*Sqrt[b*Sec[e + f*x]])/(2*Sqrt[2]*Sqrt[b]*f)}
...
{(c*Sin[a + b*x])^m*(d*Sec[a + b*x])^(5/2), x, 2, If[$VersionNumber>=8, (d^2*(Cos[a + b*x]^2)^(3/4)*Hypergeometric2F1[7/4, (1 + m)/2, (3 + m)/2, Sin[a + b*x]^2]*Sec[a + b*x]*Sqrt[d*Sec[a + b*x]]*(c*Sin[a + b*x])^(1 + m))/(b*c*(1 + m)), (d*(Cos[a + b*x]^2)^(3/4)*Hypergeometric2F1[7/4, (1 + m)/2, (3 + m)/2, Sin[a + b*x]^2]*(d*Sec[a + b*x])^(3/2)*(c*Sin[a + b*x])^(1 + m))/(b*c*(1 + m))]}
...
{(c*Sin[a + b*x])^m*(d*Sec[a + b*x])^(1/2), x, 2, If[$VersionNumber>=8, ((Cos[a + b*x]^2)^(3/4)*Hypergeometric2F1[3/4, (1 + m)/2, (3 + m)/2, Sin[a + b*x]^2]*Sec[a + b*x]*Sqrt[d*Sec[a + b*x]]*(c*Sin[a + b*x])^(1 + m))/(b*c*(1 + m)), ((Cos[a + b*x]^2)^(3/4)*Hypergeometric2F1[3/4, (1 + m)/2, (3 + m)/2, Sin[a + b*x]^2]*(d*Sec[a + b*x])^(3/2)*(c*Sin[a + b*x])^(1 + m))/(b*c*d*(1 + m))]}
...
{(c*Sin[a + b*x])^m/(d*Sec[a + b*x])^(3/2), x, 2, (Cos[a + b*x]*Hypergeometric2F1[-(1/4), (1 + m)/2, (3 + m)/2, Sin[a + b*x]^2]*Sqrt[d*Sec[a + b*x]]*(c*Sin[a + b*x])^(1 + m))/(b*c*d^2*(1 + m)*(Cos[a + b*x]^2)^(1/4))}
...
{(Sin[e + f*x])^m*(Sec[e + f*x])^n, x, 2, ((Cos[e + f*x]^2)^((1 + n)/2)*Hypergeometric2F1[(1 + m)/2, (1 + n)/2, (3 + m)/2, Sin[e + f*x]^2]*Sec[e + f*x]^(1 + n)*Sin[e + f*x]^(1 + m))/(f*(1 + m))}
{(a*Sin[e + f*x])^m*(Sec[e + f*x])^n, x, 2, ((Cos[e + f*x]^2)^((1 + n)/2)*Hypergeometric2F1[(1 + m)/2, (1 + n)/2, (3 + m)/2, Sin[e + f*x]^2]*Sec[e + f*x]^(1 + n)*(a*Sin[e + f*x])^(1 + m))/(a*f*(1 + m))}
{(Sin[e + f*x])^m*(b*Sec[e + f*x])^n, x, 2, -((b*Hypergeometric2F1[(1 - m)/2, (1 - n)/2, (3 - n)/2, Cos[e + f*x]^2]*(b*Sec[e + f*x])^(-1 + n)*Sin[e + f*x]^(-1 + m)*(Sin[e + f*x]^2)^((1 - m)/2))/(f*(1 - n))), -((Cos[e + f*x]*Hypergeometric2F1[(1 - m)/2, (1 - n)/2, (3 - n)/2, Cos[e + f*x]^2]*(b*Sec[e + f*x])^n*Sin[e + f*x]^(-1 + m)*(Sin[e + f*x]^2)^((1 - m)/2))/(f*(1 - n)))}
{(a*Sin[e + f*x])^m*(b*Sec[e + f*x])^n, x, 2, ((Cos[e + f*x]^2)^((1 + n)/2)*Hypergeometric2F1[(1 + m)/2, (1 + n)/2, (3 + m)/2, Sin[e + f*x]^2]*(b*Sec[e + f*x])^(1 + n)*(a*Sin[e + f*x])^(1 + m))/(a*b*f*(1 + m)), ((Cos[e + f*x]^2)^((1 + n)/2)*Hypergeometric2F1[(1 + m)/2, (1 + n)/2, (3 + m)/2, Sin[e + f*x]^2]*Sec[e + f*x]*(b*Sec[e + f*x])^n*(a*Sin[e + f*x])^(1 + m))/(a*f*(1 + m))}
...
{(b*Sec[e + f*x])^n*Sin[e + f*x]^6, x, 2, -((Cos[e + f*x]*Hypergeometric2F1[-(5/2), (1 - n)/2, (3 - n)/2, Cos[e + f*x]^2]*(b*Sec[e + f*x])^n*Sin[e + f*x])/(f*(1 - n)*Sqrt[Sin[e + f*x]^2]))}
{(b*Sec[e + f*x])^n*Sin[e + f*x]^4, x, 2, -((Cos[e + f*x]*Hypergeometric2F1[-(3/2), (1 - n)/2, (3 - n)/2, Cos[e + f*x]^2]*(b*Sec[e + f*x])^n*Sin[e + f*x])/(f*(1 - n)*Sqrt[Sin[e + f*x]^2]))}
{(b*Sec[e + f*x])^n*Sin[e + f*x]^2, x, 2, -((Cos[e + f*x]*Hypergeometric2F1[-(1/2), (1 - n)/2, (3 - n)/2, Cos[e + f*x]^2]*(b*Sec[e + f*x])^n*Sin[e + f*x])/(f*(1 - n)*Sqrt[Sin[e + f*x]^2]))}
...
{(b*Sec[e + f*x])^n*Csc[e + f*x]^2, x, 2, -((Cot[e + f*x]*Hypergeometric2F1[3/2, (1 - n)/2, (3 - n)/2, Cos[e + f*x]^2]*(b*Sec[e + f*x])^n*Sqrt[Sin[e + f*x]^2])/(f*(1 - n)))}
{(b*Sec[e + f*x])^n*Csc[e + f*x]^4, x, 2, -((Cot[e + f*x]*Hypergeometric2F1[5/2, (1 - n)/2, (3 - n)/2, Cos[e + f*x]^2]*(b*Sec[e + f*x])^n*Sqrt[Sin[e + f*x]^2])/(f*(1 - n)))}


{(b*Sec[a + b*x])^n*(c*Sin[a + b*x])^(3/2), x, 2, -((c*Cos[a + b*x]*Hypergeometric2F1[-(1/4), (1 - n)/2, (3 - n)/2, Cos[a + b*x]^2]*(b*Sec[a + b*x])^n*Sqrt[c*Sin[a + b*x]])/(b*(1 - n)*(Sin[a + b*x]^2)^(1/4)))}
{(b*Sec[a + b*x])^n*(c*Sin[a + b*x])^(1/2), x, 2, -((c*Cos[a + b*x]*Hypergeometric2F1[1/4, (1 - n)/2, (3 - n)/2, Cos[a + b*x]^2]*(b*Sec[a + b*x])^n*(Sin[a + b*x]^2)^(1/4))/(b*(1 - n)*Sqrt[c*Sin[a + b*x]]))}
{(b*Sec[a + b*x])^n/(c*Sin[a + b*x])^(1/2), x, 2, -((c*Cos[a + b*x]*Hypergeometric2F1[3/4, (1 - n)/2, (3 - n)/2, Cos[a + b*x]^2]*(b*Sec[a + b*x])^n*(Sin[a + b*x]^2)^(3/4))/(b*(1 - n)*(c*Sin[a + b*x])^(3/2)))}
{(b*Sec[a + b*x])^n/(c*Sin[a + b*x])^(3/2), x, 2, -((Cos[a + b*x]*Hypergeometric2F1[5/4, (1 - n)/2, (3 - n)/2, Cos[a + b*x]^2]*(b*Sec[a + b*x])^n*(Sin[a + b*x]^2)^(1/4))/(b*c*(1 - n)*Sqrt[c*Sin[a + b*x]]))}
