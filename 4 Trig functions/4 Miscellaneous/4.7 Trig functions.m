...
{1/(Sin[Sqrt[1 - a*x]/Sqrt[1 + a*x]]^1*(1 - a^2*x^2)), x, 1, -(Defer[Subst][Defer[Int][Csc[x]/x, x], x, Sqrt[1 - a*x]/Sqrt[1 + a*x]]/a)}
{1/(Sin[Sqrt[1 - a*x]/Sqrt[1 + a*x]]^2*(1 - a^2*x^2)), x, 1, -(Defer[Subst][Defer[Int][Csc[x]^2/x, x], x, Sqrt[1 - a*x]/Sqrt[1 + a*x]]/a)}
...
{1/(Cos[Sqrt[1 - a*x]/Sqrt[1 + a*x]]^1*(1 - a^2*x^2)), x, 1, -(Defer[Subst][Defer[Int][Sec[x]/x, x], x, Sqrt[1 - a*x]/Sqrt[1 + a*x]]/a)}
{1/(Cos[Sqrt[1 - a*x]/Sqrt[1 + a*x]]^2*(1 - a^2*x^2)), x, 1, -(Defer[Subst][Defer[Int][Sec[x]^2/x, x], x, Sqrt[1 - a*x]/Sqrt[1 + a*x]]/a)}
...
{Tan[3*x]*Sin[x], x, 5, (1/3)*ArcTanh[Sin[x]] + (1/3)*ArcTanh[2*Sin[x]] - Sin[x]}
...
{Tan[n*x]*Sin[x], x, 0, Defer[Int][Sin[x]*Tan[n*x], x]}
...
{Cot[3*x]*Cos[x], x, 5, (-(1/3))*ArcTanh[Cos[x]] - (1/3)*ArcTanh[2*Cos[x]] + Cos[x]}
...
(* Before use of TryTrigReduceQ in ExpandExpression, TrigReduce expansion resulted in infinite recursion. *)
{Cot[n*x]*Cos[x], x, 0, Defer[Int][Cos[x]*Cot[n*x], x]}
...
{x*Sec[c + d*x]^2/(a + b*Tan[c + d*x]^2), x, 9, -((I*x*Log[1 + ((a - b)*E^(2*I*(c + d*x)))/(Sqrt[a] - Sqrt[b])^2])/(2*Sqrt[a]*Sqrt[b]*d)) + (I*x*Log[1 + ((a - b)*E^(2*I*(c + d*x)))/(Sqrt[a] + Sqrt[b])^2])/(2*Sqrt[a]*Sqrt[b]*d) + PolyLog[2, -(((Sqrt[a] - Sqrt[b])*E^(2*I*(c + d*x)))/(Sqrt[a] + Sqrt[b]))]/(4*Sqrt[a]*Sqrt[b]*d^2) - PolyLog[2, -(((Sqrt[a] + Sqrt[b])*E^(2*I*(c + d*x)))/(Sqrt[a] - Sqrt[b]))]/(4*Sqrt[a]*Sqrt[b]*d^2)}
...
{(e + f*x)^3*Cos[c + d*x]^2/(a + a*Sin[c + d*x]), x, 6, (e + f*x)^4/(4*a*f) - (6*f^2*(e + f*x)*Cos[c + d*x])/(a*d^3) + ((e + f*x)^3*Cos[c + d*x])/(a*d) + (6*f^3*Sin[c + d*x])/(a*d^4) - (3*f*(e + f*x)^2*Sin[c + d*x])/(a*d^2)}
{(e + f*x)^2*Cos[c + d*x]^2/(a + a*Sin[c + d*x]), x, 5, (e + f*x)^3/(3*a*f) - (2*f^2*Cos[c + d*x])/(a*d^3) + ((e + f*x)^2*Cos[c + d*x])/(a*d) - (2*f*(e + f*x)*Sin[c + d*x])/(a*d^2)}
{(e + f*x)^1*Cos[c + d*x]^2/(a + a*Sin[c + d*x]), x, 4, (e*x)/a + (f*x^2)/(2*a) + ((e + f*x)*Cos[c + d*x])/(a*d) - (f*Sin[c + d*x])/(a*d^2)}
{(e + f*x)^0*Cos[c + d*x]^2/(a + a*Sin[c + d*x]), x, 2, x/a + Cos[c + d*x]/(a*d)}
{1/(e + f*x)^1*Cos[c + d*x]^2/(a + a*Sin[c + d*x]), x, 2, Defer[Int][Cos[c + d*x]^2/((e + f*x)*(1 + Sin[c + d*x])), x]/a}
{1/(e + f*x)^2*Cos[c + d*x]^2/(a + a*Sin[c + d*x]), x, 2, Defer[Int][Cos[c + d*x]^2/((e + f*x)^2*(1 + Sin[c + d*x])), x]/a}
...
{(1 + Sin[x]^2)/(1 - Sin[x]^2), x, 5, -x + 2*Tan[x]}
{(1 - Sin[x]^2)/(1 + Sin[x]^2), x, 4, -x + Sqrt[2]*x + Sqrt[2]*ArcTan[(Cos[x]*Sin[x])/(1 + Sqrt[2] + Sin[x]^2)]}


{(1 + Cos[x]^2)/(1 - Cos[x]^2), x, 5, -x - 2*Cot[x]}
{(1 - Cos[x]^2)/(1 + Cos[x]^2), x, 4, -x + Sqrt[2]*x - Sqrt[2]*ArcTan[(Cos[x]*Sin[x])/(1 + Sqrt[2] + Cos[x]^2)]}
...
{(a*Sec[x] + b*Tan[x])^5, x, 9, (-(1/16))*(a + b)^3*(3*a^2 - 9*a*b + 8*b^2)*Log[1 - Sin[x]] + (1/16)*(a - b)^3*(3*a^2 + 9*a*b + 8*b^2)*Log[1 + Sin[x]] - (1/8)*a*(7 - (3*a^2)/b^2)*b^4*Sin[x] + (1/4)*Sec[x]^4*(b + a*Sin[x])*(a + b*Sin[x])^4 + (1/8)*Sec[x]^2*(a + b*Sin[x])^2*(2*b*(a^2 - 2*b^2) + a*(3*a^2 - 5*b^2)*Sin[x])}
...
{(a*Sec[x] + b*Tan[x])^3, x, 8, (-(1/4))*(a - 2*b)*(a + b)^2*Log[1 - Sin[x]] + (1/4)*(a - b)^2*(a + 2*b)*Log[1 + Sin[x]] + (1/2)*a*b^2*Sin[x] + (1/2)*Sec[x]^2*(b + a*Sin[x])*(a + b*Sin[x])^2}
...
{(a*Cot[x] + b*Csc[x])^5, x, 9, (1/8)*a^2*b*(7*a^2 - 3*b^2)*Cos[x] + (1/8)*(b + a*Cos[x])^2*(2*a*(2*a^2 - b^2) + b*(5*a^2 - 3*b^2)*Cos[x])*Csc[x]^2 - (1/4)*(b + a*Cos[x])^4*(a + b*Cos[x])*Csc[x]^4 + (1/16)*(a + b)^3*(8*a^2 - 9*a*b + 3*b^2)*Log[1 - Cos[x]] + (1/16)*(a - b)^3*(8*a^2 + 9*a*b + 3*b^2)*Log[1 + Cos[x]]}
...
{(a*Cot[x] + b*Csc[x])^3, x, 8, (-(1/2))*a^2*b*Cos[x] - (1/2)*(b + a*Cos[x])^2*(a + b*Cos[x])*Csc[x]^2 - (1/4)*(2*a - b)*(a + b)^2*Log[1 - Cos[x]] - (1/4)*(a - b)^2*(2*a + b)*Log[1 + Cos[x]]}
...
{(Csc[x] - Sin[x])^3, x, 5, (5/2)*ArcTanh[Cos[x]] - (5*Cos[x])/2 - (5*Cos[x]^3)/6 - (1/2)*Cos[x]^3*Cot[x]^2}
...
{1/(Csc[x] - Sin[x])^(3/2), x, 9, Sec[x]/(2*Sqrt[Cos[x]*Cot[x]]) - (ArcTan[Sqrt[Sin[x]]]*Cos[x])/(4*Sqrt[Cos[x]*Cot[x]]*Sqrt[Sin[x]]) - (ArcTanh[Sqrt[Sin[x]]]*Cos[x])/(4*Sqrt[Cos[x]*Cot[x]]*Sqrt[Sin[x]])}
...
{1/(Csc[x] - Sin[x])^(7/2), x, 11, (5*Sec[x])/(192*Sqrt[Cos[x]*Cot[x]]) - (5*Sec[x]^3)/(48*Sqrt[Cos[x]*Cot[x]]) + (5*ArcTan[Sqrt[Sin[x]]]*Cos[x])/(128*Sqrt[Cos[x]*Cot[x]]*Sqrt[Sin[x]]) + (5*ArcTanh[Sqrt[Sin[x]]]*Cos[x])/(128*Sqrt[Cos[x]*Cot[x]]*Sqrt[Sin[x]]) + (Sec[x]^3*Tan[x]^2)/(6*Sqrt[Cos[x]*Cot[x]])}
...
{(Sec[x] - Cos[x])^3, x, 5, (-(5/2))*ArcTanh[Sin[x]] + (5*Sin[x])/2 + (5*Sin[x]^3)/6 + (1/2)*Sin[x]^3*Tan[x]^2}
...
{1/(2*a + 2*b*Cos[d + e*x] + 2*a*Sin[d + e*x])^1, x, 2, -(Log[a + b*Cot[Pi/4 + (1/2)*(d + e*x)]]/(2*b*e))}
{1/(2*a + 2*b*Cos[d + e*x] + 2*a*Sin[d + e*x])^2, x, 4, (a*Log[a + b*Cot[Pi/4 + (1/2)*(d + e*x)]])/(4*b^3*e) - (a*Cos[d + e*x] - b*Sin[d + e*x])/(4*b^2*e*(a + b*Cos[d + e*x] + a*Sin[d + e*x]))}
{1/(2*a + 2*b*Cos[d + e*x] + 2*a*Sin[d + e*x])^3, x, 4, -(((3*a^2 + b^2)*Log[a + b*Cot[Pi/4 + (1/2)*(d + e*x)]])/(16*b^5*e)) - (a*Cos[d + e*x] - b*Sin[d + e*x])/(16*b^2*e*(a + b*Cos[d + e*x] + a*Sin[d + e*x])^2) + (3*(a^2*Cos[d + e*x] - a*b*Sin[d + e*x]))/(16*b^4*e*(a + b*Cos[d + e*x] + a*Sin[d + e*x]))}
{1/(2*a + 2*b*Cos[d + e*x] + 2*a*Sin[d + e*x])^4, x, 5, (a*(5*a^2 + 3*b^2)*Log[a + b*Cot[Pi/4 + (1/2)*(d + e*x)]])/(32*b^7*e) - (a*Cos[d + e*x] - b*Sin[d + e*x])/(48*b^2*e*(a + b*Cos[d + e*x] + a*Sin[d + e*x])^3) + (5*(a^2*Cos[d + e*x] - a*b*Sin[d + e*x]))/(96*b^4*e*(a + b*Cos[d + e*x] + a*Sin[d + e*x])^2) - (a*(15*a^2 + 4*b^2)*Cos[d + e*x] - b*(15*a^2 + 4*b^2)*Sin[d + e*x])/(96*b^6*e*(a + b*Cos[d + e*x] + a*Sin[d + e*x]))}
...
{(2*a + 2*b*Cos[d + e*x] - 2*a*Sin[d + e*x])^2, x, 4, 2*(3*a^2 + b^2)*x + (6*a^2*Cos[d + e*x])/e + (6*a*b*Sin[d + e*x])/e + (2*(a + b*Cos[d + e*x] - a*Sin[d + e*x])*(a*Cos[d + e*x] + b*Sin[d + e*x]))/e}
{(2*a + 2*b*Cos[d + e*x] - 2*a*Sin[d + e*x])^1, x, 3, 2*a*x + (2*a*Cos[d + e*x])/e + (2*b*Sin[d + e*x])/e}
{1/(2*a + 2*b*Cos[d + e*x] - 2*a*Sin[d + e*x])^1, x, 2, Log[a + b*Tan[Pi/4 + (1/2)*(d + e*x)]]/(2*b*e)}
{1/(2*a + 2*b*Cos[d + e*x] - 2*a*Sin[d + e*x])^2, x, 4, -((a*Log[a + b*Tan[Pi/4 + (1/2)*(d + e*x)]])/(4*b^3*e)) + (a*Cos[d + e*x] + b*Sin[d + e*x])/(4*b^2*e*(a + b*Cos[d + e*x] - a*Sin[d + e*x]))}
{1/(2*a + 2*b*Cos[d + e*x] - 2*a*Sin[d + e*x])^3, x, 4, ((3*a^2 + b^2)*Log[a + b*Tan[Pi/4 + (1/2)*(d + e*x)]])/(16*b^5*e) + (a*Cos[d + e*x] + b*Sin[d + e*x])/(16*b^2*e*(a + b*Cos[d + e*x] - a*Sin[d + e*x])^2) - (3*(a^2*Cos[d + e*x] + a*b*Sin[d + e*x]))/(16*b^4*e*(a + b*Cos[d + e*x] - a*Sin[d + e*x]))}
{1/(2*a + 2*b*Cos[d + e*x] - 2*a*Sin[d + e*x])^4, x, 5, -((a*(5*a^2 + 3*b^2)*Log[a + b*Tan[Pi/4 + (1/2)*(d + e*x)]])/(32*b^7*e)) + (a*Cos[d + e*x] + b*Sin[d + e*x])/(48*b^2*e*(a + b*Cos[d + e*x] - a*Sin[d + e*x])^3) - (5*(a^2*Cos[d + e*x] + a*b*Sin[d + e*x]))/(96*b^4*e*(a + b*Cos[d + e*x] - a*Sin[d + e*x])^2) + (a*(15*a^2 + 4*b^2)*Cos[d + e*x] + b*(15*a^2 + 4*b^2)*Sin[d + e*x])/(96*b^6*e*(a + b*Cos[d + e*x] - a*Sin[d + e*x]))}
...
{Sec[x]^2/(a + b*Tan[x] + c*Sec[x]), x, 11, -((2*a*c*ArcTanh[(b - (a - c)*Tan[x/2])/Sqrt[a^2 + b^2 - c^2]])/((b^2 - c^2)*Sqrt[a^2 + b^2 - c^2])) - Log[1 - Tan[x/2]]/(b + c) - Log[1 + Tan[x/2]]/(b - c) + (b*Log[a + c + 2*b*Tan[x/2] - (a - c)*Tan[x/2]^2])/(b^2 - c^2)}
...
{Csc[x]^2/(a + b*Cot[x] + c*Csc[x]), x, 10, -((2*a*c*ArcTanh[(a - (b - c)*Tan[x/2])/Sqrt[a^2 + b^2 - c^2]])/((b^2 - c^2)*Sqrt[a^2 + b^2 - c^2])) + Log[Tan[x/2]]/(b + c) - (b*Log[b + c + 2*a*Tan[x/2] - (b - c)*Tan[x/2]^2])/(b^2 - c^2)}
...
{(a + b*Cos[c + d*x]*Sin[c + d*x])^2, x, 3, (1/8)*(8*a^2 + b^2)*x - (a*b*Cos[2*c + 2*d*x])/(2*d) - (b^2*Cos[2*c + 2*d*x]*Sin[2*c + 2*d*x])/(16*d)}
...
{1/(x^1*(a + b*Sin[x]*Cos[x])), x, 1, Defer[Int][1/(x*(a + (1/2)*b*Sin[2*x])), x]}
...
{Sin[a + b*x]*f[c, d, Cos[a + b*x], r, s], x, 1, -(Defer[Subst][Defer[Int][f[c, d, x, r, s], x], x, Cos[a + b*x]]/b)}
{Cos[a + b*x]*f[c, d, Sin[a + b*x], r, s], x, 1, Defer[Subst][Defer[Int][f[c, d, x, r, s], x], x, Sin[a + b*x]]/b}
{Sec[a + b*x]^2*f[c, d, Tan[a + b*x], r, s], x, 1, Defer[Subst][Defer[Int][f[c, d, x, r, s], x], x, Tan[a + b*x]]/b}
{Csc[a + b*x]^2*f[c, d, Cot[a + b*x], r, s], x, 1, -(Defer[Subst][Defer[Int][f[c, d, x, r, s], x], x, Cot[a + b*x]]/b)}
...
{Sec[x]^2/(3 - 4*Tan[x]^3), x, 8, x/(3*2^(2/3)*3^(1/6)) - ArcTan[(6^(2/3) - 2*6^(2/3)*Cos[x]^2 + 2*(3 - 2*6^(1/3))*Cos[x]*Sin[x])/(3*2^(2/3)*3^(1/6) + 4*6^(1/3) + (6 - 4*6^(1/3))*Cos[x]^2 + 2*6^(2/3)*Cos[x]*Sin[x])]/(3*2^(2/3)*3^(1/6)) - Log[3^(1/3) - 2^(2/3)*Tan[x]]/(3*6^(2/3)) + Log[3^(2/3) + 2^(2/3)*3^(1/3)*Tan[x] + 2*2^(1/3)*Tan[x]^2]/(6*6^(2/3))}
...
{Sec[x]^2/(1 + Sec[x]^2 - 3*Tan[x]), x, 3, (-(1/2))*Log[1 - 2*Cos[x]*Sin[x]] + (1/2)*Log[4 - 4*Cos[x]*Sin[x] - 3*Sin[x]^2]}
...
{Sec[x]^4*(-1 + Sec[x]^2)^2*Tan[x], x, 4, Sec[x]^4/4 - Sec[x]^6/3 + Sec[x]^8/8}
...
{(Cot[x] + Csc[x]^2)/(1 - Cos[x]^2), x, 4, -Cot[x] - Cot[x]^2/2 - Cot[x]^3/3}
...
{(Cos[x]*(-3 + 2*Sin[x]))/(2 - 3*Sin[x] + Sin[x]^2), x, 3, Log[2 - 3*Sin[x] + Sin[x]^2]}
...
{Sin[x]^2/(a + b*Sin[2*x]), x, 10, ArcTan[(b + a*Tan[x])/Sqrt[a^2 - b^2]]/(2*Sqrt[a^2 - b^2]) - Log[a + b*Sin[2*x]]/(4*b), ArcTan[(b + a*Tan[x])/Sqrt[a^2 - b^2]]/(2*Sqrt[a^2 - b^2]) - Log[Cos[x]]/(2*b) - Log[a + 2*b*Tan[x] + a*Tan[x]^2]/(4*b)}
{Cos[x]^2/(a + b*Sin[2*x]), x, 9, ArcTan[(b + a*Tan[x])/Sqrt[a^2 - b^2]]/(2*Sqrt[a^2 - b^2]) + Log[a + b*Sin[2*x]]/(4*b), ArcTan[(b + a*Tan[x])/Sqrt[a^2 - b^2]]/(2*Sqrt[a^2 - b^2]) + Log[Cos[x]]/(2*b) + Log[a + 2*b*Tan[x] + a*Tan[x]^2]/(4*b)}
...
{Tan[c + d*x]/Sqrt[a*Sin[c + d*x]^2], x, 4, ArcTanh[Sqrt[a*Sin[c + d*x]^2]/Sqrt[a]]/(Sqrt[a]*d)}
{Cot[c + d*x]/Sqrt[a*Cos[c + d*x]^2], x, 4, -(ArcTanh[Sqrt[a*Cos[c + d*x]^2]/Sqrt[a]]/(Sqrt[a]*d))}
...
{Sin[x]^3/(Cos[x]^3 + Sin[x]^3), x, 8, x/2 - (1/6)*Log[Cos[x] + Sin[x]] + (1/3)*Log[2 - Sin[2*x]], x/2 + (1/2)*Log[Cos[x]] - (1/6)*Log[1 + Tan[x]] + (1/3)*Log[1 - Tan[x] + Tan[x]^2]}
{Cos[x]^3/(Cos[x]^3 + Sin[x]^3), x, 8, x/2 + (1/6)*Log[Cos[x] + Sin[x]] - (1/3)*Log[2 - Sin[2*x]], x/2 - (1/2)*Log[Cos[x]] + (1/6)*Log[1 + Tan[x]] - (1/3)*Log[1 - Tan[x] + Tan[x]^2]}
...
{(Cos[x] + Sin[x])/Sqrt[1 + Sin[2*x]], x, -19, (x*Sqrt[1 + Sin[2*x]])/(Cos[x] + Sin[x])}
...
{Cos[x]*Sqrt[-1 + Csc[x]^2]*(1 - Sin[x]^2)^3, x, 10, -ArcTanh[Csc[x]/Sqrt[-1 + Csc[x]^2]] + Sqrt[-1 + Csc[x]^2]*Sin[x] + (1/3)*(-1 + Csc[x]^2)^(3/2)*Sin[x]^3 + (1/5)*(-1 + Csc[x]^2)^(5/2)*Sin[x]^5 + (1/7)*(-1 + Csc[x]^2)^(7/2)*Sin[x]^7}
...
{Sin[5*x]^3*Tan[5*x]^3, x, 4, (-(1/2))*ArcTanh[Sin[5*x]] + (1/2)*Sin[5*x] + (1/6)*Sin[5*x]^3 + (1/10)*Sin[5*x]^3*Tan[5*x]^2}
...
{(Cos[x] + Sin[x])/(Sqrt[Cos[x]]*Sqrt[Sin[x]]), x, -26, (-Sqrt[2])*ArcTan[1 - (Sqrt[2]*Sqrt[Sin[x]])/Sqrt[Cos[x]]] + Sqrt[2]*ArcTan[1 + (Sqrt[2]*Sqrt[Sin[x]])/Sqrt[Cos[x]]]}
...
{x^2*(Cos[a + b*x]/Sqrt[3*Sin[a + b*x] + x^3]), x, 0, Defer[Int][(x^2*Cos[a + b*x])/Sqrt[x^3 + 3*Sin[a + b*x]], x]}
...
{(Cos[a + b*x]^5 - Sin[a + b*x]^5)/(Cos[a + b*x]^5 + Sin[a + b*x]^5), x, 9, Log[Cos[a + b*x]]/b + Log[1 + Tan[a + b*x]]/(5*b) - (4*Log[2 - (1 - Sqrt[5])*Tan[a + b*x] + 2*Tan[a + b*x]^2])/(5*(1 - Sqrt[5])*b) - (4*Log[2 - (1 + Sqrt[5])*Tan[a + b*x] + 2*Tan[a + b*x]^2])/(5*(1 + Sqrt[5])*b)}
{(Cos[a + b*x]^4 - Sin[a + b*x]^4)/(Cos[a + b*x]^4 + Sin[a + b*x]^4), x, 6, -(Log[1 - Sqrt[2]*Tan[a + b*x] + Tan[a + b*x]^2]/(2*Sqrt[2]*b)) + Log[1 + Sqrt[2]*Tan[a + b*x] + Tan[a + b*x]^2]/(2*Sqrt[2]*b)}
{(Cos[a + b*x]^3 - Sin[a + b*x]^3)/(Cos[a + b*x]^3 + Sin[a + b*x]^3), x, 6, -(Log[Cos[a + b*x]]/b) + Log[1 + Tan[a + b*x]]/(3*b) - (2*Log[1 - Tan[a + b*x] + Tan[a + b*x]^2])/(3*b)}
...
{(Sec[a + b*x]^1 - Csc[a + b*x]^1)/(Sec[a + b*x]^1 + Csc[a + b*x]^1), x, If[$VersionNumber>=8, 5, 6], -(Log[Cos[a + b*x] + Sin[a + b*x]]/b)}
{(Sec[a + b*x]^2 - Csc[a + b*x]^2)/(Sec[a + b*x]^2 + Csc[a + b*x]^2), x, 2, -((Cos[a + b*x]*Sin[a + b*x])/b)}
{(Sec[a + b*x]^3 - Csc[a + b*x]^3)/(Sec[a + b*x]^3 + Csc[a + b*x]^3), x, 6, Log[Cos[a + b*x]]/b - Log[1 + Tan[a + b*x]]/(3*b) + (2*Log[1 - Tan[a + b*x] + Tan[a + b*x]^2])/(3*b)}
{(Sec[a + b*x]^4 - Csc[a + b*x]^4)/(Sec[a + b*x]^4 + Csc[a + b*x]^4), x, 6, Log[1 - Sqrt[2]*Tan[a + b*x] + Tan[a + b*x]^2]/(2*Sqrt[2]*b) - Log[1 + Sqrt[2]*Tan[a + b*x] + Tan[a + b*x]^2]/(2*Sqrt[2]*b)}
