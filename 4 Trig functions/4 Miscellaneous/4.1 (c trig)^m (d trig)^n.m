...
{Csc[a + b*x]*Csc[2*a + 2*b*x]^1, x, 3, ArcTanh[Sin[a + b*x]]/(2*b) - Csc[a + b*x]/(2*b)}
{Csc[a + b*x]*Csc[2*a + 2*b*x]^2, x, 4, -((3*ArcTanh[Cos[a + b*x]])/(8*b)) + (3*Sec[a + b*x])/(8*b) - (Csc[a + b*x]^2*Sec[a + b*x])/(8*b)}
{Csc[a + b*x]*Csc[2*a + 2*b*x]^3, x, 5, (5*ArcTanh[Sin[a + b*x]])/(16*b) - (5*Csc[a + b*x])/(16*b) - (5*Csc[a + b*x]^3)/(48*b) + (Csc[a + b*x]^3*Sec[a + b*x]^2)/(16*b)}
{Csc[a + b*x]*Csc[2*a + 2*b*x]^4, x, 6, -((35*ArcTanh[Cos[a + b*x]])/(128*b)) + (35*Sec[a + b*x])/(128*b) + (35*Sec[a + b*x]^3)/(384*b) - (7*Csc[a + b*x]^2*Sec[a + b*x]^3)/(128*b) - (Csc[a + b*x]^4*Sec[a + b*x]^3)/(64*b)}
...
{Csc[a + b*x]^3*Sin[2*a + 2*b*x]^2, x, 3, -((4*ArcTanh[Cos[a + b*x]])/b) + (4*Cos[a + b*x])/b}
{Csc[a + b*x]^3*Sin[2*a + 2*b*x]^1, x, 3, -((2*Csc[a + b*x])/b)}
{Csc[a + b*x]^3*Csc[2*a + 2*b*x]^1, x, 4, ArcTanh[Sin[a + b*x]]/(2*b) - Csc[a + b*x]/(2*b) - Csc[a + b*x]^3/(6*b)}
{Csc[a + b*x]^3*Csc[2*a + 2*b*x]^2, x, 5, -((15*ArcTanh[Cos[a + b*x]])/(32*b)) + (15*Sec[a + b*x])/(32*b) - (5*Csc[a + b*x]^2*Sec[a + b*x])/(32*b) - (Csc[a + b*x]^4*Sec[a + b*x])/(16*b)}
...
{Csc[a + b*x]^3*Csc[2*a + 2*b*x]^4, x, 7, -((105*ArcTanh[Cos[a + b*x]])/(256*b)) + (105*Sec[a + b*x])/(256*b) + (35*Sec[a + b*x]^3)/(256*b) - (21*Csc[a + b*x]^2*Sec[a + b*x]^3)/(256*b) - (3*Csc[a + b*x]^4*Sec[a + b*x]^3)/(128*b) - (Csc[a + b*x]^6*Sec[a + b*x]^3)/(96*b)}
...
{Cos[a + b*x]^3*Sin[2*a + 2*b*x]^m, x, 2, (Hypergeometric2F1[(1/2)*(-2 - m), (1 + m)/2, (3 + m)/2, Sin[a + b*x]^2]*Sin[a + b*x]*Sin[2*a + 2*b*x]^m)/((Cos[a + b*x]^2)^(m/2)*(b*(1 + m)))}
{Cos[a + b*x]^2*Sin[2*a + 2*b*x]^m, x, 2, (Cos[a + b*x]*(Cos[a + b*x]^2)^((1/2)*(-1 - m))*Hypergeometric2F1[(1/2)*(-1 - m), (1 + m)/2, (3 + m)/2, Sin[a + b*x]^2]*Sin[a + b*x]*Sin[2*a + 2*b*x]^m)/(b*(1 + m))}
{Cos[a + b*x]^1*Sin[2*a + 2*b*x]^m, x, 2, (Hypergeometric2F1[-(m/2), (1 + m)/2, (3 + m)/2, Sin[a + b*x]^2]*Sin[a + b*x]*Sin[2*a + 2*b*x]^m)/((Cos[a + b*x]^2)^(m/2)*(b*(1 + m)))}
