...
{Cos[a + b*x]*Csc[a + b*x]*(c + d*x)^m, x, 0, Defer[Int][(c + d*x)^m*Cot[a + b*x], x]}
...
{Cos[a + b*x]*Csc[a + b*x]/(c + d*x)^1, x, 0, Defer[Int][Cot[a + b*x]/(c + d*x), x]}
{Cos[a + b*x]*Csc[a + b*x]/(c + d*x)^2, x, 0, Defer[Int][Cot[a + b*x]/(c + d*x)^2, x]}


{Cos[a + b*x]*Csc[a + b*x]^2*(c + d*x)^m, x, 0, Defer[Int][(c + d*x)^m*Cot[a + b*x]*Csc[a + b*x], x]}

{Cos[a + b*x]*Csc[a + b*x]^2*(c + d*x)^4, x, 10, -((8*d*(c + d*x)^3*ArcTanh[E^(I*a + I*b*x)])/b^2) - ((c + d*x)^4*Csc[a + b*x])/b + (12*I*d^2*(c + d*x)^2*PolyLog[2, -E^(I*(a + b*x))])/b^3 - (12*I*d^2*(c + d*x)^2*PolyLog[2, E^(I*(a + b*x))])/b^3 - (24*d^3*(c + d*x)*PolyLog[3, -E^(I*(a + b*x))])/b^4 + (24*d^3*(c + d*x)*PolyLog[3, E^(I*(a + b*x))])/b^4 - (24*I*d^4*PolyLog[4, -E^(I*(a + b*x))])/b^5 + (24*I*d^4*PolyLog[4, E^(I*(a + b*x))])/b^5}
{Cos[a + b*x]*Csc[a + b*x]^2*(c + d*x)^3, x, 8, -((6*d*(c + d*x)^2*ArcTanh[E^(I*a + I*b*x)])/b^2) - ((c + d*x)^3*Csc[a + b*x])/b + (6*I*d^2*(c + d*x)*PolyLog[2, -E^(I*(a + b*x))])/b^3 - (6*I*d^2*(c + d*x)*PolyLog[2, E^(I*(a + b*x))])/b^3 - (6*d^3*PolyLog[3, -E^(I*(a + b*x))])/b^4 + (6*d^3*PolyLog[3, E^(I*(a + b*x))])/b^4}
{Cos[a + b*x]*Csc[a + b*x]^2*(c + d*x)^2, x, 6, -((4*d*(c + d*x)*ArcTanh[E^(I*a + I*b*x)])/b^2) - ((c + d*x)^2*Csc[a + b*x])/b + (2*I*d^2*PolyLog[2, -E^(I*(a + b*x))])/b^3 - (2*I*d^2*PolyLog[2, E^(I*(a + b*x))])/b^3}
{Cos[a + b*x]*Csc[a + b*x]^2*(c + d*x)^1, x, 2, -((d*ArcTanh[Cos[a + b*x]])/b^2) - ((c + d*x)*Csc[a + b*x])/b}
{Cos[a + b*x]*Csc[a + b*x]^2/(c + d*x)^1, x, 0, Defer[Int][(Cot[a + b*x]*Csc[a + b*x])/(c + d*x), x]}
{Cos[a + b*x]*Csc[a + b*x]^2/(c + d*x)^2, x, 0, Defer[Int][(Cot[a + b*x]*Csc[a + b*x])/(c + d*x)^2, x]}


{Cos[a + b*x]*Csc[a + b*x]^3*(c + d*x)^m, x, 0, Defer[Int][(c + d*x)^m*Cot[a + b*x]*Csc[a + b*x]^2, x]}
...
{Cos[a + b*x]*Csc[a + b*x]^3/(c + d*x)^1, x, 0, Defer[Int][(Cot[a + b*x]*Csc[a + b*x]^2)/(c + d*x), x]}
{Cos[a + b*x]*Csc[a + b*x]^3/(c + d*x)^2, x, 0, Defer[Int][(Cot[a + b*x]*Csc[a + b*x]^2)/(c + d*x)^2, x]}
...
{(c + d*x)^m*Cos[a + b*x]*Cot[a + b*x], x, 4, (E^(I*(a - (b*c)/d))*(c + d*x)^m*Gamma[1 + m, -((I*b*(c + d*x))/d)])/((-((I*b*(c + d*x))/d))^m*(2*b)) + ((c + d*x)^m*Gamma[1 + m, (I*b*(c + d*x))/d])/(E^(I*(a - (b*c)/d))*((I*b*(c + d*x))/d)^m*(2*b)) + Defer[Int][(c + d*x)^m*Csc[a + b*x], x]}

{(c + d*x)^4*Cos[a + b*x]*Cot[a + b*x], x, 17, -((2*(c + d*x)^4*ArcTanh[E^(I*a + I*b*x)])/b) + (24*d^4*Cos[a + b*x])/b^5 - (12*d^2*(c + d*x)^2*Cos[a + b*x])/b^3 + ((c + d*x)^4*Cos[a + b*x])/b + (4*I*d*(c + d*x)^3*PolyLog[2, -E^(I*(a + b*x))])/b^2 - (4*I*d*(c + d*x)^3*PolyLog[2, E^(I*(a + b*x))])/b^2 - (12*d^2*(c + d*x)^2*PolyLog[3, -E^(I*(a + b*x))])/b^3 + (12*d^2*(c + d*x)^2*PolyLog[3, E^(I*(a + b*x))])/b^3 - (24*I*d^3*(c + d*x)*PolyLog[4, -E^(I*(a + b*x))])/b^4 + (24*I*d^3*(c + d*x)*PolyLog[4, E^(I*(a + b*x))])/b^4 + (24*d^4*PolyLog[5, -E^(I*(a + b*x))])/b^5 - (24*d^4*PolyLog[5, E^(I*(a + b*x))])/b^5 + (24*d^3*(c + d*x)*Sin[a + b*x])/b^4 - (4*d*(c + d*x)^3*Sin[a + b*x])/b^2}
{(c + d*x)^3*Cos[a + b*x]*Cot[a + b*x], x, 14, -((2*(c + d*x)^3*ArcTanh[E^(I*a + I*b*x)])/b) - (6*d^2*(c + d*x)*Cos[a + b*x])/b^3 + ((c + d*x)^3*Cos[a + b*x])/b + (3*I*d*(c + d*x)^2*PolyLog[2, -E^(I*(a + b*x))])/b^2 - (3*I*d*(c + d*x)^2*PolyLog[2, E^(I*(a + b*x))])/b^2 - (6*d^2*(c + d*x)*PolyLog[3, -E^(I*(a + b*x))])/b^3 + (6*d^2*(c + d*x)*PolyLog[3, E^(I*(a + b*x))])/b^3 - (6*I*d^3*PolyLog[4, -E^(I*(a + b*x))])/b^4 + (6*I*d^3*PolyLog[4, E^(I*(a + b*x))])/b^4 + (6*d^3*Sin[a + b*x])/b^4 - (3*d*(c + d*x)^2*Sin[a + b*x])/b^2}
{(c + d*x)^2*Cos[a + b*x]*Cot[a + b*x], x, 11, -((2*(c + d*x)^2*ArcTanh[E^(I*a + I*b*x)])/b) - (2*d^2*Cos[a + b*x])/b^3 + ((c + d*x)^2*Cos[a + b*x])/b + (2*I*d*(c + d*x)*PolyLog[2, -E^(I*(a + b*x))])/b^2 - (2*I*d*(c + d*x)*PolyLog[2, E^(I*(a + b*x))])/b^2 - (2*d^2*PolyLog[3, -E^(I*(a + b*x))])/b^3 + (2*d^2*PolyLog[3, E^(I*(a + b*x))])/b^3 - (2*d*(c + d*x)*Sin[a + b*x])/b^2}
{(c + d*x)^1*Cos[a + b*x]*Cot[a + b*x], x, 8, -((2*(c + d*x)*ArcTanh[E^(I*a + I*b*x)])/b) + ((c + d*x)*Cos[a + b*x])/b + (I*d*PolyLog[2, -E^(I*(a + b*x))])/b^2 - (I*d*PolyLog[2, E^(I*(a + b*x))])/b^2 - (d*Sin[a + b*x])/b^2}
{(Cos[a + b*x]*Cot[a + b*x])/(c + d*x)^1, x, 4, Defer[Int][Csc[a + b*x]/(c + d*x), x] - (CosIntegral[(b*c)/d + b*x]*Sin[a - (b*c)/d])/d - (Cos[a - (b*c)/d]*SinIntegral[(b*c)/d + b*x])/d}
{(Cos[a + b*x]*Cot[a + b*x])/(c + d*x)^2, x, 5, -((b*Cos[a - (b*c)/d]*CosIntegral[(b*c)/d + b*x])/d^2) + Defer[Int][Csc[a + b*x]/(c + d*x)^2, x] + Sin[a + b*x]/(d*(c + d*x)) + (b*Sin[a - (b*c)/d]*SinIntegral[(b*c)/d + b*x])/d^2}


{(c + d*x)^m*Cot[a + b*x]^2, x, 0, Defer[Int][(c + d*x)^m*Cot[a + b*x]^2, x]}
...
{(c + d*x)^2*Cot[a + b*x]^2*Csc[a + b*x], x, 17, ((c + d*x)^2*ArcTanh[E^(I*a + I*b*x)])/b - (d^2*ArcTanh[Cos[a + b*x]])/b^3 - (d*(c + d*x)*Csc[a + b*x])/b^2 - ((c + d*x)^2*Cot[a + b*x]*Csc[a + b*x])/(2*b) - (I*d*(c + d*x)*PolyLog[2, -E^(I*(a + b*x))])/b^2 + (I*d*(c + d*x)*PolyLog[2, E^(I*(a + b*x))])/b^2 + (d^2*PolyLog[3, -E^(I*(a + b*x))])/b^3 - (d^2*PolyLog[3, E^(I*(a + b*x))])/b^3}
{(c + d*x)^1*Cot[a + b*x]^2*Csc[a + b*x], x, 12, ((c + d*x)*ArcTanh[E^(I*a + I*b*x)])/b - (d*Csc[a + b*x])/(2*b^2) - ((c + d*x)*Cot[a + b*x]*Csc[a + b*x])/(2*b) - (I*d*PolyLog[2, -E^(I*(a + b*x))])/(2*b^2) + (I*d*PolyLog[2, E^(I*(a + b*x))])/(2*b^2)}
{(Cot[a + b*x]^2*Csc[a + b*x])/(c + d*x)^1, x, 1, -Defer[Int][Csc[a + b*x]/(c + d*x), x] + Defer[Int][Csc[a + b*x]^3/(c + d*x), x]}
{(Cot[a + b*x]^2*Csc[a + b*x])/(c + d*x)^2, x, 1, -Defer[Int][Csc[a + b*x]/(c + d*x)^2, x] + Defer[Int][Csc[a + b*x]^3/(c + d*x)^2, x]}
...
{(c + d*x)^m*Cos[a + b*x]^2*Cot[a + b*x], x, 6, (2^(-3 - m)*E^(2*I*(a - (b*c)/d))*(c + d*x)^m*Gamma[1 + m, -((2*I*b*(c + d*x))/d)])/((-((I*b*(c + d*x))/d))^m*b) + (2^(-3 - m)*(c + d*x)^m*Gamma[1 + m, (2*I*b*(c + d*x))/d])/(E^(2*I*(a - (b*c)/d))*((I*b*(c + d*x))/d)^m*b) + Defer[Int][(c + d*x)^m*Cot[a + b*x], x]}
...
{(Cos[a + b*x]^2*Cot[a + b*x])/(c + d*x)^1, x, 6, Defer[Int][Cot[a + b*x]/(c + d*x), x] - (CosIntegral[(2*b*c)/d + 2*b*x]*Sin[2*a - (2*b*c)/d])/(2*d) - (Cos[2*a - (2*b*c)/d]*SinIntegral[(2*b*c)/d + 2*b*x])/(2*d)}
{(Cos[a + b*x]^2*Cot[a + b*x])/(c + d*x)^2, x, 7, -((b*Cos[2*a - (2*b*c)/d]*CosIntegral[(2*b*c)/d + 2*b*x])/d^2) + Defer[Int][Cot[a + b*x]/(c + d*x)^2, x] + Sin[2*a + 2*b*x]/(2*d*(c + d*x)) + (b*Sin[2*a - (2*b*c)/d]*SinIntegral[(2*b*c)/d + 2*b*x])/d^2}


{(c + d*x)^m*Cos[a + b*x]*Cot[a + b*x]^2, x, 4, (I*E^(I*(a - (b*c)/d))*(c + d*x)^m*Gamma[1 + m, -((I*b*(c + d*x))/d)])/((-((I*b*(c + d*x))/d))^m*(2*b)) - (I*(c + d*x)^m*Gamma[1 + m, (I*b*(c + d*x))/d])/(E^(I*(a - (b*c)/d))*((I*b*(c + d*x))/d)^m*(2*b)) + Defer[Int][(c + d*x)^m*Cot[a + b*x]*Csc[a + b*x], x]}

{(c + d*x)^4*Cos[a + b*x]*Cot[a + b*x]^2, x, 16, -((8*d*(c + d*x)^3*ArcTanh[E^(I*a + I*b*x)])/b^2) + (24*d^3*(c + d*x)*Cos[a + b*x])/b^4 - (4*d*(c + d*x)^3*Cos[a + b*x])/b^2 - ((c + d*x)^4*Csc[a + b*x])/b + (12*I*d^2*(c + d*x)^2*PolyLog[2, -E^(I*(a + b*x))])/b^3 - (12*I*d^2*(c + d*x)^2*PolyLog[2, E^(I*(a + b*x))])/b^3 - (24*d^3*(c + d*x)*PolyLog[3, -E^(I*(a + b*x))])/b^4 + (24*d^3*(c + d*x)*PolyLog[3, E^(I*(a + b*x))])/b^4 - (24*I*d^4*PolyLog[4, -E^(I*(a + b*x))])/b^5 + (24*I*d^4*PolyLog[4, E^(I*(a + b*x))])/b^5 - (24*d^4*Sin[a + b*x])/b^5 + (12*d^2*(c + d*x)^2*Sin[a + b*x])/b^3 - ((c + d*x)^4*Sin[a + b*x])/b}
{(c + d*x)^3*Cos[a + b*x]*Cot[a + b*x]^2, x, 13, -((6*d*(c + d*x)^2*ArcTanh[E^(I*a + I*b*x)])/b^2) + (6*d^3*Cos[a + b*x])/b^4 - (3*d*(c + d*x)^2*Cos[a + b*x])/b^2 - ((c + d*x)^3*Csc[a + b*x])/b + (6*I*d^2*(c + d*x)*PolyLog[2, -E^(I*(a + b*x))])/b^3 - (6*I*d^2*(c + d*x)*PolyLog[2, E^(I*(a + b*x))])/b^3 - (6*d^3*PolyLog[3, -E^(I*(a + b*x))])/b^4 + (6*d^3*PolyLog[3, E^(I*(a + b*x))])/b^4 + (6*d^2*(c + d*x)*Sin[a + b*x])/b^3 - ((c + d*x)^3*Sin[a + b*x])/b}
{(c + d*x)^2*Cos[a + b*x]*Cot[a + b*x]^2, x, 10, -((4*d*(c + d*x)*ArcTanh[E^(I*a + I*b*x)])/b^2) - (2*d*(c + d*x)*Cos[a + b*x])/b^2 - ((c + d*x)^2*Csc[a + b*x])/b + (2*I*d^2*PolyLog[2, -E^(I*(a + b*x))])/b^3 - (2*I*d^2*PolyLog[2, E^(I*(a + b*x))])/b^3 + (2*d^2*Sin[a + b*x])/b^3 - ((c + d*x)^2*Sin[a + b*x])/b}
{(c + d*x)^1*Cos[a + b*x]*Cot[a + b*x]^2, x, 5, -((d*ArcTanh[Cos[a + b*x]])/b^2) - (d*Cos[a + b*x])/b^2 - ((c + d*x)*Csc[a + b*x])/b - ((c + d*x)*Sin[a + b*x])/b}
{(Cos[a + b*x]*Cot[a + b*x]^2)/(c + d*x)^1, x, 4, -((Cos[a - (b*c)/d]*CosIntegral[(b*c)/d + b*x])/d) + Defer[Int][(Cot[a + b*x]*Csc[a + b*x])/(c + d*x), x] + (Sin[a - (b*c)/d]*SinIntegral[(b*c)/d + b*x])/d}
{(Cos[a + b*x]*Cot[a + b*x]^2)/(c + d*x)^2, x, 5, Cos[a + b*x]/(d*(c + d*x)) + Defer[Int][(Cot[a + b*x]*Csc[a + b*x])/(c + d*x)^2, x] + (b*CosIntegral[(b*c)/d + b*x]*Sin[a - (b*c)/d])/d^2 + (b*Cos[a - (b*c)/d]*SinIntegral[(b*c)/d + b*x])/d^2}


{(c + d*x)^m*Cot[a + b*x]^3, x, 0, Defer[Int][(c + d*x)^m*Cot[a + b*x]^3, x]}
...
{Cot[a + b*x]^3/(c + d*x)^1, x, 0, Defer[Int][Cot[a + b*x]^3/(c + d*x), x]}
{Cot[a + b*x]^3/(c + d*x)^2, x, 0, Defer[Int][Cot[a + b*x]^3/(c + d*x)^2, x]}
...
{Sec[a + b*x]*Sin[a + b*x]*(c + d*x)^m, x, 0, Defer[Int][(c + d*x)^m*Tan[a + b*x], x]}
...
{Sec[a + b*x]*Sin[a + b*x]/(c + d*x)^1, x, 0, Defer[Int][Tan[a + b*x]/(c + d*x), x]}
{Sec[a + b*x]*Sin[a + b*x]/(c + d*x)^2, x, 0, Defer[Int][Tan[a + b*x]/(c + d*x)^2, x]}


{Sec[a + b*x]*Sin[a + b*x]^2*(c + d*x)^m, x, 4, (I*E^(I*(a - (b*c)/d))*(c + d*x)^m*Gamma[1 + m, -((I*b*(c + d*x))/d)])/((-((I*b*(c + d*x))/d))^m*(2*b)) - (I*(c + d*x)^m*Gamma[1 + m, (I*b*(c + d*x))/d])/(E^(I*(a - (b*c)/d))*((I*b*(c + d*x))/d)^m*(2*b)) + Defer[Int][(c + d*x)^m*Sec[a + b*x], x]}

{Sec[a + b*x]*Sin[a + b*x]^2*(c + d*x)^3, x, 14, -((2*I*(c + d*x)^3*ArcTan[E^(I*a + I*b*x)])/b) + (6*d^3*Cos[a + b*x])/b^4 - (3*d*(c + d*x)^2*Cos[a + b*x])/b^2 + (3*I*d*(c + d*x)^2*PolyLog[2, (-I)*E^(I*(a + b*x))])/b^2 - (3*I*d*(c + d*x)^2*PolyLog[2, I*E^(I*(a + b*x))])/b^2 - (6*d^2*(c + d*x)*PolyLog[3, (-I)*E^(I*(a + b*x))])/b^3 + (6*d^2*(c + d*x)*PolyLog[3, I*E^(I*(a + b*x))])/b^3 - (6*I*d^3*PolyLog[4, (-I)*E^(I*(a + b*x))])/b^4 + (6*I*d^3*PolyLog[4, I*E^(I*(a + b*x))])/b^4 + (6*d^2*(c + d*x)*Sin[a + b*x])/b^3 - ((c + d*x)^3*Sin[a + b*x])/b}
{Sec[a + b*x]*Sin[a + b*x]^2*(c + d*x)^2, x, 11, -((2*I*(c + d*x)^2*ArcTan[E^(I*a + I*b*x)])/b) - (2*d*(c + d*x)*Cos[a + b*x])/b^2 + (2*I*d*(c + d*x)*PolyLog[2, (-I)*E^(I*(a + b*x))])/b^2 - (2*I*d*(c + d*x)*PolyLog[2, I*E^(I*(a + b*x))])/b^2 - (2*d^2*PolyLog[3, (-I)*E^(I*(a + b*x))])/b^3 + (2*d^2*PolyLog[3, I*E^(I*(a + b*x))])/b^3 + (2*d^2*Sin[a + b*x])/b^3 - ((c + d*x)^2*Sin[a + b*x])/b}
{Sec[a + b*x]*Sin[a + b*x]^2*(c + d*x)^1, x, 8, -((2*I*(c + d*x)*ArcTan[E^(I*a + I*b*x)])/b) - (d*Cos[a + b*x])/b^2 + (I*d*PolyLog[2, (-I)*E^(I*(a + b*x))])/b^2 - (I*d*PolyLog[2, I*E^(I*(a + b*x))])/b^2 - ((c + d*x)*Sin[a + b*x])/b}
{Sec[a + b*x]*Sin[a + b*x]^2/(c + d*x)^1, x, 4, -((Cos[a - (b*c)/d]*CosIntegral[(b*c)/d + b*x])/d) + Defer[Int][Sec[a + b*x]/(c + d*x), x] + (Sin[a - (b*c)/d]*SinIntegral[(b*c)/d + b*x])/d}
{Sec[a + b*x]*Sin[a + b*x]^2/(c + d*x)^2, x, 5, Cos[a + b*x]/(d*(c + d*x)) + Defer[Int][Sec[a + b*x]/(c + d*x)^2, x] + (b*CosIntegral[(b*c)/d + b*x]*Sin[a - (b*c)/d])/d^2 + (b*Cos[a - (b*c)/d]*SinIntegral[(b*c)/d + b*x])/d^2}


{Sec[a + b*x]*Sin[a + b*x]^3*(c + d*x)^m, x, 6, (2^(-3 - m)*E^(2*I*(a - (b*c)/d))*(c + d*x)^m*Gamma[1 + m, -((2*I*b*(c + d*x))/d)])/((-((I*b*(c + d*x))/d))^m*b) + (2^(-3 - m)*(c + d*x)^m*Gamma[1 + m, (2*I*b*(c + d*x))/d])/(E^(2*I*(a - (b*c)/d))*((I*b*(c + d*x))/d)^m*b) + Defer[Int][(c + d*x)^m*Tan[a + b*x], x]}
...
{Sec[a + b*x]*Sin[a + b*x]^3/(c + d*x)^1, x, 6, Defer[Int][Tan[a + b*x]/(c + d*x), x] - (CosIntegral[(2*b*c)/d + 2*b*x]*Sin[2*a - (2*b*c)/d])/(2*d) - (Cos[2*a - (2*b*c)/d]*SinIntegral[(2*b*c)/d + 2*b*x])/(2*d)}
{Sec[a + b*x]*Sin[a + b*x]^3/(c + d*x)^2, x, 7, -((b*Cos[2*a - (2*b*c)/d]*CosIntegral[(2*b*c)/d + 2*b*x])/d^2) + Defer[Int][Tan[a + b*x]/(c + d*x)^2, x] + Sin[2*a + 2*b*x]/(2*d*(c + d*x)) + (b*Sin[2*a - (2*b*c)/d]*SinIntegral[(2*b*c)/d + 2*b*x])/d^2}
...
{Sec[a + b*x]*Csc[a + b*x]*(c + d*x)^m, x, 0, Defer[Int][(c + d*x)^m*Csc[a + b*x]*Sec[a + b*x], x]}

{Sec[a + b*x]*Csc[a + b*x]*(c + d*x)^4, x, 12, -((2*(c + d*x)^4*ArcTanh[E^(2*I*a + 2*I*b*x)])/b) + (2*I*d*(c + d*x)^3*PolyLog[2, -E^(2*I*(a + b*x))])/b^2 - (2*I*d*(c + d*x)^3*PolyLog[2, E^(2*I*(a + b*x))])/b^2 - (3*d^2*(c + d*x)^2*PolyLog[3, -E^(2*I*(a + b*x))])/b^3 + (3*d^2*(c + d*x)^2*PolyLog[3, E^(2*I*(a + b*x))])/b^3 - (3*I*d^3*(c + d*x)*PolyLog[4, -E^(2*I*(a + b*x))])/b^4 + (3*I*d^3*(c + d*x)*PolyLog[4, E^(2*I*(a + b*x))])/b^4 + (3*d^4*PolyLog[5, -E^(2*I*(a + b*x))])/(2*b^5) - (3*d^4*PolyLog[5, E^(2*I*(a + b*x))])/(2*b^5)}
{Sec[a + b*x]*Csc[a + b*x]*(c + d*x)^3, x, 10, -((2*(c + d*x)^3*ArcTanh[E^(2*I*a + 2*I*b*x)])/b) + (3*I*d*(c + d*x)^2*PolyLog[2, -E^(2*I*(a + b*x))])/(2*b^2) - (3*I*d*(c + d*x)^2*PolyLog[2, E^(2*I*(a + b*x))])/(2*b^2) - (3*d^2*(c + d*x)*PolyLog[3, -E^(2*I*(a + b*x))])/(2*b^3) + (3*d^2*(c + d*x)*PolyLog[3, E^(2*I*(a + b*x))])/(2*b^3) - (3*I*d^3*PolyLog[4, -E^(2*I*(a + b*x))])/(4*b^4) + (3*I*d^3*PolyLog[4, E^(2*I*(a + b*x))])/(4*b^4)}
{Sec[a + b*x]*Csc[a + b*x]*(c + d*x)^2, x, 8, -((2*(c + d*x)^2*ArcTanh[E^(2*I*a + 2*I*b*x)])/b) + (I*d*(c + d*x)*PolyLog[2, -E^(2*I*(a + b*x))])/b^2 - (I*d*(c + d*x)*PolyLog[2, E^(2*I*(a + b*x))])/b^2 - (d^2*PolyLog[3, -E^(2*I*(a + b*x))])/(2*b^3) + (d^2*PolyLog[3, E^(2*I*(a + b*x))])/(2*b^3)}
{Sec[a + b*x]*Csc[a + b*x]*(c + d*x)^1, x, 6, -((2*(c + d*x)*ArcTanh[E^(2*I*a + 2*I*b*x)])/b) + (I*d*PolyLog[2, -E^(2*I*(a + b*x))])/(2*b^2) - (I*d*PolyLog[2, E^(2*I*(a + b*x))])/(2*b^2)}
{Sec[a + b*x]*Csc[a + b*x]/(c + d*x)^1, x, 1, 2*Defer[Int][Csc[2*a + 2*b*x]/(c + d*x), x]}
{Sec[a + b*x]*Csc[a + b*x]/(c + d*x)^2, x, 1, 2*Defer[Int][Csc[2*a + 2*b*x]/(c + d*x)^2, x]}


{Sec[a + b*x]*Csc[a + b*x]^2*(c + d*x)^m, x, 0, Defer[Int][(c + d*x)^m*Csc[a + b*x]^2*Sec[a + b*x], x]}

{Sec[a + b*x]*Csc[a + b*x]^2*(c + d*x)^3, x, 23, -((2*I*(c + d*x)^3*ArcTan[E^(I*a + I*b*x)])/b) - (6*d*(c + d*x)^2*ArcTanh[E^(I*a + I*b*x)])/b^2 - ((c + d*x)^3*Csc[a + b*x])/b + (6*I*d^2*(c + d*x)*PolyLog[2, -E^(I*(a + b*x))])/b^3 + (3*I*d*(c + d*x)^2*PolyLog[2, (-I)*E^(I*(a + b*x))])/b^2 - (3*I*d*(c + d*x)^2*PolyLog[2, I*E^(I*(a + b*x))])/b^2 - (6*I*d^2*(c + d*x)*PolyLog[2, E^(I*(a + b*x))])/b^3 - (6*d^3*PolyLog[3, -E^(I*(a + b*x))])/b^4 - (6*d^2*(c + d*x)*PolyLog[3, (-I)*E^(I*(a + b*x))])/b^3 + (6*d^2*(c + d*x)*PolyLog[3, I*E^(I*(a + b*x))])/b^3 + (6*d^3*PolyLog[3, E^(I*(a + b*x))])/b^4 - (6*I*d^3*PolyLog[4, (-I)*E^(I*(a + b*x))])/b^4 + (6*I*d^3*PolyLog[4, I*E^(I*(a + b*x))])/b^4}
{Sec[a + b*x]*Csc[a + b*x]^2*(c + d*x)^2, x, 19, -((2*I*(c + d*x)^2*ArcTan[E^(I*a + I*b*x)])/b) - (4*d*(c + d*x)*ArcTanh[E^(I*a + I*b*x)])/b^2 - ((c + d*x)^2*Csc[a + b*x])/b + (2*I*d^2*PolyLog[2, -E^(I*(a + b*x))])/b^3 + (2*I*d*(c + d*x)*PolyLog[2, (-I)*E^(I*(a + b*x))])/b^2 - (2*I*d*(c + d*x)*PolyLog[2, I*E^(I*(a + b*x))])/b^2 - (2*I*d^2*PolyLog[2, E^(I*(a + b*x))])/b^3 - (2*d^2*PolyLog[3, (-I)*E^(I*(a + b*x))])/b^3 + (2*d^2*PolyLog[3, I*E^(I*(a + b*x))])/b^3}
{Sec[a + b*x]*Csc[a + b*x]^2*(c + d*x)^1, x, 10, -((2*I*d*x*ArcTan[E^(I*a + I*b*x)])/b) - (d*ArcTanh[Cos[a + b*x]])/b^2 - (d*x*ArcTanh[Sin[a + b*x]])/b + ((c + d*x)*ArcTanh[Sin[a + b*x]])/b - ((c + d*x)*Csc[a + b*x])/b + (I*d*PolyLog[2, (-I)*E^(I*(a + b*x))])/b^2 - (I*d*PolyLog[2, I*E^(I*(a + b*x))])/b^2}
{Sec[a + b*x]*Csc[a + b*x]^2/(c + d*x)^1, x, 0, Defer[Int][(Csc[a + b*x]^2*Sec[a + b*x])/(c + d*x), x]}
{Sec[a + b*x]*Csc[a + b*x]^2/(c + d*x)^2, x, 0, Defer[Int][(Csc[a + b*x]^2*Sec[a + b*x])/(c + d*x)^2, x]}


{Sec[a + b*x]*Csc[a + b*x]^3*(c + d*x)^m, x, 0, Defer[Int][(c + d*x)^m*Csc[a + b*x]^3*Sec[a + b*x], x]}

{Sec[a + b*x]*Csc[a + b*x]^3*(c + d*x)^3, x, 22, -((3*I*d*(c + d*x)^2)/(2*b^2)) - (c + d*x)^3/(2*b) - (2*(c + d*x)^3*ArcTanh[E^(2*I*a + 2*I*b*x)])/b - (3*d*(c + d*x)^2*Cot[a + b*x])/(2*b^2) - ((c + d*x)^3*Cot[a + b*x]^2)/(2*b) + (3*d^2*(c + d*x)*Log[1 - E^(2*I*(a + b*x))])/b^3 + (3*I*d*(c + d*x)^2*PolyLog[2, -E^(2*I*(a + b*x))])/(2*b^2) - (3*I*d^3*PolyLog[2, E^(2*I*(a + b*x))])/(2*b^4) - (3*I*d*(c + d*x)^2*PolyLog[2, E^(2*I*(a + b*x))])/(2*b^2) - (3*d^2*(c + d*x)*PolyLog[3, -E^(2*I*(a + b*x))])/(2*b^3) + (3*d^2*(c + d*x)*PolyLog[3, E^(2*I*(a + b*x))])/(2*b^3) - (3*I*d^3*PolyLog[4, -E^(2*I*(a + b*x))])/(4*b^4) + (3*I*d^3*PolyLog[4, E^(2*I*(a + b*x))])/(4*b^4)}
{Sec[a + b*x]*Csc[a + b*x]^3*(c + d*x)^2, x, 17, -((c*d*x)/b) - (d^2*x^2)/(2*b) - (2*(c + d*x)^2*ArcTanh[E^(2*I*a + 2*I*b*x)])/b - (d*(c + d*x)*Cot[a + b*x])/b^2 - ((c + d*x)^2*Cot[a + b*x]^2)/(2*b) + (d^2*Log[Sin[a + b*x]])/b^3 + (I*d*(c + d*x)*PolyLog[2, -E^(2*I*(a + b*x))])/b^2 - (I*d*(c + d*x)*PolyLog[2, E^(2*I*(a + b*x))])/b^2 - (d^2*PolyLog[3, -E^(2*I*(a + b*x))])/(2*b^3) + (d^2*PolyLog[3, E^(2*I*(a + b*x))])/(2*b^3)}
{Sec[a + b*x]*Csc[a + b*x]^3*(c + d*x)^1, x, 11, -((d*x)/(2*b)) - (2*d*x*ArcTanh[E^(2*I*a + 2*I*b*x)])/b - (d*Cot[a + b*x])/(2*b^2) - ((c + d*x)*Cot[a + b*x]^2)/(2*b) - (d*x*Log[Tan[a + b*x]])/b + ((c + d*x)*Log[Tan[a + b*x]])/b + (I*d*PolyLog[2, -E^(2*I*(a + b*x))])/(2*b^2) - (I*d*PolyLog[2, E^(2*I*(a + b*x))])/(2*b^2)}
{Sec[a + b*x]*Csc[a + b*x]^3/(c + d*x)^1, x, 0, Defer[Int][(Csc[a + b*x]^3*Sec[a + b*x])/(c + d*x), x]}
{Sec[a + b*x]*Csc[a + b*x]^3/(c + d*x)^2, x, 0, Defer[Int][(Csc[a + b*x]^3*Sec[a + b*x])/(c + d*x)^2, x]}
...
{(c + d*x)^m*Sec[a + b*x]*Tan[a + b*x], x, 0, Defer[Int][(c + d*x)^m*Sec[a + b*x]*Tan[a + b*x], x]}

{(c + d*x)^4*Sec[a + b*x]*Tan[a + b*x], x, 10, ((8*I)*d*(c + d*x)^3*ArcTan[E^(I*a + I*b*x)])/b^2 - ((12*I)*d^2*(c + d*x)^2*PolyLog[2, (-I)*E^(I*(a + b*x))])/b^3 + ((12*I)*d^2*(c + d*x)^2*PolyLog[2, I*E^(I*(a + b*x))])/b^3 + (24*d^3*(c + d*x)*PolyLog[3, (-I)*E^(I*(a + b*x))])/b^4 - (24*d^3*(c + d*x)*PolyLog[3, I*E^(I*(a + b*x))])/b^4 + ((24*I)*d^4*PolyLog[4, (-I)*E^(I*(a + b*x))])/b^5 - ((24*I)*d^4*PolyLog[4, I*E^(I*(a + b*x))])/b^5 + ((c + d*x)^4*Sec[a + b*x])/b}
{(c + d*x)^3*Sec[a + b*x]*Tan[a + b*x], x, 8, ((6*I)*d*(c + d*x)^2*ArcTan[E^(I*a + I*b*x)])/b^2 - ((6*I)*d^2*(c + d*x)*PolyLog[2, (-I)*E^(I*(a + b*x))])/b^3 + ((6*I)*d^2*(c + d*x)*PolyLog[2, I*E^(I*(a + b*x))])/b^3 + (6*d^3*PolyLog[3, (-I)*E^(I*(a + b*x))])/b^4 - (6*d^3*PolyLog[3, I*E^(I*(a + b*x))])/b^4 + ((c + d*x)^3*Sec[a + b*x])/b}
{(c + d*x)^2*Sec[a + b*x]*Tan[a + b*x], x, 6, ((4*I)*d*(c + d*x)*ArcTan[E^(I*a + I*b*x)])/b^2 - ((2*I)*d^2*PolyLog[2, (-I)*E^(I*(a + b*x))])/b^3 + ((2*I)*d^2*PolyLog[2, I*E^(I*(a + b*x))])/b^3 + ((c + d*x)^2*Sec[a + b*x])/b}
{(c + d*x)^1*Sec[a + b*x]*Tan[a + b*x], x, 2, -((d*ArcTanh[Sin[a + b*x]])/b^2) + ((c + d*x)*Sec[a + b*x])/b}
{(Sec[a + b*x]*Tan[a + b*x])/(c + d*x)^1, x, 0, Defer[Int][(Sec[a + b*x]*Tan[a + b*x])/(c + d*x), x]}
{(Sec[a + b*x]*Tan[a + b*x])/(c + d*x)^2, x, 0, Defer[Int][(Sec[a + b*x]*Tan[a + b*x])/(c + d*x)^2, x]}


{(c + d*x)^m*Tan[a + b*x]^2, x, 0, Defer[Int][(c + d*x)^m*Tan[a + b*x]^2, x]}
...
{Tan[a + b*x]^2/(c + d*x)^1, x, 0, Defer[Int][Tan[a + b*x]^2/(c + d*x), x]}
{Tan[a + b*x]^2/(c + d*x)^2, x, 0, Defer[Int][Tan[a + b*x]^2/(c + d*x)^2, x]}


{(c + d*x)^m*Sin[a + b*x]*Tan[a + b*x]^2, x, 4, (E^(I*(a - (b*c)/d))*(c + d*x)^m*Gamma[1 + m, -((I*b*(c + d*x))/d)])/((-((I*b*(c + d*x))/d))^m*(2*b)) + ((c + d*x)^m*Gamma[1 + m, (I*b*(c + d*x))/d])/(E^(I*(a - (b*c)/d))*((I*b*(c + d*x))/d)^m*(2*b)) + Defer[Int][(c + d*x)^m*Sec[a + b*x]*Tan[a + b*x], x]}

{(c + d*x)^3*Sin[a + b*x]*Tan[a + b*x]^2, x, 13, (6*I*d*(c + d*x)^2*ArcTan[E^(I*a + I*b*x)])/b^2 - (6*d^2*(c + d*x)*Cos[a + b*x])/b^3 + ((c + d*x)^3*Cos[a + b*x])/b - (6*I*d^2*(c + d*x)*PolyLog[2, (-I)*E^(I*(a + b*x))])/b^3 + (6*I*d^2*(c + d*x)*PolyLog[2, I*E^(I*(a + b*x))])/b^3 + (6*d^3*PolyLog[3, (-I)*E^(I*(a + b*x))])/b^4 - (6*d^3*PolyLog[3, I*E^(I*(a + b*x))])/b^4 + ((c + d*x)^3*Sec[a + b*x])/b + (6*d^3*Sin[a + b*x])/b^4 - (3*d*(c + d*x)^2*Sin[a + b*x])/b^2}
{(c + d*x)^2*Sin[a + b*x]*Tan[a + b*x]^2, x, 10, (4*I*d*(c + d*x)*ArcTan[E^(I*a + I*b*x)])/b^2 - (2*d^2*Cos[a + b*x])/b^3 + ((c + d*x)^2*Cos[a + b*x])/b - (2*I*d^2*PolyLog[2, (-I)*E^(I*(a + b*x))])/b^3 + (2*I*d^2*PolyLog[2, I*E^(I*(a + b*x))])/b^3 + ((c + d*x)^2*Sec[a + b*x])/b - (2*d*(c + d*x)*Sin[a + b*x])/b^2}
{(c + d*x)^1*Sin[a + b*x]*Tan[a + b*x]^2, x, 5, -((d*ArcTanh[Sin[a + b*x]])/b^2) + ((c + d*x)*Cos[a + b*x])/b + ((c + d*x)*Sec[a + b*x])/b - (d*Sin[a + b*x])/b^2}
{(Sin[a + b*x]*Tan[a + b*x]^2)/(c + d*x)^1, x, 4, Defer[Int][(Sec[a + b*x]*Tan[a + b*x])/(c + d*x), x] - (CosIntegral[(b*c)/d + b*x]*Sin[a - (b*c)/d])/d - (Cos[a - (b*c)/d]*SinIntegral[(b*c)/d + b*x])/d}
{(Sin[a + b*x]*Tan[a + b*x]^2)/(c + d*x)^2, x, 5, -((b*Cos[a - (b*c)/d]*CosIntegral[(b*c)/d + b*x])/d^2) + Defer[Int][(Sec[a + b*x]*Tan[a + b*x])/(c + d*x)^2, x] + Sin[a + b*x]/(d*(c + d*x)) + (b*Sin[a - (b*c)/d]*SinIntegral[(b*c)/d + b*x])/d^2}
...
{(Csc[a + b*x]^2*Sec[a + b*x]^2)/(c + d*x)^1, x, 1, 4*Defer[Int][Csc[2*a + 2*b*x]^2/(c + d*x), x]}
{(Csc[a + b*x]^2*Sec[a + b*x]^2)/(c + d*x)^2, x, 1, 4*Defer[Int][Csc[2*a + 2*b*x]^2/(c + d*x)^2, x]}


{(c + d*x)^m*Csc[a + b*x]^3*Sec[a + b*x]^2, x, 0, Defer[Int][(c + d*x)^m*Csc[a + b*x]^3*Sec[a + b*x]^2, x]}

{(c + d*x)^3*Csc[a + b*x]^3*Sec[a + b*x]^2, x, 64, (12*I*c*d^2*x*ArcTan[E^(I*a + I*b*x)])/b^2 + (6*I*d^3*x^2*ArcTan[E^(I*a + I*b*x)])/b^2 - (6*d^3*x*ArcTanh[E^(I*a + I*b*x)])/b^3 - (3*(c + d*x)^3*ArcTanh[E^(I*a + I*b*x)])/b - (3*c*d^2*ArcTanh[Cos[a + b*x]])/b^3 - (3*c^2*d*ArcTanh[Sin[a + b*x]])/b^2 - (3*c^2*d*Csc[a + b*x])/(2*b^2) - (3*c*d^2*x*Csc[a + b*x])/b^2 - (3*d^3*x^2*Csc[a + b*x])/(2*b^2) + (3*I*d^3*PolyLog[2, -E^(I*(a + b*x))])/b^4 + (9*I*d*(c + d*x)^2*PolyLog[2, -E^(I*(a + b*x))])/(2*b^2) - (6*I*c*d^2*PolyLog[2, (-I)*E^(I*(a + b*x))])/b^3 - (6*I*d^3*x*PolyLog[2, (-I)*E^(I*(a + b*x))])/b^3 + (6*I*c*d^2*PolyLog[2, I*E^(I*(a + b*x))])/b^3 + (6*I*d^3*x*PolyLog[2, I*E^(I*(a + b*x))])/b^3 - (3*I*d^3*PolyLog[2, E^(I*(a + b*x))])/b^4 - (9*I*d*(c + d*x)^2*PolyLog[2, E^(I*(a + b*x))])/(2*b^2) - (9*d^2*(c + d*x)*PolyLog[3, -E^(I*(a + b*x))])/b^3 + (6*d^3*PolyLog[3, (-I)*E^(I*(a + b*x))])/b^4 - (6*d^3*PolyLog[3, I*E^(I*(a + b*x))])/b^4 + (9*d^2*(c + d*x)*PolyLog[3, E^(I*(a + b*x))])/b^3 - (9*I*d^3*PolyLog[4, -E^(I*(a + b*x))])/b^4 + (9*I*d^3*PolyLog[4, E^(I*(a + b*x))])/b^4 + (3*(c + d*x)^3*Sec[a + b*x])/(2*b) - ((c + d*x)^3*Csc[a + b*x]^2*Sec[a + b*x])/(2*b)}
{(c + d*x)^2*Csc[a + b*x]^3*Sec[a + b*x]^2, x, 36, (4*I*d^2*x*ArcTan[E^(I*a + I*b*x)])/b^2 - (3*(c + d*x)^2*ArcTanh[E^(I*a + I*b*x)])/b - (d^2*ArcTanh[Cos[a + b*x]])/b^3 - (2*c*d*ArcTanh[Sin[a + b*x]])/b^2 - (c*d*Csc[a + b*x])/b^2 - (d^2*x*Csc[a + b*x])/b^2 + (3*I*d*(c + d*x)*PolyLog[2, -E^(I*(a + b*x))])/b^2 - (2*I*d^2*PolyLog[2, (-I)*E^(I*(a + b*x))])/b^3 + (2*I*d^2*PolyLog[2, I*E^(I*(a + b*x))])/b^3 - (3*I*d*(c + d*x)*PolyLog[2, E^(I*(a + b*x))])/b^2 - (3*d^2*PolyLog[3, -E^(I*(a + b*x))])/b^3 + (3*d^2*PolyLog[3, E^(I*(a + b*x))])/b^3 + (3*(c + d*x)^2*Sec[a + b*x])/(2*b) - ((c + d*x)^2*Csc[a + b*x]^2*Sec[a + b*x])/(2*b)}
{(c + d*x)^1*Csc[a + b*x]^3*Sec[a + b*x]^2, x, 12, -((3*d*x*ArcTanh[E^(I*a + I*b*x)])/b) - (3*c*ArcTanh[Cos[a + b*x]])/(2*b) - (d*ArcTanh[Sin[a + b*x]])/b^2 - (d*Csc[a + b*x])/(2*b^2) + (3*I*d*PolyLog[2, -E^(I*(a + b*x))])/(2*b^2) - (3*I*d*PolyLog[2, E^(I*(a + b*x))])/(2*b^2) + (3*(c + d*x)*Sec[a + b*x])/(2*b) - ((c + d*x)*Csc[a + b*x]^2*Sec[a + b*x])/(2*b), -((3*d*x*ArcTanh[E^(I*a + I*b*x)])/b) + (3*d*x*ArcTanh[Cos[a + b*x]])/(2*b) - (3*(c + d*x)*ArcTanh[Cos[a + b*x]])/(2*b) - (d*ArcTanh[Sin[a + b*x]])/b^2 - (d*Csc[a + b*x])/(2*b^2) + (3*I*d*PolyLog[2, -E^(I*(a + b*x))])/(2*b^2) - (3*I*d*PolyLog[2, E^(I*(a + b*x))])/(2*b^2) + (3*(c + d*x)*Sec[a + b*x])/(2*b) - ((c + d*x)*Csc[a + b*x]^2*Sec[a + b*x])/(2*b)}
{(Csc[a + b*x]^3*Sec[a + b*x]^2)/(c + d*x)^1, x, 0, Defer[Int][(Csc[a + b*x]^3*Sec[a + b*x]^2)/(c + d*x), x]}
{(Csc[a + b*x]^3*Sec[a + b*x]^2)/(c + d*x)^2, x, 0, Defer[Int][(Csc[a + b*x]^3*Sec[a + b*x]^2)/(c + d*x)^2, x]}


{x^m*Csc[a + b*x]^3*Sec[a + b*x]^2, x, 0, Defer[Int][x^m*Csc[a + b*x]^3*Sec[a + b*x]^2, x]}

{x^3*Csc[a + b*x]^3*Sec[a + b*x]^2, x, 40, ((6*I)*x^2*ArcTan[E^(I*a + I*b*x)])/b^2 - (6*x*ArcTanh[E^(I*a + I*b*x)])/b^3 - (3*x^3*ArcTanh[E^(I*a + I*b*x)])/b - (3*x^2*Csc[a + b*x])/(2*b^2) + ((3*I)*PolyLog[2, -E^(I*(a + b*x))])/b^4 + (((9*I)/2)*x^2*PolyLog[2, -E^(I*(a + b*x))])/b^2 - ((6*I)*x*PolyLog[2, (-I)*E^(I*(a + b*x))])/b^3 + ((6*I)*x*PolyLog[2, I*E^(I*(a + b*x))])/b^3 - ((3*I)*PolyLog[2, E^(I*(a + b*x))])/b^4 - (((9*I)/2)*x^2*PolyLog[2, E^(I*(a + b*x))])/b^2 - (9*x*PolyLog[3, -E^(I*(a + b*x))])/b^3 + (6*PolyLog[3, (-I)*E^(I*(a + b*x))])/b^4 - (6*PolyLog[3, I*E^(I*(a + b*x))])/b^4 + (9*x*PolyLog[3, E^(I*(a + b*x))])/b^3 - ((9*I)*PolyLog[4, -E^(I*(a + b*x))])/b^4 + ((9*I)*PolyLog[4, E^(I*(a + b*x))])/b^4 + (3*x^3*Sec[a + b*x])/(2*b) - (x^3*Csc[a + b*x]^2*Sec[a + b*x])/(2*b)}
{x^2*Csc[a + b*x]^3*Sec[a + b*x]^2, x, 29, ((4*I)*x*ArcTan[E^(I*a + I*b*x)])/b^2 - (3*x^2*ArcTanh[E^(I*a + I*b*x)])/b - ArcTanh[Cos[a + b*x]]/b^3 - (x*Csc[a + b*x])/b^2 + ((3*I)*x*PolyLog[2, -E^(I*(a + b*x))])/b^2 - ((2*I)*PolyLog[2, (-I)*E^(I*(a + b*x))])/b^3 + ((2*I)*PolyLog[2, I*E^(I*(a + b*x))])/b^3 - ((3*I)*x*PolyLog[2, E^(I*(a + b*x))])/b^2 - (3*PolyLog[3, -E^(I*(a + b*x))])/b^3 + (3*PolyLog[3, E^(I*(a + b*x))])/b^3 + (3*x^2*Sec[a + b*x])/(2*b) - (x^2*Csc[a + b*x]^2*Sec[a + b*x])/(2*b)}
{x*Csc[a + b*x]^3*Sec[a + b*x]^2, x, 12, (-3*x*ArcTanh[E^(I*a + I*b*x)])/b - ArcTanh[Sin[a + b*x]]/b^2 - Csc[a + b*x]/(2*b^2) + (((3*I)/2)*PolyLog[2, -E^(I*(a + b*x))])/b^2 - (((3*I)/2)*PolyLog[2, E^(I*(a + b*x))])/b^2 + (3*x*Sec[a + b*x])/(2*b) - (x*Csc[a + b*x]^2*Sec[a + b*x])/(2*b)}
{(Csc[a + b*x]^3*Sec[a + b*x]^2)/x, x, 0, Defer[Int][(Csc[a + b*x]^3*Sec[a + b*x]^2)/x, x]}
{(Csc[a + b*x]^3*Sec[a + b*x]^2)/x^2, x, 0, Defer[Int][(Csc[a + b*x]^3*Sec[a + b*x]^2)/x^2, x]}
...
{(c + d*x)^m*Sec[a + b*x]^2*Tan[a + b*x], x, 0, Defer[Int][(c + d*x)^m*Sec[a + b*x]^2*Tan[a + b*x], x]}
...
{(Sec[a + b*x]^2*Tan[a + b*x])/(c + d*x)^1, x, 0, Defer[Int][(Sec[a + b*x]^2*Tan[a + b*x])/(c + d*x), x]}
{(Sec[a + b*x]^2*Tan[a + b*x])/(c + d*x)^2, x, 0, Defer[Int][(Sec[a + b*x]^2*Tan[a + b*x])/(c + d*x)^2, x]}


{(c + d*x)^m*Sec[a + b*x]*Tan[a + b*x]^2, x, 1, -Defer[Int][(c + d*x)^m*Sec[a + b*x], x] + Defer[Int][(c + d*x)^m*Sec[a + b*x]^3, x]}
...
{(c + d*x)^2*Sec[a + b*x]*Tan[a + b*x]^2, x, 17, (I*(c + d*x)^2*ArcTan[E^(I*a + I*b*x)])/b + (d^2*ArcTanh[Sin[a + b*x]])/b^3 - (I*d*(c + d*x)*PolyLog[2, (-I)*E^(I*(a + b*x))])/b^2 + (I*d*(c + d*x)*PolyLog[2, I*E^(I*(a + b*x))])/b^2 + (d^2*PolyLog[3, (-I)*E^(I*(a + b*x))])/b^3 - (d^2*PolyLog[3, I*E^(I*(a + b*x))])/b^3 - (d*(c + d*x)*Sec[a + b*x])/b^2 + ((c + d*x)^2*Sec[a + b*x]*Tan[a + b*x])/(2*b)}
{(c + d*x)^1*Sec[a + b*x]*Tan[a + b*x]^2, x, 12, (I*(c + d*x)*ArcTan[E^(I*a + I*b*x)])/b - (I*d*PolyLog[2, (-I)*E^(I*(a + b*x))])/(2*b^2) + (I*d*PolyLog[2, I*E^(I*(a + b*x))])/(2*b^2) - (d*Sec[a + b*x])/(2*b^2) + ((c + d*x)*Sec[a + b*x]*Tan[a + b*x])/(2*b)}
{(Sec[a + b*x]*Tan[a + b*x]^2)/(c + d*x)^1, x, 1, -Defer[Int][Sec[a + b*x]/(c + d*x), x] + Defer[Int][Sec[a + b*x]^3/(c + d*x), x]}
{(Sec[a + b*x]*Tan[a + b*x]^2)/(c + d*x)^2, x, 1, -Defer[Int][Sec[a + b*x]/(c + d*x)^2, x] + Defer[Int][Sec[a + b*x]^3/(c + d*x)^2, x]}


{(c + d*x)^m*Tan[a + b*x]^3, x, 0, Defer[Int][(c + d*x)^m*Tan[a + b*x]^3, x]}
...
{Tan[a + b*x]^3/(c + d*x)^1, x, 0, Defer[Int][Tan[a + b*x]^3/(c + d*x), x]}
{Tan[a + b*x]^3/(c + d*x)^2, x, 0, Defer[Int][Tan[a + b*x]^3/(c + d*x)^2, x]}
...
{(c + d*x)^3*Csc[a + b*x]^2*Sin[3*a + 3*b*x], x, 20, -((6*(c + d*x)^3*ArcTanh[E^(I*a + I*b*x)])/b) - (24*d^2*(c + d*x)*Cos[a + b*x])/b^3 + (4*(c + d*x)^3*Cos[a + b*x])/b + (9*I*d*(c + d*x)^2*PolyLog[2, -E^(I*(a + b*x))])/b^2 - (9*I*d*(c + d*x)^2*PolyLog[2, E^(I*(a + b*x))])/b^2 - (18*d^2*(c + d*x)*PolyLog[3, -E^(I*(a + b*x))])/b^3 + (18*d^2*(c + d*x)*PolyLog[3, E^(I*(a + b*x))])/b^3 - (18*I*d^3*PolyLog[4, -E^(I*(a + b*x))])/b^4 + (18*I*d^3*PolyLog[4, E^(I*(a + b*x))])/b^4 + (24*d^3*Sin[a + b*x])/b^4 - (12*d*(c + d*x)^2*Sin[a + b*x])/b^2}
{(c + d*x)^2*Csc[a + b*x]^2*Sin[3*a + 3*b*x], x, 16, -((6*(c + d*x)^2*ArcTanh[E^(I*a + I*b*x)])/b) - (8*d^2*Cos[a + b*x])/b^3 + (4*(c + d*x)^2*Cos[a + b*x])/b + (6*I*d*(c + d*x)*PolyLog[2, -E^(I*(a + b*x))])/b^2 - (6*I*d*(c + d*x)*PolyLog[2, E^(I*(a + b*x))])/b^2 - (6*d^2*PolyLog[3, -E^(I*(a + b*x))])/b^3 + (6*d^2*PolyLog[3, E^(I*(a + b*x))])/b^3 - (8*d*(c + d*x)*Sin[a + b*x])/b^2}
{(c + d*x)^1*Csc[a + b*x]^2*Sin[3*a + 3*b*x], x, 12, -((6*(c + d*x)*ArcTanh[E^(I*a + I*b*x)])/b) + (4*(c + d*x)*Cos[a + b*x])/b + (3*I*d*PolyLog[2, -E^(I*(a + b*x))])/b^2 - (3*I*d*PolyLog[2, E^(I*(a + b*x))])/b^2 - (4*d*Sin[a + b*x])/b^2}
{Csc[a + b*x]^2*Sin[3*a + 3*b*x]/(c + d*x)^1, x, 9, 3*Defer[Int][Csc[a + b*x]/(c + d*x), x] - (4*CosIntegral[(b*c)/d + b*x]*Sin[a - (b*c)/d])/d - (4*Cos[a - (b*c)/d]*SinIntegral[(b*c)/d + b*x])/d}
{Csc[a + b*x]^2*Sin[3*a + 3*b*x]/(c + d*x)^2, x, 11, -((4*b*Cos[a - (b*c)/d]*CosIntegral[(b*c)/d + b*x])/d^2) + 3*Defer[Int][Csc[a + b*x]/(c + d*x)^2, x] + (4*Sin[a + b*x])/(d*(c + d*x)) + (4*b*Sin[a - (b*c)/d]*SinIntegral[(b*c)/d + b*x])/d^2}
{Csc[a + b*x]^2*Sin[3*a + 3*b*x]/(c + d*x)^3, x, 13, (2*b*Cos[a + b*x])/(d^2*(c + d*x)) + 3*Defer[Int][Csc[a + b*x]/(c + d*x)^3, x] + (2*b^2*CosIntegral[(b*c)/d + b*x]*Sin[a - (b*c)/d])/d^3 + (2*Sin[a + b*x])/(d*(c + d*x)^2) + (2*b^2*Cos[a - (b*c)/d]*SinIntegral[(b*c)/d + b*x])/d^3}
...
{Sec[a + b*x]*Sin[3*a + 3*b*x]/(c + d*x)^1, x, 13, -Defer[Int][Tan[a + b*x]/(c + d*x), x] + (2*CosIntegral[(2*b*c)/d + 2*b*x]*Sin[2*a - (2*b*c)/d])/d + (2*Cos[2*a - (2*b*c)/d]*SinIntegral[(2*b*c)/d + 2*b*x])/d}
{Sec[a + b*x]*Sin[3*a + 3*b*x]/(c + d*x)^2, x, 15, (4*b*Cos[2*a - (2*b*c)/d]*CosIntegral[(2*b*c)/d + 2*b*x])/d^2 - Defer[Int][Tan[a + b*x]/(c + d*x)^2, x] - (2*Sin[2*a + 2*b*x])/(d*(c + d*x)) - (4*b*Sin[2*a - (2*b*c)/d]*SinIntegral[(2*b*c)/d + 2*b*x])/d^2}
{Sec[a + b*x]*Sin[3*a + 3*b*x]/(c + d*x)^3, x, 17, -((2*b*Cos[2*a + 2*b*x])/(d^2*(c + d*x))) - Defer[Int][Tan[a + b*x]/(c + d*x)^3, x] - (4*b^2*CosIntegral[(2*b*c)/d + 2*b*x]*Sin[2*a - (2*b*c)/d])/d^3 - Sin[2*a + 2*b*x]/(d*(c + d*x)^2) - (4*b^2*Cos[2*a - (2*b*c)/d]*SinIntegral[(2*b*c)/d + 2*b*x])/d^3}


{(c + d*x)^3*Sec[a + b*x]^2*Sin[3*a + 3*b*x], x, 19, -((6*I*d*(c + d*x)^2*ArcTan[E^(I*a + I*b*x)])/b^2) + (24*d^2*(c + d*x)*Cos[a + b*x])/b^3 - (4*(c + d*x)^3*Cos[a + b*x])/b + (6*I*d^2*(c + d*x)*PolyLog[2, (-I)*E^(I*(a + b*x))])/b^3 - (6*I*d^2*(c + d*x)*PolyLog[2, I*E^(I*(a + b*x))])/b^3 - (6*d^3*PolyLog[3, (-I)*E^(I*(a + b*x))])/b^4 + (6*d^3*PolyLog[3, I*E^(I*(a + b*x))])/b^4 - ((c + d*x)^3*Sec[a + b*x])/b - (24*d^3*Sin[a + b*x])/b^4 + (12*d*(c + d*x)^2*Sin[a + b*x])/b^2}
{(c + d*x)^2*Sec[a + b*x]^2*Sin[3*a + 3*b*x], x, 15, -((4*I*d*(c + d*x)*ArcTan[E^(I*a + I*b*x)])/b^2) + (8*d^2*Cos[a + b*x])/b^3 - (4*(c + d*x)^2*Cos[a + b*x])/b + (2*I*d^2*PolyLog[2, (-I)*E^(I*(a + b*x))])/b^3 - (2*I*d^2*PolyLog[2, I*E^(I*(a + b*x))])/b^3 - ((c + d*x)^2*Sec[a + b*x])/b + (8*d*(c + d*x)*Sin[a + b*x])/b^2}
{(c + d*x)^1*Sec[a + b*x]^2*Sin[3*a + 3*b*x], x, 9, (d*ArcTanh[Sin[a + b*x]])/b^2 - (4*(c + d*x)*Cos[a + b*x])/b - ((c + d*x)*Sec[a + b*x])/b + (4*d*Sin[a + b*x])/b^2}
{Sec[a + b*x]^2*Sin[3*a + 3*b*x]/(c + d*x)^1, x, 9, -Defer[Int][(Sec[a + b*x]*Tan[a + b*x])/(c + d*x), x] + (4*CosIntegral[(b*c)/d + b*x]*Sin[a - (b*c)/d])/d + (4*Cos[a - (b*c)/d]*SinIntegral[(b*c)/d + b*x])/d}
{Sec[a + b*x]^2*Sin[3*a + 3*b*x]/(c + d*x)^2, x, 11, (4*b*Cos[a - (b*c)/d]*CosIntegral[(b*c)/d + b*x])/d^2 - Defer[Int][(Sec[a + b*x]*Tan[a + b*x])/(c + d*x)^2, x] - (4*Sin[a + b*x])/(d*(c + d*x)) - (4*b*Sin[a - (b*c)/d]*SinIntegral[(b*c)/d + b*x])/d^2}
{Sec[a + b*x]^2*Sin[3*a + 3*b*x]/(c + d*x)^3, x, 13, -((2*b*Cos[a + b*x])/(d^2*(c + d*x))) - Defer[Int][(Sec[a + b*x]*Tan[a + b*x])/(c + d*x)^3, x] - (2*b^2*CosIntegral[(b*c)/d + b*x]*Sin[a - (b*c)/d])/d^3 - (2*Sin[a + b*x])/(d*(c + d*x)^2) - (2*b^2*Cos[a - (b*c)/d]*SinIntegral[(b*c)/d + b*x])/d^3}
