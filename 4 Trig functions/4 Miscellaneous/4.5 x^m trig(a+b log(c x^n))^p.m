...
{x^m*Sin[a + Sqrt[-(m+1)^2/(3^2*2^2)]*Log[c*x^2]]^3, x, 11, (9*E^((a*Sqrt[-(1 + m)^2])/(1 + m))*x^(1 + m)*(c*x^2)^((1/6)*(-1 - m)))/(16*Sqrt[-(1 + m)^2]) - (9*E^((a*(1 + m))/Sqrt[-(1 + m)^2])*x^(1 + m)*(c*x^2)^((1 + m)/6))/(32*Sqrt[-(1 + m)^2]) + (E^((3*a*(1 + m))/Sqrt[-(1 + m)^2])*x^(1 + m)*(c*x^2)^((1 + m)/2))/(16*Sqrt[-(1 + m)^2]) - ((1 + m)*x^(1 + m)*(c*x^2)^((1/2)*(-1 - m))*Log[x])/(E^((3*a*(1 + m))/Sqrt[-(1 + m)^2])*(8*Sqrt[-(1 + m)^2]))}
...
{x^2*Sqrt[Sin[a + b*Log[c*x^n]]], x, 1, (Sqrt[2]*x^3*Sqrt[I/(E^(I*a)*(c*x^n)^(I*b)) - I*E^(I*a)*(c*x^n)^(I*b)]*Hypergeometric2F1[-(1/2), -((6*I + b*n)/(4*b*n)), (3/4)*(1 - (2*I)/(b*n)), E^(2*I*a)*(c*x^n)^(2*I*b)])/((6 - I*b*n)*Sqrt[1 - E^(2*I*a)*(c*x^n)^(2*I*b)])}
{x^1*Sqrt[Sin[a + b*Log[c*x^n]]], x, 1, (Sqrt[2]*x^2*Sqrt[I/(E^(I*a)*(c*x^n)^(I*b)) - I*E^(I*a)*(c*x^n)^(I*b)]*Hypergeometric2F1[-(1/2), (1/4)*(-1 - (4*I)/(b*n)), (1/4)*(3 - (4*I)/(b*n)), E^(2*I*a)*(c*x^n)^(2*I*b)])/((4 - I*b*n)*Sqrt[1 - E^(2*I*a)*(c*x^n)^(2*I*b)])}
{x^0*Sqrt[Sin[a + b*Log[c*x^n]]], x, 1, (Sqrt[2]*x*Sqrt[I/(E^(I*a)*(c*x^n)^(I*b)) - I*E^(I*a)*(c*x^n)^(I*b)]*Hypergeometric2F1[-(1/2), -((2*I + b*n)/(4*b*n)), (1/4)*(3 - (2*I)/(b*n)), E^(2*I*a)*(c*x^n)^(2*I*b)])/((2 - I*b*n)*Sqrt[1 - E^(2*I*a)*(c*x^n)^(2*I*b)])}
{Sqrt[Sin[a + b*Log[c*x^n]]]/x^1, x, 2, (2*EllipticE[(1/4)*(2*a - Pi + 2*b*Log[c*x^n]), 2])/(b*n)}
...
{1/(x^1*Sqrt[Sin[a + b*Log[c*x^n]]]), x, 2, (2*EllipticF[(1/4)*(2*a - Pi + 2*b*Log[c*x^n]), 2])/(b*n)}
...
{1/(x*Sin[a + b*Log[c*x^n]]^(3/2)), x, 3, -((2*EllipticE[(1/4)*(2*a - Pi + 2*b*Log[c*x^n]), 2])/(b*n)) - (2*Cos[a + b*Log[c*x^n]])/(b*n*Sqrt[Sin[a + b*Log[c*x^n]]])}
...
{1/(x*Sin[a + b*Log[c*x^n]]^(5/2)), x, 3, (2*EllipticF[(1/4)*(2*a - Pi + 2*b*Log[c*x^n]), 2])/(3*b*n) - (2*Cos[a + b*Log[c*x^n]])/(3*b*n*Sin[a + b*Log[c*x^n]]^(3/2))}
...
{x^0*Sqrt[Cos[a + b*Log[c*x^n]]], x, 1, (Sqrt[2]*x*Sqrt[1/(E^(I*a)*(c*x^n)^(I*b)) + E^(I*a)*(c*x^n)^(I*b)]*Hypergeometric2F1[-(1/2), -((2*I + b*n)/(4*b*n)), (1/4)*(3 - (2*I)/(b*n)), (-E^(2*I*a))*(c*x^n)^(2*I*b)])/((2 - I*b*n)*Sqrt[1 + E^(2*I*a)*(c*x^n)^(2*I*b)])}
...
{x^0*Cos[a + b*Log[c*x^n]]^(5/2), x, 2, (4*x*Cos[a + b*Log[c*x^n]]^(5/2))/(4 + 25*b^2*n^2) + (15*Sqrt[2]*b^2*n^2*x*Sqrt[1/(E^(I*a)*(c*x^n)^(I*b)) + E^(I*a)*(c*x^n)^(I*b)]*Hypergeometric2F1[-(1/2), -((2*I + b*n)/(4*b*n)), (1/4)*(3 - (2*I)/(b*n)), (-E^(2*I*a))*(c*x^n)^(2*I*b)])/((2 - I*b*n)*(4 + 25*b^2*n^2)*Sqrt[1 + E^(2*I*a)*(c*x^n)^(2*I*b)]) + (10*b*n*x*Cos[a + b*Log[c*x^n]]^(3/2)*Sin[a + b*Log[c*x^n]])/(4 + 25*b^2*n^2)}
...
{Tan[a + b*Log[c*x^n]]^(5/2)/x, x, 15, ArcTan[1 - Sqrt[2]*Sqrt[Tan[a + b*Log[c*x^n]]]]/(Sqrt[2]*b*n) - ArcTan[1 + Sqrt[2]*Sqrt[Tan[a + b*Log[c*x^n]]]]/(Sqrt[2]*b*n) - Log[1 - Sqrt[2]*Sqrt[Tan[a + b*Log[c*x^n]]] + Tan[a + b*Log[c*x^n]]]/(2*Sqrt[2]*b*n) + Log[1 + Sqrt[2]*Sqrt[Tan[a + b*Log[c*x^n]]] + Tan[a + b*Log[c*x^n]]]/(2*Sqrt[2]*b*n) + (2*Tan[a + b*Log[c*x^n]]^(3/2))/(3*b*n)}
{Tan[a + b*Log[c*x^n]]^(3/2)/x, x, 15, ArcTan[1 - Sqrt[2]*Sqrt[Tan[a + b*Log[c*x^n]]]]/(Sqrt[2]*b*n) - ArcTan[1 + Sqrt[2]*Sqrt[Tan[a + b*Log[c*x^n]]]]/(Sqrt[2]*b*n) + Log[1 - Sqrt[2]*Sqrt[Tan[a + b*Log[c*x^n]]] + Tan[a + b*Log[c*x^n]]]/(2*Sqrt[2]*b*n) - Log[1 + Sqrt[2]*Sqrt[Tan[a + b*Log[c*x^n]]] + Tan[a + b*Log[c*x^n]]]/(2*Sqrt[2]*b*n) + (2*Sqrt[Tan[a + b*Log[c*x^n]]])/(b*n)}
{Sqrt[Tan[a + b*Log[c*x^n]]]/x, x, 14, -(ArcTan[1 - Sqrt[2]*Sqrt[Tan[a + b*Log[c*x^n]]]]/(Sqrt[2]*b*n)) + ArcTan[1 + Sqrt[2]*Sqrt[Tan[a + b*Log[c*x^n]]]]/(Sqrt[2]*b*n) + Log[1 - Sqrt[2]*Sqrt[Tan[a + b*Log[c*x^n]]] + Tan[a + b*Log[c*x^n]]]/(2*Sqrt[2]*b*n) - Log[1 + Sqrt[2]*Sqrt[Tan[a + b*Log[c*x^n]]] + Tan[a + b*Log[c*x^n]]]/(2*Sqrt[2]*b*n)}
{1/(x*Sqrt[Tan[a + b*Log[c*x^n]]]), x, 14, -(ArcTan[1 - Sqrt[2]*Sqrt[Tan[a + b*Log[c*x^n]]]]/(Sqrt[2]*b*n)) + ArcTan[1 + Sqrt[2]*Sqrt[Tan[a + b*Log[c*x^n]]]]/(Sqrt[2]*b*n) - Log[1 - Sqrt[2]*Sqrt[Tan[a + b*Log[c*x^n]]] + Tan[a + b*Log[c*x^n]]]/(2*Sqrt[2]*b*n) + Log[1 + Sqrt[2]*Sqrt[Tan[a + b*Log[c*x^n]]] + Tan[a + b*Log[c*x^n]]]/(2*Sqrt[2]*b*n)}
{1/(x*Tan[a + b*Log[c*x^n]]^(3/2)), x, 15, ArcTan[1 - Sqrt[2]*Sqrt[Tan[a + b*Log[c*x^n]]]]/(Sqrt[2]*b*n) - ArcTan[1 + Sqrt[2]*Sqrt[Tan[a + b*Log[c*x^n]]]]/(Sqrt[2]*b*n) - Log[1 - Sqrt[2]*Sqrt[Tan[a + b*Log[c*x^n]]] + Tan[a + b*Log[c*x^n]]]/(2*Sqrt[2]*b*n) + Log[1 + Sqrt[2]*Sqrt[Tan[a + b*Log[c*x^n]]] + Tan[a + b*Log[c*x^n]]]/(2*Sqrt[2]*b*n) - 2/(b*n*Sqrt[Tan[a + b*Log[c*x^n]]])}
{1/(x*Tan[a + b*Log[c*x^n]]^(5/2)), x, 15, ArcTan[1 - Sqrt[2]*Sqrt[Tan[a + b*Log[c*x^n]]]]/(Sqrt[2]*b*n) - ArcTan[1 + Sqrt[2]*Sqrt[Tan[a + b*Log[c*x^n]]]]/(Sqrt[2]*b*n) + Log[1 - Sqrt[2]*Sqrt[Tan[a + b*Log[c*x^n]]] + Tan[a + b*Log[c*x^n]]]/(2*Sqrt[2]*b*n) - Log[1 + Sqrt[2]*Sqrt[Tan[a + b*Log[c*x^n]]] + Tan[a + b*Log[c*x^n]]]/(2*Sqrt[2]*b*n) - 2/(3*b*n*Tan[a + b*Log[c*x^n]]^(3/2))}
...
{Cot[a + b*Log[c*x^n]]^(5/2)/x, x, 15, -(ArcTan[1 - Sqrt[2]*Sqrt[Cot[a + b*Log[c*x^n]]]]/(Sqrt[2]*b*n)) + ArcTan[1 + Sqrt[2]*Sqrt[Cot[a + b*Log[c*x^n]]]]/(Sqrt[2]*b*n) - (2*Cot[a + b*Log[c*x^n]]^(3/2))/(3*b*n) + Log[1 - Sqrt[2]*Sqrt[Cot[a + b*Log[c*x^n]]] + Cot[a + b*Log[c*x^n]]]/(2*Sqrt[2]*b*n) - Log[1 + Sqrt[2]*Sqrt[Cot[a + b*Log[c*x^n]]] + Cot[a + b*Log[c*x^n]]]/(2*Sqrt[2]*b*n)}
{Cot[a + b*Log[c*x^n]]^(3/2)/x, x, 15, -(ArcTan[1 - Sqrt[2]*Sqrt[Cot[a + b*Log[c*x^n]]]]/(Sqrt[2]*b*n)) + ArcTan[1 + Sqrt[2]*Sqrt[Cot[a + b*Log[c*x^n]]]]/(Sqrt[2]*b*n) - (2*Sqrt[Cot[a + b*Log[c*x^n]]])/(b*n) - Log[1 - Sqrt[2]*Sqrt[Cot[a + b*Log[c*x^n]]] + Cot[a + b*Log[c*x^n]]]/(2*Sqrt[2]*b*n) + Log[1 + Sqrt[2]*Sqrt[Cot[a + b*Log[c*x^n]]] + Cot[a + b*Log[c*x^n]]]/(2*Sqrt[2]*b*n)}
{Sqrt[Cot[a + b*Log[c*x^n]]]/x, x, 14, ArcTan[1 - Sqrt[2]*Sqrt[Cot[a + b*Log[c*x^n]]]]/(Sqrt[2]*b*n) - ArcTan[1 + Sqrt[2]*Sqrt[Cot[a + b*Log[c*x^n]]]]/(Sqrt[2]*b*n) - Log[1 - Sqrt[2]*Sqrt[Cot[a + b*Log[c*x^n]]] + Cot[a + b*Log[c*x^n]]]/(2*Sqrt[2]*b*n) + Log[1 + Sqrt[2]*Sqrt[Cot[a + b*Log[c*x^n]]] + Cot[a + b*Log[c*x^n]]]/(2*Sqrt[2]*b*n)}
{1/(x*Sqrt[Cot[a + b*Log[c*x^n]]]), x, 14, ArcTan[1 - Sqrt[2]*Sqrt[Cot[a + b*Log[c*x^n]]]]/(Sqrt[2]*b*n) - ArcTan[1 + Sqrt[2]*Sqrt[Cot[a + b*Log[c*x^n]]]]/(Sqrt[2]*b*n) + Log[1 - Sqrt[2]*Sqrt[Cot[a + b*Log[c*x^n]]] + Cot[a + b*Log[c*x^n]]]/(2*Sqrt[2]*b*n) - Log[1 + Sqrt[2]*Sqrt[Cot[a + b*Log[c*x^n]]] + Cot[a + b*Log[c*x^n]]]/(2*Sqrt[2]*b*n)}
{1/(x*Cot[a + b*Log[c*x^n]]^(3/2)), x, 15, -(ArcTan[1 - Sqrt[2]*Sqrt[Cot[a + b*Log[c*x^n]]]]/(Sqrt[2]*b*n)) + ArcTan[1 + Sqrt[2]*Sqrt[Cot[a + b*Log[c*x^n]]]]/(Sqrt[2]*b*n) + 2/(b*n*Sqrt[Cot[a + b*Log[c*x^n]]]) + Log[1 - Sqrt[2]*Sqrt[Cot[a + b*Log[c*x^n]]] + Cot[a + b*Log[c*x^n]]]/(2*Sqrt[2]*b*n) - Log[1 + Sqrt[2]*Sqrt[Cot[a + b*Log[c*x^n]]] + Cot[a + b*Log[c*x^n]]]/(2*Sqrt[2]*b*n)}
{1/(x*Cot[a + b*Log[c*x^n]]^(5/2)), x, 15, -(ArcTan[1 - Sqrt[2]*Sqrt[Cot[a + b*Log[c*x^n]]]]/(Sqrt[2]*b*n)) + ArcTan[1 + Sqrt[2]*Sqrt[Cot[a + b*Log[c*x^n]]]]/(Sqrt[2]*b*n) + 2/(3*b*n*Cot[a + b*Log[c*x^n]]^(3/2)) - Log[1 - Sqrt[2]*Sqrt[Cot[a + b*Log[c*x^n]]] + Cot[a + b*Log[c*x^n]]]/(2*Sqrt[2]*b*n) + Log[1 + Sqrt[2]*Sqrt[Cot[a + b*Log[c*x^n]]] + Cot[a + b*Log[c*x^n]]]/(2*Sqrt[2]*b*n)}
...
{x^m*Sec[a + b*Log[c*x^n]], x, 1, (2*E^(I*a)*x^(1 + m)*(c*x^n)^(I*b)*Hypergeometric2F1[1, -((I*(1 + m) - b*n)/(2*b*n)), -((I*(1 + m) - 3*b*n)/(2*b*n)), (-E^(2*I*a))*(c*x^n)^(2*I*b)])/(1 + m + I*b*n)}
...
{x^m*Sec[a + b*Log[c*x^n]]^2, x, 1, (4*E^(2*I*a)*x^(1 + m)*(c*x^n)^(2*I*b)*Hypergeometric2F1[2, -((I*(1 + m + 2*I*b*n))/(2*b*n)), -((I*(1 + m) - 4*b*n)/(2*b*n)), (-E^(2*I*a))*(c*x^n)^(2*I*b)])/(1 + m + 2*I*b*n)}
...
{x^m*Sec[a + b*Log[c*x^n]]^3, x, 2, (E^(I*a)*(1 + m - I*b*n)*x^(1 + m)*(c*x^n)^(I*b)*Hypergeometric2F1[1, -((I + I*m - b*n)/(2*b*n)), -((I*(1 + m) - 3*b*n)/(2*b*n)), (-E^(2*I*a))*(c*x^n)^(2*I*b)])/(b^2*n^2) - ((1 + m)*x^(1 + m)*Sec[a + b*Log[c*x^n]])/(2*b^2*n^2) + (x^(1 + m)*Sec[a + b*Log[c*x^n]]*Tan[a + b*Log[c*x^n]])/(2*b*n)}
...
{x^m*Sec[a + b*Log[c*x^n]]^4, x, 2, (2*E^(2*I*a)*(1 + m - 2*I*b*n)*x^(1 + m)*(c*x^n)^(2*I*b)*Hypergeometric2F1[2, -((I*(1 + m + 2*I*b*n))/(2*b*n)), -((I*(1 + m) - 4*b*n)/(2*b*n)), (-E^(2*I*a))*(c*x^n)^(2*I*b)])/(3*b^2*n^2) - ((1 + m)*x^(1 + m)*Sec[a + b*Log[c*x^n]]^2)/(6*b^2*n^2) + (x^(1 + m)*Sec[a + b*Log[c*x^n]]^2*Tan[a + b*Log[c*x^n]])/(3*b*n)}
...
{2*b^2*n^2*Sec[a + b*Log[c*x^n]]^3 - (1 + b^2*n^2)*Sec[a + b*Log[c*x^n]], x, 4, (-x)*Sec[a + b*Log[c*x^n]] + b*n*x*Sec[a + b*Log[c*x^n]]*Tan[a + b*Log[c*x^n]]}
...
{x^0/Sqrt[Sec[a + b*Log[c*x^n]]], x, 1, (Sqrt[2]*x*Hypergeometric2F1[-(1/2), -((2*I + b*n)/(4*b*n)), (1/4)*(3 - (2*I)/(b*n)), (-E^(2*I*a))*(c*x^n)^(2*I*b)])/((2 - I*b*n)*Sqrt[(E^(I*a)*(c*x^n)^(I*b))/(1 + E^(2*I*a)*(c*x^n)^(2*I*b))]*Sqrt[1 + E^(2*I*a)*(c*x^n)^(2*I*b)])}
...
{x^m*Sec[a + b*Log[c*x^n]]^p, x, 1, (x^(1 + m)*((E^(I*a)*(c*x^n)^(I*b))/(1 + E^(2*I*a)*(c*x^n)^(2*I*b)))^p*(2 + 2*E^(2*I*a)*(c*x^n)^(2*I*b))^p*Hypergeometric2F1[p, -((I*(1 + m) - b*n*p)/(2*b*n)), (1/2)*(2 - (I*(1 + m))/(b*n) + p), (-E^(2*I*a))*(c*x^n)^(2*I*b)])/(1 + m + I*b*n*p)}
...
{x^m*Csc[a + b*Log[c*x^n]], x, 1, (2*E^(I*a)*x^(1 + m)*(c*x^n)^(I*b)*Hypergeometric2F1[1, -((I*(1 + m) - b*n)/(2*b*n)), -((I*(1 + m) - 3*b*n)/(2*b*n)), E^(2*I*a)*(c*x^n)^(2*I*b)])/(I*(1 + m) - b*n)}
...
{x^m*Csc[a + b*Log[c*x^n]]^2, x, 1, -((4*E^(2*I*a)*x^(1 + m)*(c*x^n)^(2*I*b)*Hypergeometric2F1[2, -((I*(1 + m + 2*I*b*n))/(2*b*n)), -((I*(1 + m) - 4*b*n)/(2*b*n)), E^(2*I*a)*(c*x^n)^(2*I*b)])/(1 + m + 2*I*b*n))}
...
{x^m*Csc[a + b*Log[c*x^n]]^3, x, 2, -(((1 + m)*x^(1 + m)*Csc[a + b*Log[c*x^n]])/(2*b^2*n^2)) - (x^(1 + m)*Cot[a + b*Log[c*x^n]]*Csc[a + b*Log[c*x^n]])/(2*b*n) - (E^(I*a)*(I + I*m + b*n)*x^(1 + m)*(c*x^n)^(I*b)*Hypergeometric2F1[1, -((I + I*m - b*n)/(2*b*n)), -((I*(1 + m) - 3*b*n)/(2*b*n)), E^(2*I*a)*(c*x^n)^(2*I*b)])/(b^2*n^2)}
...
{x^m*Csc[a + b*Log[c*x^n]]^4, x, 2, -(((1 + m)*x^(1 + m)*Csc[a + b*Log[c*x^n]]^2)/(6*b^2*n^2)) - (x^(1 + m)*Cot[a + b*Log[c*x^n]]*Csc[a + b*Log[c*x^n]]^2)/(3*b*n) - (2*E^(2*I*a)*(1 + m - 2*I*b*n)*x^(1 + m)*(c*x^n)^(2*I*b)*Hypergeometric2F1[2, -((I*(1 + m + 2*I*b*n))/(2*b*n)), -((I*(1 + m) - 4*b*n)/(2*b*n)), E^(2*I*a)*(c*x^n)^(2*I*b)])/(3*b^2*n^2)}
...
{Sqrt[Csc[a + b*Log[c*x^n]]]/x, x, 3, (2*Sqrt[Csc[a + b*Log[c*x^n]]]*EllipticF[(1/4)*(2*a - Pi + 2*b*Log[c*x^n]), 2]*Sqrt[Sin[a + b*Log[c*x^n]]])/(b*n)}
...
{Csc[a + b*Log[c*x^n]]^(3/2)/x, x, 4, -((2*Cos[a + b*Log[c*x^n]]*Sqrt[Csc[a + b*Log[c*x^n]]])/(b*n)) - (2*Sqrt[Csc[a + b*Log[c*x^n]]]*EllipticE[(1/4)*(2*a - Pi + 2*b*Log[c*x^n]), 2]*Sqrt[Sin[a + b*Log[c*x^n]]])/(b*n)}
...
{Csc[a + b*Log[c*x^n]]^(5/2)/x, x, 4, -((2*Cos[a + b*Log[c*x^n]]*Csc[a + b*Log[c*x^n]]^(3/2))/(3*b*n)) + (2*Sqrt[Csc[a + b*Log[c*x^n]]]*EllipticF[(1/4)*(2*a - Pi + 2*b*Log[c*x^n]), 2]*Sqrt[Sin[a + b*Log[c*x^n]]])/(3*b*n)}
...
{x^0/Sqrt[Csc[a + b*Log[c*x^n]]], x, 1, (Sqrt[2]*x*Hypergeometric2F1[-(1/2), -((2*I + b*n)/(4*b*n)), (1/4)*(3 - (2*I)/(b*n)), E^(2*I*a)*(c*x^n)^(2*I*b)])/((2 - I*b*n)*Sqrt[-((I*E^(I*a)*(c*x^n)^(I*b))/(1 - E^(2*I*a)*(c*x^n)^(2*I*b)))]*Sqrt[1 - E^(2*I*a)*(c*x^n)^(2*I*b)])}
{1/(x*Sqrt[Csc[a + b*Log[c*x^n]]]), x, 3, (2*Sqrt[Csc[a + b*Log[c*x^n]]]*EllipticE[(1/4)*(2*a - Pi + 2*b*Log[c*x^n]), 2]*Sqrt[Sin[a + b*Log[c*x^n]]])/(b*n)}
...
{1/(x*Csc[a + b*Log[c*x^n]]^(3/2)), x, 4, -((2*Cos[a + b*Log[c*x^n]])/(3*b*n*Sqrt[Csc[a + b*Log[c*x^n]]])) + (2*Sqrt[Csc[a + b*Log[c*x^n]]]*EllipticF[(1/4)*(2*a - Pi + 2*b*Log[c*x^n]), 2]*Sqrt[Sin[a + b*Log[c*x^n]]])/(3*b*n)}
...
{x^0/Csc[a + b*Log[c*x^n]]^(5/2), x, 2, (4*x)/((4 + 25*b^2*n^2)*Csc[a + b*Log[c*x^n]]^(5/2)) - (10*b*n*x*Cos[a + b*Log[c*x^n]])/((4 + 25*b^2*n^2)*Csc[a + b*Log[c*x^n]]^(3/2)) + (15*Sqrt[2]*b^2*n^2*x*Hypergeometric2F1[-(1/2), -((2*I + b*n)/(4*b*n)), (1/4)*(3 - (2*I)/(b*n)), E^(2*I*a)*(c*x^n)^(2*I*b)])/((2 - I*b*n)*(4 + 25*b^2*n^2)*Sqrt[-((I*E^(I*a)*(c*x^n)^(I*b))/(1 - E^(2*I*a)*(c*x^n)^(2*I*b)))]*Sqrt[1 - E^(2*I*a)*(c*x^n)^(2*I*b)])}
{1/(x*Csc[a + b*Log[c*x^n]]^(5/2)), x, 4, -((2*Cos[a + b*Log[c*x^n]])/(5*b*n*Csc[a + b*Log[c*x^n]]^(3/2))) + (6*Sqrt[Csc[a + b*Log[c*x^n]]]*EllipticE[(1/4)*(2*a - Pi + 2*b*Log[c*x^n]), 2]*Sqrt[Sin[a + b*Log[c*x^n]]])/(5*b*n)}
...
{x^m*Csc[a + b*Log[c*x^n]]^p, x, 1, (x^(1 + m)*(2 - 2*E^(2*I*a)*(c*x^n)^(2*I*b))^p*(-((I*E^(I*a)*(c*x^n)^(I*b))/(1 - E^(2*I*a)*(c*x^n)^(2*I*b))))^p*Hypergeometric2F1[p, -((I*(1 + m) - b*n*p)/(2*b*n)), (1/2)*(2 - (I*(1 + m))/(b*n) + p), E^(2*I*a)*(c*x^n)^(2*I*b)])/(1 + m + I*b*n*p)}
