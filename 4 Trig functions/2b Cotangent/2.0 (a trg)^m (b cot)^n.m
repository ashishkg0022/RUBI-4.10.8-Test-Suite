...
{(c*Cot[a + b*x])^(7/2), x, 15, (c^(7/2)*ArcTan[1 - (Sqrt[2]*Sqrt[c*Cot[a + b*x]])/Sqrt[c]])/(Sqrt[2]*b) - (c^(7/2)*ArcTan[1 + (Sqrt[2]*Sqrt[c*Cot[a + b*x]])/Sqrt[c]])/(Sqrt[2]*b) + (2*c^3*Sqrt[c*Cot[a + b*x]])/b - (2*c*(c*Cot[a + b*x])^(5/2))/(5*b) + (c^(7/2)*Log[Sqrt[c] + Sqrt[c]*Cot[a + b*x] - Sqrt[2]*Sqrt[c*Cot[a + b*x]]])/(2*Sqrt[2]*b) - (c^(7/2)*Log[Sqrt[c] + Sqrt[c]*Cot[a + b*x] + Sqrt[2]*Sqrt[c*Cot[a + b*x]]])/(2*Sqrt[2]*b)}
{(c*Cot[a + b*x])^(5/2), x, 14, -((c^(5/2)*ArcTan[1 - (Sqrt[2]*Sqrt[c*Cot[a + b*x]])/Sqrt[c]])/(Sqrt[2]*b)) + (c^(5/2)*ArcTan[1 + (Sqrt[2]*Sqrt[c*Cot[a + b*x]])/Sqrt[c]])/(Sqrt[2]*b) - (2*c*(c*Cot[a + b*x])^(3/2))/(3*b) + (c^(5/2)*Log[Sqrt[c] + Sqrt[c]*Cot[a + b*x] - Sqrt[2]*Sqrt[c*Cot[a + b*x]]])/(2*Sqrt[2]*b) - (c^(5/2)*Log[Sqrt[c] + Sqrt[c]*Cot[a + b*x] + Sqrt[2]*Sqrt[c*Cot[a + b*x]]])/(2*Sqrt[2]*b)}
{(c*Cot[a + b*x])^(3/2), x, 14, -((c^(3/2)*ArcTan[1 - (Sqrt[2]*Sqrt[c*Cot[a + b*x]])/Sqrt[c]])/(Sqrt[2]*b)) + (c^(3/2)*ArcTan[1 + (Sqrt[2]*Sqrt[c*Cot[a + b*x]])/Sqrt[c]])/(Sqrt[2]*b) - (2*c*Sqrt[c*Cot[a + b*x]])/b - (c^(3/2)*Log[Sqrt[c] + Sqrt[c]*Cot[a + b*x] - Sqrt[2]*Sqrt[c*Cot[a + b*x]]])/(2*Sqrt[2]*b) + (c^(3/2)*Log[Sqrt[c] + Sqrt[c]*Cot[a + b*x] + Sqrt[2]*Sqrt[c*Cot[a + b*x]]])/(2*Sqrt[2]*b)}
{(c*Cot[a + b*x])^(1/2), x, 13, (Sqrt[c]*ArcTan[1 - (Sqrt[2]*Sqrt[c*Cot[a + b*x]])/Sqrt[c]])/(Sqrt[2]*b) - (Sqrt[c]*ArcTan[1 + (Sqrt[2]*Sqrt[c*Cot[a + b*x]])/Sqrt[c]])/(Sqrt[2]*b) - (Sqrt[c]*Log[Sqrt[c] + Sqrt[c]*Cot[a + b*x] - Sqrt[2]*Sqrt[c*Cot[a + b*x]]])/(2*Sqrt[2]*b) + (Sqrt[c]*Log[Sqrt[c] + Sqrt[c]*Cot[a + b*x] + Sqrt[2]*Sqrt[c*Cot[a + b*x]]])/(2*Sqrt[2]*b)}
{1/(c*Cot[a + b*x])^(1/2), x, 13, ArcTan[1 - (Sqrt[2]*Sqrt[c*Cot[a + b*x]])/Sqrt[c]]/(Sqrt[2]*b*Sqrt[c]) - ArcTan[1 + (Sqrt[2]*Sqrt[c*Cot[a + b*x]])/Sqrt[c]]/(Sqrt[2]*b*Sqrt[c]) + Log[Sqrt[c] + Sqrt[c]*Cot[a + b*x] - Sqrt[2]*Sqrt[c*Cot[a + b*x]]]/(2*Sqrt[2]*b*Sqrt[c]) - Log[Sqrt[c] + Sqrt[c]*Cot[a + b*x] + Sqrt[2]*Sqrt[c*Cot[a + b*x]]]/(2*Sqrt[2]*b*Sqrt[c])}
{1/(c*Cot[a + b*x])^(3/2), x, 14, -(ArcTan[1 - (Sqrt[2]*Sqrt[c*Cot[a + b*x]])/Sqrt[c]]/(Sqrt[2]*b*c^(3/2))) + ArcTan[1 + (Sqrt[2]*Sqrt[c*Cot[a + b*x]])/Sqrt[c]]/(Sqrt[2]*b*c^(3/2)) + 2/(b*c*Sqrt[c*Cot[a + b*x]]) + Log[Sqrt[c] + Sqrt[c]*Cot[a + b*x] - Sqrt[2]*Sqrt[c*Cot[a + b*x]]]/(2*Sqrt[2]*b*c^(3/2)) - Log[Sqrt[c] + Sqrt[c]*Cot[a + b*x] + Sqrt[2]*Sqrt[c*Cot[a + b*x]]]/(2*Sqrt[2]*b*c^(3/2))}
{1/(c*Cot[a + b*x])^(5/2), x, 14, -(ArcTan[1 - (Sqrt[2]*Sqrt[c*Cot[a + b*x]])/Sqrt[c]]/(Sqrt[2]*b*c^(5/2))) + ArcTan[1 + (Sqrt[2]*Sqrt[c*Cot[a + b*x]])/Sqrt[c]]/(Sqrt[2]*b*c^(5/2)) + 2/(3*b*c*(c*Cot[a + b*x])^(3/2)) - Log[Sqrt[c] + Sqrt[c]*Cot[a + b*x] - Sqrt[2]*Sqrt[c*Cot[a + b*x]]]/(2*Sqrt[2]*b*c^(5/2)) + Log[Sqrt[c] + Sqrt[c]*Cot[a + b*x] + Sqrt[2]*Sqrt[c*Cot[a + b*x]]]/(2*Sqrt[2]*b*c^(5/2))}
{1/(c*Cot[a + b*x])^(7/2), x, 15, ArcTan[1 - (Sqrt[2]*Sqrt[c*Cot[a + b*x]])/Sqrt[c]]/(Sqrt[2]*b*c^(7/2)) - ArcTan[1 + (Sqrt[2]*Sqrt[c*Cot[a + b*x]])/Sqrt[c]]/(Sqrt[2]*b*c^(7/2)) + 2/(5*b*c*(c*Cot[a + b*x])^(5/2)) - 2/(b*c^3*Sqrt[c*Cot[a + b*x]]) - Log[Sqrt[c] + Sqrt[c]*Cot[a + b*x] - Sqrt[2]*Sqrt[c*Cot[a + b*x]]]/(2*Sqrt[2]*b*c^(7/2)) + Log[Sqrt[c] + Sqrt[c]*Cot[a + b*x] + Sqrt[2]*Sqrt[c*Cot[a + b*x]]]/(2*Sqrt[2]*b*c^(7/2))}
...
{(c*Cot[a + b*x])^(4/3), x, 15, (c^(4/3)*ArcTan[(c*Cot[a + b*x])^(1/3)/c^(1/3)])/b - (c^(4/3)*ArcTan[(Sqrt[3]*c^(1/3) - 2*(c*Cot[a + b*x])^(1/3))/c^(1/3)])/(2*b) + (c^(4/3)*ArcTan[(Sqrt[3]*c^(1/3) + 2*(c*Cot[a + b*x])^(1/3))/c^(1/3)])/(2*b) - (3*c*(c*Cot[a + b*x])^(1/3))/b - (Sqrt[3]*c^(4/3)*Log[c^(2/3) - Sqrt[3]*c^(1/3)*(c*Cot[a + b*x])^(1/3) + (c*Cot[a + b*x])^(2/3)])/(4*b) + (Sqrt[3]*c^(4/3)*Log[c^(2/3) + Sqrt[3]*c^(1/3)*(c*Cot[a + b*x])^(1/3) + (c*Cot[a + b*x])^(2/3)])/(4*b)}
{(c*Cot[a + b*x])^(2/3), x, 14, -((c^(2/3)*ArcTan[(c*Cot[a + b*x])^(1/3)/c^(1/3)])/b) + (c^(2/3)*ArcTan[(Sqrt[3]*c^(1/3) - 2*(c*Cot[a + b*x])^(1/3))/c^(1/3)])/(2*b) - (c^(2/3)*ArcTan[(Sqrt[3]*c^(1/3) + 2*(c*Cot[a + b*x])^(1/3))/c^(1/3)])/(2*b) - (Sqrt[3]*c^(2/3)*Log[c^(2/3) - Sqrt[3]*c^(1/3)*(c*Cot[a + b*x])^(1/3) + (c*Cot[a + b*x])^(2/3)])/(4*b) + (Sqrt[3]*c^(2/3)*Log[c^(2/3) + Sqrt[3]*c^(1/3)*(c*Cot[a + b*x])^(1/3) + (c*Cot[a + b*x])^(2/3)])/(4*b)}
{(c*Cot[a + b*x])^(1/3), x, 10, (Sqrt[3]*c^(1/3)*ArcTan[(c^(2/3) - 2*(c*Cot[a + b*x])^(2/3))/(Sqrt[3]*c^(2/3))])/(2*b) + (c^(1/3)*Log[c^(2/3) + (c*Cot[a + b*x])^(2/3)])/(2*b) - (c^(1/3)*Log[c^(4/3) - c^(2/3)*(c*Cot[a + b*x])^(2/3) + (c*Cot[a + b*x])^(4/3)])/(4*b)}
{1/(c*Cot[a + b*x])^(1/3), x, 10, (Sqrt[3]*ArcTan[(c^(2/3) - 2*(c*Cot[a + b*x])^(2/3))/(Sqrt[3]*c^(2/3))])/(2*b*c^(1/3)) - Log[c^(2/3) + (c*Cot[a + b*x])^(2/3)]/(2*b*c^(1/3)) + Log[c^(4/3) - c^(2/3)*(c*Cot[a + b*x])^(2/3) + (c*Cot[a + b*x])^(4/3)]/(4*b*c^(1/3))}
{1/(c*Cot[a + b*x])^(2/3), x, 14, -(ArcTan[(c*Cot[a + b*x])^(1/3)/c^(1/3)]/(b*c^(2/3))) + ArcTan[(Sqrt[3]*c^(1/3) - 2*(c*Cot[a + b*x])^(1/3))/c^(1/3)]/(2*b*c^(2/3)) - ArcTan[(Sqrt[3]*c^(1/3) + 2*(c*Cot[a + b*x])^(1/3))/c^(1/3)]/(2*b*c^(2/3)) + (Sqrt[3]*Log[c^(2/3) - Sqrt[3]*c^(1/3)*(c*Cot[a + b*x])^(1/3) + (c*Cot[a + b*x])^(2/3)])/(4*b*c^(2/3)) - (Sqrt[3]*Log[c^(2/3) + Sqrt[3]*c^(1/3)*(c*Cot[a + b*x])^(1/3) + (c*Cot[a + b*x])^(2/3)])/(4*b*c^(2/3))}
{1/(c*Cot[a + b*x])^(4/3), x, 15, ArcTan[(c*Cot[a + b*x])^(1/3)/c^(1/3)]/(b*c^(4/3)) - ArcTan[(Sqrt[3]*c^(1/3) - 2*(c*Cot[a + b*x])^(1/3))/c^(1/3)]/(2*b*c^(4/3)) + ArcTan[(Sqrt[3]*c^(1/3) + 2*(c*Cot[a + b*x])^(1/3))/c^(1/3)]/(2*b*c^(4/3)) + 3/(b*c*(c*Cot[a + b*x])^(1/3)) + (Sqrt[3]*Log[c^(2/3) - Sqrt[3]*c^(1/3)*(c*Cot[a + b*x])^(1/3) + (c*Cot[a + b*x])^(2/3)])/(4*b*c^(4/3)) - (Sqrt[3]*Log[c^(2/3) + Sqrt[3]*c^(1/3)*(c*Cot[a + b*x])^(1/3) + (c*Cot[a + b*x])^(2/3)])/(4*b*c^(4/3))}
...
{(a*Cot[x]^3)^(3/2), x, 16, (2/3)*a*Sqrt[a*Cot[x]^3] + (a*ArcTan[1 - Sqrt[2]*Sqrt[Cot[x]]]*Sqrt[a*Cot[x]^3])/(Sqrt[2]*Cot[x]^(3/2)) - (a*ArcTan[1 + Sqrt[2]*Sqrt[Cot[x]]]*Sqrt[a*Cot[x]^3])/(Sqrt[2]*Cot[x]^(3/2)) - (2/7)*a*Cot[x]^2*Sqrt[a*Cot[x]^3] - (a*Sqrt[a*Cot[x]^3]*Log[1 - Sqrt[2]*Sqrt[Cot[x]] + Cot[x]])/(2*Sqrt[2]*Cot[x]^(3/2)) + (a*Sqrt[a*Cot[x]^3]*Log[1 + Sqrt[2]*Sqrt[Cot[x]] + Cot[x]])/(2*Sqrt[2]*Cot[x]^(3/2))}
{Sqrt[a*Cot[x]^3], x, 15, -((ArcTan[1 - Sqrt[2]*Sqrt[Cot[x]]]*Sqrt[a*Cot[x]^3])/(Sqrt[2]*Cot[x]^(3/2))) + (ArcTan[1 + Sqrt[2]*Sqrt[Cot[x]]]*Sqrt[a*Cot[x]^3])/(Sqrt[2]*Cot[x]^(3/2)) - (Sqrt[a*Cot[x]^3]*Log[1 - Sqrt[2]*Sqrt[Cot[x]] + Cot[x]])/(2*Sqrt[2]*Cot[x]^(3/2)) + (Sqrt[a*Cot[x]^3]*Log[1 + Sqrt[2]*Sqrt[Cot[x]] + Cot[x]])/(2*Sqrt[2]*Cot[x]^(3/2)) - 2*Sqrt[a*Cot[x]^3]*Tan[x]}
{1/Sqrt[a*Cot[x]^3], x, 15, (2*Cot[x])/Sqrt[a*Cot[x]^3] - (ArcTan[1 - Sqrt[2]*Sqrt[Cot[x]]]*Cot[x]^(3/2))/(Sqrt[2]*Sqrt[a*Cot[x]^3]) + (ArcTan[1 + Sqrt[2]*Sqrt[Cot[x]]]*Cot[x]^(3/2))/(Sqrt[2]*Sqrt[a*Cot[x]^3]) + (Cot[x]^(3/2)*Log[1 - Sqrt[2]*Sqrt[Cot[x]] + Cot[x]])/(2*Sqrt[2]*Sqrt[a*Cot[x]^3]) - (Cot[x]^(3/2)*Log[1 + Sqrt[2]*Sqrt[Cot[x]] + Cot[x]])/(2*Sqrt[2]*Sqrt[a*Cot[x]^3])}
{1/(a*Cot[x]^3)^(3/2),x, 16, -(2/(3*a*Sqrt[a*Cot[x]^3])) + (ArcTan[1 - Sqrt[2]*Sqrt[Cot[x]]]*Cot[x]^(3/2))/(Sqrt[2]*a*Sqrt[a*Cot[x]^3]) - (ArcTan[1 + Sqrt[2]*Sqrt[Cot[x]]]*Cot[x]^(3/2))/(Sqrt[2]*a*Sqrt[a*Cot[x]^3]) + (Cot[x]^(3/2)*Log[1 - Sqrt[2]*Sqrt[Cot[x]] + Cot[x]])/(2*Sqrt[2]*a*Sqrt[a*Cot[x]^3]) - (Cot[x]^(3/2)*Log[1 + Sqrt[2]*Sqrt[Cot[x]] + Cot[x]])/(2*Sqrt[2]*a*Sqrt[a*Cot[x]^3]) + (2*Tan[x]^2)/(7*a*Sqrt[a*Cot[x]^3])}
