...
(* ::Title::Closed:: *)
(*Integrands of the form (a+b Cot[e+f x])^m (d Cot[e+f x])^n*)


(* ::Section::Closed:: *)
(*Integrands of the form (a+I a Cot[e+f x])^m (d Cot[e+f x])^n*)
...
(* ::Section::Closed:: *)
(*Integrands of the form (a+a Cot[e+f x])^m (d Cot[e+f x])^n*)


(* ::Subsection::Closed:: *)
(*Integrands of the form (a+a Cot[e+f x])^m (d Cot[e+f x])^(n/2)*)
...
(* ::Subsection::Closed:: *)
(*Integrands of the form (a+a Cot[e+f x])^(m/2) (d Cot[e+f x])^n*)
...
(* ::Subsection::Closed:: *)
(*Integrands of the form (a+b Cot[e+f x])^m (d Cot[e+f x])^(n/2)*)
...
(* ::Title::Closed:: *)
(*Integrands of the form (a+b Cot[e+f x])^m (d Tan[e+f x])^n*)


(* ::Section:: *)
(*Integrands of the form (a+I a Cot[e+f x])^m (d Tan[e+f x])^n*)


(* ::Section:: *)
(*Integrands of the form (a+a Cot[e+f x])^m (d Tan[e+f x])^n*)
...
(* ::Subsection::Closed:: *)
(*Integrands of the form (a+b Cot[e+f x])^m (d Tan[e+f x])^n with m symbolic*)
...
{(-a + b*Cot[c + d*x])*(a + b*Cot[c + d*x])^(3/2), x, 7, (b*(a^2 + b^2)*Sqrt[a - Sqrt[-b^2]]*ArcTanh[Sqrt[a + b*Cot[c + d*x]]/Sqrt[a - Sqrt[-b^2]]])/(Sqrt[-b^2]*d) - (b*(a^2 + b^2)*Sqrt[a + Sqrt[-b^2]]*ArcTanh[Sqrt[a + b*Cot[c + d*x]]/Sqrt[a + Sqrt[-b^2]]])/(Sqrt[-b^2]*d) - (2*b*(a + b*Cot[c + d*x])^(3/2))/(3*d)}
{(-a + b*Cot[c + d*x])*(a + b*Cot[c + d*x])^(1/2), x, 7, (b*(a^2 + b^2)*ArcTanh[Sqrt[a + b*Cot[c + d*x]]/Sqrt[a - Sqrt[-b^2]]])/(Sqrt[-b^2]*Sqrt[a - Sqrt[-b^2]]*d) - (b*(a^2 + b^2)*ArcTanh[Sqrt[a + b*Cot[c + d*x]]/Sqrt[a + Sqrt[-b^2]]])/(Sqrt[-b^2]*Sqrt[a + Sqrt[-b^2]]*d) - (2*b*Sqrt[a + b*Cot[c + d*x]])/d}
