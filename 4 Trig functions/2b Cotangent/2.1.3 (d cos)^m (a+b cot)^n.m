...
{Cos[x]^4/(a + b*Cot[x]), x, 11, (a^5*x)/(a^2 + b^2)^3 + (3*a*x)/(8*(a^2 + b^2)) - (a*(2*a^2 + b^2)*x)/(2*(a^2 + b^2)^2) - (a^4*b*Log[b*Cos[x] + a*Sin[x]])/(a^2 + b^2)^3 - (3*a*Cos[x]*Sin[x])/(8*(a^2 + b^2)) + ((2*a^2 + b^2)*(b + a*Cot[x])*Sin[x]^2)/(2*(a^2 + b^2)^2) - ((b + a*Cot[x])*Sin[x]^4)/(4*(a^2 + b^2))}
...
{Cos[x]^2/(a + b*Cot[x]), x, 8, (a^3*x)/(a^2 + b^2)^2 - (a*x)/(2*(a^2 + b^2)) - (a^2*b*Log[b*Cos[x] + a*Sin[x]])/(a^2 + b^2)^2 + ((b + a*Cot[x])*Sin[x]^2)/(2*(a^2 + b^2))}
