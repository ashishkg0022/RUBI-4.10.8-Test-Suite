...
{Sec[a + b*x]*(c + d*x)^3, x, 9, -((2*I*(c + d*x)^3*ArcTan[E^(I*a + I*b*x)])/b) + (3*I*d*(c + d*x)^2*PolyLog[2, (-I)*E^(I*(a + b*x))])/b^2 - (3*I*d*(c + d*x)^2*PolyLog[2, I*E^(I*(a + b*x))])/b^2 - (6*d^2*(c + d*x)*PolyLog[3, (-I)*E^(I*(a + b*x))])/b^3 + (6*d^2*(c + d*x)*PolyLog[3, I*E^(I*(a + b*x))])/b^3 - (6*I*d^3*PolyLog[4, (-I)*E^(I*(a + b*x))])/b^4 + (6*I*d^3*PolyLog[4, I*E^(I*(a + b*x))])/b^4}
{Sec[a + b*x]*(c + d*x)^2, x, 7, -((2*I*(c + d*x)^2*ArcTan[E^(I*a + I*b*x)])/b) + (2*I*d*(c + d*x)*PolyLog[2, (-I)*E^(I*(a + b*x))])/b^2 - (2*I*d*(c + d*x)*PolyLog[2, I*E^(I*(a + b*x))])/b^2 - (2*d^2*PolyLog[3, (-I)*E^(I*(a + b*x))])/b^3 + (2*d^2*PolyLog[3, I*E^(I*(a + b*x))])/b^3}
{Sec[a + b*x]*(c + d*x)^1, x, 5, -((2*I*(c + d*x)*ArcTan[E^(I*a + I*b*x)])/b) + (I*d*PolyLog[2, (-I)*E^(I*(a + b*x))])/b^2 - (I*d*PolyLog[2, I*E^(I*(a + b*x))])/b^2}
{Sec[a + b*x]/(c + d*x)^1, x, 0, Defer[Int][Sec[a + b*x]/(c + d*x), x]}
...
{Sec[a + b*x]^2/(c + d*x)^1, x, 0, Defer[Int][Sec[a + b*x]^2/(c + d*x), x]}
...
{Sec[a + b*x]^3*(c + d*x)^2, x, 9, -((I*(c + d*x)^2*ArcTan[E^(I*a + I*b*x)])/b) + (d^2*ArcTanh[Sin[a + b*x]])/b^3 + (I*d*(c + d*x)*PolyLog[2, (-I)*E^(I*(a + b*x))])/b^2 - (I*d*(c + d*x)*PolyLog[2, I*E^(I*(a + b*x))])/b^2 - (d^2*PolyLog[3, (-I)*E^(I*(a + b*x))])/b^3 + (d^2*PolyLog[3, I*E^(I*(a + b*x))])/b^3 - (d*(c + d*x)*Sec[a + b*x])/b^2 + ((c + d*x)^2*Sec[a + b*x]*Tan[a + b*x])/(2*b)}
{Sec[a + b*x]^3*(c + d*x)^1, x, 6, -((I*(c + d*x)*ArcTan[E^(I*a + I*b*x)])/b) + (I*d*PolyLog[2, (-I)*E^(I*(a + b*x))])/(2*b^2) - (I*d*PolyLog[2, I*E^(I*(a + b*x))])/(2*b^2) - (d*Sec[a + b*x])/(2*b^2) + ((c + d*x)*Sec[a + b*x]*Tan[a + b*x])/(2*b)}
{Sec[a + b*x]^2/(c + d*x)^1, x, 0, Defer[Int][Sec[a + b*x]^2/(c + d*x), x]}
...
{x^1*Cos[a + b*x]^(1/2), x, 0, Defer[Int][x*Sqrt[Cos[a + b*x]], x]}
{x^0*Cos[a + b*x]^(1/2), x, 1, (2*EllipticE[(1/2)*(a + b*x), 2])/b}
{Cos[a + b*x]^(1/2)/x^1, x, 0, Defer[Int][Sqrt[Cos[a + b*x]]/x, x]}


{x^1*Cos[a + b*x]^(3/2), x, 1, (4*Cos[a + b*x]^(3/2))/(9*b^2) + (1/3)*Defer[Int][x/Sqrt[Cos[a + b*x]], x] + (2*x*Sqrt[Cos[a + b*x]]*Sin[a + b*x])/(3*b)}
{x^0*Cos[a + b*x]^(3/2), x, 2, (2*EllipticF[(1/2)*(a + b*x), 2])/(3*b) + (2*Sqrt[Cos[a + b*x]]*Sin[a + b*x])/(3*b)}
{Cos[a + b*x]^(3/2)/x^1, x, 0, Defer[Int][Cos[a + b*x]^(3/2)/x, x]}

{x^1*Cos[a + b*x]^(3/2) - x/(3*Sqrt[Cos[a + b*x]]), x, 2, (4*Cos[a + b*x]^(3/2))/(9*b^2) + (2*x*Sqrt[Cos[a + b*x]]*Sin[a + b*x])/(3*b)}


{Cos[x]^(3/2)/x^3, x, 1, -(Cos[x]^(3/2)/(2*x^2)) + (3/8)*Defer[Int][1/(x*Sqrt[Cos[x]]), x] - (9/8)*Defer[Int][Cos[x]^(3/2)/x, x] + (3*Sqrt[Cos[x]]*Sin[x])/(4*x)}


{x^1/Cos[a + b*x]^(1/2), x, 0, Defer[Int][x/Sqrt[Cos[a + b*x]], x]}
{x^0/Cos[a + b*x]^(1/2), x, 1, (2*EllipticF[(1/2)*(a + b*x), 2])/b}
{1/(x^1*Cos[a + b*x]^(1/2)), x, 0, Defer[Int][1/(x*Sqrt[Cos[a + b*x]]), x]}


{x^1/Cos[a + b*x]^(3/2), x, 1, (4*Sqrt[Cos[a + b*x]])/b^2 + (2*x*Sin[a + b*x])/(b*Sqrt[Cos[a + b*x]]) - Defer[Int][x*Sqrt[Cos[a + b*x]], x]}
{x^0/Cos[a + b*x]^(3/2), x, 2, -((2*EllipticE[(1/2)*(a + b*x), 2])/b) + (2*Sin[a + b*x])/(b*Sqrt[Cos[a + b*x]])}
{1/(x^1*Cos[a + b*x]^(3/2)), x, 0, Defer[Int][1/(x*Cos[a + b*x]^(3/2)), x]}
...
{(c + d*x)^m*(b*Cos[e + f*x])^n, x, 0, Defer[Int][(c + d*x)^m*(b*Cos[e + f*x])^n, x]}
...
{Sec[a + b*x]*(c + d*x)^m, x, 0, Defer[Int][(c + d*x)^m*Sec[a + b*x], x]}
{Sec[a + b*x]^2*(c + d*x)^m, x, 0, Defer[Int][(c + d*x)^m*Sec[a + b*x]^2, x]}
...
{1/(x*(a + a*Cos[x])), x, 1, Defer[Int][Sec[x/2]^2/x, x]/(2*a)}
...
{1/(x*(a - a*Cos[x])), x, 1, Defer[Int][Csc[x/2]^2/x, x]/(2*a)}
...
{x^3/Sqrt[a + a*Cos[c + d*x]], x, 10, -((4*I*x^3*ArcTan[E^((I*c)/2 + (I*d*x)/2)]*Cos[c/2 + (d*x)/2])/(d*Sqrt[a + a*Cos[c + d*x]])) + (12*I*x^2*Cos[c/2 + (d*x)/2]*PolyLog[2, (-I)*E^((1/2)*I*(c + d*x))])/(d^2*Sqrt[a + a*Cos[c + d*x]]) - (12*I*x^2*Cos[c/2 + (d*x)/2]*PolyLog[2, I*E^((1/2)*I*(c + d*x))])/(d^2*Sqrt[a + a*Cos[c + d*x]]) - (48*x*Cos[c/2 + (d*x)/2]*PolyLog[3, (-I)*E^((1/2)*I*(c + d*x))])/(d^3*Sqrt[a + a*Cos[c + d*x]]) + (48*x*Cos[c/2 + (d*x)/2]*PolyLog[3, I*E^((1/2)*I*(c + d*x))])/(d^3*Sqrt[a + a*Cos[c + d*x]]) - (96*I*Cos[c/2 + (d*x)/2]*PolyLog[4, (-I)*E^((1/2)*I*(c + d*x))])/(d^4*Sqrt[a + a*Cos[c + d*x]]) + (96*I*Cos[c/2 + (d*x)/2]*PolyLog[4, I*E^((1/2)*I*(c + d*x))])/(d^4*Sqrt[a + a*Cos[c + d*x]])}
{x^2/Sqrt[a + a*Cos[c + d*x]], x, 8, -((4*I*x^2*ArcTan[E^((I*c)/2 + (I*d*x)/2)]*Cos[c/2 + (d*x)/2])/(d*Sqrt[a + a*Cos[c + d*x]])) + (8*I*x*Cos[c/2 + (d*x)/2]*PolyLog[2, (-I)*E^((1/2)*I*(c + d*x))])/(d^2*Sqrt[a + a*Cos[c + d*x]]) - (8*I*x*Cos[c/2 + (d*x)/2]*PolyLog[2, I*E^((1/2)*I*(c + d*x))])/(d^2*Sqrt[a + a*Cos[c + d*x]]) - (16*Cos[c/2 + (d*x)/2]*PolyLog[3, (-I)*E^((1/2)*I*(c + d*x))])/(d^3*Sqrt[a + a*Cos[c + d*x]]) + (16*Cos[c/2 + (d*x)/2]*PolyLog[3, I*E^((1/2)*I*(c + d*x))])/(d^3*Sqrt[a + a*Cos[c + d*x]])}
{x/Sqrt[a + a*Cos[c + d*x]], x, 6, -((4*I*x*ArcTan[E^((I*c)/2 + (I*d*x)/2)]*Cos[c/2 + (d*x)/2])/(d*Sqrt[a + a*Cos[c + d*x]])) + (4*I*Cos[c/2 + (d*x)/2]*PolyLog[2, (-I)*E^((1/2)*I*(c + d*x))])/(d^2*Sqrt[a + a*Cos[c + d*x]]) - (4*I*Cos[c/2 + (d*x)/2]*PolyLog[2, I*E^((1/2)*I*(c + d*x))])/(d^2*Sqrt[a + a*Cos[c + d*x]])}
{1/Sqrt[a + a*Cos[c + d*x]], x, 2, (Sqrt[2]*ArcTanh[(Sqrt[a]*Sin[c + d*x])/(Sqrt[2]*Sqrt[a + a*Cos[c + d*x]])])/(Sqrt[a]*d)}
{1/(x*Sqrt[a + a*Cos[c + d*x]]), x, 0, Defer[Int][1/(x*Sqrt[a + a*Cos[c + d*x]]), x]}


{x^3/Sqrt[a + a*Cos[x]], x, 10, -((4*I*x^3*ArcTan[E^((I*x)/2)]*Cos[x/2])/Sqrt[a + a*Cos[x]]) + (12*I*x^2*Cos[x/2]*PolyLog[2, (-I)*E^((I*x)/2)])/Sqrt[a + a*Cos[x]] - (12*I*x^2*Cos[x/2]*PolyLog[2, I*E^((I*x)/2)])/Sqrt[a + a*Cos[x]] - (48*x*Cos[x/2]*PolyLog[3, (-I)*E^((I*x)/2)])/Sqrt[a + a*Cos[x]] + (48*x*Cos[x/2]*PolyLog[3, I*E^((I*x)/2)])/Sqrt[a + a*Cos[x]] - (96*I*Cos[x/2]*PolyLog[4, (-I)*E^((I*x)/2)])/Sqrt[a + a*Cos[x]] + (96*I*Cos[x/2]*PolyLog[4, I*E^((I*x)/2)])/Sqrt[a + a*Cos[x]]}
{x^2/Sqrt[a + a*Cos[x]], x, 8, -((4*I*x^2*ArcTan[E^((I*x)/2)]*Cos[x/2])/Sqrt[a + a*Cos[x]]) + (8*I*x*Cos[x/2]*PolyLog[2, (-I)*E^((I*x)/2)])/Sqrt[a + a*Cos[x]] - (8*I*x*Cos[x/2]*PolyLog[2, I*E^((I*x)/2)])/Sqrt[a + a*Cos[x]] - (16*Cos[x/2]*PolyLog[3, (-I)*E^((I*x)/2)])/Sqrt[a + a*Cos[x]] + (16*Cos[x/2]*PolyLog[3, I*E^((I*x)/2)])/Sqrt[a + a*Cos[x]]}
{x/Sqrt[a + a*Cos[x]], x, 6, -((4*I*x*ArcTan[E^((I*x)/2)]*Cos[x/2])/Sqrt[a + a*Cos[x]]) + (4*I*Cos[x/2]*PolyLog[2, (-I)*E^((I*x)/2)])/Sqrt[a + a*Cos[x]] - (4*I*Cos[x/2]*PolyLog[2, I*E^((I*x)/2)])/Sqrt[a + a*Cos[x]]}
{1/Sqrt[a + a*Cos[x]], x, 2, (Sqrt[2]*ArcTanh[(Sqrt[a]*Sin[x])/(Sqrt[2]*Sqrt[a + a*Cos[x]])])/Sqrt[a]}
{1/(x*Sqrt[a + a*Cos[x]]), x, 0, Defer[Int][1/(x*Sqrt[a + a*Cos[x]]), x]}
...
{x/(a + a*Cos[x])^(3/2), x, 7, -(1/(a*Sqrt[a + a*Cos[x]])) - (I*x*ArcTan[E^((I*x)/2)]*Cos[x/2])/(a*Sqrt[a + a*Cos[x]]) + (I*Cos[x/2]*PolyLog[2, (-I)*E^((I*x)/2)])/(a*Sqrt[a + a*Cos[x]]) - (I*Cos[x/2]*PolyLog[2, I*E^((I*x)/2)])/(a*Sqrt[a + a*Cos[x]]) + (x*Tan[x/2])/(2*a*Sqrt[a + a*Cos[x]])}
{1/(x*(a + a*Cos[x])^(3/2)), x, 0, Defer[Int][1/(x*(a + a*Cos[x])^(3/2)), x]}
...
(* Used to hang Rubi *)
{(a + a*Cos[c + d*x])^(1/3)/x, x, 0, Defer[Int][(a + a*Cos[c + d*x])^(1/3)/x, x]}
...
{1/(x*(a + b*Cos[x])), x, 0, Defer[Int][1/(x*(a + b*Cos[x])), x]}
{x/(a + b*Cos[c + d*x]), x, 8, -((I*x*Log[1 + (b*E^(I*(c + d*x)))/(a - Sqrt[a^2 - b^2])])/(Sqrt[a^2 - b^2]*d)) + (I*x*Log[1 + (b*E^(I*(c + d*x)))/(a + Sqrt[a^2 - b^2])])/(Sqrt[a^2 - b^2]*d) - PolyLog[2, -((b*E^(I*(c + d*x)))/(a - Sqrt[a^2 - b^2]))]/(Sqrt[a^2 - b^2]*d^2) + PolyLog[2, -((b*E^(I*(c + d*x)))/(a + Sqrt[a^2 - b^2]))]/(Sqrt[a^2 - b^2]*d^2)}
