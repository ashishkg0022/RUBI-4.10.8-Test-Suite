...
{Sec[c + d*x]^1*(A + C*Cos[c + d*x]^2), x, 3, (A*ArcTanh[Sin[c + d*x]])/d + (C*Sin[c + d*x])/d}
{Sec[c + d*x]^3*(A + C*Cos[c + d*x]^2), x, 3, ((A + 2*C)*ArcTanh[Sin[c + d*x]])/(2*d) + (A*Sec[c + d*x]*Tan[c + d*x])/(2*d)}
{Sec[c + d*x]^5*(A + C*Cos[c + d*x]^2), x, 4, ((3*A + 4*C)*ArcTanh[Sin[c + d*x]])/(8*d) + ((3*A + 4*C)*Sec[c + d*x]*Tan[c + d*x])/(8*d) + (A*Sec[c + d*x]^3*Tan[c + d*x])/(4*d)}
{Sec[c + d*x]^7*(A + C*Cos[c + d*x]^2), x, 5, ((5*A + 6*C)*ArcTanh[Sin[c + d*x]])/(16*d) + ((5*A + 6*C)*Sec[c + d*x]*Tan[c + d*x])/(16*d) + ((5*A + 6*C)*Sec[c + d*x]^3*Tan[c + d*x])/(24*d) + (A*Sec[c + d*x]^5*Tan[c + d*x])/(6*d)}
...
{(A + C*Cos[c + d*x]^2)*(b*Sec[c + d*x])^(9/2), x, 5, (2*(5*A + 7*C)*Cos[c + d*x]^(9/2)*EllipticF[(1/2)*(c + d*x), 2]*(b*Sec[c + d*x])^(9/2))/(21*d) + (2*A*Cos[c + d*x]*(b*Sec[c + d*x])^(9/2)*Sin[c + d*x])/(7*d) + (2*(5*A + 7*C)*Cos[c + d*x]^3*(b*Sec[c + d*x])^(9/2)*Sin[c + d*x])/(21*d)}
{(A + C*Cos[c + d*x]^2)*(b*Sec[c + d*x])^(7/2), x, 5, -((2*(3*A + 5*C)*Cos[c + d*x]^(7/2)*EllipticE[(1/2)*(c + d*x), 2]*(b*Sec[c + d*x])^(7/2))/(5*d)) + (2*A*Cos[c + d*x]*(b*Sec[c + d*x])^(7/2)*Sin[c + d*x])/(5*d) + (2*(3*A + 5*C)*Cos[c + d*x]^3*(b*Sec[c + d*x])^(7/2)*Sin[c + d*x])/(5*d)}
{(A + C*Cos[c + d*x]^2)*(b*Sec[c + d*x])^(5/2), x, 4, (2*(A + 3*C)*Cos[c + d*x]^(5/2)*EllipticF[(1/2)*(c + d*x), 2]*(b*Sec[c + d*x])^(5/2))/(3*d) + (2*A*Cos[c + d*x]*(b*Sec[c + d*x])^(5/2)*Sin[c + d*x])/(3*d)}
{(A + C*Cos[c + d*x]^2)*(b*Sec[c + d*x])^(3/2), x, 4, -((2*(A - C)*Cos[c + d*x]^(3/2)*EllipticE[(1/2)*(c + d*x), 2]*(b*Sec[c + d*x])^(3/2))/d) + (2*A*Cos[c + d*x]*(b*Sec[c + d*x])^(3/2)*Sin[c + d*x])/d}
{(A + C*Cos[c + d*x]^2)*(b*Sec[c + d*x])^(1/2), x, 4, (2*(3*A + C)*Sqrt[Cos[c + d*x]]*EllipticF[(1/2)*(c + d*x), 2]*Sqrt[b*Sec[c + d*x]])/(3*d) + (2*C*Cos[c + d*x]*Sqrt[b*Sec[c + d*x]]*Sin[c + d*x])/(3*d)}
{(A + C*Cos[c + d*x]^2)/(b*Sec[c + d*x])^(1/2), x, 4, (2*(5*A + 3*C)*EllipticE[(1/2)*(c + d*x), 2])/(5*d*Sqrt[Cos[c + d*x]]*Sqrt[b*Sec[c + d*x]]) + (2*C*Cos[c + d*x]*Sin[c + d*x])/(5*d*Sqrt[b*Sec[c + d*x]])}
{(A + C*Cos[c + d*x]^2)/(b*Sec[c + d*x])^(3/2), x, 5, (2*(7*A + 5*C)*EllipticF[(1/2)*(c + d*x), 2])/(21*d*Cos[c + d*x]^(3/2)*(b*Sec[c + d*x])^(3/2)) + (2*C*Cos[c + d*x]*Sin[c + d*x])/(7*d*(b*Sec[c + d*x])^(3/2)) + (2*(7*A + 5*C)*Tan[c + d*x])/(21*d*(b*Sec[c + d*x])^(3/2))}
{(A + C*Cos[c + d*x]^2)/(b*Sec[c + d*x])^(5/2), x, 5, (2*(9*A + 7*C)*EllipticE[(1/2)*(c + d*x), 2])/(15*d*Cos[c + d*x]^(5/2)*(b*Sec[c + d*x])^(5/2)) + (2*C*Cos[c + d*x]*Sin[c + d*x])/(9*d*(b*Sec[c + d*x])^(5/2)) + (2*(9*A + 7*C)*Tan[c + d*x])/(45*d*(b*Sec[c + d*x])^(5/2))}
...
{(Sqrt[b*Cos[c + d*x]]*(A + C*Cos[c + d*x]^2))/Cos[c + d*x]^(3/2), x, 4, (A*ArcTanh[Sin[c + d*x]]*Sqrt[b*Cos[c + d*x]])/(d*Sqrt[Cos[c + d*x]]) + (C*Sqrt[b*Cos[c + d*x]]*Sin[c + d*x])/(d*Sqrt[Cos[c + d*x]])}
...
{(Sqrt[b*Cos[c + d*x]]*(A + C*Cos[c + d*x]^2))/Cos[c + d*x]^(7/2), x, 4, ((A + 2*C)*ArcTanh[Sin[c + d*x]]*Sqrt[b*Cos[c + d*x]])/(2*d*Sqrt[Cos[c + d*x]]) + (A*Sqrt[b*Cos[c + d*x]]*Sin[c + d*x])/(2*d*Cos[c + d*x]^(5/2))}
...
{(Sqrt[b*Cos[c + d*x]]*(A + C*Cos[c + d*x]^2))/Cos[c + d*x]^(11/2), x, 5, ((3*A + 4*C)*ArcTanh[Sin[c + d*x]]*Sqrt[b*Cos[c + d*x]])/(8*d*Sqrt[Cos[c + d*x]]) + (A*Sqrt[b*Cos[c + d*x]]*Sin[c + d*x])/(4*d*Cos[c + d*x]^(9/2)) + ((3*A + 4*C)*Sqrt[b*Cos[c + d*x]]*Sin[c + d*x])/(8*d*Cos[c + d*x]^(5/2))}
...
{((b*Cos[c + d*x])^(3/2)*(A + C*Cos[c + d*x]^2))/Cos[c + d*x]^(5/2), x, 4, (A*b*ArcTanh[Sin[c + d*x]]*Sqrt[b*Cos[c + d*x]])/(d*Sqrt[Cos[c + d*x]]) + (b*C*Sqrt[b*Cos[c + d*x]]*Sin[c + d*x])/(d*Sqrt[Cos[c + d*x]])}
...
{((b*Cos[c + d*x])^(3/2)*(A + C*Cos[c + d*x]^2))/Cos[c + d*x]^(9/2), x, 4, (b*(A + 2*C)*ArcTanh[Sin[c + d*x]]*Sqrt[b*Cos[c + d*x]])/(2*d*Sqrt[Cos[c + d*x]]) + (A*b*Sqrt[b*Cos[c + d*x]]*Sin[c + d*x])/(2*d*Cos[c + d*x]^(5/2))}
...
{((b*Cos[c + d*x])^(3/2)*(A + C*Cos[c + d*x]^2))/Cos[c + d*x]^(13/2), x, 5, (b*(3*A + 4*C)*ArcTanh[Sin[c + d*x]]*Sqrt[b*Cos[c + d*x]])/(8*d*Sqrt[Cos[c + d*x]]) + (A*b*Sqrt[b*Cos[c + d*x]]*Sin[c + d*x])/(4*d*Cos[c + d*x]^(9/2)) + (b*(3*A + 4*C)*Sqrt[b*Cos[c + d*x]]*Sin[c + d*x])/(8*d*Cos[c + d*x]^(5/2))}
...
{((b*Cos[c + d*x])^(5/2)*(A + C*Cos[c + d*x]^2))/Cos[c + d*x]^(7/2), x, 4, (A*b^2*ArcTanh[Sin[c + d*x]]*Sqrt[b*Cos[c + d*x]])/(d*Sqrt[Cos[c + d*x]]) + (b^2*C*Sqrt[b*Cos[c + d*x]]*Sin[c + d*x])/(d*Sqrt[Cos[c + d*x]])}
...
{((b*Cos[c + d*x])^(5/2)*(A + C*Cos[c + d*x]^2))/Cos[c + d*x]^(11/2), x, 4, (b^2*(A + 2*C)*ArcTanh[Sin[c + d*x]]*Sqrt[b*Cos[c + d*x]])/(2*d*Sqrt[Cos[c + d*x]]) + (A*b^2*Sqrt[b*Cos[c + d*x]]*Sin[c + d*x])/(2*d*Cos[c + d*x]^(5/2))}
...
{((b*Cos[c + d*x])^(5/2)*(A + C*Cos[c + d*x]^2))/Cos[c + d*x]^(15/2), x, 5, (b^2*(3*A + 4*C)*ArcTanh[Sin[c + d*x]]*Sqrt[b*Cos[c + d*x]])/(8*d*Sqrt[Cos[c + d*x]]) + (A*b^2*Sqrt[b*Cos[c + d*x]]*Sin[c + d*x])/(4*d*Cos[c + d*x]^(9/2)) + (b^2*(3*A + 4*C)*Sqrt[b*Cos[c + d*x]]*Sin[c + d*x])/(8*d*Cos[c + d*x]^(5/2))}
...
{(A + C*Cos[c + d*x]^2)/(Sqrt[Cos[c + d*x]]*Sqrt[b*Cos[c + d*x]]), x, 4, (A*ArcTanh[Sin[c + d*x]]*Sqrt[Cos[c + d*x]])/(d*Sqrt[b*Cos[c + d*x]]) + (C*Sqrt[Cos[c + d*x]]*Sin[c + d*x])/(d*Sqrt[b*Cos[c + d*x]])}
...
{(A + C*Cos[c + d*x]^2)/(Cos[c + d*x]^(5/2)*Sqrt[b*Cos[c + d*x]]), x, 4, ((A + 2*C)*ArcTanh[Sin[c + d*x]]*Sqrt[Cos[c + d*x]])/(2*d*Sqrt[b*Cos[c + d*x]]) + (A*Sin[c + d*x])/(2*d*Cos[c + d*x]^(3/2)*Sqrt[b*Cos[c + d*x]])}
...
{(A + C*Cos[c + d*x]^2)/(Cos[c + d*x]^(9/2)*Sqrt[b*Cos[c + d*x]]), x, 5, ((3*A + 4*C)*ArcTanh[Sin[c + d*x]]*Sqrt[Cos[c + d*x]])/(8*d*Sqrt[b*Cos[c + d*x]]) + (A*Sin[c + d*x])/(4*d*Cos[c + d*x]^(7/2)*Sqrt[b*Cos[c + d*x]]) + ((3*A + 4*C)*Sin[c + d*x])/(8*d*Cos[c + d*x]^(3/2)*Sqrt[b*Cos[c + d*x]])}
...
{(Sqrt[Cos[c + d*x]]*(A + C*Cos[c + d*x]^2))/(b*Cos[c + d*x])^(3/2), x, 4, (A*ArcTanh[Sin[c + d*x]]*Sqrt[Cos[c + d*x]])/(b*d*Sqrt[b*Cos[c + d*x]]) + (C*Sqrt[Cos[c + d*x]]*Sin[c + d*x])/(b*d*Sqrt[b*Cos[c + d*x]])}
...
{(A + C*Cos[c + d*x]^2)/(Cos[c + d*x]^(3/2)*(b*Cos[c + d*x])^(3/2)), x, 4, ((A + 2*C)*ArcTanh[Sin[c + d*x]]*Sqrt[Cos[c + d*x]])/(2*b*d*Sqrt[b*Cos[c + d*x]]) + (A*Sin[c + d*x])/(2*b*d*Cos[c + d*x]^(3/2)*Sqrt[b*Cos[c + d*x]])}
...
{(A + C*Cos[c + d*x]^2)/(Cos[c + d*x]^(7/2)*(b*Cos[c + d*x])^(3/2)), x, 5, ((3*A + 4*C)*ArcTanh[Sin[c + d*x]]*Sqrt[Cos[c + d*x]])/(8*b*d*Sqrt[b*Cos[c + d*x]]) + (A*Sin[c + d*x])/(4*b*d*Cos[c + d*x]^(7/2)*Sqrt[b*Cos[c + d*x]]) + ((3*A + 4*C)*Sin[c + d*x])/(8*b*d*Cos[c + d*x]^(3/2)*Sqrt[b*Cos[c + d*x]])}
...
{(Cos[c + d*x]^(3/2)*(A + C*Cos[c + d*x]^2))/(b*Cos[c + d*x])^(5/2), x, 4, (A*ArcTanh[Sin[c + d*x]]*Sqrt[Cos[c + d*x]])/(b^2*d*Sqrt[b*Cos[c + d*x]]) + (C*Sqrt[Cos[c + d*x]]*Sin[c + d*x])/(b^2*d*Sqrt[b*Cos[c + d*x]])}
...
{(A + C*Cos[c + d*x]^2)/(Sqrt[Cos[c + d*x]]*(b*Cos[c + d*x])^(5/2)), x, 4, ((A + 2*C)*ArcTanh[Sin[c + d*x]]*Sqrt[Cos[c + d*x]])/(2*b^2*d*Sqrt[b*Cos[c + d*x]]) + (A*Sin[c + d*x])/(2*b^2*d*Cos[c + d*x]^(3/2)*Sqrt[b*Cos[c + d*x]])}
...
{(A + C*Cos[c + d*x]^2)/(Cos[c + d*x]^(5/2)*(b*Cos[c + d*x])^(5/2)), x, 5, ((3*A + 4*C)*ArcTanh[Sin[c + d*x]]*Sqrt[Cos[c + d*x]])/(8*b^2*d*Sqrt[b*Cos[c + d*x]]) + (A*Sin[c + d*x])/(4*b^2*d*Cos[c + d*x]^(7/2)*Sqrt[b*Cos[c + d*x]]) + ((3*A + 4*C)*Sin[c + d*x])/(8*b^2*d*Cos[c + d*x]^(3/2)*Sqrt[b*Cos[c + d*x]])}
