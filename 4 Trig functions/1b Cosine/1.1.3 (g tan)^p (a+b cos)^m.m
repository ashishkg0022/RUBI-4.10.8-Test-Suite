...
{Cot[x]^3/(a + b*Cos[x]), x, 3, -(b/(4*(a + b)*(b - b*Cos[x]))) - b/(4*(a - b)*(b + b*Cos[x])) - ((2*a + b)*Log[1 - Cos[x]])/(4*(a + b)^2) - ((2*a - b)*Log[1 + Cos[x]])/(4*(a - b)^2) + (a^3*Log[a + b*Cos[x]])/(a^2 - b^2)^2}
...
{Tan[x]*Sqrt[2 + 3*Cos[x]], x, 4, 2*Sqrt[2]*ArcTanh[Sqrt[2 + 3*Cos[x]]/Sqrt[2]] - 2*Sqrt[2 + 3*Cos[x]]}
{Tan[x]/Sqrt[2 + 3*Cos[x]], x, 3, Sqrt[2]*ArcTanh[Sqrt[2 + 3*Cos[x]]/Sqrt[2]]}
...
{(g*Tan[e + f*x])^p*(a + b*Cos[e + f*x])^m, x, 1, (g*Cot[e + f*x])^p*(g*Tan[e + f*x])^p*Defer[Int][(a + b*Cos[e + f*x])^m/(g*Cot[e + f*x])^p, x]}
