...
{(a*Cos[e + f*x])^m*(Csc[e + f*x])^n, x, 2, -(((a*Cos[e + f*x])^(1 + m)*Csc[e + f*x]^(1 + n)*Hypergeometric2F1[(1 + m)/2, (1 + n)/2, (3 + m)/2, Cos[e + f*x]^2]*(Sin[e + f*x]^2)^((1 + n)/2))/(a*f*(1 + m)))}
{(Cos[e + f*x])^m*(b*Csc[e + f*x])^n, x, 2, (Cos[e + f*x]^(-1 + m)*(Cos[e + f*x]^2)^((1 - m)/2)*(b*Csc[e + f*x])^n*Hypergeometric2F1[(1 - m)/2, (1 - n)/2, (3 - n)/2, Sin[e + f*x]^2]*Sin[e + f*x])/(f*(1 - n))}
{(a*Cos[e + f*x])^m*(b*Csc[e + f*x])^n, x, 2, (a*(a*Cos[e + f*x])^(-1 + m)*(Cos[e + f*x]^2)^((1 - m)/2)*(b*Csc[e + f*x])^n*Hypergeometric2F1[(1 - m)/2, (1 - n)/2, (3 - n)/2, Sin[e + f*x]^2]*Sin[e + f*x])/(f*(1 - n))}


{(a*Cos[e + f*x])^m*(b*Csc[e + f*x])^(7/2), x, 2, -((b^3*(a*Cos[e + f*x])^(1 + m)*Sqrt[b*Csc[e + f*x]]*Hypergeometric2F1[9/4, (1 + m)/2, (3 + m)/2, Cos[e + f*x]^2]*(Sin[e + f*x]^2)^(1/4))/(a*f*(1 + m)))}
{(a*Cos[e + f*x])^m*(b*Csc[e + f*x])^(5/2), x, 2, If[$VersionNumber>=8, -((b^2*(a*Cos[e + f*x])^(1 + m)*Csc[e + f*x]*Sqrt[b*Csc[e + f*x]]*Hypergeometric2F1[7/4, (1 + m)/2, (3 + m)/2, Cos[e + f*x]^2]*(Sin[e + f*x]^2)^(3/4))/(a*f*(1 + m))), -((b*(a*Cos[e + f*x])^(1 + m)*(b*Csc[e + f*x])^(3/2)*Hypergeometric2F1[7/4, (1 + m)/2, (3 + m)/2, Cos[e + f*x]^2]*(Sin[e + f*x]^2)^(3/4))/(a*f*(1 + m)))]}
...
{(a*Cos[e + f*x])^m*(b*Csc[e + f*x])^(1/2), x, 2, If[$VersionNumber>=8, -(((a*Cos[e + f*x])^(1 + m)*Csc[e + f*x]*Sqrt[b*Csc[e + f*x]]*Hypergeometric2F1[3/4, (1 + m)/2, (3 + m)/2, Cos[e + f*x]^2]*(Sin[e + f*x]^2)^(3/4))/(a*f*(1 + m))), -(((a*Cos[e + f*x])^(1 + m)*(b*Csc[e + f*x])^(3/2)*Hypergeometric2F1[3/4, (1 + m)/2, (3 + m)/2, Cos[e + f*x]^2]*(Sin[e + f*x]^2)^(3/4))/(a*b*f*(1 + m)))]}
...
{(a*Cos[e + f*x])^m/(b*Csc[e + f*x])^(3/2), x, 2, -(((a*Cos[e + f*x])^(1 + m)*Sqrt[b*Csc[e + f*x]]*Hypergeometric2F1[-(1/4), (1 + m)/2, (3 + m)/2, Cos[e + f*x]^2]*Sin[e + f*x])/(a*b^2*f*(1 + m)*(Sin[e + f*x]^2)^(1/4)))}
{(a*Cos[e + f*x])^m/(b*Csc[e + f*x])^(5/2), x, 2, -(((a*Cos[e + f*x])^(1 + m)*Sqrt[b*Csc[e + f*x]]*Hypergeometric2F1[-(3/4), (1 + m)/2, (3 + m)/2, Cos[e + f*x]^2]*(Sin[e + f*x]^2)^(1/4))/(a*b^3*f*(1 + m)))}
