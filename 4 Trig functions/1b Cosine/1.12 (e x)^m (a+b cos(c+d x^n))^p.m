...
{Cos[a + b*x^2]^2/x^3, x, 7, -(1/(4*x^2)) - Cos[2*a + 2*b*x^2]/(4*x^2) - (1/2)*b*CosIntegral[2*b*x^2]*Sin[2*a] - (1/2)*b*Cos[2*a]*SinIntegral[2*b*x^2]}
...
{Cos[a + b*x^2]^3/x^3, x, 12, -((3*Cos[a + b*x^2])/(8*x^2)) - Cos[3*a + 3*b*x^2]/(8*x^2) - (3/8)*b*CosIntegral[b*x^2]*Sin[a] - (3/8)*b*CosIntegral[3*b*x^2]*Sin[3*a] - (3/8)*b*Cos[a]*SinIntegral[b*x^2] - (3/8)*b*Cos[3*a]*SinIntegral[3*b*x^2]}
...
{Cos[a + b*x^(1/3)]^2/x^(1/2), x, 9, Sqrt[x] - (3*Sqrt[Pi]*Cos[2*a]*FresnelS[(2*Sqrt[b]*x^(1/6))/Sqrt[Pi]])/(8*b^(3/2)) - (3*Sqrt[Pi]*FresnelC[(2*Sqrt[b]*x^(1/6))/Sqrt[Pi]]*Sin[2*a])/(8*b^(3/2)) + (3*x^(1/6)*Sin[2*a + 2*b*x^(1/3)])/(4*b)}
...
{Cos[a + b*x^n]^2/x^(n + 1), x, 7, -(1/(x^n*(2*n))) - Cos[2*a + 2*b*x^n]/(x^n*(2*n)) - (b*CosIntegral[2*b*x^n]*Sin[2*a])/n - (b*Cos[2*a]*SinIntegral[2*b*x^n])/n}
{Cos[a + b*x^n]^3/x^(n + 1), x, 12, -((3*Cos[a + b*x^n])/(x^n*(4*n))) - Cos[3*a + 3*b*x^n]/(x^n*(4*n)) - (3*b*CosIntegral[b*x^n]*Sin[a])/(4*n) - (3*b*CosIntegral[3*b*x^n]*Sin[3*a])/(4*n) - (3*b*Cos[a]*SinIntegral[b*x^n])/(4*n) - (3*b*Cos[3*a]*SinIntegral[3*b*x^n])/(4*n)}
...
{Cos[a + b*x^n]^2/x^(2*n + 1), x, 8, -(1/(x^(2*n)*(4*n))) - Cos[2*a + 2*b*x^n]/(x^(2*n)*(4*n)) - (b^2*Cos[2*a]*CosIntegral[2*b*x^n])/n + (b*Sin[2*a + 2*b*x^n])/(x^n*(2*n)) + (b^2*Sin[2*a]*SinIntegral[2*b*x^n])/n}
{Cos[a + b*x^n]^3/x^(2*n + 1), x, 14, -((3*Cos[a + b*x^n])/(x^(2*n)*(8*n))) - Cos[3*a + 3*b*x^n]/(x^(2*n)*(8*n)) - (3*b^2*Cos[a]*CosIntegral[b*x^n])/(8*n) - (9*b^2*Cos[3*a]*CosIntegral[3*b*x^n])/(8*n) + (3*b*Sin[a + b*x^n])/(x^n*(8*n)) + (3*b*Sin[3*a + 3*b*x^n])/(x^n*(8*n)) + (3*b^2*Sin[a]*SinIntegral[b*x^n])/(8*n) + (9*b^2*Sin[3*a]*SinIntegral[3*b*x^n])/(8*n)}
...
{x^2*Cos[(a + b*x)^2], x, 8, (a^2*Sqrt[Pi/2]*FresnelC[Sqrt[2/Pi]*(a + b*x)])/b^3 - (Sqrt[Pi/2]*FresnelS[Sqrt[2/Pi]*(a + b*x)])/(2*b^3) - (a*Sin[(a + b*x)^2])/b^3 + ((a + b*x)*Sin[(a + b*x)^2])/(2*b^3)}
{x^1*Cos[(a + b*x)^2], x, 6, -((a*Sqrt[Pi/2]*FresnelC[Sqrt[2/Pi]*(a + b*x)])/b^2) + Sin[(a + b*x)^2]/(2*b^2)}
{x^0*Cos[(a + b*x)^2], x, 2, (Sqrt[Pi/2]*FresnelC[Sqrt[2/Pi]*(a + b*x)])/b}
{Cos[(a + b*x)^2]/x^1, x, 1, Defer[Int][Cos[(a + b*x)^2]/x, x], Defer[Subst][Defer[Int][Cos[x^2]/(-a + x), x], x, a + b*x]}
{Cos[(a + b*x)^2]/x^2, x, 1, Defer[Int][Cos[(a + b*x)^2]/x^2, x], b*Defer[Subst][Defer[Int][Cos[x^2]/(-a + x)^2, x], x, a + b*x]}
...
{Cos[a + b*Sqrt[c + d*x]]*x^2, x, 16, (240*Cos[a + b*Sqrt[c + d*x]])/(b^6*d^3) + (24*c*Cos[a + b*Sqrt[c + d*x]])/(b^4*d^3) + (2*c^2*Cos[a + b*Sqrt[c + d*x]])/(b^2*d^3) - (120*(c + d*x)*Cos[a + b*Sqrt[c + d*x]])/(b^4*d^3) - (12*c*(c + d*x)*Cos[a + b*Sqrt[c + d*x]])/(b^2*d^3) + (10*(c + d*x)^2*Cos[a + b*Sqrt[c + d*x]])/(b^2*d^3) + (240*Sqrt[c + d*x]*Sin[a + b*Sqrt[c + d*x]])/(b^5*d^3) + (24*c*Sqrt[c + d*x]*Sin[a + b*Sqrt[c + d*x]])/(b^3*d^3) + (2*c^2*Sqrt[c + d*x]*Sin[a + b*Sqrt[c + d*x]])/(b*d^3) - (40*(c + d*x)^(3/2)*Sin[a + b*Sqrt[c + d*x]])/(b^3*d^3) - (4*c*(c + d*x)^(3/2)*Sin[a + b*Sqrt[c + d*x]])/(b*d^3) + (2*(c + d*x)^(5/2)*Sin[a + b*Sqrt[c + d*x]])/(b*d^3)}
{Cos[a + b*Sqrt[c + d*x]]*x^1, x, 10, -((12*Cos[a + b*Sqrt[c + d*x]])/(b^4*d^2)) - (2*c*Cos[a + b*Sqrt[c + d*x]])/(b^2*d^2) + (6*(c + d*x)*Cos[a + b*Sqrt[c + d*x]])/(b^2*d^2) - (12*Sqrt[c + d*x]*Sin[a + b*Sqrt[c + d*x]])/(b^3*d^2) - (2*c*Sqrt[c + d*x]*Sin[a + b*Sqrt[c + d*x]])/(b*d^2) + (2*(c + d*x)^(3/2)*Sin[a + b*Sqrt[c + d*x]])/(b*d^2)}
{Cos[a + b*Sqrt[c + d*x]]*x^0, x, 4, (2*Cos[a + b*Sqrt[c + d*x]])/(b^2*d) + (2*Sqrt[c + d*x]*Sin[a + b*Sqrt[c + d*x]])/(b*d)}
{Cos[a + b*Sqrt[c + d*x]]/x^1, x, 10, Cos[a + b*Sqrt[c]]*CosIntegral[b*Sqrt[c] - b*Sqrt[c + d*x]] + Cos[a - b*Sqrt[c]]*CosIntegral[b*Sqrt[c] + b*Sqrt[c + d*x]] + Sin[a + b*Sqrt[c]]*SinIntegral[b*Sqrt[c] - b*Sqrt[c + d*x]] - Sin[a - b*Sqrt[c]]*SinIntegral[b*Sqrt[c] + b*Sqrt[c + d*x]]}
{Cos[a + b*Sqrt[c + d*x]]/x^2, x, 11, -(Cos[a + b*Sqrt[c + d*x]]/x) + (b*d*CosIntegral[b*Sqrt[c] + b*Sqrt[c + d*x]]*Sin[a - b*Sqrt[c]])/(2*Sqrt[c]) - (b*d*CosIntegral[b*Sqrt[c] - b*Sqrt[c + d*x]]*Sin[a + b*Sqrt[c]])/(2*Sqrt[c]) + (b*d*Cos[a + b*Sqrt[c]]*SinIntegral[b*Sqrt[c] - b*Sqrt[c + d*x]])/(2*Sqrt[c]) + (b*d*Cos[a - b*Sqrt[c]]*SinIntegral[b*Sqrt[c] + b*Sqrt[c + d*x]])/(2*Sqrt[c])}
